...
### Task 1: Iterator For-Each Method Resolution - FIXED (GAP-02)
**File:** `crates/dexterity-passes/src/loop_analysis.rs`
**JADX:** `LoopRegionVisitor.java:246-384`
**Status:** **FIXED** - Dec 24, 2025 (commit 957ca9f1b)
...
- `crates/dexterity-ir/src/regions.rs` - IterableSource::Iterator variant
- `crates/dexterity-codegen/src/body_gen.rs` - IterableSource::Iterator handling
...
2. ~~**P0-Task 1: Iterator for-each**~~ - **FIXED Dec 24** (GAP-02, commit 957ca9f1b)
