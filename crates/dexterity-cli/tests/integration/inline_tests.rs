...
"#;
    ...
    result
        .contains_one("Bundle arguments = getArguments();")
        .contains_one("@Nullable Bundle bundle")
        .does_not_contain("Bundle arguments;");
}
...
"#;
    ...
    result
        .contains_one("toMap(list, new Function<T, T>() {")
        .does_not_contain("Lambda$1.INSTANCE");
}
...
"#;
    ...
    result
        .contains_one("C.test()")
        .contains_one("public class C {")
        .does_not_contain("bridgeMth()");
}
