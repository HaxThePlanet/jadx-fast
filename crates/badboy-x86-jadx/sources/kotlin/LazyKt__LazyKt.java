...
class LazyKt__LazyKt extends kotlin.LazyKt__LazyJVMKt {
    private static final <T> T getValue(kotlin.Lazy<? extends T> $this$getValue, Object thisRef, KProperty<?> property) {
    ...
    public static final <T> kotlin.Lazy<T> lazyOf(T value) {
        InitializedLazyImpl initializedLazyImpl = new InitializedLazyImpl(value);
        return (Lazy)initializedLazyImpl;
    }
}
