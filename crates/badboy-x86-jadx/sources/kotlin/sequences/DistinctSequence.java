...
public final class DistinctSequence<T, K>  implements kotlin.sequences.Sequence<T> {
    ...
    public DistinctSequence(kotlin.sequences.Sequence<? extends T> source, Function1<? super T, ? extends K> keySelector) {
    ...
    public Iterator<T> iterator() {
        DistinctIterator distinctIterator = new DistinctIterator(this.source.iterator(), this.keySelector);
        return (Iterator)distinctIterator;
    }
}
