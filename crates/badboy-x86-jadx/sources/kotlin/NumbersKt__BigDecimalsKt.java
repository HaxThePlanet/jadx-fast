...
class NumbersKt__BigDecimalsKt {
    ...
    private static final BigDecimal inc(BigDecimal $this$inc) {
        ...
        BigDecimal num = $this$inc.add(BigDecimal.ONE);
    ...
    private static final BigDecimal plus(BigDecimal $this$plus, BigDecimal other) {
        ...
        Intrinsics.checkNotNullParameter(other, "other");
        BigDecimal num = $this$plus.add(other);
        Intrinsics.checkNotNullExpressionValue(num, "add(...)");
        return num;
    }
    ...
    private static final BigDecimal toBigDecimal(double $this$toBigDecimal) {
        BigDecimal bigDecimal = new BigDecimal(String.valueOf($this$toBigDecimal));
        return bigDecimal;
    }

    private static final BigDecimal toBigDecimal(double $this$toBigDecimal, MathContext mathContext) {
        Intrinsics.checkNotNullParameter(obj4, "mathContext");
        BigDecimal bigDecimal = new BigDecimal(String.valueOf($this$toBigDecimal), obj4);
        return bigDecimal;
    }
    ...
    private static final BigDecimal toBigDecimal(float $this$toBigDecimal, MathContext mathContext) {
        ...
        BigDecimal bigDecimal = new BigDecimal(String.valueOf($this$toBigDecimal), mathContext);
        return bigDecimal;
    }
    ...
    private static final BigDecimal toBigDecimal(long $this$toBigDecimal) {
        final BigDecimal valueOf = BigDecimal.valueOf($this$toBigDecimal);
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(...)");
        return valueOf;
    }

    private static final BigDecimal toBigDecimal(long $this$toBigDecimal, MathContext mathContext) {
        Intrinsics.checkNotNullParameter(obj3, "mathContext");
        BigDecimal bigDecimal = new BigDecimal($this$toBigDecimal, mathContext, obj3);
        return bigDecimal;
    }
