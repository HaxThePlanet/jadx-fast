...
public abstract class AbstractCoroutineContextKey<B extends kotlin.coroutines.CoroutineContext.Element, E extends B>  implements kotlin.coroutines.CoroutineContext.Key<E> {
    ...
    private final Function1<kotlin.coroutines.CoroutineContext.Element, E> safeCast;
    private final kotlin.coroutines.CoroutineContext.Key<?> topmostKey;
    public AbstractCoroutineContextKey(kotlin.coroutines.CoroutineContext.Key<B> baseKey, Function1<? super kotlin.coroutines.CoroutineContext.Element, ? extends E> safeCast) {
        Object topmostKey;
    ...
    public final E tryCast$kotlin_stdlib(kotlin.coroutines.CoroutineContext.Element element) {
