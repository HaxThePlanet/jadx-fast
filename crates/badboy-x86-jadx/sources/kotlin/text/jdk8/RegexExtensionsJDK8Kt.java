...
public final class RegexExtensionsJDK8Kt {
    public static final MatchGroup get(MatchGroupCollection $this$get, String name) {
        ...
        if ($this$get instanceof MatchNamedGroupCollection != null) {
            obj = $this$get;
        } else {
            obj = 0;
        }
        ...
        UnsupportedOperationException namedGroups = new UnsupportedOperationException("Retrieving groups by name is not supported on this platform.");
        throw namedGroups;
    }
}
