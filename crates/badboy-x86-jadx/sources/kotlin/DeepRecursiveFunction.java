...
public final class DeepRecursiveFunction<T, R>  {
    ...
    private final Function3<kotlin.DeepRecursiveScope<T, R>, T, Continuation<? super R>, Object> block;
    public DeepRecursiveFunction(Function3<? super kotlin.DeepRecursiveScope<T, R>, ? super T, ? super Continuation<? super R>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        super();
        this.block = block;
    }

    public final Function3<kotlin.DeepRecursiveScope<T, R>, T, Continuation<? super R>, Object> getBlock$kotlin_stdlib() {
        return this.block;
    }
}
