...
public final class IndexingIterable<T>  implements Iterable<kotlin.collections.IndexedValue<? extends T>>, KMappedMarker {
    ...
    public Iterator<kotlin.collections.IndexedValue<T>> iterator() {
        IndexingIterator indexingIterator = new IndexingIterator((Iterator)this.iteratorFactory.invoke());
