...
public interface KClass<T>  extends kotlin.reflect.KDeclarationContainer, kotlin.reflect.KAnnotatedElement, kotlin.reflect.KClassifier {
    ...
    public abstract Collection<kotlin.reflect.KFunction<T>> getConstructors();

    public abstract Collection<kotlin.reflect.KCallable<?>> getMembers();

    public abstract Collection<kotlin.reflect.KClass<?>> getNestedClasses();
    ...
    public abstract List<kotlin.reflect.KClass<? extends T>> getSealedSubclasses();

    @Override // kotlin.reflect.KDeclarationContainer
    public abstract String getSimpleName();

    public abstract List<kotlin.reflect.KType> getSupertypes();
