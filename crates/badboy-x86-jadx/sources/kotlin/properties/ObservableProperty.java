...
public abstract class ObservableProperty<V>  implements kotlin.properties.ReadWriteProperty<Object, V> {
    ...
    public String toString() {
        ...
        return stringBuilder.append("ObservableProperty(value=").append(this.value).append(')').toString();
    }
}
