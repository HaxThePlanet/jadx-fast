...
final class PlatformRandom extends kotlin.random.AbstractPlatformRandom implements Serializable {
    ...
    static {
        PlatformRandom.Companion companion = new PlatformRandom.Companion(0);
        PlatformRandom.Companion = companion;
    }
