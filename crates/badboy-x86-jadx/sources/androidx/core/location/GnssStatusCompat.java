...
public abstract class GnssStatusCompat {
    ...
    public static abstract class Callback {
        ...
        public void onSatelliteStatusChanged(androidx.core.location.GnssStatusCompat status) {
        }
    ...
    public static androidx.core.location.GnssStatusCompat wrap(GnssStatus gnssStatus) {
        GnssStatusWrapper gnssStatusWrapper = new GnssStatusWrapper(gnssStatus);
        return gnssStatusWrapper;
    }

    public static androidx.core.location.GnssStatusCompat wrap(GpsStatus gpsStatus) {
