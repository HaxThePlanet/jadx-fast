        ...
        if (filterParts.length != i2) {
            ...
            if (filterParts[i].isEmpty()) {
                ...
                if (filterParts[empty].isEmpty()) {
                    ...
                    if (!str.equals(filterParts[empty]) && !filterParts[empty].equals(mimeTypeParts[empty])) {
                        if (!filterParts[empty].equals(mimeTypeParts[empty])) {
                            return i;
                        }
                    }
                    return empty;
