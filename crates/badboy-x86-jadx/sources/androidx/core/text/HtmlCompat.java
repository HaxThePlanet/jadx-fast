...
public final class HtmlCompat {
    ...
    public static Spanned fromHtml(String source, int flags) {
        return HtmlCompat.Api24Impl.fromHtml(source, flags);
    }

    public static Spanned fromHtml(String source, int flags, Html.ImageGetter imageGetter, Html.TagHandler tagHandler) {
        return HtmlCompat.Api24Impl.fromHtml(source, flags, imageGetter, tagHandler);
    }

    public static String toHtml(Spanned text, int options) {
        return HtmlCompat.Api24Impl.toHtml(text, options);
    }
}
