...
public class RemoteActionCompatParcelizer {
    public static androidx.core.app.RemoteActionCompat read(VersionedParcel parcel) {
    ...
    public static void write(androidx.core.app.RemoteActionCompat obj, VersionedParcel parcel) {
        int i = 0;
