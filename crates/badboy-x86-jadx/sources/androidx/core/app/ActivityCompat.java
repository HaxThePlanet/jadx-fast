...
public class ActivityCompat extends ContextCompat {
    ...
    public static void requestPermissions(Activity activity, String[] permissions, int requestCode) {
        ...
        for (Object str2 : permissions) {
            if (Build.VERSION.SDK_INT < 33 && TextUtils.equals(permissions[i3], "android.permission.POST_NOTIFICATIONS")) {
            }
            if (TextUtils.equals(permissions[i3], "android.permission.POST_NOTIFICATIONS")) {
            }
