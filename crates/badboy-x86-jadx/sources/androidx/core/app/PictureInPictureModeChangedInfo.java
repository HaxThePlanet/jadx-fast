...
public final class PictureInPictureModeChangedInfo {
    ...
    public final Configuration getNewConfig() {
        ...
        int i = 0;
        IllegalStateException illegalStateException = new IllegalStateException("PictureInPictureModeChangedInfo must be constructed with the constructor that takes a Configuration to access the newConfig. Are you running on an API 26 or higher device that makes this information available?".toString());
