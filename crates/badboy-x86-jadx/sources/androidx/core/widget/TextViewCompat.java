...
public final class TextViewCompat {
    ...
    private static class OreoCallback implements ActionMode.Callback {
        ...
        private void recomputeProcessTextMenuItems(Menu menu) {
            ...
            i2 = 0;
            while (i2 < supportedActivities2.size()) {
                item = supportedActivities2.get(i2);
                menu.add(i3, i3, i2 + 100, (ResolveInfo)item.loadLabel(packageManager)).setIntent(createProcessTextIntentForResolveInfo(item, this.mTextView)).setShowAsAction(i4);
                i2++;
            }
        }
