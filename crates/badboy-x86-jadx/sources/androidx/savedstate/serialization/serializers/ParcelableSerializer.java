...
public abstract class ParcelableSerializer<T extends android.os.Parcelable>  implements KSerializer<T> {

    private final SerialDescriptor descriptor;
    public ParcelableSerializer() {
        super();
        final int i2 = 0;
        this.descriptor = SerialDescriptorsKt.buildClassSerialDescriptor$default("android.os.Parcelable", new SerialDescriptor[0], i2, 4, i2);
    }
    ...
    public final T deserialize(Decoder decoder) {
        ...
        if (!decoder instanceof SavedStateDecoder) {
            ...
            final int i4 = 0;
            int i5 = 0;
            android.os.Parcelable key$iv = SavedStateReader.getParcelable-impl(SavedStateReader.constructor-impl((SavedStateDecoder)obj.getSavedState$savedstate_release()), obj.getKey$savedstate_release(), Reflection.getOrCreateKotlinClass(Parcelable.class));
            Intrinsics.checkNotNull(key$iv, "null cannot be cast to non-null type T of androidx.savedstate.serialization.serializers.ParcelableSerializer");
            return key$iv;
        }
        int i = 0;
    ...
    public final void serialize(Encoder encoder, T value) {
        ...
        if (!encoder instanceof SavedStateEncoder) {
            ...
            final int i3 = 0;
            final int i4 = 0;
            SavedStateWriter.putParcelable-impl(SavedStateWriter.constructor-impl((SavedStateEncoder)obj.getSavedState$savedstate_release()), obj.getKey$savedstate_release(), value);
        }
        int i = 0;
