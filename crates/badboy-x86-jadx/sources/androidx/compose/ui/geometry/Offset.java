...
public final class Offset {
    ...
    public static String toString-impl(long arg0) {
        ...
        if (OffsetKt.isSpecified-k-4lQ0M(arg0)) {
            ...
            i = 1;
            string = stringBuilder.append("Offset(").append(GeometryUtilsKt.toStringAsFixed(Offset.getX-impl(arg0), i)).append(", ").append(GeometryUtilsKt.toStringAsFixed(Offset.getY-impl(arg0), i)).append(')').toString();
        } else {
