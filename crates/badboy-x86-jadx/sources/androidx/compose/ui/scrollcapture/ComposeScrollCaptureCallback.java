...
public final class ComposeScrollCaptureCallback implements ScrollCaptureCallback {
    ...
    private final Object onScrollCaptureImageRequest(ScrollCaptureSession scrollCaptureSession, IntRect intRect2, Continuation<? super IntRect> continuation3) {
        ...
        if (continuation3 instanceof ComposeScrollCaptureCallback.onScrollCaptureImageRequest.2 && label &= i4 != 0) {
            anon = continuation3;
            i4 = Integer.MIN_VALUE;
            if (label &= i4 != 0) {
                anon.label = obj14 -= i4;
        ...
        switch (label2) {
            ...
            case 2:
                ...
                Canvas lockHardwareCanvas = obj2.getSurface().lockHardwareCanvas();
                int i6 = 0;
                lockHardwareCanvas.drawColor(i6, BlendMode.CLEAR);
                Canvas canvas = AndroidCanvas_androidKt.Canvas(lockHardwareCanvas);
                canvas.translate(-f, -f2);
                obj13.draw(canvas, 0);
                obj2.getSurface().unlockCanvasAndPost(lockHardwareCanvas);
