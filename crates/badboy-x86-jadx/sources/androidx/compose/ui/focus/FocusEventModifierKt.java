...
public final class FocusEventModifierKt {
    public static final Modifier onFocusEvent(Modifier $this$onFocusEvent, Function1<? super androidx.compose.ui.focus.FocusState, Unit> onFocusEvent) {
        FocusEventElement focusEventElement = new FocusEventElement(onFocusEvent);
        return $this$onFocusEvent.then((Modifier)focusEventElement);
    }
}
