...
public final class InlineClassHelperKt {
    ...
    public static final void checkPrecondition(boolean value, Function0<String> lazyMessage) {
        ...
        final int i = 0;
        if (value == null) {
            InlineClassHelperKt.throwIllegalStateException((String)lazyMessage.invoke());
        }
    }

    public static final <T> T checkPreconditionNotNull(T value) {
        final int i = 0;
        if (value == 0) {
        } else {
            return value;
    ...
    public static final <T> T checkPreconditionNotNull(T value, Function0<String> lazyMessage) {
        ...
        InlineClassHelperKt.throwIllegalStateExceptionForNullCheck((String)lazyMessage.invoke());
        KotlinNothingValueException kotlinNothingValueException = new KotlinNothingValueException();
        throw kotlinNothingValueException;
    }
