...
public abstract class PointerInputFilter {
    ...
    public final long getSize-YbymL2g() {
        ...
        if (layoutCoordinates != null) {
            size-YbymL2g = layoutCoordinates.getSize-YbymL2g();
        } else {
    ...
    public abstract void onPointerEvent-H0pRuoY(androidx.compose.ui.input.pointer.PointerEvent pointerEvent, androidx.compose.ui.input.pointer.PointerEventPass pointerEventPass2, long l3);

    public final void setAttached$ui_release(boolean <set-?>) {
        this.isAttached = <set-?>;
    }

    public final void setLayoutCoordinates$ui_release(LayoutCoordinates <set-?>) {
        this.layoutCoordinates = <set-?>;
    }
}
