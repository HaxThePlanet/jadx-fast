...
public final class PointerKeyboardModifiers {
    ...
    private PointerKeyboardModifiers(int packedValue) {
        super();
        this.packedValue = packedValue;
    }

    public static final androidx.compose.ui.input.pointer.PointerKeyboardModifiers box-impl(int i) {
    ...
    public static boolean equals-impl(int i, Object object2) {
        final int i3 = 0;
        if (!object2 instanceof PointerKeyboardModifiers) {
            return i3;
        }
        if (i != (PointerKeyboardModifiers)object2.unbox-impl()) {
            return i3;
        }
        return 1;
    }
    ...
    public static String toString-impl(int i) {
        ...
        return stringBuilder.append("PointerKeyboardModifiers(packedValue=").append(i).append(')').toString();
    }

    public boolean equals(Object object) {
        return PointerKeyboardModifiers.equals-impl(this.packedValue, object);
    }

    public int hashCode() {
        return PointerKeyboardModifiers.hashCode-impl(this.packedValue);
    }

    public String toString() {
        return PointerKeyboardModifiers.toString-impl(this.packedValue);
    }
