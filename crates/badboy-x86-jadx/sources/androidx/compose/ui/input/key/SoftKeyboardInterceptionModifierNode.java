...
public interface SoftKeyboardInterceptionModifierNode extends DelegatableNode {
    ...
    public abstract boolean onInterceptKeyBeforeSoftKeyboard-ZmokQxo(KeyEvent keyEvent);

    @Override // androidx.compose.ui.node.DelegatableNode
    public abstract boolean onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo(KeyEvent keyEvent);
}
