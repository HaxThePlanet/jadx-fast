...
public final class PathFillType {
    ...
    public static final androidx.compose.ui.graphics.PathFillType.Companion Companion;
    ...
    public static final class Companion {
        ...
        public final int getEvenOdd-Rg-k1Os() {
            return PathFillType.access$getEvenOdd$cp();
        }

        public final int getNonZero-Rg-k1Os() {
            return PathFillType.access$getNonZero$cp();
        }
    }
    static {
        PathFillType.Companion companion = new PathFillType.Companion(0);
        PathFillType.Companion = companion;
        PathFillType.NonZero = PathFillType.constructor-impl(0);
        PathFillType.EvenOdd = PathFillType.constructor-impl(1);
    }

    private PathFillType(int value) {
        super();
        this.value = value;
    }
    ...
    public static final androidx.compose.ui.graphics.PathFillType box-impl(int i) {
    ...
    public static boolean equals-impl(int i, Object object2) {
        final int i3 = 0;
        if (!object2 instanceof PathFillType) {
            return i3;
        }
        if (i != (PathFillType)object2.unbox-impl()) {
            return i3;
        }
        return 1;
    }
    ...
    public static String toString-impl(int arg0) {
        String str;
        str = PathFillType.equals-impl0(arg0, PathFillType.NonZero) ? "NonZero" : equals-impl02 ? "EvenOdd" : "Unknown";
        return str;
    }

    public boolean equals(Object object) {
        return PathFillType.equals-impl(this.value, object);
    }

    public int hashCode() {
        return PathFillType.hashCode-impl(this.value);
    }

    public String toString() {
        return PathFillType.toString-impl(this.value);
    }
