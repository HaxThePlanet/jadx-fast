...
public final class CanvasHolder {
    ...
    private final androidx.compose.ui.graphics.AndroidCanvas androidCanvas;
    public CanvasHolder() {
        super();
    ...
    public final void drawInto(Canvas targetCanvas, Function1<? super androidx.compose.ui.graphics.Canvas, Unit> block) {
        final int i = 0;
        getAndroidCanvas().setInternalCanvas(targetCanvas);
        block.invoke(getAndroidCanvas());
        getAndroidCanvas().setInternalCanvas(getAndroidCanvas().getInternalCanvas());
    }
