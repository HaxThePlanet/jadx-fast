...
public final class PathSvgKt {
    ...
    public static final String toSvg(androidx.compose.ui.graphics.Path $this$toSvg, boolean asDocument) {
        ...
        if (asDocument) {
            ...
            StringBuilder append14 = sb.append(stringBuilder2.append("viewBox=\"").append(bounds.getLeft()).append(append2).append(bounds.getTop()).append(append2).append(bounds.getWidth()).append(append2).append(bounds.getHeight()).append("\">").toString());
            Intrinsics.checkNotNullExpressionValue(append14, str4);
            Intrinsics.checkNotNullExpressionValue(append14.append(append), str3);
        }
        ...
        if (iterator.hasNext() && asDocument) {
            ...
            while (iterator.hasNext()) {
                evenOdd-Rg-k1Os = 0;
                i4 = 2;
                next$default = PathIterator.next$default(iterator, fArr, evenOdd-Rg-k1Os, i4, 0);
                i = 5;
                i2 = 4;
                i3 = 3;
                ...
                sb.append(stringBuilder4.append(fArr[i4]).append(append2).append(fArr[i3]).append(append2).toString());
                StringBuilder stringBuilder5 = new StringBuilder();
                sb.append(stringBuilder5.append(fArr[i2]).append(append2).append(fArr[i]).append(append2).toString());
                StringBuilder stringBuilder6 = new StringBuilder();
                sb.append(stringBuilder6.append(fArr[6]).append(append2).append(fArr[7]).toString());
                sb.append(PathSvgKt.command(PathSegment.Type.Quadratic, lastType));
                StringBuilder stringBuilder3 = new StringBuilder();
                sb.append(stringBuilder3.append(fArr[i4]).append(append2).append(fArr[i3]).append(append2).append(fArr[i2]).append(append2).append(fArr[i]).toString());
                StringBuilder stringBuilder7 = new StringBuilder();
                sb.append(stringBuilder7.append(PathSvgKt.command(PathSegment.Type.Line, lastType)).append(fArr[i4]).append(append2).append(fArr[i3]).toString());
                StringBuilder stringBuilder8 = new StringBuilder();
                sb.append(stringBuilder8.append(PathSvgKt.command(PathSegment.Type.Move, lastType)).append(fArr[evenOdd-Rg-k1Os]).append(append2).append(fArr[1]).toString());
            }
            if (asDocument) {
                StringBuilder append4 = sb.append("\"/>");
                Intrinsics.checkNotNullExpressionValue(append4, str4);
                Intrinsics.checkNotNullExpressionValue(append4.append(append), str3);
            }
        }
        if (asDocument) {
            append2 = sb.append("</svg>");
            Intrinsics.checkNotNullExpressionValue(append2, str4);
            Intrinsics.checkNotNullExpressionValue(append2.append(append), str3);
        }
