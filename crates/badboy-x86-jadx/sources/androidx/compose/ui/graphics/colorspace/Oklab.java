...
public final class Oklab extends androidx.compose.ui.graphics.colorspace.ColorSpace {
    ...
    public float[] toXyz(float[] v) {
        ...
        int i28 = 0;
        int i33 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv3, i16) < 0) {
            $this$fastCoerceAtMost$iv$iv3 = i16;
        }
        int i34 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv3, i24) > 0) {
            $this$fastCoerceAtMost$iv$iv3 = i24;
        }
        v[i9] = $this$fastCoerceAtMost$iv$iv3;
        int i14 = 2;
        int i25 = -1090519040;
        int i29 = 1056964608;
        int i32 = 0;
