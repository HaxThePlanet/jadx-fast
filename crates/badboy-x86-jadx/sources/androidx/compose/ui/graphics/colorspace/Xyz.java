...
public final class Xyz extends androidx.compose.ui.graphics.colorspace.ColorSpace {
    ...
    public long xyzaToColor-JlNiLsg$ui_graphics_release(float x, float y, float z, float a, androidx.compose.ui.graphics.colorspace.ColorSpace colorSpace) {
        ...
        int i15 = 0;
        int i20 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv$iv3, i6) < 0) {
            $this$fastCoerceAtMost$iv$iv$iv3 = i6;
        }
        int i21 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv$iv3, i9) > 0) {
            $this$fastCoerceAtMost$iv$iv$iv3 = i9;
        }
        return ColorKt.Color($this$fastCoerceAtMost$iv$iv$iv, $this$fastCoerceAtMost$iv$iv$iv2, $this$fastCoerceAtMost$iv$iv$iv3, a, colorSpace);
    }
}
