...
public final class Lab extends androidx.compose.ui.graphics.colorspace.ColorSpace {
    ...
    public float[] fromXyz(float[] v) {
        ...
        int i34 = 0;
        int i38 = 0;
        if (Float.compare($this$fastCoerceAtLeast$iv$iv2, i3) < 0) {
            $this$fastCoerceAtLeast$iv$iv2 = i3;
        }
        int i39 = 0;
        if (Float.compare($this$fastCoerceAtLeast$iv$iv2, i23) > 0) {
            $this$fastCoerceAtLeast$iv$iv2 = i23;
        }
        v[i7] = $this$fastCoerceAtLeast$iv$iv2;
        int i4 = -1023410176;
        int i8 = 1124073472;
        int i32 = 0;
        int i36 = 0;
    ...
    public float[] toXyz(float[] v) {
        ...
        int i33 = 0;
        if (Float.compare($this$fastCoerceAtLeast$iv$iv, i12) > 0) {
            $this$fastCoerceAtLeast$iv$iv = i12;
        }
        v[i4] = $this$fastCoerceAtLeast$iv$iv;
        int i8 = 1;
        int i13 = -1023410176;
        int i19 = 1124073472;
        int i26 = 0;
        ...
        int i34 = 0;
        int i43 = 0;
        if (Float.compare($this$fastCoerceAtLeast$iv$iv2, i20) < 0) {
            $this$fastCoerceAtLeast$iv$iv2 = i20;
        }
        int i44 = 0;
        if (Float.compare($this$fastCoerceAtLeast$iv$iv2, i27) > 0) {
            $this$fastCoerceAtLeast$iv$iv2 = i27;
        }
        ...
        int i45 = 1041055179;
        int i47 = 1040416807;
        i3 = Float.compare(i25, i36) > 0 ? i42 * i25 : i41 * i47;
        i = Float.compare(i17, i36) > 0 ? i49 * i17 : i48 * i47;
        i2 = Float.compare(i31, i36) > 0 ? i38 * i31 : i37 * i47;
        v[i4] = f3 *= i3;
        v[i8] = f *= i;
        v[i11] = f2 *= i2;
        return v;
