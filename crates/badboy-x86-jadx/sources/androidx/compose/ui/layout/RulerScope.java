...
public interface RulerScope extends Density {
    ...
    @Override // androidx.compose.ui.unit.Density
    public abstract void provides(androidx.compose.ui.layout.Ruler ruler, float f2);

    @Override // androidx.compose.ui.unit.Density
    public abstract void providesRelative(androidx.compose.ui.layout.VerticalRuler verticalRuler, float f2);
}
