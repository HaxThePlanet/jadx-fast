...
public final class DefaultIntrinsicMeasurable implements androidx.compose.ui.layout.Measurable {
    ...
    public androidx.compose.ui.layout.Placeable measure-BRTryo0(long constraints) {
        ...
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            ...
            FixedSizeIntrinsicsPlaceable fixedSizeIntrinsicsPlaceable2 = new FixedSizeIntrinsicsPlaceable(minIntrinsicWidth, maxHeight-impl2);
        ...
        FixedSizeIntrinsicsPlaceable fixedSizeIntrinsicsPlaceable = new FixedSizeIntrinsicsPlaceable(maxHeight-impl2, minIntrinsicHeight);
