...
public final class OnPlacedModifierKt {
    public static final Modifier onPlaced(Modifier $this$onPlaced, Function1<? super androidx.compose.ui.layout.LayoutCoordinates, Unit> onPlaced) {
        OnPlacedElement onPlacedElement = new OnPlacedElement(onPlaced);
        return $this$onPlaced.then((Modifier)onPlacedElement);
    }
}
