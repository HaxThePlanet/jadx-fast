...
public final class SemanticsNodeCopy {
    ...
    public SemanticsNodeCopy(SemanticsNode semanticsNode, IntObjectMap<androidx.compose.ui.platform.SemanticsNodeWithAdjustedBounds> currentSemanticsNodes) {
        int index$iv;
        Object obj;
        Object obj2;
        int i;
        ...
        this.children = IntSetKt.mutableIntSetOf();
        ...
        while (index$iv < replacedChildren$ui_release.size()) {
            obj2 = obj;
            i = 0;
            if (currentSemanticsNodes.contains((SemanticsNode)obj2.getId())) {
            }
            index$iv++;
            this.children.add(obj2.getId());
        }
    }
