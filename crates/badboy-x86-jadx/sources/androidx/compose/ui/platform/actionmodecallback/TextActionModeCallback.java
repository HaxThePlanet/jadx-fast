...
public final class TextActionModeCallback {
    ...
    public final boolean onCreateActionMode(ActionMode mode, Menu menu) {
        ...
        if (menu == null) {
            ...
            int i2 = 0;
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException("onCreateActionMode requires a non-null mode".toString());
            throw illegalArgumentException;
        }
        int i4 = 0;
        IllegalArgumentException illegalArgumentException2 = new IllegalArgumentException("onCreateActionMode requires a non-null menu".toString());
