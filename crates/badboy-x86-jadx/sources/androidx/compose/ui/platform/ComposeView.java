...
public final class ComposeView extends androidx.compose.ui.platform.AbstractComposeView {
    ...
    public void Content(Composer $composer, int $changed) {
        ...
        if ($dirty & 3 == str) {
            if (!obj5.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty, -1, "androidx.compose.ui.platform.ComposeView.Content (ComposeView.android.kt:439)");
                }
        ...
        if (endRestartGroup != null) {
            traceInProgress = new ComposeView.Content.1(this, $changed);
