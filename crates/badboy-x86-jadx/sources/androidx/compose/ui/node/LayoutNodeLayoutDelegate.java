...
public final class LayoutNodeLayoutDelegate {
    ...
    public final void setChildrenAccessingLookaheadCoordinatesDuringPlacement(int value) {
        ...
        i = 1;
        i2 = this.childrenAccessingLookaheadCoordinatesDuringPlacement == 0 ? i : layoutDelegate$ui_release;
        if (value == null) {
        ...
        if (i2 != layoutDelegate$ui_release) {
            ...
            if (layoutDelegate$ui_release != null) {
                if (value == null) {
                    ...
                    layoutDelegate$ui_release.setChildrenAccessingLookaheadCoordinatesDuringPlacement(childrenAccessingLookaheadCoordinatesDuringPlacement3 += i);
                }
            }
        }
    }
