    ...
    private final void updateTranslationOnAppeared(SemanticsNode node) {
        ...
        if (this.translateStatus == AndroidContentCaptureManager.TranslateStatus.SHOW_ORIGINAL && Intrinsics.areEqual((Boolean)orNull, valueOf2)) {
            if (Intrinsics.areEqual(orNull, valueOf2)) {
                translateStatus = SemanticsConfigurationKt.getOrNull(unmergedConfig$ui_release, SemanticsActions.INSTANCE.getShowTextSubstitution());
                translateStatus = (AccessibilityAction)translateStatus.getAction();
                if (translateStatus != null && (Function1)translateStatus != null) {
                    translateStatus = translateStatus.getAction();
                    if ((Function1)(Function1)translateStatus != null) {
                        translateStatus = (Function1)(Function1)translateStatus.invoke(valueOf);
                    }
                }
            } else {
                translateStatus = SemanticsConfigurationKt.getOrNull(unmergedConfig$ui_release, SemanticsActions.INSTANCE.getShowTextSubstitution());
                translateStatus = (AccessibilityAction)translateStatus.getAction();
                if (this.translateStatus == AndroidContentCaptureManager.TranslateStatus.SHOW_TRANSLATED && Intrinsics.areEqual(orNull, valueOf) && translateStatus != null && (Function1)translateStatus != null) {
                    if (Intrinsics.areEqual(orNull, valueOf)) {
                        translateStatus = SemanticsConfigurationKt.getOrNull(unmergedConfig$ui_release, SemanticsActions.INSTANCE.getShowTextSubstitution());
                        if ((AccessibilityAction)translateStatus != null) {
                            translateStatus = (AccessibilityAction)translateStatus.getAction();
                            if ((Function1)(Function1)translateStatus != null) {
                                translateStatus = (Function1)(Function1)translateStatus.invoke(valueOf2);
                            }
                        }
                    }
                }
