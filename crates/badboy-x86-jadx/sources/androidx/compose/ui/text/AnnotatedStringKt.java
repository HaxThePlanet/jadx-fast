...
public final class AnnotatedStringKt {
    ...
    private static final List<androidx.compose.ui.text.AnnotatedString.Range<androidx.compose.ui.text.ParagraphStyle>> getLocalParagraphStyles(androidx.compose.ui.text.AnnotatedString $this$getLocalParagraphStyles, int start, int end) {
        ...
        list2 = paragraphStylesOrNull$ui_text_release;
        int i7 = 0;
    ...
    public static final List<androidx.compose.ui.text.AnnotatedString.Range<androidx.compose.ui.text.ParagraphStyle>> normalizedParagraphStyles(androidx.compose.ui.text.AnnotatedString $this$normalizedParagraphStyles, androidx.compose.ui.text.ParagraphStyle defaultParagraphStyle) {
        ...
        Object component1;
        int component2;
        androidx.compose.ui.text.AnnotatedString.Range range2;
        ...
        range = paragraphStylesOrNull$ui_text_release;
        i = 0;
        index$iv = 0;
        while (index$iv < range.size()) {
            Object obj3 = obj;
            i2 = 0;
            ...
            range2 = new AnnotatedString.Range(obj2.merge((ParagraphStyle)(AnnotatedString.Range)obj3.component1()), component2, component3);
            (List)arrayList.add(range2);
            lastOffset = component3;
            index$iv++;
            range2 = new AnnotatedString.Range(obj2, lastOffset, component2);
            arrayList.add(range2);
        }
        if (lastOffset != length) {
            range = new AnnotatedString.Range(obj2, lastOffset, length);
            arrayList.add(range);
        }
        if (arrayList.isEmpty()) {
            i = 0;
            empty = new AnnotatedString.Range(obj2, i, i);
            arrayList.add(empty);
        }
        return arrayList;
    }
