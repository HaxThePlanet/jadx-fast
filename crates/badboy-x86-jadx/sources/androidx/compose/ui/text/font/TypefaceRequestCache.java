...
public final class TypefaceRequestCache {
    ...
    public final void preWarmCache(List<androidx.compose.ui.text.font.TypefaceRequest> typefaceRequests, Function1<? super androidx.compose.ui.text.font.TypefaceRequest, ? extends androidx.compose.ui.text.font.TypefaceResult> resolveTypeface) {
        ...
        while (i < typefaceRequests.size()) {
            obj3 = typefaceRequests.get(i);
            illegalStateException = this.lock;
            lock = 0;
            th = 0;
            illegalStateException = resolveTypeface.invoke(obj3);
            if ((TypefaceResult)this.resultCache.get((TypefaceRequest)obj3) == null && !illegalStateException instanceof TypefaceResult.Async) {
            }
            i++;
            illegalStateException = resolveTypeface.invoke(obj3);
            ...
            th = 0;
            i2 = 0;
            obj = this.resultCache.put(obj3, (TypefaceResult)(TypefaceResult)illegalStateException);
        }
    }
