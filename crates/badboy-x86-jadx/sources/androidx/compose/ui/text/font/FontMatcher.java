...
public final class FontMatcher {
    ...
    public static List filterByClosestWeight$ui_text_release$default(androidx.compose.ui.text.font.FontMatcher $this, List $receiver, androidx.compose.ui.text.font.FontWeight fontWeight, boolean preferBelow, androidx.compose.ui.text.font.FontWeight minSearchRange, androidx.compose.ui.text.font.FontWeight maxSearchRange, int i7, Object object8) {
        ...
        minSearchRange2 = i7 & 4 != 0 ? 0 : minSearchRange;
        ...
        while (index$iv$iv < obj6.size()) {
            ...
            i3 = 0;
            i2 = 0;
            if (Intrinsics.areEqual((Font)obj23.getWeight(), i)) {
            } else {
            }
            obj26 = minSearchRange2;
            minSearchRange3 = obj23;
            index$iv$iv++;
            fontWeight2 = fontWeight;
            minSearchRange2 = obj26;
            obj26 = minSearchRange2;
    ...
    public final List<androidx.compose.ui.text.font.Font> filterByClosestWeight$ui_text_release(List<? extends androidx.compose.ui.text.font.Font> $this$filterByClosestWeight, androidx.compose.ui.text.font.FontWeight fontWeight, boolean preferBelow, androidx.compose.ui.text.font.FontWeight minSearchRange, androidx.compose.ui.text.font.FontWeight maxSearchRange) {
        ...
        while (index$iv$iv < obj7.size()) {
            ...
            i = 0;
            i2 = 0;
            if (Intrinsics.areEqual((Font)obj2.getWeight(), fontWeight3)) {
            } else {
            }
            it$iv = obj2;
            index$iv$iv++;
    ...
    public final List<androidx.compose.ui.text.font.Font> matchFont-RetOiIg(List<? extends androidx.compose.ui.text.font.Font> fontList, androidx.compose.ui.text.font.FontWeight fontWeight, int fontStyle) {
        ...
        int size3;
        int i11;
        ArrayList bestWeightAbove$iv2;
        int index$iv$iv2;
        int index$iv$iv;
        int bestWeightAbove$iv;
        ...
        while (index$iv$iv2 < list5.size()) {
            ...
            it = weight;
            weight2 = 0;
            if (Intrinsics.areEqual((Font)it.getWeight(), size2) && FontStyle.equals-impl0(it.getStyle-_-LCdwA(), i13)) {
            }
            if (i2 != 0) {
            }
            index$iv$iv2++;
        ...
        if (size2.compareTo(FontWeight.Companion.getW400()) < 0) {
            i3 = 1;
            size3 = 0;
            i11 = 0;
            ...
            index$iv = 0;
            while (index$iv < (List)$this$fastFilter$iv.size()) {
                compareTo = (Font)$this$fastFilter$iv.get(index$iv).getWeight();
                if (compareTo.compareTo(size2) >= 0) {
                    break;
                } else {
                }
                if (compareTo.compareTo(size2) <= 0) {
                ...
                bestWeightAbove$iv = compareTo;
                index$iv++;
                if (compareTo.compareTo(bestWeightAbove$iv) < 0) {
                }
                if (bestWeightBelow$iv != 0) {
                } else {
                }
                bestWeightBelow$iv = compareTo;
                if (compareTo.compareTo(bestWeightBelow$iv) > 0) {
                }
            }
            index$iv$iv$iv2 = bestWeightBelow$iv == 0 ? bestWeightAbove$iv : bestWeightBelow$iv;
            bestWeightBelow$iv2 = $this$fastFilter$iv;
            arrayList2 = 0;
            arrayList = new ArrayList(bestWeightBelow$iv2.size());
            compareTo2 = bestWeightBelow$iv2;
            index$iv$iv$iv3 = 0;
            index$iv$iv$iv = 0;
            ...
            while (index$iv$iv$iv < size) {
                ...
                i8 = 0;
                i6 = 0;
                if (Intrinsics.areEqual((Font)i5.getWeight(), index$iv$iv$iv2)) {
                } else {
                }
                fontsToSearch = i3;
                preferBelow$iv = i5;
                index$iv$iv$iv++;
                i3 = fontsToSearch;
                size = $i$a$IfEmptyFontMatcher$matchFont$result$1;
                fontsToSearch = i3;
                (Collection)arrayList.add(i5);
            }
            int preferBelow$iv2 = i3;
            list = arrayList;
            fontsToSearch2 = $this$fastFilter$iv;
        } else {
            if (size2.compareTo(FontWeight.Companion.getW500()) > 0) {
                i12 = 0;
                i3 = 0;
                size3 = 0;
                i11 = 0;
                ...
                bestWeightAbove$iv = 0;
                index$iv4 = 0;
                while (index$iv4 < $this$fastFilter$iv.size()) {
                    weight = (Font)$this$fastFilter$iv.get(index$iv4).getWeight();
                    if (weight.compareTo(size2) >= 0) {
                        break;
                    } else {
                    }
                    if (weight.compareTo(size2) <= 0) {
                ...
                bestWeightBelow$iv = bestWeightAbove$iv2 == 0 ? bestWeightAbove$iv : bestWeightAbove$iv2;
                index$iv$iv$iv2 = $this$fastFilter$iv;
                bestWeightBelow$iv2 = 0;
                arrayList2 = new ArrayList(index$iv$iv$iv2.size());
                arrayList = index$iv$iv$iv2;
                compareTo2 = 0;
                index$iv$iv$iv3 = 0;
                while (index$iv$iv$iv3 < arrayList.size()) {
                    i5 = i4;
                    i8 = 0;
                    i6 = 0;
                    if (Intrinsics.areEqual((Font)i5.getWeight(), bestWeightBelow$iv)) {
                    } else {
                    }
                    ...
                    i12 = $i$a$IfEmptyFontMatcher$matchFont$result$1;
                    fontsToSearch = $this$fastFilter$iv;
                    (Collection)arrayList2.add(i5);
                }
                $i$a$IfEmptyFontMatcher$matchFont$result$1 = i12;
                fontsToSearch2 = $this$fastFilter$iv;
                list = arrayList2;
            } else {
                fontsToSearch2 = $this$fastFilter$iv;
                ...
                int i18 = 0;
                i11 = i18;
                bestWeightAbove$iv2 = fontsToSearch2;
                bestWeightAbove$iv = 0;
                bestWeightBelow$iv = 0;
                bestWeightBelow$iv2 = 0;
                index$iv2 = 0;
                while (index$iv2 < bestWeightAbove$iv2.size()) {
                    weight2 = (Font)bestWeightAbove$iv2.get(index$iv2).getWeight();
                    if (weight2.compareTo(size2) >= 0) {
                        break;
                    } else {
                    }
                    if (weight2.compareTo(size2) <= 0) {
                ...
                arrayList2 = bestWeightBelow$iv == 0 ? bestWeightBelow$iv2 : bestWeightBelow$iv;
                arrayList = bestWeightAbove$iv2;
                compareTo2 = 0;
                index$iv$iv$iv3 = new ArrayList(arrayList.size());
                index$iv$iv$iv = arrayList;
                i4 = 0;
                i6 = i2;
                index$iv$iv$iv2 = i5;
                while (index$iv$iv$iv2 < index$iv$iv$iv.size()) {
                    $i$a$IfEmptyFontMatcher$matchFont$result$1 = i5;
                    i7 = 0;
                    i9 = 0;
                    ...
                    this_$iv = i;
                    this_$iv2 = $i$a$IfEmptyFontMatcher$matchFont$result$1;
                    index$iv$iv$iv2++;
                    i = this_$iv;
                    fontWeight2 = maxSearchRange$iv;
                    this_$iv = i;
                    (Collection)index$iv$iv$iv3.add($i$a$IfEmptyFontMatcher$matchFont$result$1);
                }
                maxSearchRange$iv = fontWeight2;
                this_$iv = i;
                if ((Collection)(List)index$iv$iv$iv3.isEmpty()) {
                    i10 = 0;
                    ...
                    bestWeightBelow$iv = 0;
                    index$iv3 = 0;
                    while (index$iv3 < i11.size()) {
                        arrayList = (Font)i11.get(index$iv3).getWeight();
                        if (arrayList.compareTo(size2) >= 0) {
                            break;
                        } else {
                        }
                        if (arrayList.compareTo(size2) <= 0) {
                        ...
                        bestWeightAbove$iv = arrayList;
                        index$iv3++;
                        if (arrayList.compareTo(bestWeightAbove$iv) < 0) {
                        }
                        if (bestWeightBelow$iv != 0) {
                        } else {
                        }
                        bestWeightBelow$iv = arrayList;
                        if (arrayList.compareTo(bestWeightBelow$iv) > 0) {
                        }
                    }
                    index$iv$iv$iv2 = bestWeightAbove$iv == 0 ? bestWeightBelow$iv : bestWeightAbove$iv;
                    bestWeightBelow$iv2 = i11;
                    arrayList2 = 0;
                    arrayList = new ArrayList(bestWeightBelow$iv2.size());
                    compareTo2 = bestWeightBelow$iv2;
                    index$iv$iv$iv3 = 0;
                    ...
                    while (index$iv$iv$iv < size2) {
                        ...
                        $i$a$IfEmptyFontMatcher$matchFont$result$1 = i10;
                        $i$a$IfEmptyFontMatcher$matchFont$result$12 = i5;
                        index$iv$iv$iv++;
                        i10 = $i$a$IfEmptyFontMatcher$matchFont$result$1;
                        size2 = this_$iv;
                        $i$a$IfEmptyFontMatcher$matchFont$result$1 = i10;
                        (Collection)arrayList.add(i5);
                    }
