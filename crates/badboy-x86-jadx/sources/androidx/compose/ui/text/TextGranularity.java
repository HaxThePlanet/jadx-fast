...
public final class TextGranularity {
    ...
    public static final androidx.compose.ui.text.TextGranularity.Companion Companion;
    ...
    public static final class Companion {
        ...
        public final int getWord-DRrd7Zo() {
            return TextGranularity.access$getWord$cp();
        }
    }
    static {
        TextGranularity.Companion companion = new TextGranularity.Companion(0);
        TextGranularity.Companion = companion;
        TextGranularity.Character = TextGranularity.constructor-impl(0);
        TextGranularity.Word = TextGranularity.constructor-impl(1);
    }

    private TextGranularity(int value) {
        super();
        this.value = value;
    }

    public static final int access$getCharacter$cp() {
        return TextGranularity.Character;
    }

    public static final int access$getWord$cp() {
        return TextGranularity.Word;
    }

    public static final androidx.compose.ui.text.TextGranularity box-impl(int i) {
        TextGranularity textGranularity = new TextGranularity(i);
    ...
    public static boolean equals-impl(int i, Object object2) {
        final int i3 = 0;
        if (!object2 instanceof TextGranularity) {
            return i3;
        }
        if (i != (TextGranularity)object2.unbox-impl()) {
            return i3;
        }
        return 1;
    }
    ...
    public static String toString-impl(int i) {
        ...
        return stringBuilder.append("TextGranularity(value=").append(i).append(')').toString();
    }

    public boolean equals(Object object) {
        return TextGranularity.equals-impl(this.value, object);
    }

    public int hashCode() {
        return TextGranularity.hashCode-impl(this.value);
    }

    public String toString() {
        return TextGranularity.toString-impl(this.value);
    }
