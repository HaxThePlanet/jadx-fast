...
public final class Placeholder {
    ...
    private Placeholder(long width, long height, int placeholderVerticalAlign) {
        ...
        if (TextUnitKt.isUnspecified--R2X_6o(this.width)) {
            ...
            int i = 0;
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException("height cannot be TextUnit.Unspecified".toString());
            throw illegalArgumentException;
        }
        int i2 = 0;
        IllegalArgumentException illegalArgumentException2 = new IllegalArgumentException("width cannot be TextUnit.Unspecified".toString());
