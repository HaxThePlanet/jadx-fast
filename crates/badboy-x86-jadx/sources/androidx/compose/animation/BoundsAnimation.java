...
public final class BoundsAnimation {
    ...
    public final void animate(Rect currentBounds, Rect targetBounds) {
        ...
        androidx.compose.animation.BoundsAnimation.animate.1 anon2;
        androidx.compose.animation.BoundsAnimation.animate.2 anon;
        if (this.transitionScope.isTransitionActive() && getAnimationState() == null) {
            ...
            anon2 = new BoundsAnimation.animate.1(this);
            anon = new BoundsAnimation.animate.2(this, targetBounds, currentBounds);
            setAnimationState(getAnimation().animate((Function1)anon2, (Function1)anon));
        }
    }
