    ...
    public MeasureResult approachMeasure-3p2s80s(ApproachMeasureScope $this$approachMeasure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if (!getSharedElement().getFoundMatch()) {
            ...
            if (currentBounds != null) {
                ...
                int i5 = 0;
                width-impl = IntSize.getWidth-impl(roundToIntSize-uvyYCjk);
                int i6 = 0;
                height-impl = IntSize.getHeight-impl(roundToIntSize-uvyYCjk);
                int i3 = Integer.MAX_VALUE;
                int i7 = 0;
                if (width-impl != i3 && height-impl != i3) {
                    i = height-impl != i3 ? 1 : i7;
                } else {
                }
                if (i == 0) {
                } else {
                    it = Constraints.Companion.fixed-JhjzzOo(RangesKt.coerceAtLeast(width-impl, i7), RangesKt.coerceAtLeast(height-impl, i7));
