...
public final class AnimatedContentKt {
    public static final <S> void AnimatedContent(Transition<S> $this$AnimatedContent, Modifier modifier, Function1<? super androidx.compose.animation.AnimatedContentTransitionScope<S>, androidx.compose.animation.ContentTransform> transitionSpec, Alignment contentAlignment, Function1<? super S, ? extends Object> contentKey, Function4<? super androidx.compose.animation.AnimatedContentScope, ? super S, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i9) {
        ...
        boolean contains;
        int i;
        Object animatedContentMeasurePolicy;
        ...
        if (i9 & i45 != 0) {
            ...
            if (modifier4 & 6 == 0) {
                i21 = restartGroup.changed(empty) ? 4 : 2;
                $dirty |= i21;
            }
        }
        int i46 = i9 & 1;
        ...
        if (i3 != 0) {
            ...
            if (modifier4 & 384 == 0) {
                i14 = restartGroup.changedInstance(transitionSpec) ? 256 : 128;
                $dirty |= i14;
            } else {
                obj2 = transitionSpec;
            }
        ...
        if (currentCompositionLocalMap != null) {
            $dirty |= 3072;
            obj8 = contentAlignment;
        } else {
            if (modifier4 & 3072 == 0) {
                i17 = restartGroup.changed(contentAlignment) ? 2048 : 1024;
                $dirty |= i17;
            } else {
                obj8 = contentAlignment;
            }
        ...
        if ($i$f$cache != 0) {
            ...
            if (modifier4 & 24576 == 0) {
                i19 = restartGroup.changedInstance(contentKey) ? 16384 : 8192;
                $dirty |= i19;
            } else {
                obj6 = contentKey;
            }
        ...
        if ($dirty2 &= i74 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, i74, -1, "androidx.compose.animation.AnimatedContent (AnimatedContent.kt:713)");
                }
                int i48 = 0;
                int i53 = 0;
                ...
                if (i16 == 0) {
                    if (rememberedValue3 == Composer.Companion.getEmpty()) {
                        $i$f$cache = 0;
                        animatedContentTransitionScopeImpl = new AnimatedContentTransitionScopeImpl(empty, obj8, (LayoutDirection)consume);
                ...
                if (empty2 == 0) {
                    ...
                    if (rememberedValue5 == Composer.Companion.getEmpty()) {
                        ...
                        mutableStateListOf = rememberedValue5;
                    }
                } else {
                    obj33 = empty2;
                }
                ...
                if (i15 == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        mutableScatterMapOf = rememberedValue;
                    }
                } else {
                }
                $i$f$cache = mutableScatterMapOf;
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                ...
                if (Intrinsics.areEqual($this$AnimatedContent.getCurrentState(), $this$AnimatedContent.getTargetState())) {
                    ...
                    (AnimatedContentTransitionScopeImpl)animatedContentTransitionScopeImpl.setContentAlignment(obj8);
                ...
                if ($i$f$cache.containsKey($this$AnimatedContent.getTargetState())) {
                    if (!$i$f$cache.containsKey($this$AnimatedContent.getCurrentState())) {
                        ...
                        index$iv = 0;
                        targetState2 = 0;
                        targetState = (List)$this$cache$iv.size();
                        while (targetState2 < targetState) {
                            ...
                            targetState2 = modifier3 + 1;
                            consume = obj30;
                            modifier5 = obj14;
                            targetState = i72;
                            i = $this$fastForEach$iv2;
                            currentCompositeKeyHash = content;
                            modifier4 = $changed;
                        }
                        $this$fastForEach$iv2 = i;
                        modifier3 = targetState2;
                        modifier4 = modifier5;
                        obj30 = consume;
                ...
                if (rememberedValue6 == Composer.Companion.getEmpty()) {
                    obj33 = i29;
                    animatedContentMeasurePolicy = new AnimatedContentMeasurePolicy(animatedContentTransitionScopeImpl);
                    composer7.updateRememberedValue(animatedContentMeasurePolicy);
                } else {
                    animatedContentMeasurePolicy = rememberedValue6;
                }
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                obj2 = 0;
                ...
                int i78 = 0;
                $this$fastForEach$iv2 = factory$iv$iv;
                Updater.set-impl(constructor-impl, (MeasurePolicy)(AnimatedContentMeasurePolicy)animatedContentMeasurePolicy, ComposeUiNode.Companion.getSetMeasurePolicy());
                ...
                while (i18 < empty) {
                    i13 = 0;
                    int i41 = i80;
                    composer3.startMovableGroup(1908315325, obj6.invoke(i41));
                    ComposerKt.sourceInformation(composer3, str);
                    obj12 = $i$f$cache.get(i41);
                    if ((Function2)obj12 == null) {
                    } else {
                    }
                    composer3.startReplaceGroup(1908317105);
                    ComposerKt.sourceInformation(composer3, "815@39722L8");
                    (Function2)obj12.invoke(composer3, 0);
        ...
        if (endRestartGroup != null) {
            traceInProgress = new AnimatedContentKt.AnimatedContent.9($this$AnimatedContent, obj3, obj, obj7, obj11, content, $changed, i9);
    ...
    public static final <S> void AnimatedContent(S targetState, Modifier modifier, Function1<? super androidx.compose.animation.AnimatedContentTransitionScope<S>, androidx.compose.animation.ContentTransform> transitionSpec, Alignment contentAlignment, String label, Function1<? super S, ? extends Object> contentKey, Function4<? super androidx.compose.animation.AnimatedContentScope, ? super S, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i10) {
        ...
        if (str != null) {
            ...
            if (i34 & 384 == 0) {
                i3 = restartGroup.changedInstance(transitionSpec) ? 256 : 128;
                $dirty |= i3;
            } else {
                obj6 = transitionSpec;
            }
        ...
        if (i8 != 0) {
            ...
            if (i34 & 3072 == 0) {
                i = restartGroup.changed(contentAlignment) ? 2048 : 1024;
                $dirty |= i;
            } else {
                contentAlignment2 = contentAlignment;
            }
        ...
        if (i12 != 0) {
            ...
            if (i40 &= i34 == 0) {
                i4 = restartGroup.changedInstance(contentKey) ? 131072 : 65536;
                $dirty |= i4;
            } else {
                obj4 = contentKey;
            }
        ...
        if (i10 & 64 != 0) {
            ...
            if (i34 & i6 == 0) {
                i6 = restartGroup.changedInstance(content) ? 1048576 : 524288;
                $dirty |= i6;
            } else {
                obj8 = content;
            }
        ...
        if ($dirty & i7 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                label3 = i36 != 0 ? "AnimatedContent" : obj;
                if (i12 != 0) {
                    obj4 = iNSTANCE;
                }
                if (ComposerKt.isTraceInProgress()) {
                ...
                obj = obj6;
                i12 = contentAlignment2;
                AnimatedContentKt.AnimatedContent(TransitionKt.updateTransition(obj10, label3, restartGroup, i18 |= i22, 0), modifier2, obj, i12, obj4, obj8, restartGroup, i27 | i8, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj7 = label3;
        ...
        if (endRestartGroup != null) {
            modifier3 = $dirty;
            traceInProgress = new AnimatedContentKt.AnimatedContent.3(obj10, obj5, label2, obj2, obj7, obj3, content, i34, i10);
            endRestartGroup.updateScope((Function2)traceInProgress);
        } else {
            modifier3 = $dirty;
            $dirty2 = obj9;
