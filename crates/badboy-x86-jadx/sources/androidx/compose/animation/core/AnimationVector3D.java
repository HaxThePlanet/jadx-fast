...
public final class AnimationVector3D extends androidx.compose.animation.core.AnimationVector {
    ...
    public androidx.compose.animation.core.AnimationVector3D newVector$animation_core_release() {
        final int i = 0;
        AnimationVector3D animationVector3D = new AnimationVector3D(i, i, i);
    ...
    public String toString() {
        ...
        return stringBuilder.append("AnimationVector3D: v1 = ").append(this.v1).append(", v2 = ").append(this.v2).append(", v3 = ").append(this.v3).toString();
    }
}
