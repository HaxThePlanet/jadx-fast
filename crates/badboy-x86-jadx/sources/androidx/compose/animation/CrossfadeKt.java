...
public final class CrossfadeKt {
    public static final <T> void Crossfade(Transition<T> $this$Crossfade, Modifier modifier, FiniteAnimationSpec<Float> animationSpec, Function1<? super T, ? extends Object> contentKey, Function3<? super T, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i8) {
        ...
        if (i8 & i43 != 0) {
            ...
            if (i57 & 6 == 0) {
                i12 = restartGroup.changed(size) ? 4 : 2;
                $dirty2 |= i12;
            }
        }
        int i44 = i8 & 1;
        ...
        if (str != null) {
            ...
            if (i57 & 384 == 0) {
                i14 = restartGroup.changedInstance(animationSpec) ? 256 : 128;
                $dirty2 |= i14;
            } else {
                obj2 = animationSpec;
            }
        ...
        if (i10 != 0) {
            ...
            if (i57 & 3072 == 0) {
                i = restartGroup.changedInstance(contentKey) ? 2048 : 1024;
                $dirty2 |= i;
            } else {
                i6 = contentKey;
            }
        ...
        if (i68 & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                if (Intrinsics.areEqual(size.getCurrentState(), size.getTargetState())) {
                    ...
                    if ((SnapshotStateList)invalid$iv.size() == index$iv2) {
                        if (!Intrinsics.areEqual(invalid$iv.get(0), size.getTargetState())) {
                            ...
                            index$iv = i68 & 14 == 4 ? index$iv2 : 0;
                            next = restartGroup;
                            $i$a$CacheCrossfadeKt$Crossfade$contentMap$1 = 0;
                            index$iv2 = next.rememberedValue();
                            i3 = 0;
                            if (index$iv == 0) {
                                obj40 = modifier2;
                                if (index$iv2 == Composer.Companion.getEmpty()) {
                                    obj38 = modifier3;
                ...
                if (!invalid$iv2.contains(size.getTargetState())) {
                    ...
                    equal2 = 0;
                    index$iv2 = 0;
                    while (index$iv2 < (List)invalid$iv.size()) {
                        i3 = 0;
                        Object $this$fastForEach$iv3 = obj36;
                        CrossfadeKt.Crossfade.5.1 currentlyVisible = new CrossfadeKt.Crossfade.5.1(size, obj2, $this$fastForEach$iv3, rememberBoxMeasurePolicy);
                ...
                while ($i$a$LayoutBoxKt$Box$1$iv < size) {
                    ...
                    $changed2.startMovableGroup(-1081873445, i6.invoke($this$fastForEach$iv2));
                    ComposerKt.sourceInformation($changed2, str);
                    obj5 = invalid$iv2.get($this$fastForEach$iv2);
                    if ((Function2)obj5 == null) {
                    } else {
                    }
                    $changed2.startReplaceGroup(-1081871785);
                    ComposerKt.sourceInformation($changed2, "140@5906L8");
                    (Function2)obj5.invoke($changed2, 0);
                    $changed2.endReplaceGroup();
                    $changed2.endMovableGroup();
                    $i$a$LayoutBoxKt$Box$1$iv = i20 + 1;
                    size = it;
        ...
        if (endRestartGroup != null) {
            traceInProgress = new CrossfadeKt.Crossfade.7($this$Crossfade, obj3, obj, obj6, content, i57, i8);
    ...
    public static final <T> void Crossfade(T targetState, Modifier modifier, FiniteAnimationSpec<Float> animationSpec, String label, Function3<? super T, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i8) {
        ...
        if (str != null) {
            ...
            if (i23 & 3072 == 0) {
                i7 = restartGroup.changed(label) ? 2048 : 1024;
                $dirty |= i7;
            } else {
                obj2 = label;
            }
        ...
        if (i8 & 16 != 0) {
            ...
            if (i23 & 24576 == 0) {
                i2 = restartGroup.changedInstance(content) ? 16384 : 8192;
                $dirty |= i2;
            } else {
                obj3 = content;
            }
        ...
        if (i29 & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                label2 = str != null ? "Crossfade" : obj2;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, i29, -1, "androidx.compose.animation.Crossfade (Crossfade.kt:55)");
                }
                str = modifier2;
                obj2 = animationSpec2;
                CrossfadeKt.Crossfade(TransitionKt.updateTransition(obj7, label2, restartGroup, i11 |= i27, i16), str, obj2, 0, obj3, restartGroup, i14 | i19, 4);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj4 = label2;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new CrossfadeKt.Crossfade.1(obj7, obj, obj5, obj4, content, i23, i8);
    ...
    public static final void Crossfade(Object targetState, Modifier modifier, FiniteAnimationSpec animationSpec, Function3 content, Composer $composer, int $changed, int i7) {
        ...
        if (transition != 0) {
            ...
            if (i24 & 384 == 0) {
                i5 = restartGroup.changedInstance(animationSpec) ? 256 : 128;
                $dirty |= i5;
            } else {
                obj4 = animationSpec;
            }
        ...
        if (i26 & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                ...
                obj4 = $dirty2;
                CrossfadeKt.Crossfade(TransitionKt.updateTransition(targetState, i16, restartGroup, i10 |= tween$default, i20), obj4, i2, 0, obj2, restartGroup, i13 | i19, 4);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj3 = obj4;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new CrossfadeKt.Crossfade.2(targetState, obj3, obj, content, i24, i7);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
}
