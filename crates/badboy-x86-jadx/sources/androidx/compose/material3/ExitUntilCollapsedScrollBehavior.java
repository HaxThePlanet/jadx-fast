...
final class ExitUntilCollapsedScrollBehavior implements androidx.compose.material3.TopAppBarScrollBehavior {
    ...
    public ExitUntilCollapsedScrollBehavior(androidx.compose.material3.TopAppBarState state, AnimationSpec<Float> snapAnimationSpec, DecayAnimationSpec<Float> flingAnimationSpec, Function0<Boolean> canScroll) {
        super();
        this.state = state;
        this.snapAnimationSpec = snapAnimationSpec;
        this.flingAnimationSpec = flingAnimationSpec;
        this.canScroll = canScroll;
        ExitUntilCollapsedScrollBehavior.nestedScrollConnection.1 anon = new ExitUntilCollapsedScrollBehavior.nestedScrollConnection.1(this);
        this.nestedScrollConnection = (NestedScrollConnection)anon;
    }

    public ExitUntilCollapsedScrollBehavior(androidx.compose.material3.TopAppBarState topAppBarState, AnimationSpec animationSpec2, DecayAnimationSpec decayAnimationSpec3, Function0 function04, int i5, DefaultConstructorMarker defaultConstructorMarker6) {
        androidx.compose.material3.ExitUntilCollapsedScrollBehavior.1 obj4;
        if (i5 &= 8 != 0) {
            obj4 = ExitUntilCollapsedScrollBehavior.1.INSTANCE;
        }
