...
final class FloatingActionButtonElevationAnimatable {
    ...
    public static final Object access$snapElevation(androidx.compose.material3.FloatingActionButtonElevationAnimatable $this, Continuation $completion) {
    ...
    private final Object snapElevation(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof FloatingActionButtonElevationAnimatable.snapElevation.1 && label &= th2 != 0) {
            anon = continuation;
            th2 = Integer.MIN_VALUE;
            if (label &= th2 != 0) {
                anon.label = obj9 -= th2;
        ...
        switch (targetInteraction2) {
            case 0:
                ResultKt.throwOnFailure(obj9);
                targetInteraction2 = this;
                targetInteraction = targetInteraction2.calculateTarget-u2uoSUM(targetInteraction2.targetInteraction);
                anon.L$0 = targetInteraction2;
                anon.label = 1;
                return cOROUTINE_SUSPENDED;
                cOROUTINE_SUSPENDED = targetInteraction2;
    ...
    public final Object animateElevation(Interaction interaction, Continuation<? super Unit> continuation2) {
        ...
        if (continuation2 instanceof FloatingActionButtonElevationAnimatable.animateElevation.1 && label2 &= th != 0) {
            anon = continuation2;
            th = Integer.MIN_VALUE;
            if (label2 &= th != 0) {
                anon.label = obj10 -= th;
        ...
        switch (label) {
            case 0:
                ...
                label = this;
                target-u2uoSUM = label.calculateTarget-u2uoSUM(interaction);
