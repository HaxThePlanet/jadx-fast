...
public final class KeylinesKt {
    ...
    public static final androidx.compose.material3.carousel.KeylineList uncontainedKeylineList(Density density, float carouselMainAxisSize, float itemSize, float itemSpacing) {
        ...
        int i9 = 0;
        int i11 = 1;
        i = Float.compare(carouselMainAxisSize, i3) == 0 ? i11 : i9;
        if (i == 0) {
            i = Float.compare(itemSize, i3) == 0 ? i11 : i9;
            if (i != 0) {
            } else {
                ...
                i2 = Float.compare(i8, i3) > 0 ? i11 : i9;
            }
            int i10 = 0;
            ...
            Arrangement arrangement = new Arrangement(0, 0, 0, mediumChildSize, i2, f5, i17);
