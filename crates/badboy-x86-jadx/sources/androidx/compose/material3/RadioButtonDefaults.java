...
public final class RadioButtonDefaults {
    ...
    public final androidx.compose.material3.RadioButtonColors colors-ro_MJ88(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor, Composer $composer, int $changed, int i7) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return getDefaultRadioButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).copy-jRlVdoo(l4, obj6, l3, obj8);
    }
    ...
    public final androidx.compose.material3.RadioButtonColors getDefaultRadioButtonColors$material3_release(androidx.compose.material3.ColorScheme $this$defaultRadioButtonColors) {
        ...
        if (colorScheme.getDefaultRadioButtonColorsCached$material3_release() == null) {
            i = 0;
            i8 = 0;
            radioButtonColors = new RadioButtonColors(ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getSelectedIconColor()), obj4, ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getUnselectedIconColor()), obj6, Color.copy-wmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getDisabledSelectedIconColor()), obj8, 1052938076, i, 0, i8, 14), obj8, Color.copy-wmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getDisabledUnselectedIconColor()), i, 1052938076, i8, 0, 0, 14), i, 0);
            i7 = 0;
