...
public final class SnackbarKt {
    ...
    private static final void NewLineButtonSnackbar-kKq0p4A(Function2<? super Composer, ? super Integer, Unit> text, Function2<? super Composer, ? super Integer, Unit> action, Function2<? super Composer, ? super Integer, Unit> dismissAction, TextStyle actionTextStyle, long actionContentColor, long dismissActionContentColor, Composer $composer, int $changed) {
        ...
        if (i33 & 6 == 0) {
            i28 = restartGroup.changedInstance(obj) ? 4 : 2;
            $dirty |= i28;
        }
        if (i33 & 48 == 0) {
            i19 = restartGroup.changedInstance(obj2) ? 32 : 16;
            $dirty |= i19;
        }
        if (i33 & 384 == 0) {
            i20 = restartGroup.changedInstance(obj3) ? 256 : 128;
            $dirty |= i20;
        }
        if (i33 & 3072 == 0) {
        ...
        if (i33 & 24576 == 0) {
            i15 = restartGroup.changed(actionContentColor) ? 16384 : 8192;
            $dirty |= i15;
        } else {
            l = actionContentColor;
        }
        if (i66 &= i33 == 0) {
            i35 = restartGroup.changed($composer) ? 131072 : 65536;
            $dirty |= i35;
        } else {
        ...
        if ($dirty2 &= i95 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (!composer18.getInserting()) {
                    localMap$iv$iv4 = currentCompositionLocalMap2;
                ...
                i22 = i65;
                $i$a$LayoutRowKt$Row$1$iv = composer;
    ...
    private static final void OneRowSnackbar-kKq0p4A(Function2<? super Composer, ? super Integer, Unit> text, Function2<? super Composer, ? super Integer, Unit> action, Function2<? super Composer, ? super Integer, Unit> dismissAction, TextStyle actionTextStyle, long actionTextColor, long dismissActionColor, Composer $composer, int $changed) {
        ...
        traceInProgress2 = -903235475;
        restartGroup = obj63.startRestartGroup(traceInProgress2);
        ...
        if ($i$a$LayoutBoxKt$Box$1$iv2 & 6 == 0) {
            i3 = restartGroup.changedInstance(str2) ? 4 : 2;
            $dirty |= i3;
        }
        if ($i$a$LayoutBoxKt$Box$1$iv2 & 48 == 0) {
            i21 = restartGroup.changedInstance(materialized$iv$iv) ? 32 : 16;
            $dirty |= i21;
        }
        if ($i$a$LayoutBoxKt$Box$1$iv2 & 384 == 0) {
            i18 = restartGroup.changedInstance(obj) ? 256 : 128;
            $dirty |= i18;
        }
        if ($i$a$LayoutBoxKt$Box$1$iv2 & 3072 == 0) {
            i17 = restartGroup.changed(valueOf) ? 2048 : 1024;
            $dirty |= i17;
        }
        if ($i$a$LayoutBoxKt$Box$1$iv2 & 24576 == 0) {
            i = restartGroup.changed(actionTextColor) ? 16384 : 8192;
            $dirty |= i;
        } else {
        ...
        if ($dirty2 &= i72 == 74898) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, i72, -1, "androidx.compose.material3.OneRowSnackbar (Snackbar.kt:308)");
                }
                String str5 = "text";
                skipping = "action";
                str3 = "dismissAction";
                ...
                if (it$iv2 == Composer.Companion.getEmpty()) {
                    empty = 0;
                    it$iv = it$iv2;
                    it$iv2 = new SnackbarKt.OneRowSnackbar.2.1(skipping, str3, str5);
                ...
                int $changed$iv5 = 0;
                i10 = i56;
                maybeCachedBoxMeasurePolicy3 = BoxKt.maybeCachedBoxMeasurePolicy(topStart2, $changed$iv5);
                i2 = 0;
                ...
                Updater.set-impl(constructor-impl, maybeCachedBoxMeasurePolicy3, ComposeUiNode.Companion.getSetMeasurePolicy());
                ...
                if (materialized$iv$iv != null) {
                    ...
                    composer5 = i37;
                    composer4 = i51;
                    $i$a$LayoutBoxKt$Box$1$iv = i5;
                    ComposerKt.sourceInformationMarkerStart($i$a$LayoutBoxKt$Box$1$iv, 1309057900, "C317@13446L221:Snackbar.kt#uh7d8r");
                    str2 = new ProvidedValue[2];
                    obj63 = materializeModifier3;
                    str2[$i$a$LayoutSnackbarKt$OneRowSnackbar$1] = TextKt.getLocalTextStyle().provides(valueOf);
                    CompositionLocalKt.CompositionLocalProvider(str2, materialized$iv$iv, $i$a$LayoutBoxKt$Box$1$iv, $stable2 |= $i$a$LayoutBoxKt$Box$1$iv2);
                ...
                Modifier layoutId = LayoutIdKt.layoutId((Modifier)Modifier.Companion, str3);
                valueOf2 = 6;
                ...
                if (obj != null && !applier2 instanceof Applier) {
                    layoutId = LayoutIdKt.layoutId((Modifier)Modifier.Companion, str3);
                    valueOf2 = 6;
                    $i$a$LayoutBoxKt$Box$1$iv = 0;
                    ComposerKt.sourceInformationMarkerStart(composer2, 733328855, restartGroup);
                    i20 = 0;
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new SnackbarKt.OneRowSnackbar.3(text, action, obj, actionTextStyle, actionTextColor, str3, $composer, composer2, obj64);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    public static final void Snackbar-eQBnUkQ(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> action, Function2<? super Composer, ? super Integer, Unit> dismissAction, boolean actionOnNewLine, Shape shape, long containerColor, long contentColor, long actionContentColor, long dismissActionContentColor, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i13) {
        ...
        if (i40 != 0) {
            ...
            if (i53 & 384 == 0) {
                i8 = restartGroup.changedInstance(dismissAction) ? 256 : 128;
                $dirty5 |= i8;
            } else {
                str = dismissAction;
            }
        ...
        if (i43 != 0) {
            ...
            if (i53 & 3072 == 0) {
                i9 = restartGroup.changed(actionOnNewLine) ? 2048 : 1024;
                $dirty5 |= i9;
            } else {
                function2 = actionOnNewLine;
            }
        ...
        if (i49 &= i53 == 0) {
            if (traceInProgress2 & 32 == 0) {
                changed5 = restartGroup.changed(containerColor) ? 131072 : 65536;
            } else {
                l3 = containerColor;
            }
            $dirty5 |= changed5;
        ...
        if (i53 & i54 == 0) {
            if (traceInProgress2 & 64 == 0) {
                $dirty = $dirty5;
                obj39 = i28;
                changed = restartGroup.changed(actionContentColor) ? 1048576 : 524288;
            } else {
                $dirty = $dirty5;
                obj39 = i28;
                $dirty4 = actionContentColor;
            }
            $dirty |= changed;
        } else {
            $dirty2 = $dirty5;
        ...
        if (i53 & i57 == 0) {
            if (traceInProgress2 & 128 == 0) {
                i4 = restartGroup.changed(content) ? 8388608 : 4194304;
            } else {
                l = content;
            }
            $dirty2 |= i4;
        ...
        if (i11 &= i53 == 0) {
            if (traceInProgress2 & 256 == 0) {
                i3 = restartGroup.changed($changed) ? 67108864 : 33554432;
            } else {
                l4 = $changed;
            }
            $dirty2 |= i3;
        ...
        if (traceInProgress2 & 512 != 0) {
            ...
            if (i53 & i2 == 0) {
                i2 = restartGroup.changedInstance(obj38) ? 536870912 : 268435456;
                $dirty2 |= i2;
            } else {
                obj6 = obj38;
            }
        }
        if ($dirty2 & i59 == 306783378) {
            if (!restartGroup.getSkipping()) {
                ...
                if (i53 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (traceInProgress2 & 32 != 0) {
                            containerColor2 = SnackbarDefaults.INSTANCE.getColor(restartGroup, str);
                            $dirty2 &= i;
                        } else {
                            containerColor2 = l3;
                        }
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-1235788955, i6, -1, "androidx.compose.material3.Snackbar (Snackbar.kt:113)");
                }
                obj28 = obj38;
                obj27 = action2;
                ...
                obj25 = modifier2;
                obj35 = restartGroup;
                SurfaceKt.Surface-T9BRK9s(obj25, shape3, containerColor2, obj28, contentColor2, obj30, 0, SnackbarTokens.INSTANCE.getContainerElevation-D9Ej5fM(), 0, (Function2)ComposableLambdaKt.rememberComposableLambda(-1829663446, true, obj25, restartGroup, 54), obj35);
                obj5 = obj25;
                composer = obj35;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                ...
                actionContentColor3 = i6;
                $dirty3 = dismissAction2;
                dismissAction3 = containerColor2;
                containerColor3 = l2;
            } else {
                restartGroup.skipToGroupEnd();
                ...
                obj = obj4;
                dismissAction3 = l3;
                actionContentColor3 = $dirty2;
                shape2 = actionContentColor;
                containerColor3 = content;
        ...
        if (endRestartGroup != null) {
            endRestartGroup = new SnackbarKt.Snackbar.2(obj5, $composer2, $dirty3, z, obj, dismissAction3, obj3, shape2, str, containerColor3, function2, contentColor3, l3, obj38, i53, obj41);
    ...
    public static final void Snackbar-sDKtq54(androidx.compose.material3.SnackbarData snackbarData, Modifier modifier, boolean actionOnNewLine, Shape shape, long containerColor, long contentColor, long actionColor, long actionContentColor, long dismissActionContentColor, Composer $composer, int $changed, int i12) {
        ...
        Object actionColor3;
        int i8;
        androidx.compose.material3.SnackbarDefaults iNSTANCE2;
        long l9;
        ...
        if (i64 &= i67 == 0) {
            if (i11 & 64 == 0) {
                $dirty = $dirty4;
                obj48 = i25;
                changed6 = restartGroup.changed(dismissActionContentColor) ? 1048576 : 524288;
            } else {
                $dirty = $dirty4;
                obj48 = i25;
                $dirty3 = dismissActionContentColor;
            }
            $dirty |= changed6;
        } else {
            $dirty2 = $dirty4;
        ...
        if (i13 &= i67 == 0) {
            if (i11 & 256 == 0) {
                i10 = restartGroup.changed(obj46) ? 67108864 : 33554432;
            } else {
                l = obj46;
            }
            $dirty2 |= i10;
        ...
        if (i14 &= $dirty2 == 38347922) {
            if (!restartGroup.getSkipping()) {
                ...
                if (i67 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (i11 & 256 != 0) {
                            $dirty2 = i24;
                            l13 = actionColor2;
                            l7 = actionContentColor3;
                            l2 = dismissActionContentColor2;
                            z2 = actionOnNewLine2;
                ...
                if (actionOnNewLine2 != null) {
                    SnackbarKt.Snackbar.actionComposable.1 anon3 = new SnackbarKt.Snackbar.actionComposable.1(l13, iNSTANCE2, obj, actionOnNewLine2);
                    i6 = rememberComposableLambda;
                } else {
                    i6 = rememberComposableLambda2;
                }
                ...
                SnackbarKt.Snackbar-eQBnUkQ(PaddingKt.padding-3ABfNKs(modifier2, Dp.constructor-impl((float)i29)), i6, i, z2, actionContentColor2, l10, dismissActionContentColor2, l4, obj24, l7, obj26, l2, obj28);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                l3 = l13;
        ...
        endRestartGroup = composer.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup = new SnackbarKt.Snackbar.4(obj, modifier2, $composer2, actionColor3, l9, actionOnNewLine2, l6, z, l3, rememberComposableLambda, l8, l5, l11, $dirty2, i67, obj50);
            endRestartGroup.updateScope((Function2)endRestartGroup);
        }
    }
