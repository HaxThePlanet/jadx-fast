...
public final class TextFieldImplKt {
    ...
    public static final void CommonDecorationBox(androidx.compose.material3.internal.TextFieldType type, String value, Function2<? super Composer, ? super Integer, Unit> innerTextField, VisualTransformation visualTransformation, Function2<? super Composer, ? super Integer, Unit> label, Function2<? super Composer, ? super Integer, Unit> placeholder, Function2<? super Composer, ? super Integer, Unit> leadingIcon, Function2<? super Composer, ? super Integer, Unit> trailingIcon, Function2<? super Composer, ? super Integer, Unit> prefix, Function2<? super Composer, ? super Integer, Unit> suffix, Function2<? super Composer, ? super Integer, Unit> supportingText, boolean singleLine, boolean enabled, boolean isError, InteractionSource interactionSource, PaddingValues contentPadding, TextFieldColors colors, Function2<? super Composer, ? super Integer, Unit> container, Composer $composer, int $changed, int $changed1, int i22) {
        ...
        traceInProgress7 = contentPadding;
        labelSize = colors;
        obj7 = container;
        int i66 = $changed;
        int i142 = $changed1;
        ...
        if (i23 & 1 != 0) {
            ...
            if (i66 & 6 == 0) {
                i54 = restartGroup.changed(type) ? 4 : 2;
                $dirty3 |= i54;
            } else {
                obj10 = type;
            }
        ...
        if (i23 & 2 != 0) {
            ...
            if (i66 & 48 == 0) {
                i32 = restartGroup.changed(value) ? 32 : 16;
                $dirty3 |= i32;
            } else {
                str = value;
            }
        ...
        if (i23 & 4 != 0) {
            ...
            if (i66 & 384 == 0) {
                i47 = restartGroup.changedInstance(innerTextField) ? 256 : 128;
                $dirty3 |= i47;
            } else {
                obj8 = innerTextField;
            }
        ...
        if (i23 & 8 != 0) {
            ...
            if (i66 & 3072 == 0) {
                i14 = restartGroup.changed(decoratedPrefix2) ? 2048 : 1024;
                $dirty3 |= i14;
            }
        }
        if (i23 & 16 != 0) {
            ...
            if (i66 & 24576 == 0) {
                i18 = restartGroup.changedInstance(label) ? 16384 : 8192;
                $dirty3 |= i18;
            }
        }
        int i277 = i23 & 32;
        ...
        if (i277 != 0) {
            ...
            if (i66 & i48 == 0) {
                i48 = restartGroup.changedInstance(placeholder) ? 131072 : 65536;
                $dirty3 |= i48;
            } else {
                obj2 = placeholder;
            }
        ...
        if (prefix2 != 0) {
            ...
            if ($changed & i8 == 0) {
                i8 = restartGroup.changedInstance(leadingIcon) ? 1048576 : 524288;
                $dirty3 |= i8;
            } else {
                obj4 = leadingIcon;
            }
        ...
        if (i67 != 0) {
            ...
            if ($changed & i278 == 0) {
                suffix2 = i67;
                i40 = restartGroup.changedInstance(trailingIcon) ? 8388608 : 4194304;
                $dirty3 |= i40;
            } else {
                suffix2 = i67;
                obj6 = trailingIcon;
        ...
        if (i68 != 0) {
            $dirty3 |= i281;
            traceInProgress5 = i68;
            obj3 = prefix;
        } else {
            if ($changed & i281 == 0) {
                traceInProgress5 = i68;
                i5 = restartGroup.changedInstance(prefix) ? 67108864 : 33554432;
                $dirty3 |= i5;
            } else {
                traceInProgress5 = i68;
                obj3 = prefix;
        ...
        if (i69 != 0) {
            ...
            if ($changed & i283 == 0) {
                decoratedPlaceholder = i69;
                i35 = restartGroup.changedInstance(suffix) ? 536870912 : 268435456;
                $dirty3 |= i35;
            } else {
                decoratedPlaceholder = i69;
                obj5 = suffix;
        ...
        if (i70 != 0) {
            ...
            if (i142 & 6 == 0) {
                decoratedLeading = i70;
                i21 = restartGroup.changedInstance(supportingText) ? 4 : 2;
                $dirty1 |= i21;
            } else {
                decoratedLeading = i70;
                obj9 = supportingText;
        ...
        if (i71 != 0) {
            ...
            if (i142 & 48 == 0) {
                i17 = i71;
                i25 = restartGroup.changed(singleLine) ? 32 : 16;
                $dirty1 |= i25;
            } else {
                i17 = i71;
                z3 = singleLine;
        ...
        if (i74 != 0) {
            ...
            i27 = i74;
            if (i142 & 3072 == 0) {
                i24 = restartGroup.changed(isError) ? 2048 : 1024;
                $dirty1 |= i24;
            } else {
                z = isError;
            }
        ...
        if (i23 & 16384 != 0) {
            ...
            if (i142 & 24576 == 0) {
                i34 = restartGroup.changed(obj14) ? 16384 : 8192;
                $dirty1 |= i34;
            }
        }
        if (i75 &= i23 != 0) {
        ...
        if ($dirty13 &= $dirty3 == 306783378 && i141 &= iNSTANCE == 4793490) {
            if (i141 &= iNSTANCE == 4793490) {
                if (!restartGroup.getSkipping()) {
                    placeholder3 = i277 != 0 ? 0 : placeholder;
                    leadingIcon2 = prefix2 != 0 ? 0 : leadingIcon;
                    trailingIcon3 = suffix2 != 0 ? 0 : trailingIcon;
                    prefix2 = traceInProgress5 != 0 ? 0 : prefix;
                    suffix2 = decoratedPlaceholder != 0 ? 0 : suffix;
                    i33 = decoratedLeading != 0 ? traceInProgress5 : supportingText;
                    i24 = i17 != 0 ? traceInProgress5 : singleLine;
                    if (i43 != 0) {
                        obj97 = placeholder3;
                        placeholder4 = traceInProgress5;
                    } else {
                        obj97 = placeholder3;
                        placeholder4 = enabled;
                    }
                    i4 = i27 != 0 ? traceInProgress5 : isError;
                    ...
                    i45 = iNSTANCE;
                    obj92 = 0;
                    i29 = $dirty3 & 112 == 32 ? 1 : obj92;
                    i28 = $dirty3 & 7168 == 2048 ? 1 : obj92;
                    ...
                    if (booleanValue) {
                        ...
                        i13 = (CharSequence)text2.length() == 0 ? 1 : obj92;
                        unfocusedNotEmpty = i13 != 0 ? InputPhase.UnfocusedEmpty : InputPhase.UnfocusedNotEmpty;
                    }
                    int i94 = 6;
                    ...
                    int i288 = i94;
                    l = labelColor-XeAY9LY$material3_release;
                    if (Color.equals-impl0(bodyLarge5.getColor-0d7_KjU(), placeholder4)) {
                        if (Color.equals-impl0(bodySmall.getColor-0d7_KjU(), placeholder4)) {
                            if (!Color.equals-impl0(bodyLarge5.getColor-0d7_KjU(), placeholder4) && Color.equals-impl0(bodySmall.getColor-0d7_KjU(), placeholder4)) {
                                i10 = Color.equals-impl0(bodySmall.getColor-0d7_KjU(), placeholder4) ? 1 : obj92;
                            } else {
                            }
                        } else {
                        }
                    ...
                    int i99 = 0;
                    if (i10 != 0) {
                        companion = $this$CommonDecorationBox_u24lambda_u242;
                        i41 = 0;
                        $this$isSpecified$iv$iv2 = 0;
                        $this$isSpecified$iv$iv = Long.compare(l11, i315) != 0 ? 1 : obj92;
                        if ($this$isSpecified$iv$iv != 0) {
                            $this$CommonDecorationBox_u24lambda_u242 = companion;
                        } else {
                            $this$isSpecified$iv$iv = 0;
                            $this$CommonDecorationBox_u24lambda_u242 = l;
                        }
                    }
                    int i100 = 0;
                    if (i10 != 0) {
                        i41 = $this$CommonDecorationBox_u24lambda_u244;
                        borderContainerWithId = 0;
                        i56 = 0;
                        $this$isSpecified$iv$iv2 = Long.compare(l12, i325) != 0 ? 1 : obj92;
                        if ($this$isSpecified$iv$iv2 != 0) {
                            $this$CommonDecorationBox_u24lambda_u244 = i41;
                        } else {
                            $this$isSpecified$iv$iv2 = 0;
                            $this$CommonDecorationBox_u24lambda_u244 = l;
                        }
                    }
                    i7 = label != null ? 1 : obj92;
                    l5 = $this$CommonDecorationBox_u24lambda_u244;
                    i49 = obj92;
                    i2 = 0;
                    ...
                    int i313 = 0;
                    obj85 = valueOf5;
                    $composer$iv5.startReplaceGroup(1128033978);
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ...
                        companion2 = $this$animateColor$iv$iv;
                    ...
                    int i251 = 1;
                    l6 = TextFieldImplKt.WhenMappings.$EnumSwitchMapping$1[(InputPhase)$this$animateColor$iv$iv.getTargetState().ordinal()] == i251 ? focusedLabelTextStyleColor$iv : l5;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    ...
                    invalid$iv$iv$iv2 = composer6.changed(colorSpace-impl);
                    Composer composer8 = composer6;
                    int i305 = 0;
                    rememberedValue3 = composer8.rememberedValue();
                    int i314 = 0;
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer6);
                    i216 |= i257;
                    $this$animateValue$iv$iv$iv = companion2;
                    int i306 = 0;
                    obj88 = rememberedValue3;
                    ...
                    it$iv = obj85;
                    it$iv.startReplaceGroup($changed$iv$iv$iv4);
                    ComposerKt.sourceInformation(it$iv, str6);
                    if (ComposerKt.isTraceInProgress()) {
                        $composer$iv2 = it$iv;
                    ...
                    int i258 = 1;
                    l4 = TextFieldImplKt.WhenMappings.$EnumSwitchMapping$1[(InputPhase)$this$animateValue$iv$iv$iv.getCurrentState().ordinal()] == i258 ? focusedLabelTextStyleColor$iv : l5;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    ...
                    $composer$iv6.startReplaceGroup(initialValue$iv$iv$iv4);
                    ComposerKt.sourceInformation($composer$iv6, str6);
                    if (ComposerKt.isTraceInProgress()) {
                        obj84 = it$iv3;
                        obj87 = $composer$iv6;
                    ...
                    l10 = TextFieldImplKt.WhenMappings.$EnumSwitchMapping$1[obj84.ordinal()] == 1 ? focusedLabelTextStyleColor$iv : l5;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    obj87.endReplaceGroup();
                    ...
                    androidx.compose.ui.graphics.colorspace.ColorSpace colorSpace-impl2 = Color.getColorSpace-impl(l);
                    ComposerKt.sourceInformationMarkerStart(composer6, 1918408083, "CC(remember):Transition.kt#9igjgp");
                    invalid$iv$iv$iv = composer6.changed(colorSpace-impl2);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer6);
                    i228 |= i269;
                    $this$animateValue$iv$iv$iv2 = $this$isSpecified$iv$iv;
                    int i298 = 0;
                    obj88 = rememberedValue2;
                    ...
                    enabled2 = i329;
                    long placeholderColor-XeAY9LY$material3_release = labelSize.placeholderColor-XeAY9LY$material3_release(enabled2, i4, booleanValue);
                    ComposerKt.sourceInformationMarkerStart(composer7, -156971732, str2);
                    bodyLarge3 = composer7;
                    int i286 = 0;
                    rememberedValue4 = bodyLarge3.rememberedValue();
                    int i308 = 0;
                    obj84 = i125;
                    if (rememberedValue4 == Composer.Companion.getEmpty()) {
                        ...
                        bodyLarge3.updateRememberedValue(SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), (Function0)$i$a$CacheTextFieldImplKt$CommonDecorationBox$3$showPlaceholder$2));
                    } else {
                        obj86 = rememberedValue4;
                    }
                    ...
                    if (obj97 != null) {
                        ...
                        if (placeholderAlpha != 0 && TextFieldImplKt.CommonDecorationBox$lambda$15$lambda$7((State)rememberedValue4)) {
                            if (TextFieldImplKt.CommonDecorationBox$lambda$15$lambda$7(rememberedValue4)) {
                                obj88 = obj85;
                                obj89 = obj97;
                                obj84 = anon7;
                                obj85 = state7;
                                ...
                                obj92 = rememberedValue4;
                                obj97 = state7;
                                l2 = placeholderColor-XeAY9LY$material3_release;
                    ...
                    composer7.endReplaceGroup();
                    long prefixColor-XeAY9LY$material3_release = labelSize.prefixColor-XeAY9LY$material3_release(enabled2, i4, booleanValue);
                    ComposerKt.sourceInformationMarkerStart(composer7, -156946547, str2);
                    bodyLarge = composer7;
                    int i270 = 0;
                    decoratedLeading = showPlaceholder$delegate;
                    rememberedValue = bodyLarge.rememberedValue();
                    int i309 = 0;
                    obj84 = i128;
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        bodyLarge.updateRememberedValue(SnapshotStateKt.derivedStateOf(SnapshotStateKt.structuralEqualityPolicy(), (Function0)$i$a$CacheTextFieldImplKt$CommonDecorationBox$3$showPrefixSuffix$2));
                    } else {
                        obj86 = rememberedValue;
                        obj88 = i270;
                    ...
                    if (prefix2 != 0 && TextFieldImplKt.CommonDecorationBox$lambda$15$lambda$9((State)rememberedValue)) {
                        if (TextFieldImplKt.CommonDecorationBox$lambda$15$lambda$9(rememberedValue)) {
                            obj88 = obj85;
                            obj89 = prefix2;
                            ...
                            l3 = obj86;
                            i53 = obj89;
                            showPrefixSuffix$delegate = rememberedValue;
                            obj85 = textStyle;
                            ...
                            obj84 = $i$a$LetTextFieldImplKt$CommonDecorationBox$3$decoratedTrailing$1;
                            i53 = prefix2;
                            l3 = prefixColor-XeAY9LY$material3_release;
                            decoratedPrefix = 0;
                        }
                    } else {
                    }
                    composer7.endReplaceGroup();
                    long suffixColor-XeAY9LY$material3_release = labelSize.suffixColor-XeAY9LY$material3_release(enabled2, i4, booleanValue);
                    ...
                    if (suffix2 != 0 && TextFieldImplKt.CommonDecorationBox$lambda$15$lambda$9(showPrefixSuffix$delegate)) {
                        if (TextFieldImplKt.CommonDecorationBox$lambda$15$lambda$9(showPrefixSuffix$delegate)) {
                            ...
                            i27 = rememberComposableLambda2;
                        } else {
                            bodyLarge4 = obj85;
                            i6 = suffix2;
                            l8 = suffixColor-XeAY9LY$material3_release;
                            obj85 = obj84;
                            obj84 = decoratedPrefix;
                            i27 = 0;
                        }
                    ...
                    composer7.endReplaceGroup();
                    long leadingIconColor-XeAY9LY$material3_release = labelSize.leadingIconColor-XeAY9LY$material3_release(enabled2, i4, booleanValue);
                    ...
                    long trailingIconColor-XeAY9LY$material3_release = labelSize.trailingIconColor-XeAY9LY$material3_release(enabled2, i4, booleanValue);
                    composer7.startReplaceGroup(-156893937);
                    ComposerKt.sourceInformation(composer7, "*211@8937L62");
                    if (trailingIcon3 == 0) {
                        l7 = trailingIconColor-XeAY9LY$material3_release;
                        trailingIconColor = 0;
                    } else {
                        int i184 = trailingIcon3;
                        obj89 = i272;
                    ...
                    decoratedPrefix2 = labelSize.supportingTextColor-XeAY9LY$material3_release(enabled2, i4, booleanValue);
                    ...
                    if (i33 == 0) {
                        ...
                        TextFieldImplKt.CommonDecorationBox.3.decoratedSupporting.1.1 anon3 = new TextFieldImplKt.CommonDecorationBox.3.decoratedSupporting.1.1(decoratedPrefix2, rememberComposableLambda2, labelTextStyleColor, i33);
                        i16 = enabled2;
                        l9 = decoratedPrefix2;
                    ...
                    switch (i63) {
                        case 1:
                            ...
                            TextFieldImplKt.CommonDecorationBox.3.containerWithId.1 anon5 = new TextFieldImplKt.CommonDecorationBox.3.containerWithId.1(obj7);
                            traceInProgress5 = decoratedPlaceholder;
                            int decoratedLabel = decoratedLeading;
                            TextFieldKt.TextFieldLayout((Modifier)Modifier.Companion, innerTextField, traceInProgress5, decoratedLabel, obj86, obj89, obj84, i27, i24, f, (Function2)ComposableLambdaKt.rememberComposableLambda(1750327932, true, anon5, composer, 54), borderContainerWithId, contentPadding, composer, i137 | str3, rememberComposableLambda2 | 6);
                            decoratedLeading = decoratedLabel;
                            decoratedPlaceholder = traceInProgress5;
                        ...
                        case 2:
                            ...
                            invalid$iv2 = obj;
                            ComposerKt.sourceInformationMarkerEnd(composer7);
                            TextFieldImplKt.CommonDecorationBox.3.borderContainerWithId.1 anon4 = new TextFieldImplKt.CommonDecorationBox.3.borderContainerWithId.1((MutableState)invalid$iv2, traceInProgress7, obj7);
                            ...
                            obj90 = i62;
                            $i$a$CacheTextFieldImplKt$CommonDecorationBox$3$1 = new TextFieldImplKt.CommonDecorationBox.3.1.1(f2, invalid$iv2);
                            composer5.updateRememberedValue((Function1)$i$a$CacheTextFieldImplKt$CommonDecorationBox$3$1);
                            ComposerKt.sourceInformationMarkerEnd(composer7);
                            i43 = obj84;
                            i17 = obj89;
                            i56 = composer7;
                            traceInProgress5 = decoratedLeading;
                            $this$isSpecified$iv$iv2 = borderContainerWithId;
                            androidx.compose.runtime.internal.ComposableLambda decoratedPlaceholder2 = obj86;
                            OutlinedTextFieldKt.OutlinedTextFieldLayout((Modifier)Modifier.Companion, obj8, traceInProgress5, decoratedPlaceholder, decoratedPlaceholder2, i17, i43, i27, i24, f2, (Function1)$i$a$CacheTextFieldImplKt$CommonDecorationBox$3$1, (Function2)ComposableLambdaKt.rememberComposableLambda(157291737, true, anon4, composer7, 54), $this$isSpecified$iv$iv2, contentPadding, i56, i59 | i133, i61 | 48);
                            labelSize = decoratedPlaceholder2;
                            iNSTANCE = i17;
                            decoratedPrefix2 = i43;
                            borderContainerWithId = $this$isSpecified$iv$iv2;
                            decoratedLeading = traceInProgress5;
                            i56.endReplaceGroup();
                    ...
                    i12 = i16;
                    trailingIcon2 = i4;
                    isError2 = placeholder2;
                    endRestartGroup = composer2.endRestartGroup();
                    if (endRestartGroup != null) {
                        endRestartGroup = new TextFieldImplKt.CommonDecorationBox.4(type, value, innerTextField, visualTransformation, label, isError2, i46, $composer2, $dirty, i, i15, i52, i12, trailingIcon2, obj14, contentPadding, colors, obj7, $changed, $changed1, i22);
    ...
    private static final void Decoration-3J-VO9M(long contentColor, TextStyle textStyle, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (i9 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                ProvideContentColorTextStyleKt.ProvideContentColorTextStyle-3J-VO9M(contentColor, obj7, content, obj3, restartGroup);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            } else {
    ...
    private static final void Decoration-Iv8Zu3U(long contentColor, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (obj8 & 6 == 0) {
            i = obj7.changed(contentColor) ? 4 : 2;
            $dirty |= i;
        }
        if (obj8 & 48 == 0) {
            i2 = obj7.changedInstance($composer) ? 32 : 16;
            $dirty |= i2;
        }
        if ($dirty & 19 == 18) {
            if (!obj7.getSkipping()) {
    ...
    private static final void TextFieldTransitionScope-Jy8F4Js(androidx.compose.material3.internal.InputPhase inputState, long focusedLabelTextStyleColor, long unfocusedLabelTextStyleColor, long labelColor, boolean showLabel, Function7<? super State<Float>, ? super State<Color>, ? super State<Color>, ? super State<Float>, ? super State<Float>, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        Object it7;
        int i4;
        Object $this$animateValue$iv$iv7;
        int i2;
        Object it;
        int i3;
        ...
        it7 = $this$animateValue$iv$iv2.getTargetState();
        ...
        int i177 = i15 | i41;
        $this$animateValue$iv$iv7 = transition7;
        int i183 = 0;
        str = str22;
        ...
        if (ComposerKt.isTraceInProgress()) {
            $this$animateValue$iv$iv6 = $this$animateValue$iv$iv7;
            str2 = str;
        ...
        it = $this$animateValue$iv$iv6.getTargetState();
        ...
        it9 = transition3.getCurrentState();
        $composer3 = obj40;
        int i145 = 0;
        ...
        composer.endReplaceGroup();
        initialValue$iv$iv2 = Float.valueOf(i);
        it16 = companion.getTargetState();
        ...
        it8 = transition9.getTargetState();
        $composer4 = obj40;
        int i130 = 0;
        int i147 = -107432127;
        ...
        obj14 = TextFieldImplKt.WhenMappings.$EnumSwitchMapping$1[it2.ordinal()] == 1 ? focusedLabelTextStyleColor : labelColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ...
        changed = composer7.changed(colorSpace-impl);
        ...
        $i$f$cache = invoke;
        ComposerKt.sourceInformationMarkerEnd(composer7);
        $this$animateValue$iv$iv = transition9;
        int i189 = i90;
        companion2 = 0;
        ComposerKt.sourceInformationMarkerStart(composer7, -142660079, str20);
        int i198 = 0;
        ...
        int i92 = 1;
        obj5 = TextFieldImplKt.WhenMappings.$EnumSwitchMapping$1[(InputPhase)$this$animateValue$iv$iv.getCurrentState().ordinal()] == i92 ? focusedLabelTextStyleColor : labelColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer2.endReplaceGroup();
        it3 = transition.getTargetState();
        ...
        int i93 = 1;
        obj6 = TextFieldImplKt.WhenMappings.$EnumSwitchMapping$1[it13.ordinal()] == i93 ? focusedLabelTextStyleColor : labelColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ...
        int i180 = 0;
        ComposerKt.sourceInformationMarkerStart(composer7, -1939694975, "CC(animateColor)P(2)68@3220L31,69@3287L70,73@3370L70:Transition.kt#xbi5r1");
        it5 = transition10.getTargetState();
        $composer5 = obj40;
        int i136 = 0;
        int i151 = 1023351670;
        $composer5.startReplaceGroup(i151);
        ...
        ComposerKt.sourceInformationMarkerStart(composer7, 1918408083, "CC(remember):Transition.kt#9igjgp");
        changed2 = composer7.changed(colorSpace-impl2);
        Composer composer6 = obj40;
        int i137 = 0;
        Object rememberedValue2 = composer6.rememberedValue();
        int i190 = 0;
        if (!changed2) {
            invalid$iv$iv2 = changed2;
            if (rememberedValue2 == Composer.Companion.getEmpty()) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            $this$animateValue$iv$iv5 = $this$animateValue$iv$iv4;
            obj = it10;
        ...
        it4 = $this$animateValue$iv$iv5.getTargetState();
