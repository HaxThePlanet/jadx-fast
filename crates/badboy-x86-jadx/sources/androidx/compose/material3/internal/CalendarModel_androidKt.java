...
public final class CalendarModel_androidKt {
    ...
    public static final String formatWithSkeleton(long utcTimeMillis, String skeleton, Locale locale, Map<String, Object> cache) {
        ...
        if (obj2 == null) {
            ...
            bestDateTimePattern = obj2;
        }
        return CalendarModelImpl.Companion.formatWithPattern(utcTimeMillis, obj2, bestDateTimePattern.toString(), cache);
    }
}
