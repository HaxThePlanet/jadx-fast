...
public final class SegmentedButtonKt {
    ...
    public static final void MultiChoiceSegmentedButtonRow-uFdPcIQ(Modifier modifier, float space, Function3<? super androidx.compose.material3.MultiChoiceSegmentedButtonRowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i6) {
        ...
        if (centerVertically != 0) {
            ...
            if ($i$a$LayoutRowKt$Row$1$iv & 48 == 0) {
                i4 = restartGroup.changed(space) ? 32 : 16;
                $dirty2 |= i4;
            } else {
                f3 = space;
            }
        ...
        if (i6 & 4 != 0) {
            ...
            if ($i$a$LayoutRowKt$Row$1$iv & 384 == 0) {
                i2 = restartGroup.changedInstance(obj2) ? 256 : 128;
                $dirty2 |= i2;
            }
        }
        int i39 = $dirty2;
        if (i39 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                if (it$iv == Composer.Companion.getEmpty()) {
                    empty = 0;
                    it$iv2 = it$iv;
                    it$iv = new MultiChoiceSegmentedButtonScopeWrapper((RowScope)RowScopeInstance.INSTANCE);
                    composer4.updateRememberedValue(it$iv);
                } else {
                    it$iv2 = it$iv;
                }
                ComposerKt.sourceInformationMarkerEnd($i$a$LayoutRowKt$Row$1$iv);
                obj2.invoke((MultiChoiceSegmentedButtonScopeWrapper)it$iv, $i$a$LayoutRowKt$Row$1$iv, Integer.valueOf(i25 |= 6));
                ComposerKt.sourceInformationMarkerEnd($i$a$LayoutRowKt$Row$1$iv);
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new SegmentedButtonKt.MultiChoiceSegmentedButtonRow.2(obj, f, obj2, $changed, i6);
    ...
    public static final void SegmentedButton(androidx.compose.material3.MultiChoiceSegmentedButtonRowScope $this$SegmentedButton, boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Shape shape, Modifier modifier, boolean enabled, androidx.compose.material3.SegmentedButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> icon, Function2<? super Composer, ? super Integer, Unit> label, Composer $composer, int $changed, int $changed1, int i15) {
        ...
        if (i46 &= i14 != 0) {
            ...
            if (i40 & 6 == 0) {
                i9 = restartGroup.changed($this$SegmentedButton) ? 4 : 2;
                $dirty4 |= i9;
            }
        }
        if (i14 & 1 != 0) {
            ...
            if (i40 & 48 == 0) {
                i = restartGroup.changed(traceInProgress) ? 32 : 16;
                $dirty4 |= i;
            }
        }
        if (i14 & 2 != 0) {
            ...
            if (i40 & 384 == 0) {
                i2 = restartGroup.changedInstance(onCheckedChange) ? 256 : 128;
                $dirty4 |= i2;
            } else {
                obj6 = onCheckedChange;
            }
        ...
        interactionSource3 = i14 & 8;
        if (interactionSource3 != 0) {
            $dirty4 |= 24576;
            rememberComposableLambda = modifier;
        } else {
            if (i40 & 24576 == 0) {
                i18 = restartGroup.changed(modifier) ? 16384 : 8192;
                $dirty4 |= i18;
            } else {
                rememberComposableLambda = modifier;
            }
        ...
        if (i28 != 0) {
            ...
            if (i40 & i64 == 0) {
                companion = i28;
                i7 = restartGroup.changedInstance(icon) ? 536870912 : 268435456;
                $dirty4 |= i7;
            } else {
                companion = i28;
                obj = icon;
        ...
        $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$1 = $dirty12;
        if ($dirty13 &= $dirty4 == 306783378 && $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$1 & 3 == 2) {
            if ($i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$1 & 3 == 2) {
                if (!restartGroup.getSkipping()) {
                    ...
                    if (i17 == 0) {
                        ...
                        i12 = 0;
                        $dirty1 = $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$1;
                    ...
                    obj31 = i29;
                    SegmentedButtonKt.SegmentedButton.2 anon = new SegmentedButtonKt.SegmentedButton.2($dirty3, obj5);
                    obj5 = interactionCountAsState;
                    SurfaceKt.Surface-d85dljk(traceInProgress, onCheckedChange, SizeKt.defaultMinSize-VpY3zN4(SegmentedButtonKt.interactionZIndex(RowScope.weight$default((RowScope)$this$SegmentedButton, obj2, 1065353216, false, 2, 0), traceInProgress, interactionCountAsState), ButtonDefaults.INSTANCE.getMinWidth-D9Ej5fM(), ButtonDefaults.INSTANCE.getMinHeight-D9Ej5fM()), colors2, shape, obj9.containerColor-WaAFU9c$material3_release(colors2, traceInProgress), interactionCountAsState, obj9.contentColor-WaAFU9c$material3_release(colors2, traceInProgress), enabled2, 0, 0, interactionSource3, rememberComposableLambda, (Function2)ComposableLambdaKt.rememberComposableLambda(1635710341, true, anon, restartGroup, 54), restartGroup, i26 | i38);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    $dirty = $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$1;
                    $composer2 = colors2;
                    obj7 = interactionSource3;
                    enabled3 = i7;
                    $dirty2 = borderColor-WaAFU9c$material3_release;
                    obj4 = l;
                    i13 = i17;
                } else {
                    restartGroup.skipToGroupEnd();
                    ...
                    $dirty = $dirty4;
                    $composer2 = z;
                    obj7 = borderStroke-l07J4OM$default;
                    obj4 = icon;
                    $dirty2 = colors4;
        ...
        if (endRestartGroup != null) {
            obj31 = $dirty;
            endRestartGroup = new SegmentedButtonKt.SegmentedButton.3($this$SegmentedButton, checked, onCheckedChange, shape, enabled3, $composer2, $dirty2, obj7, i13, obj4, label, $changed, $changed1, i15);
    ...
    public static final void SegmentedButton(androidx.compose.material3.SingleChoiceSegmentedButtonRowScope $this$SegmentedButton, boolean selected, Function0<Unit> onClick, Shape shape, Modifier modifier, boolean enabled, androidx.compose.material3.SegmentedButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> icon, Function2<? super Composer, ? super Integer, Unit> label, Composer $composer, int $changed, int $changed1, int i15) {
        ...
        if (i46 &= i13 != 0) {
            ...
            if (i31 & 6 == 0) {
                i = restartGroup.changed($this$SegmentedButton) ? 4 : 2;
                $dirty2 |= i;
            }
        }
        if (i13 & 1 != 0) {
            ...
            if (i31 & 48 == 0) {
                i4 = restartGroup.changed(traceInProgress2) ? 32 : 16;
                $dirty2 |= i4;
            }
        }
        if (i13 & 2 != 0) {
        ...
        if (i13 & 4 != 0) {
            ...
            if (i31 & 3072 == 0) {
                i19 = restartGroup.changed(shape) ? 2048 : 1024;
                $dirty2 |= i19;
            } else {
                obj = shape;
            }
        }
        interactionSource3 = i13 & 8;
        if (interactionSource3 != 0) {
            $dirty2 |= 24576;
            rememberComposableLambda = modifier;
        } else {
            if (i31 & 24576 == 0) {
                i9 = restartGroup.changed(modifier) ? 16384 : 8192;
                $dirty2 |= i9;
            } else {
                rememberComposableLambda = modifier;
            }
        ...
        if (i21 != 0) {
            ...
            if (i31 & i66 == 0) {
                companion = i21;
                i14 = restartGroup.changedInstance(icon) ? 536870912 : 268435456;
                $dirty2 |= i14;
            } else {
                companion = i21;
                obj8 = icon;
        ...
        if (i13 & 512 != 0) {
            ...
            if ($changed1 & 6 == 0) {
                i8 = restartGroup.changedInstance(anon) ? 4 : 2;
                $dirty1 |= i8;
            }
        }
        $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$2 = $dirty1;
                ...
                if (!restartGroup.getSkipping()) {
                    ...
                    if ($changed & 1 != 0) {
                        if (restartGroup.getDefaultsInvalid()) {
                            ...
                            if (i13 & 64 != 0) {
                                borderStroke-l07J4OM$default = SegmentedButtonDefaults.borderStroke-l07J4OM$default(SegmentedButtonDefaults.INSTANCE, colors3.borderColor-WaAFU9c$material3_release(z, traceInProgress2), obj22, 0, 2);
                                $dirty2 &= i12;
                            }
                            interactionSource2 = i10 != 0 ? 0 : interactionSource;
                            if (companion != 0) {
                                SegmentedButtonKt.SegmentedButton.4 anon3 = new SegmentedButtonKt.SegmentedButton.4(traceInProgress2);
                                $dirty3 = composableLambda;
                                obj6 = colors3;
                                colors4 = z;
                                enabled2 = i64;
                    ...
                    restartGroup.endDefaults();
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(-1016574361, enabled2, $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$2, "androidx.compose.material3.SegmentedButton (SegmentedButton.kt:217)");
                    }
                    ...
                    if (i11 == 0) {
                        ...
                        rememberedValue = composer2.rememberedValue();
                        i12 = 0;
                        $dirty12 = $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$2;
                        if (rememberedValue == Composer.Companion.getEmpty()) {
                            int i23 = 0;
                            composer2.updateRememberedValue(InteractionSourceKt.MutableInteractionSource());
                        } else {
                    ...
                    State interactionCountAsState = SegmentedButtonKt.interactionCountAsState((InteractionSource)rememberComposableLambda, restartGroup, 0);
                    obj34 = i22;
                    SegmentedButtonKt.SegmentedButton.6 anon2 = new SegmentedButtonKt.SegmentedButton.6($dirty3, anon);
                    borderColor-WaAFU9c$material3_release = interactionCountAsState;
                    SurfaceKt.Surface-d85dljk(selected, onClick, SemanticsModifierKt.semantics$default(SizeKt.defaultMinSize-VpY3zN4(SegmentedButtonKt.interactionZIndex(RowScope.weight$default((RowScope)$this$SegmentedButton, obj2, 1065353216, false, 2, 0), traceInProgress2, interactionCountAsState), ButtonDefaults.INSTANCE.getMinWidth-D9Ej5fM(), ButtonDefaults.INSTANCE.getMinHeight-D9Ej5fM()), false, (Function1)SegmentedButtonKt.SegmentedButton.5.INSTANCE, 1, 0), colors4, shape, obj6.containerColor-WaAFU9c$material3_release(colors4, traceInProgress2), interactionCountAsState, obj6.contentColor-WaAFU9c$material3_release(colors4, traceInProgress2), enabled2, 0, 0, interactionSource3, rememberComposableLambda, (Function2)ComposableLambdaKt.rememberComposableLambda(383378045, true, anon2, restartGroup, 54), restartGroup, i29 |= i40);
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    $dirty4 = $i$a$CacheSegmentedButtonKt$SegmentedButton$interactionSource$2;
                    $composer2 = colors4;
                    obj5 = interactionSource3;
                    enabled3 = i14;
                    $dirty = l;
                    i3 = i11;
                    obj7 = containerColor;
                    ...
                    $dirty4 = $dirty2;
                    $composer2 = z;
                    obj5 = borderStroke-l07J4OM$default;
                    obj7 = icon;
                    $dirty = colors3;
                    enabled3 = rememberComposableLambda;
                }
        ...
        if (endRestartGroup != null) {
            obj33 = $dirty4;
            anon = new SegmentedButtonKt.SegmentedButton.7($this$SegmentedButton, selected, onClick, shape, enabled3, $composer2, $dirty, obj5, i3, obj7, label, $changed, $changed1, i15);
    ...
    private static final void SegmentedButtonContent(Function2<? super Composer, ? super Integer, Unit> icon, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        traceInProgress2 = 1464121570;
        rememberComposableLambda = $composer.startRestartGroup(traceInProgress2);
        ...
        if (i16 & 6 == 0) {
            i6 = rememberComposableLambda.changedInstance(obj) ? 4 : 2;
            $dirty |= i6;
        }
        if (i16 & 48 == 0) {
            i8 = rememberComposableLambda.changedInstance(obj2) ? 32 : 16;
            $dirty |= i8;
        }
        if ($dirty & 19 == 18) {
            if (!rememberComposableLambda.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty, -1, "androidx.compose.material3.SegmentedButtonContent (SegmentedButton.kt:324)");
                }
                int i30 = i22;
                i2 = 0;
    ...
    public static final void SingleChoiceSegmentedButtonRow-uFdPcIQ(Modifier modifier, float space, Function3<? super androidx.compose.material3.SingleChoiceSegmentedButtonRowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i6) {
        ...
        if (centerVertically != 0) {
            ...
            if ($i$a$LayoutRowKt$Row$1$iv & 48 == 0) {
                i2 = restartGroup.changed(space) ? 32 : 16;
                $dirty |= i2;
            } else {
                f3 = space;
            }
        ...
        if (i38 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, i38, -1, "androidx.compose.material3.SingleChoiceSegmentedButtonRow (SegmentedButton.kt:268)");
                }
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new SegmentedButtonKt.SingleChoiceSegmentedButtonRow.2(obj, f, obj2, $changed, i6);
