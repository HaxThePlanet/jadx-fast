...
public final class ChipElevation {
    ...
    public ChipElevation(float f, float f2, float f3, float f4, float f5, float f6, DefaultConstructorMarker defaultConstructorMarker7) {
        super(f, f2, f3, f4, f5, f6);
    }

    public static final Interaction access$animateElevation$lambda$2(MutableState $lastInteraction$delegate) {
        return ChipElevation.animateElevation$lambda$2($lastInteraction$delegate);
    }

    public static final void access$animateElevation$lambda$3(MutableState $lastInteraction$delegate, Interaction value) {
        ChipElevation.animateElevation$lambda$3($lastInteraction$delegate, value);
    }
    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        int i8 = -2071499570;
        ComposerKt.sourceInformationMarkerStart(composer4, i8, "C(animateElevation)2180@105136L46,2181@105214L47,2182@105304L1473,2182@105270L1507,2234@107332L51,2236@107416L514,2236@107393L537:Chip.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i8, i30, -1, "androidx.compose.material3.ChipElevation.animateElevation (Chip.kt:2179)");
        }
        String str3 = "CC(remember):Chip.kt#9igjgp";
        ComposerKt.sourceInformationMarkerStart(composer4, 363854634, str3);
        int i10 = 0;
    ...
    public boolean equals(Object other) {
        ...
        final int i2 = 0;
        if (other != null) {
            if (!other instanceof ChipElevation) {
            } else {
    ...
    public final State<Dp> shadowElevation$material3_release(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        String str;
        int i = 1881877139;
        ComposerKt.sourceInformationMarkerStart($composer, i, "C(shadowElevation)2172@104887L74:Chip.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material3.ChipElevation.shadowElevation (Chip.kt:2171)");
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
