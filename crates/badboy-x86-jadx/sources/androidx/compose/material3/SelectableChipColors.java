...
public final class SelectableChipColors {
    ...
    public final androidx.compose.material3.SelectableChipColors copy-daRQuJA(long containerColor, long labelColor, long leadingIconColor, long trailingIconColor, long disabledContainerColor, long disabledLabelColor, long disabledLeadingIconColor, long disabledTrailingIconColor, long selectedContainerColor, long disabledSelectedContainerColor, long selectedLabelColor, long selectedLeadingIconColor, long selectedTrailingIconColor) {
        ...
        i = 1;
        final int i55 = 0;
        $this$isSpecified$iv$iv2 = Long.compare(i16, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv2 != 0) {
            l4 = i2;
        } else {
            int i40 = 0;
            l4 = $this$isSpecified$iv$iv2;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv = leadingIconColor;
        int i4 = 0;
        int i42 = 0;
        $this$isSpecified$iv$iv6 = Long.compare(i17, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv6 != 0) {
            l7 = $this$takeOrElse_u2dDxMtmZc$iv;
        } else {
            int i39 = 0;
            l7 = $this$isSpecified$iv$iv6;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv2 = disabledContainerColor;
        int i5 = 0;
        int i43 = 0;
        $this$isSpecified$iv$iv7 = Long.compare(i18, i54) != 0 ? i : i55;
        ...
        int i6 = 0;
        int i44 = 0;
        $this$isSpecified$iv$iv8 = Long.compare(i19, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv8 != 0) {
            l10 = $this$takeOrElse_u2dDxMtmZc$iv3;
        } else {
            int i37 = 0;
            l10 = $this$isSpecified$iv$iv8;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv4 = selectedContainerColor;
        int i7 = 0;
        int i45 = 0;
        $this$isSpecified$iv$iv = Long.compare(i20, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv != 0) {
            l8 = $this$takeOrElse_u2dDxMtmZc$iv4;
        } else {
            int i36 = 0;
            l8 = $this$isSpecified$iv$iv;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv5 = selectedLabelColor;
        int i8 = 0;
        int i46 = 0;
        $this$isSpecified$iv$iv12 = Long.compare(i21, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv12 != 0) {
            l3 = $this$takeOrElse_u2dDxMtmZc$iv5;
        } else {
            int i35 = 0;
            l3 = $this$isSpecified$iv$iv12;
        }
        ...
        if ($this$isSpecified$iv$iv5 != 0) {
            l9 = $this$takeOrElse_u2dDxMtmZc$iv6;
        } else {
            int i34 = 0;
            l9 = $this$isSpecified$iv$iv5;
        }
        ...
        if ($this$isSpecified$iv$iv3 != 0) {
            l11 = $this$takeOrElse_u2dDxMtmZc$iv7;
        } else {
            int i33 = 0;
            l11 = $this$isSpecified$iv$iv3;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv8 = obj57;
        int i11 = 0;
        int i49 = 0;
        $this$isSpecified$iv$iv4 = Long.compare(i24, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv4 != 0) {
            l12 = $this$takeOrElse_u2dDxMtmZc$iv8;
        } else {
            int i32 = 0;
            l12 = $this$isSpecified$iv$iv4;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv9 = obj59;
        int i12 = 0;
        int i50 = 0;
        $this$isSpecified$iv$iv9 = Long.compare(i25, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv9 != 0) {
            l5 = $this$takeOrElse_u2dDxMtmZc$iv9;
        } else {
            int i31 = 0;
            l5 = $this$isSpecified$iv$iv9;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv10 = obj61;
        int i13 = 0;
        int i51 = 0;
        $this$isSpecified$iv$iv10 = Long.compare(i26, i54) != 0 ? i : i55;
        if ($this$isSpecified$iv$iv10 != 0) {
            l6 = $this$takeOrElse_u2dDxMtmZc$iv10;
        } else {
            int i30 = 0;
            l6 = $this$isSpecified$iv$iv10;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv11 = obj63;
        int i14 = 0;
        int i52 = 0;
        $this$isSpecified$iv$iv11 = Long.compare(i27, i54) != 0 ? i : i55;
        ...
        int i15 = 0;
        int i53 = 0;
        if (Long.compare(selectedTrailingIconColor2, i54) != 0) {
        } else {
            i = i55;
        }
        if (i != 0) {
            l = $this$takeOrElse_u2dDxMtmZc$iv12;
        } else {
            int i28 = 0;
            l = selectedTrailingIconColor2;
        }
        SelectableChipColors selectableChipColors = new SelectableChipColors(l4, obj14, l7, obj16, l2, obj18, l10, obj20, l8, obj22, l3, obj24, l9, obj26, l11, obj28, l12, obj30, l5, obj32, l6, obj34, l13, obj36, l, obj38, 0);
