...
public final class SliderDefaults {
    ...
    private final void drawTrack-ngJ0SCU(DrawScope $this$drawTrack_u2dngJ0SCU, float[] tickFractions, float activeRangeStart, float activeRangeEnd, long inactiveTrackColor, long activeTrackColor, long inactiveTickColor, long activeTickColor, float height, float startThumbWidth, float endThumbWidth, float thumbTrackGapSize, float trackInsideCornerSize, Function2<? super DrawScope, ? super Offset, Unit> drawStopIndicator, Function3<? super DrawScope, ? super Offset, ? super Color, Unit> drawTick, boolean isRangeSlider) {
        ...
        activeTrackStart = i6;
        int i42 = x-impl8 - i5;
        i4 = obj64 != null ? cornerSize2 : cornerSize;
        ...
        contains = OffsetKt.Offset(x-impl4 += cornerSize, Offset.getY-impl(l6));
        rangeTo = RangesKt.rangeTo(x-impl6 -= i9, x-impl20 += i9);
        ...
        while ($this$forEachIndexed$iv < startCornerRadius) {
            ...
            i = $this$forEachIndexed$iv;
            i13 = startCornerRadius;
            i7 = valueOf;
            if (Float.compare(i46, activeRangeEnd) <= 0) {
            }
            l2 = contains;
            box-impl2 = Offset.getY-impl(drawScope.getCenter-F1C5BW0());
            contains = OffsetKt.Offset(Offset.getX-impl(OffsetKt.lerp-Wko1d7g(contains, box-impl2, OffsetKt.Offset(x-impl5 -= cornerSize, Offset.getY-impl(l7)))), box-impl2);
            if (obj64 != null) {
            } else {
            }
            center = contains;
            if (RangesKt.rangeTo(x-impl21 -= i5, x-impl22 += i5).contains((Comparable)Float.valueOf(Offset.getX-impl(center)))) {
            } else {
            }
            if (i3 != 0) {
            } else {
            ...
            $this$forEachIndexed$iv = i + 1;
            valueOf = i2;
            rangeTo = tick;
            startCornerRadius = i13;
            contains = l2;
            obj2 = height;
            tick = rangeTo;
            tickStartGap = obj63;
    ...
    public final void Thumb-9LiSoMs(MutableInteractionSource interactionSource, Modifier modifier, androidx.compose.material3.SliderColors colors, boolean enabled, long thumbSize, Composer $composer, int $changed, int i8) {
        ...
        if (thumbColor-vNxB06k$material3_release != 0) {
            ...
            if (i26 & 24576 == 0) {
                i5 = restartGroup.changed(thumbSize) ? 16384 : 8192;
                $dirty |= i5;
            } else {
                l2 = thumbSize;
            }
        ...
        if ($dirty & companion2 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (rememberedValue == Composer.Companion.getEmpty()) {
                    ...
                    mutableStateListOf = rememberedValue;
                }
                invalid$iv = mutableStateListOf;
                ...
                int i24 = 0;
                SpacerKt.Spacer(BackgroundKt.background-bw27NRU(HoverableKt.hoverable$default(SizeKt.size-6HolHcs(obj3, copy-DwJknco$default), obj5, i24, 2, i36), obj.thumbColor-vNxB06k$material3_release(z), 0), restartGroup, i24);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            invalid$iv = new SliderDefaults.Thumb.2(this, obj5, $dirty2, obj2, z2, l, obj3, i26, obj32);
    ...
    public final void Track(androidx.compose.material3.RangeSliderState rangeSliderState, Modifier modifier, androidx.compose.material3.SliderColors colors, boolean enabled, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 1 != 0) {
            ...
            if (i35 & 6 == 0) {
                i4 = restartGroup.changedInstance(rangeSliderState) ? 4 : 2;
                $dirty |= i4;
            }
        }
        int i16 = i7 & 2;
        ...
        if (i7 & 16 != 0) {
            ...
            if (i35 & 24576 == 0) {
                i3 = restartGroup.changed(this) ? 16384 : 8192;
                $dirty |= i3;
            }
        }
        if ($dirty & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(i8, i, -1, "androidx.compose.material3.SliderDefaults.Track (Slider.kt:1189)");
                }
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new SliderDefaults.Track.8(this, rangeSliderState, enabled2, modifier2, z3, i35, i7);
    ...
    public final void Track(androidx.compose.material3.SliderPositions sliderPositions, Modifier modifier, androidx.compose.material3.SliderColors colors, boolean enabled, Composer $composer, int $changed, int i7) {
        ...
        if ($dirty & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                int i11 = 0;
                trackColor-WaAFU9c$material3_release = colors2.trackColor-WaAFU9c$material3_release(enabled2, i11);
                int i28 = 1;
                trackColor-WaAFU9c$material3_release2 = colors2.trackColor-WaAFU9c$material3_release(enabled2, i28);
                obj27 = $dirty;
                ...
                if (i30 | changed9 == 0) {
                    ...
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        $this$cache$iv = new SliderDefaults.Track.1.1(trackColor-WaAFU9c$material3_release, defaultsInvalid, obj, trackColor-WaAFU9c$material3_release2, obj14, l2, companion, activeTickColor, obj18);
                ...
                obj3 = obj5;
                obj6 = enabled2;
                colors3 = trackColor-WaAFU9c$material3_release;
            }
        } else {
        }
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
    ...
    public final void Track(androidx.compose.material3.SliderState sliderState, Modifier modifier, androidx.compose.material3.SliderColors colors, boolean enabled, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 1 != 0) {
            ...
            if (i35 & 6 == 0) {
                i10 = restartGroup.changedInstance(sliderState) ? 4 : 2;
                $dirty |= i10;
            }
        }
        int i16 = i7 & 2;
        ...
        if ($dirty & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(i, i8, -1, "androidx.compose.material3.SliderDefaults.Track (Slider.kt:1081)");
                }
    ...
    public final void Track-4EFweAY(androidx.compose.material3.RangeSliderState rangeSliderState, Modifier modifier, boolean enabled, androidx.compose.material3.SliderColors colors, Function2<? super DrawScope, ? super Offset, Unit> drawStopIndicator, Function3<? super DrawScope, ? super Offset, ? super Color, Unit> drawTick, float thumbTrackGapSize, float trackInsideCornerSize, Composer $composer, int $changed, int i11) {
        ...
        if (i58 & 1 != 0) {
            ...
            if (i25 & 6 == 0) {
                i22 = restartGroup.changedInstance(anon) ? 4 : 2;
                $dirty3 |= i22;
            }
        }
        i6 = i58 & 2;
        ...
        if (i73 != 0) {
            ...
            if (i25 & i9 == 0) {
                i23 = restartGroup.changedInstance(drawTick) ? 131072 : 65536;
                $dirty3 |= i23;
            } else {
                obj3 = drawTick;
            }
        ...
        if (i24 != 0) {
            ...
            if (i25 & i14 == 0) {
                i5 = restartGroup.changed(thumbTrackGapSize) ? 1048576 : 524288;
                $dirty3 |= i5;
            } else {
                f = thumbTrackGapSize;
            }
        ...
        if (i17 != 0) {
            ...
            if (i25 & i21 == 0) {
                i18 = restartGroup.changed(trackInsideCornerSize) ? 8388608 : 4194304;
                $dirty3 |= i18;
            } else {
                inactiveTickColor2 = trackInsideCornerSize;
            }
        ...
        if (i27 &= $dirty3 == 38347922) {
            if (!restartGroup.getSkipping()) {
                        ...
                        if (i11 & 16 != 0) {
                            ...
                            if (i33 ^= 3072 > 2048) {
                                if (!restartGroup.changed(obj2)) {
                                    i20 = $dirty3 & 3072 == 2048 ? 1 : 0;
                                } else {
                                }
                            } else {
                            }
                            i7 = $dirty3 & 896 == 256 ? 1 : 0;
                            i20 |= i7;
                            i6 = restartGroup;
                            i4 = 0;
                            ...
                            if (empty == 0) {
                                ...
                                if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                    obj30 = invalid$iv;
                                    colors5 = new SliderDefaults.Track.9.1(obj2, trackColor-WaAFU9c$material3_release);
                                    i6.updateRememberedValue((Function2)colors5);
                                } else {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-541824132, $dirty3, -1, "androidx.compose.material3.SliderDefaults.Track (Slider.kt:1236)");
                }
                int i61 = 0;
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                i15 = restartGroup.consume((CompositionLocal)CompositionLocalsKt.getLocalLayoutDirection()) == LayoutDirection.Rtl ? 1127481344 : 0;
                ComposerKt.sourceInformationMarkerStart(restartGroup, -800695691, "CC(remember):Slider.kt#9igjgp");
                long l3 = obj31;
                i2 = $dirty3 & i75 == 1048576 ? 1 : 0;
                i10 = i52 &= $dirty3 == 8388608 ? 1 : 0;
                if (i55 ^= 24576 > 16384) {
                    drawStopIndicator2 = obj12;
                    if (!restartGroup.changed(drawStopIndicator2)) {
                        obj5 = drawStopIndicator2;
                        i13 = $dirty3 & 24576 == 16384 ? 1 : 0;
                    } else {
                        obj5 = drawStopIndicator2;
                    }
                } else {
                ...
                if (obj31 | i == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        companion = 0;
                        i14 = enabled2;
                        i5 = thumbTrackGapSize2;
                        obj29 = restartGroup;
                        obj30 = rememberedValue;
                        drawStopIndicator3 = $dirty3;
                        anon = new SliderDefaults.Track.11.1(rangeSliderState, l3, restartGroup, trackColor-WaAFU9c$material3_release, tickColor-WaAFU9c$material3_release, tickColor-WaAFU9c$material3_release2, l3, tickColor-WaAFU9c$material3_release, trackColor-WaAFU9c$material3_release, obj29, obj30, obj5, obj3);
                        ...
                        obj29 = restartGroup;
                        colors2 = l3;
                        i17 = tickColor-WaAFU9c$material3_release;
                ...
                CanvasKt.Canvas(RotateKt.rotate(SizeKt.height-3ABfNKs(SizeKt.fillMaxWidth$default(obj6, 0, i66, 0), SliderKt.getTrackHeight()), i15), (Function1)anon, obj29, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                inactiveTickColor = obj2;
                z = i14;
                $composer4 = i5;
                obj7 = i21;
                f2 = inactiveTickColor2;
                $dirty2 = obj4;
                obj = obj3;
            } else {
                restartGroup.skipToGroupEnd();
        ...
        if (endRestartGroup != null) {
            $composer2 = $composer3;
            traceInProgress = new SliderDefaults.Track.12(this, rangeSliderState, obj7, z, $composer4, $dirty2, obj, inactiveTickColor, f2, $changed, i11);
    ...
    public final void Track-4EFweAY(androidx.compose.material3.SliderState sliderState, Modifier modifier, boolean enabled, androidx.compose.material3.SliderColors colors, Function2<? super DrawScope, ? super Offset, Unit> drawStopIndicator, Function3<? super DrawScope, ? super Offset, ? super Color, Unit> drawTick, float thumbTrackGapSize, float trackInsideCornerSize, Composer $composer, int $changed, int i11) {
        ...
        if (i58 & 1 != 0) {
            ...
            if (i25 & 6 == 0) {
                i5 = restartGroup.changedInstance(anon) ? 4 : 2;
                $dirty2 |= i5;
            }
        }
        i10 = i58 & 2;
        ...
        if (i25 & 3072 == 0) {
            if (i58 & 8 == 0) {
                changed3 = restartGroup.changed(colors) ? 2048 : 1024;
            } else {
                obj6 = colors;
            }
            $dirty2 |= changed3;
        ...
        if (i73 != 0) {
            ...
            if (i25 & i12 == 0) {
                i13 = restartGroup.changedInstance(drawTick) ? 131072 : 65536;
                $dirty2 |= i13;
            } else {
                obj2 = drawTick;
            }
        ...
        if (i22 != 0) {
            ...
            if (i25 & i2 == 0) {
                i3 = restartGroup.changed(thumbTrackGapSize) ? 1048576 : 524288;
                $dirty2 |= i3;
            } else {
                f = thumbTrackGapSize;
            }
        ...
        if (i23 != 0) {
            ...
            if (i25 & i16 == 0) {
                i15 = restartGroup.changed(trackInsideCornerSize) ? 8388608 : 4194304;
                $dirty2 |= i15;
            } else {
                inactiveTickColor = trackInsideCornerSize;
            }
        ...
        if (i27 &= $dirty2 == 38347922) {
            if (!restartGroup.getSkipping()) {
                    ...
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (i11 & 16 != 0) {
                            ...
                            if (empty == 0) {
                                ...
                                if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                    obj30 = invalid$iv;
                                    colors5 = new SliderDefaults.Track.4.1(obj6, trackColor-WaAFU9c$material3_release);
                                    i10.updateRememberedValue((Function2)colors5);
                                } else {
                                    colors5 = rememberedValue2;
                                }
                            } else {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(49984771, $dirty2, -1, "androidx.compose.material3.SliderDefaults.Track (Slider.kt:1128)");
                }
                int i61 = 0;
                long trackColor-WaAFU9c$material3_release2 = thumbTrackGapSize2.trackColor-WaAFU9c$material3_release(enabled2, i61);
                obj29 = colors2;
                ...
                ComposerKt.sourceInformationMarkerStart(restartGroup, i67, "CC:CompositionLocal.kt#9igjgp");
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                i21 = restartGroup.consume((CompositionLocal)CompositionLocalsKt.getLocalLayoutDirection()) == LayoutDirection.Rtl ? 1127481344 : 0;
                ComposerKt.sourceInformationMarkerStart(restartGroup, -800841850, "CC(remember):Slider.kt#9igjgp");
                long l3 = obj31;
                i24 = $dirty2 & i75 == 1048576 ? 1 : 0;
                i19 = i52 &= $dirty2 == 8388608 ? 1 : 0;
                if (i55 ^= 24576 > 16384) {
                    drawStopIndicator3 = obj12;
                    if (!restartGroup.changed(drawStopIndicator3)) {
                        obj7 = drawStopIndicator3;
                        i8 = $dirty2 & 24576 == 16384 ? 1 : 0;
                    } else {
                        obj7 = drawStopIndicator3;
                    }
                } else {
                ...
                if (obj31 | i == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        obj29 = restartGroup;
                        colors4 = l3;
                        i23 = tickColor-WaAFU9c$material3_release;
                ...
                ComposerKt.sourceInformationMarkerEnd(obj29);
                CanvasKt.Canvas(RotateKt.rotate(SizeKt.height-3ABfNKs(SizeKt.fillMaxWidth$default(obj4, 0, i66, 0), SliderKt.getTrackHeight()), i21), (Function1)anon, obj29, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                inactiveTickColor2 = obj6;
                z = i2;
                $composer2 = i3;
                obj = i16;
        ...
        if (endRestartGroup != null) {
            $composer3 = $composer4;
            traceInProgress2 = new SliderDefaults.Track.7(this, sliderState, obj, z, $composer2, $dirty, obj5, inactiveTickColor2, f2, $changed, i11);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        } else {
            $composer3 = $composer4;
        }
    ...
    public final androidx.compose.material3.SliderColors colors-q0g_0yA(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor, Composer $composer, int $changed, int $changed1, int i14) {
        ...
        if (i3 & 4 != 0) {
            ...
            l8 = inactiveTickColor;
        }
        if (i3 & 8 != 0) {
            l5 = unspecified-0d7_KjU8;
        } else {
            l5 = disabledActiveTrackColor;
        }
        if (i3 & 16 != 0) {
            l3 = unspecified-0d7_KjU5;
        } else {
            l3 = disabledInactiveTrackColor;
        }
        if (i3 & 32 != 0) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return this.getDefaultSliderColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).copy--K518z4(l10, obj7, l4, obj9, l8, obj11, l5, obj13, l3, obj15);
    }
