...
public final class ModalBottomSheetKt {
    ...
    public static final void ModalBottomSheet-dYc4hso(Function0<Unit> onDismissRequest, Modifier modifier, androidx.compose.material3.SheetState sheetState, float sheetMaxWidth, Shape shape, long containerColor, long contentColor, float tonalElevation, long scrimColor, Function2<? super Composer, ? super Integer, Unit> dragHandle, Function2<? super Composer, ? super Integer, ? extends WindowInsets> contentWindowInsets, androidx.compose.material3.ModalBottomSheetProperties properties, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i17) {
        ...
        float f2;
        Function2 function2;
        androidx.compose.material3.ModalBottomSheetKt.ModalBottomSheet.1 anon6;
        Object obj10;
        ...
        if (i36 & 1 != 0) {
            ...
            if (i31 & 6 == 0) {
                i28 = rememberedValue2.changedInstance(obj12) ? 4 : 2;
                $dirty3 |= i28;
            }
        }
        expandedShape = i36 & 2;
        if (expandedShape != 0) {
            ...
            if (i31 & 48 == 0) {
                i4 = rememberedValue2.changed(modifier) ? 32 : 16;
                $dirty3 |= i4;
            } else {
                obj3 = modifier;
            }
        ...
        if (i31 & 384 == 0) {
            if (i36 & 4 == 0) {
                changed3 = rememberedValue2.changed(sheetState) ? 256 : 128;
            } else {
                obj = sheetState;
            }
            $dirty3 |= changed3;
        ...
        if (i31 & 24576 == 0) {
            if (i36 & 16 == 0) {
                changed6 = rememberedValue2.changed(shape) ? 16384 : 8192;
            } else {
                obj11 = shape;
            }
            $dirty3 |= changed6;
        ...
        if (i31 & i95 == 0) {
            ...
            $dirty3 |= $i$a$RememberCoroutineScopeEffectsKt$rememberCoroutineScope$1;
        } else {
            $dirty4 = tonalElevation;
        }
        int i53 = i36 & 128;
        ...
        if (i53 != 0) {
            ...
            if (i31 & i23 == 0) {
                i23 = rememberedValue2.changed(dragHandle) ? 8388608 : 4194304;
                $dirty3 |= i23;
            } else {
                f = dragHandle;
            }
        ...
        if (obj64 & i97 == 0) {
            if (i36 & 256 == 0) {
                $dirty5 = $dirty3;
                z = changedInstance;
                changed8 = rememberedValue2.changed(contentWindowInsets) ? 67108864 : 33554432;
            } else {
                $dirty5 = $dirty3;
                z = changedInstance;
        ...
        if (i9 != 0) {
            ...
            if (i33 & 48 == 0) {
                i11 = i9;
                i29 = rememberedValue2.changed($changed) ? 32 : 16;
                $dirty12 |= i29;
            } else {
                i11 = i9;
                i9 = $changed;
        ...
        if (i63 &= $dirty7 == 306783378 && $dirty14 & 147 == 146) {
            if ($dirty14 & 147 == 146) {
                if (!rememberedValue2.getSkipping()) {
                    ...
                    if (obj64 & 1 != 0) {
                        if (rememberedValue2.getDefaultsInvalid()) {
                            ...
                            if (i36 & 4 != 0) {
                                $dirty7 &= -897;
                                obj = rememberModalBottomSheetState;
                            }
                            if (i6 != 0) {
                            ...
                            if (scrimColor2 != 0) {
                                dragHandle2 = 0;
                                obj48 = $dirty7;
                                $dirty2 = Dp.constructor-impl((float)$dirty4);
                            } else {
                                obj48 = $dirty7;
                                $dirty2 = dragHandle;
                            }
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(2132719801, $dirty7, $dirty14, "androidx.compose.material3.ModalBottomSheet (ModalBottomSheet.kt:132)");
                    }
                    ...
                    if (i38 ^= 384 > 256) {
                        if (!rememberedValue2.changed(obj)) {
                            i16 = $dirty7 & 384 == 256 ? 1 : i6;
                        } else {
                        }
                    } else {
                    }
                    ...
                    if (i39 |= i5 == 0) {
                        if (rememberedValue3 == Composer.Companion.getEmpty()) {
                            empty3 = 0;
                            anon4 = new ModalBottomSheetKt.ModalBottomSheet.animateToDismiss.1.1(obj, wrapper$iv, obj12);
                            composer4.updateRememberedValue((Function0)anon4);
                        } else {
                            anon4 = rememberedValue3;
                        }
                    } else {
                    }
                    ComposerKt.sourceInformationMarkerEnd(rememberedValue2);
                    ...
                    if (i74 ^= 384 > 256) {
                        if (!rememberedValue2.changed(obj)) {
                            i13 = $dirty7 & 384 == 256 ? 1 : i6;
                        } else {
                        }
                    } else {
                    }
                    i12 = $dirty7 & 14 == 4 ? 1 : i6;
                    ...
                    if (i42 |= i12 == 0) {
                        if (rememberedValue4 == Composer.Companion.getEmpty()) {
                            empty3 = 0;
                            anon3 = new ModalBottomSheetKt.ModalBottomSheet.settleToDismiss.1.1(wrapper$iv, obj, obj12);
                            composer5.updateRememberedValue((Function1)anon3);
                        } else {
                    ...
                    if (rememberedValue5 == Composer.Companion.getEmpty()) {
                        ...
                        obj48 = invalid$iv;
                        i3 = $dirty14;
                        $dirty15 = rememberedValue5;
                    }
                    Object obj14 = $dirty15;
                    ComposerKt.sourceInformationMarkerEnd(rememberedValue2);
                    ComposerKt.sourceInformationMarkerStart(rememberedValue2, -2011371154, str);
                    if (i55 ^= 384 > 256) {
                        if (!rememberedValue2.changed(obj)) {
                            i25 = $dirty7 & 384 == 256 ? 1 : i6;
                        } else {
                        }
                    } else {
                    }
                    i10 = $dirty7 & 14 == 4 ? 1 : i6;
                    ...
                    if (i57 |= i10 == 0) {
                        if (rememberedValue == Composer.Companion.getEmpty()) {
                            dragHandle2 = 0;
                            anon2 = new ModalBottomSheetKt.ModalBottomSheet.2.1(obj, wrapper$iv, obj14, obj12);
                            empty2.updateRememberedValue((Function0)anon2);
                        } else {
                    ...
                    ComposerKt.sourceInformationMarkerEnd(rememberedValue2);
                    obj4 = obj14;
                    changed2 = new ModalBottomSheetKt.ModalBottomSheet.3(l3, obj29, (Function0)anon4, obj, obj4, wrapper$iv, (Function1)anon3, obj6, f4, obj2, l4, obj39, l5, obj41, f2, function2, anon6, obj5);
                    i = 1;
                    i29 = 6;
                    obj52 = rememberedValue2;
                    ModalBottomSheet_androidKt.ModalBottomSheetDialog((Function0)anon2, properties2, obj4, (Function2)ComposableLambdaKt.rememberComposableLambda(-314673510, i, changed2, rememberedValue2, 54), obj52, i47 |= i18);
                    composer2 = obj52;
                    if (obj.getHasExpandedState()) {
                        ComposerKt.sourceInformationMarkerStart(composer2, -2011320033, str);
                        if (i50 ^= 384 > 256) {
                            if (!composer2.changed(obj)) {
                                str = $dirty7 & 384 == 256 ? i : i6;
                            } else {
                            }
                        } else {
                        }
                        ...
                        if (str == null) {
                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                empty2 = 0;
                                containerColor2 = new ModalBottomSheetKt.ModalBottomSheet.4.1(obj, 0);
                        ...
                        EffectsKt.LaunchedEffect(obj, (Function2)containerColor2, composer2, i51 &= 14);
                    }
                    if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            $composer3 = composer2;
            endRestartGroup = new ModalBottomSheetKt.ModalBottomSheet.5(obj12, obj3, obj8, $dirty1, $composer4, l, str, l6, containerColor2, f3, l2, dragHandle2, function2, sheetState2, modalBottomSheetProperties, $changed1, obj64, obj65, obj66);
    ...
    public static final void ModalBottomSheetContent-IQkwcL4(BoxScope $this$ModalBottomSheetContent_u2dIQkwcL4, Animatable<Float, AnimationVector1D> predictiveBackProgress, CoroutineScope scope, Function0<Unit> animateToDismiss, Function1<? super Float, Unit> settleToDismiss, Modifier modifier, androidx.compose.material3.SheetState sheetState, float sheetMaxWidth, Shape shape, long containerColor, long contentColor, float tonalElevation, Function2<? super Composer, ? super Integer, Unit> dragHandle, Function2<? super Composer, ? super Integer, ? extends WindowInsets> contentWindowInsets, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i19) {
        ...
        if (i88 &= str != 0) {
            ...
            if (i35 & 6 == 0) {
                i20 = restartGroup.changed(obj8) ? 4 : 2;
                $dirty |= i20;
            }
        }
        if (str & 1 != 0) {
            ...
            if (i35 & 48 == 0) {
                ...
                i17 = changedInstance != null ? 32 : 16;
                $dirty |= i17;
            }
        }
        if (str & 2 != 0) {
            ...
            if (i35 & 384 == 0) {
                i21 = restartGroup.changedInstance(scope) ? 256 : 128;
                $dirty |= i21;
            } else {
                obj = scope;
            }
        ...
        if (str & 4 != 0) {
            $dirty |= 3072;
            obj2 = animateToDismiss;
        } else {
            if (i35 & 3072 == 0) {
                i14 = restartGroup.changedInstance(animateToDismiss) ? changedInstance3 : i34;
                $dirty |= i14;
            } else {
                obj2 = animateToDismiss;
            }
        ...
        if (str & 8 != 0) {
            ...
            if (i35 & 24576 == 0) {
                i31 = restartGroup.changedInstance(obj13) ? 16384 : i6;
                $dirty |= i31;
            }
        }
        i24 = str & 16;
        ...
        if (i24 != 0) {
            ...
            if (i35 & i5 == 0) {
                i11 = restartGroup.changed(modifier) ? 131072 : 65536;
                $dirty |= i11;
            } else {
                obj9 = modifier;
            }
        ...
        if (companion != 0) {
            ...
            if (i35 & i2 == 0) {
                i12 = restartGroup.changed(sheetMaxWidth) ? 8388608 : 4194304;
                $dirty |= i12;
            } else {
                f2 = sheetMaxWidth;
            }
        ...
        if (i35 & i110 == 0) {
            if (str & 256 == 0) {
                $dirty4 = $dirty;
                i27 = i76;
                changed2 = restartGroup.changed(containerColor) ? 536870912 : 268435456;
            } else {
                $dirty4 = $dirty;
                i27 = i76;
        ...
        if ($dirty13 != 0) {
            ...
            if (i54 & 48 == 0) {
                draggableState$material3_release = $dirty13;
                changedInstance5 = restartGroup.changed(contentWindowInsets) ? 32 : 16;
                $dirty12 |= changedInstance5;
            } else {
                draggableState$material3_release = $dirty13;
        ...
        if (i65 != 0) {
            ...
            if (i54 & 384 == 0) {
                changedInstance4 = restartGroup.changedInstance(content) ? 256 : 128;
                $dirty16 |= changedInstance4;
            } else {
                obj3 = content;
            }
        }
        final int obj57 = $dirty16;
        if (i54 & 3072 == 0) {
            if (str & 4096 == 0) {
                if (restartGroup.changedInstance($composer)) {
                } else {
                    changedInstance3 = i34;
                }
            } else {
                obj10 = $composer;
            }
            $dirty14 = changedInstance4;
        } else {
        ...
        if ($dirty2 & contentColor3 == 306783378 && $dirty14 & 9363 == 9362) {
                ...
                if (!restartGroup.getSkipping()) {
                    ...
                    if (i19 & 1 != 0) {
                        if (restartGroup.getDefaultsInvalid()) {
                            ...
                            if (str & 512 != 0) {
                                contentColor2 = ColorSchemeKt.contentColorFor-ek8zF_U(l, obj3, restartGroup);
                                $dirty14 &= -15;
                            } else {
                    ...
                    companion3 = 0;
                    if (i == 0) {
                        sheetMaxWidth4 = containerColor4;
                        if (rememberedValue == Composer.Companion.getEmpty()) {
                            containerColor4 = 0;
                            obj47 = rememberedValue;
                            composer3.updateRememberedValue(SheetDefaultsKt.ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection(obj6, Orientation.Vertical, obj13));
                        } else {
                            obj47 = rememberedValue;
                        }
                    } else {
                    ...
                    if (i71 ^= i107 > 1048576) {
                        if (!restartGroup.changed(obj6)) {
                            i15 = modifier2 & i107 == 1048576 ? 1 : 0;
                        } else {
                        }
                    } else {
                    }
                    ...
                    if (i15 == 0) {
                        ...
                        if (it$iv == Composer.Companion.getEmpty()) {
                            $i$f$cache2 = 0;
                            obj48 = it$iv;
                            it$iv = new ModalBottomSheetKt.ModalBottomSheetContent.3.1(obj6);
                    ...
                    changed4 = restartGroup.changed(str);
                    ...
                    if (i46 ^= i107 > 1048576) {
                        if (!restartGroup.changed(obj6)) {
                            i7 = modifier2 & i107 == 1048576 ? 1 : i62;
                        } else {
                        }
                    } else {
                    }
                    ...
                    if (i47 == 0) {
                        if (rememberedValue3 == Composer.Companion.getEmpty()) {
                            empty = 0;
                            obj45 = i47;
                            invalid$iv = new ModalBottomSheetKt.ModalBottomSheetContent.6.1(obj6, obj11);
                    ...
                    int i98 = 1;
                    f2 = contentColor2;
                    contentColor3 = restartGroup;
                    Object $dirty19 = obj53;
                    $dirty2 = i96;
                    long $dirty5 = companion;
                    SurfaceKt.Surface-T9BRK9s(GraphicsLayerModifierKt.graphicsLayer(SemanticsModifierKt.semantics$default(DraggableKt.draggable$default(AnchoredDraggableKt.draggableAnchors(NestedScrollModifierKt.nestedScroll$default(SizeKt.fillMaxWidth$default(SizeKt.widthIn-VpY3zN4$default(obj8.align($dirty15, Alignment.Companion.getTopCenter()), 0, containerColor4, i41, shape5), 0, i41, shape5), (NestedScrollConnection)rememberedValue, i68, 2, i68), obj6.getAnchoredDraggableState$material3_release(), Orientation.Vertical, (Function2)it$iv), obj6.getAnchoredDraggableState$material3_release().getDraggableState$material3_release(), Orientation.Vertical, obj6.isVisible(), 0, obj6.getAnchoredDraggableState$material3_release().isAnimationRunning(), 0, (Function3)invalid$iv2, false, 168, 0), i62, (Function1)$i$a$CacheModalBottomSheetKt$ModalBottomSheetContent$5, 1, 0), (Function1)invalid$iv), $dirty19, $dirty5, i98, f2, obj6, shape4, 0, 0, (Function2)ComposableLambdaKt.rememberComposableLambda(-692668920, i98, obj45, restartGroup, 54), contentColor3);
                    composer = contentColor3;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    obj4 = $dirty14;
        ...
        if (endRestartGroup != null) {
            endRestartGroup = new ModalBottomSheetKt.ModalBottomSheetContent.8($this$ModalBottomSheetContent_u2dIQkwcL4, predictiveBackProgress, scope, animateToDismiss, obj13, sheetMaxWidth3, obj4, shape2, containerColor2, l3, f2, l2, shape4, f, function2, anon, $changed, i19, obj59, obj60);
            endRestartGroup.updateScope((Function2)endRestartGroup);
        }
    }
    ...
    private static final void Scrim-3J-VO9M(long color, Function0<Unit> onDismissRequest, boolean visible, Composer $composer, int $changed) {
        ...
        if (i18 & 6 == 0) {
            i9 = restartGroup.changed(l) ? 4 : 2;
            $dirty |= i9;
        }
        anon2 = 32;
        if (i18 & 48 == 0) {
            i = restartGroup.changedInstance(obj) ? anon2 : 16;
            $dirty |= i;
        }
        if (i18 & 384 == 0) {
        ...
        if ($dirty & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                i7 = 1;
                rememberedValue = 0;
                $i$f$isSpecified8_81llA = Long.compare(string-2EP1pXo, i27) != 0 ? i7 : rememberedValue;
                if ($i$f$isSpecified8_81llA != 0) {
                    i12 = anon ? 1065353216 : 0;
                    TweenSpec tweenSpec3 = new TweenSpec(0, 0, 0, 7, 0);
                    $dirty2 = $dirty;
                    int i17 = i15;
                    $dirty = AnimateAsStateKt.animateFloatAsState(i12, (AnimationSpec)tweenSpec3, 0, 0, 0, restartGroup, 48, 28);
                    androidx.compose.material3.internal.Strings.Companion companion4 = Strings.Companion;
                    int i21 = 0;
                    ...
                    if (anon) {
                        ...
                        i3 = $dirty2 & 112 == anon2 ? empty3 : i17;
                        ...
                        if (i3 == 0) {
                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                empty3 = 0;
                                anon3 = new ModalBottomSheetKt.Scrim.dismissSheet.1.1(obj, 0);
                        ...
                        i14 = $dirty2 & 112 == 32 ? 1 : 0;
                        i13 = restartGroup;
                        i4 = 0;
                        Object rememberedValue3 = i13.rememberedValue();
                        anon2 = 0;
                        if (changed4 |= i14 == 0) {
                            if (rememberedValue3 == Composer.Companion.getEmpty()) {
                                empty = 0;
                                anon = new ModalBottomSheetKt.Scrim.dismissSheet.2.1(string-2EP1pXo, obj);
                                i13.updateRememberedValue((Function1)anon);
                            } else {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(restartGroup);
                        $i$f$isSpecified8_81llA = SemanticsModifierKt.semantics(SuspendingPointerInputFilterKt.pointerInput((Modifier)Modifier.Companion, obj, (Function2)anon3), true, (Function1)anon);
                    } else {
                    ...
                    if (changed3 |= i5 == 0) {
                        if (rememberedValue == Composer.Companion.getEmpty()) {
                            empty2 = 0;
                            anon2 = new ModalBottomSheetKt.Scrim.1.1(l, obj2, $dirty);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    CanvasKt.Canvas(SizeKt.fillMaxSize$default((Modifier)Modifier.Companion, 0, empty2, 0).then($i$f$isSpecified8_81llA), (Function1)anon2, restartGroup, 0);
                } else {
                    $dirty2 = $dirty;
                }
                if (ComposerKt.isTraceInProgress()) {
