...
final class ListItemMeasurePolicy implements MultiContentMeasurePolicy {
    private final int calculateIntrinsicHeight(IntrinsicMeasureScope $this$calculateIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> measurables, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasure) {
        ...
        if ((IntrinsicMeasurable)firstOrNull4 != null) {
            i5 = 0;
            intValue2 = (Number)obj7.invoke((IntrinsicMeasurable)firstOrNull4, Integer.valueOf(remainingWidth)).intValue();
            i3 = remainingWidth;
        } else {
            intValue2 = i4;
            i3 = remainingWidth;
        }
        firstOrNull = CollectionsKt.firstOrNull((List)obj6.get(i));
        ...
        if ((IntrinsicMeasurable)firstOrNull5 != null) {
            intValue3 = (Number)obj7.invoke((IntrinsicMeasurable)firstOrNull5, Integer.valueOf(i3)).intValue();
        } else {
            intValue3 = i4;
        }
        ...
        int invoke-Z-LSjz4$material3_release = ListItemType.Companion.invoke-Z-LSjz4$material3_release(i4, i, z);
        ...
        final int i20 = 0;
        boolean z2 = z;
        return ListItemKt.access$calculateHeight-N4Jib3Y(density, intValue, intValue2, i6, i7, intValue3, invoke-Z-LSjz4$material3_release, density.roundToPx-0680j_4(Dp.constructor-impl(listItemType *= f)), ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, 0));
    }
    ...
    private final int calculateIntrinsicWidth(IntrinsicMeasureScope $this$calculateIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> measurables, int height, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasure) {
        ...
        intValue = 0;
        firstOrNull4 = CollectionsKt.firstOrNull((List)obj.get(3));
        if ((IntrinsicMeasurable)firstOrNull4 != null) {
            i4 = firstOrNull4;
        } else {
            i4 = intValue;
        ...
        firstOrNull = CollectionsKt.firstOrNull((List)obj.get(intValue));
        if ((IntrinsicMeasurable)firstOrNull != null) {
            i = firstOrNull;
        } else {
            i = intValue;
        ...
        final int i14 = 0;
        return ListItemKt.access$calculateWidth-yeHjK3Y($i$f$plus5rwHm24, i4, i2, i, i3, intValue, $i$f$plus5rwHm24.roundToPx-0680j_4(Dp.constructor-impl(listItemStartPadding + listItemEndPadding)), ConstraintsKt.Constraints$default(0, i14, 0, 0, 15, 0));
    }
    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends List<? extends Measurable>> measurables, long constraints) {
        ...
        currentTotalWidth2 = CollectionsKt.firstOrNull(obj10) != null ? 1 : 0;
        int i27 = 0;
        ...
        if ((Measurable)intrinsicVerticalPadding != null) {
            measure-BRTryo02 = (Measurable)intrinsicVerticalPadding.measure-BRTryo0(offset-NN6Ew-U);
        } else {
            measure-BRTryo02 = measure-BRTryo03;
        }
        final int i58 = measure-BRTryo02;
        int leadingPlaceable = i9 + widthOrZero4;
        ...
        if ((Measurable)firstOrNull2 != null) {
            i10 = i28;
            trailingPlaceable2 = measure-BRTryo0;
            obj = obj8;
            l = l2;
            trailingPlaceable = (Measurable)firstOrNull2.measure-BRTryo0(ConstraintsKt.offset-NN6Ew-U$default(l2, obj22, -currentTotalWidth3, 0, 2));
        } else {
            trailingPlaceable2 = measure-BRTryo0;
            i10 = i28;
            obj = obj8;
            l = l2;
            trailingPlaceable = measure-BRTryo03;
        }
        heightOrZero2 += i10;
        firstOrNull = CollectionsKt.firstOrNull(obj10);
        if ((Measurable)firstOrNull != null) {
            headlinePlaceable = trailingPlaceable;
            i8 = trailingPlaceable2;
            i13 = i7;
            supportingPlaceable = trailingPlaceable;
        } else {
            headlinePlaceable = trailingPlaceable;
            i13 = i7;
            i8 = trailingPlaceable2;
        ...
        if (supportingPlaceable != null && supportingPlaceable.get((AlignmentLine)AlignmentLineKt.getFirstBaseline()) != supportingPlaceable.get((AlignmentLine)AlignmentLineKt.getLastBaseline())) {
            i5 = supportingPlaceable.get((AlignmentLine)AlignmentLineKt.getFirstBaseline()) != supportingPlaceable.get((AlignmentLine)AlignmentLineKt.getLastBaseline()) ? 1 : 0;
        } else {
        }
        Object firstOrNull3 = CollectionsKt.firstOrNull(obj9);
        if ((Measurable)firstOrNull3 != null) {
            placeable = supportingPlaceable;
            currentTotalWidth = currentTotalWidth3;
            i11 = i22;
            measure-BRTryo03 = (Measurable)firstOrNull3.measure-BRTryo0(ConstraintsKt.offset-NN6Ew-U(l, obj8, -currentTotalWidth3));
        } else {
            currentTotalWidth = currentTotalWidth3;
            i11 = i22;
            placeable = supportingPlaceable;
        ...
        return ListItemKt.access$place(measureScope, ListItemKt.access$calculateWidth-yeHjK3Y((IntrinsicMeasureScope)measureScope, TextFieldImplKt.widthOrZero(i58), TextFieldImplKt.widthOrZero(i8), TextFieldImplKt.widthOrZero(headlinePlaceable), TextFieldImplKt.widthOrZero(i31), TextFieldImplKt.widthOrZero(placeable), i48, constraints), ListItemKt.access$calculateHeight-N4Jib3Y((IntrinsicMeasureScope)measureScope, TextFieldImplKt.heightOrZero(i58), TextFieldImplKt.heightOrZero(i8), TextFieldImplKt.heightOrZero(headlinePlaceable), TextFieldImplKt.heightOrZero(i31), TextFieldImplKt.heightOrZero(placeable), i49, measureScope.roundToPx-0680j_4(constructor-impl2), constraints), i58, i8, headlinePlaceable, i31, placeable, ListItemType.equals-impl0(i49, ListItemType.Companion.getThreeLine-AlXitO8()), measureScope.roundToPx-0680j_4(listItemStartPadding), measureScope.roundToPx-0680j_4(listItemEndPadding), measureScope.roundToPx-0680j_4(f2));
    }
