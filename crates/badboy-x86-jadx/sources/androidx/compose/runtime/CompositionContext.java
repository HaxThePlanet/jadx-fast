...
public abstract class CompositionContext {
    ...
    public abstract void composeInitial$runtime_release(androidx.compose.runtime.ControlledComposition controlledComposition, Function2<? super androidx.compose.runtime.Composer, ? super Integer, Unit> function22);

    public abstract void deletedMovableContent$runtime_release(androidx.compose.runtime.MovableContentStateReference movableContentStateReference);
    ...
    public abstract void insertMovableContent$runtime_release(androidx.compose.runtime.MovableContentStateReference movableContentStateReference);

    public abstract void invalidate$runtime_release(androidx.compose.runtime.ControlledComposition controlledComposition);

    public abstract void invalidateScope$runtime_release(androidx.compose.runtime.RecomposeScopeImpl recomposeScopeImpl);

    public abstract void movableContentStateReleased$runtime_release(androidx.compose.runtime.MovableContentStateReference movableContentStateReference, androidx.compose.runtime.MovableContentState movableContentState2);
    ...
    public abstract void registerComposition$runtime_release(androidx.compose.runtime.ControlledComposition controlledComposition);

    public abstract void reportRemovedComposition$runtime_release(androidx.compose.runtime.ControlledComposition controlledComposition);
    ...
    public abstract void unregisterComposition$runtime_release(androidx.compose.runtime.ControlledComposition controlledComposition);
}
