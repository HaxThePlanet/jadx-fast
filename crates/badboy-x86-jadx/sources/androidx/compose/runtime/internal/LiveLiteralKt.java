...
public final class LiveLiteralKt {
    ...
    public static final <T> State<T> liveLiteral(String key, T value) {
        ...
        if (obj == null) {
            ...
            mutableStateOf$default = obj;
        }
        Intrinsics.checkNotNull(mutableStateOf$default, "null cannot be cast to non-null type androidx.compose.runtime.State<T of androidx.compose.runtime.internal.LiveLiteralKt.liveLiteral>");
        return (State)mutableStateOf$default;
    }
    ...
    public static final void updateLiveLiteralValue(String key, Object value) {
        ...
        if (obj == null) {
            ...
            needToUpdate = 0;
            i = 0;
            liveLiteralCache.put(key, SnapshotStateKt.mutableStateOf$default(value, i, 2, i));
        } else {
            mutableStateOf$default = obj;
        }
        if (needToUpdate != 0) {
            (MutableState)mutableStateOf$default.setValue(value);
        }
    }
}
