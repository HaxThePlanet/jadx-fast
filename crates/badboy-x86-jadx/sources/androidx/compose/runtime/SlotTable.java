...
public final class SlotTable implements CompositionData, Iterable<CompositionGroup>, KMappedMarker {
    ...
    private final int emitGroup(StringBuilder $this$emitGroup, int index, int level) {
        ...
        if (sourceInformationOf != null && sourceInformationOf != null) {
            ...
            if (sourceInformationOf != null) {
                ...
                dataIndex2 = 2;
                str = 0;
                if (!StringsKt.startsWith$default(sourceInformationOf, "C(", slotsSize, dataIndex2, str)) {
                    if (StringsKt.startsWith$default(sourceInformationOf, "CC(", slotsSize, dataIndex2, str)) {
                        i2 = 6;
                        i5 = 0;
                        int i17 = 0;
                        i6 = 0;
                        $this$emitGroup.append(" ");
                        String substring = sourceInformationOf.substring(indexOf$default += i9, StringsKt.indexOf$default((CharSequence)sourceInformationOf, ')', i17, i6, i2, i5));
        ...
        if (slotsSize != 0 && emitGroup$dataIndex2 <= this.slotsSize) {
            if (emitGroup$dataIndex2 <= this.slotsSize) {
                ...
                string4 = SlotTableKt.access$slotAnchor(this.groups, index);
                if (string4 < emitGroup$dataIndex2) {
                    $this$emitGroup.append(", slots=[");
                    $this$emitGroup.append(string4);
                    $this$emitGroup.append(": ");
                    dataIndex = string4;
                    while (dataIndex < emitGroup$dataIndex2) {
                        if (dataIndex != string4) {
                        }
                        $this$emitGroup.append(SlotTableKt.access$summarize(String.valueOf(this.slots[dataIndex]), i10));
                        dataIndex++;
                        $this$emitGroup.append(", ");
                    }
                    $this$emitGroup.append("]");
    ...
    private final androidx.compose.runtime.Anchor tryAnchor(int index) {
        ...
        int groupsSize;
        int groupsSize2;
        String $i$a$RuntimeCheckSlotTable$tryAnchor$1;
        groupsSize2 = 0;
    ...
    private static final int verifyWellFormed$validateGroup(Ref.IntRef current, androidx.compose.runtime.SlotTable this$0, int parent, int parentEnd) {
        ...
        boolean z;
        String string5;
        int $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$11;
        String string2;
        int minSlotsNeeded;
        int string4;
        Object isNode;
        ...
        int value$iv;
        int str;
        String $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$1;
        int i4;
        StringBuilder $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$2;
        int slotsSize;
        String $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$3;
        int i6;
        int i2;
        String append2;
        int i5;
        ...
        String $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$5;
        int i3;
        ...
        final int element = string3.element;
        string3.element = element + 1;
        string5 = SlotTableKt.access$parentAnchor(obj.groups, element);
        string4 = 1;
        i10 = string5 == i13 ? string4 : 0;
        int i20 = 0;
        if (i10 == 0) {
            int i23 = 0;
            StringBuilder stringBuilder4 = new StringBuilder();
            PreconditionsKt.throwIllegalStateException(stringBuilder4.append("Invalid parent index detected at ").append(element).append(", expected parent index to be ").append(i13).append(" found ").append(string5).toString());
        }
        i18 += element;
        i11 = string <= obj.groupsSize ? string4 : 0;
        int i21 = 0;
        if (i11 == 0) {
            int i26 = 0;
        ...
        i5 = SlotTableKt.access$slotAnchor(obj.groups, element) <= slotsSize ? string4 : 0;
        int i33 = 0;
        if (i5 == 0) {
            append = 0;
        ...
        i16 += z5;
        i8 = slotsSize - i22 >= i17 ? string4 : 0;
        i3 = 0;
        if (i8 == 0) {
            append = 0;
            stringBuilder = new StringBuilder();
        ...
        $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$11 = 0;
        while (string3.element < string) {
            $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$11 += verifyWellFormed$validateGroup;
        }
        int i32 = SlotTableKt.access$nodeCount(obj.groups, element);
        int i35 = SlotTableKt.access$groupSize(obj.groups, element);
        i9 = i32 == $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$11 ? 1 : 0;
        i12 = 0;
        final int i39 = i17;
        ...
        if (i9 == 0) {
            ...
            PreconditionsKt.throwIllegalStateException(end2.append("Incorrect node count detected at ").append(element).append(isNode).append(i32).append(minSlotsNeeded).append($i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$11).toString());
        } else {
            end = string;
        }
        element2 -= element;
        ...
        if (str == null) {
            i12 = 0;
            StringBuilder stringBuilder2 = new StringBuilder();
            nodeCount = $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$11;
    ...
    private static final void verifyWellFormed$verifySourceGroup(androidx.compose.runtime.SlotTable this$0, androidx.compose.runtime.GroupSourceInformation group) {
        ...
        boolean ownsAnchor;
        int i3;
        String $i$a$RequirePreconditionSlotTable$verifyWellFormed$verifySourceGroup$1$2;
        ...
        if (groups != null) {
            ...
            while (index$iv < (List)groups.size()) {
                ...
                index$iv++;
                SlotTable.verifyWellFormed$verifySourceGroup(this$0, (GroupSourceInformation)obj);
                int i4 = 0;
                if (!(Anchor)obj.getValid()) {
                }
                i3 = 0;
                if (!this$0.ownsAnchor((Anchor)obj)) {
                }
                int i5 = 0;
    ...
    public final androidx.compose.runtime.Anchor anchor(int index) {
        int i;
        int $i$a$RequirePreconditionSlotTable$anchor$2;
        String $i$a$RuntimeCheckSlotTable$anchor$1;
        Object obj;
        Object anchor;
        $i$a$RequirePreconditionSlotTable$anchor$2 = 0;
        if (writer ^= i == 0) {
            int i7 = 0;
    ...
    public final int anchorIndex(androidx.compose.runtime.Anchor anchor) {
        String $i$a$RuntimeCheckSlotTable$anchorIndex$1;
        int i2 = 0;
        if (writer ^= 1 == 0) {
            int i4 = 0;
    ...
    public final void close$runtime_release(androidx.compose.runtime.SlotReader reader, HashMap<androidx.compose.runtime.Anchor, androidx.compose.runtime.GroupSourceInformation> sourceInformationMap) {
        ...
        int i2;
        int i;
        int $i$a$SynchronizedSlotTable$close$2;
        String $i$a$RuntimeCheckSlotTable$close$1;
        Map map;
        if (reader.getTable$runtime_release() == this && this.readers > 0) {
            i2 = this.readers > 0 ? 1 : 0;
        } else {
        }
        $i$a$SynchronizedSlotTable$close$2 = 0;
        if (i2 == 0) {
            int i4 = 0;
        ...
        if (sourceInformationMap != null) {
            i = 0;
            int i3 = 0;
            $i$a$RuntimeCheckSlotTable$close$1 = this.sourceInformationMap;
            synchronized (this) {
                $i$a$RuntimeCheckSlotTable$close$1.putAll((Map)sourceInformationMap);
                $i$a$SynchronizedSlotTable$close$2 = Unit.INSTANCE;
            }
        }
    }
    ...
    public final void close$runtime_release(androidx.compose.runtime.SlotWriter writer, int[] groups, int groupsSize, Object[] slots, int slotsSize, ArrayList<androidx.compose.runtime.Anchor> anchors, HashMap<androidx.compose.runtime.Anchor, androidx.compose.runtime.GroupSourceInformation> sourceInformationMap, MutableIntObjectMap<MutableIntSet> calledByMap) {
        androidx.compose.runtime.SlotTable table$runtime_release;
        int i;
        String $i$a$RequirePreconditionSlotTable$close$3;
        int i2 = 0;
    ...
    public final boolean groupContainsAnchor(int groupIndex, androidx.compose.runtime.Anchor anchor) {
        ...
        int ownsAnchor;
        int groupsSize;
        String $i$a$RuntimeCheckSlotTable$groupContainsAnchor$1;
        int location$runtime_release;
        String $i$a$RuntimeCheckSlotTable$groupContainsAnchor$2;
        i2 = 1;
        groupsSize = 0;
        if (writer ^= i2 == 0) {
            int i6 = 0;
        ...
        if (groupIndex >= 0 && groupIndex < this.groupsSize) {
            i = groupIndex < this.groupsSize ? i2 : value$iv;
        } else {
        }
        location$runtime_release = 0;
        if (i == 0) {
        ...
        if (ownsAnchor(anchor)) {
            ...
            if (groupIndex <= location$runtime_release && location$runtime_release < i4 += groupIndex) {
                ownsAnchor = location$runtime_release < i4 += groupIndex ? i2 : value$iv;
            } else {
            }
            if (ownsAnchor != 0) {
            } else {
    ...
    public final List<androidx.compose.runtime.RecomposeScopeImpl> invalidateGroupsWithKey$runtime_release(int target) {
        ...
        calledByMap = calledByMap.get(i2);
        ...
        Unit $i$a$ReadSlotTable$invalidateGroupsWithKey$2 = Unit.INSTANCE;
        reader3.close();
        int i10 = 0;
    ...
    public final androidx.compose.runtime.SlotWriter openWriter() {
        int i;
        String $i$a$RuntimeCheckSlotTable$openWriter$2;
        final int i4 = 1;
        int i5 = 0;
        if (writer ^= i4 == 0) {
            int i8 = 0;
    ...
    public final boolean ownsAnchor(androidx.compose.runtime.Anchor anchor) {
        ...
        if (anchor.getValid()) {
            ...
            if (i4 >= 0 && Intrinsics.areEqual(this.anchors.get(i4), anchor)) {
                it = Intrinsics.areEqual(this.anchors.get(i4), anchor) ? i2 : i;
            } else {
            }
            if (it != 0) {
                i = i2;
    ...
    public final androidx.compose.runtime.GroupSourceInformation sourceInformationOf(int group) {
        ...
        if (sourceInformationMap != null && tryAnchor != null) {
            ...
            if (tryAnchor != null) {
                int i2 = 0;
                $i$a$LetSlotTable$sourceInformationOf$1$1 = obj;
            }
        }
        return $i$a$LetSlotTable$sourceInformationOf$1$1;
    }
    ...
    public final void verifyWellFormed() {
        ...
        int i;
        Object iterator;
        String $i$a$CheckPreconditionSlotTable$verifyWellFormed$1;
        int value;
        StringBuilder append2;
        int index$iv;
        int $i$a$CheckPreconditionSlotTable$verifyWellFormed$2;
        int ownsAnchor;
        StringBuilder append;
        String $i$a$RequirePreconditionSlotTable$verifyWellFormed$4$2;
        int i5;
        int indexFor;
        int groupsSize;
        int i4;
        int i3;
        String $i$a$RequirePreconditionSlotTable$verifyWellFormed$3$2;
        ...
        while (value$iv < slots.length) {
            ...
            $i$a$CheckPreconditionSlotTable$verifyWellFormed$1 = i6;
            append2 = null;
            if ($i$a$CheckPreconditionSlotTable$verifyWellFormed$1 == null) {
            }
            value$iv++;
            int i9 = 0;
            StringBuilder stringBuilder2 = new StringBuilder();
            ...
            $i$a$CheckPreconditionSlotTable$verifyWellFormed$1 = i2;
        }
        int index = 0;
        lastLocation = -1;
