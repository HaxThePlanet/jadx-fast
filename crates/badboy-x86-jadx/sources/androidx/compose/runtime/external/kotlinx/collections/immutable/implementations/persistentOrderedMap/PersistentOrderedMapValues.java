...
public final class PersistentOrderedMapValues<K, V>  extends AbstractCollection<V> implements ImmutableCollection<V> {
    ...
    public PersistentOrderedMapValues(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.persistentOrderedMap.PersistentOrderedMap<K, V> map) {
        super();
        this.map = map;
    }
    ...
    public Iterator<V> iterator() {
        PersistentOrderedMapValuesIterator persistentOrderedMapValuesIterator = new PersistentOrderedMapValuesIterator(this.map);
        return (Iterator)persistentOrderedMapValuesIterator;
    }
}
