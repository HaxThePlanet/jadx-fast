...
final class MutableMapEntry<K, V>  extends androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.MapEntry<K, V> implements Map.Entry<K, V>, KMutableMap.Entry {
    ...
    private V value;
    public MutableMapEntry(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.PersistentHashMapBuilderEntriesIterator<K, V> parentIterator, K key, V value) {
        super(key, value);
