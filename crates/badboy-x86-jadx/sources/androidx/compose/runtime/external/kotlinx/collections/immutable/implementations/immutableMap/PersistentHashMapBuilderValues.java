...
public final class PersistentHashMapBuilderValues<K, V>  extends AbstractMutableCollection<V> implements Collection<V>, KMutableCollection {
    ...
    public PersistentHashMapBuilderValues(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.PersistentHashMapBuilder<K, V> builder) {
        super();
    ...
    public Iterator<V> iterator() {
        ...
        return (Iterator)persistentHashMapBuilderValuesIterator;
    }
}
