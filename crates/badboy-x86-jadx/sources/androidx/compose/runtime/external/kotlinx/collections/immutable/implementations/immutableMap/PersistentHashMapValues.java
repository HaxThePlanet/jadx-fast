...
public final class PersistentHashMapValues<K, V>  extends AbstractCollection<V> implements ImmutableCollection<V> {
    ...
    public PersistentHashMapValues(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.PersistentHashMap<K, V> map) {
        super();
        this.map = map;
    }
    ...
    public Iterator<V> iterator() {
        ...
        return (Iterator)persistentHashMapValuesIterator;
    }
}
