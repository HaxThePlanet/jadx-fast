...
public final class SnapshotStateList<T>  implements androidx.compose.runtime.snapshots.StateObject, List<T>, RandomAccess, KMutableList {
    ...
    static boolean conditionalUpdate$default(androidx.compose.runtime.snapshots.SnapshotStateList $this, boolean structural, Function1 block, int i4, Object object5) {
        ...
        int structural5;
        int structural3;
        androidx.compose.runtime.snapshots.StateRecord structural4;
        PersistentList oldList;
        int currentModification;
        Object invoke;
        ...
        androidx.compose.runtime.snapshots.StateRecord firstStateRecord2;
        ...
        int i18 = 0;
        firstStateRecord2 = 0;
        firstStateRecord = stateObject3.getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
        snapshot$iv$iv = 0;
    ...
    private final <R> R mutate(Function1<? super List<T>, ? extends R> block) {
        ...
        int $i$f$mutate2;
        int i3;
        androidx.compose.runtime.snapshots.StateRecord $i$f$mutate3;
        int result;
        PersistentList oldList;
        int currentModification;
        ...
        i6 = this;
        firstStateRecord = 0;
        androidx.compose.runtime.snapshots.StateRecord firstStateRecord2 = i6.getFirstStateRecord();
        ...
        synchronized (lock) {
            $i$f$mutate = i3;
            $i$f$mutate3 = stateRecord2;
            $i$f$mutate3.setList$runtime_release(build);
            $this$mutate_u24lambda_u2423 = 1;
            $i$f$mutate3.setModification$runtime_release(modification$runtime_release2++);
            $i$f$mutate3.setStructuralChange$runtime_release(structuralChange$runtime_release++);
            equal = $this$mutate_u24lambda_u2423;
            i3 = 0;
            SnapshotKt.notifyWrite(snapshot$iv$iv, (StateObject)i6);
    ...
    private final boolean mutateBoolean(Function1<? super List<T>, Boolean> block) {
        ...
        synchronized (lock) {
            ...
            this_$iv2.setList$runtime_release(build);
            $this$mutate_u24lambda_u2423$iv = 1;
            this_$iv2.setModification$runtime_release(modification$runtime_release2++);
            this_$iv2.setStructuralChange$runtime_release(structuralChange$runtime_release++);
    ...
    public final int retainAllInRange$runtime_release(Collection<? extends T> elements, int start, int end) {
        ...
        int i11 = 0;
        int i23 = 0;
        androidx.compose.runtime.snapshots.StateRecord firstStateRecord2 = i8.getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
        int i24 = 0;
        current = SnapshotKt.current((StateRecord)(SnapshotStateList.StateListStateRecord)firstStateRecord2);
        stateRecord = 0;
        ...
        synchronized (obj3) {
            ...
            i11 = 0;
            i23 = 0;
            firstStateRecord2 = i8.getFirstStateRecord();
            Intrinsics.checkNotNull(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
            i24 = 0;
            current = SnapshotKt.current((StateRecord)(SnapshotStateList.StateListStateRecord)firstStateRecord2);
            stateRecord = 0;
        ...
        synchronized (lock) {
            ...
            i8 = 0;
            i7 = i15;
            SnapshotKt.notifyWrite(startSize2, (StateObject)subList);
            if ($this$mutate_u24lambda_u2423$iv != 0) {
            } else {
            }
