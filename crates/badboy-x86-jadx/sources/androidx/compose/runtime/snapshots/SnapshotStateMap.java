...
public final class SnapshotStateMap<K, V>  implements androidx.compose.runtime.snapshots.StateObject, Map<K, V>, KMutableMap {
    ...
    private final <R> R mutate(Function1<? super Map<K, V>, ? extends R> block) {
        ...
        synchronized (lock) {
            ...
            $i$f$mutate3.setMap$runtime_release(build);
            ...
            i2 = 0;
            SnapshotKt.notifyWrite(snapshot$iv$iv, (StateObject)i3);
    ...
    private final void update(Function1<? super PersistentMap<K, ? extends V>, ? extends PersistentMap<K, ? extends V>> block) {
        ...
        androidx.compose.runtime.snapshots.StateObject i;
        androidx.compose.runtime.snapshots.StateObject stateObject;
        int i6;
        androidx.compose.runtime.snapshots.StateRecord stateRecord;
        int i7;
    ...
    public void clear() {
        ...
        int i16 = 0;
        PersistentMap map = it;
        if (map != stateRecord3.getMap$runtime_release()) {
    ...
    public V put(K key, V value) {
        ...
        i2 = i10;
        synchronized (lock) {
            this_$iv3 = stateRecord;
            this_$iv = stateRecord3;
            this_$iv.setMap$runtime_release(build);
    ...
    public void putAll(Map<? extends K, ? extends V> from) {
        ...
        int i8 = 0;
        i = 0;
        firstStateRecord = i6.getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap, V of androidx.compose.runtime.snapshots.SnapshotStateMap>");
        stateRecord = 0;
        current = SnapshotKt.current((StateRecord)(SnapshotStateMap.StateMapStateRecord)firstStateRecord);
        snapshot$iv$iv$iv = 0;
        ...
        i = i6;
        firstStateRecord = 0;
        androidx.compose.runtime.snapshots.StateRecord firstStateRecord2 = i.getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap, V of androidx.compose.runtime.snapshots.SnapshotStateMap>");
        current = 0;
        int i9 = 0;
        androidx.compose.runtime.snapshots.Snapshot snapshotInitializer = SnapshotKt.getSnapshotInitializer();
        ...
        synchronized (lock) {
            ...
            equal = $this$mutate_u24lambda_u2415$iv;
            i6 = 0;
            SnapshotKt.notifyWrite(snapshot$iv$iv$iv, (StateObject)i);
            if ($this$mutate_u24lambda_u2415$iv != 0) {
            } else {
            }
        }
    ...
    public V remove(Object key) {
        ...
        int i8 = 0;
        i7 = 0;
        firstStateRecord = i5.getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap, V of androidx.compose.runtime.snapshots.SnapshotStateMap>");
        stateRecord = 0;
        current = SnapshotKt.current((StateRecord)(SnapshotStateMap.StateMapStateRecord)firstStateRecord);
        snapshot$iv$iv$iv = 0;
        ...
        i7 = i5;
        firstStateRecord = 0;
        androidx.compose.runtime.snapshots.StateRecord firstStateRecord2 = i7.getFirstStateRecord();
        Intrinsics.checkNotNull(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap, V of androidx.compose.runtime.snapshots.SnapshotStateMap>");
        current = 0;
        int i9 = 0;
        androidx.compose.runtime.snapshots.Snapshot snapshotInitializer = SnapshotKt.getSnapshotInitializer();
        ...
        synchronized (lock) {
            ...
            equal = $this$mutate_u24lambda_u2415$iv;
            i5 = 0;
            SnapshotKt.notifyWrite(snapshot$iv$iv$iv, (StateObject)i7);
            if ($this$mutate_u24lambda_u2415$iv != 0) {
            } else {
            }
    ...
    public final boolean removeIf$runtime_release(Function1<? super Map.Entry<K, V>, Boolean> predicate) {
        ...
        if (!Intrinsics.areEqual(build, oldMap$iv)) {
            ...
            $i$f$removeIf$runtime_release3 = i4;
        }
        return removed;
    }
