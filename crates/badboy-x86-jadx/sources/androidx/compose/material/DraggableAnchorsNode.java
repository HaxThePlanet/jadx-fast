...
final class DraggableAnchorsNode<T>  extends Modifier.Node implements LayoutModifierNode {
    ...
    public final Function2<IntSize, Constraints, Pair<androidx.compose.material.DraggableAnchors<T>, T>> getAnchors() {
        return this.anchors;
    }
    ...
    public final androidx.compose.material.AnchoredDraggableState<T> getState() {
        return this.state;
    }
    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        int height;
        Object invoke;
        androidx.compose.material.AnchoredDraggableState state;
        Object first;
        Object second;
    ...
    public final void setAnchors(Function2<? super IntSize, ? super Constraints, ? extends Pair<? extends androidx.compose.material.DraggableAnchors<T>, ? extends T>> <set-?>) {
        this.anchors = <set-?>;
    }
    ...
    public final void setState(androidx.compose.material.AnchoredDraggableState<T> <set-?>) {
        this.state = <set-?>;
    }
}
