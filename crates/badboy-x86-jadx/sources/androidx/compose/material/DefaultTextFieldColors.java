...
final class DefaultTextFieldColors implements androidx.compose.material.TextFieldColors {
    ...
    private DefaultTextFieldColors(long textColor, long disabledTextColor, long cursorColor, long errorCursorColor, long focusedIndicatorColor, long unfocusedIndicatorColor, long errorIndicatorColor, long disabledIndicatorColor, long leadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long trailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long backgroundColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long placeholderColor, long disabledPlaceholderColor) {
        ...
        this.errorIndicatorColor = disabledTrailingIconColor;
        this.disabledIndicatorColor = backgroundColor;
        this.leadingIconColor = unfocusedLabelColor;
        this.disabledLeadingIconColor = errorLabelColor;
        this.errorLeadingIconColor = disabledPlaceholderColor;
        this.trailingIconColor = obj37;
        this.disabledTrailingIconColor = obj39;
        this.errorTrailingIconColor = obj41;
        this.backgroundColor = obj43;
        this.focusedLabelColor = obj45;
        this.unfocusedLabelColor = obj47;
        this.disabledLabelColor = obj49;
        this.errorLabelColor = obj51;
        this.placeholderColor = obj53;
        this.disabledPlaceholderColor = obj55;
    }

    public DefaultTextFieldColors(long l, long l2, long l3, long l4, long l5, long l6, long l7, long l8, long l9, long l10, long l11, long l12, long l13, long l14, long l15, long l16, long l17, long l18, long l19, long l20, long l21, DefaultConstructorMarker defaultConstructorMarker22) {
        super(l, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, defaultConstructorMarker22, obj23, obj24, obj25, obj26, obj27, obj28, obj29, obj30, obj31, obj32, obj33, obj34, obj35, obj36, obj37, obj38, obj39, obj40, obj41, obj42);
    }
    ...
    public State<Color> backgroundColor(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.backgroundColor (TextFieldDefaults.kt:881)");
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> cursorColor(boolean isError, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.cursorColor (TextFieldDefaults.kt:913)");
        }
    ...
    public State<Color> indicatorColor(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i4, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.indicatorColor (TextFieldDefaults.kt:864)");
        }
        disabledIndicatorColor = !enabled ? this.disabledIndicatorColor : isError != null ? this.errorIndicatorColor : indicatorColor$lambda$0 ? this.focusedIndicatorColor : this.unfocusedIndicatorColor;
        int i7 = 0;
        if (enabled) {
    ...
    public State<Color> labelColor(boolean enabled, boolean error, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.labelColor (TextFieldDefaults.kt:895)");
        }
        unfocusedLabelColor = !enabled ? this.disabledLabelColor : error != null ? this.errorLabelColor : labelColor$lambda$1 ? this.focusedLabelColor : this.unfocusedLabelColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        $composer.endReplaceGroup();
    ...
    public State<Color> leadingIconColor(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.leadingIconColor (TextFieldDefaults.kt:822)");
        }
    ...
    public State<Color> leadingIconColor(boolean enabled, boolean isError, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.leadingIconColor (TextFieldDefaults.kt:807)");
        }
        disabledLeadingIconColor = !enabled ? this.disabledLeadingIconColor : isError != null ? this.errorLeadingIconColor : this.leadingIconColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public State<Color> placeholderColor(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.placeholderColor (TextFieldDefaults.kt:886)");
        }
    ...
    public State<Color> textColor(boolean enabled, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.textColor (TextFieldDefaults.kt:908)");
        }
    ...
    public State<Color> trailingIconColor(boolean enabled, boolean isError, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.trailingIconColor (TextFieldDefaults.kt:849)");
        }
    ...
    public State<Color> trailingIconColor(boolean enabled, boolean isError, Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.DefaultTextFieldColors.trailingIconColor (TextFieldDefaults.kt:834)");
        }
        disabledTrailingIconColor = !enabled ? this.disabledTrailingIconColor : isError != null ? this.errorTrailingIconColor : this.trailingIconColor;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
