...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == 0) {
            if (Float.compare(f, booleanValue) >= 0 && Float.compare(f2, i2) < 0 && Float.compare(f3, booleanValue) >= 0 && Float.compare(f4, i2) < 0) {
                        ...
                        if (Float.compare(f4, i2) < 0) {
                            if (event.getAction() == 4) {
                                ...
                                if (parentBounds != null) {
                                    i = 0;
                                    rawY = Float.compare(rawX2, booleanValue) == 0 ? i2 : i;
                                    if (rawY == 0) {
                                        booleanValue = Float.compare(rawY, booleanValue) == 0 ? i2 : i;
                                        if (booleanValue == 0) {
