...
public final class InternalMutatorMutex {
    ...
    private final AtomicReference<androidx.compose.material.InternalMutatorMutex.Mutator> currentMutator;
    ...
    private static final class Mutator {
        ...
        public final boolean canInterrupt(androidx.compose.material.InternalMutatorMutex.Mutator other) {
            int i;
    ...
    public static final AtomicReference access$getCurrentMutator$p(androidx.compose.material.InternalMutatorMutex $this) {
        return $this.currentMutator;
    }

    public static final Mutex access$getMutex$p(androidx.compose.material.InternalMutatorMutex $this) {
        return $this.mutex;
    }

    public static final void access$tryMutateOrCancel(androidx.compose.material.InternalMutatorMutex $this, androidx.compose.material.InternalMutatorMutex.Mutator mutator) {
        $this.tryMutateOrCancel(mutator);
    }

    public static Object mutate$default(androidx.compose.material.InternalMutatorMutex internalMutatorMutex, MutatePriority mutatePriority2, Function1 function13, Continuation continuation4, int i5, Object object6) {
        MutatePriority obj1;
        if (i5 &= 1 != 0) {
    ...
    public static Object mutateWith$default(androidx.compose.material.InternalMutatorMutex internalMutatorMutex, Object object2, MutatePriority mutatePriority3, Function2 function24, Continuation continuation5, int i6, Object object7) {
        MutatePriority obj2;
        if (i6 &= 2 != 0) {
    ...
    private final void tryMutateOrCancel(androidx.compose.material.InternalMutatorMutex.Mutator mutator) {
        Object obj;
        boolean interrupt;
