...
final class StateLayer {
    ...
    public final void handleInteraction$material_ripple_release(Interaction interaction, CoroutineScope scope) {
        ...
        int i;
        int i4;
        androidx.compose.material.ripple.StateLayer.handleInteraction.1 anon2;
        int i5;
        int i6;
        CoroutineScope coroutineScope2;
        int i3;
        int i7;
        androidx.compose.material.ripple.StateLayer.handleInteraction.2 anon;
        int i8;
        int i2;
