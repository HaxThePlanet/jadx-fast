...
@Metadata(d1 = "\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0008\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\u0008\u0004\u0010\u0005¨\u0006\u0006", d2 = {"_create", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Create", "Landroidx/compose/material/icons/Icons$Outlined;", "getCreate", "(Landroidx/compose/material/icons/Icons$Outlined;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-core_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class CreateKt {
    ...
    public static final ImageVector getCreate(Icons.Outlined $this$Create) {
        ...
        builder5.close();
        builder5.moveTo(1086156964, 1100480512);
        ...
        builder5.lineTo(1086156964, 1100480512);
        builder5.close();
        builder5.moveTo(1101377044, 1085548790);
        int i14 = -1072315761;
        builder5.lineToRelative(i14, i14);
        ...
        final int i67 = i25;
        builder.reflectiveCurveToRelative(-1090351268, 1036831949, -1087163597, 1049918177);
        int i22 = -1075167887;
        int i23 = 1072315761;
        builder.lineToRelative(i22, i23);
        int i27 = 1081081856;
        builder.lineToRelative(i27, i27);
        builder.lineToRelative(i23, i22);
        builder6.curveToRelative(1053273620, -1094210028, 1053273620, -1081962660, 0, -1078691103);
        builder6.close();
        CreateKt._create = ImageVector.Builder.addPath-oIyEayM$default(builder2, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, i37, 1065353216, i46, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), i46, 0, 0, 0, 14336, 0).build();
