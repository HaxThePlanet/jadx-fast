...
public final class AccountBoxKt {
    ...
    public static final ImageVector getAccountBox(Icons.Sharp $this$AccountBox) {
        ...
        builder6.curveToRelative(1073154621, 0, 1080033280, 1070134723, 1080033280, i70);
        builder6.curveToRelative(0, 1073154621, -1077348925, 1080033280, -1067450368, i70);
        PathBuilder builder = builder6;
        int i26 = -1067450368;
        builder.reflectiveCurveToRelative(i26, -1077348925, i26, i26);
        ...
        builder.close();
        AccountBoxKt._accountBox = ImageVector.Builder.addPath-oIyEayM$default(builder2, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, i21, 1065353216, i33, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), i33, 0, 0, 0, 14336, 0).build();
