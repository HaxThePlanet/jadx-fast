...
public final class KeyboardArrowLeftKt {
    ...
    public static final ImageVector getKeyboardArrowLeft(Icons.Sharp $this$KeyboardArrowLeft) {
        ...
        int i13 = 0;
        int i14 = 0;
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.KeyboardArrowLeft", Dp.constructor-impl(1103101952), Dp.constructor-impl(1103101952), 1103101952, 1103101952, 0, obj8, 0, 0, 96, 0);
        int i12 = 0;
        int i16 = 0;
        int i22 = 0;
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Sharp.KeyboardArrowLeft", replaceWith = @ReplaceWith(...))
    public static void getKeyboardArrowLeft$annotations(Icons.Sharp icons$Sharp) {
    }
}
