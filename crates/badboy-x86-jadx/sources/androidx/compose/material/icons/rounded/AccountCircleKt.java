...
@Metadata(d1 = "\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0008\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\u0008\u0004\u0010\u0005¨\u0006\u0006", d2 = {"_accountCircle", "Landroidx/compose/ui/graphics/vector/ImageVector;", "AccountCircle", "Landroidx/compose/material/icons/Icons$Rounded;", "getAccountCircle", "(Landroidx/compose/material/icons/Icons$Rounded;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-core_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(Icons.Rounded $this$AccountCircle) {
        ...
        String str = "Rounded.AccountCircle";
        int i23 = 0;
        int i24 = 0;
        ...
        int i50 = 0;
        builder5.curveToRelative(1073154621, i50, 1080033280, 1070134723, 1080033280, 1080033280);
        int i16 = 1095761920;
        int i6 = 1094713344;
        ...
        builder5.curveToRelative(-1073615995, i50, -1064451441, -1085150331, -1060865311, -1070050836);
        int i69 = 1094713344;
        builder5.curveTo(1089575322, 1098697933, 1092280648, 1097859072, i69, 1097859072);
        final int i77 = i21;
        builder4.reflectiveCurveToRelative(1083074150, 1061997773, 1086618337, 1074245140);
        builder5.curveTo(1099133092, 1100574884, 1096841953, 1101004800, i69, 1101004800);
        builder5.close();
        AccountCircleKt._accountCircle = ImageVector.Builder.addPath-oIyEayM$default(builder, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, i32, 1065353216, i40, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), i40, 0, 0, 0, 14336, 0).build();
