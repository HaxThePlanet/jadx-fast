...
@Metadata(d1 = "\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0008\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\u0008\u0004\u0010\u0005¨\u0006\u0006", d2 = {"_share", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Share", "Landroidx/compose/material/icons/Icons$Filled;", "getShare", "(Landroidx/compose/material/icons/Icons$Filled;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-core_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class ShareKt {
    ...
    public static final ImageVector getShare(Icons.Filled $this$Share) {
        ...
        int i62 = 0;
        builder6.curveToRelative(-1076593951, i62, -1069547520, 1068205343, -1069547520, 1077936128);
        int i15 = 1077936128;
        builder.reflectiveCurveToRelative(1068205343, i15, i15, i15);
        builder6.curveToRelative(1061830001, i62, 1069547520, -1096894382, 1073909596, -1085318103);
        ...
        int i99 = 1077600584;
        builder6.curveToRelative(0, 1070470267, 1067953684, 1077600584, i99, 1077600584);
        int i65 = 0;
        builder6.curveToRelative(1070470267, i65, 1077600584, -1079529964, i99, -1069883064);
        int i17 = -1069883064;
        builder.reflectiveCurveToRelative(-1079529964, i17, i17, i17);
        builder.close();
        ShareKt._share = ImageVector.Builder.addPath-oIyEayM$default(builder2, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, 0, 1065353216, 1065353216, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), 1065353216, 0, 0, i65, 14336, 0).build();
