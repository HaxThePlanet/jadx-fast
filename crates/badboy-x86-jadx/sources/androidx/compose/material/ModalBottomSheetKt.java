...
public final class ModalBottomSheetKt {
    ...
    public static final void ModalBottomSheetLayout-Gs3lGvM(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> sheetContent, Modifier modifier, androidx.compose.material.ModalBottomSheetState sheetState, boolean sheetGesturesEnabled, Shape sheetShape, float sheetElevation, long sheetBackgroundColor, long sheetContentColor, long scrimColor, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i13) {
        ...
        if (i127 & 1 != 0) {
            ...
            if (i126 & 6 == 0) {
                i29 = sheetElevation2.changedInstance(obj5) ? 4 : 2;
                $dirty3 |= i29;
            }
        }
        int i59 = i127 & 2;
        if (i59 != 0) {
            ...
            if (i126 & 48 == 0) {
                i28 = sheetElevation2.changed(modifier) ? 32 : 16;
                $dirty3 |= i28;
            } else {
                obj3 = modifier;
            }
        ...
        if (i126 & 384 == 0) {
            if (i127 & 4 == 0) {
                i6 = sheetElevation2.changedInstance(sheetState) ? 256 : 128;
            } else {
                obj2 = sheetState;
            }
            $dirty3 |= i6;
        ...
        if (i35 != 0) {
            ...
            if (i126 & 3072 == 0) {
                i6 = sheetElevation2.changed(sheetGesturesEnabled) ? 2048 : 1024;
                $dirty3 |= i6;
            } else {
                maybeCachedBoxMeasurePolicy = sheetGesturesEnabled;
            }
        ...
        if (i126 & 24576 == 0) {
            if (i127 & 16 == 0) {
                changed2 = sheetElevation2.changed(sheetShape) ? 16384 : 8192;
            } else {
                obj4 = sheetShape;
            }
            $dirty3 |= changed2;
        ...
        if (i91 &= i126 == 0) {
            if (i127 & 32 == 0) {
                changed4 = sheetElevation2.changed(sheetElevation) ? 131072 : 65536;
            } else {
                f2 = sheetElevation;
            }
            $dirty3 |= changed4;
        ...
        if (i126 & i26 == 0) {
            if (i127 & 64 == 0) {
                i10 = sheetElevation2.changed(sheetBackgroundColor) ? 1048576 : 524288;
            } else {
        ...
        if (i96 &= i126 == 0) {
            if (i127 & 128 == 0) {
                i33 = sheetElevation2.changed(scrimColor) ? 8388608 : 4194304;
            } else {
                i19 = scrimColor;
            }
            $dirty3 |= i33;
        ...
        if (i97 &= i126 == 0) {
            if (i127 & 256 == 0) {
                i37 = i59;
                changed3 = sheetElevation2.changed($composer) ? 67108864 : 33554432;
            } else {
                i37 = i59;
                l3 = $composer;
            }
        ...
        if (i127 & 512 != 0) {
            ...
            if (i126 & i54 == 0) {
                i40 = sheetElevation2.changedInstance(obj7) ? 536870912 : 268435456;
                $dirty3 |= i40;
            }
        }
        $dirty = $dirty3;
        if (i55 &= $dirty == 306783378) {
            if (!sheetElevation2.getSkipping()) {
                ...
                if (i126 & 1 != 0) {
                    if (sheetElevation2.getDefaultsInvalid()) {
                        ...
                        sheetGesturesEnabled2 = i35 != 0 ? 1 : maybeCachedBoxMeasurePolicy;
                        if (i127 & 16 != 0) {
                            sheetShape3 = MaterialTheme.INSTANCE.getShapes(composer7, modifier5).getLarge();
                        ...
                        if (i127 & 64 != 0) {
                            sheetBackgroundColor3 = MaterialTheme.INSTANCE.getColors(composer7, modifier5).getSurface-0d7_KjU();
                            $dirty &= sheetContentColor2;
                        } else {
                            sheetBackgroundColor3 = sheetContentColor2;
                        }
                        if (i127 & 128 != 0) {
                            sheetContentColor2 = ColorsKt.contentColorFor-ek8zF_U(sheetBackgroundColor3, i37, composer7);
                            $dirty &= i35;
                        } else {
                        ...
                        if (i127 & 256 != 0) {
                            f = sheetElevation2;
                            l8 = sheetBackgroundColor3;
                            l4 = sheetContentColor2;
                            sheetBackgroundColor2 = $dirty4;
                            $dirty2 = obj64;
                            obj = sheetShape3;
                            sheetShape2 = l6;
                        } else {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-92970288, sheetBackgroundColor2, -1, "androidx.compose.material.ModalBottomSheetLayout (ModalBottomSheet.kt:360)");
                }
                int i99 = i7;
                int i113 = 0;
                ...
                Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer7, $dirty2);
                obj73 = constructor;
                i30 = 0;
                i36 = sheetBackgroundColor2;
                ...
                currentCompositionLocalMap = $i$a$LayoutBoxKt$Box$1$iv.getCurrentCompositionLocalMap();
                ...
                i18 = rememberModalBottomSheetState.getAnchoredDraggableState$material_release().getTargetValue() != ModalBottomSheetValue.Hidden ? 1 : 0;
                ModalBottomSheetKt.Scrim-3J-VO9M(obj64, obj65, (Function0)it$iv, i18, obj68);
                ComposerKt.sourceInformationMarkerEnd(obj68);
                ...
                if (obj70 != null) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd($i$a$LayoutBoxKt$Box$1$iv);
                    obj2 = 0;
                    nestedScroll$default = NestedScrollModifierKt.nestedScroll$default((Modifier)Modifier.Companion, (NestedScrollConnection)maxModalBottomSheetWidth, obj2, 2, obj2);
                ...
                SurfaceKt.Surface-F-jzlyU(AnchoredDraggableKt.anchoredDraggable$default(ModalBottomSheetKt.modalBottomSheetAnchors(SizeKt.fillMaxWidth$default(SizeKt.widthIn-VpY3zN4$default((BoxScope)iNSTANCE.align((Modifier)Modifier.Companion, Alignment.Companion.getTopCenter()), i23, ModalBottomSheetKt.MaxModalBottomSheetWidth, $this$ModalBottomSheetLayout_Gs3lGvM_u24lambda_u245, obj2), i23, $this$ModalBottomSheetLayout_Gs3lGvM_u24lambda_u245, obj2).then(nestedScroll$default), rememberModalBottomSheetState), rememberModalBottomSheetState.getAnchoredDraggableState$material_release(), vertical, i2, false, 0, false, 56, 0).then(semantics$default), obj, l8, obj23, l4, obj25, 0, f, (Function2)ComposableLambdaKt.rememberComposableLambda(17396558, true, anon, $i$a$LayoutBoxKt$Box$1$iv, 54), $i$a$LayoutBoxKt$Box$1$iv);
                ComposerKt.sourceInformationMarkerEnd($i$a$LayoutBoxKt$Box$1$iv);
        ...
        if (endRestartGroup != null) {
            endRestartGroup = new ModalBottomSheetKt.ModalBottomSheetLayout.2(function3, sheetState2, $composer3, scope, obj4, $composer2, l5, i37, l2, obj2, l7, maybeCachedBoxMeasurePolicy, obj7, i126, i127);
    ...
    private static final void Scrim-3J-VO9M(long color, Function0<Unit> onDismiss, boolean visible, Composer $composer, int $changed) {
        ...
        if (i19 & 384 == 0) {
            i3 = restartGroup.changed(anon3) ? 256 : 128;
            $dirty2 |= i3;
        }
        if ($dirty2 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty2, -1, "androidx.compose.material.Scrim (ModalBottomSheet.kt:495)");
                }
                int i16 = 0;
                i = 0;
                rememberedValue = 1;
                $i$f$isSpecified8_81llA = Long.compare(string-4foXLRw, i25) != 0 ? rememberedValue : i;
                if ($i$f$isSpecified8_81llA != 0) {
                    ...
                    i13 = anon3 ? 1065353216 : 0;
                    TweenSpec tweenSpec3 = new TweenSpec(0, 0, 0, 7, 0);
                    i4 = i34;
                    $dirty = $dirty2;
                    $dirty2 = AnimateAsStateKt.animateFloatAsState(i13, (AnimationSpec)tweenSpec3, 0, 0, 0, restartGroup, 48, 28);
                    ...
                    if (anon3) {
                        ...
                        i15 = restartGroup;
                        i14 = 0;
                        Object rememberedValue3 = i15.rememberedValue();
                        anon = 0;
                        if (changed4 |= i6 == 0) {
                            if (rememberedValue3 == Composer.Companion.getEmpty()) {
                                empty2 = 0;
                                anon3 = new ModalBottomSheetKt.Scrim.dismissModifier.2.1(string-4foXLRw, obj);
                                i15.updateRememberedValue((Function1)anon3);
                            } else {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(restartGroup);
                        semantics = SemanticsModifierKt.semantics(SuspendingPointerInputFilterKt.pointerInput((Modifier)Modifier.Companion, obj, (Function2)anon2), true, (Function1)anon3);
        ...
        if (endRestartGroup != null) {
            traceInProgress = new ModalBottomSheetKt.Scrim.2(l, obj2, obj, $composer, i19);
    ...
    public static final androidx.compose.material.ModalBottomSheetState rememberModalBottomSheetState(androidx.compose.material.ModalBottomSheetValue initialValue, AnimationSpec<Float> animationSpec, Function1<? super androidx.compose.material.ModalBottomSheetValue, Boolean> confirmValueChange, boolean skipHalfExpanded, Composer $composer, int $changed, int i7) {
        ...
        if (i4 |= empty == 0) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                i8 = 0;
                anon = new ModalBottomSheetKt.rememberModalBottomSheetState.2.1(obj2, $changed$iv, anon3, animationSpec4, i3);
                obj = $changed$iv;
                anon2 = anon3;
        ...
        return (ModalBottomSheetState)RememberSaveableKt.rememberSaveable(/* result */, ModalBottomSheetState.Companion.Saver(animationSpec4, anon3, i3, (Density)$changed$iv), 0, (Function0)anon, $composer, 0, 4);
    }
}
