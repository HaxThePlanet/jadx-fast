...
public final class PagerIntervalContent implements LazyLayoutIntervalContent.Interval {
    ...
    private final Function4<androidx.compose.foundation.pager.PagerScope, Integer, Composer, Integer, Unit> item;
    private final Function1<Integer, Object> key;
    static {
    }

    public PagerIntervalContent(Function1<? super Integer, ? extends Object> key, Function4<? super androidx.compose.foundation.pager.PagerScope, ? super Integer, ? super Composer, ? super Integer, Unit> item) {
        super();
        this.key = key;
        this.item = item;
    }

    public final Function4<androidx.compose.foundation.pager.PagerScope, Integer, Composer, Integer, Unit> getItem() {
        return this.item;
    }
