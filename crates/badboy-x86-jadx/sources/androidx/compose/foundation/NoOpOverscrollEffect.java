...
public final class NoOpOverscrollEffect implements androidx.compose.foundation.OverscrollEffect {
    ...
    public long applyToScroll-Rhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        return (Offset)obj6.invoke(Offset.box-impl(delta)).unbox-impl();
    }

    @Override // androidx.compose.foundation.OverscrollEffect
    public Modifier getEffectModifier() {
        return (Modifier)Modifier.Companion;
    }
