...
public final class ContextMenuArea_androidKt {
    public static final void ContextMenu(androidx.compose.foundation.contextmenu.ContextMenuState state, Function0<Unit> onDismiss, Modifier modifier, Function1<? super androidx.compose.foundation.contextmenu.ContextMenuScope, Unit> contextMenuBuilderBlock, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 1 != 0) {
            ...
            if (i2 & 6 == 0) {
                i4 = restartGroup.changed(state) ? 4 : 2;
                $dirty |= i4;
            }
        }
        if (i7 & 2 != 0) {
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (!status instanceof ContextMenuState.Status.Open && ComposerKt.isTraceInProgress()) {
                    ...
                    if (endRestartGroup2 != null) {
                        traceInProgress2 = new ContextMenuArea_androidKt.ContextMenu.1(state, onDismiss, obj, obj2, i2, i7);
                        endRestartGroup2.updateScope((Function2)traceInProgress2);
                    }
                }
    ...
    public static final void ContextMenuArea(androidx.compose.foundation.contextmenu.ContextMenuState state, Function0<Unit> onDismiss, Function1<? super androidx.compose.foundation.contextmenu.ContextMenuScope, Unit> contextMenuBuilderBlock, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i9) {
        ...
        if (i9 & 1 != 0) {
            ...
            if (i13 & 6 == 0) {
                i19 = restartGroup.changed(traceInProgress2) ? 4 : 2;
                $dirty |= i19;
            }
        }
        if (i9 & 2 != 0) {
        ...
        if (i9 & 4 != 0) {
            ...
            if (i13 & 384 == 0) {
                i14 = restartGroup.changedInstance(contextMenuBuilderBlock) ? 256 : 128;
                $dirty |= i14;
            } else {
                obj2 = contextMenuBuilderBlock;
            }
        ...
        if (i9 & 32 != 0) {
            ...
            if (i13 & i53 == 0) {
                i16 = restartGroup.changedInstance(obj3) ? 131072 : 65536;
                $dirty |= i16;
            }
        }
        int i52 = $dirty;
        if ($dirty2 &= i52 == 74898) {
            if (!restartGroup.getSkipping()) {
                if (str != null) {
                    ...
                    i21 = materialized$iv$iv;
                }
                if (i17 != 0) {
                    z = companion;
                }
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(i22, i52, -1, "androidx.compose.foundation.contextmenu.ContextMenuArea (ContextMenuArea.android.kt:44)");
                }
                if (z) {
                    contextMenuGestures = ContextMenuGestures_androidKt.contextMenuGestures(i21, traceInProgress2);
                } else {
                    contextMenuGestures = i21;
                }
                i11 = i28;
                i8 = 0;
                ...
                obj3.invoke(composer5, Integer.valueOf(i32 &= 14));
                function0 = obj37;
                modifier2 = modifier3;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new ContextMenuArea_androidKt.ContextMenuArea.2(state, onDismiss, contextMenuBuilderBlock, obj, z2, obj3, i13, i9);
