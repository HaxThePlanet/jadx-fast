...
public final class AndroidSelectionHandles_androidKt {
    public static final void HandlePopup(androidx.compose.foundation.text.selection.OffsetProvider positionProvider, Alignment handleReferencePoint, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (i25 & 6 == 0) {
            ...
            i8 = changedInstance != null ? changed : 2;
            $dirty2 |= i8;
        }
        i2 = 32;
        if (i25 & 48 == 0) {
            i9 = restartGroup.changed(obj2) ? i2 : 16;
            $dirty2 |= i9;
        }
        if (i25 & 384 == 0) {
            i = restartGroup.changedInstance(obj5) ? 256 : 128;
            $dirty2 |= i;
        }
        ...
        if (i26 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, i26, -1, "androidx.compose.foundation.text.selection.HandlePopup (AndroidSelectionHandles.android.kt:247)");
                }
                ComposerKt.sourceInformationMarkerStart(restartGroup, 1288574970, "CC(remember):AndroidSelectionHandles.android.kt#9igjgp");
                int i20 = 0;
                i7 = i26 & 112 == i2 ? i12 : i20;
                if (i26 & 14 != changed) {
    ...
    public static final void SelectionHandle-pzduO1o(androidx.compose.foundation.text.selection.OffsetProvider offsetProvider, boolean isStartHandle, ResolvedTextDirection direction, boolean handlesCrossed, long minTouchTargetSize, Modifier modifier, Composer $composer, int $changed, int i9) {
        ...
        if (obj27 & 2 != 0) {
            ...
            if (i7 & 48 == 0) {
                i5 = restartGroup.changed(z2) ? i14 : 16;
                $dirty |= i5;
            }
        }
        if (obj27 & 4 != 0) {
            ...
            if (i7 & 384 == 0) {
                i2 = restartGroup.changed(direction) ? 256 : 128;
                $dirty |= i2;
            } else {
                obj = direction;
            }
        ...
        if (obj27 & 8 != 0) {
            ...
            if (i7 & 3072 == 0) {
                i = restartGroup.changed(handlesCrossed) ? 2048 : 1024;
                $dirty |= i;
            } else {
                z = handlesCrossed;
            }
        ...
        if (i7 & 24576 == 0) {
            if (obj27 & 16 == 0) {
                i10 = restartGroup.changed(minTouchTargetSize) ? 16384 : 8192;
            } else {
        ...
        if (obj27 & 32 != 0) {
            ...
            if (i7 & i28 == 0) {
                i6 = restartGroup.changed(obj2) ? 131072 : 65536;
                $dirty |= i6;
            }
        }
        if (i16 &= $dirty == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, i12, -1, "androidx.compose.foundation.text.selection.SelectionHandle (AndroidSelectionHandles.android.kt:64)");
                }
                ...
                if (i12 & 14 != i8) {
                    if (i12 & 8 != 0 && restartGroup.changedInstance(obj3)) {
                ...
                if (i18 |= changed6 == 0) {
                    ...
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        anon = new AndroidSelectionHandles_androidKt.SelectionHandle.semanticsModifier.1.1(obj3, z2, leftSelectionHandle);
                ...
                AndroidSelectionHandles_androidKt.SelectionHandle.1 anon2 = new AndroidSelectionHandles_androidKt.SelectionHandle.1((ViewConfiguration)this_$iv, l2, 0, leftSelectionHandle, SemanticsModifierKt.semantics$default(obj2, false, (Function1)anon, 1, 0), obj3);
                obj22 = this_$iv;
                AndroidSelectionHandles_androidKt.HandlePopup(obj3, obj25, (Function2)ComposableLambdaKt.rememberComposableLambda(280174801, true, anon2, restartGroup, 54), restartGroup, i15 |= 384);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
        ...
        if (endRestartGroup != null) {
            endRestartGroup = new AndroidSelectionHandles_androidKt.SelectionHandle.2(obj3, z2, obj, z, handleReferencePoint, obj3, obj2, i7, obj27);
            endRestartGroup.updateScope((Function2)endRestartGroup);
        } else {
            minTouchTargetSize2 = handleReferencePoint;
        }
    }
    ...
    public static final void SelectionHandleIcon(Modifier modifier, Function0<Boolean> iconVisible, boolean isLeft, Composer $composer, int $changed) {
        ...
        if ($changed & 48 == 0) {
            i = obj7.changedInstance(iconVisible) ? 32 : 16;
            $dirty |= i;
        }
        if ($changed & 384 == 0) {
            i3 = obj7.changed(isLeft) ? 256 : 128;
            $dirty |= i3;
        }
        if ($dirty & 147 == 146) {
            if (!obj7.getSkipping()) {
    ...
    public static final ImageBitmap createHandleImage(CacheDrawScope $this$createHandleImage, float radius) {
        ...
        canvas2 = HandleImageCache.INSTANCE.getCanvas();
        drawScope = HandleImageCache.INSTANCE.getCanvasDrawScope();
        if (imageBitmap != null && canvas2 != null && iNSTANCE <= imageBitmap.getWidth()) {
            if (canvas2 != null) {
                if (iNSTANCE <= imageBitmap.getWidth()) {
                    if (iNSTANCE > imageBitmap.getHeight()) {
                        ...
                        canvas2 = CanvasKt.Canvas(imageBitmap);
                        HandleImageCache.INSTANCE.setCanvas(canvas2);
