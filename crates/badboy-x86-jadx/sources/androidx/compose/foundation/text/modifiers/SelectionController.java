...
public final class SelectionController implements RememberObserver {
    ...
    public final void draw(DrawScope drawScope) {
        ...
        Object size-NH-jbRc;
        long obj3;
        long $this$withTransform_u24lambda_u246$iv$iv4;
        long l5;
        ...
        if (obj2.params.getShouldClip()) {
            ...
            int i8 = 0;
            drawContext.getTransform().clipRect-N_I0leg(l5, i13, width-impl, height-impl, intersect-rtfAjoo);
            l2 = l5;
            l6 = i13;
            f = width-impl;
            l = height-impl;
            l3 = intersect-rtfAjoo;
            int i9 = 0;
            l4 = context;
            DrawScope.drawPath-LG529CI$default(obj6, path, obj2.backgroundSelectionColor, l5, 0, 0, 0, 0, 60);
            l4.getCanvas().restore();
            l4.setSize-uvyYCjk(drawContext.getSize-NH-jbRc());
            obj3 = obj4;
        } else {
            selection = size-NH-jbRc;
            i7 = i10;
