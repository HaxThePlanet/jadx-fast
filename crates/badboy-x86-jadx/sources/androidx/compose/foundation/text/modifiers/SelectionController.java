...
public final class SelectionController implements RememberObserver {
    ...
    public final void draw(DrawScope drawScope) {
        ...
        Object size-NH-jbRc;
        long obj3;
        long $this$withTransform_u24lambda_u246$iv$iv3;
        long l;
        ...
        if (obj2.params.getShouldClip()) {
            ...
            int i8 = 0;
            drawContext.getTransform().clipRect-N_I0leg(l, i13, width-impl, height-impl, intersect-rtfAjoo);
            l3 = l;
            l2 = i13;
            f = width-impl;
            l5 = height-impl;
            l6 = intersect-rtfAjoo;
            int i9 = 0;
            l4 = context;
            DrawScope.drawPath-LG529CI$default(obj6, path, obj2.backgroundSelectionColor, l, 0, 0, 0, 0, 60);
