...
public final class TextFieldCoreModifierNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, CompositionLocalConsumerModifierNode, GlobalPositionAwareModifierNode, SemanticsModifierNode {
    ...
    private final int calculateOffsetToFollow-72CqOWE(long currSelection, int currTextLayoutSize) {
        ...
        if (previousSelection2 != null && TextRange.getEnd-impl(currSelection) == TextRange.getEnd-impl(previousSelection2.unbox-impl())) {
            i = TextRange.getEnd-impl(currSelection) == TextRange.getEnd-impl(previousSelection2.unbox-impl()) ? i2 : i3;
        } else {
        }
        if (i == 0) {
            start-impl2 = TextRange.getEnd-impl(currSelection);
        } else {
            ...
            if (i2 == 0) {
                start-impl2 = TextRange.getStart-impl(currSelection);
            } else {
