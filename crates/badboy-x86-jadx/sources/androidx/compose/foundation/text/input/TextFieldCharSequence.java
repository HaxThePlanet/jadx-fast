...
public final class TextFieldCharSequence implements java.lang.CharSequence {
    ...
    private TextFieldCharSequence(java.lang.CharSequence text, long selection, TextRange composition, Pair<androidx.compose.foundation.text.input.TextHighlightType, TextRange> highlight) {
        ...
        this.text = text2;
        box-impl = 0;
        this.selection = TextRangeKt.coerceIn-8ffj60Q(selection, composition, box-impl);
        copy$default = 0;
        if (highlight != null) {
            box-impl2 = TextRange.box-impl(TextRangeKt.coerceIn-8ffj60Q(highlight.unbox-impl(), obj3, box-impl));
        } else {
            box-impl2 = copy$default;
        }
        this.composition = box-impl2;
        if (obj10 != null) {
            long unbox-impl = (TextRange)obj10.getSecond().unbox-impl();
            copy$default = Pair.copy$default(obj10, copy$default, TextRange.box-impl(TextRangeKt.coerceIn-8ffj60Q(unbox-impl, obj3, box-impl)), 1, copy$default);
        }
    ...
    public TextFieldCharSequence(java.lang.CharSequence charSequence, long l2, TextRange textRange3, Pair pair4, int i5, DefaultConstructorMarker defaultConstructorMarker6) {
        ...
        obj9 = 0;
        i2 = defaultConstructorMarker6 & 4 != 0 ? obj9 : pair4;
        i = defaultConstructorMarker6 & 8 != 0 ? obj9 : i5;
        super(str, l, obj3, i2, i, 0);
    }
