...
public abstract class TextFieldMagnifierNode extends DelegatingNode implements OnGloballyPositionedModifier, DrawModifierNode, SemanticsModifierNode {
    ...
    @Override // androidx.compose.ui.node.DelegatingNode
    public abstract void update(TransformedTextFieldState transformedTextFieldState, androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState textFieldSelectionState2, TextLayoutState textLayoutState3, boolean z4);
}
