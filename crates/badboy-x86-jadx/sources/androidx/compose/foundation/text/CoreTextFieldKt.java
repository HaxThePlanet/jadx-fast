...
public final class CoreTextFieldKt {
    public static final void CoreTextField(TextFieldValue value, Function1<? super TextFieldValue, Unit> onValueChange, Modifier modifier, TextStyle textStyle, VisualTransformation visualTransformation, Function1<? super TextLayoutResult, Unit> onTextLayout, MutableInteractionSource interactionSource, Brush cursorBrush, boolean softWrap, int maxLines, int minLines, ImeOptions imeOptions, androidx.compose.foundation.text.KeyboardActions keyboardActions, boolean enabled, boolean readOnly, Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit> decorationBox, Composer $composer, int $changed, int $changed1, int i20) {
        ...
        Object i17;
        androidx.compose.foundation.text.LegacyTextFieldState bringIntoViewRequester3;
        Object state;
        int $i$f$cache4;
        androidx.compose.foundation.text.LegacyTextFieldState manager3;
        ImeOptions state2;
        ...
        androidx.compose.foundation.text.LegacyTextFieldState imeOptions3;
        int i18;
        int i39;
        int i51;
        int enabled3;
        ...
        int i13;
        int i22;
        androidx.compose.foundation.text.CoreTextFieldKt.CoreTextField.pointerModifier.2.1 companion7;
        int i43;
        int companion6;
        int $composer2;
        int i31;
        ...
        if (i112 & 1 != 0) {
            ...
            if (i62 & 6 == 0) {
                i38 = restartGroup.changed(obj23) ? 4 : 2;
                $dirty |= i38;
            }
        }
        if (i112 & 2 != 0) {
        ...
        if (i28 != 0) {
            ...
            if (i62 & 384 == 0) {
                i55 = restartGroup.changed(modifier) ? 256 : 128;
                $dirty |= i55;
            } else {
                obj18 = modifier;
            }
        ...
        if (i206 != 0) {
            ...
            if (i62 & 3072 == 0) {
                i32 = restartGroup.changed(textStyle) ? 2048 : 1024;
                $dirty |= i32;
            } else {
                i17 = textStyle;
            }
        ...
        if (keyboardActions2 != 0) {
            ...
            if (i62 & 24576 == 0) {
                i53 = restartGroup.changed(visualTransformation) ? 16384 : 8192;
                $dirty |= i53;
            } else {
                obj11 = visualTransformation;
            }
        ...
        if (readOnly3 != 0) {
            ...
            if (i62 & i48 == 0) {
                i22 = restartGroup.changedInstance(onTextLayout) ? 131072 : 65536;
                $dirty |= i22;
            } else {
                unspecified-0d7_KjU = onTextLayout;
            }
        ...
        if (i221 != 0) {
            ...
            if (i62 & companion6 == 0) {
                $composer2 = restartGroup.changed(interactionSource) ? 1048576 : 524288;
                $dirty |= $composer2;
            } else {
                obj7 = interactionSource;
            }
        ...
        if (i154 != 0) {
            ...
            if (i62 & i21 == 0) {
                i21 = restartGroup.changed(cursorBrush) ? 8388608 : 4194304;
                $dirty |= i21;
            } else {
                obj12 = cursorBrush;
            }
        ...
        if (i63 != 0) {
            ...
            if ($changed & i231 == 0) {
                minLines3 = i63;
                i36 = restartGroup.changed(softWrap) ? 67108864 : 33554432;
                $dirty |= i36;
            } else {
                minLines3 = i63;
                z3 = softWrap;
        ...
        if (i64 != 0) {
            ...
            if ($changed & i234 == 0) {
                backgroundColor-0d7_KjU = i64;
                i60 = restartGroup.changed(maxLines) ? 536870912 : 268435456;
                $dirty |= i60;
            } else {
                backgroundColor-0d7_KjU = i64;
                i5 = maxLines;
        ...
        if (i65 != 0) {
            ...
            if (i93 & 6 == 0) {
                i3 = i65;
                i4 = restartGroup.changed(minLines) ? 4 : 2;
                $dirty1 |= i4;
            } else {
                i3 = i65;
                i52 = minLines;
        ...
        if (i93 & 48 == 0) {
            if (i112 & 2048 == 0) {
                changed6 = restartGroup.changed(imeOptions) ? 32 : 16;
            } else {
                obj14 = imeOptions;
            }
            $dirty1 |= changed6;
        ...
        if (i66 != 0) {
            ...
            i7 = i66;
            if (i93 & 384 == 0) {
                i39 = restartGroup.changed(keyboardActions) ? 256 : 128;
                $dirty1 |= i39;
            } else {
                obj15 = keyboardActions;
            }
        ...
        if (i68 != 0) {
            ...
            i51 = i68;
            if (i93 & 3072 == 0) {
                changed3 = restartGroup.changed(enabled) ? 2048 : 1024;
                $dirty1 |= changed3;
            } else {
                z = enabled;
            }
        ...
        if (i69 != 0) {
            ...
            i33 = i69;
            if (i93 & 24576 == 0) {
                i24 = restartGroup.changed(readOnly) ? 16384 : 8192;
                $dirty1 |= i24;
            } else {
                z2 = readOnly;
            }
        ...
        if (i26 != 0) {
            ...
            if (i93 & i48 == 0) {
                i48 = restartGroup.changedInstance(decorationBox) ? 131072 : 65536;
                $dirty1 |= i48;
            } else {
                obj19 = decorationBox;
            }
                ...
                if (!restartGroup.getSkipping()) {
                    ...
                    if ($changed & 1 != 0) {
                        if (restartGroup.getDefaultsInvalid()) {
                            ...
                            maxLines5 = backgroundColor-0d7_KjU != 0 ? 0x7fffffff /* Unknown resource */ : maxLines;
                            ...
                            enabled3 = i51 != 0 ? 1 : enabled;
                            readOnly3 = i33 != 0 ? 0 : readOnly;
                            if (i26 != 0) {
                                decorationBox2 = ComposableSingletons.CoreTextFieldKt.INSTANCE.getLambda-1$foundation_release();
                                i16 = $dirty1;
                                $dirty12 = keyboardActions4;
                                keyboardActions2 = onTextLayout3;
                                onTextLayout2 = obj7;
                                interactionSource3 = visualTransformation5;
                    ...
                    $this$cache$iv = $i$a$CacheCoreTextFieldKt$CoreTextField$focusRequester$1;
                    ...
                    $this$cache$iv3 = $i$a$CacheCoreTextFieldKt$CoreTextField$legacyTextInputServiceAdapter$1;
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    int i180 = 1;
                    if (maxLines5 == i180 && obj66 == null && imeOptions2.getSingleLine()) {
                        if (obj66 == null) {
                            i7 = imeOptions2.getSingleLine() ? i180 : 0;
                        } else {
                        }
                    } else {
                    }
                    horizontal = i7 != 0 ? Orientation.Horizontal : Orientation.Vertical;
                    ...
                    if (!restartGroup.changed(orientation2)) {
                        ...
                        if (it$iv4 == Composer.Companion.getEmpty()) {
                            ...
                            obj60 = it$iv4;
                            it$iv4 = new CoreTextFieldKt.CoreTextField.scrollerPosition.1.1(orientation2);
                            obj59.updateRememberedValue((Function0)it$iv4);
                        } else {
                            composer2 = obj59;
                            obj60 = it$iv4;
                        }
                    ...
                    if (obj59 | i45 == 0) {
                        ...
                        if (filterWithValidation == Composer.Companion.getEmpty()) {
                            ...
                            filterWithValidation = ValidatingOffsetMappingKt.filterWithValidation(interactionSource3, obj23.getAnnotatedString());
                            composition-MzsxiRA = obj23.getComposition-MzsxiRA();
                            if (composition-MzsxiRA != null) {
                                companion8 = unbox-impl;
                                obj61 = maxLines5;
                                composition-MzsxiRA = 0;
                                interactionSource2 = onTextLayout2;
                                if (TextFieldDelegate.Companion.applyCompositionDecoration-72CqOWE(composition-MzsxiRA.unbox-impl(), maxLines5) == null) {
                    ...
                    int i258 = 0;
                    obj60 = text;
                    it$iv6 = composer22.rememberedValue();
                    int i260 = 0;
                    if (!changed) {
                        invalid$iv2 = changed;
                        if (it$iv6 == Composer.Companion.getEmpty()) {
                            ...
                            obj3 = obj66;
                            obj10 = obj67;
                            it$iv6 = new LegacyTextFieldState(obj59, currentRecomposeScope, consume);
                            composer22.updateRememberedValue(it$iv6);
                        } else {
                            str2 = obj60;
                            i44 = obj66;
                            obj4 = obj67;
                    ...
                    obj68 = obj32;
                    obj62 = obj4;
                    obj59.update-fnh65Uc(obj23.getAnnotatedString(), str2, obj62, i44, obj3, obj10, onValueChange, obj67, obj68, (TextSelectionColors)restartGroup.consume((CompositionLocal)TextSelectionColorsKt.getLocalTextSelectionColors()).getBackgroundColor-0d7_KjU());
                    ...
                    int i246 = 0;
                    obj59 = i72;
                    it$iv5 = composer17.rememberedValue();
                    int i259 = 0;
                    if (it$iv5 == Composer.Companion.getEmpty()) {
                        obj60 = it$iv5;
                        obj61 = i92;
                        companion = onTextLayout2;
                        obj5 = focusManager;
                        it$iv5 = new UndoManager(0, 1, 0);
                        composer17.updateRememberedValue(it$iv5);
                    } else {
                        obj60 = it$iv5;
                        companion = onTextLayout2;
                        obj5 = focusManager;
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    obj60 = value;
                    UndoManager.snapshotIfNeeded$default((UndoManager)it$iv5, obj60, 0, obj62, 2);
                    ComposerKt.sourceInformationMarkerStart(composer13, -1705276454, str4);
                    Composer composer7 = composer13;
                    obj59 = i96;
                    it$iv14 = composer7.rememberedValue();
                    int i248 = 0;
                    obj60 = i184;
                    if (it$iv14 == Composer.Companion.getEmpty()) {
                        empty = 0;
                        obj61 = it$iv14;
                        it$iv14 = new TextFieldSelectionManager(it$iv5);
                        composer7.updateRememberedValue(it$iv14);
                    } else {
                        obj61 = it$iv14;
                    }
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    (TextFieldSelectionManager)it$iv14.setOffsetMapping$foundation_release(offsetMapping3);
                    it$iv14.setVisualTransformation$foundation_release(interactionSource3);
                    it$iv14.setOnValueChange$foundation_release(field4.getOnValueChange());
                    it$iv14.setState$foundation_release(field4);
                    it$iv14.setValue$foundation_release(obj60);
                    int i185 = 0;
                    int i249 = 0;
                    ComposerKt.sourceInformationMarkerStart(composer13, 2023513938, textStyle4);
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    it$iv14.setClipboardManager$foundation_release((ClipboardManager)composer13.consume((CompositionLocal)CompositionLocalsKt.getLocalClipboardManager()));
                    int i122 = 0;
                    int i186 = 0;
                    ComposerKt.sourceInformationMarkerStart(composer13, 2023513938, textStyle4);
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    it$iv14.setTextToolbar((TextToolbar)composer13.consume((CompositionLocal)CompositionLocalsKt.getLocalTextToolbar()));
                    int i84 = 0;
                    int i123 = 0;
                    ComposerKt.sourceInformationMarkerStart(composer13, 2023513938, textStyle4);
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    it$iv14.setHapticFeedBack((HapticFeedback)composer13.consume((CompositionLocal)CompositionLocalsKt.getLocalHapticFeedback()));
                    it$iv14.setFocusRequester((FocusRequester)$this$cache$iv);
                    it$iv14.setEditable(enabled2 ^ 1);
                    it$iv14.setEnabled(modifier3);
                    ...
                    i35 = i16 & 7168 == 2048 ? 1 : 0;
                    i57 = i16 & i242 == 16384 ? 1 : 0;
                    i34 = obj73 & 14 == 4 ? 1 : 0;
                    if (i194 ^= 48 > 32) {
                    ...
                    if (i136 |= changedInstance18 == 0) {
                        if (rememberedValue == Composer.Companion.getEmpty()) {
                            ...
                            it$iv9 = modifier3;
                            enabled4 = obj67;
                            bringIntoViewRequester3 = field4;
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    Object obj24 = interactionSource2;
                    Modifier textFieldFocusModifier = TextFieldGestureModifiersKt.textFieldFocusModifier((Modifier)Modifier.Companion, it$iv9, $this$cache$iv, obj24, (Function1)$i$a$CacheCoreTextFieldKt$CoreTextField$focusModifier$1);
                    if (it$iv9 != 0 && enabled2 == 0) {
                        i30 = enabled2 == 0 ? 1 : 0;
                    } else {
                    }
                    State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Boolean.valueOf(i30), composer13, 0);
                    companion7 = it$iv9;
                    ...
                    if (obj59 | i11 == 0) {
                        ...
                        if (rememberedValue2 == Composer.Companion.getEmpty()) {
                            ...
                            obj59 = anon5;
                            super(bringIntoViewRequester3, obj61, offsetMapping2, enabled4, imeOptions2, 0);
                            companion5 = obj61;
                    ...
                    int i254 = 0;
                    if (!composer13.changedInstance(bringIntoViewRequester3)) {
                        obj60 = $i$f$cache2;
                        if (it$iv2 == Composer.Companion.getEmpty()) {
                            $i$f$cache2 = 0;
                            obj61 = it$iv2;
                            it$iv2 = new CoreTextFieldKt.CoreTextField.pointerModifier.1.1(bringIntoViewRequester3);
                    ...
                    i19 = i16 & i242 == 16384 ? 1 : 0;
                    i49 = i16 & 7168 == 2048 ? 1 : 0;
                    ...
                    if (i101 |= changedInstance5 == 0) {
                        if (rememberedValue3 == Composer.Companion.getEmpty()) {
                            ...
                            obj61 = i198;
                            obj67 = enabled4;
                            $i$a$CacheCoreTextFieldKt$CoreTextField$pointerModifier$2 = companion7;
                            manager2 = obj65;
                            $i$f$cache5 = obj59;
                            it$iv = bringIntoViewRequester3;
                            state = obj69;
                        }
                    } else {
                        obj65 = state3;
                    ...
                    obj69 = state;
                    Modifier pointerHoverIcon$default = PointerIconKt.pointerHoverIcon$default(SelectionGesturesKt.selectionGestureInput(TextFieldPressGestureFilterKt.tapPressTextFieldModifier(SelectionGesturesKt.updateSelectionTouchMode((Modifier)Modifier.Companion, (Function1)it$iv2), obj24, $i$a$CacheCoreTextFieldKt$CoreTextField$pointerModifier$2, (Function1)$i$f$cache5), obj67.getMouseSelectionObserver$foundation_release(), obj67.getTouchSelectionObserver$foundation_release()), TextPointerIcon_androidKt.getTextPointerIcon(), false, 2, 0);
                    ComposerKt.sourceInformationMarkerStart(composer13, -1705122293, str4);
                    i8 = obj73 & 14 == 4 ? 1 : 0;
                    Composer composer19 = composer13;
                    $i$f$cache4 = 0;
                    it$iv15 = composer19.rememberedValue();
                    int i208 = 0;
                    if (i173 |= changedInstance19 == 0) {
                        ...
                        if (it$iv15 == Composer.Companion.getEmpty()) {
                            $i$f$cache4 = 0;
                            obj62 = it$iv15;
                            it$iv15 = new CoreTextFieldKt.CoreTextField.drawModifier.1.1(it$iv, textInputService, manager2);
                            composer19.updateRememberedValue((Function1)it$iv15);
                        } else {
                            obj62 = it$iv15;
                        }
                    } else {
                    ...
                    obj59 = it$iv;
                    i6 = i16 & 7168 == 2048 ? 1 : 0;
                    Object obj29 = companion8;
                    Object obj31 = obj67;
                    i37 = obj73 & 14 == 4 ? 1 : 0;
                    ...
                    boolean z4 = interactionSource3 instanceof PasswordVisualTransformation;
                    ComposerKt.sourceInformationMarkerStart(composer13, -1705046115, str4);
                    i42 = obj73 & 14 == 4 ? 1 : 0;
                    i43 = i16;
                    i40 = i16 & 7168 == 2048 ? 1 : 0;
                    i29 = i43 & i242 == 16384 ? 1 : 0;
                    if (i152 ^= 48 > 32) {
                        if (!composer13.changed(imeOptions2)) {
                            i41 = i43 & 48 == 32 ? 1 : 0;
                        } else {
                    ...
                    if (empty3 == 0) {
                        ...
                        if (rememberedValue5 == Composer.Companion.getEmpty()) {
                            ...
                            obj59 = anon;
                            obj62 = i58;
                            super(companion, value, obj62, obj63, enabled2, obj65, obj66, manager2, obj68, obj69);
                            companion6 = obj63;
                            state2 = obj65;
                            imeOptions3 = obj66;
                            manager = obj69;
                            ...
                            imeOptions3 = manager3;
                            state2 = obj59;
                            companion6 = obj63;
                            obj61 = i160;
                            $i$a$CacheCoreTextFieldKt$CoreTextField$semanticsModifier$1 = i58;
                            $i$f$cache3 = obj59;
                            it$iv13 = windowInfo;
                            manager = obj69;
                        }
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    Modifier semantics = SemanticsModifierKt.semantics((Modifier)Modifier.Companion, true, (Function1)$i$f$cache3);
                    if ($i$a$CacheCoreTextFieldKt$CoreTextField$semanticsModifier$1 != 0 && enabled2 == 0 && obj13.isWindowFocused() && !imeOptions3.hasHighlight()) {
                        if (enabled2 == 0) {
                            if (obj13.isWindowFocused()) {
                                i25 = !imeOptions3.hasHighlight() ? 1 : 0;
                            } else {
                            }
                        } else {
                        }
                    ...
                    int i269 = 0;
                    if (!composer13.changedInstance(it$iv13)) {
                        obj72 = onGloballyPositioned;
                        if (it$iv3 == Composer.Companion.getEmpty()) {
                            int onPositionedModifier2 = 0;
                            obj61 = it$iv3;
                            it$iv3 = new CoreTextFieldKt.CoreTextField.3.1(it$iv13);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    EffectsKt.DisposableEffect(it$iv13, (Function1)it$iv3, composer13, 0);
                    ...
                    $i$f$cache = 0;
                    it$iv10 = composer15.rememberedValue();
                    int i230 = 0;
                    if (i109 |= i54 == 0) {
                        obj60 = $i$f$cache;
                        if (it$iv10 == Composer.Companion.getEmpty()) {
                            $i$f$cache = 0;
                            obj61 = it$iv10;
                            it$iv10 = new CoreTextFieldKt.CoreTextField.4.1(imeOptions3, offsetMapping2, obj61, state2);
                            composer15.updateRememberedValue((Function1)it$iv10);
                        } else {
                            obj61 = it$iv10;
                        }
                    } else {
                    ...
                    ComposerKt.sourceInformationMarkerEnd(composer13);
                    EffectsKt.DisposableEffect(state2, (Function1)it$iv10, composer13, i164 &= 14);
                    int i153 = maxLines3;
                    int i111 = 1;
                    i31 = i153 == i111 ? i111 : 0;
                    obj61 = obj67;
                    Modifier textFieldKeyInput-2WJ9YEU = TextFieldKeyInputKt.textFieldKeyInput-2WJ9YEU((Modifier)Modifier.Companion, imeOptions3, obj61, value, imeOptions3.getOnValueChange(), enabled2 ^ 1, i31, manager2, it$iv5, state2.getImeAction-eUduSuo());
                    Object obj28 = obj61;
                    ...
                    if (empty2 == 0) {
                        ...
                        if (it$iv8 == Composer.Companion.getEmpty()) {
                            int invalid$iv4 = 0;
                            obj61 = it$iv8;
                            it$iv8 = new CoreTextFieldKt.CoreTextField.stylusHandwritingModifier.1.1(imeOptions3, manager, state2, obj27);
                            obj59.updateRememberedValue((Function0)it$iv8);
                        } else {
                            composer5 = obj59;
                            obj61 = it$iv8;
                        }
                    ...
                    Modifier stylusHandwriting = StylusHandwritingKt.stylusHandwriting((Modifier)Modifier.Companion, CoreTextFieldKt.CoreTextField$lambda$11(companion5), (Function0)it$iv8);
                    Object obj25 = obj33;
                    Object obj26 = obj5;
                    CoreTextFieldKt.CoreTextField.decorationBoxModifier.1 scrollerPosition2 = new CoreTextFieldKt.CoreTextField.decorationBoxModifier.1(imeOptions3);
                    if ($i$a$CacheCoreTextFieldKt$CoreTextField$semanticsModifier$1 != 0 && imeOptions3.getHasFocus() && imeOptions3.isInTouchMode() && obj13.isWindowFocused()) {
                        if (imeOptions3.getHasFocus()) {
                            if (imeOptions3.isInTouchMode()) {
                                i9 = obj13.isWindowFocused() ? 1 : 0;
                            } else {
                            }
                        } else {
                        }
                    ...
                    Object enabled6 = obj4;
                    Object imeOptions5 = obj9;
                    visualTransformation3 = obj59;
                    $composer2 = obj63;
                    minLines3 = obj70;
                    scrollerPosition = obj71;
                    bringIntoViewRequester2 = stylusHandwriting;
                    density = semantics;
                    textStyle2 = textFieldKeyInput-2WJ9YEU;
                    OffsetMapping drawModifier3 = manager2;
                    androidx.compose.foundation.text.LegacyTextFieldState stylusHandwritingModifier = imeOptions3;
                    int semanticsModifier = i261;
                    showHandleAndMagnifier = obj73;
                    maxLines4 = pointerHoverIcon$default;
                    Object offsetMapping5 = obj28;
                    Function3 pointerModifier = decorationBox2;
                    decorationBox4 = manager;
                    androidx.compose.ui.Modifier.Companion focusRequester3 = textFieldMagnifier;
                    CoreTextFieldKt.CoreTextField.5 decorationBoxModifier2 = new CoreTextFieldKt.CoreTextField.5(pointerModifier, stylusHandwritingModifier, enabled6, interactionSource5, semanticsModifier, modifier6, value, focusManager2, TextFieldCursorKt.cursor((Modifier)Modifier.Companion, imeOptions3, obj61, manager2, obj63, obj64), legacyTextInputServiceAdapter3, obj72, focusRequester3, imeOptions5, offsetMapping5, i9, enabled2, keyboardActions2, drawModifier3, obj3);
                    ...
                    decorationBox3 = keyboardActions2;
                } else {
                    restartGroup.skipToGroupEnd();
                    i15 = softWrap;
                    ...
                    i43 = $dirty1;
                    obj6 = obj7;
                    decorationBox3 = unspecified-0d7_KjU;
                    maxLines2 = obj11;
                    minLines4 = i17;
                    obj = obj18;
        ...
        if (endRestartGroup != null) {
            $composer3 = bringIntoViewRequester;
            endRestartGroup = new CoreTextFieldKt.CoreTextField.6(value, onValueChange, obj, minLines4, maxLines2, decorationBox3, obj6, visualTransformation4, i15, i56, onPositionedModifier, imeOptions4, keyboardActions3, i27, i18, readOnly2, $changed, $changed1, i20);
    ...
    private static final void CoreTextFieldRootBox(Modifier modifier, TextFieldSelectionManager manager, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (i13 & 6 == 0) {
            i12 = restartGroup.changed(obj) ? 4 : 2;
            $dirty |= i12;
        }
        if (i13 & 48 == 0) {
        ...
        if (i13 & 384 == 0) {
            i9 = restartGroup.changedInstance(obj3) ? 256 : 128;
            $dirty |= i9;
        }
        if ($dirty & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                if (show) {
                        ...
                        if (state$foundation_release != null) {
                            ...
                            if (state$foundation_release != null) {
                                ...
                                if (state$foundation_release2 != null) {
                                    ...
                                    layoutResultStale = i7;
                                }
                                if (layoutResultStale == 0) {
                                    i = state$foundation_release;
                                }
                            }
                        }
                    }
                    if (i == 0) {
                        ...
                        if (!TextRange.getCollapsed-impl(obj.getValue$foundation_release().getSelection-d9O1mEE())) {
                            ...
                            if (showSelectionHandleStart != null && showSelectionHandleStart.getShowSelectionHandleStart() == i7) {
                                i3 = showSelectionHandleStart.getShowSelectionHandleStart() == i7 ? i7 : i5;
                            } else {
                            }
                            if (i3 != 0) {
                                obj14.startReplaceGroup(-1680216289);
                                ComposerKt.sourceInformation(obj14, "1158@51449L203");
                                TextFieldSelectionManagerKt.TextFieldSelectionHandle(i7, i.getBidiRunDirection(obj.getOffsetMapping$foundation_release().originalToTransformed(TextRange.getStart-impl(obj.getValue$foundation_release().getSelection-d9O1mEE()))), manager, obj14, i18 |= 6);
                            ...
                            if (showSelectionHandleEnd != null && showSelectionHandleEnd.getShowSelectionHandleEnd() == i7) {
                                if (showSelectionHandleEnd.getShowSelectionHandleEnd() == i7) {
                                } else {
                                    i7 = i5;
                                }
                            } else {
                            ...
                            if (i7 != 0) {
                                ...
                                TextFieldSelectionManagerKt.TextFieldSelectionHandle(i5, i.getBidiRunDirection(Math.max(originalToTransformed + -1, i5)), manager, obj14, i12 |= 6);
                                obj14.endReplaceGroup();
                            } else {
                        ...
                        if (textFieldState != null && obj.isTextChanged$foundation_release()) {
                            ...
                            if (obj.isTextChanged$foundation_release()) {
                                textFieldState.setShowFloatingToolbar(i5);
                            }
    ...
    public static final void TextFieldCursorHandle(TextFieldSelectionManager manager, Composer $composer, int $changed) {
        ...
        i2 = 2;
        if (i7 & 6 == 0) {
            $i$a$CacheCoreTextFieldKt$TextFieldCursorHandle$2 = restartGroup.changedInstance(obj) ? 4 : i2;
            $dirty2 |= $i$a$CacheCoreTextFieldKt$TextFieldCursorHandle$2;
        }
        ...
        if (i23 & 3 == i2) {
            if (!restartGroup.getSkipping()) {
                ...
                if (showCursorHandle != null && showCursorHandle.getShowCursorHandle() == $dirty) {
                    i6 = showCursorHandle.getShowCursorHandle() == $dirty ? $dirty : 0;
                } else {
                }
                if (i6 != 0) {
                    ...
                    if (transformedText$foundation_release != null) {
                        ...
                        i6 = transformedText$foundation_release == $dirty ? $dirty : 0;
                    } else {
                    }
                    if (i6 != 0) {
                        ...
                        int i17 = 0;
                        int i20 = 0;
                        empty = "CC:CompositionLocal.kt#9igjgp";
                        ComposerKt.sourceInformationMarkerStart(restartGroup, 2023513938, empty);
                        ComposerKt.sourceInformationMarkerEnd(restartGroup);
                        ...
                        if (!restartGroup.changed(cursorPosition-tuRUvjQ$foundation_release)) {
                            if (rememberedValue3 == Composer.Companion.getEmpty()) {
                                empty3 = 0;
                                anon2 = new CoreTextFieldKt.TextFieldCursorHandle.1.1(cursorPosition-tuRUvjQ$foundation_release, empty);
                        ...
                        if (!restartGroup.changed(cursorPosition-tuRUvjQ$foundation_release)) {
                            if (rememberedValue == Composer.Companion.getEmpty()) {
                                empty2 = 0;
                                anon3 = new CoreTextFieldKt.TextFieldCursorHandle.3.1(cursorPosition-tuRUvjQ$foundation_release, empty);
                        ...
                        ComposerKt.sourceInformationMarkerEnd(restartGroup);
                        i3 = 0;
                        AndroidCursorHandle_androidKt.CursorHandle-USBMPiE(companion, SemanticsModifierKt.semantics$default(SuspendingPointerInputFilterKt.pointerInput((Modifier)Modifier.Companion, invalid$iv, (Function2)anon), i3, (Function1)anon3, 1, 0), 0, i3, restartGroup, 0);
