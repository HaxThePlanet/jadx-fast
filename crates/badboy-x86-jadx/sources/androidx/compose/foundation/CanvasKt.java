...
public final class CanvasKt {
    public static final void Canvas(Modifier modifier, String contentDescription, Function1<? super DrawScope, Unit> onDraw, Composer $composer, int $changed) {
        ...
        if ($changed & 6 == 0) {
            i4 = obj14.changed(modifier) ? 4 : 2;
            $dirty |= i4;
        }
        i3 = 32;
        if ($changed & 48 == 0) {
            i5 = obj14.changed(contentDescription) ? i3 : 16;
            $dirty |= i5;
        }
        if ($changed & 384 == 0) {
            i = obj14.changedInstance(onDraw) ? 256 : 128;
            $dirty |= i;
        }
        if ($dirty & 147 == 146) {
            if (!obj14.getSkipping()) {
                ...
                SpacerKt.Spacer(SemanticsModifierKt.semantics$default(DrawModifierKt.drawBehind(modifier, onDraw), i8, (Function1)anon, str, 0), obj14, i8);
                if (ComposerKt.isTraceInProgress()) {
