...
final class AspectRatioNode extends Modifier.Node implements LayoutModifierNode {
    ...
    private final long findSize-ToXhtMw(long $this$findSize_u2dToXhtMw) {
        ...
        if (!this.matchHeightConstraintsFirst) {
            ...
            i3 = 1;
            obj9 = AspectRatioNode.tryMinHeight-JN-0ABg$default(this, aspectRatioNode, obj4, 0, i3);
            int i14 = 0;
            if (!IntSize.equals-impl0(obj9, obj10)) {
                return obj9;
            }
            ...
            i3 = 1;
            obj9 = AspectRatioNode.tryMinWidth-JN-0ABg$default(this, aspectRatioNode, obj4, 0, i3);
            int i7 = 0;
            if (!IntSize.equals-impl0(obj9, obj10)) {
                return obj9;
            }
