...
public final class WithAlignmentLineBlockElement extends ModifierNodeElement<androidx.compose.foundation.layout.SiblingsAlignedNode.WithAlignmentLineBlockNode> {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof WithAlignmentLineBlockElement) {
            obj = other;
        } else {
            obj = 0;
        }
    ...
    public void update(Modifier.Node node) {
        update((SiblingsAlignedNode.WithAlignmentLineBlockNode)node);
    }
}
