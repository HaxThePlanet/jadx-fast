...
final class OffsetPxNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        OffsetPxNode.measure.1 anon = new OffsetPxNode.measure.1(this, $this$measure_u2d3p2s80s, measure-BRTryo0);
    ...
    public final void setOffset(Function1<? super Density, IntOffset> <set-?>) {
        this.offset = <set-?>;
    }
