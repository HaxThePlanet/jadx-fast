...
public abstract class LongIntMap {
    ...
    public boolean equals(Object other) {
        ...
        j$iv$iv = 0;
        if (obj2 instanceof LongIntMap == null) {
            return j$iv$iv;
        }
        if ((LongIntMap)obj2.getSize() != i2.getSize()) {
            return j$iv$iv;
        }
        obj = this;
        final int i14 = 0;
    ...
    public final String joinToString(java.lang.CharSequence separator, java.lang.CharSequence prefix, java.lang.CharSequence postfix, int limit, java.lang.CharSequence truncated, Function2<? super Long, ? super Integer, ? extends java.lang.CharSequence> transform) {
        ...
        int i7;
        int i2;
        int $i$a$BuildStringLongIntMap$joinToString$2;
        int i8;
        long l;
        int i6;
        int i9;
        ...
        if (0 <= i11) {
            ...
            $i$a$BuildStringLongIntMap$joinToString$2 = $this$maskEmptyOrDeleted$iv$iv$iv;
