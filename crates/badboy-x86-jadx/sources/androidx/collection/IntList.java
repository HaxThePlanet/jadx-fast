...
public abstract class IntList {
    ...
    public IntList(int i, DefaultConstructorMarker defaultConstructorMarker2) {
        super(i);
    }
    ...
    public static String joinToString$default(androidx.collection.IntList intList, java.lang.CharSequence charSequence2, java.lang.CharSequence charSequence3, java.lang.CharSequence charSequence4, int i5, java.lang.CharSequence charSequence6, int i7, Object object8) {
        String obj2;
        String obj3;
        String obj4;
        int obj5;
        ...
        if (object8 != null) {
            ...
            return intList.joinToString(obj2, obj3, obj4, obj5, obj8);
        }
    ...
    public static String joinToString$default(androidx.collection.IntList $this, java.lang.CharSequence separator, java.lang.CharSequence prefix, java.lang.CharSequence postfix, int limit, java.lang.CharSequence truncated, Function1 transform, int i8, Object object9) {
        String separator2;
        String prefix2;
        String postfix2;
        int limit2;
        ...
        if (object9 != null) {
            ...
            while (i$iv < obj2._size) {
                ...
                sb.append((CharSequence)obj.invoke(Integer.valueOf(obj2.content[i$iv])));
                i$iv++;
                separator2 = obj18;
                prefix2 = obj19;
    ...
    public final boolean containsAll(androidx.collection.IntList elements) {
        ...
        int i3 = 0;
        final int i5 = 0;
        IntRange this_$iv = RangesKt.until(i5, obj._size);
    ...
    public final int elementAtOrElse(int index, Function1<? super Integer, Integer> defaultValue) {
        ...
        if (i == 0) {
            return (Number)defaultValue.invoke(Integer.valueOf(index)).intValue();
        }
        return this.content[index];
    }
    ...
    public final int first() {
        ...
        NoSuchElementException noSuchElementException = new NoSuchElementException("IntList is empty.");
    ...
    public final <R> R foldRightIndexed(R initial, Function3<? super Integer, ? super Integer, ? super R, ? extends R> operation) {
        ...
        while (-1 < i$iv) {
            i3 = 0;
            acc = operation.invoke(Integer.valueOf(i$iv), Integer.valueOf(obj.content[i$iv]), acc);
            i$iv--;
        }
        return acc;
    }
    ...
    public final void forEach(Function1<? super Integer, Unit> block) {
        ...
        i = 0;
        while (i < this._size) {
            block.invoke(Integer.valueOf(this.content[i]));
            i++;
        }
    }
    ...
    public final void forEachIndexed(Function2<? super Integer, ? super Integer, Unit> block) {
        ...
        i = 0;
        while (i < this._size) {
            block.invoke(Integer.valueOf(i), Integer.valueOf(this.content[i]));
            i++;
        }
    }
    ...
    public final String joinToString() {
        return IntList.joinToString$default(this, 0, 0, 0, 0, 0, 31, 0);
    }

    public final String joinToString(java.lang.CharSequence charSequence) {
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        return IntList.joinToString$default(this, charSequence, 0, 0, 0, 0, 30, 0);
    }

    public final String joinToString(java.lang.CharSequence charSequence, java.lang.CharSequence charSequence2) {
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        return IntList.joinToString$default(this, charSequence, charSequence2, 0, 0, 0, 28, 0);
    }
    ...
    public final String joinToString(java.lang.CharSequence charSequence, java.lang.CharSequence charSequence2, java.lang.CharSequence charSequence3) {
        ...
        return IntList.joinToString$default(this, charSequence, charSequence2, charSequence3, 0, 0, 24, 0);
    }
    ...
    public final String joinToString(java.lang.CharSequence charSequence, java.lang.CharSequence charSequence2, java.lang.CharSequence charSequence3, int i4) {
        ...
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        Intrinsics.checkNotNullParameter(charSequence3, "postfix");
        return IntList.joinToString$default(this, charSequence, charSequence2, charSequence3, i4, 0, 16, 0);
    }
    ...
    public final String joinToString(java.lang.CharSequence separator, java.lang.CharSequence prefix, Function1<? super Integer, ? extends java.lang.CharSequence> transform) {
        ...
        while (i$iv$iv < obj4._size) {
            ...
            sb.append((CharSequence)obj3.invoke(Integer.valueOf(obj4.content[i$iv$iv])));
            i$iv$iv++;
            obj = separator;
            obj2 = prefix;
            sb.append(obj);
    ...
    public final String joinToString(java.lang.CharSequence separator, Function1<? super Integer, ? extends java.lang.CharSequence> transform) {
        ...
        while (i$iv$iv < obj3._size) {
            ...
            sb.append((CharSequence)obj2.invoke(Integer.valueOf(obj3.content[i$iv$iv])));
            i$iv$iv++;
            obj = separator;
    ...
    public String toString() {
        return IntList.joinToString$default(this, 0, (CharSequence)"[", (CharSequence)"]", 0, 0, 25, 0);
    }
}
