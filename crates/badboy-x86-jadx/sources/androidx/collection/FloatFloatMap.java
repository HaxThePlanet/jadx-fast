...
public abstract class FloatFloatMap {
    ...
    public static String joinToString$default(androidx.collection.FloatFloatMap floatFloatMap, java.lang.CharSequence charSequence2, java.lang.CharSequence charSequence3, java.lang.CharSequence charSequence4, int i5, java.lang.CharSequence charSequence6, int i7, Object object8) {
        String obj2;
        String obj3;
        String obj4;
        int obj5;
        ...
        if (object8 != null) {
            ...
            return floatFloatMap.joinToString(obj2, obj3, obj4, obj5, obj8);
        }
    ...
    public static String joinToString$default(androidx.collection.FloatFloatMap $this, java.lang.CharSequence separator, java.lang.CharSequence prefix, java.lang.CharSequence postfix, int limit, java.lang.CharSequence truncated, Function2 transform, int i8, Object object9) {
        String separator2;
        String prefix2;
        int m$iv$iv;
        String postfix2;
    ...
    public boolean equals(Object other) {
        ...
        j$iv$iv = 0;
        if (obj2 instanceof FloatFloatMap == null) {
            return j$iv$iv;
        }
        if ((FloatFloatMap)obj2.getSize() != obj.getSize()) {
            return j$iv$iv;
        }
        Object obj5 = this;
        final int i13 = 0;
    ...
    public final String joinToString() {
        return FloatFloatMap.joinToString$default(this, 0, 0, 0, 0, 0, 31, 0);
    }

    public final String joinToString(java.lang.CharSequence charSequence) {
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        return FloatFloatMap.joinToString$default(this, charSequence, 0, 0, 0, 0, 30, 0);
    }

    public final String joinToString(java.lang.CharSequence charSequence, java.lang.CharSequence charSequence2) {
        Intrinsics.checkNotNullParameter(charSequence, "separator");
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        return FloatFloatMap.joinToString$default(this, charSequence, charSequence2, 0, 0, 0, 28, 0);
    }
    ...
    public final String joinToString(java.lang.CharSequence charSequence, java.lang.CharSequence charSequence2, java.lang.CharSequence charSequence3) {
        ...
        return FloatFloatMap.joinToString$default(this, charSequence, charSequence2, charSequence3, 0, 0, 24, 0);
    }
    ...
    public final String joinToString(java.lang.CharSequence charSequence, java.lang.CharSequence charSequence2, java.lang.CharSequence charSequence3, int i4) {
        ...
        Intrinsics.checkNotNullParameter(charSequence2, "prefix");
        Intrinsics.checkNotNullParameter(charSequence3, "postfix");
        return FloatFloatMap.joinToString$default(this, charSequence, charSequence2, charSequence3, i4, 0, 16, 0);
    }
    ...
    public final String joinToString(java.lang.CharSequence separator, java.lang.CharSequence prefix, java.lang.CharSequence postfix, int limit, java.lang.CharSequence truncated, Function2<? super Float, ? super Float, ? extends java.lang.CharSequence> transform) {
        int invoke;
        int m$iv$iv;
        Object valueOf;
        int $this$maskEmptyOrDeleted$iv$iv$iv2;
        ...
        int i2;
        int i8;
        int $i$a$BuildStringFloatFloatMap$joinToString$2;
        int i7;
        long l;
        int i6;
        float f;
        ...
        if (0 <= i10) {
            ...
            $i$a$BuildStringFloatFloatMap$joinToString$2 = $this$maskEmptyOrDeleted$iv$iv$iv2;
            $this$maskEmptyOrDeleted$iv$iv$iv = index;
            i2 = j$iv$iv;
            index2 = limit;
            this_$iv = invoke;
    ...
    public final String joinToString(java.lang.CharSequence separator, java.lang.CharSequence prefix, java.lang.CharSequence postfix, int limit, Function2<? super Float, ? super Float, ? extends java.lang.CharSequence> transform) {
        int invoke;
        int m$iv$iv$iv;
        String valueOf;
        ...
        if (0 <= i10) {
            ...
            i6 = $this$maskEmptyOrDeleted$iv$iv$iv$iv;
            sb = stringBuilder;
    ...
    public final String joinToString(java.lang.CharSequence separator, java.lang.CharSequence prefix, java.lang.CharSequence postfix, Function2<? super Float, ? super Float, ? extends java.lang.CharSequence> transform) {
        int invoke;
        int m$iv$iv$iv;
        int $this$maskEmptyOrDeleted$iv$iv$iv$iv;
        int stringBuilder;
    ...
    public final String joinToString(java.lang.CharSequence separator, java.lang.CharSequence prefix, Function2<? super Float, ? super Float, ? extends java.lang.CharSequence> transform) {
        int invoke;
        int m$iv$iv$iv;
        int $this$maskEmptyOrDeleted$iv$iv$iv$iv;
        int stringBuilder;
    ...
    public final String joinToString(java.lang.CharSequence separator, Function2<? super Float, ? super Float, ? extends java.lang.CharSequence> transform) {
        int invoke;
        int m$iv$iv$iv;
        int $this$maskEmptyOrDeleted$iv$iv$iv$iv2;
        int stringBuilder;
    ...
    public final String joinToString(Function2<? super Float, ? super Float, ? extends java.lang.CharSequence> transform) {
        int separator$iv2;
        int m$iv$iv$iv;
        int $this$maskEmptyOrDeleted$iv$iv$iv$iv2;
        int stringBuilder;
