...
public final class ViewModelProviderImpl {
    ...
    public final <T extends ViewModel> T getViewModel$lifecycle_viewmodel_release(KClass<T> modelClass, String key) {
        ...
        final int i3 = 0;
        final int i4 = 0;
        viewModel = ViewModelProviderImpl.access$getStore$p(this).get(key);
        synchronized (lock) {
            if (factory instanceof ViewModelProvider.OnRequeryFactory != null) {
                Intrinsics.checkNotNull(viewModel);
                (ViewModelProvider.OnRequeryFactory)ViewModelProviderImpl.access$getFactory$p(this).onRequery(viewModel);
            }
