...
public final class LegacySavedStateHandleController {
    ...
    public static final class OnRecreation implements SavedStateRegistry.AutoRecreated {
        ...
        public void onRecreated(SavedStateRegistryOwner owner) {
            ...
            IllegalStateException illegalStateException = new IllegalStateException(stringBuilder.append("Internal error: OnRecreation should be registered only on components that implement ViewModelStoreOwner. Received owner: ").append(owner).toString().toString());
