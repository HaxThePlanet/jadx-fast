...
public final class LongSerializer implements KSerializer<Long> {
    ...
    static {
        ...
        LongSerializer.INSTANCE = longSerializer;
        PrimitiveSerialDescriptor primitiveSerialDescriptor = new PrimitiveSerialDescriptor("kotlin.Long", (PrimitiveKind)PrimitiveKind.LONG.INSTANCE);
        LongSerializer.descriptor = (SerialDescriptor)primitiveSerialDescriptor;
    }
