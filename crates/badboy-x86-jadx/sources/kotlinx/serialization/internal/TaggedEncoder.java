...
public abstract class TaggedEncoder<Tag>  implements Encoder, CompositeEncoder {
    ...
    protected Encoder encodeTaggedInline(Tag tag, SerialDescriptor inlineDescriptor) {
        ...
        final int i = 0;
        (TaggedEncoder)this.pushTag(tag);
        return (Encoder)this;
    }
    ...
    protected void encodeTaggedNull(Tag tag) {
        SerializationException serializationException = new SerializationException("null is not supported");
    ...
    protected final Tag popTag() {
        ...
        SerializationException serializationException = new SerializationException("No tag in stack for requested element");
        throw serializationException;
    }
