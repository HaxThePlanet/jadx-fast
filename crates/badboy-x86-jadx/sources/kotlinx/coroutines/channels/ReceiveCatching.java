...
final class ReceiveCatching<E>  implements Waiter {
    ...
    public final CancellableContinuationImpl<kotlinx.coroutines.channels.ChannelResult<? extends E>> cont;
    public ReceiveCatching(CancellableContinuationImpl<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> cont) {
        super();
        this.cont = cont;
    }
