...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        int i2 = 0;
        constructor-impl = Result.constructor-impl(Class.forName("kotlin.coroutines.jvm.internal.BaseContinuationImpl").getCanonicalName());
        ...
        int i = 0;
        constructor-impl2 = Result.constructor-impl(Class.forName("kotlinx.coroutines.internal.StackTraceRecoveryKt").getCanonicalName());
        if (Result.exceptionOrNull-impl(constructor-impl2) == null) {
            str2 = constructor-impl2;
        } else {
            constructor-impl2 = 0;
        }
