...
public abstract class AtomicOp<T>  extends kotlinx.coroutines.internal.OpDescriptor {
    ...
    private final Object decide(Object decision) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED()) {
            ...
            i = decision != AtomicKt.NO_DECISION ? 1 : 0;
            if (i == 0) {
            } else {
            }
        ...
        Object obj = AtomicOp._consensus$FU.get(this);
        if (obj != AtomicKt.NO_DECISION) {
            return obj;
        }
        if (AbstractResolvableFuture.SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(AtomicOp._consensus$FU, this, AtomicKt.NO_DECISION, decision)) {
            return decision;
        }
        return AtomicOp._consensus$FU.get(this);
    }

    public abstract void complete(T t, Object object2);
    ...
    public final Object perform(Object affected) {
        Object decision;
        Object nO_DECISION;
        if (AtomicOp._consensus$FU.get(this) == AtomicKt.NO_DECISION) {
