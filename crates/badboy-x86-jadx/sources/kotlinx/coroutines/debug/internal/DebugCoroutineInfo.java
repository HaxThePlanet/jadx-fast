...
public final class DebugCoroutineInfo {
    ...
    public DebugCoroutineInfo(kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl source, CoroutineContext context) {
        super();
        this.context = context;
        this.creationStackBottom = (CoroutineStackFrame)source.getCreationStackBottom$kotlinx_coroutines_core();
    ...
    public final List<java.lang.StackTraceElement> lastObservedStackTrace() {
