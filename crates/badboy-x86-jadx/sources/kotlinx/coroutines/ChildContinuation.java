...
public final class ChildContinuation extends kotlinx.coroutines.JobCancellingNode {
    ...
    public ChildContinuation(kotlinx.coroutines.CancellableContinuationImpl<?> child) {
        super();
        this.child = child;
    }
    ...
    public void invoke(Throwable cause) {
        this.child.parentCancelled$kotlinx_coroutines_core(this.child.getContinuationCancellationCause((Job)getJob()));
    }
}
