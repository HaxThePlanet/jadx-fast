...
final class LazyDeferredCoroutine<T>  extends kotlinx.coroutines.DeferredCoroutine<T> {
    ...
    public LazyDeferredCoroutine(CoroutineContext parentContext, Function2<? super kotlinx.coroutines.CoroutineScope, ? super Continuation<? super T>, ? extends Object> block) {
        super(parentContext, 0);
        this.continuation = IntrinsicsKt.createCoroutineUnintercepted(block, this, (Continuation)this);
    }

    @Override // kotlinx.coroutines.DeferredCoroutine
