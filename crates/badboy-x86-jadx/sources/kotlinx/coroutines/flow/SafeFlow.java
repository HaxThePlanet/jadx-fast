...
final class SafeFlow<T>  extends kotlinx.coroutines.flow.AbstractFlow<T> {
    ...
    private final Function2<kotlinx.coroutines.flow.FlowCollector<? super T>, Continuation<? super Unit>, Object> block;
    public SafeFlow(Function2<? super kotlinx.coroutines.flow.FlowCollector<? super T>, ? super Continuation<? super Unit>, ? extends Object> block) {
        super();
        this.block = block;
    }

    public Object collectSafely(kotlinx.coroutines.flow.FlowCollector<? super T> collector, Continuation<? super Unit> $completion) {
