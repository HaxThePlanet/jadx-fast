...
public final class ProcessLifecycleInitializer implements Initializer<androidx.lifecycle.LifecycleOwner> {
    ...
    public androidx.lifecycle.LifecycleOwner create(Context context) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckProcessLifecycleInitializer$create$1 = new IllegalStateException("ProcessLifecycleInitializer cannot be initialized lazily.\n               Please ensure that you have:\n               <meta-data\n                   android:name='androidx.lifecycle.ProcessLifecycleInitializer'\n                   android:value='androidx.startup' />\n               under InitializationProvider in your AndroidManifest.xml".toString());
        throw $i$a$CheckProcessLifecycleInitializer$create$1;
    }
