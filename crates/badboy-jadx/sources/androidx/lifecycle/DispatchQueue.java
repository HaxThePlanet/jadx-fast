...
public final class DispatchQueue {
    ...
    private final void enqueue(Runnable runnable) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckDispatchQueue$enqueue$1 = new IllegalStateException("cannot enqueue any more runnables".toString());
        throw $i$a$CheckDispatchQueue$enqueue$1;
    }
    ...
    public final void resume() {
        ...
        int i2 = 0;
        IllegalStateException $i$a$CheckDispatchQueue$resume$1 = new IllegalStateException("Cannot resume a finished dispatcher".toString());
        throw $i$a$CheckDispatchQueue$resume$1;
    }
}
