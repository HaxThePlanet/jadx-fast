...
@Metadata(d1 = "\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0008\u0003\n\u0002\u0018\u0002\n\u0002\u0008\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0008\u0004\u0008&\u0018\u00002\u00020\u0001B\t\u0008\u0000¢\u0006\u0004\u0008\u0002\u0010\u0003J6\u0010\u0008\u001a\u00020\t2'\u0010\n\u001a#\u0008\u0001\u0012\u0004\u0012\u00020\u0001\u0012\n\u0012\u0008\u0012\u0004\u0012\u00020\r0\u000c\u0012\u0006\u0012\u0004\u0018\u00010\u000e0\u000b¢\u0006\u0002\u0008\u000fH\u0007¢\u0006\u0002\u0010\u0010J6\u0010\u0011\u001a\u00020\t2'\u0010\n\u001a#\u0008\u0001\u0012\u0004\u0012\u00020\u0001\u0012\n\u0012\u0008\u0012\u0004\u0012\u00020\r0\u000c\u0012\u0006\u0012\u0004\u0018\u00010\u000e0\u000b¢\u0006\u0002\u0008\u000fH\u0007¢\u0006\u0002\u0010\u0010J6\u0010\u0012\u001a\u00020\t2'\u0010\n\u001a#\u0008\u0001\u0012\u0004\u0012\u00020\u0001\u0012\n\u0012\u0008\u0012\u0004\u0012\u00020\r0\u000c\u0012\u0006\u0012\u0004\u0018\u00010\u000e0\u000b¢\u0006\u0002\u0008\u000fH\u0007¢\u0006\u0002\u0010\u0010R\u0012\u0010\u0004\u001a\u00020\u0005X \u0004¢\u0006\u0006\u001a\u0004\u0008\u0006\u0010\u0007¨\u0006\u0013", d2 = {"Landroidx/lifecycle/LifecycleCoroutineScope;", "Lkotlinx/coroutines/CoroutineScope;", "<init>", "()V", "lifecycle", "Landroidx/lifecycle/Lifecycle;", "getLifecycle$lifecycle_common", "()Landroidx/lifecycle/Lifecycle;", "launchWhenCreated", "Lkotlinx/coroutines/Job;", "block", "Lkotlin/Function2;", "Lkotlin/coroutines/Continuation;", "", "", "Lkotlin/ExtensionFunctionType;", "(Lkotlin/jvm/functions/Function2;)Lkotlinx/coroutines/Job;", "launchWhenStarted", "launchWhenResumed", "lifecycle-common"}, k = 1, mv = {2, 0, 0}, xi = 48)
public abstract class LifecycleCoroutineScope implements CoroutineScope {
    ...
    public final Job launchWhenCreated(Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> block) {
        ...
        final int i = 0;
        LifecycleCoroutineScope.launchWhenCreated.1 anon = new LifecycleCoroutineScope.launchWhenCreated.1(this, block, i);
        return BuildersKt.launch$default((CoroutineScope)this, i, 0, (Function2)anon, 3, 0);
    }
    ...
    public final Job launchWhenResumed(Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        final int i = 0;
        LifecycleCoroutineScope.launchWhenResumed.1 anon = new LifecycleCoroutineScope.launchWhenResumed.1(this, block, i);
        return BuildersKt.launch$default((CoroutineScope)this, i, 0, (Function2)anon, 3, 0);
    }
    ...
    public final Job launchWhenStarted(Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        final int i = 0;
        LifecycleCoroutineScope.launchWhenStarted.1 anon = new LifecycleCoroutineScope.launchWhenStarted.1(this, block, i);
        return BuildersKt.launch$default((CoroutineScope)this, i, 0, (Function2)anon, 3, 0);
    }
}
