...
public final class SavedStateHandleSupport {
    ...
    public static final <T extends SavedStateRegistryOwner & androidx.lifecycle.ViewModelStoreOwner> void enableSavedStateHandles(T $this$enableSavedStateHandles) {
        int i;
        androidx.savedstate.SavedStateRegistry.SavedStateProvider savedStateHandlesProvider;
        androidx.lifecycle.Lifecycle.State iNITIALIZED;
        Object lifecycle;
        androidx.lifecycle.SavedStateHandleAttacher savedStateHandleAttacher;
        androidx.lifecycle.SavedStateHandlesProvider savedStateHandlesProvider2;
        ...
        if (i == 0) {
            ...
            if ($this$enableSavedStateHandles.getSavedStateRegistry().getSavedStateProvider(lifecycle) == null) {
                savedStateHandlesProvider = new SavedStateHandlesProvider($this$enableSavedStateHandles.getSavedStateRegistry(), (ViewModelStoreOwner)$this$enableSavedStateHandles);
                $this$enableSavedStateHandles.getSavedStateRegistry().registerSavedStateProvider(lifecycle, (SavedStateRegistry.SavedStateProvider)savedStateHandlesProvider);
                savedStateHandleAttacher = new SavedStateHandleAttacher(savedStateHandlesProvider);
