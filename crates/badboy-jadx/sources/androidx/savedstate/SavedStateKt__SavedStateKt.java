...
final class SavedStateKt__SavedStateKt {
    public static final <T> T read(Bundle $this$read, Function1<? super androidx.savedstate.SavedStateReader, ? extends T> block) {
        ...
        int i = 0;
        return block.invoke(SavedStateReader.box-impl(SavedStateReader.constructor-impl($this$read)));
    }
    ...
    public static final <T> T write(Bundle $this$write, Function1<? super androidx.savedstate.SavedStateWriter, ? extends T> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        int i = 0;
        return block.invoke(SavedStateWriter.box-impl(SavedStateWriter.constructor-impl($this$write)));
    }
}
