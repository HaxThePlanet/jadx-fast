...
public final class SavedStateRegistry {
    ...
    public final void runOnNextRecreation(Class<? extends androidx.savedstate.SavedStateRegistry.AutoRecreated> clazz) {
        ...
        int e = 0;
        IllegalStateException $i$a$CheckSavedStateRegistry$runOnNextRecreation$1 = new IllegalStateException("Can not perform this action after onSaveInstanceState".toString());
        throw $i$a$CheckSavedStateRegistry$runOnNextRecreation$1;
    }
