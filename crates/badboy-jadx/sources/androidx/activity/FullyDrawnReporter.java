...
public final class FullyDrawnReporter {
    ...
    private static final void reportRunnable$lambda$2(androidx.activity.FullyDrawnReporter this$0) {
        ...
        synchronized (lock) {
            ...
            Unit $i$a$SynchronizedFullyDrawnReporter$reportRunnable$1$1 = Unit.INSTANCE;
        }
    }
    ...
    public final void addReporter() {
        ...
        synchronized (lock) {
            ...
            Unit $i$a$SynchronizedFullyDrawnReporter$addReporter$1 = Unit.INSTANCE;
        }
    }
    ...
    public final void fullyDrawnReported() {
        ...
        synchronized (lock) {
            ...
            Unit $i$a$SynchronizedFullyDrawnReporter$fullyDrawnReported$1 = Unit.INSTANCE;
        }
    }
    ...
    public final void removeOnReportDrawnListener(Function0<Unit> callback) {
        ...
        Unit $i$a$SynchronizedFullyDrawnReporter$removeOnReportDrawnListener$1 = Unit.INSTANCE;
        return;
        synchronized (lock) {
            Intrinsics.checkNotNullParameter(callback, "callback");
            lock = this.lock;
            i = 0;
            (Collection)this.onReportCallbacks.remove(callback);
            $i$a$SynchronizedFullyDrawnReporter$removeOnReportDrawnListener$1 = Unit.INSTANCE;
        }
    }
    ...
    public final void removeReporter() {
        ...
        synchronized (lock) {
            ...
            Unit $i$a$SynchronizedFullyDrawnReporter$removeReporter$1 = Unit.INSTANCE;
        }
    }
}
