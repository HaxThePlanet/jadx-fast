...
public final class BackHandlerKt {
    public static final void BackHandler(boolean enabled, Function0<Unit> onBack, Composer $composer, int $changed, int i5) {
        ...
        if (i12 != 0) {
            ...
            if (i7 & 6 == 0) {
                i4 = restartGroup.changed(enabled) ? onBackPressedDispatcher : 2;
                $dirty |= i4;
            } else {
                invalid$iv = enabled;
            }
        ...
        if ($dirty & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty, -1, "androidx.activity.compose.BackHandler (BackHandler.kt:81)");
                }
                ...
                if (rememberedValue2 == Composer.Companion.getEmpty()) {
                    empty2 = 0;
                    empty = new BackHandlerKt.BackHandler.backCallback.1.1(enabled2, rememberUpdatedState);
                    composer2.updateRememberedValue(empty);
                } else {
                ...
                i = $dirty & 14 == onBackPressedDispatcher ? 1 : 0;
