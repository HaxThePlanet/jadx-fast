...
public final class PredictiveBackHandlerKt {
    public static final void PredictiveBackHandler(boolean enabled, Function2<Flow<BackEventCompat>, ? super Continuation<Unit>, ? extends Object> onBack, Composer $composer, int $changed, int i5) {
        ...
        if (i14 != 0) {
            ...
            if (i7 & 6 == 0) {
                i2 = restartGroup.changed(enabled) ? 4 : 2;
                $dirty |= i2;
            } else {
                traceInProgress = enabled;
            }
        ...
        if ($dirty & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                ...
                if (rememberedValue3 == Composer.Companion.getEmpty()) {
                    ...
                    currentOnBack$delegate2 = rememberUpdatedState;
                    currentOnBack$delegate = rememberedValue3;
                }
                ...
                if (rememberedValue4 == Composer.Companion.getEmpty()) {
                    empty2 = 0;
                    $i$a$CachePredictiveBackHandlerKt$PredictiveBackHandler$1 = new PredictiveBackHandlerCallback(enabled2, onBackScope, PredictiveBackHandlerKt.PredictiveBackHandler$lambda$0(currentOnBack$delegate2));
