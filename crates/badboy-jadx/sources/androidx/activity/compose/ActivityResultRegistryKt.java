...
public final class ActivityResultRegistryKt {
    public static final <I, O> androidx.activity.compose.ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(ActivityResultContract<I, O> contract, Function1<? super O, Unit> onResult, Composer $composer, int $changed) {
        ...
        if (current == null) {
            ...
            invalid$iv3 = activityResultLauncherHolder;
            ...
            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                empty2 = 0;
                invalid$iv2 = i16;
                invalid$iv = new ManagedActivityResultLauncher((ActivityResultLauncherHolder)invalid$iv3, SnapshotStateKt.rememberUpdatedState(obj, composer, i23 & 14));
                composer5.updateRememberedValue(invalid$iv);
            } else {
                invalid$iv2 = i16;
            ...
            if (changed2 |= empty == 0) {
                if (rememberedValue3 == Composer.Companion.getEmpty()) {
                    invalid$iv2 = 0;
                    empty = rememberUpdatedState;
                    activityResultRegistry2 = realLauncher;
                    androidx.activity.compose.ActivityResultLauncherHolder key = invalid$iv3;
                    androidx.activity.result.ActivityResultRegistry activity3 = activity;
                    ActivityResultRegistryKt.rememberLauncherForActivityResult.1.1 currentOnResult2 = new ActivityResultRegistryKt.rememberLauncherForActivityResult.1.1(key, activity3, activityResultRegistry2, obj, empty);
            ...
            return (ManagedActivityResultLauncher)invalid$iv;
        }
