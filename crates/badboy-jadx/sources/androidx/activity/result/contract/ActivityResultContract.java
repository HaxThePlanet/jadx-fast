...
public abstract class ActivityResultContract<I, O>  {
    ...
    public androidx.activity.result.contract.ActivityResultContract.SynchronousResult<O> getSynchronousResult(Context context, I input) {
        Intrinsics.checkNotNullParameter(context, "context");
        return 0;
    }

    public abstract O parseResult(int i, Intent intent2);
}
