...
public final class Pools {
    ...
    public static class SimplePool implements androidx.core.util.Pools.Pool<T> {
        ...
        public SimplePool(int maxPoolSize) {
            ...
            int i2 = 0;
            IllegalArgumentException $i$a$RequirePools$SimplePool$1 = new IllegalArgumentException("The max pool size must be > 0".toString());
            throw $i$a$RequirePools$SimplePool$1;
        }
        ...
        public boolean release(T instance) {
            ...
            int i3 = 0;
            IllegalStateException $i$a$CheckPools$SimplePool$release$1 = new IllegalStateException("Already in the pool!".toString());
            throw $i$a$CheckPools$SimplePool$release$1;
        }
    }
