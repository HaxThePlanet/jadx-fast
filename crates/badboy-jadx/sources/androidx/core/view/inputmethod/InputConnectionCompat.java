...
public final class InputConnectionCompat {
    ...
    static boolean handlePerformPrivateCommand(String action, Bundle data, androidx.core.view.inputmethod.InputConnectionCompat.OnCommitContentListener onCommitContentListener) {
        ...
        if (TextUtils.equals("androidx.core.view.inputmethod.InputConnectionCompat.COMMIT_CONTENT", action)) {
            ...
            int i3 = 0;
            result = 0;
            str = i != 0 ? "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_RESULT_RECEIVER" : "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_RESULT_RECEIVER";
            android.os.Parcelable resultReceiver = parcelable;
            str4 = i != 0 ? "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_URI" : "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_URI";
            android.os.Parcelable parcelable2 = data.getParcelable(str4);
            str2 = i != 0 ? "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION" : "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION";
            android.os.Parcelable parcelable3 = data.getParcelable(str2);
            str5 = i != 0 ? "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_LINK_URI" : "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_LINK_URI";
            str6 = i != 0 ? "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS" : "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS";
            str3 = i != 0 ? "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_OPTS" : "androidx.core.view.inputmethod.InputConnectionCompat.CONTENT_OPTS";
            if ((Uri)parcelable2 != null && (ClipDescription)parcelable3 != null) {
                if ((ClipDescription)parcelable3 != null) {
                    inputContentInfoCompat = new InputContentInfoCompat((Uri)parcelable2, (ClipDescription)parcelable3, (Uri)data.getParcelable(str5));
