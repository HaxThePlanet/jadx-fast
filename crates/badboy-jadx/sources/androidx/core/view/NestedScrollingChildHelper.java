                    ...
                    if (dxUnconsumed == 0) {
                        if (dyUnconsumed != 0) {
                            ...
                            if (iArr2 != null) {
                                this.mView.getLocationInWindow(iArr2);
                                iArr2[i2] = i6 -= i;
                                iArr2[nestedScrollingEnabled] = i5 -= i3;
                            }
                        }
                        if (iArr2 != null) {
                            iArr2[i2] = i2;
        ...
        if (isNestedScrollingEnabled() && nestedScrollingParentForType == null) {
            ...
            if (dx == 0) {
                if (dy != 0) {
                    ...
                    iArr[i4] = i4;
                    iArr[nestedScrollingEnabled] = i4;
                    ViewParentCompat.onNestedPreScroll(nestedScrollingParentForType, this.mView, dx, dy, iArr, type);
                    if (offsetInWindow != null) {
                        this.mView.getLocationInWindow(offsetInWindow);
                        offsetInWindow[i4] = obj11 -= i5;
                        offsetInWindow[nestedScrollingEnabled] = obj11 -= i2;
                    }
                    if (iArr[i4] == 0) {
                        if (iArr[nestedScrollingEnabled] != 0) {
                            i4 = nestedScrollingEnabled;
                        }
                    } else {
                    }
                }
                if (offsetInWindow != null) {
                    offsetInWindow[i4] = i4;
                    offsetInWindow[nestedScrollingEnabled] = i4;
                    dx2 = dx;
                    i3 = dy;
                    i = type;
                } else {
