...
public class ViewCompat {
    ...
    static abstract class AccessibilityViewProperty {
        ...
        boolean booleanNullToFalseEquals(Boolean a, Boolean b) {
            ...
            if (a != null && a.booleanValue()) {
                i2 = a.booleanValue() ? i : i4;
            } else {
            }
            if (b != null && b.booleanValue()) {
                i3 = b.booleanValue() ? i : i4;
            } else {
            }
            if (i2 == i3) {
            } else {
    ...
    static class AccessibilityPaneVisibilityManager implements ViewTreeObserver.OnGlobalLayoutListener, View.OnAttachStateChangeListener {
        ...
        private void checkPaneVisibility(Map.Entry<View, Boolean> map$Entry) {
            ...
            if ((View)key.isShown() && key.getWindowVisibility() == 0) {
                i = key.getWindowVisibility() == 0 ? 1 : 0;
            } else {
            }
            if ((Boolean)entry.getValue().booleanValue() != i) {
                i2 = i != 0 ? 16 : 32;
                ViewCompat.notifyViewAccessibilityStateChangedIfNeeded(key, i2);
                entry.setValue(Boolean.valueOf(i));
            }
        }
    ...
    static void notifyViewAccessibilityStateChangedIfNeeded(View view, int changeType) {
        java.lang.CharSequence accessibilityPaneTitle2;
        int i;
        Object obtain;
        int text;
