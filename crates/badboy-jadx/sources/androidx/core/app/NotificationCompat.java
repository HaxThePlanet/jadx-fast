...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        public void addCompatExtras(Bundle extras) {
            ...
            Object mBigContentTitle;
            java.lang.CharSequence mBigContentTitle2;
        ...
        public RemoteViews applyStandardTemplate(boolean showSmallIcon, int resId, boolean fitIn1U) {
            ...
            final int i10 = 1;
            i = 0;
            i3 = obj.mBuilder.getPriority() < -1 ? i10 : i;
            final int i11 = i3;
            if (mBuilder4.mLargeIcon != null) {
                view.setViewVisibility(R.id.icon, i);
                view.setImageViewBitmap(R.id.icon, obj.createColoredBitmap(mBuilder13.mLargeIcon, i));
                if (showSmallIcon && mNotification.icon != 0) {
                    if (mNotification.icon != 0) {
                        dimensionPixelSize2 = resources.getDimensionPixelSize(R.dimen.notification_right_icon_size);
                        view.setImageViewBitmap(R.id.right_icon, obj.createIconWithBackground(mNotification3.icon, dimensionPixelSize2, dimensionPixelSize2 - i6, obj.mBuilder.getColor()));
                        view.setViewVisibility(R.id.right_icon, i);
                    }
                }
            } else {
            ...
            if (mBuilder14.mContentInfo != null) {
                ...
                view.setViewVisibility(R.id.info, i);
                showLine3 = 1;
            ...
            if (hasRightSide3.mSubText != null) {
                ...
                if (mBuilder12.mContentText != null) {
                    ...
                    view.setViewVisibility(R.id.text2, i);
                    showLine2 = 1;
                    i4 = 8;
                } else {
            ...
            if (showLine2 != 0 && fitIn1U) {
                if (fitIn1U) {
                    view.setTextViewTextSize(R.id.text, i, (float)dimensionPixelSize4);
                }
            ...
            if (Long.compare(whenIfShowing, i8) != 0) {
                if (mBuilder10.mUseChronometer) {
                    view.setViewVisibility(R.id.chronometer, i);
                    ...
                    view.setViewVisibility(R.id.time, i);
                    view.setLong(R.id.time, "setTime", obj.mBuilder.getWhenIfShowing());
                }
                hasRightSide = 1;
            }
            i2 = hasRightSide != 0 ? i : i4;
            view.setViewVisibility(R.id.right_side, i2);
            if (showLine3 != 0) {
            } else {
                i = i4;
            }
            view.setViewVisibility(R.id.line3, i);
            return view;
        }
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (notification.actions != null && actions.length != 0) {
                if (actions.length != 0) {
                    ...
                    boolean3 = i;
                    while (boolean3 < largeIcon.length) {
                        addAction(NotificationCompat.Action.Builder.fromAndroidAction(largeIcon[boolean3]).build());
                        boolean3++;
                    }
                }
            }
            ...
            if (!invisibleActions.isEmpty()) {
                ...
                for (NotificationCompat.Action boolean3 : iterator2) {
                    addInvisibleAction(boolean3);
                }
            }
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                if (!parcelableArrayList.isEmpty()) {
                    ...
                    for (Person boolean3 : iterator) {
                        addPerson(Person.fromAndroidPerson(boolean3));
                    }
                }
            }
            boolean = "android.chronometerCountDown";
            if (extras.containsKey(boolean)) {
                setChronometerCountDown(extras.getBoolean(boolean));
            }
        ...
        public androidx.core.app.NotificationCompat.Builder setLights(int argb, int onMs, int offMs) {
            ...
            if (mNotification4.ledOnMS != 0 && mNotification5.ledOffMS != 0) {
                i = mNotification5.ledOffMS != 0 ? i2 : i4;
            } else {
            }
            if (i != 0) {
            } else {
    ...
    public static final class CarExtender implements androidx.core.app.NotificationCompat.Extender {
        ...
        public CarExtender(Notification notification) {
            ...
            if (NotificationCompat.getExtras(notification) == null) {
                ...
                bundle2 = NotificationCompat.getExtras(notification).getBundle("android.car.EXTENSIONS");
            }
            if (bundle2 != null) {
                this.mLargeIcon = (Bitmap)bundle2.getParcelable("large_icon");
                this.mColor = bundle2.getInt("app_color", 0);
                this.mUnreadConversation = NotificationCompat.CarExtender.getUnreadConversationFromBundle(bundle2.getBundle("car_conversation"));
            }
        }
        ...
        private static Bundle getBundleForUnreadConversation(androidx.core.app.NotificationCompat.CarExtender.UnreadConversation uc) {
            ...
            while (i < arr.length) {
                bundle = new Bundle();
                bundle.putString("text", uc.getMessages()[i]);
                    ...
                    if (stringArray != null) {
                        if (stringArray.length != 1) {
                            ...
                            if ((RemoteInput)parcelable3 != null) {
                                remoteInput = new RemoteInput(NotificationCompat.CarExtender.Api20Impl.getResultKey((RemoteInput)parcelable3), NotificationCompat.CarExtender.Api20Impl.getLabel(parcelable3), NotificationCompat.CarExtender.Api20Impl.getChoices(parcelable3), NotificationCompat.CarExtender.Api20Impl.getAllowFreeFormInput(parcelable3), NotificationCompat.CarExtender.Api29Impl.getEditChoicesBeforeSending(parcelable3), NotificationCompat.CarExtender.Api20Impl.getExtras(parcelable3), 0);
                                remoteInput2 = remoteInput;
                            } else {
                                remoteInput2 = i3;
                            }
                        }
                        NotificationCompat.CarExtender.UnreadConversation unreadConversation = new NotificationCompat.CarExtender.UnreadConversation(strArr, remoteInput2, (PendingIntent)obj.getParcelable("on_reply"), (PendingIntent)obj.getParcelable("on_read"), stringArray, obj.getLong("timestamp"), resultKey);
    ...
    public static class DecoratedCustomViewStyle extends androidx.core.app.NotificationCompat.Style {
        ...
        public static List<java.lang.CharSequence> getTextsFromContentView(Context context, Notification notification) {
            ...
            headsUpContentView2 = notification.bigContentView != null ? notification.bigContentView : contentView != null ? notification.contentView : notification.headsUpContentView;
            final String package = headsUpContentView2.getPackage();
            int i = 0;
            final Context packageContext = context.createPackageContext(package, i);
            packageContext.setTheme(applicationInfo2.theme);
            ArrayList arrayList = new ArrayList();
            NotificationCompat.DecoratedCustomViewStyle.getTextsFromViewTraversal(headsUpContentView2.apply(packageContext, 0), arrayList);
            return arrayList;
        }
        ...
        private static void getTextsFromViewTraversal(View v, ArrayList<java.lang.CharSequence> arrayList2) {
            ...
            while (i < (ViewGroup)v.getChildCount()) {
                ...
                text2 = (TextView)childAt.getText();
                if (childAt instanceof TextView != null && text2 != null && text2.length() > 0) {
                }
    ...
    public static class MessagingStyle extends androidx.core.app.NotificationCompat.Style {
        ...
        public boolean isGroupConversation() {
            androidx.core.app.NotificationCompat.Builder mIsGroupConversation;
            Boolean mIsGroupConversation2;
            int booleanValue;
            int i;
            booleanValue = 0;
    ...
    static androidx.core.app.NotificationCompat.Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (NotificationCompat.Api23Impl.getIcon(action) == null && action.icon != 0) {
            if (action.icon != 0) {
                NotificationCompat.Action action2 = new NotificationCompat.Action(action.icon, action.title, action.actionIntent, NotificationCompat.Api20Impl.getExtras(action), i2, 0, i3, semanticAction, boolean, contextual, i10);
                return action2;
            }
        }
        ...
        NotificationCompat.Action action3 = new NotificationCompat.Action(fromIconOrNullIfZeroResId, action.title, action.actionIntent, NotificationCompat.Api20Impl.getExtras(action), i2, 0, i3, semanticAction, boolean, contextual, i10);
        return action3;
    }
