...
public final class MultiWindowModeChangedInfo {
    ...
    public final Configuration getNewConfig() {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckNotNullMultiWindowModeChangedInfo$newConfig$1 = new IllegalStateException("MultiWindowModeChangedInfo must be constructed with the constructor that takes a Configuration to access the newConfig. Are you running on an API 26 or higher device that makes this information available?".toString());
        throw $i$a$CheckNotNullMultiWindowModeChangedInfo$newConfig$1;
    }
