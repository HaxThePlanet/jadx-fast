...
public final class ScrollerCompat {
    ...
    @Deprecated
    public static androidx.core.widget.ScrollerCompat create(Context context) {
        return ScrollerCompat.create(context, 0);
    }

    @Deprecated
    public static androidx.core.widget.ScrollerCompat create(Context context, Interpolator interpolator) {
