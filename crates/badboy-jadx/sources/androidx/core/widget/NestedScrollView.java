...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    private View findFocusableViewInBounds(boolean topFocus, int top, int bottom) {
        ...
        i4 = 0;
        while (i4 < focusables.size()) {
            obj = focusables.get(i4);
            ...
            focusCandidate = obj;
            foundFullyContainedFocusable = i2;
            if (bottom2 < bottom) {
            } else {
            }
            i2 = i3;
    ...
    private boolean scrollAndFocus(int direction, int top, int bottom) {
        ...
        int i5 = 0;
        final int i6 = 1;
        i = direction == 33 ? i6 : i5;
        if (findFocusableViewInBounds(i, top, bottom) == null) {
            newFocused = this;
        }
        if (top >= scrollY && bottom <= i3) {
            if (bottom <= i3) {
                ...
                i2 = i != 0 ? top - scrollY : bottom - i3;
                scrollBy(i2, i5, i6, i6);
            }
        } else {
        }
            ...
            if (isWithinDeltaOfScreen(nextFocus, maxScrollAmount, getHeight())) {
                ...
                if (direction == 33 && getScrollY() < maxScrollAmount) {
                    if (getScrollY() < maxScrollAmount) {
                        ...
                        if (direction == i4 && getChildCount() > 0) {
                            if (getChildCount() > 0) {
                                childCount = getChildAt(descendantFocusability);
                                scrollDelta = Math.min(i3 - i2, maxScrollAmount);
                            }
                        }
                    }
                } else {
                ...
                i = direction == i4 ? scrollDelta : -scrollDelta;
                scrollBy(i, descendantFocusability, i6, i6);
            }
        } else {
        }
    ...
    protected int computeScrollDeltaToGetChildRectOnScreen(Rect rect) {
        ...
        if (rect.bottom > screenBottom && rect.top > screenTop) {
            if (rect.top > screenTop) {
                ...
                scrollYDelta3 = Math.min(scrollYDelta, bottom2 - i4);
            } else {
            }
        } else {
        }
    ...
    public void draw(Canvas canvas) {
        ...
        if (!this.mEdgeGlowTop.isFinished() && NestedScrollView.Api21Impl.getClipToPadding(this)) {
            if (NestedScrollView.Api21Impl.getClipToPadding(this)) {
                width -= i5;
                xTranslation += clipToPadding4;
            }
            if (NestedScrollView.Api21Impl.getClipToPadding(this)) {
                height -= i4;
                yTranslation += clipToPadding;
            }
        ...
        if (!this.mEdgeGlowBottom.isFinished() && NestedScrollView.Api21Impl.getClipToPadding(this)) {
            ...
            if (NestedScrollView.Api21Impl.getClipToPadding(this)) {
                width -= i8;
                xTranslation += clipToPadding3;
            }
            if (NestedScrollView.Api21Impl.getClipToPadding(this)) {
                height -= i6;
                yTranslation -= clipToPadding2;
            }
    ...
    int getScrollRange() {
        ...
        if (getChildCount() > 0) {
            ...
            layoutParams = childAt.getLayoutParams();
            scrollRange = Math.max(childCount, i2 - i);
        }
        return scrollRange;
    }
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (motionEvent.getAction() == 8 && !this.mIsBeingDragged) {
            if (!this.mIsBeingDragged) {
                ...
                obj2.scrollBy(-i14, i3, motionEvent3, i, 1, MotionEventCompat.isFromSource(motionEvent, 8194));
                if (Float.compare(x, x2) != 0 && i3 != 0) {
                    obj2 = this;
                    motionEvent3 = motionEvent;
                    obj2.scrollBy(-i14, i3, motionEvent3, i, 1, MotionEventCompat.isFromSource(motionEvent, 8194));
                    if (i3 != 0) {
                        obj2.mDifferentialMotionFlingController.onMotionEvent(motionEvent3, i3);
                    }
                    return 1;
                }
                obj = this;
    ...
    boolean overScrollByCompat(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
        ...
        int i12 = 1;
        i3 = obj.computeHorizontalScrollRange() > obj.computeHorizontalScrollExtent() ? i12 : 0;
        i4 = obj.computeVerticalScrollRange() > obj.computeVerticalScrollExtent() ? i12 : 0;
        if (overScrollMode != 0) {
            if (overScrollMode == i12 && i3 != 0) {
                if (i3 != 0) {
                    i = i12;
                } else {
                    i = 0;
        ...
        maxOverScrollX2 = i == 0 ? 0 : maxOverScrollX;
        int i14 = scrollY + deltaY;
        maxOverScrollY2 = i2 == 0 ? 0 : maxOverScrollY;
        ...
        if (newScrollY != 0 && !obj.hasNestedScrollingParent(i12)) {
            if (!obj.hasNestedScrollingParent(i12)) {
                obj.mScroller.springBack(i11, i7, 0, 0, 0, obj.getScrollRange());
                newScrollX = i11;
                i10 = i7;
            } else {
                newScrollX = i11;
        ...
        obj.onOverScrolled(newScrollX, i10, newScrollX2, newScrollY);
        if (newScrollX2 == 0) {
            if (newScrollY != 0) {
                i6 = 1;
            } else {
    ...
    public boolean pageScroll(int direction) {
        ...
        if (i2 != 0) {
            ...
            mTempRect2 = getChildAt(childCount + -1);
            i7 += paddingBottom;
            if (childCount > 0 && top3 += height > i3) {
                mTempRect2 = getChildAt(childCount + -1);
                i7 += paddingBottom;
                if (top3 += height > i3) {
                    mTempRect.top = i3 - height;
                }
            }
        } else {
    ...
    int scrollBy(int verticalScrollDistance, int verticalScrollAxis, MotionEvent ev, int x, int touchType, boolean isSourceMouseOrKeyboard) {
        ...
        Object scrollFeedbackProvider2;
        int mScrollConsumed;
        int source2;
        int source;
        int i2;
        ...
        if (obj.dispatchNestedPreScroll(0, verticalScrollDistance, obj.mScrollConsumed, obj.mScrollOffset, i20)) {
            i = dispatchNestedPreScroll;
            i2 = totalScrollOffset;
        } else {
            i = verticalScrollDistance;
            i2 = totalScrollOffset;
        }
        ...
        if (obj.canOverScroll() && !isSourceMouseOrKeyboard) {
            i4 = !isSourceMouseOrKeyboard ? source2 : i6;
        } else {
        }
        final int i31 = i4;
        final int i32 = i;
        int i26 = scrollY;
        if (obj.overScrollByCompat(0, i, 0, scrollY, 0, scrollRange, 0, 0, true) && !obj.hasNestedScrollingParent(source)) {
            i3 = !obj.hasNestedScrollingParent(source) ? source2 : i6;
        } else {
        }
        hitScrollBarrier = i3;
        int i16 = scrollFeedbackProvider - i26;
        if (ev != null && i16 != 0) {
            if (i16 != 0) {
                obj.getScrollFeedbackProvider().onScrollProgress(ev.getDeviceId(), ev.getSource(), i29, i16);
            }
        }
        obj.mScrollConsumed[source2] = i6;
        mEdgeGlowBottom = source;
        ...
        if (i18 < 0) {
            ...
            if (i31 != 0 && ev != null) {
                EdgeEffectCompat.onPullDistance(obj.mEdgeGlowTop, f2 /= f6, f7 /= i6);
                if (ev != null) {
                    obj.getScrollFeedbackProvider().onScrollLimit(ev.getDeviceId(), ev.getSource(), i29, source2);
                }
            ...
            EdgeEffectCompat.onPullDistance(obj.mEdgeGlowBottom, f /= f4, i30 -= source);
