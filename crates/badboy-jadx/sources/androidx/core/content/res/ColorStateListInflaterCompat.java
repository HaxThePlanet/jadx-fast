...
public final class ColorStateListInflaterCompat {
    ...
    private static ColorStateList inflate(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (depth != i10) {
            ...
            i3 = -1;
            resourceId = attributes.getResourceId(R.styleable.ColorStateListItem_android_color, i3);
            if (resourceId != i3 && !ColorStateListInflaterCompat.isColorInt(resources, resourceId)) {
            } else {
            }
            ...
            while (i7 < attributeCount) {
                int attributeNameResource = set.getAttributeNameResource(i7);
                ...
                if (set.getAttributeBooleanValue(i7, false)) {
                } else {
                }
            ...
            i4 = i8;
            colorList = GrowingArrayUtils.append(colorList, listSize, ColorStateListInflaterCompat.modulateColorAlpha(defaultColor, alphaMod, float));
            colorList2 = append;
            listSize++;
            resources = r;
            theme2 = theme;
            i5 = innerDepth;
            i10 = 1;
            attributeNameResource = set.getAttributeNameResource(i7);
            if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != R.attr.alpha && attributeNameResource != R.attr.lStar) {
            }
            i7++;
            i5 = i6;
        ...
        int i16 = 0;
        System.arraycopy(colorList, i16, iArr, i16, listSize);
        System.arraycopy(colorList2, i16, iArr3, i16, listSize);
