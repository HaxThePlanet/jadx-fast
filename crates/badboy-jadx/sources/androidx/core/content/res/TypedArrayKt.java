...
public final class TypedArrayKt {
    ...
    public static final ColorStateList getColorStateListOrThrow(TypedArray $this$getColorStateListOrThrow, int index) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckNotNullTypedArrayKt$getColorStateListOrThrow$1 = new IllegalStateException("Attribute value was not a color or color state list.".toString());
        throw $i$a$CheckNotNullTypedArrayKt$getColorStateListOrThrow$1;
    }
    ...
    public static final String getStringOrThrow(TypedArray $this$getStringOrThrow, int index) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckNotNullTypedArrayKt$getStringOrThrow$1 = new IllegalStateException("Attribute value could not be coerced to String.".toString());
        throw $i$a$CheckNotNullTypedArrayKt$getStringOrThrow$1;
    }
    ...
    public static final java.lang.CharSequence getTextOrThrow(TypedArray $this$getTextOrThrow, int index) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckNotNullTypedArrayKt$getTextOrThrow$1 = new IllegalStateException("Attribute value could not be coerced to CharSequence.".toString());
        throw $i$a$CheckNotNullTypedArrayKt$getTextOrThrow$1;
    }
