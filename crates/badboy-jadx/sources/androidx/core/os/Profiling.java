...
public final class Profiling {
    ...
    public static final Flow<ProfilingResult> registerForAllProfilingResults(Context context) {
        ...
        Profiling.registerForAllProfilingResults.1 anon = new Profiling.registerForAllProfilingResults.1(context, 0);
    ...
    public static final void requestProfiling(Context context, androidx.core.os.ProfilingRequest profilingRequest, Executor executor, Consumer<ProfilingResult> listener) {
        Intrinsics.checkNotNullParameter(context, "context");
