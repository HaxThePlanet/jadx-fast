...
class FontProvider {
    ...
    static androidx.core.provider.FontsContractCompat.FontInfo[] query(Context context, androidx.core.provider.FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        weight = "font_italic";
        columnIndex4 = "font_weight";
        columnIndex2 = "font_ttc_index";
        ...
        strArr2[2] = columnIndex2;
        strArr2[3] = "font_variation_settings";
        strArr2[4] = columnIndex4;
        strArr2[5] = weight;
        ...
        if (cursor != null && cursor.getCount() > 0) {
            if (cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    italicColumnIndex3 = weight;
                    id = appendedId;
                    if (columnIndex4 != int) {
                    } else {
                    }
                    int3 = 400;
                    int resultCodeColumnIndex2 = italicColumnIndex3;
                    ...
                    italicColumnIndex = 1;
                    arrayList = 0;
                    arrayList.add(FontsContractCompat.FontInfo.create(id, int2, int3, arrayList, strArr));
                    weight = italicColumnIndex2;
                    columnIndex = resultCodeColumnIndex;
                    fileUri = 1;
                    italicColumnIndex2 = resultCodeColumnIndex2;
                    italicColumnIndex = 1;
                    if (cursor.getInt(resultCodeColumnIndex2) == italicColumnIndex) {
                    } else {
                    }
                    arrayList = italicColumnIndex;
