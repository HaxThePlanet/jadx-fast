...
public final class LocationRequestCompat {
    ...
    private static class Api19Impl {
        ...
        public static Object toLocationRequest(androidx.core.location.LocationRequestCompat obj, String provider) {
            ...
            Method sSetNumUpdatesMethod2;
            int sSetNumUpdatesMethod;
            ...
            if (LocationRequestCompat.Api19Impl.sLocationRequestClass == null) {
                try {
                    ...
                    arr2 = new Class[4];
                    arr2[sSetExpireInMethod] = String.class;
                    arr2[arr3] = Long.TYPE;
                    arr2[2] = Float.TYPE;
                    arr2[3] = Boolean.TYPE;
                    LocationRequestCompat.Api19Impl.sCreateFromDeprecatedProviderMethod = LocationRequestCompat.Api19Impl.sLocationRequestClass.getDeclaredMethod("createFromDeprecatedProvider", arr2);
                    LocationRequestCompat.Api19Impl.sCreateFromDeprecatedProviderMethod.setAccessible(arr3);
                    ...
                    LocationRequestCompat.Api19Impl.sSetQualityMethod.setAccessible(arr3);
                    ...
                    LocationRequestCompat.Api19Impl.sSetFastestIntervalMethod.setAccessible(arr3);
                    ...
                    LocationRequestCompat.Api19Impl.sSetNumUpdatesMethod.setAccessible(arr3);
                    LocationRequestCompat.Api19Impl.sSetNumUpdatesMethod.invoke(invoke, /* result */);
                    if (Long.compare(durationMillis2, arr4) < 0 && LocationRequestCompat.Api19Impl.sSetExpireInMethod == null) {
                    }
                    if (LocationRequestCompat.Api19Impl.sSetExpireInMethod == null) {
                    }
                    arr4 = new Class[arr3];
                    arr4[sSetExpireInMethod] = Long.TYPE;
                    LocationRequestCompat.Api19Impl.sSetExpireInMethod = LocationRequestCompat.Api19Impl.sLocationRequestClass.getDeclaredMethod("setExpireIn", arr4);
                    LocationRequestCompat.Api19Impl.sSetExpireInMethod.setAccessible(arr3);
    ...
    public static final class Builder {
        ...
        public androidx.core.location.LocationRequestCompat.Builder setQuality(int quality) {
            ...
            Preconditions.checkArgument(i, "quality must be a defined QUALITY constant, not %d", /* result */);
