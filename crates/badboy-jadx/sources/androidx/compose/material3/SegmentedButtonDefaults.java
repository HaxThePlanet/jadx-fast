...
public final class SegmentedButtonDefaults {
    ...
    public final void ActiveIcon(Composer $composer, int $changed) {
        ...
        str = 2;
        if ($changed & 6 == 0) {
            i4 = restartGroup.changed(this) ? 4 : str;
            obj10 |= i4;
        }
        if (obj10 & 3 == str) {
    ...
    public final void Icon(boolean active, Function2<? super Composer, ? super Integer, Unit> activeContent, Function2<? super Composer, ? super Integer, Unit> inactiveContent, Composer $composer, int $changed, int i6) {
        ...
        if (i6 & 1 != 0) {
            ...
            if (i15 & 6 == 0) {
                i2 = restartGroup.changed(active) ? 4 : i12;
                $dirty |= i2;
            } else {
                z = active;
            }
        ...
        if (i14 != 0) {
            ...
            if (i15 & 48 == 0) {
                i3 = restartGroup.changedInstance(activeContent) ? 32 : 16;
                $dirty |= i3;
            } else {
                obj = activeContent;
            }
        ...
        if (str != null) {
            ...
            if (i15 & 384 == 0) {
                i = restartGroup.changedInstance(inactiveContent) ? 256 : 128;
                $dirty |= i;
            } else {
                plus = inactiveContent;
            }
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new SegmentedButtonDefaults.Icon.3(this, active, obj2, inactiveContent2, i15, i6);
    ...
    public final androidx.compose.material3.SegmentedButtonColors colors-XqyqHi0(long activeContainerColor, long activeContentColor, long activeBorderColor, long inactiveContainerColor, long inactiveContentColor, long inactiveBorderColor, long disabledActiveContainerColor, long disabledActiveContentColor, long disabledActiveBorderColor, long disabledInactiveContainerColor, long disabledInactiveContentColor, long disabledInactiveBorderColor, Composer $composer, int $changed, int $changed1, int i16) {
        ...
        if (i3 & 1 != 0) {
            ...
            l = activeContainerColor;
        }
        if (i3 & 2 != 0) {
            l6 = unspecified-0d7_KjU2;
        } else {
            l6 = activeBorderColor;
        }
        if (i3 & 4 != 0) {
            l3 = unspecified-0d7_KjU11;
        } else {
            l3 = inactiveContentColor;
        }
        if (i3 & 8 != 0) {
            l9 = unspecified-0d7_KjU6;
        } else {
            l9 = disabledActiveContainerColor;
        }
        if (i3 & 16 != 0) {
            l2 = unspecified-0d7_KjU7;
        } else {
            l2 = disabledActiveBorderColor;
        }
        if (i3 & 32 != 0) {
            l4 = unspecified-0d7_KjU8;
        } else {
            l4 = disabledInactiveContentColor;
        }
        if (i3 & 64 != 0) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return this.getDefaultSegmentedButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).copy-2qZNXz8(l, obj7, l6, obj9, l3, obj11, l9, obj13, l2, obj15, l4, obj17);
    }
