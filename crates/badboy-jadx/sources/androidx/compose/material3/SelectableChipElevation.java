    ...
    private final State<Dp> animateElevation(boolean enabled, InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (i20 | it$iv2 == 0) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                animatable = 0;
                obj = obj4;
                animatable2 = new SelectableChipElevation.animateElevation.2.1(invalid$iv, f, z5, obj3, (MutableState)$i$a$CacheSelectableChipElevation$animateElevation$lastInteraction$2, 0);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer4);
        EffectsKt.LaunchedEffect(Dp.box-impl(f), (Function2)animatable2, composer4, 0);
        if (ComposerKt.isTraceInProgress()) {
