...
public final class StrategyKt {
    ...
    private static final androidx.compose.material3.carousel.KeylineList createShiftedKeylineListForContentPadding(androidx.compose.material3.carousel.KeylineList from, float carouselMainAxisSize, float itemSpacing, float contentPadding, androidx.compose.material3.carousel.Keyline pivot, int pivotIndex) {
        ...
        i3 = contentPadding / f;
        StrategyKt.createShiftedKeylineListForContentPadding.newKeylines.1 anon = new StrategyKt.createShiftedKeylineListForContentPadding.newKeylines.1(list, i3);
    ...
    private static final List<androidx.compose.material3.carousel.KeylineList> getEndKeylineSteps(androidx.compose.material3.carousel.KeylineList defaultKeylines, float carouselMainAxisSize, float itemSpacing, float afterContentPadding) {
        ...
        while (i2 < i5) {
            ...
            lastIndex = lastNonAnchorIndex - i2;
            dstIndex = 0;
    ...
    private static final androidx.compose.material3.carousel.ShiftPointRange getShiftPointRange(int stepsCount, FloatList shiftPoint, float interpolation) {
        ...
        ShiftPointRange $this$forEach$iv = new ShiftPointRange(i5, i5, i2);
    ...
    private static final List<androidx.compose.material3.carousel.KeylineList> getStartKeylineSteps(androidx.compose.material3.carousel.KeylineList defaultKeylines, float carouselMainAxisSize, float itemSpacing, float beforeContentPadding) {
        ...
        int cmp;
        int i;
        androidx.compose.material3.carousel.KeylineList shiftedKeylineListForContentPadding;
        int firstFocalIndex;
        ...
        i3 = 0;
        i = 0;
        shiftedKeylineListForContentPadding = 1;
        if (obj2.isFirstFocalItemAtStartOfContainer() && Float.compare(beforeContentPadding, i3) == 0) {
            if (Float.compare(beforeContentPadding, i3) == 0) {
                i = shiftedKeylineListForContentPadding;
            }
            if (i == 0) {
                i3 = itemSpacing;
                obj = obj2;
                f2 = i3;
                list.add(StrategyKt.createShiftedKeylineListForContentPadding(obj2, carouselMainAxisSize, i3, beforeContentPadding, obj2.getFirstFocal(), obj2.getFirstFocalIndex()));
            } else {
                f = carouselMainAxisSize;
                obj = obj2;
                f2 = itemSpacing;
        ...
        if (i4 <= 0 && Float.compare(cutoff, i3) > 0) {
            if (Float.compare(cutoff, i3) > 0) {
                list.add(StrategyKt.moveKeylineAndCreateShiftedKeylineList(obj5, i, i, f3, shiftedKeylineListForContentPadding2));
                return list;
            }
        }
        i2 = firstFocalIndex2;
        while (i2 < i4) {
            ...
            lastIndex = firstNonAnchorIndex + i2;
            dstIndex = CollectionsKt.getLastIndex((List)obj5);
            if (lastIndex > 0) {
            }
            list.add(StrategyKt.moveKeylineAndCreateShiftedKeylineList((KeylineList)firstFocalIndex2, obj5.getFirstNonAnchorIndex(), dstIndex, f3, shiftedKeylineListForContentPadding2));
            i2++;
        ...
        if (i == 0) {
            list.set(CollectionsKt.getLastIndex(list), StrategyKt.createShiftedKeylineListForContentPadding((KeylineList)CollectionsKt.last(list), f3, shiftedKeylineListForContentPadding2, beforeContentPadding, (KeylineList)CollectionsKt.last(list).getFirstFocal(), (KeylineList)CollectionsKt.last(list).getFirstFocalIndex()));
        }
        return list;
    }
