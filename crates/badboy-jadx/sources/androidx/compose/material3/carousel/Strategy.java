...
public final class Strategy {
    ...
    public boolean equals(Object other) {
        ...
        i5 = Float.compare(availableSpace, availableSpace2) == 0 ? i8 : i9;
        if (i5 == 0) {
            return i9;
        }
        i6 = Float.compare(itemSpacing, itemSpacing2) == 0 ? i8 : i9;
        if (i6 == 0) {
            return i9;
        }
        i7 = Float.compare(beforeContentPadding, beforeContentPadding2) == 0 ? i8 : i9;
        if (i7 == 0) {
            return i9;
        }
        i = Float.compare(afterContentPadding, afterContentPadding2) == 0 ? i8 : i9;
        if (i == 0) {
            return i9;
        }
        i2 = Float.compare(itemMainAxisSize, itemMainAxisSize2) == 0 ? i8 : i9;
        if (i2 == 0) {
            return i9;
        }
        i4 = Float.compare(startShiftDistance, startShiftDistance2) == 0 ? i8 : i9;
        if (i4 == 0) {
            return i9;
        }
        i3 = Float.compare(endShiftDistance, endShiftDistance2) == 0 ? i8 : i9;
        if (i3 == 0) {
            return i9;
        }
    ...
    public final androidx.compose.material3.carousel.KeylineList getKeylineListForScrollOffset$material3_release(float scrollOffset, float maxScrollOffset, boolean roundToNearestStep) {
        ...
        List steps;
        i2 = 0;
        final float f = Math.max(i2, scrollOffset);
        final float startShiftDistance = this.startShiftDistance;
        float f2 = Math.max(i2, maxScrollOffset - endShiftDistance);
        i = 0;
        ...
        int i4 = 1065353216;
        interpolation = StrategyKt.access$lerp(i4, i2, i2, startShiftDistance, f);
