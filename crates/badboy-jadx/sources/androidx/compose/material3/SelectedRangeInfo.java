        ...
        public final androidx.compose.material3.SelectedRangeInfo calculateRangeInfo(CalendarMonth month, CalendarDate startDate, CalendarDate endDate) {
            ...
            if (Long.compare(utcTimeMillis, startUtcTimeMillis) <= 0) {
                if (Long.compare(utcTimeMillis2, startUtcTimeMillis) < 0) {
                    ...
                    dayOfMonth = 0;
                    int i7 = 1;
                    i2 = Long.compare(utcTimeMillis3, startUtcTimeMillis2) >= 0 ? i7 : dayOfMonth;
                    final int i12 = i2;
                    final long endUtcTimeMillis = month.getEndUtcTimeMillis();
                    i = Long.compare(utcTimeMillis4, endUtcTimeMillis) <= 0 ? i7 : dayOfMonth;
                    if (i12 != 0) {
                        i4 -= i7;
                    } else {
                ...
                SelectedRangeInfo selectedRangeInfo = new SelectedRangeInfo(IntOffsetKt.IntOffset(daysFromStartOfWeekToFirstOfMonth % 7, daysFromStartOfWeekToFirstOfMonth / 7), endUtcTimeMillis, IntOffsetKt.IntOffset(i3 % 7, i3 / 7), obj7, i12, i, 0);
