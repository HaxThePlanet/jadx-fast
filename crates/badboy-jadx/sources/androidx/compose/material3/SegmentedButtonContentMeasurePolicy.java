...
public final class SegmentedButtonContentMeasurePolicy implements MultiContentMeasurePolicy {
    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends List<? extends Measurable>> measurables, long constraints) {
        ...
        while (it < obj12.size()) {
            $i$a$FastMaxBySegmentedButtonContentMeasurePolicy$measure$height$1 = 0;
            num = 0;
            (Collection)arrayList2.add((Measurable)obj12.get(it).measure-BRTryo0(l));
            it++;
            list2 = list;
            obj5 = obj6;
        }
        ...
        if ($this$fastMaxBy$iv2.isEmpty()) {
            ...
            it = CollectionsKt.getLastIndex($this$fastMaxBy$iv2);
            if (1 <= it) {
            } else {
                $i$a$FastMaxBySegmentedButtonContentMeasurePolicy$measure$iconWidth$1 = $this$fastMaxBy$iv2;
            }
        }
        if ((Placeable)maxElem$iv != 0) {
            valueOf2 = Integer.valueOf((Placeable)maxElem$iv.getWidth());
        } else {
            valueOf2 = 0;
        }
        int i32 = valueOf2;
        ...
        if ($this$fastMaxBy$iv.isEmpty()) {
            ...
            int i35 = 0;
            it = (Placeable)$this$fastMaxBy$iv.get(0).getHeight();
        ...
        if (obj9.initialOffset == null) {
            ...
            if ((Number)valueOf.getTargetValue().intValue() != i) {
                i$iv = new SegmentedButtonContentMeasurePolicy.measure.1(valueOf, i, 0);
                BuildersKt.launch$default(obj9.scope, 0, 0, (Function2)i$iv, 3, 0);
            }
        }
        int i27 = i2;
        SegmentedButtonContentMeasurePolicy.measure.2 anon = new SegmentedButtonContentMeasurePolicy.measure.2(list2, $this$measure_u2d3p2s80s, obj9, i, (List)arrayList2, i27);
        int i36 = i;
