...
public final class DatePickerColors {
    ...
    public final androidx.compose.material3.DatePickerColors copy-tNwlRmA(long containerColor, long titleContentColor, long headlineContentColor, long weekdayContentColor, long subheadContentColor, long navigationContentColor, long yearContentColor, long disabledYearContentColor, long currentYearContentColor, long selectedYearContentColor, long disabledSelectedYearContentColor, long selectedYearContainerColor, long disabledSelectedYearContainerColor, long dayContentColor, long disabledDayContentColor, long selectedDayContentColor, long disabledSelectedDayContentColor, long selectedDayContainerColor, long disabledSelectedDayContainerColor, long todayContentColor, long todayDateBorderColor, long dayInSelectionRangeContainerColor, long dayInSelectionRangeContentColor, long dividerColor, androidx.compose.material3.TextFieldColors dateTextFieldColors) {
        ...
        i3 = 1;
        final int i101 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$1 = Long.compare(i29, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$1 != 0) {
            l20 = i4;
        } else {
            int i75 = 0;
            l20 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$1;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv = headlineContentColor;
        int i6 = 0;
        int i77 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$2 = Long.compare(i30, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$2 != 0) {
            l15 = $this$takeOrElse_u2dDxMtmZc$iv;
        } else {
            int i74 = 0;
            l15 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$2;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv2 = subheadContentColor;
        int i7 = 0;
        int i78 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$3 = Long.compare(i31, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$3 != 0) {
            l4 = $this$takeOrElse_u2dDxMtmZc$iv2;
        } else {
            int i73 = 0;
            l4 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$3;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv3 = yearContentColor;
        int i8 = 0;
        int i79 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$4 = Long.compare(i32, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$4 != 0) {
            l2 = $this$takeOrElse_u2dDxMtmZc$iv3;
        } else {
            int i72 = 0;
            l2 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$4;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv4 = currentYearContentColor;
        int i9 = 0;
        int i80 = 0;
        $this$isSpecified$iv$iv = Long.compare(i33, i100) != 0 ? i3 : i101;
        if ($this$isSpecified$iv$iv != 0) {
            l5 = $this$takeOrElse_u2dDxMtmZc$iv4;
        } else {
            int i71 = 0;
            l5 = $this$isSpecified$iv$iv;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv5 = disabledSelectedYearContentColor;
        int i10 = 0;
        int i81 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$6 = Long.compare(i34, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$6 != 0) {
            l9 = $this$takeOrElse_u2dDxMtmZc$iv5;
        } else {
            int i70 = 0;
            l9 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$6;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv6 = disabledSelectedYearContainerColor;
        int i11 = 0;
        int i82 = 0;
        $this$isSpecified$iv$iv2 = Long.compare(i35, i100) != 0 ? i3 : i101;
        if ($this$isSpecified$iv$iv2 != 0) {
            l = $this$takeOrElse_u2dDxMtmZc$iv6;
        } else {
            int i69 = 0;
        ...
        int i12 = 0;
        int i83 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$8 = Long.compare(i36, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$8 != 0) {
            l21 = $this$takeOrElse_u2dDxMtmZc$iv7;
        } else {
            int i68 = 0;
            l21 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$8;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv8 = disabledSelectedDayContentColor;
        int i13 = 0;
        int i84 = 0;
        $this$isSpecified$iv$iv4 = Long.compare(i37, i100) != 0 ? i3 : i101;
        if ($this$isSpecified$iv$iv4 != 0) {
            l22 = $this$takeOrElse_u2dDxMtmZc$iv8;
        } else {
            int i67 = 0;
        ...
        int i14 = 0;
        int i85 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$10 = Long.compare(i38, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$10 != 0) {
            l11 = $this$takeOrElse_u2dDxMtmZc$iv9;
        } else {
            int i66 = 0;
            l11 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$10;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv10 = todayDateBorderColor;
        int i15 = 0;
        int i86 = 0;
        $this$isSpecified$iv$iv3 = Long.compare(i39, i100) != 0 ? i3 : i101;
        if ($this$isSpecified$iv$iv3 != 0) {
            l17 = $this$takeOrElse_u2dDxMtmZc$iv10;
        } else {
            int i65 = 0;
            l17 = $this$isSpecified$iv$iv3;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv11 = dayInSelectionRangeContentColor;
        int i16 = 0;
        int i87 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$12 = Long.compare(i40, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$12 != 0) {
            l12 = $this$takeOrElse_u2dDxMtmZc$iv11;
        } else {
            int i64 = 0;
            l12 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$12;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv12 = dateTextFieldColors;
        int i17 = 0;
        int i88 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$13 = Long.compare(i41, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$13 != 0) {
            l6 = $this$takeOrElse_u2dDxMtmZc$iv12;
        } else {
            int i63 = 0;
            l6 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$13;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv13 = obj90;
        int i18 = 0;
        int i89 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$14 = Long.compare(i42, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$14 != 0) {
            l18 = $this$takeOrElse_u2dDxMtmZc$iv13;
        } else {
            int i62 = 0;
            l18 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$14;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv14 = obj92;
        int i19 = 0;
        int i90 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$15 = Long.compare(i43, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$15 != 0) {
            i2 = $this$takeOrElse_u2dDxMtmZc$iv14;
        } else {
            int i61 = 0;
            i2 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$15;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv15 = obj94;
        int i20 = 0;
        int i91 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$16 = Long.compare(i44, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$16 != 0) {
            l16 = $this$takeOrElse_u2dDxMtmZc$iv15;
        } else {
            int i60 = 0;
            l16 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$16;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv16 = obj96;
        int i21 = 0;
        int i92 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$17 = Long.compare(i45, i100) != 0 ? i3 : i101;
        ...
        int i22 = 0;
        int i93 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$18 = Long.compare(i46, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$18 != 0) {
            l7 = $this$takeOrElse_u2dDxMtmZc$iv17;
        } else {
            int i58 = 0;
            l7 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$18;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv18 = obj100;
        int i23 = 0;
        int i94 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$19 = Long.compare(i47, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$19 != 0) {
            l10 = $this$takeOrElse_u2dDxMtmZc$iv18;
        } else {
            int i48 = 0;
            l10 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$19;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv19 = obj102;
        int i24 = 0;
        int i95 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$20 = Long.compare(i49, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$20 != 0) {
            l19 = $this$takeOrElse_u2dDxMtmZc$iv19;
        } else {
            int i57 = 0;
            l19 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$20;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv20 = obj104;
        int i25 = 0;
        int i96 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$21 = Long.compare(i50, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$21 != 0) {
            l14 = $this$takeOrElse_u2dDxMtmZc$iv20;
        } else {
            int i51 = 0;
            l14 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$21;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv21 = obj106;
        int i26 = 0;
        int i97 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$22 = Long.compare(i52, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$22 != 0) {
            l8 = $this$takeOrElse_u2dDxMtmZc$iv21;
        } else {
            int i56 = 0;
            l8 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$22;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv22 = obj108;
        int i27 = 0;
        int i98 = 0;
        $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$23 = Long.compare(i53, i100) != 0 ? i3 : i101;
        if ($i$a$TakeOrElseDxMtmZcDatePickerColors$copy$23 != 0) {
            l13 = $this$takeOrElse_u2dDxMtmZc$iv22;
        } else {
            int i55 = 0;
            l13 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$23;
        }
        ...
        if (i3 != 0) {
            l3 = $this$takeOrElse_u2dDxMtmZc$iv23;
        } else {
            int i54 = 0;
            l3 = $i$a$TakeOrElseDxMtmZcDatePickerColors$copy$24;
        }
        DatePickerColors.copy.25 $this$takeOrElse_u2dDxMtmZc$iv24 = new DatePickerColors.copy.25(obj);
        DatePickerColors datePickerColors = new DatePickerColors(l20, obj14, l15, obj16, l4, obj18, l2, obj20, l5, obj22, l9, obj24, l, obj26, l21, obj28, l22, obj30, l11, obj32, l17, obj34, l12, obj36, l6, obj38, l18, obj40, i2, obj42, l16, obj44, i, obj46, l7, obj48, l10, obj50, l19, obj52, l14, obj54, l8, obj56, l13, obj58, l3, obj60, obj.takeOrElse$material3_release(obj112, (Function0)$this$takeOrElse_u2dDxMtmZc$iv24), 0);
