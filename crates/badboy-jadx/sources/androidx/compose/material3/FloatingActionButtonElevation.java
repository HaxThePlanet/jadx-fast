    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (changedInstance |= i4 == 0) {
            if (rememberedValue3 == Composer.Companion.getEmpty()) {
                rememberedValue = 0;
                anon = new FloatingActionButtonElevation.animateElevation.1.1(floatingActionButtonElevationAnimatable, obj, i24);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        EffectsKt.LaunchedEffect(obj, (Function2)anon, composer, i12 &= 14);
        ...
        if (changedInstance2 |= i2 == 0) {
            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                empty = 0;
                anon2 = new FloatingActionButtonElevation.animateElevation.2.1(obj2, floatingActionButtonElevationAnimatable, i24);
