...
final class DateRangePickerStateImpl extends androidx.compose.material3.BaseDatePickerStateImpl implements androidx.compose.material3.DateRangePickerState {
    ...
    public void setSelection(Long startDateMillis, Long endDateMillis) {
        ...
        if (canonicalDate2 != null) {
            ...
            IllegalArgumentException illegalArgumentException = new IllegalArgumentException(stringBuilder.append("The provided start date year (").append(utcTimeMillis.getYear()).append(str).append(getYearRange()).append(i).toString().toString());
        ...
        if (canonicalDate != null) {
            ...
            IllegalArgumentException illegalArgumentException2 = new IllegalArgumentException(stringBuilder2.append("The provided end date year (").append(utcTimeMillis.getYear()).append(str).append(getYearRange()).append(i).toString().toString());
            throw illegalArgumentException2;
        }
        if (canonicalDate != null) {
            if (canonicalDate2 == null) {
            } else {
                i = Long.compare(utcTimeMillis2, utcTimeMillis) <= 0 ? 1 : 0;
                if (i == 0) {
                } else {
                }
                int i4 = 0;
