...
public final class SliderColors {
    ...
    public final androidx.compose.material3.SliderColors copy--K518z4(long thumbColor, long activeTrackColor, long activeTickColor, long inactiveTrackColor, long inactiveTickColor, long disabledThumbColor, long disabledActiveTrackColor, long disabledActiveTickColor, long disabledInactiveTrackColor, long disabledInactiveTickColor) {
        ...
        if ($i$a$TakeOrElseDxMtmZcSliderColors$copy$1 != 0) {
            ...
            int i31 = 0;
            l9 = $i$a$TakeOrElseDxMtmZcSliderColors$copy$1;
        }
        ...
        if ($i$a$TakeOrElseDxMtmZcSliderColors$copy$2 != 0) {
            ...
            int i30 = 0;
            l8 = $i$a$TakeOrElseDxMtmZcSliderColors$copy$2;
        }
        ...
        if ($i$a$TakeOrElseDxMtmZcSliderColors$copy$4 != 0) {
            l = $this$takeOrElse_u2dDxMtmZc$iv3;
        } else {
            int i28 = 0;
            l = $i$a$TakeOrElseDxMtmZcSliderColors$copy$4;
        }
        ...
        if ($this$isSpecified$iv$iv2 != 0) {
            l2 = $this$takeOrElse_u2dDxMtmZc$iv4;
        } else {
            int i27 = 0;
        ...
        int i9 = 0;
        int i38 = 0;
        $this$isSpecified$iv$iv5 = Long.compare(i19, i42) != 0 ? i : i43;
        ...
        int i10 = 0;
        int i39 = 0;
        $this$isSpecified$iv$iv = Long.compare(i20, i42) != 0 ? i : i43;
        if ($this$isSpecified$iv$iv != 0) {
            l10 = $this$takeOrElse_u2dDxMtmZc$iv7;
        } else {
            int i24 = 0;
        ...
        int i11 = 0;
        int i40 = 0;
        $this$isSpecified$iv$iv3 = Long.compare(i21, i42) != 0 ? i : i43;
        if ($this$isSpecified$iv$iv3 != 0) {
            l5 = $this$takeOrElse_u2dDxMtmZc$iv8;
        } else {
            int i23 = 0;
            l5 = $this$isSpecified$iv$iv3;
        }
        ...
        if (i != 0) {
            ...
            int i22 = 0;
            l3 = $i$a$TakeOrElseDxMtmZcSliderColors$copy$10;
        }
        SliderColors sliderColors = new SliderColors(l9, obj14, l8, obj16, l4, obj18, l, obj20, l2, obj22, l7, obj24, l6, obj26, l10, obj28, l5, obj30, l3, obj32, 0);
        return sliderColors;
    }
