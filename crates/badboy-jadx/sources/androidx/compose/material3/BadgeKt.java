...
public final class BadgeKt {
    ...
    public static final void Badge-eopBjH0(Modifier modifier, long containerColor, long contentColor, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i7) {
        ...
        if (i26 != 0) {
            ...
            if (i44 & 6 == 0) {
                i6 = restartGroup.changed(modifier) ? 4 : $i$a$LayoutRowKt$Row$1$iv;
                $dirty2 |= i6;
            } else {
                obj = modifier;
            }
        ...
        if (i44 & 384 == 0) {
            if (obj40 & 4 == 0) {
                i14 = restartGroup.changed(content) ? 256 : 128;
            } else {
        ...
        if (str != null) {
            ...
            if (i44 & 3072 == 0) {
                i5 = restartGroup.changedInstance($changed) ? 2048 : 1024;
                $dirty2 |= i5;
            } else {
                i11 = $changed;
            }
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i44 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (obj40 & 2 != 0) {
                            containerColor2 = BadgeDefaults.INSTANCE.getContainerColor(restartGroup, i15);
                            $dirty2 &= -113;
                        } else {
                            containerColor2 = l4;
                        }
                        if (obj40 & 4 != 0) {
                            contentColorFor-ek8zF_U = ColorSchemeKt.contentColorFor-ek8zF_U(containerColor2, l4, restartGroup);
                            $dirty2 &= -897;
                        }
                        if (str != null) {
                            i11 = i13;
                ...
                if (i11 != null) {
                    ...
                    value = ShapesKt.getValue(BadgeTokens.INSTANCE.getLargeShape(), restartGroup, i15);
                    restartGroup.endReplaceGroup();
                } else {
                    restartGroup.startReplaceGroup(-1271743789);
                    ComposerKt.sourceInformation(restartGroup, "189@8378L5");
                    value = ShapesKt.getValue(BadgeTokens.INSTANCE.getShape(), restartGroup, i15);
                    restartGroup.endReplaceGroup();
                }
                if (i11 != null) {
                    obj38 = i15;
                    size2 = largeSize-D9Ej5fM;
                    size = PaddingKt.padding-VpY3zN4$default((Modifier)Modifier.Companion, BadgeKt.BadgeWithContentHorizontalPadding, 0, $i$a$LayoutRowKt$Row$1$iv, 0);
                } else {
                    size2 = largeSize-D9Ej5fM;
                    obj38 = i15;
                ...
                Modifier materializeModifier = ComposedModifierKt.materializeModifier(restartGroup, BackgroundKt.background-bw27NRU(SizeKt.defaultMinSize-VpY3zN4(modifier2, largeSize-D9Ej5fM, largeSize-D9Ej5fM), containerColor2, l4).then(size));
                ...
                if (!obj32.getInserting()) {
                    ...
                    l = containerColor2;
                    if (!Intrinsics.areEqual(obj32.rememberedValue(), Integer.valueOf(i12))) {
                        obj32.updateRememberedValue(Integer.valueOf(i12));
                ...
                if (i11 != null) {
                    BadgeKt.Badge.1.1 anon = new BadgeKt.Badge.1.1(i11, (RowScope)$this$Badge_eopBjH0_u24lambda_u2415);
                    obj34 = value2;
        ...
        if (endRestartGroup != null) {
            traceInProgress = new BadgeKt.Badge.2($dirty, l3, $i$a$LayoutRowKt$Row$1$iv, l2, l4, obj2, i44, obj40);
    ...
    public static final void BadgedBox(Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> badge, Modifier modifier, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i6) {
        ...
        if (i6 & 4 != 0) {
            ...
            if (i2 & 384 == 0) {
                i22 = restartGroup.changedInstance(obj3) ? 256 : 128;
                $dirty |= i22;
            }
        }
        i4 = $dirty;
        if (i4 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, i4, -1, "androidx.compose.material3.BadgedBox (Badge.kt:72)");
                }
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(modifier3, (Function1)$i$a$CacheBadgeKt$BadgedBox$2);
                ...
                int i35 = 0;
                obj4 = invalid$iv3;
                maybeCachedBoxMeasurePolicy2 = BoxKt.maybeCachedBoxMeasurePolicy(center, i35);
                int i96 = 0;
                int i97 = i35;
        ...
        if (endRestartGroup != null) {
            traceInProgress = new BadgeKt.BadgedBox.4(obj6, obj, content, $changed, i6);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
