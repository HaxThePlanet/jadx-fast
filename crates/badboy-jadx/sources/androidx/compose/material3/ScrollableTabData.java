...
final class ScrollableTabData {
    ...
    public static final ScrollState access$getScrollState$p(androidx.compose.material3.ScrollableTabData $this) {
        return $this.scrollState;
    }

    private final int calculateTabOffset(androidx.compose.material3.TabPosition $this$calculateTabOffset, Density density, int edgeOffset, List<androidx.compose.material3.TabPosition> tabPositions) {
    ...
    public final void onLaidOut(Density density, int edgeOffset, List<androidx.compose.material3.TabPosition> tabPositions, int selectedTab) {
        Object selectedTab2;
        int i;
        int tabOffset;
        int value;
        ...
        if (selectedTab2 == null) {
            ...
            if ((TabPosition)selectedTab2 != null) {
                ...
                if (this.scrollState.getValue() != tabOffset) {
                    i2 = 0;
                    value = new ScrollableTabData.onLaidOut.1.1(this, tabOffset, i2);
                    BuildersKt.launch$default(this.coroutineScope, i2, 0, (Function2)value, 3, 0);
                }
            }
        } else {
            this.selectedTab = Integer.valueOf(selectedTab);
