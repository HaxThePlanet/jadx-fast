...
public final class SnackbarHostState {
    ...
    public final Object showSnackbar(androidx.compose.material3.SnackbarVisuals snackbarVisuals, Continuation<? super androidx.compose.material3.SnackbarResult> continuation2) {
        ...
        if (obj2 instanceof SnackbarHostState.showSnackbar.2 && label2 &= i6 != 0) {
            anon = obj2;
            i6 = Integer.MIN_VALUE;
            if (label2 &= i6 != 0) {
                anon.label = label -= i6;
                ...
                anon = new SnackbarHostState.showSnackbar.2(this, obj2);
            }
        } else {
        }
        ...
        SnackbarHostState.access$setCurrentSnackbarData(owner$iv2, (SnackbarData)$continuation2);
