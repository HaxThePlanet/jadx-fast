...
final class DateVisualTransformation implements VisualTransformation {
    ...
    public TransformedText filter(AnnotatedString text) {
        ...
        while (i3 < (CharSequence)str2.length()) {
            i4 = 0;
            StringBuilder stringBuilder = new StringBuilder();
            if (i + 1 != this.firstDelimiterOffset) {
            } else {
            }
            StringBuilder stringBuilder2 = new StringBuilder();
            transformedText2 = stringBuilder2.append(stringBuilder.append(transformedText2).append(str2.charAt(i3)).toString()).append(this.dateInputFormat.getDelimiter()).toString();
            i3++;
            i = i2;
            if (i + 2 == this.secondDelimiterOffset) {
            }
        }
