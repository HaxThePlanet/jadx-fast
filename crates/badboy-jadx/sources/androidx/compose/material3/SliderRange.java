...
public final class SliderRange {
    ...
    public static final float getEndInclusive-impl(long arg0) {
        ...
        int i2 = 0;
        IllegalStateException $i$a$CheckSliderRange$endInclusive$1 = new IllegalStateException("SliderRange is unspecified".toString());
        throw $i$a$CheckSliderRange$endInclusive$1;
    }
    ...
    public static final float getStart-impl(long arg0) {
        ...
        int i2 = 0;
        IllegalStateException $i$a$CheckSliderRange$start$1 = new IllegalStateException("SliderRange is unspecified".toString());
        throw $i$a$CheckSliderRange$start$1;
    }
