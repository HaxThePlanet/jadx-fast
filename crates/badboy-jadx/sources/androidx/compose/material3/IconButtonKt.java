...
public final class IconButtonKt {
    public static final void FilledIconButton(Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, androidx.compose.material3.IconButtonColors colors, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i10) {
        ...
        if (i42 &= $dirty4 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                SurfaceKt.Surface-o_FOJdg(obj5, SemanticsModifierKt.semantics$default(modifier2, false, (Function1)IconButtonKt.FilledIconButton.1.INSTANCE, i37, 0), colors2, i4, $dirty2.containerColor-vNxB06k$material3_release(colors2), defaultsInvalid, $dirty2.contentColor-vNxB06k$material3_release(colors2), obj16, 0, 0, 0, obj4, (Function2)ComposableLambdaKt.rememberComposableLambda(-1560623888, i37, anon, restartGroup, 54), restartGroup, i19 | i29);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            traceInProgress = new IconButtonKt.FilledIconButton.3(onClick, $dirty3, modifier3, $dirty, obj6, obj, obj9, i34, i10);
    ...
    public static final void FilledIconToggleButton(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, androidx.compose.material3.IconToggleButtonColors colors, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i11) {
        ...
        if (i28 & 2 != 0) {
            ...
            if (i23 & 48 == 0) {
                i6 = restartGroup.changedInstance(onCheckedChange) ? 32 : 16;
                $dirty2 |= i6;
            } else {
                obj2 = onCheckedChange;
            }
        ...
        if (i2 != 0) {
            ...
            if (i59 &= i23 == 0) {
                i4 = restartGroup.changed(interactionSource) ? 1048576 : 524288;
                $dirty2 |= i4;
            } else {
                obj = interactionSource;
            }
        ...
        if (i30 &= $dirty2 == 4793490) {
            if (!restartGroup.getSkipping()) {
                ...
                int i50 = 1;
                semantics$default = SemanticsModifierKt.semantics$default(obj4, false, (Function1)IconButtonKt.FilledIconToggleButton.1.INSTANCE, i50, 0);
                IconButtonKt.FilledIconToggleButton.2 anon = new IconButtonKt.FilledIconToggleButton.2(obj8);
                colors2 = i3;
                SurfaceKt.Surface-d85dljk(checked, onCheckedChange, semantics$default, z, obj7, (Color)$dirty3.containerColor$material3_release(z, traceInProgress, restartGroup, i41 |= i48).getValue().unbox-impl(), obj2, (Color)$dirty3.contentColor$material3_release(z, traceInProgress, restartGroup, i57 |= i64).getValue().unbox-impl(), semantics$default, 0, 0, 0, colors5, (Function2)ComposableLambdaKt.rememberComposableLambda(1235871670, i50, anon, restartGroup, 54), restartGroup, i13 |= i19);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $dirty = obj7;
        ...
        if (endRestartGroup != null) {
            traceInProgress = new IconButtonKt.FilledIconToggleButton.3(checked, onCheckedChange, enabled2, shape3, $dirty, obj9, obj6, content, $changed, i11);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    public static final void FilledTonalIconButton(Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, androidx.compose.material3.IconButtonColors colors, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i10) {
        ...
        if (i10 & 64 != 0) {
            ...
            if (i34 & i43 == 0) {
                i7 = restartGroup.changedInstance(obj9) ? 1048576 : 524288;
                $dirty4 |= i7;
            }
        }
        if (i42 &= $dirty4 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, interactionSource2, -1, "androidx.compose.material3.FilledTonalIconButton (IconButton.kt:289)");
                }
                int i37 = 1;
                IconButtonKt.FilledTonalIconButton.2 anon = new IconButtonKt.FilledTonalIconButton.2(obj9);
                SurfaceKt.Surface-o_FOJdg(obj3, SemanticsModifierKt.semantics$default(modifier2, false, (Function1)IconButtonKt.FilledTonalIconButton.1.INSTANCE, i37, 0), colors2, i6, $dirty3.containerColor-vNxB06k$material3_release(colors2), defaultsInvalid, $dirty3.contentColor-vNxB06k$material3_release(colors2), obj16, 0, 0, 0, obj6, (Function2)ComposableLambdaKt.rememberComposableLambda(-1772884636, i37, anon, restartGroup, 54), restartGroup, i19 | i29);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj5 = $dirty3;
        ...
        ScopeUpdateScope endRestartGroup = composer.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new IconButtonKt.FilledTonalIconButton.3(onClick, $dirty, modifier3, $dirty2, obj5, obj4, obj9, i34, i10);
    ...
    public static final void FilledTonalIconToggleButton(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, androidx.compose.material3.IconToggleButtonColors colors, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i11) {
        ...
        if (i28 & 128 != 0) {
            ...
            if (i23 & colors5 == 0) {
                i = restartGroup.changedInstance(obj6) ? 8388608 : 4194304;
                $dirty |= i;
            }
        }
        if (i30 &= $dirty == 4793490) {
            if (!restartGroup.getSkipping()) {
                restartGroup.startDefaults();
                int i32 = -458753;
                int i65 = -57345;
                ...
                int i50 = 1;
                semantics$default = SemanticsModifierKt.semantics$default(obj7, false, (Function1)IconButtonKt.FilledTonalIconToggleButton.1.INSTANCE, i50, 0);
                IconButtonKt.FilledTonalIconToggleButton.2 anon = new IconButtonKt.FilledTonalIconToggleButton.2(obj6);
                colors3 = i4;
                SurfaceKt.Surface-d85dljk(checked, onCheckedChange, semantics$default, z, obj8, (Color)$dirty3.containerColor$material3_release(z, traceInProgress, restartGroup, i41 |= i48).getValue().unbox-impl(), obj5, (Color)$dirty3.contentColor$material3_release(z, traceInProgress, restartGroup, i57 |= i64).getValue().unbox-impl(), semantics$default, 0, 0, 0, colors6, (Function2)ComposableLambdaKt.rememberComposableLambda(-58218680, i50, anon, restartGroup, 54), restartGroup, i13 |= i19);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $dirty2 = obj8;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new IconButtonKt.FilledTonalIconToggleButton.3(checked, onCheckedChange, enabled2, shape3, $dirty2, obj2, obj3, content, $changed, i11);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    public static final void IconButton(Function0<Unit> onClick, Modifier modifier, boolean enabled, androidx.compose.material3.IconButtonColors colors, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i9) {
        ...
        if (i9 & 32 != 0) {
            ...
            if (i35 & i47 == 0) {
                i11 = restartGroup.changedInstance(obj8) ? 131072 : 65536;
                $dirty2 |= i11;
            }
        }
        if (i43 &= $dirty2 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (i35 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (str != null) {
                            ...
                            obj5 = obj3;
                            obj4 = maybeCachedBoxMeasurePolicy;
                        }
                    } else {
                        restartGroup.skipToGroupEnd();
                        if (i9 & 8 != 0) {
                ...
                boolean z6 = $dirty;
                i7 = obj4;
                Modifier clickable-O2vRcR0$default = ClickableKt.clickable-O2vRcR0$default(BackgroundKt.background-bw27NRU$default(ClipKt.clip(SizeKt.size-3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(modifier2), IconButtonTokens.INSTANCE.getStateLayerSize-D9Ej5fM()), ShapesKt.getValue(IconButtonTokens.INSTANCE.getStateLayerShape(), restartGroup, i49)), obj5.containerColor-vNxB06k$material3_release($dirty), obj18, 0, 2), i7, RippleKt.rippleOrFallbackImplementation-9IZ8Weo(false, Dp.constructor-impl(stateLayerSize-D9Ej5fM2 / f), 0, 0, restartGroup, 54), z6, 0, Role.box-impl(Role.Companion.getButton-o7Vup1c()), obj2, 8, i57);
                z = z6;
                ...
                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.box-impl(obj5.contentColor-vNxB06k$material3_release(z))), obj8, composer3, $stable |= i4);
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new IconButtonKt.IconButton.2(onClick, obj7, z2, obj5, obj6, obj8, i35, i9);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    public static final void IconToggleButton(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, androidx.compose.material3.IconToggleButtonColors colors, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i10) {
        ...
        if (i10 & 1 != 0) {
            ...
            if (i42 & 6 == 0) {
                i9 = restartGroup.changed(z3) ? 4 : 2;
                $dirty2 |= i9;
            }
        }
        if (i10 & 2 != 0) {
        ...
        if (i10 & 64 != 0) {
            ...
            if (i42 & i63 == 0) {
                i3 = restartGroup.changedInstance(obj9) ? 1048576 : 524288;
                $dirty2 |= i3;
            }
        }
        if (i58 &= $dirty2 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                Object colors3 = obj6;
                z = modifier2;
                Modifier toggleable-O2vRcR0 = ToggleableKt.toggleable-O2vRcR0(BackgroundKt.background-bw27NRU$default(ClipKt.clip(SizeKt.size-3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(obj2), IconButtonTokens.INSTANCE.getStateLayerSize-D9Ej5fM()), ShapesKt.getValue(IconButtonTokens.INSTANCE.getStateLayerShape(), restartGroup, i44)), (Color)$dirty.containerColor$material3_release(enabled2, z3, restartGroup, i17 |= i50).getValue().unbox-impl(), obj19, 0, 2), z3, colors3, RippleKt.rippleOrFallbackImplementation-9IZ8Weo(false, Dp.constructor-impl(stateLayerSize-D9Ej5fM2 / f), 0, 0, restartGroup, 54), enabled2, Role.box-impl(Role.Companion.getCheckbox-o7Vup1c()), obj3);
                Alignment center = Alignment.Companion.getCenter();
                int i36 = 48;
                valueOf = 0;
                ComposerKt.sourceInformationMarkerStart(restartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
                ...
                CompositionLocalKt.CompositionLocalProvider(ContentColorKt.getLocalContentColor().provides(Color.box-impl((Color)obj10.contentColor$material3_release(enabled2, z3, composer3, i25 |= i31).getValue().unbox-impl())), obj9, composer3, $stable |= i12);
                ComposerKt.sourceInformationMarkerEnd(composer3);
                ComposerKt.sourceInformationMarkerEnd(composer3);
                restartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                ...
                enabled2 = z;
                obj = obj4;
                obj8 = maybeCachedBoxMeasurePolicy;
                colors2 = $dirty2;
            }
        } else {
        }
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new IconButtonKt.IconToggleButton.2(z3, onCheckedChange, obj5, enabled2, obj, obj8, obj9, i42, i10);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    public static final void OutlinedIconButton(Function0<Unit> onClick, Modifier modifier, boolean enabled, Shape shape, androidx.compose.material3.IconButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i11) {
        ...
        if (i48 & 1 != 0) {
            ...
            if (i47 & 6 == 0) {
                i3 = traceInProgress2.changedInstance(onClick) ? 4 : 2;
                $dirty |= i3;
            } else {
                obj6 = onClick;
            }
        ...
        if (i20 != 0) {
            ...
            if (i47 & 48 == 0) {
                i = traceInProgress2.changed(modifier) ? 32 : 16;
                $dirty |= i;
            } else {
                colors3 = modifier;
            }
        ...
        if (i47 & 24576 == 0) {
            if (i48 & 16 == 0) {
                changed2 = traceInProgress2.changed(colors) ? 16384 : 8192;
            } else {
        ...
        if (i9 != 0) {
            ...
            if (i54 &= i47 == 0) {
                i4 = traceInProgress2.changed(interactionSource) ? 1048576 : 524288;
                $dirty |= i4;
            } else {
                containerColor-vNxB06k$material3_release = interactionSource;
            }
        ...
        if (i48 & 128 != 0) {
            $dirty |= contentColor-vNxB06k$material3_release;
        } else {
            if (i47 & contentColor-vNxB06k$material3_release == 0) {
                i2 = traceInProgress2.changedInstance(obj10) ? 8388608 : 4194304;
                $dirty |= i2;
            }
        }
        if (i15 &= $dirty == 4793490) {
            if (!traceInProgress2.getSkipping()) {
                ...
                SurfaceKt.Surface-o_FOJdg(obj6, SemanticsModifierKt.semantics$default(modifier2, false, (Function1)IconButtonKt.OutlinedIconButton.1.INSTANCE, i46, 0), border2, i9, $dirty3.containerColor-vNxB06k$material3_release(border2), i4, $dirty3.contentColor-vNxB06k$material3_release(border2), obj18, 0, 0, obj4, obj, (Function2)ComposableLambdaKt.rememberComposableLambda(582332538, i46, anon, traceInProgress2, 54), traceInProgress2, i28 | i36);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj7 = $dirty3;
        ...
        ScopeUpdateScope endRestartGroup = composer.endRestartGroup();
        if (endRestartGroup != null) {
            modifier2 = new IconButtonKt.OutlinedIconButton.3(onClick, colors2, $dirty2, obj3, obj7, obj8, obj5, obj10, i47, i48);
    ...
    public static final void OutlinedIconToggleButton(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, Shape shape, androidx.compose.material3.IconToggleButtonColors colors, BorderStroke border, MutableInteractionSource interactionSource, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i12) {
        ...
        if (i36 & 256 != 0) {
            ...
            if ($changed & modifier2 == 0) {
                i3 = restartGroup.changedInstance(obj) ? 67108864 : 33554432;
                $dirty3 |= i3;
            }
        }
        if (i29 &= $dirty3 == 38347922) {
            if (!restartGroup.getSkipping()) {
                restartGroup.startDefaults();
                int i38 = -3670017;
                int i76 = -458753;
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(1470292106, i10, -1, "androidx.compose.material3.OutlinedIconToggleButton (IconButton.kt:561)");
                }
                Modifier semantics$default = SemanticsModifierKt.semantics$default(obj8, false, (Function1)IconButtonKt.OutlinedIconToggleButton.1.INSTANCE, 1, 0);
                IconButtonKt.OutlinedIconToggleButton.2 anon = new IconButtonKt.OutlinedIconToggleButton.2(obj);
                modifier3 = i10;
                SurfaceKt.Surface-d85dljk(checked, onCheckedChange, semantics$default, z, obj3, (Color)$dirty2.containerColor$material3_release(z, traceInProgress, restartGroup, i50 |= i58).getValue().unbox-impl(), obj6, (Color)$dirty2.contentColor$material3_release(z, traceInProgress, restartGroup, i68 |= i73).getValue().unbox-impl(), semantics$default, 0, 0, shape2, colors4, (Function2)ComposableLambdaKt.rememberComposableLambda(1207657396, true, anon, restartGroup, 54), restartGroup, i16 |= i24);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $dirty = obj3;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new IconButtonKt.OutlinedIconToggleButton.3(checked, onCheckedChange, enabled2, shape3, $dirty, obj12, obj10, obj11, content, $changed, i12);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
}
