...
final class DelegatingThemeAwareRippleNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, ObserverModifierNode {
    ...
    public static final void access$attachNewRipple(androidx.compose.material3.DelegatingThemeAwareRippleNode $this) {
        $this.attachNewRipple();
    }

    public static final ColorProducer access$getColor$p(androidx.compose.material3.DelegatingThemeAwareRippleNode $this) {
        return $this.color;
    }

    public static final DelegatableNode access$getRippleNode$p(androidx.compose.material3.DelegatingThemeAwareRippleNode $this) {
        return $this.rippleNode;
    }

    public static final void access$removeRipple(androidx.compose.material3.DelegatingThemeAwareRippleNode $this) {
        $this.removeRipple();
    }
