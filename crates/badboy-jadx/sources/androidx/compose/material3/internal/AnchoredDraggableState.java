...
public final class AnchoredDraggableState<T>  {
    ...
    @Metadata(d1 = "\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0008\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0008\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0008\u0003\n\u0002\u0018\u0002\n\u0000\u0008\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\u0008\u0002¢\u0006\u0002\u0010\u0002Ju\u0010\u0003\u001a\u0014\u0012\n\u0012\u0008\u0012\u0004\u0012\u0002H\u00060\u0005\u0012\u0004\u0012\u0002H\u00060\u0004\"\u0008\u0008\u0001\u0010\u0006*\u00020\u00012\u000c\u0010\u0007\u001a\u0008\u0012\u0004\u0012\u00020\t0\u00082\u0012\u0010\n\u001a\u000e\u0012\u0004\u0012\u0002H\u0006\u0012\u0004\u0012\u00020\u000c0\u000b2!\u0010\r\u001a\u001d\u0012\u0013\u0012\u00110\t¢\u0006\u000c\u0008\u000e\u0012\u0008\u0008\u000f\u0012\u0004\u0008\u0008(\u0010\u0012\u0004\u0012\u00020\t0\u000b2\u000c\u0010\u0011\u001a\u0008\u0012\u0004\u0012\u00020\t0\u0012¨\u0006\u0013", d2 = {"Landroidx/compose/material3/internal/AnchoredDraggableState$Companion;", "", "()V", "Saver", "Landroidx/compose/runtime/saveable/Saver;", "Landroidx/compose/material3/internal/AnchoredDraggableState;", "T", "animationSpec", "Landroidx/compose/animation/core/AnimationSpec;", "", "confirmValueChange", "Lkotlin/Function1;", "", "positionalThreshold", "Lkotlin/ParameterName;", "name", "distance", "velocityThreshold", "Lkotlin/Function0;", "material3_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class Companion {
        public Companion(DefaultConstructorMarker defaultConstructorMarker) {
            super();
        }

        public final <T> Saver<androidx.compose.material3.internal.AnchoredDraggableState<T>, T> Saver(AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> confirmValueChange, Function1<? super Float, Float> positionalThreshold, Function0<Float> velocityThreshold) {
    ...
    public AnchoredDraggableState(T initialValue, androidx.compose.material3.internal.DraggableAnchors<T> anchors, Function1<? super Float, Float> positionalThreshold, Function0<Float> velocityThreshold, AnimationSpec<Float> animationSpec, Function1<? super T, Boolean> confirmValueChange) {
    ...
    public AnchoredDraggableState(Object object, androidx.compose.material3.internal.DraggableAnchors draggableAnchors2, Function1 function13, Function0 function04, AnimationSpec animationSpec5, Function1 function16, int i7, DefaultConstructorMarker defaultConstructorMarker8) {
        androidx.compose.material3.internal.AnchoredDraggableState.2 anon;
        androidx.compose.material3.internal.AnchoredDraggableState.2 obj13;
        if (i7 &= 32 != 0) {
            anon = obj13;
        } else {
            anon = function16;
    ...
    public AnchoredDraggableState(Object object, Function1 function12, Function0 function03, AnimationSpec animationSpec4, Function1 function15, int i6, DefaultConstructorMarker defaultConstructorMarker7) {
        androidx.compose.material3.internal.AnchoredDraggableState.1 anon;
        androidx.compose.material3.internal.AnchoredDraggableState.1 obj11;
        if (i6 &= 16 != 0) {
            anon = obj11;
        } else {
            anon = function15;
    ...
    public static final Object access$computeTarget(androidx.compose.material3.internal.AnchoredDraggableState $this, float offset, Object currentValue, float velocity) {
        return $this.computeTarget(offset, currentValue, velocity);
    }

    public static final Object access$computeTargetWithoutThresholds(androidx.compose.material3.internal.AnchoredDraggableState $this, float offset, Object currentValue) {
        return $this.computeTargetWithoutThresholds(offset, currentValue);
    }

    public static final androidx.compose.material3.internal.AnchoredDragScope access$getAnchoredDragScope$p(androidx.compose.material3.internal.AnchoredDraggableState $this) {
        return $this.anchoredDragScope;
    }

    public static final Object access$getDragTarget(androidx.compose.material3.internal.AnchoredDraggableState $this) {
        return $this.getDragTarget();
    }

    public static final void access$setCurrentValue(androidx.compose.material3.internal.AnchoredDraggableState $this, Object <set-?>) {
        $this.setCurrentValue(<set-?>);
    }

    public static final void access$setDragTarget(androidx.compose.material3.internal.AnchoredDraggableState $this, Object <set-?>) {
        $this.setDragTarget(<set-?>);
    }

    public static final void access$setLastVelocity(androidx.compose.material3.internal.AnchoredDraggableState $this, float <set-?>) {
        $this.setLastVelocity(<set-?>);
    }

    public static final void access$setOffset(androidx.compose.material3.internal.AnchoredDraggableState $this, float <set-?>) {
        $this.setOffset(<set-?>);
    }

    public static Object anchoredDrag$default(androidx.compose.material3.internal.AnchoredDraggableState anchoredDraggableState, MutatePriority mutatePriority2, Function3 function33, Continuation continuation4, int i5, Object object6) {
        MutatePriority obj1;
        if (i5 &= 1 != 0) {
    ...
    public static Object anchoredDrag$default(androidx.compose.material3.internal.AnchoredDraggableState anchoredDraggableState, Object object2, MutatePriority mutatePriority3, Function4 function44, Continuation continuation5, int i6, Object object7) {
        MutatePriority obj2;
        if (i6 &= 2 != 0) {
    ...
    private final T computeTarget(float offset, T currentValue, float velocity) {
        ...
        float f;
        int cmp;
        final androidx.compose.material3.internal.DraggableAnchors anchors = getAnchors();
    ...
    private final void setAnchors(androidx.compose.material3.internal.DraggableAnchors<T> <set-?>) {
        final int i = 0;
        final int i2 = 0;
    ...
    public static void updateAnchors$default(androidx.compose.material3.internal.AnchoredDraggableState anchoredDraggableState, androidx.compose.material3.internal.DraggableAnchors draggableAnchors2, Object object3, int i4, Object object5) {
        Object obj2;
        if (i4 &= 2 != 0) {
    ...
    public final Object anchoredDrag(MutatePriority mutatePriority, Function3<? super androidx.compose.material3.internal.AnchoredDragScope, ? super androidx.compose.material3.internal.DraggableAnchors<T>, ? super Continuation<? super Unit>, ? extends Object> function32, Continuation<? super Unit> continuation3) {
        boolean anon2;
        androidx.compose.material3.internal.DraggableAnchors closestAnchor;
        float booleanValue2;
        MutatePriority booleanValue;
        int positionOf;
        androidx.compose.material3.internal.DraggableAnchors positionOf2;
        androidx.compose.material3.internal.AnchoredDraggableState.anchoredDrag.2 anon;
        int i;
        Object obj8;
        Object obj10;
        anon2 = continuation3;
        booleanValue = Integer.MIN_VALUE;
        if (continuation3 instanceof AnchoredDraggableState.anchoredDrag.1 && label &= booleanValue != 0) {
            anon2 = continuation3;
            booleanValue = Integer.MIN_VALUE;
            if (label &= booleanValue != 0) {
                anon2.label = obj10 -= booleanValue;
            } else {
    ...
    public final Object anchoredDrag(T t, MutatePriority mutatePriority2, Function4<? super androidx.compose.material3.internal.AnchoredDragScope, ? super androidx.compose.material3.internal.DraggableAnchors<T>, ? super T, ? super Continuation<? super Unit>, ? extends Object> function43, Continuation<? super Unit> continuation4) {
        boolean anon2;
        float booleanValue;
        ...
        int label;
        Object anchorFor;
        androidx.compose.material3.internal.AnchoredDraggableState.anchoredDrag.4 anon;
        int i;
        Object obj9;
        Object obj10;
        float obj11;
    ...
    public final float dispatchRawDelta(float delta) {
        int offset;
        final float offsetForDelta$material3_release = newOffsetForDelta$material3_release(delta);
        if (Float.isNaN(getOffset())) {
            offset = 0;
        } else {
            offset = getOffset();
        }
        setOffset(offsetForDelta$material3_release);
        return offsetForDelta$material3_release - offset;
    }
