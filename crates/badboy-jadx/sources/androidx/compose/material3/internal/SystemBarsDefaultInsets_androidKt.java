...
public final class SystemBarsDefaultInsets_androidKt {
    public static final WindowInsets getSystemBarsForVisualComponents(WindowInsets.Companion $this$systemBarsForVisualComponents, Composer $composer, int $changed) {
        ...
        String str;
        int i = 2011811170;
        ComposerKt.sourceInformationMarkerStart($composer, i, "C23@925L10:SystemBarsDefaultInsets.android.kt#mqatfk");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material3.internal.<get-systemBarsForVisualComponents> (SystemBarsDefaultInsets.android.kt:23)");
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        return WindowInsets_androidKt.getSystemBars($this$systemBarsForVisualComponents, $composer, $changed & 14);
    }
}
