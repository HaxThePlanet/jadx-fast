...
public final class AnchoredDraggableKt {
    public static final <T> androidx.compose.material3.internal.DraggableAnchors<T> DraggableAnchors(Function1<? super androidx.compose.material3.internal.DraggableAnchorsConfig<T>, Unit> builder) {
        DraggableAnchorsConfig draggableAnchorsConfig = new DraggableAnchorsConfig();
        builder.invoke(draggableAnchorsConfig);
        MapDraggableAnchors mapDraggableAnchors = new MapDraggableAnchors(draggableAnchorsConfig.getAnchors$material3_release());
        return (DraggableAnchors)mapDraggableAnchors;
    }

    public static final androidx.compose.material3.internal.MapDraggableAnchors access$emptyDraggableAnchors() {
    ...
    public static final <T> Modifier anchoredDraggable(Modifier $this$anchoredDraggable, androidx.compose.material3.internal.AnchoredDraggableState<T> state, Orientation orientation, boolean enabled, boolean reverseDirection, MutableInteractionSource interactionSource) {
        AnchoredDraggableKt.anchoredDraggable.1 anon = new AnchoredDraggableKt.anchoredDraggable.1(state, 0);
        return DraggableKt.draggable$default($this$anchoredDraggable, state.getDraggableState$material3_release(), orientation, enabled, interactionSource, state.isAnimationRunning(), 0, (Function3)anon, reverseDirection, 32, 0);
    }

    public static Modifier anchoredDraggable$default(Modifier modifier, androidx.compose.material3.internal.AnchoredDraggableState anchoredDraggableState2, Orientation orientation3, boolean z4, boolean z5, MutableInteractionSource mutableInteractionSource6, int i7, Object object8) {
        int i2;
        int i3;
        int i;
        int obj9;
        ...
        i2 = i7 & 4 != 0 ? obj9 : z4;
        i3 = i7 & 8 != 0 ? obj10 : z5;
        i = i7 & 16 != 0 ? obj11 : mutableInteractionSource6;
        return AnchoredDraggableKt.anchoredDraggable(modifier, anchoredDraggableState2, orientation3, i2, i3, i);
    }

    public static final <T> Object animateTo(androidx.compose.material3.internal.AnchoredDraggableState<T> $this$animateTo, T targetValue, float velocity, Continuation<? super Unit> $completion) {
    ...
    public static Object animateTo$default(androidx.compose.material3.internal.AnchoredDraggableState anchoredDraggableState, Object object2, float f3, Continuation continuation4, int i5, Object object6) {
        float obj2;
        if (i5 &= 2 != 0) {
    ...
    public static final <T> Modifier draggableAnchors(Modifier $this$draggableAnchors, androidx.compose.material3.internal.AnchoredDraggableState<T> state, Orientation orientation, Function2<? super IntSize, ? super Constraints, ? extends Pair<? extends androidx.compose.material3.internal.DraggableAnchors<T>, ? extends T>> anchors) {
    ...
    private static final <T> androidx.compose.material3.internal.MapDraggableAnchors<T> emptyDraggableAnchors() {
    ...
    private static final <I> Object restartable(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function22, Continuation<? super Unit> continuation3) {
        ...
        if (continuation3 instanceof AnchoredDraggableKt.restartable.1 && label &= i3 != 0) {
            anon = continuation3;
            i3 = Integer.MIN_VALUE;
            if (label &= i3 != 0) {
                anon.label = obj6 -= i3;
    ...
    public static final <T> Object snapTo(androidx.compose.material3.internal.AnchoredDraggableState<T> $this$snapTo, T targetValue, Continuation<? super Unit> $completion) {
