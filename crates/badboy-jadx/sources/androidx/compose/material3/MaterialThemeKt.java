...
public final class MaterialThemeKt {
    ...
    public static final void MaterialExpressiveTheme(androidx.compose.material3.ColorScheme colorScheme, androidx.compose.material3.Shapes shapes, androidx.compose.material3.Typography typography, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i7) {
        ...
        if (obj11 != null) {
            traceInProgress = new MaterialThemeKt.MaterialExpressiveTheme.2(obj4, obj3, obj, content, i18, i7);
    ...
    public static final void MaterialTheme(androidx.compose.material3.ColorScheme colorScheme, androidx.compose.material3.Shapes shapes, androidx.compose.material3.Typography typography, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i7) {
        ...
        if (i11 & 6 == 0) {
            if (i7 & 1 == 0) {
                changed3 = restartGroup.changed(colorScheme) ? i10 : i26;
            } else {
        ...
        if (i11 & 48 == 0) {
            if (i7 & 2 == 0) {
                changed = restartGroup.changed(shapes) ? 32 : 16;
            } else {
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i11 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        if (i7 & 1 != 0) {
                            colorScheme3 = MaterialTheme.INSTANCE.getColorScheme(restartGroup, i6);
                            $dirty2 &= -15;
                        }
                        if (i7 & 2 != 0) {
                            rippleOrFallbackImplementation-9IZ8Weo = MaterialTheme.INSTANCE.getShapes(restartGroup, i6);
                            $dirty2 &= -113;
                        }
                        if (i7 & 4 != 0) {
                            shapes2 = $dirty4;
                ...
                anon = shapes2;
                int i23 = 0;
                skipping = new ProvidedValue[i6];
                skipping[i23] = ColorSchemeKt.getLocalColorScheme().provides(colorScheme3);
                i5 = 1;
                skipping[i5] = IndicationKt.getLocalIndication().provides(RippleKt.rippleOrFallbackImplementation-9IZ8Weo(false, 0, 0, i2, restartGroup, i23));
                ...
                CompositionLocalKt.CompositionLocalProvider(skipping, (Function2)ComposableLambdaKt.rememberComposableLambda(-1066563262, i5, anon2, restartGroup, 54), restartGroup, $stable |= 48);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                colorScheme2 = $dirty;
    ...
    public static final TextSelectionColors rememberTextSelectionColors(androidx.compose.material3.ColorScheme colorScheme, Composer $composer, int $changed) {
        ...
        if (!composer.changed(primary-0d7_KjU)) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                ...
                super(l2, i10, Color.copy-wmQWz5c$default(primary-0d7_KjU, obj6, i10, 0, i3, 0, 14), i3, 0);
                primary-0d7_KjU = l;
