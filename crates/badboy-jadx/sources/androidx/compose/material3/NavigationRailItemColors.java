...
public final class NavigationRailItemColors {
    ...
    public NavigationRailItemColors(long l, long l2, long l3, long l4, long l5, long l6, long l7, DefaultConstructorMarker defaultConstructorMarker8) {
        super(l, l2, l3, l4, l5, l6, l7, defaultConstructorMarker8, obj9, obj10, obj11, obj12, obj13, obj14);
    }

    public static androidx.compose.material3.NavigationRailItemColors copy-4JmcsL4$default(androidx.compose.material3.NavigationRailItemColors navigationRailItemColors, long l2, long l3, long l4, long l5, long l6, long l7, long l8, int i9, Object object10) {
        ...
        selectedIconColor = obj29 & 1 != 0 ? navigationRailItemColors.selectedIconColor : l2;
        selectedTextColor = obj29 & 2 != 0 ? navigationRailItemColors.selectedTextColor : l4;
        selectedIndicatorColor = obj29 & 4 != 0 ? navigationRailItemColors.selectedIndicatorColor : l6;
        unselectedIconColor = obj29 & 8 != 0 ? navigationRailItemColors.unselectedIconColor : l8;
        unselectedTextColor = obj29 & 16 != 0 ? navigationRailItemColors.unselectedTextColor : object10;
        disabledIconColor = obj29 & 32 != 0 ? navigationRailItemColors.disabledIconColor : obj25;
        disabledTextColor = obj29 & 64 != 0 ? navigationRailItemColors.disabledTextColor : obj27;
        return navigationRailItemColors.copy-4JmcsL4(selectedIconColor, l4, selectedTextColor, l6, selectedIndicatorColor, l8, unselectedIconColor);
    }
    ...
    public final androidx.compose.material3.NavigationRailItemColors copy-4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
        ...
        if ($i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$1 != 0) {
            ...
            int i26 = 0;
            l = $i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$1;
        }
        ...
        if ($i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$2 != 0) {
            ...
            int i25 = 0;
            l3 = $i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$2;
        }
        ...
        if ($i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$3 != 0) {
            ...
            int i24 = 0;
            l2 = $i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$3;
        }
        ...
        if ($i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$4 != 0) {
            i4 = $this$takeOrElse_u2dDxMtmZc$iv3;
        } else {
            int i23 = 0;
            i4 = $i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$4;
        }
        int $this$takeOrElse_u2dDxMtmZc$iv4 = obj37;
        int i11 = 0;
        int i31 = 0;
        $this$isSpecified$iv$iv2 = Long.compare(i18, i34) != 0 ? i : i35;
        ...
        int i12 = 0;
        int i32 = 0;
        $this$isSpecified$iv$iv = Long.compare(i19, i34) != 0 ? i : i35;
        ...
        if (i != 0) {
            i2 = $this$takeOrElse_u2dDxMtmZc$iv6;
        } else {
            int i20 = 0;
            i2 = $i$a$TakeOrElseDxMtmZcNavigationRailItemColors$copy$7;
        }
        NavigationRailItemColors navigationRailItemColors = new NavigationRailItemColors(l, obj14, l3, obj16, l2, obj18, i4, obj20, i5, obj22, i3, obj24, i2, obj26, 0);
    ...
    public boolean equals(Object other) {
        ...
        final int i2 = 0;
        if (other != null) {
            if (!other instanceof NavigationRailItemColors) {
            } else {
