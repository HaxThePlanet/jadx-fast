...
final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope $this$intrinsicHeight, List<? extends IntrinsicMeasurable> measurables, int width, Function2<? super IntrinsicMeasurable, ? super Integer, Integer> intrinsicMeasurer) {
        ...
        invoke = 0;
        index$iv$iv9 = 0;
        while (index$iv$iv9 < obj10.size()) {
            i2 = 0;
            i8 = 0;
            index$iv$iv9++;
        }
        obj3 = 0;
        if ((IntrinsicMeasurable)obj3 != 0) {
            int i21 = 0;
            remainingWidth = i27;
            $i$a$LetOutlinedTextFieldMeasurePolicy$intrinsicHeight$leadingHeight$2 = (Number)obj8.invoke(obj3, Integer.valueOf(width)).intValue();
        } else {
        ...
        int i31 = 0;
        index$iv$iv8 = 0;
        while (index$iv$iv8 < i28.size()) {
            obj6 = null;
            layoutId = null;
            index$iv$iv8++;
            equal3 = Integer.MAX_VALUE;
        }
        i2 = 0;
        if ((IntrinsicMeasurable)i2 != 0) {
            int i14 = 0;
            remainingWidth = i19;
            $i$a$LetOutlinedTextFieldMeasurePolicy$intrinsicHeight$labelHeight$2 = (Number)obj8.invoke(i2, Integer.valueOf(width)).intValue();
        } else {
        ...
        if ((IntrinsicMeasurable)obj3 != 0) {
            int i13 = 0;
            i3 = $i$a$LetOutlinedTextFieldMeasurePolicy$intrinsicHeight$labelHeight$2;
        } else {
            i7 = width;
            i3 = 0;
        }
        ...
        if ((IntrinsicMeasurable)obj3 != 0) {
            equal = 0;
            prefixHeight = (Number)obj8.invoke((IntrinsicMeasurable)obj3, Integer.valueOf(remainingWidth)).intValue();
            remainingWidth = obj5;
        } else {
            prefixHeight = 0;
        }
        ...
        if ((IntrinsicMeasurable)i2 != 0) {
            equal2 = 0;
            intValue = (Number)obj8.invoke((IntrinsicMeasurable)i2, Integer.valueOf(remainingWidth)).intValue();
            remainingWidth = i5;
        } else {
            intValue = 0;
        }
        ...
        int i33 = 0;
        index$iv$iv3 = 0;
        while (index$iv$iv3 < obj14.size()) {
            i2 = obj3;
            obj6 = null;
            layoutId = null;
            i = remainingWidth;
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId((IntrinsicMeasurable)i2), "TextField")) {
                break;
            } else {
            }
            index$iv$iv3++;
            obj = placeholderHeight;
            remainingWidth = i;
        }
    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, List<? extends Measurable> measurables, long constraints) {
        ...
        obj = 0;
        measure-BRTryo05 = obj;
        if ((Measurable)measure-BRTryo05 != 0) {
            relaxedConstraints2 = measure-BRTryo05;
        } else {
        ...
        int i69 = equal;
        index$iv$iv2 = 0;
        while (index$iv$iv2 < i69.size()) {
            obj3 = 0;
            $this$fastFirstOrNull$iv = 0;
            index$iv$iv2++;
            equal = $this$fastFirstOrNull$iv2;
            $i$f$fastFirstOrNull = i12;
        }
        $this$fastFirstOrNull$iv2 = equal;
        i12 = $i$f$fastFirstOrNull;
        obj2 = 0;
        if ((Measurable)obj2 != null) {
            relaxedConstraints = relaxedConstraints3;
            measure-BRTryo02 = (Measurable)obj2.measure-BRTryo0(ConstraintsKt.offset-NN6Ew-U$default(relaxedConstraints3, i26, -occupiedSpaceHorizontally2, 0, 2));
        } else {
            relaxedConstraints = relaxedConstraints3;
            measure-BRTryo02 = 0;
        }
        ...
        i4 = -roundToPx-0680j_44;
        i14 = 0;
        f3 = i81;
        int i96 = 0;
        i19 = measure-BRTryo02;
        equal2 = f3.size();
        final int i125 = i49;
        labelHorizontalPaddingOffset = i24;
        while (labelHorizontalPaddingOffset < equal2) {
            $this$fastFirstOrNull$iv = 0;
            i12 = 0;
            labelHorizontalPaddingOffset = i27 + 1;
            equal2 = i30;
        }
        i27 = labelHorizontalPaddingOffset;
        i10 = 0;
        int i42 = i10;
        if ((Measurable)i42 != 0) {
        ...
        equal4 = i87.size();
        int i99 = i50;
        $this$fastFirstOrNull$iv4 = i7;
        while ($this$fastFirstOrNull$iv4 < equal4) {
            $this$fastFirstOrNull$iv = 0;
            i12 = 0;
            $this$fastFirstOrNull$iv4 = i27 + 1;
            equal4 = i30;
        }
        i27 = $this$fastFirstOrNull$iv4;
        i10 = 0;
        int i43 = i10;
        if ((Measurable)i43 != 0) {
        ...
        long copy-Zbe2FdA$default3 = Constraints.copy-Zbe2FdA$default(ConstraintsKt.offset-NN6Ew-U(constraints, relaxedConstraints2, -occupiedSpaceHorizontally3), i7, 0, 0, 0, 0, 11);
        int i106 = 0;
        ...
        while (i28 < size) {
            ...
            i3 = 0;
            i27 = 0;
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId((Measurable)i20), "TextField")) {
                break;
            } else {
            }
            supportingMeasurable2 = i43;
