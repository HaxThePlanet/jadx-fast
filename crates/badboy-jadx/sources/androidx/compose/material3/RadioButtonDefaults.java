...
public final class RadioButtonDefaults {
    ...
    public final androidx.compose.material3.RadioButtonColors colors-ro_MJ88(long selectedColor, long unselectedColor, long disabledSelectedColor, long disabledUnselectedColor, Composer $composer, int $changed, int i7) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        return getDefaultRadioButtonColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer, 6)).copy-jRlVdoo(l3, obj6, l4, obj8);
    }
    ...
    public final androidx.compose.material3.RadioButtonColors getDefaultRadioButtonColors$material3_release(androidx.compose.material3.ColorScheme $this$defaultRadioButtonColors) {
        ...
        if (colorScheme.getDefaultRadioButtonColorsCached$material3_release() == null) {
            i5 = 0;
            i2 = 0;
            radioButtonColors = new RadioButtonColors(ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getSelectedIconColor()), obj4, ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getUnselectedIconColor()), obj6, Color.copy-wmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getDisabledSelectedIconColor()), obj8, 1052938076, i5, 0, i2, 14), obj8, Color.copy-wmQWz5c$default(ColorSchemeKt.fromToken(colorScheme, RadioButtonTokens.INSTANCE.getDisabledUnselectedIconColor()), i5, 1052938076, i2, 0, 0, 14), i5, 0);
            i4 = 0;
