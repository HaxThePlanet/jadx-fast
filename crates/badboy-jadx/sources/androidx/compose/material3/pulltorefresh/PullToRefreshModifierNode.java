...
public final class PullToRefreshModifierNode extends DelegatingNode implements CompositionLocalConsumerModifierNode, NestedScrollConnection {
    ...
    private final Object animateToHidden(Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof PullToRefreshModifierNode.animateToHidden.1 && label2 &= i2 != 0) {
            anon = continuation;
            i2 = Integer.MIN_VALUE;
            if (label2 &= i2 != 0) {
                anon.label = obj6 -= i2;
    ...
    private final Object animateToThreshold(Continuation<? super Unit> continuation) {
        ...
        anon = continuation;
        i = Integer.MIN_VALUE;
        if (continuation instanceof PullToRefreshModifierNode.animateToThreshold.1 && label2 &= i != 0) {
            anon = continuation;
            i = Integer.MIN_VALUE;
            if (label2 &= i != 0) {
                anon.label = obj6 -= i;
    ...
    public Object onPreFling-QWom1Mo(long l, Continuation<? super Velocity> continuation2) {
        ...
        if (obj9 instanceof PullToRefreshModifierNode.onPreFling.1 && label2 &= i4 != 0) {
            anon = obj9;
            i4 = Integer.MIN_VALUE;
            if (label2 &= i4 != 0) {
                anon.label = obj9 -= i4;
        ...
        return Velocity.box-impl(VelocityKt.Velocity(i, (Number)obj7.floatValue()));
    }
