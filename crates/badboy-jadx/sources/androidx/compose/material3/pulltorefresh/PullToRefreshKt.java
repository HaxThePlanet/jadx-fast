...
public final class PullToRefreshKt {
    ...
    private static final void CircularArrowProgressIndicator-RPmYEkk(Function0<Float> progress, long color, Composer $composer, int $changed) {
        ...
        Object obj;
        int i9;
        PathFillType.Companion companion;
        int i7;
        ...
        if (i16 & 48 == 0) {
            i2 = restartGroup.changed(l) ? 32 : 16;
            $dirty2 |= i2;
        }
        if ($dirty2 & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty2, -1, "androidx.compose.material3.pulltorefresh.CircularArrowProgressIndicator (PullToRefresh.kt:561)");
                }
        ...
        if (endRestartGroup != null) {
            $dirty2 = new PullToRefreshKt.CircularArrowProgressIndicator.3(obj2, l, obj4, i16);
    ...
    public static final void PullToRefreshBox(boolean isRefreshing, Function0<Unit> onRefresh, Modifier modifier, androidx.compose.material3.pulltorefresh.PullToRefreshState state, Alignment contentAlignment, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> indicator, Function3<? super BoxScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i10) {
        ...
        if (i10 & 1 != 0) {
            ...
            if (i & 6 == 0) {
                i14 = restartGroup.changed(valueOf2) ? 4 : 2;
                $dirty |= i14;
            }
        }
        if (i10 & 2 != 0) {
            ...
            if (i & 48 == 0) {
                i12 = restartGroup.changedInstance(onRefresh) ? 32 : 16;
                $dirty |= i12;
            } else {
                obj3 = onRefresh;
            }
        ...
        if (i13 != 0) {
            ...
            if (i & 24576 == 0) {
                i11 = restartGroup.changed(contentAlignment) ? 16384 : 8192;
                $dirty |= i11;
            } else {
                obj = contentAlignment;
            }
        ...
        if (i10 & 64 != 0) {
            ...
            if (i & i53 == 0) {
                i5 = restartGroup.changedInstance(obj6) ? 1048576 : 524288;
                $dirty |= i5;
            }
        }
        if (i52 &= $dirty == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                if (i & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (i48 != 0) {
                            PullToRefreshKt.PullToRefreshBox.1 anon = new PullToRefreshKt.PullToRefreshBox.1(str, valueOf2);
                            i2 = $dirty;
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, i2, -1, "androidx.compose.material3.pulltorefresh.PullToRefreshBox (PullToRefresh.kt:134)");
                }
                Object obj10 = modifier2;
                pullToRefresh-Z4HSEVQ$default = PullToRefreshKt.pullToRefresh-Z4HSEVQ$default(obj10, valueOf2, $dirty2, false, 0, obj3, 12, 0);
                i17 &= 112;
                valueOf = 0;
                ...
                obj9.invoke(iNSTANCE, $i$a$LayoutBoxKt$Box$1$iv, Integer.valueOf(i25 |= $dirty));
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new PullToRefreshKt.PullToRefreshBox.3(isRefreshing, onRefresh, obj2, obj7, obj5, obj8, obj6, i, i10);
    ...
    public static Modifier pullToRefreshIndicator-wUdLESc$default(Modifier modifier, androidx.compose.material3.pulltorefresh.PullToRefreshState pullToRefreshState2, boolean z3, float f4, Shape shape5, long l6, float f7, int i8, Object object9) {
        ...
        return PullToRefreshKt.pullToRefreshIndicator-wUdLESc(modifier, pullToRefreshState2, z3, f2, shape, l, obj6);
    }
