...
public final class BottomSheetDefaults {
    ...
    public final void DragHandle-lgZ2HuY(Modifier modifier, float width, float height, Shape shape, long color, Composer $composer, int $changed, int i8) {
        ...
        if (i12 != 0) {
            ...
            if (i26 & 6 == 0) {
                i9 = traceInProgress2.changed(modifier) ? 4 : 2;
                $dirty3 |= i9;
            } else {
                dockedDragHandleWidth-D9Ej5fM = modifier;
            }
        ...
        if (i11 != 0) {
            ...
            if (i26 & 48 == 0) {
                i5 = traceInProgress2.changed(width) ? 32 : 16;
                $dirty3 |= i5;
            } else {
                f = width;
            }
        ...
        if (str != null) {
            ...
            if (i26 & 384 == 0) {
                i10 = traceInProgress2.changed(height) ? 256 : 128;
                $dirty3 |= i10;
            } else {
                semantics$default = height;
            }
        ...
        if (i26 & 24576 == 0) {
            if (obj31 & 16 == 0) {
                changed = traceInProgress2.changed(color) ? 16384 : 8192;
            } else {
                l = color;
            }
            $dirty3 |= changed;
        ...
        if ($dirty3 & 9363 == 9362) {
            if (!traceInProgress2.getSkipping()) {
                ...
                int i34 = 1;
                BottomSheetDefaults.DragHandle.2 anon2 = new BottomSheetDefaults.DragHandle.2(f, $dirty2);
                i7 = -1039573072;
                SurfaceKt.Surface-T9BRK9s(SemanticsModifierKt.semantics$default(PaddingKt.padding-VpY3zN4$default(modifier3, 0, SheetDefaultsKt.access$getDragHandleVerticalPadding$p(), 1, 0), false, (Function1)anon, i34, 0), obj2, l, obj12, 0, i7, 0, 0, 0, (Function2)ComposableLambdaKt.rememberComposableLambda(i7, i34, anon2, traceInProgress2, 54), traceInProgress2);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            string-2EP1pXo = new BottomSheetDefaults.DragHandle.3(this, height2, modifier2, $dirty, obj, width2, str, i26, obj31);
