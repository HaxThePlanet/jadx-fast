...
public final class LabelKt {
    private static final void HandleInteractions(boolean enabled, androidx.compose.material3.TooltipState state, MutableInteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if ($changed & 48 == 0) {
            ...
            i6 = changedInstance2 ? changedInstance : 16;
            $dirty |= i6;
        }
        rememberedValue = 256;
        if ($changed & 384 == 0) {
            i4 = obj12.changed(interactionSource) ? rememberedValue : 128;
            $dirty |= i4;
        }
        if ($dirty & 147 == 146) {
            if (!obj12.getSkipping()) {
                ...
                if (enabled) {
                    ...
                    int i13 = 0;
                    i3 = $dirty & 896 == rememberedValue ? i : i13;
    ...
    public static final void Label(Function3<? super androidx.compose.material3.TooltipScope, ? super Composer, ? super Integer, Unit> label, Modifier modifier, MutableInteractionSource interactionSource, boolean isPersistent, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i8) {
        ...
        if (i8 & 1 != 0) {
            ...
            if (i26 & 6 == 0) {
                i11 = modifier3.changedInstance(obj6) ? 4 : 2;
                $dirty |= i11;
            }
        }
        int i19 = i8 & 2;
        if (i19 != 0) {
            ...
            if (i26 & 48 == 0) {
                i5 = modifier3.changed(modifier) ? 32 : 16;
                $dirty |= i5;
            } else {
                obj2 = modifier;
            }
        ...
        if (str != null) {
            ...
            if (i26 & 384 == 0) {
                i = modifier3.changed(interactionSource) ? 256 : 128;
                $dirty |= i;
            } else {
                obj = interactionSource;
            }
        ...
        if (rememberedValue2 != 0) {
            ...
            if (i26 & 3072 == 0) {
                i4 = modifier3.changed(isPersistent) ? 2048 : 1024;
                $dirty |= i4;
            } else {
                i3 = isPersistent;
            }
        ...
        if (i8 & 16 != 0) {
            ...
            if (i26 & 24576 == 0) {
                i6 = modifier3.changedInstance(obj8) ? 16384 : 8192;
                $dirty |= i6;
            }
        }
        if ($dirty & 9363 == 9362) {
            if (!modifier3.getSkipping()) {
                ...
                obj3 = str != null ? obj2 : obj;
                z = rememberedValue2 != 0 ? obj2 : i3;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(invalid$iv, $dirty, -1, "androidx.compose.material3.Label (Label.kt:70)");
                }
                ...
                if (obj3 == null) {
                    ...
                    if (rememberedValue2 == Composer.Companion.getEmpty()) {
                        ...
                        $i$a$CacheLabelKt$Label$interactionSource$1 = rememberedValue2;
                    }
                    ComposerKt.sourceInformationMarkerEnd(modifier3);
                } else {
                    $i$a$CacheLabelKt$Label$interactionSource$1 = obj3;
                }
                ...
                if (z) {
                    ...
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        $dirty4 = $dirty;
                        obj5 = modifier2;
                        $dirty2 = new LabelStateImpl(i12, i12, 3, i10);
                ...
                if (rememberedValue4 == Composer.Companion.getEmpty()) {
                    obj24 = i18;
                    composer3.updateRememberedValue(SnapshotStateKt.mutableStateOf$default(i9, i9, 2, i9));
                } else {
                ...
                i14 = modifier3;
                BasicTooltip_androidKt.BasicTooltipBox(TooltipDefaults.INSTANCE.rememberPlainTooltipPositionProvider-kHDZbjc(0, modifier3, 48, 1), (Function2)ComposableLambdaKt.rememberComposableLambda(784196780, i35, anon3, modifier3, i31), obj, obj5, false, false, (Function2)ComposableLambdaKt.rememberComposableLambda(1950723216, i35, anon2, modifier3, i31), i14, i23 |= i32, 0);
                LabelKt.HandleInteractions(z ^ 1, obj, $i$a$CacheLabelKt$Label$interactionSource$1, i14, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj4 = obj3;
        ...
        if (endRestartGroup != null) {
            invalid$iv = new LabelKt.Label.2(obj6, $dirty3, obj4, z2, obj8, i26, i8);
