...
public final class NavigationRailKt {
    ...
    public static final void NavigationRail-qi6gXK8(Modifier modifier, long containerColor, long contentColor, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> header, WindowInsets windowInsets, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i9) {
        ...
        if (i32 & 384 == 0) {
            if (obj35 & 4 == 0) {
                i = restartGroup.changed(header) ? 256 : 128;
            } else {
        ...
        if (i30 != 0) {
            ...
            if (i32 & 3072 == 0) {
                i6 = restartGroup.changedInstance(content) ? 2048 : 1024;
                $dirty |= i6;
            } else {
                header2 = content;
            }
        ...
        if (obj35 & 32 != 0) {
            ...
            if (i32 & i39 == 0) {
                i12 = restartGroup.changedInstance(obj6) ? 131072 : 65536;
                $dirty |= i12;
            }
        }
        if (i37 &= $dirty == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (i32 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (obj35 & 16 != 0) {
                            windowInsets3 = NavigationRailDefaults.INSTANCE.getWindowInsets(restartGroup, i38);
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, modifier3, -1, "androidx.compose.material3.NavigationRail (NavigationRail.kt:118)");
                }
                NavigationRailKt.NavigationRail.1 anon = new NavigationRailKt.NavigationRail.1(windowInsets3, $dirty3, obj6);
                SurfaceKt.Surface-T9BRK9s(contentColor2, 0, header2, obj, skipping, i7, 0, 0, 0, (Function2)ComposableLambdaKt.rememberComposableLambda(-2092683357, true, anon, restartGroup, 54), restartGroup);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            traceInProgress = new NavigationRailKt.NavigationRail.2($composer2, $dirty2, modifier3, windowInsets2, l2, obj4, obj2, obj6, i32, obj35);
    ...
    public static final void NavigationRailItem(boolean selected, Function0<Unit> onClick, Function2<? super Composer, ? super Integer, Unit> icon, Modifier modifier, boolean enabled, Function2<? super Composer, ? super Integer, Unit> label, boolean alwaysShowLabel, androidx.compose.material3.NavigationRailItemColors colors, MutableInteractionSource interactionSource, Composer $composer, int $changed, int i12) {
        ...
        androidx.compose.runtime.internal.ComposableLambda composableLambda;
        boolean z3;
        androidx.compose.material3.NavigationRailKt.NavigationRailItem.1.2.1 anon;
        int companion3;
        Composer composer3;
        Object companion;
        Object obj;
        ...
        if (i85 & 4 != 0) {
            ...
            if (i84 & 384 == 0) {
                i20 = restartGroup.changedInstance(icon) ? 256 : 128;
                $dirty |= i20;
            } else {
                obj3 = icon;
            }
        ...
        if (i13 != 0) {
            ...
            if (i90 &= i84 == 0) {
                i10 = restartGroup.changedInstance(label) ? 131072 : 65536;
                $dirty |= i10;
            } else {
                obj6 = label;
            }
        ...
        if ($dirty & companion2 == 38347922) {
            if (!restartGroup.getSkipping()) {
                ...
                if (interactionSource2 == 0) {
                    ...
                    obj53 = colors2;
                    i25 = rememberedValue;
                    $i$a$CacheNavigationRailKt$NavigationRailItem$interactionSource$1 = interactionSource2;
                }
                restartGroup.endReplaceGroup();
                obj54 = selected;
                obj52 = anon3;
                super(obj53, obj54, z2, obj6, z3, obj3);
                ...
                if (obj6 == null) {
                    ...
                    i9 = obj6;
                    i31 = 0;
                    anon2 = new NavigationRailKt.NavigationRailItem.styledLabel.1.1(navigationRailItemColors, obj54, z2, obj6);
                ...
                i27 = selected ? $this$NavigationRailItem_u24lambda_u245 : 0;
                Composer composer9 = composer6;
                i8 = i68;
                int $composer2 = 0;
                androidx.compose.runtime.State animateFloatAsState = AnimateAsStateKt.animateFloatAsState(i27, (AnimationSpec)AnimationSpecKt.tween$default(150, 0, $composer2, i25, $composer2), 0, 0, 0, composer9, 48, 28);
                $dirty = composer9;
                int i103 = 0;
                int i99 = 0;
                int i105 = i69;
                ...
                changed2 = $dirty.changed(animateFloatAsState);
        ...
        if (endRestartGroup != null) {
            traceInProgress = new NavigationRailKt.NavigationRailItem.2(selected, onClick, icon, obj4, z, obj7, z4, navigationRailItemColors, enabled2, i84, i85);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    private static final void NavigationRailItemLayout(Function2<? super Composer, ? super Integer, Unit> indicatorRipple, Function2<? super Composer, ? super Integer, Unit> indicator, Function2<? super Composer, ? super Integer, Unit> icon, Function2<? super Composer, ? super Integer, Unit> label, boolean alwaysShowLabel, Function0<Float> animationProgress, Composer $composer, int $changed) {
        ...
        if (materialized$iv$iv2 & 6 == 0) {
            i29 = restartGroup.changedInstance($changed$iv3) ? 4 : 2;
            $dirty |= i29;
        }
        ...
        if (materialized$iv$iv2 & 384 == 0) {
            i30 = restartGroup.changedInstance(empty) ? 256 : 128;
            $dirty |= i30;
        }
        $changed$iv = 2048;
        if (materialized$iv$iv2 & 3072 == 0) {
            i23 = restartGroup.changedInstance(obj2) ? $changed$iv : 1024;
            $dirty |= i23;
        }
        i25 = 16384;
        if (materialized$iv$iv2 & 24576 == 0) {
            i14 = restartGroup.changed(valueOf3) ? i25 : 8192;
            $dirty |= i14;
        }
        empty2 = 131072;
        if (i68 &= materialized$iv$iv2 == 0) {
            i20 = restartGroup.changedInstance(obj3) ? empty2 : 65536;
            $dirty |= i20;
        }
        if (i69 &= $dirty == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                maybeCachedBoxMeasurePolicy = "CC(remember):NavigationRail.kt#9igjgp";
                ComposerKt.sourceInformationMarkerStart(restartGroup, -1881815062, maybeCachedBoxMeasurePolicy);
                int i34 = 458752;
                int i35 = 0;
                i32 = $dirty & i34 == empty2 ? 1 : i35;
                i13 = $dirty & 7168 == $changed$iv ? 1 : i35;
                int i83 = 57344;
                i18 = $dirty & i83 == i25 ? 1 : i35;
                ...
                $changed$iv3.invoke(restartGroup, Integer.valueOf(i31 & 14));
                ...
                i8 = i64;
                maybeCachedBoxMeasurePolicy2 = BoxKt.maybeCachedBoxMeasurePolicy(topStart, materialized$iv);
                $changed$iv2 = 0;
                obj = topStart;
                ComposerKt.sourceInformationMarkerStart(restartGroup, -1323940314, currentCompositionLocalMap2);
                ...
                if (obj2 != null) {
                    ComposerKt.sourceInformationMarkerStart(restartGroup, 2145404101, maybeCachedBoxMeasurePolicy);
                    i3 = i31 & companion == 16384 ? 1 : 0;
                    i27 = i31 & obj62 == 131072 ? 1 : 0;
