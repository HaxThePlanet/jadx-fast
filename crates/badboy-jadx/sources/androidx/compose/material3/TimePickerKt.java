...
public final class TimePickerKt {
    ...
    private static final void CircularLayout-uFdPcIQ(Modifier modifier, float radius, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i6) {
        ...
        if (i21 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                int i17 = 0;
                i2 = i21 & 112 == currentCompositionLocalMap ? 1 : i17;
    ...
    public static final void ClockFace(androidx.compose.material3.AnalogTimePickerState state, androidx.compose.material3.TimePickerColors colors, boolean autoSwitchToMinute, Composer $composer, int $changed) {
        ...
        if ($changed & 384 == 0) {
            i4 = restartGroup.changed(autoSwitchToMinute) ? 256 : 128;
            obj12 |= i4;
        }
        if (obj12 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
    ...
    private static final void ClockText(Modifier modifier, androidx.compose.material3.AnalogTimePickerState state, int value, boolean autoSwitchToMinute, Composer $composer, int $changed) {
        ...
        i3 = 2;
        if (changed & 6 == 0) {
            i22 = restartGroup.changed(modifier) ? 4 : i3;
            $dirty2 |= i22;
        } else {
            obj = modifier;
        }
        if (changed & 48 == 0) {
            i13 = restartGroup.changedInstance(it$iv4) ? 32 : 16;
            $dirty2 |= i13;
        }
        if (changed & 384 == 0) {
            i20 = restartGroup.changed(i31) ? 256 : 128;
            $dirty2 |= i20;
        }
        if (changed & 3072 == 0) {
            i26 = restartGroup.changed(autoSwitchToMinute) ? 2048 : 1024;
            $dirty2 |= i26;
        } else {
            z2 = autoSwitchToMinute;
        }
        final int i80 = $dirty2;
        if (i80 & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, i80, -1, "androidx.compose.material3.ClockText (TimePicker.kt:1638)");
                }
                int i81 = 6;
                int i37 = 0;
                int i47 = 0;
                ...
                if (rememberedValue3 == Composer.Companion.getEmpty()) {
                    empty2 = 0;
                    invalid$iv2 = i39;
                    composer5.updateRememberedValue(SnapshotStateKt.mutableStateOf$default(Offset.box-impl(Offset.Companion.getZero-F1C5BW0()), i78, i3, i78));
                } else {
                    invalid$iv2 = i39;
                ...
                String str12 = str2;
                String localString$default3 = CalendarLocale_jvmKt.toLocalString$default(i31, 0, 0, false, 7, 0);
                if (TimePickerSelectionMode.equals-impl0(it$iv4.getSelection-yecRtBI(), TimePickerSelectionMode.Companion.getMinute-yecRtBI())) {
                    selected = Intrinsics.areEqual(CalendarLocale_jvmKt.toLocalString$default(it$iv4.getMinute(), 0, 0, false, 7, 0), localString$default3);
                } else {
                    selected = Intrinsics.areEqual(CalendarLocale_jvmKt.toLocalString$default(it$iv4.getHour(), 0, 0, false, 7, 0), localString$default3);
                }
                ...
                if (it$iv == Composer.Companion.getEmpty()) {
                    empty3 = 0;
                    it$iv3 = it$iv;
                    it$iv = new TimePickerKt.ClockText.1.1((MutableState)obj6, (MutableState)invalid$iv);
                    composer8.updateRememberedValue((Function1)it$iv);
                } else {
                    it$iv3 = it$iv;
                }
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                int i73 = 0;
                Modifier focusable$default = FocusableKt.focusable$default(OnGloballyPositionedModifierKt.onGloballyPositioned(SizeKt.size-3ABfNKs(InteractiveComponentSizeKt.minimumInteractiveComponentSize(obj), TimePickerKt.MinimumInteractiveSize), (Function1)it$iv), false, i73, 3, i73);
                ComposerKt.sourceInformationMarkerStart(restartGroup, 297264943, str12);
                i14 = i80 & 7168 == 2048 ? 1 : 0;
                ...
                if (i59 | changed6 == 0) {
                    if (rememberedValue2 == Composer.Companion.getEmpty()) {
                        ...
                        text = 1;
                        maxDist = new TimePickerKt.ClockText.2.1(selected, coroutineScope4, it$iv4, $this$ClockText_u24lambda_u2427, z2, invalid$iv, obj6);
                ...
                Modifier materializeModifier = ComposedModifierKt.materializeModifier(restartGroup, SemanticsModifierKt.semantics(modifier2, text, (Function1)maxDist));
                i36 = currentCompositeKeyHash;
                ...
                if (!inserting) {
                    ...
                    f = valueOf;
                    if (!Intrinsics.areEqual(composer11.rememberedValue(), Integer.valueOf(i36))) {
                        composer11.updateRememberedValue(Integer.valueOf(i36));
                        constructor-impl.apply(Integer.valueOf(i36), ComposeUiNode.Companion.getSetCompositeKeyHash());
                    } else {
                ...
                int i87 = 0;
                it$iv4 = composer10.rememberedValue();
                int i89 = 0;
                if (!composer4.changed($dirty)) {
                    $i$a$LayoutBoxKt$Box$1$iv = empty;
                    if (it$iv4 == Composer.Companion.getEmpty()) {
                        int $i$a$LayoutBoxKt$Box$1$iv2 = 0;
                        obj3 = it$iv4;
                        it$iv4 = new TimePickerKt.ClockText.3.1.1($dirty);
                        composer10.updateRememberedValue((Function1)it$iv4);
                    } else {
                        obj3 = it$iv4;
                        i31 = composer10;
                    }
                ...
                TextKt.Text--4IGK_g(str, SemanticsModifierKt.clearAndSetSemantics((Modifier)Modifier.Companion, (Function1)it$iv4), 0, str, 0, inserting, 0, 0, 0, 0, i6, 0, false, 0, obj30, 0, 0, 0, 0, 0, TypographyKt.getValue(TimePickerTokens.INSTANCE.getClockDialLabelTextFont(), restartGroup, i81));
                ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    private static final void DisplaySeparator(Modifier modifier, Composer $composer, int $changed) {
        ...
        androidx.compose.ui.text.font.FontWeight contentAlignment$iv3;
        int $composer2;
        int i8;
        int i11;
        ...
        propagateMinConstraints$iv3 = 2;
        if (i17 & 6 == 0) {
            i3 = restartGroup.changed(obj) ? 4 : propagateMinConstraints$iv3;
            $dirty |= i3;
        }
        if ($dirty & 3 == propagateMinConstraints$iv3) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.material3.DisplaySeparator (TimePicker.kt:1324)");
                }
                int i20 = 6;
                int i21 = 0;
                ComposerKt.sourceInformationMarkerStart(restartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                ...
                TextKt.Text--4IGK_g(":", 0, ColorSchemeKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSeparatorColor(), composer5, i9), currentCompositionLocalMap, 0, constructor, 0, 0, 0, 0, 0, 0, false, 0, alignment2, 0, 0, 0, 0, 0, TextStyle.copy-p1EtxEg$default((TextStyle)restartGroup.consume((CompositionLocal)TextKt.getLocalTextStyle()), 0, obj10, 0, obj12, 0, 0, 0, 0, 0, 0, obj19, 0, 0, 0, 0, obj24, 0, 0, 0, TextAlign.Companion.getCenter-e0LSkKk(), 0, 0, obj31, 0, 0, lineHeightStyle));
    ...
    private static final void HorizontalClockDisplay(androidx.compose.material3.TimePickerState state, androidx.compose.material3.TimePickerColors colors, Composer $composer, int $changed) {
        ...
        if (i23 & 48 == 0) {
            i20 = restartGroup.changed(obj2) ? 32 : 16;
            $dirty |= i20;
        }
        if ($dirty & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                ...
                i4 = i41;
                $i$a$LayoutColumnKt$Column$1$iv = i19;
    ...
    private static final void HorizontalPeriodToggle(Modifier modifier, androidx.compose.material3.TimePickerState state, androidx.compose.material3.TimePickerColors colors, Composer $composer, int $changed) {
        ...
        if ($changed & 384 == 0) {
            i = restartGroup.changed(colors) ? 256 : 128;
            obj12 |= i;
        }
        if (obj12 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
        ...
        if (obj9 != null) {
            obj10 = new TimePickerKt.HorizontalPeriodToggle.1(obj2, obj, obj3, $changed);
    ...
    public static final void HorizontalTimePicker(androidx.compose.material3.AnalogTimePickerState state, Modifier modifier, androidx.compose.material3.TimePickerColors colors, boolean autoSwitchToMinute, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 1 != 0) {
            ...
            if (valueOf2 & 6 == 0) {
                i = restartGroup.changedInstance(obj5) ? 4 : 2;
                $dirty2 |= i;
            }
        }
        int i29 = i7 & 2;
        ...
        if (i7 & 8 != 0) {
            ...
            if (valueOf2 & 3072 == 0) {
                i6 = restartGroup.changed(z2) ? 2048 : 1024;
                $dirty2 |= i6;
            }
        }
        if ($dirty2 & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                ...
                TimePickerKt.HorizontalClockDisplay((TimePickerState)obj5, obj3, composer3, i22 |= i5);
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new TimePickerKt.HorizontalTimePicker.2(obj5, $dirty, obj2, z2, $changed, i7);
    ...
    private static final void PeriodToggleImpl(Modifier modifier, androidx.compose.material3.TimePickerState state, androidx.compose.material3.TimePickerColors colors, MeasurePolicy measurePolicy, Shape startShape, Shape endShape, Composer $composer, int $changed) {
        ...
        if (i47 & 6 == 0) {
            i10 = restartGroup.changed(obj3) ? 4 : 2;
            $dirty2 |= i10;
        }
        if (i47 & 48 == 0) {
            if (i47 & 64 == 0) {
        ...
        if (i47 & 384 == 0) {
            i16 = restartGroup.changed(colors) ? 256 : 128;
            $dirty2 |= i16;
        } else {
            obj2 = colors;
        }
        if (i47 & 3072 == 0) {
            i8 = restartGroup.changed(valueOf) ? 2048 : 1024;
            $dirty2 |= i8;
        }
        if (i47 & 24576 == 0) {
            i17 = restartGroup.changed(startShape) ? 16384 : 8192;
            $dirty2 |= i17;
        } else {
            obj = startShape;
        }
        if (i36 &= i47 == 0) {
            i4 = restartGroup.changed(endShape) ? 131072 : 65536;
            $dirty2 |= i4;
        } else {
            obj4 = endShape;
        }
        if (i48 &= $dirty2 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                androidx.compose.foundation.BorderStroke borderStroke2 = BorderStrokeKt.BorderStroke-cXLIe8U(TimePickerTokens.INSTANCE.getPeriodSelectorOutlineWidth-D9Ej5fM(), obj2.getPeriodSelectorBorderColor-0d7_KjU());
                int i54 = 6;
                ...
                Modifier materializeModifier = ComposedModifierKt.materializeModifier(restartGroup, BorderKt.border(SelectableGroupKt.selectableGroup(SemanticsModifierKt.semantics$default(obj3, false, (Function1)anon, i38, 0)), borderStroke2, (Shape)(CornerBasedShape)value));
                ...
                TimePickerKt.ToggleItem(afternoon2 ^= 1, obj, (Function0)it$iv, obj2, ComposableSingletons.TimePickerKt.INSTANCE.getLambda-1$material3_release(), factory$iv$iv, i25 |= i45);
                int i56 = i5;
                int i49 = 0;
                ...
                ComposerKt.sourceInformationMarkerEnd(factory$iv$iv);
                TimePickerKt.ToggleItem(obj5.isAfternoon(), obj4, (Function0)contentDescription, colors, ComposableSingletons.TimePickerKt.INSTANCE.getLambda-2$material3_release(), factory$iv$iv, i31 | obj3);
                ComposerKt.sourceInformationMarkerEnd(factory$iv$iv);
                restartGroup.endNode();
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
    ...
    public static final void TimeInput(androidx.compose.material3.TimePickerState state, Modifier modifier, androidx.compose.material3.TimePickerColors colors, Composer $composer, int $changed, int i6) {
        ...
        if (companion != 0) {
            ...
            if ($changed & 48 == 0) {
                i = obj11.changed(modifier) ? 32 : 16;
                $dirty |= i;
            }
        }
        if ($changed & 384 == 0) {
        ...
        if ($dirty & 147 == 146) {
            if (!obj11.getSkipping()) {
                ...
                obj11.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.material3.TimeInput (TimePicker.kt:260)");
                }
    ...
    private static final void TimeInputImpl(Modifier modifier, androidx.compose.material3.TimePickerColors colors, androidx.compose.material3.TimePickerState state, Composer $composer, int $changed) {
        ...
        if (i86 & 6 == 0) {
            i = restartGroup.changed(obj) ? 4 : 2;
            $dirty |= i;
        }
        if (i86 & 48 == 0) {
            i24 = restartGroup.changed(obj2) ? 32 : 16;
            $dirty |= i24;
        }
        ...
        if (i86 & 384 == 0) {
            ...
            i3 = changedInstance3 ? materializeModifier : 128;
            $dirty |= i3;
        }
        if ($dirty & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                if (!obj3.is24hour()) {
                    ...
                    i31 = currentCompositeKeyHash2;
                    modifier3 = padding-qDBjuR0$default2;
                    int i105 = 6;
                    Function0 function04 = constructor;
                    i29 = 0;
                    ...
                    if (!composer11.getInserting()) {
                        ...
                        $composer2 = valueOf2;
                        if (!Intrinsics.areEqual(composer11.rememberedValue(), Integer.valueOf(i31))) {
                            composer11.updateRememberedValue(Integer.valueOf(i31));
                            constructor-impl2.apply(Integer.valueOf(i31), ComposeUiNode.Companion.getSetCompositeKeyHash());
                        } else {
    ...
    public static final void TimePicker-mT9BvqQ(androidx.compose.material3.TimePickerState state, Modifier modifier, androidx.compose.material3.TimePickerColors colors, int layoutType, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 1 != 0) {
            ...
            if (i17 & 6 == 0) {
                ...
                i9 = changedInstance != null ? changed3 : 2;
                $dirty3 |= i9;
            }
        }
        int i13 = i7 & 2;
        ...
        if (i17 & 3072 == 0) {
            if (i7 & 8 == 0) {
                changed = restartGroup.changed(layoutType) ? 2048 : 1024;
            } else {
                i2 = layoutType;
            }
            $dirty3 |= changed;
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i17 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (i7 & 8 != 0) {
                            modifier2 = $dirty5;
                            $dirty2 = layoutType-sDNSZnc;
                            layoutType2 = obj4;
                            i2 = $i$f$cache;
                        } else {
                            layoutType2 = modifier3;
                            modifier2 = $dirty3;
                            $dirty2 = i2;
                            i2 = $i$f$cache;
                        }
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, modifier2, -1, "androidx.compose.material3.TimePicker (TimePicker.kt:220)");
                }
                i4 = 0;
                rememberAccessibilityServiceState = AccessibilityServiceStateProvider_androidKt.rememberAccessibilityServiceState(i4, i4, restartGroup, i4, 3);
                ComposerKt.sourceInformationMarkerStart(restartGroup, -2089091954, "CC(remember):TimePicker.kt#9igjgp");
                int i29 = 1;
                if (modifier2 & 14 != changed3) {
                    if (modifier2 & 8 != 0 && restartGroup.changed(obj2)) {
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                if (TimePickerLayoutType.equals-impl0($dirty2, TimePickerLayoutType.Companion.getVertical-QJTpgSE())) {
                    restartGroup.startReplaceGroup(-337235422);
                    ComposerKt.sourceInformation(restartGroup, "224@11728L178");
                    TimePickerKt.VerticalTimePicker((AnalogTimePickerState)$i$f$cache, layoutType2, i2, i29 ^= z2, restartGroup, i10 | i8, 0);
                    restartGroup.endReplaceGroup();
                } else {
                    restartGroup.startReplaceGroup(-337036960);
                    ComposerKt.sourceInformation(restartGroup, "231@11928L180");
                    TimePickerKt.HorizontalTimePicker($i$f$cache, layoutType2, i2, i29 ^= z, restartGroup, i10 | i8, 0);
                    restartGroup.endReplaceGroup();
                }
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new TimePickerKt.TimePicker.1(obj2, $dirty, $dirty4, i6, i17, i7);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    private static final void TimePickerTextField-1vLObsk(Modifier modifier, TextFieldValue value, Function1<? super TextFieldValue, Unit> onValueChange, androidx.compose.material3.TimePickerState state, int selection, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, androidx.compose.material3.TimePickerColors colors, Composer $composer, int $changed, int i11) {
        ...
        if (rememberedValue & 1 != 0) {
            ...
            if (invalid$iv3 & 6 == 0) {
                i53 = restartGroup.changed(traceInProgress) ? i275 : i276;
                $dirty3 |= i53;
            }
        }
        if (rememberedValue & 2 != 0) {
            ...
            if (invalid$iv3 & 48 == 0) {
                i22 = restartGroup.changed(box-impl) ? 32 : 16;
                $dirty3 |= i22;
            }
        }
        if (rememberedValue & 4 != 0) {
            ...
            if (invalid$iv3 & 384 == 0) {
                i46 = restartGroup.changedInstance(onValueChange) ? 256 : 128;
                $dirty3 |= i46;
            } else {
                measurePolicy$iv = onValueChange;
            }
        ...
        if (rememberedValue & 8 != 0) {
            ...
            if (invalid$iv3 & 3072 == 0) {
                ...
                i27 = changedInstance2 ? 2048 : 1024;
                $dirty3 |= i27;
            }
        }
        if (rememberedValue & 16 != 0) {
            ...
            if (invalid$iv3 & 24576 == 0) {
                i71 = restartGroup.changed(i62) ? 16384 : 8192;
                $dirty3 |= i71;
            }
        }
        ...
        if (str2 != null) {
            ...
            if (i170 &= invalid$iv3 == 0) {
                i67 = restartGroup.changed(keyboardOptions) ? 131072 : 65536;
                $dirty3 |= i67;
            } else {
                empty = keyboardOptions;
            }
        ...
        if (i168 &= $dirty3 == 4793490) {
            if (!restartGroup.getSkipping()) {
                ...
                boolean equals-impl04 = TimePickerSelectionMode.equals-impl0(i62, obj7.getSelection-yecRtBI());
                i54 = i176;
                i25 = 0;
                ...
                if (!equals-impl04) {
                    if (TimePickerSelectionMode.equals-impl0(i62, TimePickerSelectionMode.Companion.getHour-yecRtBI())) {
                        i37 = hourForDisplay;
                    } else {
                        i37 = hourForDisplay;
                    }
                    ...
                    TimePickerKt.TimeSelector-SAnMeKU(SizeKt.size-VpY3zN4((Modifier)Modifier.Companion, TimeInputTokens.INSTANCE.getTimeFieldContainerWidth-D9Ej5fM(), TimeInputTokens.INSTANCE.getTimeFieldContainerHeight-D9Ej5fM()), i37, state, i62, obj8, $dirty6, i94 |= i6);
                    $composer$iv2 = i62;
                    composer7 = $dirty6;
                } else {
                ...
                String string-2EP1pXo2 = Strings_androidKt.getString-2EP1pXo(this_$iv2, composer7, materialized$iv$iv);
                ...
                Modifier materializeModifier2 = ComposedModifierKt.materializeModifier(composer7, visible);
                i35 = i140;
                ...
                BasicTextFieldKt.BasicTextField(value, onValueChange, SemanticsModifierKt.semantics$default(SizeKt.size-VpY3zN4(FocusRequesterModifierKt.focusRequester((Modifier)Modifier.Companion, $composer3), TimeInputTokens.INSTANCE.getTimeFieldContainerWidth-D9Ej5fM(), TimeInputTokens.INSTANCE.getTimeFieldContainerHeight-D9Ej5fM()), false, (Function1)it$iv, contentDescription3, 0), true, false, (TextStyle)composer11.consume((CompositionLocal)TextKt.getLocalTextStyle()), obj5, measurePolicy$iv, true, 0, 0, 0, 0, $i$a$CacheTimePickerKt$TimePickerTextField$interactionSource$1, Brush.Companion.verticalGradient-8A-3gB4$default(Brush.Companion, objArr, 0, 0, 0, 14, 0), (Function3)ComposableLambdaKt.rememberComposableLambda(825138052, i96, anon2, composer11, 54), propagateMinConstraints$iv, i136 |= i162, 199680, 7696);
                ...
                int i180 = 0;
                int i114 = 6;
                TextKt.Text--4IGK_g(Strings_androidKt.getString-2EP1pXo(this_$iv, composer10, i180), SemanticsModifierKt.clearAndSetSemantics(OffsetKt.offset-VpY3zN4$default((Modifier)Modifier.Companion, 0, TimePickerKt.SupportLabelTop, i5, $dirty5), (Function1)TimePickerKt.TimePickerTextField.1.2.INSTANCE), ColorSchemeKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextColor(), composer10, i114), 0, 0, i35, 0, 0, 0, 0, 0, 0, false, 0, maybeCachedBoxMeasurePolicy, 0, 0, 0, 0, 0, TypographyKt.getValue(TimeInputTokens.INSTANCE.getTimeFieldSupportingTextFont(), composer10, i114));
                ComposerKt.sourceInformationMarkerEnd(composer6);
                ...
                ComposerKt.sourceInformationMarkerEnd(composer2);
                composer5 = composer2;
                ComposerKt.sourceInformationMarkerStart(composer5, 883095798, str15);
                $dirty = obj117;
                if ($dirty & 7168 != 2048) {
                    if ($dirty & 4096 != 0) {
                        if (composer5.changedInstance(state)) {
                            empty = i5;
                        } else {
                            empty = i180;
                        }
                ...
                if (i84 == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        empty = 0;
                        obj117 = i84;
                        anon = new TimePickerKt.TimePickerTextField.2.1($composer2, i62, obj3, $dirty5);
                ...
                ComposerKt.sourceInformationMarkerEnd(composer5);
                EffectsKt.LaunchedEffect(TimePickerSelectionMode.box-impl(state.getSelection-yecRtBI()), (Function2)anon, composer5, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
        ...
        if (endRestartGroup != null) {
            $dirty2 = $dirty;
            invalid$iv3 = new TimePickerKt.TimePickerTextField.3(modifier, value, onValueChange, $composer2, i62, contentDescription2, obj6, colors, $changed, i11);
            endRestartGroup.updateScope((Function2)invalid$iv3);
        } else {
            $dirty2 = $dirty;
            obj2 = contentDescription2;
        }
    }
    ...
    private static final void TimeSelector-SAnMeKU(Modifier modifier, int value, androidx.compose.material3.TimePickerState state, int selection, androidx.compose.material3.TimePickerColors colors, Composer $composer, int $changed) {
        ...
        i7 = -1148055889;
        $composer2 = $composer.startRestartGroup(i7);
        ...
        if (i31 & 6 == 0) {
            i13 = $composer2.changed(empty2) ? 4 : 2;
            $dirty3 |= i13;
        }
        if (i31 & 48 == 0) {
            i8 = $composer2.changed(value) ? 32 : 16;
            $dirty3 |= i8;
        } else {
        ...
        if (i31 & 384 == 0) {
            ...
            i = changedInstance2 ? 256 : 128;
            $dirty3 |= i;
        }
        if (i31 & 3072 == 0) {
            i12 = $composer2.changed(i4) ? 2048 : 1024;
            $dirty3 |= i12;
        }
        if (i31 & 24576 == 0) {
            i2 = $composer2.changed(traceInProgress) ? 16384 : 8192;
            $dirty3 |= i2;
        }
        $dirty2 = $dirty3;
        if ($dirty2 & 9363 == 9362) {
            if (!$composer2.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(i7, $dirty2, -1, "androidx.compose.material3.TimeSelector (TimePicker.kt:1348)");
                }
                boolean equals-impl02 = TimePickerSelectionMode.equals-impl0(obj.getSelection-yecRtBI(), i4);
                if (TimePickerSelectionMode.equals-impl0(i4, TimePickerSelectionMode.Companion.getHour-yecRtBI())) {
                ...
                i11 = $dirty2 & 7168 == 2048 ? i32 : 0;
                if ($dirty2 & 896 != 256) {
                    if ($dirty2 & 512 != 0 && $composer2.changedInstance(obj)) {
                ...
                if (i11 |= i9 == 0) {
                    if (it$iv == Composer.Companion.getEmpty()) {
                        empty2 = 0;
                        obj2 = it$iv;
                        it$iv = new TimePickerKt.TimeSelector.2.1(i4, obj);
    ...
    private static final void ToggleItem(boolean checked, Shape shape, Function0<Unit> onClick, androidx.compose.material3.TimePickerColors colors, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        i = 4;
        if (i14 & 6 == 0) {
            i6 = restartGroup.changed(z) ? i : 2;
            $dirty2 |= i6;
        }
        if (i14 & 48 == 0) {
            i2 = restartGroup.changed(shape) ? 32 : 16;
            $dirty2 |= i2;
        } else {
            obj = shape;
        }
        if (i14 & 384 == 0) {
            i3 = restartGroup.changedInstance(onClick) ? 256 : 128;
            $dirty2 |= i3;
        } else {
            obj2 = onClick;
        }
        if (i14 & 3072 == 0) {
            i12 = restartGroup.changed(obj5) ? 2048 : 1024;
            $dirty2 |= i12;
        }
        if (i14 & 24576 == 0) {
            i8 = restartGroup.changedInstance(content) ? 16384 : 8192;
            $dirty2 |= i8;
        } else {
            obj3 = content;
        }
        if ($dirty2 & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty2, -1, "androidx.compose.material3.ToggleItem (TimePicker.kt:1304)");
                }
                ...
                composer2 = composer4;
                ButtonKt.TextButton(onClick, SemanticsModifierKt.semantics$default(SizeKt.fillMaxSize$default(ZIndexModifierKt.zIndex((Modifier)Modifier.Companion, i7), i29, i35, 0), false, (Function1)anon, 1, 0), false, obj, ButtonDefaults.INSTANCE.textButtonColors-ro_MJ88(periodSelectorContainerColor-vNxB06k$material3_release, obj3, periodSelectorContentColor-vNxB06k$material3_release, str, 0, f, 0), 0, 0, PaddingKt.PaddingValues-0680j_4(Dp.constructor-impl(f)), 0, content, composer2, i20 | i26, 356);
                composer = composer2;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
        ...
        if (endRestartGroup != null) {
            $dirty = $dirty2;
            traceInProgress2 = new TimePickerKt.ToggleItem.2(z, shape, onClick, obj5, content, i14);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        } else {
            $dirty = $dirty2;
        }
        ...
        if ($dirty & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                ...
                if (!obj.is24hour()) {
                    ...
                    i5 = 0;
                    alignment = topStart;
                    ComposerKt.sourceInformationMarkerStart($i$a$LayoutRowKt$Row$1$iv, -1323940314, currentCompositionLocalMap);
                    obj52 = currentCompositeKeyHash2;
                    ...
                    int i60 = 0;
                    function0 = factory$iv$iv$iv;
                    Updater.set-impl(constructor-impl2, BoxKt.maybeCachedBoxMeasurePolicy(topStart, valueOf2), ComposeUiNode.Companion.getSetMeasurePolicy());
    ...
    private static final void VerticalPeriodToggle(Modifier modifier, androidx.compose.material3.TimePickerState state, androidx.compose.material3.TimePickerColors colors, Composer $composer, int $changed) {
        ...
        obj9 = restartGroup.endRestartGroup();
        if (obj9 != null) {
            obj10 = new TimePickerKt.VerticalPeriodToggle.1(obj, obj3, obj2, $changed);
            obj9.updateScope((Function2)obj10);
        }
    }
    ...
    public static final void VerticalTimePicker(androidx.compose.material3.AnalogTimePickerState state, Modifier modifier, androidx.compose.material3.TimePickerColors colors, boolean autoSwitchToMinute, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 8 != 0) {
            ...
            if (valueOf & 3072 == 0) {
                i8 = restartGroup.changed(z2) ? 2048 : 1024;
                $dirty2 |= i8;
            }
        }
        if ($dirty2 & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty2, -1, "androidx.compose.material3.VerticalTimePicker (TimePicker.kt:929)");
                }
                ...
                TimePickerKt.VerticalClockDisplay((TimePickerState)obj5, obj2, composer3, i22 |= i6);
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new TimePickerKt.VerticalTimePicker.3(obj5, $dirty, obj, z2, $changed, i7);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    private static final void timeInputOnChange-z7XvuPQ(int selection, androidx.compose.material3.TimePickerState state, TextFieldValue value, TextFieldValue prevValue, int max, Function1<? super TextFieldValue, Unit> onNewValue) {
        ...
        int i3 = 1;
        valueOf = 0;
        i2 = (CharSequence)value.getText().length() == 0 ? i3 : valueOf;
        if (i2 != 0) {
