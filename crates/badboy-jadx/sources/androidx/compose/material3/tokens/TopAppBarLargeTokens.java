...
public final class TopAppBarLargeTokens {
    ...
    public static final androidx.compose.material3.tokens.TopAppBarLargeTokens INSTANCE;
    ...
    static {
        TopAppBarLargeTokens topAppBarLargeTokens = new TopAppBarLargeTokens();
        TopAppBarLargeTokens.INSTANCE = topAppBarLargeTokens;
        TopAppBarLargeTokens.ContainerColor = ColorSchemeKeyTokens.Surface;
        TopAppBarLargeTokens.ContainerElevation = ElevationTokens.INSTANCE.getLevel0-D9Ej5fM();
        int i = 0;
        TopAppBarLargeTokens.ContainerHeight = Dp.constructor-impl((float)l);
        TopAppBarLargeTokens.ContainerShape = ShapeKeyTokens.CornerNone;
        TopAppBarLargeTokens.ContainerSurfaceTintLayerColor = ColorSchemeKeyTokens.SurfaceTint;
        TopAppBarLargeTokens.HeadlineColor = ColorSchemeKeyTokens.OnSurface;
        TopAppBarLargeTokens.HeadlineFont = TypographyKeyTokens.HeadlineMedium;
        TopAppBarLargeTokens.LeadingIconColor = ColorSchemeKeyTokens.OnSurface;
        int i2 = 0;
        TopAppBarLargeTokens.LeadingIconSize = Dp.constructor-impl((float)l2);
        TopAppBarLargeTokens.TrailingIconColor = ColorSchemeKeyTokens.OnSurfaceVariant;
        int i3 = 0;
        TopAppBarLargeTokens.TrailingIconSize = Dp.constructor-impl((float)l3);
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getContainerColor() {
        return TopAppBarLargeTokens.ContainerColor;
    }

    public final float getContainerElevation-D9Ej5fM() {
        return TopAppBarLargeTokens.ContainerElevation;
    }

    public final float getContainerHeight-D9Ej5fM() {
        return TopAppBarLargeTokens.ContainerHeight;
    }

    public final androidx.compose.material3.tokens.ShapeKeyTokens getContainerShape() {
        return TopAppBarLargeTokens.ContainerShape;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getContainerSurfaceTintLayerColor() {
        return TopAppBarLargeTokens.ContainerSurfaceTintLayerColor;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getHeadlineColor() {
        return TopAppBarLargeTokens.HeadlineColor;
    }

    public final androidx.compose.material3.tokens.TypographyKeyTokens getHeadlineFont() {
        return TopAppBarLargeTokens.HeadlineFont;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getLeadingIconColor() {
        return TopAppBarLargeTokens.LeadingIconColor;
    }

    public final float getLeadingIconSize-D9Ej5fM() {
        return TopAppBarLargeTokens.LeadingIconSize;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getTrailingIconColor() {
        return TopAppBarLargeTokens.TrailingIconColor;
    }

    public final float getTrailingIconSize-D9Ej5fM() {
        return TopAppBarLargeTokens.TrailingIconSize;
    }
}
