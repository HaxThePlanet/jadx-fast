...
public final class TopAppBarSmallTokens {
    ...
    public static final androidx.compose.material3.tokens.TopAppBarSmallTokens INSTANCE;
    private static final androidx.compose.material3.tokens.ColorSchemeKeyTokens LeadingIconColor;
    private static final float LeadingIconSize;
    private static final androidx.compose.material3.tokens.ColorSchemeKeyTokens OnScrollContainerColor;
    ...
    static {
        TopAppBarSmallTokens topAppBarSmallTokens = new TopAppBarSmallTokens();
        TopAppBarSmallTokens.INSTANCE = topAppBarSmallTokens;
        TopAppBarSmallTokens.ContainerColor = ColorSchemeKeyTokens.Surface;
        TopAppBarSmallTokens.ContainerElevation = ElevationTokens.INSTANCE.getLevel0-D9Ej5fM();
        int i = 0;
        TopAppBarSmallTokens.ContainerHeight = Dp.constructor-impl((float)l);
        TopAppBarSmallTokens.ContainerShape = ShapeKeyTokens.CornerNone;
        TopAppBarSmallTokens.HeadlineColor = ColorSchemeKeyTokens.OnSurface;
        TopAppBarSmallTokens.HeadlineFont = TypographyKeyTokens.TitleLarge;
        TopAppBarSmallTokens.LeadingIconColor = ColorSchemeKeyTokens.OnSurface;
        int i2 = 0;
        TopAppBarSmallTokens.LeadingIconSize = Dp.constructor-impl((float)l2);
        TopAppBarSmallTokens.OnScrollContainerColor = ColorSchemeKeyTokens.SurfaceContainer;
        TopAppBarSmallTokens.OnScrollContainerElevation = ElevationTokens.INSTANCE.getLevel2-D9Ej5fM();
        TopAppBarSmallTokens.TrailingIconColor = ColorSchemeKeyTokens.OnSurfaceVariant;
        int i3 = 0;
        TopAppBarSmallTokens.TrailingIconSize = Dp.constructor-impl((float)l3);
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getContainerColor() {
        return TopAppBarSmallTokens.ContainerColor;
    }

    public final float getContainerElevation-D9Ej5fM() {
        return TopAppBarSmallTokens.ContainerElevation;
    }

    public final float getContainerHeight-D9Ej5fM() {
        return TopAppBarSmallTokens.ContainerHeight;
    }

    public final androidx.compose.material3.tokens.ShapeKeyTokens getContainerShape() {
        return TopAppBarSmallTokens.ContainerShape;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getHeadlineColor() {
        return TopAppBarSmallTokens.HeadlineColor;
    }

    public final androidx.compose.material3.tokens.TypographyKeyTokens getHeadlineFont() {
        return TopAppBarSmallTokens.HeadlineFont;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getLeadingIconColor() {
        return TopAppBarSmallTokens.LeadingIconColor;
    }

    public final float getLeadingIconSize-D9Ej5fM() {
        return TopAppBarSmallTokens.LeadingIconSize;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getOnScrollContainerColor() {
        return TopAppBarSmallTokens.OnScrollContainerColor;
    }

    public final float getOnScrollContainerElevation-D9Ej5fM() {
        return TopAppBarSmallTokens.OnScrollContainerElevation;
    }

    public final androidx.compose.material3.tokens.ColorSchemeKeyTokens getTrailingIconColor() {
        return TopAppBarSmallTokens.TrailingIconColor;
    }

    public final float getTrailingIconSize-D9Ej5fM() {
        return TopAppBarSmallTokens.TrailingIconSize;
    }
}
