...
final class ThumbNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if (obj2.maxIntrinsicHeight(Constraints.getMaxWidth-impl(constraints)) != 0 && obj2.maxIntrinsicWidth(Constraints.getMaxHeight-impl(constraints)) != 0) {
            i3 = obj2.maxIntrinsicWidth(Constraints.getMaxHeight-impl(constraints)) != 0 ? 1 : 0;
        } else {
        }
        if (obj.isPressed) {
        ...
        int i12 = 0;
        if (sizeAnim2 != null) {
            targetValue = sizeAnim2.getTargetValue();
        } else {
            targetValue = i12;
        }
        if (!Intrinsics.areEqual(targetValue, f4)) {
        ...
        if (offsetAnim != null) {
            targetValue2 = offsetAnim.getTargetValue();
        } else {
            targetValue2 = i12;
        }
        if (!Intrinsics.areEqual(targetValue2, px-0680j_4)) {
