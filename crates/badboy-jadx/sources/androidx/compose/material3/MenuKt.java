...
public final class MenuKt {
    ...
    public static final void DropdownMenuContent-Qj0Zi0g(Modifier modifier, MutableTransitionState<Boolean> expandedState, MutableState<TransformOrigin> transformOriginState, ScrollState scrollState, Shape shape, long containerColor, float tonalElevation, float shadowElevation, BorderStroke border, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        if (i100 & 6 == 0) {
            i15 = scale$delegate.changed(obj5) ? 4 : 2;
            $dirty |= i15;
        }
        if (i100 & 48 == 0) {
            if (i100 & 64 == 0) {
                changedInstance = scale$delegate.changed(obj);
            } else {
                changedInstance = scale$delegate.changedInstance(obj);
            }
            i10 = changedInstance != null ? 32 : 16;
            $dirty |= i10;
        }
        if (i100 & 384 == 0) {
            i17 = scale$delegate.changed(transformOriginState) ? 256 : 128;
            $dirty |= i17;
        } else {
            it$iv = transformOriginState;
        }
        if (i100 & 3072 == 0) {
            i8 = scale$delegate.changed(anon) ? 2048 : 1024;
            $dirty |= i8;
        }
        if (i100 & 24576 == 0) {
            i20 = scale$delegate.changed(shape) ? 16384 : 8192;
            $dirty |= i20;
        } else {
            obj4 = shape;
        }
        if (i93 &= i100 == 0) {
            i = scale$delegate.changed(containerColor) ? 131072 : 65536;
            $dirty |= i;
        } else {
            graphicsLayer = containerColor;
        }
        if (i94 &= i100 == 0) {
            i24 = scale$delegate.changed(shadowElevation) ? 1048576 : 524288;
            $dirty |= i24;
        } else {
            f = shadowElevation;
        }
        i7 = 12582912;
        if (i100 & i7 == 0) {
            i26 = scale$delegate.changed(border) ? 8388608 : 4194304;
            $dirty |= i26;
        } else {
            f2 = border;
        }
        if (i100 & i122 == 0) {
            i22 = scale$delegate.changed(content) ? 67108864 : 33554432;
            $dirty |= i22;
        } else {
            obj3 = content;
        }
        if (i100 & i123 == 0) {
            i19 = scale$delegate.changedInstance(obj7) ? 536870912 : 268435456;
            $dirty |= i19;
        }
        if ($dirty & i12 == 306783378) {
            if (!scale$delegate.getSkipping()) {
                ...
                i4 = (Boolean)transition3.getCurrentState().booleanValue() ? 1065353216 : 1061997773;
                if (ComposerKt.isTraceInProgress()) {
                ...
                i3 = (Boolean)transition3.getTargetState().booleanValue() ? 1065353216 : 1061997773;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                ...
                State transitionAnimation2 = TransitionKt.createTransitionAnimation(transition3, Float.valueOf(i4), Float.valueOf(i3), (FiniteAnimationSpec)(Function3)MenuKt.DropdownMenuContent.scale.2.INSTANCE.invoke(transition3.getSegment(), scale$delegate, Integer.valueOf(i84 &= 112)), VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), "FloatAnimation", composer8, i73 | i89);
                ...
                i23 = (Boolean)transition4.getCurrentState().booleanValue() ? 1065353216 : 0;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                ...
                i16 = expanded ? 1065353216 : 0;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer4.endReplaceGroup();
                Composer composer9 = composer3;
                transitionAnimation = TransitionKt.createTransitionAnimation(transition4, Float.valueOf(i23), Float.valueOf(i16), (FiniteAnimationSpec)(Function3)MenuKt.DropdownMenuContent.alpha.2.INSTANCE.invoke(transition4.getSegment(), composer3, Integer.valueOf(i75 &= 112)), VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), str, composer9, i55 | i80);
                obj3 = composer9;
                ...
                ComposerKt.sourceInformationMarkerEnd(obj3);
                boolean booleanValue = (Boolean)obj3.consume((CompositionLocal)InspectionModeKt.getLocalInspectionMode()).booleanValue();
                ComposerKt.sourceInformationMarkerStart(obj3, 526637745, "CC(remember):Menu.kt#9igjgp");
                if ($dirty & 112 != 32) {
                    if ($dirty & 64 != 0 && obj3.changedInstance(obj)) {
                        if (obj3.changedInstance(obj)) {
                            i9 = 1;
                        } else {
                            i9 = 0;
                        }
                ...
                composer = obj3;
                SurfaceKt.Surface-T9BRK9s(GraphicsLayerModifierKt.graphicsLayer((Modifier)Modifier.Companion, (Function1)isInspecting), shape, containerColor, 0, 0, str, shadowElevation, border, content, (Function2)ComposableLambdaKt.rememberComposableLambda(1573559053, true, anon2, obj3, 54), composer);
                composer2 = composer;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
    ...
    public static final void DropdownMenuItemContent(Function2<? super Composer, ? super Integer, Unit> text, Function0<Unit> onClick, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> leadingIcon, Function2<? super Composer, ? super Integer, Unit> trailingIcon, boolean enabled, androidx.compose.material3.MenuItemColors colors, PaddingValues contentPadding, MutableInteractionSource interactionSource, Composer $composer, int $changed) {
        ...
        if (i38 & 6 == 0) {
            i12 = restartGroup.changedInstance(text) ? 4 : 2;
            $dirty |= i12;
        } else {
            obj4 = text;
        }
        ...
        if (i21 &= i38 == 0) {
            i5 = restartGroup.changed(enabled) ? 131072 : 65536;
            $dirty |= i5;
        } else {
            localMap$iv$iv = enabled;
        }
        if (i22 &= i38 == 0) {
            i6 = restartGroup.changed(colors) ? 1048576 : 524288;
            $dirty |= i6;
        } else {
            centerVertically = colors;
        }
        if (i25 &= i38 == 0) {
            i3 = restartGroup.changed(obj8) ? 8388608 : 4194304;
            $dirty |= i3;
        }
        if (i26 &= i38 == 0) {
        ...
        if (i30 &= $dirty == 38347922) {
            if (!restartGroup.getSkipping()) {
                ...
                valueOf2 = PaddingKt.padding(SizeKt.sizeIn-qDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.clickable-O2vRcR0$default(obj2, interactionSource, RippleKt.rippleOrFallbackImplementation-9IZ8Weo(true, i24, 0, traceInProgress2, restartGroup, 6), enabled, 0, 0, rememberComposableLambda, 24, 0), i24, 1, 0), MenuKt.DropdownMenuItemDefaultMinWidth, MenuKt.MenuListItemContainerHeight, MenuKt.DropdownMenuItemDefaultMaxWidth, 0, 8, 0), obj8);
                obj5 = 384;
                restartGroup = 0;
                ...
                androidx.compose.runtime.CompositionLocalMap currentCompositionLocalMap = valueOf.getCurrentCompositionLocalMap();
                Modifier materializeModifier = ComposedModifierKt.materializeModifier(valueOf, valueOf2);
                ...
                if (valueOf.getInserting()) {
                    valueOf.createNode(constructor);
                } else {
                    valueOf.useNode();
                }
                Composer constructor-impl = Updater.constructor-impl(valueOf);
                int i50 = 0;
                Updater.set-impl(constructor-impl, RowKt.rowMeasurePolicy(Arrangement.INSTANCE.getStart(), Alignment.Companion.getCenterVertically(), valueOf, i36 |= i40), ComposeUiNode.Companion.getSetMeasurePolicy());
                Updater.set-impl(constructor-impl, currentCompositionLocalMap, ComposeUiNode.Companion.getSetResolvedCompositionLocals());
                int i61 = 0;
                Composer composer5 = constructor-impl;
                int i66 = 0;
                if (!composer5.getInserting()) {
                    modifier$iv = valueOf2;
                    composer = valueOf;
                ...
                obj4 = map;
                MenuKt.DropdownMenuItemContent.1.1 localMap$iv$iv2 = new MenuKt.DropdownMenuItemContent.1.1(leadingIcon, colors, enabled, trailingIcon, (RowScope)RowScopeInstance.INSTANCE, obj4);
