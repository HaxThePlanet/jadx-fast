...
public final class DateRangePickerKt {
    ...
    public static final void DateRangePicker(androidx.compose.material3.DateRangePickerState state, Modifier modifier, androidx.compose.material3.DatePickerFormatter dateFormatter, Function2<? super Composer, ? super Integer, Unit> title, Function2<? super Composer, ? super Integer, Unit> headline, boolean showModeToggle, androidx.compose.material3.DatePickerColors colors, Composer $composer, int $changed, int i10) {
        ...
        if (i10 & 1 != 0) {
            ...
            if (i48 & 6 == 0) {
                i11 = restartGroup.changed(obj5) ? 4 : 2;
                $dirty3 |= i11;
            }
        }
        i15 = i10 & 2;
        ...
        if (i48 & 384 == 0) {
            if (i10 & 4 == 0) {
                ...
                i5 = changedInstance != null ? 256 : 128;
            } else {
            }
            $dirty3 |= i5;
        }
        ...
        if (i59 &= $dirty3 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                if (i48 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (i10 & 4 != 0) {
                            ...
                            i15 = restartGroup;
                            obj3 = 0;
                            Object rememberedValue2 = i15.rememberedValue();
                            i4 = 0;
                            obj28 = i32;
                            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                                int i33 = 0;
                                i15.updateRememberedValue(DatePickerDefaults.dateFormatter$default(DatePickerDefaults.INSTANCE, 0, 0, 0, 7, 0));
                            } else {
                        ...
                        if (i3 != 0) {
                            DateRangePickerKt.DateRangePicker.2 anon2 = new DateRangePickerKt.DateRangePicker.2(obj5);
                            obj28 = $dirty3;
                        ...
                        if (i50 != 0) {
                            DateRangePickerKt.DateRangePicker.3 anon = new DateRangePickerKt.DateRangePicker.3(obj5, dateFormatter2);
                            obj2 = $i$a$CacheDateRangePickerKt$DateRangePicker$1;
                        }
                        if (i14 != 0) {
                ...
                if (obj28 != null) {
                    DateRangePickerKt.DateRangePicker.4 anon4 = new DateRangePickerKt.DateRangePicker.4(obj5);
                    i14 = rememberComposableLambda;
                } else {
                    i14 = rememberComposableLambda;
                }
                restartGroup.endReplaceGroup();
                int i61 = 0;
                DateRangePickerKt.DateRangePicker.5 anon3 = new DateRangePickerKt.DateRangePicker.5(obj5, (CalendarModel)$i$a$CacheDateRangePickerKt$DateRangePicker$calendarModel$1, dateFormatter2, showModeToggle2);
                DatePickerKt.DateEntryContainer-au3_HiA(title2, obj7, obj2, i14, showModeToggle2, TypographyKt.getValue(DatePickerModalTokens.INSTANCE.getRangeSelectionHeaderHeadlineFont(), restartGroup, 6), Dp.constructor-impl(rangeSelectionHeaderContainerHeight-D9Ej5fM - headerHeightOffset), (Function2)ComposableLambdaKt.rememberComposableLambda(-57534331, true, anon3, restartGroup, 54), restartGroup, i22 | obj5);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new DateRangePickerKt.DateRangePicker.6(state, obj, $composer2, $dirty2, obj6, z, obj4, i48, i10);
    ...
    private static final void DateRangePickerContent(Long selectedStartDateMillis, Long selectedEndDateMillis, long displayedMonthMillis, Function2<? super Long, ? super Long, Unit> onDatesSelectionChange, Function1<? super Long, Unit> onDisplayedMonthChange, CalendarModel calendarModel, IntRange yearRange, androidx.compose.material3.DatePickerFormatter dateFormatter, androidx.compose.material3.SelectableDates selectableDates, androidx.compose.material3.DatePickerColors colors, Composer $composer, int $changed) {
        ...
        if (traceInProgress2 & 6 == 0) {
            i10 = restartGroup.changed(selectedStartDateMillis) ? 4 : 2;
            $dirty |= i10;
        } else {
            obj9 = selectedStartDateMillis;
        }
        if (traceInProgress2 & 48 == 0) {
            i2 = restartGroup.changed(selectedEndDateMillis) ? 32 : 16;
            $dirty |= i2;
        } else {
            obj4 = selectedEndDateMillis;
        }
        if (traceInProgress2 & 384 == 0) {
            i4 = restartGroup.changed(materializeModifier) ? 256 : 128;
            $dirty |= i4;
        }
        if (traceInProgress2 & 3072 == 0) {
            i20 = restartGroup.changedInstance(onDisplayedMonthChange) ? 2048 : 1024;
            $dirty |= i20;
        } else {
            obj5 = onDisplayedMonthChange;
        }
        if (traceInProgress2 & 24576 == 0) {
            i9 = restartGroup.changedInstance(calendarModel) ? 16384 : 8192;
            $dirty |= i9;
        } else {
            obj = calendarModel;
        }
        if (i71 &= traceInProgress2 == 0) {
            i14 = restartGroup.changedInstance(obj3) ? 131072 : 65536;
            $dirty |= i14;
        }
        if (i72 &= traceInProgress2 == 0) {
            i15 = restartGroup.changedInstance(obj2) ? 1048576 : 524288;
            $dirty |= i15;
        }
        if (i73 &= traceInProgress2 == 0) {
            if (i76 &= traceInProgress2 == 0) {
        ...
        if (i74 &= traceInProgress2 == 0) {
            i8 = restartGroup.changed(colors) ? 67108864 : 33554432;
            $dirty |= i8;
        } else {
            obj8 = colors;
        }
        if (traceInProgress2 & i78 == 0) {
            i = restartGroup.changed(obj7) ? 536870912 : 268435456;
            $dirty |= i;
        }
        if ($dirty & i13 == 306783378) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-787063721, $dirty, -1, "androidx.compose.material3.DateRangePickerContent (DateRangePicker.kt:715)");
                }
                CalendarMonth month = obj3.getMonth(materializeModifier);
                int i67 = 0;
                calendar = month;
                ...
                ComposerKt.sourceInformationMarkerStart(obj8, 556336155, "C720@32122L31,721@32162L514:DateRangePicker.kt#uh7d8r");
                DatePickerKt.WeekDays(obj7, obj3, obj8, i26 |= i51);
                monthsListState = $dirty;
                androidx.compose.ui.Alignment.Horizontal horizontal = start;
                DateRangePickerKt.VerticalMonthsList(LazyListStateKt.rememberLazyListState(month.indexIn(obj2), i67, restartGroup, i67, 2), selectedStartDateMillis, obj4, obj5, obj, obj3, obj2, obj6, colors, obj7, obj8, i36 | i66);
        ...
        ScopeUpdateScope endRestartGroup = composer2.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new DateRangePickerKt.DateRangePickerContent.2(selectedStartDateMillis, selectedEndDateMillis, displayedMonthMillis, currentCompositionLocalMap, onDisplayedMonthChange, calendarModel, yearRange, dateFormatter, selectableDates, colors, $composer, obj46);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    private static final void SwitchableDateEntryContent-RN-2D1Q(Long selectedStartDateMillis, Long selectedEndDateMillis, long displayedMonthMillis, int displayMode, Function2<? super Long, ? super Long, Unit> onDatesSelectionChange, Function1<? super Long, Unit> onDisplayedMonthChange, CalendarModel calendarModel, IntRange yearRange, androidx.compose.material3.DatePickerFormatter dateFormatter, androidx.compose.material3.SelectableDates selectableDates, androidx.compose.material3.DatePickerColors colors, Composer $composer, int $changed, int $changed1) {
        ...
        if (i3 & 6 == 0) {
            i14 = restartGroup.changed(selectedStartDateMillis) ? 4 : 2;
            $dirty2 |= i14;
        } else {
        ...
        if (i3 & 384 == 0) {
            i5 = restartGroup.changed(displayedMonthMillis) ? 256 : 128;
            $dirty2 |= i5;
        } else {
            l = displayedMonthMillis;
        }
        if (i3 & 3072 == 0) {
            i12 = restartGroup.changed(onDatesSelectionChange) ? 2048 : 1024;
            $dirty2 |= i12;
        } else {
            i2 = onDatesSelectionChange;
        }
        if (i3 & 24576 == 0) {
        ...
        if (i30 &= i3 == 0) {
            i8 = restartGroup.changedInstance(calendarModel) ? 131072 : 65536;
            $dirty2 |= i8;
        } else {
            obj6 = calendarModel;
        }
        if (i32 &= i3 == 0) {
            i15 = restartGroup.changedInstance(yearRange) ? 1048576 : 524288;
            $dirty2 |= i15;
        } else {
            obj7 = yearRange;
        }
        if (i3 & i34 == 0) {
            i10 = restartGroup.changedInstance(dateFormatter) ? 8388608 : 4194304;
            $dirty2 |= i10;
        } else {
            obj4 = dateFormatter;
        }
        ...
        if (i3 & i36 == 0) {
            i11 = restartGroup.changed(colors) ? 536870912 : 268435456;
            $dirty2 |= i11;
        } else {
            obj9 = colors;
        }
        if (obj34 & 6 == 0) {
            i4 = restartGroup.changed($composer) ? 4 : 2;
            $dirty1 |= i4;
        } else {
            obj2 = $composer;
        }
        if ($dirty2 & i40 == 306783378 && $dirty1 & 3 == 2) {
            if ($dirty1 & 3 == 2) {
                if (!restartGroup.getSkipping()) {
                    ...
                    i3 = 1;
                    i6 = $dirty1;
                    DateRangePickerKt.SwitchableDateEntryContent.2 anon = new DateRangePickerKt.SwitchableDateEntryContent.2(selectedStartDateMillis, obj5, l, obj4, obj3, obj6, obj7, obj4, obj8, colors, obj2);
                    obj5 = restartGroup;
                    CrossfadeKt.Crossfade(DisplayMode.box-impl(i2), SemanticsModifierKt.semantics$default((Modifier)Modifier.Companion, false, (Function1)DateRangePickerKt.SwitchableDateEntryContent.1.INSTANCE, i3, 0), (FiniteAnimationSpec)AnimationSpecKt.spring$default(i26, i26, $dirty3, 7, $dirty3), 0, (Function3)ComposableLambdaKt.rememberComposableLambda(-1026642619, i3, anon, restartGroup, 54), obj5, i21 | 24960, 8);
                    composer = obj5;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
        ...
        if (endRestartGroup != null) {
            obj32 = $dirty;
            endRestartGroup = new DateRangePickerKt.SwitchableDateEntryContent.3(selectedStartDateMillis, selectedEndDateMillis, displayedMonthMillis, obj4, i2, onDisplayedMonthChange, calendarModel, yearRange, dateFormatter, selectableDates, colors, $composer, $changed1, obj34);
    ...
    private static final void VerticalMonthsList(LazyListState lazyListState, Long selectedStartDateMillis, Long selectedEndDateMillis, Function2<? super Long, ? super Long, Unit> onDatesSelectionChange, Function1<? super Long, Unit> onDisplayedMonthChange, CalendarModel calendarModel, IntRange yearRange, androidx.compose.material3.DatePickerFormatter dateFormatter, androidx.compose.material3.SelectableDates selectableDates, androidx.compose.material3.DatePickerColors colors, Composer $composer, int $changed) {
        ...
        if (rememberedValue & 6 == 0) {
            i2 = restartGroup.changed(lazyListState) ? 4 : 2;
            $dirty |= i2;
        }
        if (rememberedValue & 48 == 0) {
            i3 = restartGroup.changed(selectedStartDateMillis) ? 32 : 16;
            $dirty |= i3;
        } else {
            obj3 = selectedStartDateMillis;
        }
        if (rememberedValue & 384 == 0) {
            i11 = restartGroup.changed(selectedEndDateMillis) ? 256 : 128;
            $dirty |= i11;
        } else {
            obj5 = selectedEndDateMillis;
        }
        if (rememberedValue & 3072 == 0) {
            i4 = restartGroup.changedInstance(onDatesSelectionChange) ? 2048 : 1024;
            $dirty |= i4;
        } else {
            obj2 = onDatesSelectionChange;
        }
        if (rememberedValue & 24576 == 0) {
            i6 = restartGroup.changedInstance(onDisplayedMonthChange) ? 16384 : 8192;
            $dirty |= i6;
        } else {
            obj4 = onDisplayedMonthChange;
        }
        if (i33 &= rememberedValue == 0) {
            i15 = restartGroup.changedInstance(obj6) ? 131072 : 65536;
            $dirty |= i15;
        }
        if (i34 &= rememberedValue == 0) {
            i13 = restartGroup.changedInstance(obj7) ? 1048576 : 524288;
            $dirty |= i13;
        }
        if (i35 &= rememberedValue == 0) {
            ...
            i8 = changedInstance != null ? 8388608 : 4194304;
            $dirty |= i8;
        }
        if (i36 &= rememberedValue == 0) {
            i17 = restartGroup.changed(selectableDates) ? 67108864 : 33554432;
            $dirty |= i17;
        } else {
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (!restartGroup.changed(obj7)) {
                    if (rememberedValue2 == Composer.Companion.getEmpty()) {
                        ...
                        composer.updateRememberedValue(obj6.getMonth(obj7.getFirst(), 1));
                    } else {
                        companion = rememberedValue2;
                    }
                } else {
                ...
                i9 = $dirty;
                Object obj12 = obj7;
                DateRangePickerKt.VerticalMonthsList.1 firstMonth = new DateRangePickerKt.VerticalMonthsList.1(obj3, obj5, onDatesSelectionChange, lazyListState, obj12, obj6, (CalendarMonth)rememberedValue2, obj8, colors, obj6.getToday(), obj9);
                obj7 = obj12;
                obj3 = 1;
                TextKt.ProvideTextStyle(TypographyKt.getValue(DatePickerModalTokens.INSTANCE.getDateLabelTextFont(), restartGroup, 6), (Function2)ComposableLambdaKt.rememberComposableLambda(1090773432, obj3, firstMonth, restartGroup, 54), restartGroup, 48);
                ComposerKt.sourceInformationMarkerStart(restartGroup, -2140037042, str3);
                int i25 = 0;
                i = i9 & 14 == 4 ? obj3 : i25;
                i5 = i28 &= i9 == 16384 ? obj3 : i25;
                obj8 = restartGroup;
                obj9 = 0;
                rememberedValue = obj8.rememberedValue();
                skipping = 0;
                if (i22 |= changedInstance3 == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        i16 = 0;
                        anon = new DateRangePickerKt.VerticalMonthsList.2.1(lazyListState, onDisplayedMonthChange, obj6, obj7, 0);
                        obj8.updateRememberedValue((Function2)anon);
                    } else {
                        obj = lazyListState;
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                EffectsKt.LaunchedEffect(obj, (Function2)anon, restartGroup, i9 & 14);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            } else {
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new DateRangePickerKt.VerticalMonthsList.3(obj, selectedStartDateMillis, selectedEndDateMillis, onDatesSelectionChange, onDisplayedMonthChange, calendarModel, yearRange, dateFormatter, selectableDates, colors, $changed);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    public static final void drawRangeBackground-mxwnekA(ContentDrawScope $this$drawRangeBackground_u2dmxwnekA, androidx.compose.material3.SelectedRangeInfo selectedRangeInfo, long color) {
        ...
        i = selectedRangeInfo.getFirstIsSelectionStart() ? px-0680j_4 / f4 : 0;
        i30 += i13;
        f = selectedRangeInfo.getLastIsSelectionEnd() ? px-0680j_4 / f4 : px-0680j_4;
        i5 = width-impl.getLayoutDirection() == LayoutDirection.Rtl ? i2 : 0;
        if (i5 != 0) {
    ...
    public static final androidx.compose.material3.DateRangePickerState rememberDateRangePickerState-IlFM19s(Long initialSelectedStartDateMillis, Long initialSelectedEndDateMillis, Long initialDisplayedMonthMillis, IntRange yearRange, int initialDisplayMode, androidx.compose.material3.SelectableDates selectableDates, Composer $composer, int $changed, int i9) {
        ...
        i10 = i9 & 1 != 0 ? i11 : initialSelectedStartDateMillis;
        i6 = i9 & 2 != 0 ? i5 : initialSelectedEndDateMillis;
        i7 = i9 & 4 != 0 ? i8 : initialDisplayedMonthMillis;
        if (i9 & 8 != 0) {
            intRange = yearRange2;
        } else {
            intRange = yearRange;
        ...
        if (i21 |= changedInstance == null) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                i4 = 0;
                anon = new DateRangePickerKt.rememberDateRangePickerState.1.1(i10, i6, i7, intRange, i3, date, defaultLocale);
