...
public final class SheetState {
    ...
    public SheetState(boolean skipPartiallyExpanded, Density density, androidx.compose.material3.SheetValue initialValue, Function1<? super androidx.compose.material3.SheetValue, Boolean> confirmValueChange, boolean skipHiddenState) {
        ...
        if (this.skipPartiallyExpanded) {
            ...
            int i2 = 0;
            IllegalArgumentException $i$a$RequireSheetState$2 = new IllegalArgumentException("The initial value must not be set to PartiallyExpanded if skipPartiallyExpanded is set to true.".toString());
            throw $i$a$RequireSheetState$2;
        }
        if (this.skipHiddenState) {
            ...
            int i3 = 0;
            IllegalArgumentException $i$a$RequireSheetState$3 = new IllegalArgumentException("The initial value must not be set to Hidden if skipHiddenState is set to true.".toString());
            throw $i$a$RequireSheetState$3;
        }
