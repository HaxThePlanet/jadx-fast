...
public final class ExposedDropdownMenuDefaults {
    ...
    public final void TrailingIcon(boolean expanded, Modifier modifier, Composer $composer, int $changed, int i5) {
        ...
        if (i9 & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, i9, -1, "androidx.compose.material3.ExposedDropdownMenuDefaults.TrailingIcon (ExposedDropdownMenu.android.kt:519)");
                }
                i4 = expanded ? 1127481344 : 0;
                IconKt.Icon-ww6aTOc(ArrowDropDownKt.getArrowDropDown(Icons.Filled.INSTANCE), 0, RotateKt.rotate($dirty2, i4), 0, obj7, restartGroup, 48);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj = $dirty2;
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new ExposedDropdownMenuDefaults.TrailingIcon.1(this, expanded, obj, $changed, i5);
    ...
    public final androidx.compose.material3.TextFieldColors outlinedTextFieldColors-FD9MK7s(long focusedTextColor, long unfocusedTextColor, long disabledTextColor, long errorTextColor, long focusedContainerColor, long unfocusedContainerColor, long disabledContainerColor, long errorContainerColor, long cursorColor, long errorCursorColor, TextSelectionColors selectionColors, long focusedBorderColor, long unfocusedBorderColor, long disabledBorderColor, long errorBorderColor, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long focusedPlaceholderColor, long unfocusedPlaceholderColor, long disabledPlaceholderColor, long errorPlaceholderColor, long focusedPrefixColor, long unfocusedPrefixColor, long disabledPrefixColor, long errorPrefixColor, long focusedSuffixColor, long unfocusedSuffixColor, long disabledSuffixColor, long errorSuffixColor, Composer $composer, int $changed, int $changed1, int $changed2, int $changed3, int i45, int i46) {
        ...
        if (i44 & 1024 != 0) {
            ...
            selectionColors3 = unfocusedTrailingIconColor;
        }
        if (i44 & 2048 != 0) {
            value7 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldFocusOutlineColor(), composer, 6);
        } else {
            i4 = 6;
            value7 = disabledTrailingIconColor;
        }
        if (i44 & 4096 != 0) {
            l4 = value9;
        } else {
        ...
        if (i44 & 8192 != 0) {
            disabledBorderColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldDisabledOutlineColor(), composer, i4), unfocusedTextColor, OutlinedAutocompleteTokens.INSTANCE.getTextFieldDisabledOutlineOpacity(), 0, 0, 0, 14);
        } else {
            disabledBorderColor2 = disabledLabelColor;
        }
        if (i44 & 16384 != 0) {
            value6 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldErrorOutlineColor(), composer, 6);
        } else {
        ...
        if (obj180 & i47 != 0) {
            ...
            i3 = 6;
            value2 = focusedSuffixColor;
        }
        if (obj180 & i48 != 0) {
            focusedTrailingIconColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldFocusTrailingIconColor(), composer, i3);
        } else {
            focusedTrailingIconColor2 = disabledSuffixColor;
        }
        if (obj180 & i49 != 0) {
            unfocusedTrailingIconColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldTrailingIconColor(), composer, i3);
        } else {
            unfocusedTrailingIconColor2 = $composer;
        }
        if (obj180 & i50 != 0) {
            disabledTrailingIconColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldDisabledTrailingIconColor(), composer, i3), obj100, OutlinedAutocompleteTokens.INSTANCE.getTextFieldDisabledTrailingIconOpacity(), 0, 0, 0, 14);
        } else {
            disabledTrailingIconColor2 = $changed1;
        }
        if (obj180 & i51 != 0) {
            value8 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldErrorTrailingIconColor(), composer, 6);
        } else {
            i12 = 6;
            value8 = $changed3;
        }
        if (obj180 & i52 != 0) {
            focusedLabelColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldFocusLabelTextColor(), composer, i12);
        } else {
            focusedLabelColor2 = i46;
        }
        if (obj180 & i53 != 0) {
            unfocusedLabelColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldLabelTextColor(), composer, i12);
        } else {
            unfocusedLabelColor2 = obj145;
        }
        if (obj180 & i54 != 0) {
            disabledLabelColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldDisabledLabelTextColor(), composer, i12), obj100, OutlinedAutocompleteTokens.INSTANCE.getFieldDisabledLabelTextOpacity(), 0, 0, 0, 14);
        } else {
        ...
        if (obj180 & i56 != 0) {
            focusedPlaceholderColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i30);
        } else {
            focusedPlaceholderColor2 = obj151;
        }
        if (obj180 & i57 != 0) {
            unfocusedPlaceholderColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i30);
        } else {
            unfocusedPlaceholderColor2 = obj153;
        }
        if (obj180 & i58 != 0) {
            disabledPlaceholderColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldDisabledSupportingTextColor(), composer, i30), obj100, OutlinedAutocompleteTokens.INSTANCE.getFieldDisabledSupportingTextOpacity(), 0, 0, 0, 14);
        } else {
        ...
        return OutlinedTextFieldDefaults.INSTANCE.colors-0hiis_0(focusedTextColor2, i43, unfocusedTextColor2, i95, disabledTextColor2, disabledBorderColor2, errorTextColor2, focusedTextColor2, focusedContainerColor2, unfocusedTextColor2, unfocusedContainerColor2, disabledTextColor2, disabledContainerColor2, errorTextColor2, errorContainerColor2, focusedContainerColor2, cursorColor2, unfocusedContainerColor2, errorCursorColor2, disabledContainerColor2, selectionColors3, value7, obj24, l4, obj26, disabledBorderColor2, obj28, value6, i31, focusedLeadingIconColor2, i140, unfocusedLeadingIconColor2, obj34, disabledLeadingIconColor2, obj36, value2, i23, focusedTrailingIconColor2, i7, unfocusedTrailingIconColor2, obj42, disabledTrailingIconColor2, i39, value8, i15, focusedLabelColor2, obj48, unfocusedLabelColor2, obj50, disabledLabelColor2, i17);
    }
    ...
    public final androidx.compose.material3.TextFieldColors outlinedTextFieldColors-St-qZLY(long textColor, long disabledTextColor, long containerColor, long cursorColor, long errorCursorColor, TextSelectionColors selectionColors, long focusedBorderColor, long unfocusedBorderColor, long disabledBorderColor, long errorBorderColor, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long placeholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int $changed2, int i29) {
        ...
        if (i14 & 8 != 0) {
            l16 = textFieldDisabledOutlineOpacity;
        } else {
            l16 = focusedBorderColor;
        }
        if (i14 & 16 != 0) {
            l19 = textFieldDisabledOutlineOpacity;
        } else {
            l19 = disabledBorderColor;
        }
        if (i14 & 32 != 0) {
        ...
        return this.outlinedTextFieldColors-FD9MK7s(l21, i46, textColor2, i111, disabledTextColor2, textColor2, l21, disabledTextColor2, l25, containerColor2, l25, i115, l25, i119, l25, i122, l16, obj19, l19, obj21, obj, l9, obj24, l10, obj26, l4, i10, l7, obj30, l15, obj32, l12, obj34, l2, i8, l20, obj38, l3, obj40, l13, obj42, l, i11, l17, obj46, l11);
    }
    ...
    public final androidx.compose.material3.TextFieldColors outlinedTextFieldColors-tN0la-I(long focusedTextColor, long unfocusedTextColor, long disabledTextColor, long errorTextColor, long containerColor, long errorContainerColor, long cursorColor, long errorCursorColor, TextSelectionColors selectionColors, long focusedBorderColor, long unfocusedBorderColor, long disabledBorderColor, long errorBorderColor, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long focusedPlaceholderColor, long unfocusedPlaceholderColor, long disabledPlaceholderColor, long errorPlaceholderColor, long focusedPrefixColor, long unfocusedPrefixColor, long disabledPrefixColor, long errorPrefixColor, long focusedSuffixColor, long unfocusedSuffixColor, long disabledSuffixColor, long errorSuffixColor, Composer $composer, int $changed, int $changed1, int $changed2, int $changed3, int i43, int i44) {
        ...
        if (i37 & 512 != 0) {
            value11 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldFocusOutlineColor(), composer, 6);
        } else {
            i3 = 6;
            value11 = focusedTrailingIconColor;
        }
        if (i37 & 1024 != 0) {
            l10 = value12;
        } else {
        ...
        if (i37 & 2048 != 0) {
            disabledBorderColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldDisabledOutlineColor(), composer, i3), unfocusedTextColor, OutlinedAutocompleteTokens.INSTANCE.getTextFieldDisabledOutlineOpacity(), 0, 0, 0, 14);
        } else {
            disabledBorderColor2 = focusedLabelColor;
        }
        if (i37 & 4096 != 0) {
            obj88 = disabledBorderColor2;
            value5 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldErrorOutlineColor(), composer, 6);
        } else {
            obj88 = disabledBorderColor2;
            disabledBorderColor3 = 6;
            value5 = disabledLabelColor;
        }
        if (i37 & 8192 != 0) {
            focusedLeadingIconColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldFocusLeadingIconColor(), composer, disabledBorderColor3);
        } else {
            focusedLeadingIconColor2 = focusedPlaceholderColor;
        }
        if (i37 & 16384 != 0) {
            unfocusedLeadingIconColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldLeadingIconColor(), composer, disabledBorderColor3);
        } else {
        ...
        if (i54 &= i37 != 0) {
            focusedTrailingIconColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldFocusTrailingIconColor(), composer, i10);
        } else {
            focusedTrailingIconColor2 = focusedSuffixColor;
        }
        if (i55 &= i37 != 0) {
            unfocusedTrailingIconColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldTrailingIconColor(), composer, i10);
        } else {
        ...
        if (i57 &= i37 != 0) {
            value9 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getTextFieldErrorTrailingIconColor(), composer, 6);
        } else {
            i15 = 6;
            value9 = $changed1;
        }
        if (i58 &= i37 != 0) {
            focusedLabelColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldFocusLabelTextColor(), composer, i15);
        } else {
            focusedLabelColor2 = $changed3;
        }
        if (i59 &= i37 != 0) {
            unfocusedLabelColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldLabelTextColor(), composer, i15);
        } else {
        ...
        if (i62 &= i37 != 0) {
            focusedPlaceholderColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i9);
        } else {
            focusedPlaceholderColor2 = obj136;
        }
        if (i63 &= i37 != 0) {
            unfocusedPlaceholderColor2 = ColorSchemeKt.getValue(OutlinedAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i9);
        } else {
        ...
        return this.outlinedTextFieldColors-FD9MK7s(focusedTextColor2, i49, unfocusedTextColor2, i164, disabledTextColor2, focusedTextColor2, errorTextColor2, unfocusedTextColor2, l17, disabledTextColor2, containerColor2, errorTextColor2, l17, containerColor2, errorContainerColor2, errorContainerColor2, cursorColor2, cursorColor2, errorCursorColor2, errorCursorColor2, selectionColors2, value11, i23, l10, i167, obj88, obj28, value5, obj30, focusedLeadingIconColor2, i16, unfocusedLeadingIconColor2, i12, l, obj36, value4, i2, focusedTrailingIconColor2, obj40, unfocusedTrailingIconColor2, obj42, l5, obj44, value9, i5, focusedLabelColor2);
    }
    ...
    public final androidx.compose.material3.TextFieldColors textFieldColors-FD9MK7s(long focusedTextColor, long unfocusedTextColor, long disabledTextColor, long errorTextColor, long focusedContainerColor, long unfocusedContainerColor, long disabledContainerColor, long errorContainerColor, long cursorColor, long errorCursorColor, TextSelectionColors selectionColors, long focusedIndicatorColor, long unfocusedIndicatorColor, long disabledIndicatorColor, long errorIndicatorColor, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long focusedPlaceholderColor, long unfocusedPlaceholderColor, long disabledPlaceholderColor, long errorPlaceholderColor, long focusedPrefixColor, long unfocusedPrefixColor, long disabledPrefixColor, long errorPrefixColor, long focusedSuffixColor, long unfocusedSuffixColor, long disabledSuffixColor, long errorSuffixColor, Composer $composer, int $changed, int $changed1, int $changed2, int $changed3, int i45, int i46) {
        ...
        int fieldSupportingTextColor3;
        int fieldSupportingTextColor5;
        int fieldDisabledSupportingTextOpacity3;
        int value4;
        boolean traceInProgress;
        int i10;
        Object selectionColors2;
        ...
        if (i39 & 2048 != 0) {
            value7 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldFocusActiveIndicatorColor(), composer, 6);
        } else {
            i13 = 6;
            value7 = disabledTrailingIconColor;
        }
        if (i39 & 4096 != 0) {
            ...
            l2 = focusedLabelColor;
        }
        if (i39 & 8192 != 0) {
            disabledIndicatorColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldDisabledActiveIndicatorColor(), composer, i13), unfocusedTextColor, FilledAutocompleteTokens.INSTANCE.getTextFieldDisabledActiveIndicatorOpacity(), 0, 0, 0, 14);
        } else {
            disabledIndicatorColor2 = disabledLabelColor;
        }
        if (i39 & 16384 != 0) {
            value = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldErrorActiveIndicatorColor(), composer, 6);
        } else {
            textFieldDisabledLeadingIconOpacity = 6;
            value = focusedPlaceholderColor;
        }
        if (obj180 & i92 != 0) {
        ...
        if (obj180 & i40 != 0) {
            value5 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldErrorLeadingIconColor(), composer, 6);
        } else {
            i8 = 6;
            value5 = focusedSuffixColor;
        }
        if (obj180 & i41 != 0) {
            focusedTrailingIconColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldFocusTrailingIconColor(), composer, i8);
        } else {
            focusedTrailingIconColor2 = disabledSuffixColor;
        }
        if (obj180 & i42 != 0) {
            unfocusedTrailingIconColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldTrailingIconColor(), composer, i8);
        } else {
            unfocusedTrailingIconColor2 = $composer;
        }
        if (obj180 & i43 != 0) {
            disabledTrailingIconColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldDisabledTrailingIconColor(), composer, i8), obj100, FilledAutocompleteTokens.INSTANCE.getTextFieldDisabledTrailingIconOpacity(), 0, 0, 0, 14);
        } else {
            disabledTrailingIconColor2 = $changed1;
        }
        if (obj180 & i44 != 0) {
            value3 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldErrorTrailingIconColor(), composer, 6);
        } else {
            i11 = 6;
            value3 = $changed3;
        }
        if (obj180 & i47 != 0) {
            focusedLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldFocusLabelTextColor(), composer, i11);
        } else {
            focusedLabelColor2 = i46;
        }
        if (obj180 & i48 != 0) {
            unfocusedLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldLabelTextColor(), composer, i11);
        } else {
            unfocusedLabelColor2 = obj145;
        }
        if (obj180 & i49 != 0) {
            disabledLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldDisabledLabelTextColor(), composer, i11);
        } else {
            disabledLabelColor2 = obj147;
        }
        if (obj180 & i50 != 0) {
            errorLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldErrorLabelTextColor(), composer, i11);
        } else {
            errorLabelColor2 = obj149;
        }
        if (obj180 & i51 != 0) {
            focusedPlaceholderColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i11);
        } else {
            focusedPlaceholderColor2 = obj151;
        }
        if (obj180 & i52 != 0) {
            unfocusedPlaceholderColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i11);
        } else {
            unfocusedPlaceholderColor2 = obj153;
        }
        if (obj180 & i53 != 0) {
            disabledPlaceholderColor2 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldDisabledSupportingTextColor(), composer, i11), obj100, FilledAutocompleteTokens.INSTANCE.getFieldDisabledSupportingTextOpacity(), 0, 0, 0, 14);
        } else {
            disabledPlaceholderColor2 = obj155;
        }
        if (obj180 & i54 != 0) {
        ...
        ComposerKt.sourceInformationMarkerEnd(obj175);
        return TextFieldDefaults.INSTANCE.colors-0hiis_0(focusedTextColor2, i38, unfocusedTextColor2, i90, disabledTextColor2, disabledIndicatorColor2, errorTextColor2, focusedTextColor2, focusedContainerColor2, unfocusedTextColor2, unfocusedContainerColor2, disabledTextColor2, disabledContainerColor2, errorTextColor2, errorContainerColor2, focusedContainerColor2, cursorColor2, unfocusedContainerColor2, errorCursorColor2, disabledContainerColor2, selectionColors2, value7, obj24, l2, obj26, disabledIndicatorColor2, obj28, value, i16, focusedLeadingIconColor2, i135, unfocusedLeadingIconColor2, obj34, disabledLeadingIconColor2, obj36, value5, i15, focusedTrailingIconColor2, i3, unfocusedTrailingIconColor2, obj42, disabledTrailingIconColor2, i31, value3, i34, focusedLabelColor2, obj48, unfocusedLabelColor2, obj50, disabledLabelColor2, i18);
    }
    ...
    public final androidx.compose.material3.TextFieldColors textFieldColors-St-qZLY(long textColor, long disabledTextColor, long containerColor, long cursorColor, long errorCursorColor, TextSelectionColors selectionColors, long focusedIndicatorColor, long unfocusedIndicatorColor, long disabledIndicatorColor, long errorIndicatorColor, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long placeholderColor, long disabledPlaceholderColor, Composer $composer, int $changed, int $changed1, int $changed2, int i29) {
        ...
        if (i13 & 8 != 0) {
            l3 = textFieldDisabledActiveIndicatorOpacity;
        } else {
            l3 = focusedIndicatorColor;
        }
        if (i13 & 16 != 0) {
            l19 = textFieldDisabledActiveIndicatorOpacity;
        } else {
            l19 = disabledIndicatorColor;
        }
        if (i13 & 32 != 0) {
        ...
        if (i13 & 64 != 0) {
            ...
            l17 = unfocusedLeadingIconColor;
        }
        if (i13 & 128 != 0) {
            l15 = value7;
        } else {
            l15 = errorLeadingIconColor;
        }
        if (i13 & 256 != 0) {
            l20 = copy-wmQWz5c$default2;
        } else {
            l20 = unfocusedTrailingIconColor;
        }
        if (i13 & 512 != 0) {
            l = value3;
        } else {
        ...
        if (i13 & 4096 != 0) {
            l16 = copy-wmQWz5c$default3;
        } else {
            l16 = disabledPlaceholderColor;
        }
        if (i13 & 8192 != 0) {
            l2 = value6;
        } else {
        ...
        ComposerKt.sourceInformationMarkerEnd(obj134);
        return this.textFieldColors-FD9MK7s(l21, i45, textColor2, i110, disabledTextColor2, textColor2, l21, disabledTextColor2, l25, containerColor2, l25, i114, l25, i118, l25, i121, l3, obj19, l19, obj21, obj, l17, obj24, l15, obj26, l20, i8, l, obj30, l13, obj32, l11, obj34, l16, i2, l2, obj38, l12, obj40, l5, obj42, l9, i9, l4, obj46, l6);
    }
    ...
    public final androidx.compose.material3.TextFieldColors textFieldColors-tN0la-I(long focusedTextColor, long unfocusedTextColor, long disabledTextColor, long errorTextColor, long containerColor, long errorContainerColor, long cursorColor, long errorCursorColor, TextSelectionColors selectionColors, long focusedIndicatorColor, long unfocusedIndicatorColor, long disabledIndicatorColor, long errorIndicatorColor, long focusedLeadingIconColor, long unfocusedLeadingIconColor, long disabledLeadingIconColor, long errorLeadingIconColor, long focusedTrailingIconColor, long unfocusedTrailingIconColor, long disabledTrailingIconColor, long errorTrailingIconColor, long focusedLabelColor, long unfocusedLabelColor, long disabledLabelColor, long errorLabelColor, long focusedPlaceholderColor, long unfocusedPlaceholderColor, long disabledPlaceholderColor, long errorPlaceholderColor, long focusedPrefixColor, long unfocusedPrefixColor, long disabledPrefixColor, long errorPrefixColor, long focusedSuffixColor, long unfocusedSuffixColor, long disabledSuffixColor, long errorSuffixColor, Composer $composer, int $changed, int $changed1, int $changed2, int $changed3, int i43, int i44) {
        ...
        if (i33 & 512 != 0) {
            value2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldFocusActiveIndicatorColor(), composer, 6);
        } else {
            i6 = 6;
            value2 = focusedTrailingIconColor;
        }
        if (i33 & 1024 != 0) {
            l9 = value11;
        } else {
        ...
        if (i33 & 2048 != 0) {
            disabledIndicatorColor3 = Color.copy-wmQWz5c$default(ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldDisabledActiveIndicatorColor(), composer, i6), unfocusedTextColor, FilledAutocompleteTokens.INSTANCE.getTextFieldDisabledActiveIndicatorOpacity(), 0, 0, 0, 14);
        } else {
        ...
        if (i49 &= i33 != 0) {
            ...
            i29 = 6;
            value6 = disabledPrefixColor;
        }
        if (i50 &= i33 != 0) {
            focusedTrailingIconColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldFocusTrailingIconColor(), composer, i29);
        } else {
            focusedTrailingIconColor2 = focusedSuffixColor;
        }
        if (i51 &= i33 != 0) {
            unfocusedTrailingIconColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldTrailingIconColor(), composer, i29);
        } else {
            unfocusedTrailingIconColor2 = disabledSuffixColor;
        }
        if (i52 &= i33 != 0) {
        ...
        if (i53 &= i33 != 0) {
            value12 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getTextFieldErrorTrailingIconColor(), composer, 6);
        } else {
            i21 = 6;
            value12 = $changed1;
        }
        if (i54 &= i33 != 0) {
            focusedLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldFocusLabelTextColor(), composer, i21);
        } else {
            focusedLabelColor2 = $changed3;
        }
        if (i55 &= i33 != 0) {
            unfocusedLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldLabelTextColor(), composer, i21);
        } else {
            unfocusedLabelColor2 = i44;
        }
        if (i56 &= i33 != 0) {
            disabledLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldDisabledLabelTextColor(), composer, i21);
        } else {
            disabledLabelColor2 = obj132;
        }
        if (i57 &= i33 != 0) {
            errorLabelColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldErrorLabelTextColor(), composer, i21);
        } else {
            errorLabelColor2 = obj134;
        }
        if (i58 &= i33 != 0) {
            focusedPlaceholderColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i21);
        } else {
            focusedPlaceholderColor2 = obj136;
        }
        if (i59 &= i33 != 0) {
            unfocusedPlaceholderColor2 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, i21);
        } else {
            unfocusedPlaceholderColor2 = obj138;
        }
        if (i60 &= i33 != 0) {
        ...
        if (i61 &= i33 != 0) {
            value10 = ColorSchemeKt.getValue(FilledAutocompleteTokens.INSTANCE.getFieldSupportingTextColor(), composer, 6);
        } else {
            fieldDisabledSupportingTextOpacity = 6;
            value10 = obj142;
        }
        ...
        ComposerKt.sourceInformationMarkerEnd(obj160);
        return this.textFieldColors-FD9MK7s(focusedTextColor2, i45, unfocusedTextColor2, i160, disabledTextColor2, focusedTextColor2, errorTextColor2, unfocusedTextColor2, l16, disabledTextColor2, containerColor2, errorTextColor2, l16, containerColor2, errorContainerColor2, errorContainerColor2, cursorColor2, cursorColor2, errorCursorColor2, errorCursorColor2, selectionColors2, value2, i16, l9, i163, obj88, obj28, value3, obj30, focusedLeadingIconColor2, i30, unfocusedLeadingIconColor2, i15, l11, obj36, value6, i5, focusedTrailingIconColor2, obj40, unfocusedTrailingIconColor2, obj42, l8, obj44, value12, i25, focusedLabelColor2);
    }
}
