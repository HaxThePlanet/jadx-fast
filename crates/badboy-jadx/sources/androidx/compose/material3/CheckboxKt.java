...
public final class CheckboxKt {
    ...
    public static final void Checkbox(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, androidx.compose.material3.CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, int $changed, int i9) {
        ...
        if (i9 & 1 != 0) {
            ...
            if (i27 & 6 == 0) {
                i10 = restartGroup.changed(z2) ? 4 : 2;
                $dirty2 |= i10;
            }
        }
        rememberedValue = 32;
        if (i9 & 2 != 0) {
            ...
            if (i27 & 48 == 0) {
                i8 = restartGroup.changedInstance(obj6) ? rememberedValue : 16;
                $dirty2 |= i8;
            }
        }
        companion = i9 & 4;
        ...
        if (i37 &= $dirty2 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty2, -1, "androidx.compose.material3.Checkbox (Checkbox.kt:98)");
                }
                ...
                if (obj6 != null) {
                    ...
                    int i25 = 1;
                    i = $dirty2 & 112 == rememberedValue ? i25 : i6;
                    if ($dirty2 & 14 == 4) {
                        i6 = i25;
                    }
                    i |= i6;
                ...
                CheckboxKt.TriStateCheckbox(ToggleableStateKt.ToggleableState(z2), obj2, enabled2, colors2, i7, obj5, restartGroup, i19 | i24, 0);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new CheckboxKt.Checkbox.2(z2, obj6, $dirty, z, obj3, obj4, i27, i9);
    ...
    private static final void CheckboxImpl(boolean enabled, ToggleableState value, Modifier modifier, androidx.compose.material3.CheckboxColors colors, Composer $composer, int $changed) {
        ...
        rememberedValue = 2;
        if (i13 & 6 == 0) {
            i18 = restartGroup.changed(z) ? 4 : rememberedValue;
            $dirty |= i18;
        }
        if (i13 & 48 == 0) {
        ...
        if (i13 & 384 == 0) {
            i14 = restartGroup.changed(obj4) ? 256 : 128;
            $dirty |= i14;
        }
        if (i13 & 3072 == 0) {
            i7 = restartGroup.changed(obj5) ? 2048 : 1024;
            $dirty |= i7;
        }
        final int i105 = $dirty;
        if (i105 & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    $this$animateValue$iv$iv = $this$animateValue$iv$iv2;
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                $dirty2 = obj5.checkmarkColor$material3_release(obj3, restartGroup, i54 |= i62);
                ...
                if (i97 |= changed9 == 0) {
                    ...
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        anon = new CheckboxKt.CheckboxImpl.1.1(boxColor$material3_release, borderColor$material3_release, $dirty2, checkDrawFraction, state5, (CheckDrawingCache)$i$a$CacheCheckboxKt$CheckboxImpl$checkCache$1);
    ...
    public static final void TriStateCheckbox(ToggleableState state, Function0<Unit> onClick, Modifier modifier, boolean enabled, androidx.compose.material3.CheckboxColors colors, MutableInteractionSource interactionSource, Composer $composer, int $changed, int i9) {
        ...
        if (i33 &= $dirty2 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                if (onClick != null) {
                    ...
                    z = $dirty;
                    $dirty = $dirty2;
                    companion = ToggleableKt.triStateToggleable-O2vRcR0((Modifier)Modifier.Companion, obj, obj2, RippleKt.rippleOrFallbackImplementation-9IZ8Weo(false, Dp.constructor-impl(stateLayerSize-D9Ej5fM / f), 0, interactionSource2, restartGroup, 54), $dirty, Role.box-impl(Role.Companion.getCheckbox-o7Vup1c()), onClick);
                ...
                Object obj9 = obj4;
                CheckboxKt.CheckboxImpl($dirty2, state, PaddingKt.padding-3ABfNKs(obj6.then(minimumInteractiveComponentSize).then(companion), CheckboxKt.CheckboxDefaultPadding), obj9, restartGroup, i13 | i20);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj7 = obj9;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            companion = new CheckboxKt.TriStateCheckbox.1(state, onClick, obj3, colors2, obj7, obj5, i24, i9);
