...
public final class CutCornerShape extends androidx.compose.foundation.shape.CornerBasedShape {
    ...
    public Outline createOutline-LjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        float height-impl;
        int i11 = 0;
        i7 = Float.compare(i10, i11) == 0 ? 1 : 0;
        if (i7 != 0) {
            ...
            path = path2;
            i4 = 0;
            i3 = obj14 == LayoutDirection.Ltr ? topEnd : bottomEnd;
            path.moveTo(i11, i3);
            path.lineTo(i3, i11);
            i = obj14 == LayoutDirection.Ltr ? bottomEnd : topEnd;
            path.lineTo(width-impl -= i, i11);
            path.lineTo(Size.getWidth-impl(size), i);
            i5 = obj14 == LayoutDirection.Ltr ? bottomStart : layoutDirection;
            path.lineTo(Size.getWidth-impl(size), height-impl4 -= i5);
            path.lineTo(width-impl4 -= i5, Size.getHeight-impl(size));
            i6 = obj14 == LayoutDirection.Ltr ? layoutDirection : bottomStart;
            path.lineTo(i6, Size.getHeight-impl(size));
            path.lineTo(i11, height-impl3 -= i6);
            path.close();
