...
final class LazyStaggeredGridItemProviderImpl implements androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridItemProvider {
    ...
    public void Item(int index, Object key, Composer $composer, int $changed) {
        ...
        if ($changed & 384 == 0) {
            i = restartGroup.changed(this) ? 256 : 128;
            obj10 |= i;
        }
        if (obj10 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(i6, obj10, -1, "androidx.compose.foundation.lazy.staggeredgrid.LazyStaggeredGridItemProviderImpl.Item (LazyStaggeredGridItemProvider.kt:76)");
                }
                LazyStaggeredGridItemProviderImpl.Item.1 anon = new LazyStaggeredGridItemProviderImpl.Item.1(this, index);
                LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedItems$foundation_release(), (Function2)ComposableLambdaKt.rememberComposableLambda(608834466, true, anon, restartGroup, 54), restartGroup, i6 | i11);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (obj8 != null) {
            obj9 = new LazyStaggeredGridItemProviderImpl.Item.2(this, i3, obj, $changed);
