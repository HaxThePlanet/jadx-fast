...
public interface LazyGridPrefetchStrategy {
    ...
    public abstract void onScroll(androidx.compose.foundation.lazy.grid.LazyGridPrefetchScope lazyGridPrefetchScope, float f2, androidx.compose.foundation.lazy.grid.LazyGridLayoutInfo lazyGridLayoutInfo3);

    public abstract void onVisibleItemsUpdated(androidx.compose.foundation.lazy.grid.LazyGridPrefetchScope lazyGridPrefetchScope, androidx.compose.foundation.lazy.grid.LazyGridLayoutInfo lazyGridLayoutInfo2);
}
