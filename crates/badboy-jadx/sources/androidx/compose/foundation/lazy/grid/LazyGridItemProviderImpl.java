...
final class LazyGridItemProviderImpl implements androidx.compose.foundation.lazy.grid.LazyGridItemProvider {
    ...
    public void Item(int index, Object key, Composer $composer, int $changed) {
        ...
        if (obj10 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(i3, obj10, -1, "androidx.compose.foundation.lazy.grid.LazyGridItemProviderImpl.Item (LazyGridItemProvider.kt:74)");
                }
                LazyGridItemProviderImpl.Item.1 anon = new LazyGridItemProviderImpl.Item.1(this, index);
                LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedItems$foundation_release(), (Function2)ComposableLambdaKt.rememberComposableLambda(726189336, true, anon, restartGroup, 54), restartGroup, i3 | i11);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (obj8 != null) {
            obj9 = new LazyGridItemProviderImpl.Item.2(this, i6, obj, $changed);
