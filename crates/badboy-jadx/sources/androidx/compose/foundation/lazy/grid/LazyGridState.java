...
public final class LazyGridState implements ScrollableState {
        ...
        if (i2 == 0) {
            ...
            if (Float.compare(f2, i7) > 0) {
                ...
                if ((LazyGridMeasureResult)value.tryToApplyScrollWithoutRemeasure(MathKt.roundToInt(this.scrollToBeConsumed))) {
                    applyMeasureResult$foundation_release(value, i);
    ...
    public final void requestScrollToItem(int index, int scrollOffset) {
        ...
        if (isScrollInProgress()) {
            i4 = 0;
            scrollInProgress = new LazyGridState.requestScrollToItem.1(this, i4);
            BuildersKt.launch$default((LazyGridMeasureResult)this.layoutInfoState.getValue().getCoroutineScope(), i4, 0, (Function2)scrollInProgress, 3, 0);
        }
