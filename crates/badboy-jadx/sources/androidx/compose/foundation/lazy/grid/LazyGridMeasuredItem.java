...
public final class LazyGridMeasuredItem implements androidx.compose.foundation.lazy.grid.LazyGridItemInfo, LazyLayoutMeasuredItem {
    ...
    private LazyGridMeasuredItem(int index, Object key, boolean isVertical, int crossAxisSize, int mainAxisSpacing, boolean reverseLayout, LayoutDirection layoutDirection, int beforeContentPadding, int afterContentPadding, List<? extends Placeable> placeables, long visualOffset, Object contentType, LazyLayoutItemAnimator<androidx.compose.foundation.lazy.grid.LazyGridMeasuredItem> animator, long constraints, int lane, int span) {
        ...
        while (index$iv < obj.placeables.size()) {
            ...
            height = (Placeable)i2.getWidth();
            maxMainAxis = Math.max(maxMainAxis, height);
            index$iv++;
            maxMainAxis2 = list;
            height = i2.getHeight();
        }
        List $this$fastForEach$iv2 = maxMainAxis2;
        obj.mainAxisSize = maxMainAxis;
        obj.mainAxisSizeWithSpacings = RangesKt.coerceAtLeast(maxMainAxis + mainAxisSpacing, 0);
        if (obj.isVertical()) {
    ...
    public final void applyScrollDelta(int delta) {
        ...
        while (i6 < getPlaceablesCount()) {
            i3 = 0;
            it2 = this.animator.getAnimation(getKey(), i6);
            if (it2 != 0) {
            }
            i6++;
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        if (i6 == 0) {
            ...
            i8 = mainAxisSize;
            while (i8 < obj.getPlaceablesCount()) {
                i9 = i8;
                i2 = 0;
                i6 = obj.placeables.get(i9);
                mainAxisSize = obj.getMainAxisSize((Placeable)i6);
                i4 = minMainAxisOffset - mainAxisSize;
                maxMainAxisOffset = obj.maxMainAxisOffset;
                offset3 = obj.getOffset-nOcc-ac();
                LazyLayoutItemAnimation animation2 = obj.animator.getAnimation(obj.getKey(), i9);
                int i13 = 0;
                if (animation2 != null) {
                } else {
                }
                ...
                layer3 = layer2;
                offset2 = offset3;
                offset = IntOffset.plus-qkQi6aY(offset3, mainAxisSize);
                if (animation2 == null) {
                } else {
                }
                ...
                Placeable.PlacementScope.placeRelativeWithLayer-aW-9-wM$default($this$place_u24lambda_u247, i6, offset, mainAxisSize, 0, 0, 6);
                i8++;
                Placeable.PlacementScope.placeRelativeWithLayer-aW-9-wM$default($this$place_u24lambda_u247, i6, offset, mainAxisSize, layer3, 0, 4);
                if (layer3 != null) {
                } else {
                }
                $this$place_u24lambda_u2472 = animation2;
                Placeable.PlacementScope.placeWithLayer-aW-9-wM$default($this$place_u24lambda_u2473, i6, offset, mainAxisSize, 0, 0, 6);
                $this$place_u24lambda_u2472 = animation2;
                Placeable.PlacementScope.placeWithLayer-aW-9-wM$default($this$place_u24lambda_u2473, i6, offset, mainAxisSize, layer3, 0, 4);
                layer = offset3;
                i7 = this;
                i3 = 0;
                if (i7.isVertical()) {
                ...
                offset3 = IntOffsetKt.IntOffset(layer2, y-impl);
                i = 0;
                offset2 = offset3;
                i12 -= mainAxisSize;
                layer3 = layer2;
                layer2 = x-impl;
                plus-qkQi6aY = IntOffset.plus-qkQi6aY(offset3, mainAxisSize);
                $this$place_u24lambda_u2473 = $this$place_u24lambda_u247;
                if (obj.getMainAxis--gyyYBs(offset3) <= i4) {
                } else {
                }
                if (obj.getMainAxis--gyyYBs(offset3) >= maxMainAxisOffset && obj.getMainAxis--gyyYBs(plus-qkQi6aY) >= maxMainAxisOffset) {
                }
                offset3 = plus-qkQi6aY;
                layer2 = animation2.getLayer();
                if (obj.getMainAxis--gyyYBs(plus-qkQi6aY) >= maxMainAxisOffset) {
                }
                animation2.cancelPlacementAnimation();
                if (obj.getMainAxis--gyyYBs(plus-qkQi6aY) > i4) {
                } else {
                }
            }
        }
