...
public final class LazyListMeasuredItem implements androidx.compose.foundation.lazy.LazyListItemInfo, LazyLayoutMeasuredItem {
    ...
    public final void applyScrollDelta(int delta, boolean updateAnimations) {
        ...
        i = i5;
        while (i < placeableOffsets.length) {
            i3 = i;
            animation = 0;
            if (isVertical()) {
            } else {
            }
            if (!isVertical() && i3 % 2 == 0) {
            }
            i++;
            if (i3 % 2 == 0) {
            }
            $this$copy_u2d4Tuh3kE$iv = this.placeableOffsets;
            $this$copy_u2d4Tuh3kE$iv[i3] = i7 += delta;
            if (i3 % 2 != 1) {
            } else {
            }
        }
        if (updateAnimations) {
            while (i5 < getPlaceablesCount()) {
                i3 = 0;
                animation = this.animator.getAnimation(getKey(), i5);
                if (animation != null) {
                }
                i5++;
    ...
    public final void place(Placeable.PlacementScope scope, boolean isLookingAhead) {
        int $this$place_u24lambda_u2410;
        ...
        LazyLayoutItemAnimation $this$place_u24lambda_u24102;
        ...
        long offset3;
        final Object obj = this;
        $this$place_u24lambda_u2410 = scope;
        final int i12 = 0;
        mainAxisSize = 0;
        ...
        if (i5 == 0) {
            ...
            while (i4 < obj.getPlaceablesCount()) {
                i3 = i4;
                i2 = 0;
                i5 = obj.placeables.get(i3);
                mainAxisSize = obj.getMainAxisSize((Placeable)i5);
                i7 = minMainAxisOffset - mainAxisSize;
                maxMainAxisOffset = obj.maxMainAxisOffset;
                targetOffset = obj.getOffset-Bjo55l4(i3);
                LazyLayoutItemAnimation animation2 = obj.animator.getAnimation(obj.getKey(), i3);
                int i11 = 0;
                if (animation2 != null) {
                } else {
                }
                $this$place_u24lambda_u24103 = $this$place_u24lambda_u2410;
                ...
                $this$place_u24lambda_u2410 = $this$place_u24lambda_u24103;
                $this$place_u24lambda_u24102 = animation2;
                if (layer2 != null) {
                } else {
                }
                Placeable.PlacementScope.placeRelativeWithLayer-aW-9-wM$default($this$place_u24lambda_u2410, i5, offset, mainAxisSize, 0, 0, 6);
                i4++;
                Placeable.PlacementScope.placeRelativeWithLayer-aW-9-wM$default($this$place_u24lambda_u2410, i5, offset, mainAxisSize, layer2, 0, 4);
                if (layer2 != null) {
                } else {
                }
                $this$place_u24lambda_u24102 = animation2;
                Placeable.PlacementScope.placeWithLayer-aW-9-wM$default($this$place_u24lambda_u24103, i5, offset, mainAxisSize, 0, 0, 6);
                $this$place_u24lambda_u24102 = animation2;
                Placeable.PlacementScope.placeWithLayer-aW-9-wM$default($this$place_u24lambda_u24103, i5, offset, mainAxisSize, layer2, 0, 4);
                if (animation2 == null) {
                } else {
                }
                ...
                targetOffset = IntOffsetKt.IntOffset(layer3, y-impl);
                i = 0;
                offset3 = targetOffset;
                i10 -= mainAxisSize;
                layer2 = layer3;
                ...
                $this$place_u24lambda_u24103 = $this$place_u24lambda_u2410;
                if (obj.getMainAxis--gyyYBs(lookaheadOffset-nOcc-ac) <= i7) {
                } else {
                }
                ...
                if (obj.getMainAxis--gyyYBs(plus-qkQi6aY) > i7) {
                } else {
                }
        ...
        int i9 = 0;
        IllegalArgumentException $i$a$RequireLazyListMeasuredItem$place$1$1 = new IllegalArgumentException("position() should be called first".toString());
        throw $i$a$RequireLazyListMeasuredItem$place$1$1;
    }
    ...
    public final void position(int mainAxisOffset, int layoutWidth, int layoutHeight) {
        ...
        i2 = mainAxisOffset;
        obj3.offset = i2;
        i7 = obj3.isVertical() ? layoutHeight : layoutWidth;
        obj3.mainAxisLayoutSize = i7;
        ...
        while (index$iv < placeables.size()) {
            ...
            obj3.placeableOffsets[i3 + 1] = verticalAlignment.align((Placeable)obj.getHeight(), layoutHeight);
            mainAxisOffset2 += height;
            index$iv++;
            i2 = mainAxisOffset;
            Alignment.Horizontal horizontalAlignment = obj3.horizontalAlignment;
            obj3.placeableOffsets[i3] = horizontalAlignment.align(obj.getWidth(), layoutWidth, obj3.layoutDirection);
