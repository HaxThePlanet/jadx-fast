...
public final class AndroidPrefetchScheduler implements androidx.compose.foundation.lazy.layout.PrefetchScheduler, RememberObserver, Runnable, Choreographer.FrameCallback {
    ...
    public static final class Companion {
        ...
        private final void calculateFrameIntervalIfNeeded(View view) {
            int display;
            int refreshRate;
            boolean refreshRate2;
            int i;
            int cmp;
            display = view.getDisplay();
            refreshRate = 1114636288;
            refreshRate2 = display.getRefreshRate();
            if (Long.compare(l, i) == 0 && !view.isInEditMode() && display != null && Float.compare(refreshRate2, i3) >= 0) {
                display = view.getDisplay();
                refreshRate = 1114636288;
                if (!view.isInEditMode()) {
                    if (display != null) {
                        refreshRate2 = display.getRefreshRate();
                        if (Float.compare(refreshRate2, i3) >= 0) {
