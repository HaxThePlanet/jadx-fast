...
public interface LazyLayoutAnimateScrollScope {
    ...
    public abstract int getLastVisibleItemIndex();

    public abstract Object scroll(Function2<? super ScrollScope, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation2);

    public abstract void snapToItem(ScrollScope scrollScope, int i2, int i3);
}
