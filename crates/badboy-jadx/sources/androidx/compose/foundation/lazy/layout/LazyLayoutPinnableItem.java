...
final class LazyLayoutPinnableItem implements PinnableContainer, PinnableContainer.PinnedHandle, androidx.compose.foundation.lazy.layout.LazyLayoutPinnedItemList.PinnedItem {
    ...
    public void release() {
        ...
        int i2 = 0;
        IllegalStateException $i$a$CheckLazyLayoutPinnableItem$release$1 = new IllegalStateException("Release should only be called once".toString());
        throw $i$a$CheckLazyLayoutPinnableItem$release$1;
    }
