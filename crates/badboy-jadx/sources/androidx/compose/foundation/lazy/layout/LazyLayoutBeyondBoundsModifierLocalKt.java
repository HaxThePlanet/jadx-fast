        ...
        if (!enabled) {
            ...
            if (i18 |= i7 == 0) {
                if (rememberedValue == Composer.Companion.getEmpty()) {
                    i6 = 0;
                    lazyLayoutBeyondBoundsModifierLocal = new LazyLayoutBeyondBoundsModifierLocal(obj2, obj3, z, obj, traceInProgress);
