...
final class BringIntoViewRequesterImpl implements androidx.compose.foundation.relocation.BringIntoViewRequester {
    ...
    public Object bringIntoView(Rect rect, Continuation<? super Unit> continuation2) {
        ...
        if (continuation2 instanceof BringIntoViewRequesterImpl.bringIntoView.1 && label &= i2 != 0) {
            anon = continuation2;
            i2 = Integer.MIN_VALUE;
            if (label &= i2 != 0) {
                anon.label = obj13 -= i2;
        ...
        anon.I$1 = i$iv3;
        anon.label = i4;
        if (ScrollIntoView.scrollIntoView((DelegatableNode)(BringIntoViewRequesterNode)i$iv2[i$iv3], l$0, anon) != cOROUTINE_SUSPENDED) {
            _this = i3;
        }
