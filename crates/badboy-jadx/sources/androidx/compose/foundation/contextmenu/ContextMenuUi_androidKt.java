...
public final class ContextMenuUi_androidKt {
    ...
    public static final void ContextMenuItem(String label, boolean enabled, androidx.compose.foundation.contextmenu.ContextMenuColors colors, Modifier modifier, Function3<? super Color, ? super Composer, ? super Integer, Unit> leadingIcon, Function0<Unit> onClick, Composer $composer, int $changed, int i9) {
        ...
        if (i9 & 1 != 0) {
            ...
            if (i25 & 6 == 0) {
                i32 = restartGroup.changed(label) ? 4 : 2;
                $dirty |= i32;
            } else {
                factory$iv$iv$iv = label;
            }
        ...
        if (i9 & 2 != 0) {
            ...
            if (i25 & 48 == 0) {
                i26 = restartGroup.changed(weight) ? i61 : 16;
                $dirty |= i26;
            }
        }
        if (i9 & 4 != 0) {
            ...
            if (i25 & 384 == 0) {
                i35 = restartGroup.changed(colors) ? 256 : 128;
                $dirty |= i35;
            } else {
                obj = colors;
            }
        ...
        if (i3 != 0) {
            ...
            if (i25 & 24576 == 0) {
                i29 = restartGroup.changedInstance(leadingIcon) ? 16384 : 8192;
                $dirty |= i29;
            } else {
                $composer2 = leadingIcon;
            }
        ...
        if (i9 & 32 != 0) {
            ...
            if (i25 & i4 == 0) {
                i33 = restartGroup.changedInstance(obj2) ? i15 : 65536;
                $dirty |= i33;
            }
        }
        ...
        if ($dirty2 &= localMap$iv$iv == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                i = i3 != 0 ? i31 : $composer2;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, localMap$iv$iv, -1, "androidx.compose.foundation.contextmenu.ContextMenuItem (ContextMenuUi.android.kt:181)");
                }
                ComposerKt.sourceInformationMarkerStart(restartGroup, -1814201532, "CC(remember):ContextMenuUi.android.kt#9igjgp");
                i5 = localMap$iv$iv & 112 == i61 ? 1 : 0;
                i17 = i62 &= localMap$iv$iv == i15 ? 1 : 0;
                ...
                ComposerKt.sourceInformationMarkerStart(restartGroup, -1323940314, currentCompositeKeyHash);
                ...
                if (!composer.getInserting()) {
                    ...
                    if (!Intrinsics.areEqual(composer.rememberedValue(), Integer.valueOf(currentCompositeKeyHash2))) {
                        composer.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash2));
                ...
                if (i == null) {
                    ...
                    composer6 = valueOf2;
                    i36 = $i$a$LayoutBoxKt$Box$1$iv;
                    i22 = materializeModifier;
                    i23 = i3;
                } else {
                    ...
                    i34 = 0;
                    alignment = topStart;
                    ComposerKt.sourceInformationMarkerStart(composer9, -1323940314, currentCompositeKeyHash);
                    currentCompositeKeyHash = ComposablesKt.getCurrentCompositeKeyHash(composer9, 0);
                    currentCompositionLocalMap = composer9.getCurrentCompositionLocalMap();
                    constructor = i55;
                    i22 = materializeModifier;
                    Modifier propagateMinConstraints$iv = modifier7;
                    modifier2 = propagateMinConstraints$iv;
                    ...
                    i38 = i60;
                    $i$a$LayoutBoxKt$Box$1$iv = i11;
                    ComposerKt.sourceInformationMarkerStart($i$a$LayoutBoxKt$Box$1$iv, -1218311042, $composer$iv2);
                    if (enabled) {
                        disabledIconColor-0d7_KjU = obj.getIconColor-0d7_KjU();
                    } else {
                        disabledIconColor-0d7_KjU = obj.getDisabledIconColor-0d7_KjU();
                    }
                    i.invoke(Color.box-impl(disabledIconColor-0d7_KjU), $i$a$LayoutBoxKt$Box$1$iv, 0);
                ...
                if (enabled) {
                    disabledTextColor-0d7_KjU = obj.getTextColor-0d7_KjU();
                } else {
                    disabledTextColor-0d7_KjU = obj.getDisabledTextColor-0d7_KjU();
                }
                skipping = currentCompositionLocalMap2;
                i37 = obj56;
                composer4 = composer9;
                Function0 function02 = function03;
                BasicTextKt.BasicText-VhcvRP8(label, (RowScope)RowScopeInstance.INSTANCE.weight((Modifier)Modifier.Companion, 1065353216, true), ContextMenuSpec.INSTANCE.textStyle-8_81llA(disabledTextColor-0d7_KjU), 0, 0, false, 1, 0, 0, composer4, i54 | i31, 440);
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new ContextMenuUi_androidKt.ContextMenuItem.3(label, enabled, colors, obj4, obj3, obj2, i25, i9);
    ...
    public static final void ContextMenuPopup(PopupPositionProvider popupPositionProvider, Function0<Unit> onDismiss, Modifier modifier, androidx.compose.foundation.contextmenu.ContextMenuColors colors, Function1<? super androidx.compose.foundation.contextmenu.ContextMenuScope, Unit> contextMenuBuilderBlock, Composer $composer, int $changed, int i8) {
        ...
        if (i8 & 1 != 0) {
            ...
            if (i16 & 6 == 0) {
                i2 = restartGroup.changed(popupPositionProvider) ? 4 : 2;
                $dirty2 |= i2;
            }
        }
        if (i8 & 2 != 0) {
        ...
        if (i8 & 8 != 0) {
            ...
            if (i16 & 3072 == 0) {
                i7 = restartGroup.changed(obj3) ? 2048 : 1024;
                $dirty2 |= i7;
            }
        }
        if (i8 & 16 != 0) {
            ...
            if (i16 & 24576 == 0) {
                i9 = restartGroup.changedInstance(obj4) ? 16384 : 8192;
                $dirty2 |= i9;
            }
        }
        ...
        if (i18 & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                ContextMenuUi_androidKt.ContextMenuPopup.2 anon = new ContextMenuUi_androidKt.ContextMenuPopup.2(obj3, $dirty, obj4);
                AndroidPopup_androidKt.Popup(popupPositionProvider, obj, ContextMenuUi_androidKt.DefaultPopupProperties, (Function2)ComposableLambdaKt.rememberComposableLambda(795909757, true, anon, restartGroup, 54), restartGroup, i12 | i6, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                str = $dirty;
    ...
    public static final void ContextMenuPopup(PopupPositionProvider popupPositionProvider, Function0<Unit> onDismiss, Modifier modifier, Function1<? super androidx.compose.foundation.contextmenu.ContextMenuScope, Unit> contextMenuBuilderBlock, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 8 != 0) {
            $dirty2 |= 3072;
            obj6 = contextMenuBuilderBlock;
        } else {
            if (i21 & 3072 == 0) {
                i3 = restartGroup.changedInstance(contextMenuBuilderBlock) ? 2048 : 1024;
                $dirty2 |= i3;
            } else {
                obj6 = contextMenuBuilderBlock;
            }
        ...
        if (i22 & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                ...
                int i9 = 0;
                ContextMenuUi_androidKt.ContextMenuPopup(popupPositionProvider, obj3, obj, ContextMenuUi_androidKt.computeContextMenuColors(i9, i9, restartGroup, i9, 3), obj6, restartGroup, i12 | $dirty, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj5 = obj;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new ContextMenuUi_androidKt.ContextMenuPopup.1(popupPositionProvider, onDismiss, obj5, contextMenuBuilderBlock, i21, i7);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    public static final androidx.compose.foundation.contextmenu.ContextMenuColors computeContextMenuColors(int backgroundStyleId, int foregroundStyleId, Composer $composer, int $changed, int i5) {
        ...
        if (changed |= changed2 == 0) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                ...
                contextMenuColors = new ContextMenuColors(ContextMenuUi_androidKt.resolveColor-g2O1Hgs(this_$iv, backgroundStyleId2, i2, ContextMenuUi_androidKt.DefaultContextMenuColors.getBackgroundColor-0d7_KjU()), obj16, enabledColor-4WTKRHQ, obj18, enabledColor-4WTKRHQ, obj20, disabledColor-4WTKRHQ, obj22, disabledColor-4WTKRHQ, obj24, 0);
