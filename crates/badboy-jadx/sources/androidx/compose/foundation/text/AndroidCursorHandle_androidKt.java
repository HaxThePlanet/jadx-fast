    ...
    public static final void CursorHandle-USBMPiE(OffsetProvider offsetProvider, Modifier modifier, long minTouchTargetSize, Composer $composer, int $changed, int i6) {
        ...
        if (obj24 & 1 != 0) {
            ...
            if (i13 & 6 == 0) {
                ...
                i8 = changedInstance != null ? rememberComposableLambda : 2;
                $dirty2 |= i8;
            }
        }
        if (obj24 & 2 != 0) {
        ...
        if (i13 & 384 == 0) {
            if (obj24 & 4 == 0) {
                i2 = restartGroup.changed(minTouchTargetSize) ? 256 : 128;
            } else {
        ...
        if ($dirty2 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(semantics$default, $dirty2, -1, "androidx.compose.foundation.text.CursorHandle (AndroidCursorHandle.android.kt:51)");
                }
                ComposerKt.sourceInformationMarkerStart(restartGroup, -533359786, "CC(remember):AndroidCursorHandle.android.kt#9igjgp");
                int i12 = 0;
                int i14 = 1;
                if ($dirty2 & 14 != rememberComposableLambda) {
                    if ($dirty2 & 8 != 0 && restartGroup.changedInstance(obj)) {
        ...
        if (endRestartGroup != null) {
            semantics$default = new AndroidCursorHandle_androidKt.CursorHandle.2(obj, obj2, $dirty, traceInProgress, i13, obj24);
