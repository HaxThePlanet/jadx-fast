...
public final class ClickableTextKt {
    ...
    public static final void ClickableText-03UYbkw(AnnotatedString text, Function1<? super Integer, Unit> onHover, Modifier modifier, TextStyle style, boolean softWrap, int overflow, int maxLines, Function1<? super TextLayoutResult, Unit> onTextLayout, Function1<? super Integer, Unit> onClick, Composer $composer, int $changed, int i12) {
        ...
        if (i65 & 2 != 0) {
            ...
            if (i64 & 48 == 0) {
                i3 = restartGroup.changedInstance(onHover) ? 32 : 16;
                $dirty |= i3;
            }
        }
        str = i65 & 4;
        ...
        if (i59 != 0) {
            ...
            if (i64 & 3072 == 0) {
                i6 = restartGroup.changed(style) ? 2048 : 1024;
                $dirty |= i6;
            } else {
                then = style;
            }
        ...
        if (i17 != 0) {
            ...
            if (i64 & 24576 == 0) {
                i14 = restartGroup.changed(softWrap) ? 16384 : 8192;
                $dirty |= i14;
            } else {
                softWrap2 = softWrap;
            }
        ...
        if (i13 != 0) {
            ...
            if (i64 & i10 == 0) {
                i10 = restartGroup.changed(overflow) ? 131072 : 65536;
                $dirty |= i10;
            } else {
                i5 = overflow;
            }
        ...
        if (i21 != 0) {
            ...
            if (i64 & i4 == 0) {
                i26 = restartGroup.changed(maxLines) ? 1048576 : 524288;
                $dirty |= i26;
            } else {
                i15 = maxLines;
            }
        ...
        if (i2 != 0) {
            ...
            if (i64 & i25 == 0) {
                i11 = restartGroup.changedInstance(onTextLayout) ? 8388608 : 4194304;
                $dirty |= i11;
            } else {
                i9 = onTextLayout;
            }
        ...
        if (i65 & 256 != 0) {
            ...
            if (i64 & i78 == 0) {
                i16 = restartGroup.changedInstance(obj7) ? 67108864 : 33554432;
                $dirty |= i16;
            }
        }
        ...
        if ($dirty2 &= traceInProgress == 38347922) {
            if (!restartGroup.getSkipping()) {
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                i21 = softWrap2;
                BasicTextKt.BasicText-RWo7tUw(obj, obj3.then(pointerInput), i17, (Function1)$i$a$CacheClickableTextKt$ClickableText$5, i13, i21, i15, 0, 0, 0, restartGroup, i39 | i57, 896);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            traceInProgress = new ClickableTextKt.ClickableText.6(text, function1, obj3, obj2, z, i5, i8, anon, $i$a$CacheClickableTextKt$ClickableText$pointerInputModifier$1, i64, i65);
    ...
    public static final void ClickableText-4YKlhWE(AnnotatedString text, Modifier modifier, TextStyle style, boolean softWrap, int overflow, int maxLines, Function1<? super TextLayoutResult, Unit> onTextLayout, Function1<? super Integer, Unit> onClick, Composer $composer, int $changed, int i11) {
        ...
        if (i47 & 1 != 0) {
            ...
            if ($i$a$CacheClickableTextKt$ClickableText$pressIndicator$1 & 6 == 0) {
                i16 = traceInProgress2.changed(text) ? 4 : 2;
                $dirty2 |= i16;
            } else {
                obj = text;
            }
        ...
        if (i28 != 0) {
            ...
            if ($i$a$CacheClickableTextKt$ClickableText$pressIndicator$1 & 48 == 0) {
                i20 = traceInProgress2.changed(modifier) ? 32 : 16;
                $dirty2 |= i20;
            } else {
                obj4 = modifier;
            }
        ...
        if (then != 0) {
            ...
            if ($i$a$CacheClickableTextKt$ClickableText$pressIndicator$1 & 3072 == 0) {
                i13 = traceInProgress2.changed(softWrap) ? 2048 : 1024;
                $dirty2 |= i13;
            } else {
                softWrap2 = softWrap;
            }
        ...
        if (invalid$iv != 0) {
            ...
            if ($i$a$CacheClickableTextKt$ClickableText$pressIndicator$1 & 24576 == 0) {
                i5 = traceInProgress2.changed(overflow) ? 16384 : 8192;
                $dirty2 |= i5;
            } else {
                i3 = overflow;
            }
        ...
        if (i4 != 0) {
            ...
            if ($i$a$CacheClickableTextKt$ClickableText$pressIndicator$1 & i2 == 0) {
                i2 = traceInProgress2.changed(maxLines) ? 131072 : 65536;
                $dirty2 |= i2;
            } else {
                i6 = maxLines;
            }
        ...
        if (i14 != 0) {
            ...
            if ($i$a$CacheClickableTextKt$ClickableText$pressIndicator$1 & i12 == 0) {
                i18 = traceInProgress2.changedInstance(onTextLayout) ? 1048576 : 524288;
                $dirty2 |= i18;
            } else {
                obj3 = onTextLayout;
            }
        ...
        if ($dirty2 & i58 == 4793490) {
            if (!traceInProgress2.getSkipping()) {
                ...
                if (invalid$iv != 0) {
                    i3 = mutableStateOf$default;
                }
                maxLines2 = i4 != 0 ? 0x7fffffff /* Unknown resource */ : i6;
                if (i14 != 0) {
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(-246609449, $dirty2, -1, "androidx.compose.foundation.text.ClickableText (ClickableText.kt:83)");
                }
                ...
                i4 = softWrap2;
                softWrap2 = obj26;
                BasicTextKt.BasicText-RWo7tUw(obj, obj4.then(SuspendingPointerInputFilterKt.pointerInput((Modifier)Modifier.Companion, obj6, (Function2)it$iv)), softWrap2, (Function1)$i$a$CacheClickableTextKt$ClickableText$2, i3, i4, i14, 0, 0, 0, $composer2, i27 | i40, 896);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                anon = onTextLayout2;
        ...
        if (endRestartGroup != null) {
            $dirty = $dirty2;
            mutableStateOf$default = new ClickableTextKt.ClickableText.3(text, obj4, onTextLayout3, z, i3, i21, anon, obj6, $changed, i47);
