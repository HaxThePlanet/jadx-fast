...
public final class InlineTextContentKt {
    ...
    public static final void appendInlineContent(AnnotatedString.Builder $this$appendInlineContent, String id, String alternateText) {
        ...
        int i2 = 0;
        IllegalArgumentException $i$a$RequireInlineTextContentKt$appendInlineContent$1 = new IllegalArgumentException("alternateText can't be an empty string.".toString());
        throw $i$a$RequireInlineTextContentKt$appendInlineContent$1;
    }
