...
final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public VerticalScrollLayoutModifier(androidx.compose.foundation.text.TextFieldScrollerPosition scrollerPosition, int cursorOffset, TransformedText transformedText, Function0<androidx.compose.foundation.text.TextLayoutResultProxy> textLayoutResultProvider) {
        super();
    ...
    public static androidx.compose.foundation.text.VerticalScrollLayoutModifier copy$default(androidx.compose.foundation.text.VerticalScrollLayoutModifier verticalScrollLayoutModifier, androidx.compose.foundation.text.TextFieldScrollerPosition textFieldScrollerPosition2, int i3, TransformedText transformedText4, Function0 function05, int i6, Object object7) {
        androidx.compose.foundation.text.TextFieldScrollerPosition obj1;
        int obj2;
        TransformedText obj3;
        Function0 obj4;
        if (i6 & 1 != 0) {
            obj1 = verticalScrollLayoutModifier.scrollerPosition;
        }
        if (i6 & 2 != 0) {
            obj2 = verticalScrollLayoutModifier.cursorOffset;
        }
        if (i6 & 4 != 0) {
            obj3 = verticalScrollLayoutModifier.transformedText;
        }
        if (i6 &= 8 != 0) {
            obj4 = verticalScrollLayoutModifier.textLayoutResultProvider;
        }
        return verticalScrollLayoutModifier.copy(obj1, obj2, obj3, obj4);
    }
    ...
    public final androidx.compose.foundation.text.VerticalScrollLayoutModifier copy(androidx.compose.foundation.text.TextFieldScrollerPosition textFieldScrollerPosition, int i2, TransformedText transformedText3, Function0<androidx.compose.foundation.text.TextLayoutResultProxy> function04) {
        VerticalScrollLayoutModifier verticalScrollLayoutModifier = new VerticalScrollLayoutModifier(textFieldScrollerPosition, i2, transformedText3, function04);
        return verticalScrollLayoutModifier;
    }
    ...
    public boolean equals(Object object) {
        ...
        final int i2 = 0;
        if (!object instanceof VerticalScrollLayoutModifier) {
            return i2;
        }
        Object obj = object;
    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        VerticalScrollLayoutModifier.measure.1 anon = new VerticalScrollLayoutModifier.measure.1($this$measure_u2d3p2s80s, this, measure-BRTryo0, i7);
        return MeasureScope.layout$default($this$measure_u2d3p2s80s, measure-BRTryo0.getWidth(), i7, 0, (Function1)anon, 4, 0);
    }

    @Override // androidx.compose.ui.layout.LayoutModifier
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        return stringBuilder.append("VerticalScrollLayoutModifier(scrollerPosition=").append(this.scrollerPosition).append(", cursorOffset=").append(this.cursorOffset).append(", transformedText=").append(this.transformedText).append(", textLayoutResultProvider=").append(this.textLayoutResultProvider).append(')').toString();
    }
}
