...
public final class KeyboardOptions {
    ...
    public KeyboardOptions(int i, Boolean boolean2, int i3, int i4, PlatformImeOptions platformImeOptions5, Boolean boolean6, LocaleList localeList7, int i8, DefaultConstructorMarker defaultConstructorMarker9) {
        ...
        i6 = i8 & 16 != 0 ? i7 : platformImeOptions5;
        i5 = i8 & 32 != 0 ? i7 : boolean6;
        if (i8 & 64 != 0) {
        } else {
            i7 = localeList7;
        }
        super(unspecified-IUNYP9k, i2, unspecified-PjHm6EE, unspecified-eUduSuo, i6, i5, i7, 0);
    }
    ...
    public KeyboardOptions(int i, boolean z2, int i3, int i4, PlatformImeOptions platformImeOptions5, Boolean boolean6, LocaleList localeList7, int i8, DefaultConstructorMarker defaultConstructorMarker9) {
        ...
        obj12 = 0;
        i9 = i8 & 16 != 0 ? obj12 : platformImeOptions5;
        i6 = i8 & 32 != 0 ? obj12 : boolean6;
        i7 = i8 & 64 != 0 ? obj12 : localeList7;
        super(i10, z2, i2, i5, i9, i6, i7, 0);
    }
        ...
        if (other != null && !other.isCompletelyUnspecified()) {
            if (!other.isCompletelyUnspecified()) {
                if (Intrinsics.areEqual(other, this)) {
                    ...
                    platformImeOptions2 = platformImeOptions == null ? platformImeOptions : platformImeOptions;
                ...
                KeyboardOptions keyboardOptions = new KeyboardOptions(i3, bool, i, i2, platformImeOptions2, bool2, list, 0);
                return keyboardOptions;
            }
        }
        return this;
    ...
    public int hashCode() {
        ...
        i = 0;
        if (autoCorrectEnabled != null) {
            i2 = autoCorrectEnabled.hashCode();
        } else {
            i2 = i;
        }
