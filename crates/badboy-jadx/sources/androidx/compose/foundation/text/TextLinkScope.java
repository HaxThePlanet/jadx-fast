...
public final class TextLinkScope {
    ...
    private final void StyleAnnotation(Object[] keys, Function1<? super androidx.compose.foundation.text.TextAnnotatorScope, Unit> block, Composer $composer, int $changed) {
        ...
        i3 = 32;
        if ($changed & 48 == 0) {
            i4 = obj13.changedInstance(block) ? i3 : 16;
            $dirty |= i4;
        }
        if ($changed & 384 == 0) {
        ...
        i = i11;
        while (i < keys.length) {
            if (obj13.changedInstance(keys[i])) {
            } else {
            }
            i2 = i11;
            $dirty |= i2;
    ...
    public final void LinksComposables(Composer $composer, int $changed) {
        ...
        i10 = 2;
        if (i24 & 6 == 0) {
            it = restartGroup.changedInstance(obj6) ? 4 : i10;
            $dirty |= it;
        }
        i3 = $dirty;
        if (i3 & 3 == i10) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, i3, -1, "androidx.compose.foundation.text.TextLinkScope.LinksComposables (TextLinkScope.kt:152)");
                }
                int i16 = 0;
                it = 0;
                ComposerKt.sourceInformationMarkerStart(restartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                obj = isPressed$delegate;
                list = linkAnnotations;
                i6 = 0;
                i2 = 0;
                while (i2 < list.size()) {
                    $dirty2 = obj4;
                    i8 = 0;
                    shapeForRange = obj6.shapeForRange((AnnotatedString.Range)$dirty2);
                    ...
                    $dirty3 = 0;
                    i = i14;
                    invalid$iv = new TextLinkScope.LinksComposables.1.1.1(obj6, $dirty2, obj);
                    composer2.updateRememberedValue((Function0)invalid$iv);
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    BoxKt.Box(ClickableKt.combinedClickable-XVZzFYc$default(PointerIconKt.pointerHoverIcon$default(HoverableKt.hoverable$default(obj6.textRange(it, $dirty2.getStart(), $dirty2.getEnd()), (MutableInteractionSource)$this$cache$iv2, i29, $dirty3, i25), PointerIcon.Companion.getHand(), i29, $dirty3, i25), obj2, 0, false, 0, 0, 0, 0, 0, (Function0)invalid$iv, 252, 0), restartGroup, 0);
                    int i20 = 6;
                    collectIsHoveredAsState = HoverInteractionKt.collectIsHoveredAsState((InteractionSource)obj2, restartGroup, i20);
                    State collectIsFocusedAsState = FocusInteractionKt.collectIsFocusedAsState((InteractionSource)obj2, restartGroup, i20);
                    State collectIsPressedAsState = PressInteractionKt.collectIsPressedAsState((InteractionSource)obj2, restartGroup, i20);
                    styles = (LinkAnnotation)$dirty2.getItem().getStyles();
                    if (styles != null) {
                    } else {
                    }
                    spanStyle = 0;
                    focusedStyle = (LinkAnnotation)$dirty2.getItem().getStyles();
                    if (focusedStyle != null) {
                    } else {
                    }
                    spanStyle3 = 0;
                    hoveredStyle = (LinkAnnotation)$dirty2.getItem().getStyles();
                    if (hoveredStyle != null) {
                    } else {
                    }
                    spanStyle4 = 0;
                    pressedStyle = (LinkAnnotation)$dirty2.getItem().getStyles();
                    ...
                    anon = new TextLinkScope.LinksComposables.1.2.1(obj6, $dirty2, state2, isHovered$delegate2, collectIsPressedAsState);
                    ...
                    spanStyle4 = hoveredStyle;
                    spanStyle3 = focusedStyle;
                    spanStyle = styles;
        ...
        if (endRestartGroup != null) {
            $dirty2 = new TextLinkScope.LinksComposables.2(obj6, i24);
