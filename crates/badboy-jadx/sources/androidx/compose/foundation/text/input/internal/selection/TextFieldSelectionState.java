...
public final class TextFieldSelectionState {
    ...
    private final class TextFieldTextDragObserver implements TextDragObserver {
        ...
        public void onDrag-k-4lQ0M(long delta) {
            ...
            if (TextFieldSelectionState.access$getEnabled$p(obj.this$0)) {
                i2 = 0;
                z = (CharSequence)TextFieldSelectionState.access$getTextFieldState$p(obj.this$0).getVisualText().length() == 0 ? i7 : i2;
                if (z != 0) {
                    l = delta;
                } else {
                    ...
                    if (obj.dragBeginOffsetInText < 0 && !TextFieldSelectionState.access$getTextLayoutState$p(obj.this$0).isPositionOnText-k-4lQ0M(plus-MK-Hz9U2)) {
                        if (!TextFieldSelectionState.access$getTextLayoutState$p(obj.this$0).isPositionOnText-k-4lQ0M(plus-MK-Hz9U2)) {
                            ...
                            if (dragBeginOffsetInText2 != 0) {
                                offsetForPosition-3MmeM6k2 = dragBeginOffsetInText2.intValue();
                            } else {
                    ...
                    newSelection = TextFieldSelectionState.updateSelection-SsL-Rf8$default(obj.this$0, TextFieldSelectionState.access$getTextFieldState$p(obj.this$0).getVisualText(), i, i3, false, selectionAdjustment, false, false, 64, 0);
    ...
    private final Object detectCursorHandleDragGestures(PointerInputScope pointerInputScope, Continuation<? super Unit> continuation2) {
        ...
        Object obj2;
        androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectCursorHandleDragGestures.3 anon;
        androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectCursorHandleDragGestures.4 anon2;
        ...
        switch (label2) {
            case 0:
                ...
                TextFieldSelectionState.detectCursorHandleDragGestures.2 anon5 = new TextFieldSelectionState.detectCursorHandleDragGestures.2(obj11, field2, num);
                anon = new TextFieldSelectionState.detectCursorHandleDragGestures.3(obj11, num, field2);
                anon2 = new TextFieldSelectionState.detectCursorHandleDragGestures.4(obj11, num, field2);
                anon3 = new TextFieldSelectionState.detectCursorHandleDragGestures.5(num, field2, obj11);
                field3.L$0 = field2;
                field3.L$1 = obj11;
                field3.L$2 = num;
                field3.label = 1;
        ...
        TextFieldSelectionState.detectCursorHandleDragGestures$onDragStop(obj3, obj11, obj2);
    ...
    private final Object detectSelectionHandleDragGestures(PointerInputScope pointerInputScope, boolean z2, Continuation<? super Unit> continuation3) {
        ...
        androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectSelectionHandleDragGestures.5 anon2;
        ...
        if (obj4 instanceof TextFieldSelectionState.detectSelectionHandleDragGestures.1 && label2 &= num2 != 0) {
            anon = obj4;
            num2 = Integer.MIN_VALUE;
            if (label2 &= num2 != 0) {
                anon.label = label -= num2;
                field = this;
            } else {
                anon = new TextFieldSelectionState.detectSelectionHandleDragGestures.1(this, obj4);
            }
        } else {
        }
        final androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.detectSelectionHandleDragGestures.1 field10 = anon;
        ...
        switch (label3) {
            case 0:
                ...
                int i2 = 1;
                num4 = longRef;
                dragBeginPosition2 = handle4;
                handle2 = i2;
                num4 = longRef;
                dragBeginPosition2 = handle4;
                handle2 = i;
                TextFieldSelectionState.detectSelectionHandleDragGestures.2 anon4 = new TextFieldSelectionState.detectSelectionHandleDragGestures.2(num4, field5, handle2, dragBeginPosition2, longRef2);
                TextFieldSelectionState.detectSelectionHandleDragGestures.3 anon5 = new TextFieldSelectionState.detectSelectionHandleDragGestures.3(num4, field5, longRef2);
                TextFieldSelectionState.detectSelectionHandleDragGestures.4 anon6 = new TextFieldSelectionState.detectSelectionHandleDragGestures.4(num4, field5, longRef2);
                i = i2;
                handle = dragBeginPosition2;
                Ref.LongRef handle5 = num4;
                Ref.LongRef dragBeginPosition3 = longRef2;
                anon2 = new TextFieldSelectionState.detectSelectionHandleDragGestures.5(dragBeginPosition3, field5, handle, handle5, i);
                num3 = dragBeginPosition3;
                dragTotalDistance = handle5;
                dragBeginPosition = handle;
                field10.L$0 = field5;
                field10.L$1 = dragTotalDistance;
                field10.L$2 = num3;
                field10.L$3 = dragBeginPosition;
                field10.label = i2;
                return cOROUTINE_SUSPENDED;
                obj = dragTotalDistance;
                obj5 = field5;
                obj3 = dragBeginPosition;
                obj2 = num3;
                break;
            case 1:
                obj3 = l$3;
        ...
        TextFieldSelectionState.detectSelectionHandleDragGestures.6 anon3 = new TextFieldSelectionState.detectSelectionHandleDragGestures.6(obj5, obj3);
        TextFieldSelectionStateKt.access$logDebug((Function0)anon3);
        if (obj5.getDraggingHandle() == obj3) {
            TextFieldSelectionState.detectSelectionHandleDragGestures$onDragStop$5(obj, obj5, obj2);
        }
        return Unit.INSTANCE;
    }
    ...
    private final Rect getContentRect() {
        ...
        if (textLayoutCoordinates4 != null) {
            ...
            y-impl2 = Offset.getY-impl(textLayoutCoordinates4.localToRoot-MK-Hz9U(OffsetKt.Offset(y-impl, top2)));
        } else {
            y-impl2 = y-impl;
        }
        ...
        if (textLayoutCoordinates5 != null) {
            ...
            y-impl = Offset.getY-impl(textLayoutCoordinates5.localToRoot-MK-Hz9U(OffsetKt.Offset(y-impl, top)));
        } else {
        }
        Rect rect2 = new Rect(Math.min(Offset.getX-impl(localToRoot-MK-Hz9U4), Offset.getX-impl(localToRoot-MK-Hz9U)), Math.min(y-impl2, y-impl), Math.max(Offset.getX-impl(localToRoot-MK-Hz9U4), Offset.getX-impl(localToRoot-MK-Hz9U)), Math.max(Offset.getY-impl(localToRoot-MK-Hz9U4), Offset.getY-impl(localToRoot-MK-Hz9U)));
        return rect2;
    }
    ...
    private final void showTextToolbar(Rect contentRect) {
        ...
        androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.showTextToolbar$$inlined.menuItem.2 field2;
        ...
        int anon;
        androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.showTextToolbar$$inlined.menuItem.1 anon2;
        androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.showTextToolbar$$inlined.menuItem.2 anon3;
        androidx.compose.foundation.text.input.internal.selection.TextFieldSelectionState.showTextToolbar$$inlined.menuItem.3 anon4;
        ...
        if (textToolbar != null) {
            ...
            if (!canCopy()) {
                ...
                anon2 = new TextFieldSelectionState.showTextToolbar$$inlined.menuItem.1(this, TextToolbarState.None, this);
            }
            int i2 = 0;
            if (!canPaste()) {
                anon3 = anon;
            } else {
                anon3 = new TextFieldSelectionState.showTextToolbar$$inlined.menuItem.2(this, TextToolbarState.None, this);
            }
            int i3 = 0;
            if (!canCut()) {
                anon4 = anon;
            } else {
                anon4 = new TextFieldSelectionState.showTextToolbar$$inlined.menuItem.3(this, TextToolbarState.None, this);
            }
            int i4 = 0;
            if (!canSelectAll()) {
            } else {
                anon = new TextFieldSelectionState.showTextToolbar$$inlined.menuItem.4(this, TextToolbarState.Selection, this);
            }
            textToolbar.showMenu(contentRect, anon2, anon3, anon4, anon);
        } else {
    ...
    public final boolean canPaste() {
        ...
        if (clipboardManager2 != null && clipboardManager2.hasText() == i3) {
            i2 = clipboardManager2.hasText() == i3 ? i3 : i;
        } else {
        }
        if (i2 != 0) {
            return i3;
