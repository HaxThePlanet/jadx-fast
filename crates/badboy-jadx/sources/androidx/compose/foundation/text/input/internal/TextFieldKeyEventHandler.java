...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean onKeyEvent-6ptp14s(KeyEvent event, androidx.compose.foundation.text.input.internal.TransformedTextFieldState textFieldState, androidx.compose.foundation.text.input.internal.TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        ...
        TextFieldPreparedSelection field;
        ...
        if (TextFieldKeyInput_androidKt.isTypedEvent-ZmokQxo(mainBuffer$foundation_release) && typedEvent-ZmokQxo != null) {
            ...
            if (typedEvent-ZmokQxo != null) {
                ...
                if (editable) {
                    ...
                    EditCommandKt.commitText(mainBuffer$foundation_release2, StringHelpers_jvmKt.appendCodePointX(stringBuilder, typedEvent-ZmokQxo.intValue()).toString(), selection-d9O1mEE3);
                    TextFieldState.access$commitEditAsUser(field2, TransformedTextFieldState.access$getInputTransformation$p(intValue), fromSoftKeyboard-ZmokQxo ^= selection-d9O1mEE3, TextFieldEditUndoBehavior.MergeIfPossible);
                    obj.preparedSelectionState.resetCachedX();
                    i9 = selection-d9O1mEE3;
                } else {
                }
                return i9;
            }
                ...
                if (!editable) {
                    ...
                    switch (i) {
                        ...
                        case 20:
                            ...
                            it = 1;
                            it = 0;
                            selection-d9O1mEE3 = box-impl;
                            box-impl = TextRange.box-impl(TextRangeKt.TextRange((Number)selection-d9O1mEE3.intValue(), TextRange.getEnd-impl(field13.getSelection-d9O1mEE())));
                            command2 = 0;
                            i2 = 1;
                        ...
                        case 21:
                            ...
                            it = 0;
                            selection-d9O1mEE3 = box-impl;
                            box-impl = TextRange.box-impl(TextRangeKt.TextRange(TextRange.getStart-impl(field13.getSelection-d9O1mEE()), (Number)selection-d9O1mEE3.intValue()));
                            command2 = 0;
                            i2 = 1;
                    ...
                    if (!TextRange.equals-impl0(field.getSelection-d9O1mEE(), command2)) {
                        textFieldState.selectCharsIn-5zc-tL8(field.getSelection-d9O1mEE());
                    } else {
