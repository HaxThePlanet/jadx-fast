...
public final class TextFieldBuffer implements java.lang.Appendable {
    ...
    private final void requireValidIndex(int index, boolean startExclusive, boolean endExclusive) {
        ...
        IllegalArgumentException illegalArgumentException = new IllegalArgumentException(stringBuilder.append("Expected ").append(index).append(" to be in [").append(i2).append(", ").append(length).append(')').toString().toString());
