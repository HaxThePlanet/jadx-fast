...
public final class TransformedTextFieldState {
    ...
    private static final class Companion {
        ...
        private final long mapToTransformed-XGyztTk(long range, androidx.compose.foundation.text.input.internal.OffsetMappingCalculator mapping, androidx.compose.foundation.text.input.internal.SelectionWedgeAffinity wedgeAffinity) {
            ...
            if (TextRange.getReversed-impl(range)) {
                l2 = TextRangeKt.TextRange(i2, i);
            } else {
                l2 = TextRangeKt.TextRange(i, i2);
            }
            if (TextRange.getCollapsed-impl(range) && !TextRange.getCollapsed-impl(l2)) {
                if (!TextRange.getCollapsed-impl(l2)) {
                    ...
                    switch (collapsed-impl) {
                        ...
                        case 1:
                            l = TextRangeKt.TextRange(TextRange.getStart-impl(l2));
                            break;
                        default:
                            l = TextRangeKt.TextRange(TextRange.getEnd-impl(l2));
                    }
                } else {
                }
            } else {
    ...
    public final Object collectImeNotifications(TextFieldState.NotifyImeListener textFieldState$NotifyImeListener, Continuation<?> continuation2) {
        ...
        if (continuation2 instanceof TransformedTextFieldState.collectImeNotifications.1 && label &= i4 != 0) {
            anon2 = continuation2;
            i4 = Integer.MIN_VALUE;
            if (label &= i4 != 0) {
                anon2.label = obj12 -= i4;
            } else {
