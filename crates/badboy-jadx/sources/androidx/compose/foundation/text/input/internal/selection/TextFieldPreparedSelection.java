...
public final class TextFieldPreparedSelection {
    ...
    private final androidx.compose.foundation.text.input.internal.selection.TextFieldPreparedSelection moveCursorNext() {
        ...
        i2 = (CharSequence)TextFieldPreparedSelection.access$getText$p(this).length() > 0 ? adjacentCursorPosition : 0;
        i2 = this;
        i = 0;
    ...
    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        ...
        if (!TextRange.getCollapsed-impl(getSelection-d9O1mEE())) {
            TransformedTextFieldState.replaceText-M8tDOmk$default(TextFieldPreparedSelection.access$getState$p(this), (CharSequence)str2, getSelection-d9O1mEE(), obj6, false, invoke ^ 1, 4);
        } else {
            invoke = block.invoke();
            if ((TextRange)invoke != null) {
                invoke = 0;
                TransformedTextFieldState.replaceText-M8tDOmk$default(TextFieldPreparedSelection.access$getState$p(this), (CharSequence)str2, (TextRange)invoke.unbox-impl(), obj6, false, str2 ^ 1, 4);
            }
        }
    }
    ...
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldPreparedSelection moveCursorNextByParagraph() {
        ...
        i2 = this;
        i = 0;
        paragraphEnd = StringHelpersKt.findParagraphEnd((CharSequence)i2.text, TextRange.getMax-impl(i2.selection));
        if (i2 != 0 && paragraphEnd == TextRange.getMax-impl(i2.selection) && paragraphEnd != i2.text.length()) {
            i2 = this;
            i = 0;
            paragraphEnd = StringHelpersKt.findParagraphEnd((CharSequence)i2.text, TextRange.getMax-impl(i2.selection));
            if (paragraphEnd == TextRange.getMax-impl(i2.selection)) {
                if (paragraphEnd != i2.text.length()) {
                    paragraphEnd = StringHelpersKt.findParagraphEnd((CharSequence)i2.text, paragraphEnd + 1);
                }
            }
            (TextFieldPreparedSelection)(TextFieldPreparedSelection)i2.setCursor(paragraphEnd);
        }
        return this;
    }
    ...
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldPreparedSelection moveCursorPrevByParagraph() {
        ...
        i2 = this;
        i = 0;
        paragraphStart = StringHelpersKt.findParagraphStart((CharSequence)i2.text, TextRange.getMin-impl(i2.selection));
        if (i2 != 0 && paragraphStart == TextRange.getMin-impl(i2.selection) && paragraphStart != 0) {
            i2 = this;
            i = 0;
            paragraphStart = StringHelpersKt.findParagraphStart((CharSequence)i2.text, TextRange.getMin-impl(i2.selection));
            if (paragraphStart == TextRange.getMin-impl(i2.selection)) {
                if (paragraphStart != 0) {
                    paragraphStart = StringHelpersKt.findParagraphStart((CharSequence)i2.text, paragraphStart + -1);
                }
            }
            (TextFieldPreparedSelection)(TextFieldPreparedSelection)i2.setCursor(paragraphStart);
        }
        return this;
    }
    ...
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldPreparedSelection moveCursorUpByLine() {
        ...
        final Object obj = this;
        final int i5 = 0;
        i = (CharSequence)TextFieldPreparedSelection.access$getText$p(obj).length() > 0 ? 1 : 0;
        if (i != 0) {
            i = obj;
            i2 = 0;
            TextLayoutResult textLayoutResult2 = i.textLayoutResult;
            Intrinsics.checkNotNull(textLayoutResult2);
            i.setCursor((TextFieldPreparedSelection)i.jumpByLinesOffset(textLayoutResult2, -1));
        }
        return obj;
    }
    ...
    public final androidx.compose.foundation.text.input.internal.selection.TextFieldPreparedSelection moveCursorUpByPage() {
        ...
        if (i2 != 0) {
            i2 = field;
            i = 0;
            i2.setCursor((TextFieldPreparedSelection)i2.jumpByPagesOffset(-1));
        }
        return field;
    }
