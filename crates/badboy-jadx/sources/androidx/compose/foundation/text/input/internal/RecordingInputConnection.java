...
public final class RecordingInputConnection implements InputConnection {
    ...
    public boolean requestCursorUpdates(int cursorUpdateMode) {
        ...
        if (isActive) {
            ...
            sDK_INT = 0;
            final int i13 = 1;
            i2 = cursorUpdateMode & 1 != 0 ? i13 : sDK_INT;
            i4 = cursorUpdateMode & 2 != 0 ? i13 : sDK_INT;
            if (Build.VERSION.SDK_INT >= 33) {
                i = cursorUpdateMode & 16 != 0 ? i13 : sDK_INT;
                includeInsertionMarker = i;
                i7 = cursorUpdateMode & 8 != 0 ? i13 : sDK_INT;
                includeCharacterBounds = i7;
                i6 = cursorUpdateMode & 4 != 0 ? i13 : sDK_INT;
                int includeEditorBounds2 = i6;
                int i20 = 34;
                        ...
                        if (includeEditorBounds2 == 0) {
                            if (includeLineBounds == 0) {
                                ...
                                if (Build.VERSION.SDK_INT >= i20) {
                                    i3 = includeEditorBounds3;
                                    i5 = includeLineBounds3;
                                    includeEditorBounds = includeInsertionMarker;
                                    includeLineBounds2 = includeCharacterBounds;
                                } else {
                                    i3 = includeEditorBounds3;
                                    i5 = includeLineBounds;
                                    includeEditorBounds = includeInsertionMarker;
                                    includeLineBounds2 = includeCharacterBounds;
                                }
                            } else {
                                i3 = includeEditorBounds2;
                                i5 = includeLineBounds;
                                includeEditorBounds = includeInsertionMarker;
                                includeLineBounds2 = includeCharacterBounds;
                            }
            ...
            this.eventCallback.onRequestCursorAnchorInfo(i2, i4, includeEditorBounds, includeLineBounds2, i3, i5);
            return i13;
        }
        return isActive;
    }
