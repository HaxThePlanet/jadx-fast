...
public final class LegacyCursorAnchorInfoBuilder_androidKt {
    private static final CursorAnchorInfo.Builder addCharacterBounds(CursorAnchorInfo.Builder $this$addCharacterBounds, int startOffset, int endOffset, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Rect innerTextFieldBounds) {
        ...
        while (offset < i3) {
            ...
            if (LegacyCursorAnchorInfoBuilder_androidKt.containsInclusive(rect3, rect4.getLeft(), rect4.getTop())) {
            } else {
            }
            flags |= 2;
            ...
            offset++;
            i = flags;
            if (!LegacyCursorAnchorInfoBuilder_androidKt.containsInclusive(rect3, rect4.getRight(), rect4.getBottom())) {
            }
            flags |= 1;
        }
    ...
    public static final CursorAnchorInfo build(CursorAnchorInfo.Builder $this$build, TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResult textLayoutResult, Matrix matrix, Rect innerTextFieldBounds, Rect decorationBoxBounds, boolean includeInsertionMarker, boolean includeCharacterBounds, boolean includeEditorBounds, boolean includeLineBounds) {
        ...
        if (includeInsertionMarker) {
            LegacyCursorAnchorInfoBuilder_androidKt.setInsertionMarker($this$build, min-impl2, offsetMapping, textLayoutResult, innerTextFieldBounds);
        }
        if (includeCharacterBounds) {
            ...
            if (subSequence != 0) {
                $this$build.setComposingText(i, textFieldValue.getText().subSequence(i, i2));
                LegacyCursorAnchorInfoBuilder_androidKt.addCharacterBounds($this$build, i, i2, offsetMapping, textLayoutResult, innerTextFieldBounds);
            }
        }
    ...
    public static CursorAnchorInfo build$default(CursorAnchorInfo.Builder cursorAnchorInfo$Builder, TextFieldValue textFieldValue2, OffsetMapping offsetMapping3, TextLayoutResult textLayoutResult4, Matrix matrix5, Rect rect6, Rect rect7, boolean z8, boolean z9, boolean z10, boolean z11, int i12, Object object13) {
        int obj8;
        int obj9;
        int obj10;
        int obj11;
        ...
        return LegacyCursorAnchorInfoBuilder_androidKt.build(builder, textFieldValue2, offsetMapping3, textLayoutResult4, matrix5, rect6, rect7, obj8, obj9, obj10, obj11);
    }
