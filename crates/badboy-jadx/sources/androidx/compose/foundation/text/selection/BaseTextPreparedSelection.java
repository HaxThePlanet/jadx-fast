...
public abstract class BaseTextPreparedSelection<T extends androidx.compose.foundation.text.selection.BaseTextPreparedSelection<T>>  {
    ...
    private final T moveCursorNext() {
        ...
        i = this;
        i2 = 0;
        nextCharacterIndex = (BaseTextPreparedSelection)i.getNextCharacterIndex();
        if (i != 0 && nextCharacterIndex != -1) {
            i = this;
            i2 = 0;
            nextCharacterIndex = (BaseTextPreparedSelection)i.getNextCharacterIndex();
            if (nextCharacterIndex != -1) {
                i.setCursor(nextCharacterIndex);
            }
        }
    ...
    private final T moveCursorNextByWord() {
        ...
        i2 = this;
        i3 = 0;
        nextWordOffset = (BaseTextPreparedSelection)i2.getNextWordOffset();
        if (i2 != 0 && nextWordOffset != null) {
            i2 = this;
            i3 = 0;
            nextWordOffset = (BaseTextPreparedSelection)i2.getNextWordOffset();
            if (nextWordOffset != null) {
                i = 0;
                i2.setCursor((Number)nextWordOffset.intValue());
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return (BaseTextPreparedSelection)this;
    ...
    public final T deselect() {
        ...
        if (i2 != 0) {
            i2 = this;
            i = 0;
            (BaseTextPreparedSelection)i2.setCursor(TextRange.getEnd-impl(i2.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return (BaseTextPreparedSelection)this;
    }
    ...
    public final T moveCursorPrevByParagraph() {
        ...
        i2 = this;
        i = 0;
        paragraphStart = StringHelpersKt.findParagraphStart((CharSequence)(BaseTextPreparedSelection)i2.getText$foundation_release(), TextRange.getMin-impl(i2.selection));
        if (i2 != 0 && paragraphStart == TextRange.getMin-impl(i2.selection) && paragraphStart != 0) {
            ...
            if (paragraphStart == TextRange.getMin-impl(i2.selection)) {
                if (paragraphStart != 0) {
                    paragraphStart = StringHelpersKt.findParagraphStart((CharSequence)i2.getText$foundation_release(), paragraphStart + -1);
                }
            }
            i2.setCursor(paragraphStart);
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return (BaseTextPreparedSelection)this;
    }
    ...
    public final T moveCursorToLineEnd() {
        ...
        i3 = this;
        i = 0;
        lineEndByOffset = (BaseTextPreparedSelection)i3.getLineEndByOffset();
        if (i3 != 0 && lineEndByOffset != null) {
            i3 = this;
            i = 0;
            lineEndByOffset = (BaseTextPreparedSelection)i3.getLineEndByOffset();
            if (lineEndByOffset != null) {
                i2 = 0;
                i3.setCursor((Number)lineEndByOffset.intValue());
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return (BaseTextPreparedSelection)this;
    ...
    public final T moveCursorToLineStart() {
        ...
        i = this;
        i2 = 0;
        lineStartByOffset = (BaseTextPreparedSelection)i.getLineStartByOffset();
        if (i != 0 && lineStartByOffset != null) {
            i = this;
            i2 = 0;
            lineStartByOffset = (BaseTextPreparedSelection)i.getLineStartByOffset();
            if (lineStartByOffset != null) {
                i3 = 0;
                i.setCursor((Number)lineStartByOffset.intValue());
            }
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return (BaseTextPreparedSelection)this;
    ...
    public final T selectMovement() {
        ...
        final Object obj = this;
        final int i4 = 0;
        i = (CharSequence)this.getText$foundation_release().length() > 0 ? 1 : 0;
        if (i != 0) {
            i = obj;
            i2 = 0;
            i.selection = TextRangeKt.TextRange(TextRange.getStart-impl(i.originalSelection), TextRange.getEnd-impl(i.selection));
        }
        Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        return (BaseTextPreparedSelection)obj;
    }
