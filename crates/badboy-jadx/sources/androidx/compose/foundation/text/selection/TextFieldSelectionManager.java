...
public final class TextFieldSelectionManager {
            ...
            if (state != 0) {
                ...
                if (layoutCoordinates != null && layoutCoordinates != null) {
                    ...
                    if (layoutCoordinates != null) {
                        localToRoot-MK-Hz9U3 = layoutCoordinates.localToRoot-MK-Hz9U(obj.getHandlePosition-tuRUvjQ$foundation_release(true));
                    } else {
                ...
                if (layoutCoordinates2 != null && layoutCoordinates2 != null) {
                    ...
                    if (layoutCoordinates2 != null) {
                        localToRoot-MK-Hz9U2 = layoutCoordinates2.localToRoot-MK-Hz9U(obj.getHandlePosition-tuRUvjQ$foundation_release(false));
                    } else {
                ...
                if (layoutCoordinates4 != null && layoutCoordinates4 != null) {
                    ...
                    if (layoutCoordinates4 != null) {
                        ...
                        y-impl = Offset.getY-impl(layoutCoordinates4.localToRoot-MK-Hz9U(OffsetKt.Offset(y-impl2, top)));
                    } else {
                        y-impl = y-impl2;
                    }
                } else {
                ...
                if (layoutCoordinates3 != null && layoutCoordinates3 != null) {
                    ...
                    if (layoutCoordinates3 != null) {
                        ...
                        y-impl2 = Offset.getY-impl(layoutCoordinates3.localToRoot-MK-Hz9U(OffsetKt.Offset(y-impl2, top2)));
                    } else {
                    }
                } else {
                }
                final int i8 = 0;
                Rect rect = new Rect(Math.min(Offset.getX-impl(localToRoot-MK-Hz9U3), Offset.getX-impl(localToRoot-MK-Hz9U2)), Math.min(y-impl, y-impl2), Math.max(Offset.getX-impl(localToRoot-MK-Hz9U3), Offset.getX-impl(localToRoot-MK-Hz9U2)), f5 += i2);
                return rect;
            }
        }
    ...
    private final long updateSelection-8UEBfa8(TextFieldValue value, long currentPosition, boolean isStartOfSelection, boolean isStartHandle, androidx.compose.foundation.text.selection.SelectionAdjustment adjustment, boolean isTouchBasedSelection) {
        ...
        int selectionHandleInVisibleBound2;
        long selectionHandleInVisibleBound;
        ...
        if (layoutResult != null) {
            ...
            if (layoutResult == null) {
                ...
                if (TextRange.getReversed-impl(l2) != reversed-impl2) {
                    ...
                    i3 = TextRange.equals-impl0(TextRangeKt.TextRange(TextRange.getEnd-impl(l3), TextRange.getStart-impl(l3)), reversed-impl2) ? selectionHandleInVisibleBound2 : 0;
                } else {
                    $i$a$WithTextFieldSelectionManager$updateSelection$onlyChangeIsReversed$1 = textHandleMove-5zf0vsI;
                    selectionHandleInVisibleBound2 = 1;
                }
                if (TextRange.getCollapsed-impl(l2) && TextRange.getCollapsed-impl(value.getSelection-d9O1mEE())) {
                    i = TextRange.getCollapsed-impl(value.getSelection-d9O1mEE()) ? selectionHandleInVisibleBound2 : 0;
                } else {
                }
                if (z) {
                    selection-d9O1mEE = (CharSequence)value.getText().length() > 0 ? selectionHandleInVisibleBound2 : 0;
                ...
                if (collapsed-impl == null) {
                    ...
                    if (!TextRange.getCollapsed-impl(l2) && TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(obj, selectionHandleInVisibleBound2)) {
                        z = TextFieldSelectionManagerKt.isSelectionHandleInVisibleBound(obj, selectionHandleInVisibleBound2) ? 1 : 0;
                    } else {
                    }
    ...
    public final void deselect-_kEHs6E$foundation_release(Offset position) {
        ...
        if (!TextRange.getCollapsed-impl(getValue$foundation_release().getSelection-d9O1mEE())) {
            ...
            this.onValueChange.invoke(TextFieldValue.copy-3r_uNRQ$default(getValue$foundation_release(), 0, TextRangeKt.TextRange(transformedToOriginal), i3, 0, 5));
        }
    ...
    public final void showSelectionToolbar$foundation_release() {
        ...
        int i2;
        androidx.compose.foundation.text.selection.TextFieldSelectionManager.showSelectionToolbar.copy.1 anon;
        ...
        androidx.compose.foundation.text.selection.TextFieldSelectionManager.showSelectionToolbar.cut.1 field2;
        androidx.compose.foundation.text.selection.TextFieldSelectionManager.showSelectionToolbar.selectAll.1 field3;
        if (getEnabled()) {
            inTouchMode = this.state;
            anon2 = 1;
            i2 = 0;
            if (inTouchMode != null && !inTouchMode.isInTouchMode()) {
                enabled = !inTouchMode.isInTouchMode() ? anon2 : i2;
            } else {
            }
            if (enabled != 0) {
            } else {
                ...
                if (!TextRange.getCollapsed-impl(getValue$foundation_release().getSelection-d9O1mEE()) && !z) {
                    if (!z) {
                        anon = new TextFieldSelectionManager.showSelectionToolbar.copy.1(this);
                    } else {
                        anon = i;
                    }
                } else {
                ...
                if (getEditable()) {
                    clipboardManager = this.clipboardManager;
                    if (clipboardManager != null && clipboardManager.hasText() == anon2) {
                        if (clipboardManager.hasText() == anon2) {
                        } else {
                            anon2 = i2;
                        }
                    } else {
                    ...
                    if (anon2 != 0) {
                        anon2 = new TextFieldSelectionManager.showSelectionToolbar.paste.1(this);
                        field = anon2;
                    } else {
                        field = i;
                    }
                ...
                if (textToolbar != null) {
                    textToolbar.showMenu(getContentRect(), anon, field, field2, field3);
                }
            }
        }
    }
