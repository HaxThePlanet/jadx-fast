...
public final class SelectionManagerKt {
    ...
    public static final Rect getSelectedRegionRect(List<? extends Pair<? extends androidx.compose.foundation.text.selection.Selectable, androidx.compose.foundation.text.selection.Selection>> selectableSubSelectionPairs, LayoutCoordinates containerCoordinates) {
        float f;
        float containerBottom2;
        float containerLeft;
        float containerTop;
        float containerRight;
        long containerBottom;
        int minOffset;
        int offsets;
        int[] iArr;
        int bottom;
        ...
        int i9 = 0;
        containerBottom2 = invertedInfiniteRect2.component4();
        offsets = 0;
        bottom = 0;
        size = selectableSubSelectionPairs.size();
        while (bottom < size) {
            item$iv = containerBottom.get(bottom);
            Object obj = item$iv;
            i = 0;
            ...
            $this$fastForEach$iv = containerBottom;
            i5 = offsets;
            i4 = bottom;
            left2 = size;
            top = item$iv;
            ...
            bottom = i4 + 1;
            f = containerCoordinates;
            containerBottom = $this$fastForEach$iv;
            offsets = i5;
            size = left2;
            ...
            f2 = left;
            boundingBox = item$iv;
            localPositionOf-R5De75A2 = f.localPositionOf-R5De75A(layoutCoordinates, OffsetKt.Offset(left, item$iv));
            localPositionOf-R5De75A = f.localPositionOf-R5De75A(layoutCoordinates, OffsetKt.Offset(subSelection, bottom));
            containerBottom2 = Math.max(containerBottom2, Offset.getY-impl(localPositionOf-R5De75A));
            containerRight = f5;
            containerTop = f4;
            containerLeft = f;
            i11 = iArr2[offsets];
        ...
        Rect rect = new Rect(containerLeft, containerTop, containerRight, containerBottom2);
        return rect;
    }
