...
public final class TextFieldSelectionManagerKt {
    ...
    public static final void TextFieldSelectionHandle(boolean isStartHandle, ResolvedTextDirection direction, androidx.compose.foundation.text.selection.TextFieldSelectionManager manager, Composer $composer, int $changed) {
        ...
        companion = 4;
        if (i24 & 6 == 0) {
            i5 = restartGroup.changed(z) ? companion : 2;
            $dirty2 |= i5;
        }
        if (i24 & 48 == 0) {
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (changedInstance |= i2 == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        empty = 0;
                        anon2 = new TextFieldSelectionManagerKt.TextFieldSelectionHandle.1.1(obj5, z);
                        composer.updateRememberedValue((OffsetProvider)anon2);
                    } else {
                ...
                if (!restartGroup.changedInstance((TextDragObserver)obj)) {
                    if (rememberedValue2 == Composer.Companion.getEmpty()) {
                        ...
                        obj19 = invalid$iv;
                        anon = new TextFieldSelectionManagerKt.TextFieldSelectionHandle.2.1(obj, 0);
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                AndroidSelectionHandles_androidKt.SelectionHandle-pzduO1o(obj19, isStartHandle, obj3, TextRange.getReversed-impl(obj5.getValue$foundation_release().getSelection-d9O1mEE()), 0, companion, SuspendingPointerInputFilterKt.pointerInput((Modifier)companion, obj, (Function2)anon), restartGroup, i15 | i17);
                if (ComposerKt.isTraceInProgress()) {
