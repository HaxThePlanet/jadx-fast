...
public final class SelectionContainerKt {
        ...
        if ($dirty & 3 == str) {
            if (!obj5.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.foundation.text.selection.DisableSelection (SelectionContainer.kt:67)");
                }
    ...
    public static final void SelectionContainer(Modifier modifier, androidx.compose.foundation.text.selection.Selection selection, Function1<? super androidx.compose.foundation.text.selection.Selection, Unit> onSelectionChange, Function2<? super Composer, ? super Integer, Unit> children, Composer $composer, int $changed, int i7) {
        ...
        if (i7 & 2 != 0) {
            ...
            if (i10 & 48 == 0) {
                i8 = restartGroup.changed(obj2) ? 32 : 16;
                $dirty2 |= i8;
            }
        }
        if (i7 & 4 != 0) {
        ...
        if (i7 & 8 != 0) {
            ...
            if (i10 & 3072 == 0) {
                i5 = restartGroup.changedInstance(obj4) ? 2048 : 1024;
                $dirty2 |= i5;
            }
        }
        final int i31 = $dirty2;
        if (i31 & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                if (rememberSaveable != 0) {
                    modifier2 = Modifier.Companion;
                } else {
                    modifier2 = traceInProgress2;
                }
                if (ComposerKt.isTraceInProgress()) {
                ...
                ComposerKt.sourceInformationMarkerStart(restartGroup, i29, empty);
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
