...
public final class SelectionLayoutKt {
    ...
    public static final androidx.compose.foundation.text.selection.SelectionLayout getTextFieldSelectionLayout-RcvT-LA(TextLayoutResult layoutResult, int rawStartHandleOffset, int rawEndHandleOffset, int rawPreviousHandleOffset, long previousSelectionRange, boolean isStartOfSelection, boolean isStartHandle) {
        ...
        if (isStartHandle) {
            ...
            i = 1;
            anchorInfo2 = new Selection.AnchorInfo(SelectionLayoutKt.getTextDirectionForOffset(layoutResult, TextRange.getStart-impl(previousSelectionRange)), TextRange.getStart-impl(previousSelectionRange), i, obj5);
            anchorInfo = new Selection.AnchorInfo(SelectionLayoutKt.getTextDirectionForOffset(layoutResult, TextRange.getEnd-impl(previousSelectionRange)), TextRange.getEnd-impl(previousSelectionRange), i, obj5);
            selection = new Selection(anchorInfo2, anchorInfo, TextRange.getReversed-impl(previousSelectionRange));
        }
        int i4 = 1;
        SelectableInfo selectableInfo = new SelectableInfo(1, anchorInfo, i4, rawStartHandleOffset, rawEndHandleOffset, rawPreviousHandleOffset, layoutResult);
    ...
    private static final boolean isOffsetAnEmptyLine(TextLayoutResult $this$isOffsetAnEmptyLine, int offset) {
        ...
        i = 0;
        final int i3 = 1;
        lineForOffset = (CharSequence)$this$isOffsetAnEmptyLine.getLayoutInput().getText().length() == 0 ? i3 : i;
