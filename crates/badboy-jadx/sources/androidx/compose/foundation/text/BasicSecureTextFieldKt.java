...
public final class BasicSecureTextFieldKt {
    ...
    public static final void BasicSecureTextField-Jb9bMDk(TextFieldState state, Modifier modifier, boolean enabled, InputTransformation inputTransformation, TextStyle textStyle, androidx.compose.foundation.text.KeyboardOptions keyboardOptions, KeyboardActionHandler onKeyboardAction, Function2<? super Density, ? super Function0<TextLayoutResult>, Unit> onTextLayout, MutableInteractionSource interactionSource, Brush cursorBrush, TextFieldDecorator decorator, int textObfuscationMode, char textObfuscationCharacter, Composer $composer, int $changed, int $changed1, int i17) {
        ...
        int i16;
        int i14;
        androidx.compose.foundation.text.BasicSecureTextFieldKt.BasicSecureTextField.3 $composer3;
        int companion2;
        TextFieldState i34;
        Composer composer2;
        int i23;
        ...
        if (i62 != 0) {
            ...
            if (i72 & 48 == 0) {
                i28 = restartGroup.changed(modifier) ? 32 : 16;
                $dirty3 |= i28;
            } else {
                solidColor = modifier;
            }
        ...
        if (companion3 != 0) {
            ...
            if (i72 & 384 == 0) {
                i23 = restartGroup.changed(enabled) ? i16 : i34;
                $dirty3 |= i23;
            } else {
                z2 = enabled;
            }
        ...
        if (then != 0) {
            ...
            if (i72 & 3072 == 0) {
                i12 = restartGroup.changed(inputTransformation) ? 2048 : 1024;
                $dirty3 |= i12;
            } else {
                z = inputTransformation;
            }
        ...
        if (i27 != 0) {
            ...
            if (i72 & 24576 == 0) {
                i19 = restartGroup.changed(textStyle) ? 16384 : 8192;
                $dirty3 |= i19;
            } else {
                obj6 = textStyle;
            }
        ...
        if (secureTextFieldController != 0) {
            ...
            if (i72 & i9 == 0) {
                i7 = restartGroup.changed(keyboardOptions) ? 131072 : 65536;
                $dirty3 |= i7;
            } else {
                obj4 = keyboardOptions;
            }
        ...
        if (i32 != 0) {
            $dirty3 |= i15;
            i31 = onKeyboardAction;
        } else {
            if (i72 & i15 == 0) {
                i6 = restartGroup.changed(onKeyboardAction) ? 1048576 : 524288;
                $dirty3 |= i6;
            } else {
                i31 = onKeyboardAction;
            }
        ...
        if (i40 != 0) {
            ...
            if (i72 & i81 == 0) {
                i8 = i40;
                i20 = restartGroup.changedInstance(onTextLayout) ? 8388608 : 4194304;
                $dirty3 |= i20;
            } else {
                i8 = i40;
                obj3 = onTextLayout;
        ...
        if (i41 != 0) {
            ...
            if (i72 & i83 == 0) {
                i10 = i41;
                i33 = restartGroup.changed(interactionSource) ? 67108864 : 33554432;
                $dirty3 |= i33;
            } else {
                i10 = i41;
                obj5 = interactionSource;
        ...
        if (i35 != 0) {
            $dirty12 |= 48;
            i2 = i35;
            i18 = textObfuscationMode;
        } else {
            if (i73 & 48 == 0) {
                i2 = i35;
                i3 = restartGroup.changed(textObfuscationMode) ? 32 : 16;
                $dirty12 |= i3;
            } else {
                i2 = i35;
                i18 = textObfuscationMode;
        ...
        if ($dirty3 & $composer3 == 306783378 && $dirty12 & 147 == 146) {
            if ($dirty12 & 147 == 146) {
                if (!restartGroup.getSkipping()) {
                    ...
                    onKeyboardAction2 = i32 != 0 ? 0 : onKeyboardAction;
                    i8 = i8 != 0 ? obj4 : onTextLayout;
                    i10 = i10 != 0 ? obj4 : interactionSource;
                    if (i13 != 0) {
                        obj34 = enabled2;
                        i14 = i43;
                        solidColor = new SolidColor(Color.Companion.getBlack-0d7_KjU(), i43, 0);
                        i13 = enabled2;
                    } else {
                        obj34 = enabled2;
                        i14 = i43;
                    ...
                    if (!restartGroup.changedInstance((SecureTextFieldController)it$iv)) {
                        ...
                        if (it$iv2 == Composer.Companion.getEmpty()) {
                            obj38 = it$iv2;
                            obj39 = $dirty14;
                            it$iv2 = new BasicSecureTextFieldKt.BasicSecureTextField.1.1(it$iv, 0);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    EffectsKt.LaunchedEffect(it$iv, (Function2)it$iv2, restartGroup, 0);
                    ...
                    obj38 = restartGroup;
                    int i76 = 0;
                    it$iv3 = obj38.rememberedValue();
                    companion2 = 0;
                    if (changed |= changedInstance3 == 0) {
                        if (it$iv3 == Composer.Companion.getEmpty()) {
                            obj40 = it$iv3;
                            obj41 = i58;
                            it$iv3 = new BasicSecureTextFieldKt.BasicSecureTextField.2.1(equals-impl03, it$iv, 0);
                            obj38.updateRememberedValue((Function2)it$iv3);
                        } else {
                            composer = obj38;
                            obj40 = it$iv3;
                        }
                    ...
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    int i56 = 0;
                    EffectsKt.LaunchedEffect(Boolean.valueOf(equals-impl03), (Function2)it$iv3, restartGroup, i56);
                    ComposerKt.sourceInformationMarkerStart(restartGroup, 121007343, str2);
                    i4 = $dirty13 & 112 == 32 ? 1 : i56;
                    ...
                    i9 = textStyle2;
                    i32 = keyboardOptions2;
                    i15 = onKeyboardAction2;
                    $composer3 = new BasicSecureTextFieldKt.BasicSecureTextField.3(state, SemanticsModifierKt.semantics(modifier3, true, (Function1)BasicSecureTextFieldKt.BasicSecureTextField.secureTextFieldModifier.1.INSTANCE).then(focusChangeModifier), i2, equals-impl03, i29, secureTextFieldController, i9, i32, i15, i8, i10, i13, (CodepointTransformation)codepointTransformation, i);
                    BasicSecureTextFieldKt.DisableCutCopy((Function2)ComposableLambdaKt.rememberComposableLambda(2023988909, true, $composer3, restartGroup, 54), restartGroup, 6);
                    if (ComposerKt.isTraceInProgress()) {
                    ...
                    i30 = interactionSource;
                    i22 = textObfuscationCharacter;
                    modifier2 = restartGroup;
                    obj46 = $dirty3;
                    $dirty13 = $dirty12;
                    $composer2 = z2;
                    ...
                    obj = obj4;
                    obj7 = solidColor;
                    i25 = onKeyboardAction;
                    i5 = onTextLayout;
                    solidColor2 = cursorBrush;
                    i26 = decorator;
        ...
        if (endRestartGroup != null) {
            $dirty2 = obj46;
            composer2 = composer5;
            modifier2 = new BasicSecureTextFieldKt.BasicSecureTextField.4(state, obj7, $composer2, $dirty, $dirty1, obj, i25, i5, i30, solidColor2, i26, i21, i22, i72, i73, i17);
    ...
    private static final void DisableCutCopy(Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        traceInProgress = 2;
        if ($changed & 6 == 0) {
            i2 = obj10.changedInstance(content) ? 4 : traceInProgress;
            $dirty |= i2;
        }
