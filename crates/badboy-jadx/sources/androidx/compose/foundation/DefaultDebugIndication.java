    ...
    private static final class DefaultDebugIndicationInstance extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope $this$draw) {
            ...
            if (this.isPressed) {
                ...
                i7 = 0;
                i8 = 0;
                DrawScope.drawRect-n-J9OG0$default((DrawScope)$this$draw, Color.copy-wmQWz5c$default(Color.Companion.getBlack-0d7_KjU(), obj3, 1050253722, i7, 0, i8, 14), obj3, 0, i7, $this$draw.getSize-NH-jbRc(), i8, 0, i2, 0);
            } else {
                if (!this.isHovered) {
                    if (this.isFocused) {
                        i2 = 0;
                        i7 = 0;
                        i8 = 0;
                        DrawScope.drawRect-n-J9OG0$default((DrawScope)$this$draw, Color.copy-wmQWz5c$default(Color.Companion.getBlack-0d7_KjU(), obj3, 1036831949, i7, 0, i8, 14), obj3, 0, i7, $this$draw.getSize-NH-jbRc(), i8, 0, i2, 0);
                    }
                } else {
                }
            }
