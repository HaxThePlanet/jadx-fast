...
public final class PagerLazyLayoutItemProvider implements LazyLayoutItemProvider {
    ...
    public void Item(int index, Object key, Composer $composer, int $changed) {
        ...
        if (obj10 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(i4, obj10, -1, "androidx.compose.foundation.pager.PagerLazyLayoutItemProvider.Item (LazyLayoutPager.kt:206)");
                }
                PagerLazyLayoutItemProvider.Item.1 anon = new PagerLazyLayoutItemProvider.Item.1(this, index);
                LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(key, index, this.state.getPinnedPages$foundation_release(), (Function2)ComposableLambdaKt.rememberComposableLambda(1142237095, true, anon, restartGroup, 54), restartGroup, i4 | i11);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (obj8 != null) {
            obj9 = new PagerLazyLayoutItemProvider.Item.2(this, i3, obj, $changed);
