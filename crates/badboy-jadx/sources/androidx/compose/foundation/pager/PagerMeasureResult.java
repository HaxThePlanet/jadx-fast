                        ...
                        if (this.currentPage != null && Float.compare(i10, i11) < 0) {
                            if (Float.compare(i10, i11) < 0) {
                                if (Float.compare(i10, i12) <= 0) {
                                    ...
                                    if (delta < 0) {
                                        deltaToFirstItemChange = Math.min(i13 -= viewportStartOffset2, i16 -= viewportEndOffset2) > -delta ? i : i2;
                                    } else {
                                        deltaToFirstItemChange = Math.min(viewportStartOffset -= offset3, viewportEndOffset -= offset4) > delta ? i : i2;
                                    }
                                    if (deltaToFirstItemChange != 0) {
                                        ...
                                        i3 = 0;
                                        index$iv2 = 0;
                                        while (index$iv2 < $this$fastForEach$iv2.size()) {
                                            i5 = 0;
                                            (MeasuredPage)$this$fastForEach$iv2.get(index$iv2).applyScrollDelta(delta);
                                            index$iv2++;
                                        }
