...
public abstract class PagerState implements ScrollableState {
    ...
    private final float performScroll(float delta) {
        ...
        if ((PagerMeasureResult)value.tryToApplyScrollWithoutRemeasure(-i13)) {
            int i15 = 0;
            pagerState.applyMeasureResult$foundation_release(value, i3);
            ObservableScopeInvalidator.invalidateScope-impl(pagerState.placementScopeInvalidator);
            pagerState.layoutWithoutMeasurement = layoutWithoutMeasurement += i3;
        } else {
            int i16 = 0;
            i4 = i3;
    ...
    public final Object animateScrollToPage(int i, float f2, AnimationSpec<Float> animationSpec3, Continuation<? super Unit> continuation4) {
        ...
        anon2 = continuation4;
        i3 = Integer.MIN_VALUE;
        if (continuation4 instanceof PagerState.animateScrollToPage.1 && label &= i3 != 0) {
            anon2 = continuation4;
            i3 = Integer.MIN_VALUE;
            if (label &= i3 != 0) {
    ...
    public final void requestScrollToPage(int page, float pageOffsetFraction) {
        ...
        if (isScrollInProgress()) {
            i3 = 0;
            scrollInProgress = new PagerState.requestScrollToPage.1(this, i3);
            BuildersKt.launch$default((PagerMeasureResult)this.pagerLayoutInfoState.getValue().getCoroutineScope(), i3, 0, (Function2)scrollInProgress, 3, 0);
        }
