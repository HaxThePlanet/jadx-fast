...
public final class MeasuredPage implements androidx.compose.foundation.pager.PageInfo {
    ...
    public final void place(Placeable.PlacementScope scope) {
        ...
        final int i13 = 0;
        final int i12 = 0;
        i4 = obj.mainAxisLayoutSize != Integer.MIN_VALUE ? 1 : i12;
        if (i4 == 0) {
        } else {
            i5 = i12;
            while (i5 < obj.placeables.size()) {
                i8 = i5;
                i3 = 0;
                placeables = obj.placeables.get(i8);
                ...
                Placeable.PlacementScope.placeRelativeWithLayer-aW-9-wM$default($this$place_u24lambda_u247, (Placeable)placeables, offset, i12, 0, 0, 6);
                i5++;
                Placeable.PlacementScope.placeWithLayer-aW-9-wM$default($this$place_u24lambda_u247, placeables, offset, i12, 0, 0, 6);
                long l2 = offset2;
                i7 = this;
                i = 0;
                if (i7.isVertical) {
                ...
                i6 = 0;
                $this$place_u24lambda_u247 = $this$place_u24lambda_u2472;
                mainAxisOffset = $this$place_u24lambda_u2472;
                if (i7.isVertical) {
                } else {
                }
                $this$place_u24lambda_u2472 = IntOffset.getY-impl(l2);
    ...
    public final void position(int offset, int layoutWidth, int layoutHeight) {
        ...
        obj2 = this;
        obj2.offset = offset;
        i = obj2.isVertical ? layoutHeight : layoutWidth;
        obj2.mainAxisLayoutSize = i;
        int i13 = 0;
        ...
        while (index$iv < placeables.size()) {
            ...
            i7 = i3 * 2;
            i2 = layoutWidth;
            obj2.placeableOffsets[i7] = mainAxisOffset;
            Alignment.Vertical verticalAlignment = obj2.verticalAlignment;
            obj2.placeableOffsets[i7 + 1] = verticalAlignment.align((Placeable)obj3.getHeight(), layoutHeight);
            mainAxisOffset += height;
            index$iv++;
            obj2 = this;
            i4 = offset;
            Alignment.Horizontal horizontalAlignment = obj2.horizontalAlignment;
            obj2.placeableOffsets[i7] = horizontalAlignment.align(obj3.getWidth(), layoutWidth, obj2.layoutDirection);
            obj2.placeableOffsets[i7 + 1] = mainAxisOffset;
            mainAxisOffset += height;
            i5 = layoutHeight;
        }
        int i11 = layoutWidth;
