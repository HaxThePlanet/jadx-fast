...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    public void draw(ContentDrawScope $this$draw) {
        ...
        i3 = 1;
        int i16 = 0;
        i10 = Float.compare(direction, i14) == 0 ? i3 : i16;
        if (i10 != 0) {
            i = Float.compare(floatValue2, f) < 0 ? i3 : i16;
        } else {
            i = Float.compare(floatValue3, f) < 0 ? i3 : i16;
        }
        i9 = Float.compare(direction2, i14) == 0 ? i3 : i16;
        if (i9 != 0) {
            i2 = Float.compare(floatValue4, f2) > 0 ? i3 : i16;
        } else {
            i2 = Float.compare(floatValue5, f2) > 0 ? i3 : i16;
        }
        final int i22 = i2;
