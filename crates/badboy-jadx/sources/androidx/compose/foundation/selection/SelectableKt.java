...
public final class SelectableKt {
    public static final Modifier selectable-O2vRcR0(Modifier $this$selectable_u2dO2vRcR0, boolean selected, MutableInteractionSource interactionSource, Indication indication, boolean enabled, Role role, Function0<Unit> onClick) {
        ...
        if (obj instanceof IndicationNodeFactory != null) {
            indication2 = 0;
            selectableElement = new SelectableElement(selected, interactionSource, (IndicationNodeFactory)obj, enabled, role, onClick, 0);
        } else {
            if (obj == null) {
                indication2 = 0;
                ...
                if (interactionSource != null) {
                    int i4 = 0;
                    selectableElement2 = new SelectableElement(selected, interactionSource, 0, enabled, role, onClick, 0);
                    selectableElement = IndicationKt.indication((Modifier)Modifier.Companion, (InteractionSource)interactionSource, obj).then((Modifier)selectableElement2);
                } else {
                    indication2 = new SelectableKt.selectable-O2vRcR0$$inlined.clickableWithIndicationIfNeeded.1(obj, selected, enabled, role, onClick);
