...
public final class BringIntoViewRequestPriorityQueue {
    ...
    public final void cancelAndRemoveAll(Throwable cause) {
        ...
        int i5 = 0;
        IllegalStateException $i$a$CheckBringIntoViewRequestPriorityQueue$cancelAndRemoveAll$3 = new IllegalStateException("uncancelled requests present".toString());
        throw $i$a$CheckBringIntoViewRequestPriorityQueue$cancelAndRemoveAll$3;
    }
