...
public final class SnapFlingBehavior implements TargetedFlingBehavior {
    ...
    private final Object tryApproach(ScrollScope scrollScope, float f2, float f3, Function1<? super Float, Unit> function14, Continuation<? super AnimationState<Float, AnimationVector1D>> continuation5) {
        ...
        if (obj instanceof SnapFlingBehavior.tryApproach.1 && label2 &= i2 != 0) {
            anon = obj;
            i2 = Integer.MIN_VALUE;
            if (label2 &= i2 != 0) {
                anon.label = label -= i2;
        ...
        switch (_this) {
            case 0:
                ...
                obj14 = AnimationStateKt.AnimationState$default(f2, f, 0, i, false, i7, 0);
                return obj14;
            case 1:
                ResultKt.throwOnFailure(result);
                obj14 = result;
    ...
    public Object performFling(ScrollScope scrollScope, float f2, Function1<? super Float, Unit> function13, Continuation<? super Float> continuation4) {
        ...
        anon = continuation4;
        i = Integer.MIN_VALUE;
        if (continuation4 instanceof SnapFlingBehavior.performFling.1 && label2 &= i != 0) {
            anon = continuation4;
            i = Integer.MIN_VALUE;
            if (label2 &= i != 0) {
                anon.label = obj8 -= i;
