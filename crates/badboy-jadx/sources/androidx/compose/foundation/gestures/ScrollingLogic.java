...
public final class ScrollingLogic {
    ...
    private final long singleAxisVelocity-AH228Gc(long $this$singleAxisVelocity_u2dAH228Gc) {
        ...
        if (this.orientation == horizontal) {
            i2 = $this$singleAxisVelocity_u2dAH228Gc;
            obj9 = Velocity.copy-OhffZ5M$default(i2, obj3, 0, 0, 1);
            $this$singleAxisVelocity_u2dAH228Gc2 = i2;
        } else {
    ...
    public final Object doFlingAnimation-QWom1Mo(long l, Continuation<? super Velocity> continuation2) {
        ...
        if (obj11 instanceof ScrollingLogic.doFlingAnimation.1 && label2 &= i3 != 0) {
            anon = obj11;
            i3 = Integer.MIN_VALUE;
            if (label2 &= i3 != 0) {
                anon.label = obj11 -= i3;
    ...
    public final long singleAxisOffset-MK-Hz9U(long $this$singleAxisOffset_u2dMK_u2dHz9U) {
        ...
        final androidx.compose.foundation.gestures.Orientation horizontal = Orientation.Horizontal;
        if (this.orientation == horizontal) {
            i4 = $this$singleAxisOffset_u2dMK_u2dHz9U;
            obj9 = Offset.copy-dBAh8RU$default(i4, obj3, 0, 0, 1);
            $this$singleAxisOffset_u2dMK_u2dHz9U2 = i4;
        } else {
