...
public final class TapGestureDetectorKt {
    ...
    public static final Object awaitFirstDown(AwaitPointerEventScope awaitPointerEventScope, boolean z2, PointerEventPass pointerEventPass3, Continuation<? super PointerInputChange> continuation4) {
        ...
        if (obj3 instanceof TapGestureDetectorKt.awaitFirstDown.2 && label2 &= i2 != 0) {
            $result = obj3;
            i2 = Integer.MIN_VALUE;
            if (label2 &= i2 != 0) {
                $result.label = label -= i2;
            } else {
                $result = new TapGestureDetectorKt.awaitFirstDown.2(obj3);
            }
        } else {
        }
        event = $result.result;
        ...
        switch (label3) {
            case 0:
                ...
                requireUnconsumed2 = pointerEventPass3;
                pass = obj5;
            ...
            case 1:
                ...
                pass2 = z$0;
                requireUnconsumed = $continuation;
                anon = $result;
                $continuation2 = event;
                ...
                return event.getChanges().get(i7);
                event = $continuation2;
                $result = anon;
                $continuation = requireUnconsumed;
                $this$awaitFirstDown2 = pass2;
                requireUnconsumed2 = $this$awaitFirstDown;
                pass = obj2;
                break;
            default:
        ...
        $result.L$0 = pass;
        $result.L$1 = requireUnconsumed2;
        $result.Z$0 = $this$awaitFirstDown2;
        $result.label = i8;
        Object awaitPointerEvent = pass.awaitPointerEvent(requireUnconsumed2, $result);
        if (awaitPointerEvent != $continuation) {
            $continuation2 = event;
            event = awaitPointerEvent;
            obj2 = pass;
            $this$awaitFirstDown = requireUnconsumed2;
    ...
    private static final Object consumeUntilUp(AwaitPointerEventScope awaitPointerEventScope, Continuation<? super Unit> continuation2) {
        ...
        if (continuation2 instanceof TapGestureDetectorKt.consumeUntilUp.1 && label2 &= i6 != 0) {
            $result = continuation2;
            i6 = Integer.MIN_VALUE;
            if (label2 &= i6 != 0) {
                $result.label = obj15 -= i6;
            } else {
    ...
    public static final Object waitForUpOrCancellation(AwaitPointerEventScope awaitPointerEventScope, PointerEventPass pointerEventPass2, Continuation<? super PointerInputChange> continuation3) {
        ...
        if (obj4 instanceof TapGestureDetectorKt.waitForUpOrCancellation.2 && label2 &= i4 != 0) {
            $result = obj4;
            i4 = Integer.MIN_VALUE;
            if (label2 &= i4 != 0) {
        ...
        switch (label3) {
            ...
            case 1:
                ...
                return $result2.getChanges().get(i2);
                List event = $result2.getChanges();
                size2 = 0;
                i3 = 0;
                index$iv$iv = 0;
                it2 = event.get(index$iv$iv);
                obj3 = null;
                obj = null;
                obj22 = 0;
