...
public final class BorderModifierNode extends DelegatingNode {
    ...
    private final DrawResult drawGenericBorder(CacheDrawScope $this$drawGenericBorder, Brush brush, Outline.Generic outline, boolean fillArea, float strokeWidth) {
        ...
        int i3;
        ColorFilter.Companion prevCanvas$iv$iv2;
        ...
        if (fillArea) {
            ...
            i18 = IntSizeKt.IntSize((int)f, (int)f4);
            ...
            if (!equals-impl0) {
                ...
                if (ImageBitmapConfig.equals-impl(i9, equals-impl)) {
                    size-NH-jbRc = 1;
                }
            } else {
            }
                ...
                if (targetCanvas$iv != null) {
                    if (Float.compare(width-impl3, equals-impl0) <= 0) {
                        if (Float.compare(height-impl3, equals-impl0) <= 0) {
                            if (size-NH-jbRc == 0) {
                                ImageBitmap imageBitmap3 = ImageBitmapKt.ImageBitmap-x__-hDU$default(IntSize.getWidth-impl(i18), IntSize.getHeight-impl(i18), i9, false, 0, 24, 0);
                                int i51 = 0;
            ...
            if (BorderCache.access$getCanvasDrawScope$p(borderCache4) == null) {
                canvasDrawScope5 = new CanvasDrawScope();
                targetCanvas$iv = 0;
                BorderCache.access$setCanvasDrawScope$p(borderCache4, canvasDrawScope5);
            }
            long size-ozmzZPI = IntSizeKt.toSize-ozmzZPI(i18);
            ...
            int i53 = 0;
            drawParams2.setDensity((Density)i5);
            drawParams2.setLayoutDirection(layoutDirection4);
            drawParams2.setCanvas(canvas2);
            drawParams2.setSize-uvyYCjk(size-ozmzZPI);
            canvas2.save();
            canvasDrawScope4 = i15;
            i6 = 0;
            DrawScope.drawRect-n-J9OG0$default((DrawScope)canvasDrawScope4, Color.Companion.getBlack-0d7_KjU(), obj31, 0, obj33, size-ozmzZPI, obj35, 0, 0, 0);
            i25 = 0;
            int i45 = -left;
            canvasDrawScope = canvasDrawScope6;
            int i47 = i29;
            i12 = 0;
            canvasDrawScope.getDrawContext().getTransform().translate(i45, i47);
            CanvasDrawScope pathBounds2 = canvasDrawScope;
            i23 = 0;
            ...
            i35 /= width-impl2;
            i38 /= height-impl;
            canvasDrawScope7 = canvasDrawScope8;
            long center-F1C5BW0 = canvasDrawScope7.getCenter-F1C5BW0();
            i10 = 0;
            canvasDrawScope2 = canvasDrawScope7;
            i19 = 0;
            ...
            DrawScope.drawPath-GBMwjPU$default(canvasDrawScope2, scaleY$iv, brush, 0, $this$withTransform_u24lambda_u246$iv$iv, 0, BlendMode.Companion.getClear-0nO6VwU(), 28, 0);
            top$iv = scaleY$iv;
            previousSize$iv$iv.getCanvas().restore();
            previousSize$iv$iv.setSize-uvyYCjk(context4.getSize-NH-jbRc());
            canvasDrawScope.getDrawContext().getTransform().translate(-i33, -prevCanvas$iv$iv);
            canvas2.restore();
            ...
            prevCanvas$iv$iv2 = i18;
            anon = new BorderModifierNode.drawGenericBorder.3(bounds, objectRef4, prevCanvas$iv$iv2, $this$withTransform_u24lambda_u246$iv$iv, canvas);
            pathBounds = prevCanvas$iv$iv2;
    ...
    private final DrawResult drawRoundRectBorder-JqoCqck(CacheDrawScope $this$drawRoundRectBorder_u2dJqoCqck, Brush brush, Outline.Rounded outline, long topLeft, long borderSize, boolean fillArea, float strokeWidth) {
        ...
        if (RoundRectKt.isSimple(outline.getRoundRect())) {
            ...
            BorderModifierNode.drawRoundRectBorder.1 anon = new BorderModifierNode.drawRoundRectBorder.1(obj24, brush, topLeftCornerRadius-kKHJgLs, i11, i, obj25, topLeft, topLeftCornerRadius-kKHJgLs, fillArea, i, stroke);
