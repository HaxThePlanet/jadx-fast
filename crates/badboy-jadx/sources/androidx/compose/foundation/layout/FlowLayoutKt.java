...
public final class FlowLayoutKt {
    ...
    public static final void FlowColumn(Modifier modifier, androidx.compose.foundation.layout.Arrangement.Vertical verticalArrangement, androidx.compose.foundation.layout.Arrangement.Horizontal horizontalArrangement, int maxItemsInEachColumn, int maxLines, androidx.compose.foundation.layout.FlowColumnOverflow overflow, Function3<? super androidx.compose.foundation.layout.FlowColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i10) {
        ...
        int obj;
        int i16;
        androidx.compose.foundation.layout.FlowLayoutOverflowState i8;
        ...
        if (i7 != 0) {
            $dirty2 |= 3072;
            obj = maxItemsInEachColumn;
        } else {
            if (i60 & 3072 == 0) {
                i16 = restartGroup.changed(maxItemsInEachColumn) ? 2048 : 1024;
                $dirty2 |= i16;
            } else {
                obj = maxItemsInEachColumn;
            }
        ...
        if (i8 != 0) {
            ...
            if (i60 & 24576 == 0) {
                i13 = restartGroup.changed(maxLines) ? 16384 : 8192;
                $dirty2 |= i13;
            } else {
                columnMeasurementMultiContentHelper = maxLines;
            }
        ...
        if (i9 != 0) {
            ...
            if (i60 & i == 0) {
                i = restartGroup.changed(overflow) ? 131072 : 65536;
                $dirty2 |= i;
            } else {
                empty = overflow;
            }
        ...
        if ($dirty2 & i75 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                i7 = i7 != 0 ? start : obj;
                obj = i8 != 0 ? start : columnMeasurementMultiContentHelper;
                if (i9 != 0) {
                ...
                i8 = flowLayoutOverflowState;
                int overflowState = 256;
                columnMeasurementMultiContentHelper = FlowLayoutKt.columnMeasurementMultiContentHelper(empty, obj2, i7, obj, i8, restartGroup, i55 | i66);
                ComposerKt.sourceInformationMarkerStart(restartGroup, -1515605194, str3);
                i18 = $dirty2 & obj26 == 131072 ? i56 : 0;
                ...
                if (composableLambdaInstance == null) {
                    ...
                    if (rememberedValue4 == Composer.Companion.getEmpty()) {
                        ...
                        overflow2.addOverflowComposables$foundation_layout_release(i8, $i$a$CacheFlowLayoutKt$FlowColumn$list$1);
                ...
                obj5 = empty;
                i6 = obj;
                i4 = columnMeasurementMultiContentHelper;
                obj4 = obj2;
            }
        } else {
        }
        ...
        if (endRestartGroup != null) {
            traceInProgress = new FlowLayoutKt.FlowColumn.1($dirty, obj3, obj4, i6, i4, obj5, obj6, i60, i10);
    ...
    public static final void FlowRow(Modifier modifier, androidx.compose.foundation.layout.Arrangement.Horizontal horizontalArrangement, androidx.compose.foundation.layout.Arrangement.Vertical verticalArrangement, int maxItemsInEachRow, int maxLines, androidx.compose.foundation.layout.FlowRowOverflow overflow, Function3<? super androidx.compose.foundation.layout.FlowRowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i10) {
        ...
        int obj5;
        int i8;
        androidx.compose.foundation.layout.FlowLayoutOverflowState i13;
        ...
        if (i42 != 0) {
            ...
            if (i60 & 48 == 0) {
                i3 = restartGroup.changed(horizontalArrangement) ? 32 : 16;
                $dirty |= i3;
            } else {
                str = horizontalArrangement;
            }
        ...
        if (i17 != 0) {
            ...
            if (i60 & 384 == 0) {
                i22 = restartGroup.changed(verticalArrangement) ? 256 : 128;
                $dirty |= i22;
            } else {
                obj4 = verticalArrangement;
            }
        ...
        if (i14 != 0) {
            ...
            if (i60 & i4 == 0) {
                i4 = restartGroup.changed(overflow) ? 131072 : 65536;
                $dirty |= i4;
            } else {
                empty = overflow;
            }
        ...
        if (i10 & 64 != 0) {
            ...
            if (i60 & i23 == 0) {
                i18 = restartGroup.changedInstance(obj6) ? 1048576 : 524288;
                $dirty |= i18;
            }
        }
        if ($dirty & i75 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                i5 = i5 != 0 ? top : obj5;
                obj5 = i13 != 0 ? top : rowMeasurementMultiContentHelper;
                if (i14 != 0) {
                ...
                i13 = flowLayoutOverflowState;
                int overflowState = 256;
                rowMeasurementMultiContentHelper = FlowLayoutKt.rowMeasurementMultiContentHelper(empty, obj4, i5, obj5, i13, restartGroup, i55 | i66);
                ComposerKt.sourceInformationMarkerStart(restartGroup, 454965447, str3);
                i15 = $dirty & obj26 == 131072 ? i56 : 0;
                i6 = i48 &= $dirty == 1048576 ? i56 : 0;
                i15 |= i6;
                Composer composer4 = restartGroup;
                $i$f$cache = 0;
                Object rememberedValue4 = composer4.rememberedValue();
                ...
                if (composableLambdaInstance == null) {
                    ...
                    if (rememberedValue4 == Composer.Companion.getEmpty()) {
                        ...
                        overflow2.addOverflowComposables$foundation_layout_release(i13, $i$a$CacheFlowLayoutKt$FlowRow$list$1);
                ...
                obj3 = empty;
                i = obj5;
                i7 = rowMeasurementMultiContentHelper;
                obj2 = obj4;
            }
        } else {
        }
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new FlowLayoutKt.FlowRow.1($dirty2, obj, obj2, i, i7, obj3, obj6, i60, i10);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    public static final MeasureResult breakDownItems-di9J0FM(MeasureScope $this$breakDownItems_u2ddi9J0FM, androidx.compose.foundation.layout.FlowLineMeasurePolicy measurePolicy, Iterator<? extends Measurable> measurablesIterator, float mainAxisSpacingDp, float crossAxisSpacingDp, long constraints, int maxItemsInMainAxis, int maxLines, androidx.compose.foundation.layout.FlowLayoutOverflowState overflow) {
        ...
        int i12;
        int valueOf;
        MutableIntList nextMainAxisSize;
        ...
        int items2 = i80;
        if (!obj.hasNext()) {
            measureAndCache-rqJ1uqs2 = 0;
        } else {
            measureAndCache-rqJ1uqs2 = FlowLayoutKt.safeNext(obj, items2);
        }
        Measurable measurable6 = measureAndCache-rqJ1uqs2;
        if (measurable6 != null) {
        ...
        super(maxLines, obj78, constraints, measureAndCache-rqJ1uqs2, overflow, currentLineCrossAxisSize, i74, 0);
        final androidx.compose.foundation.layout.FlowLayoutBuildingBlocks flowLayoutBuildingBlocks4 = flowLayoutBuildingBlocks;
        ellipsisWrapInfo2 = 0;
        androidx.compose.foundation.layout.FlowLayoutBuildingBlocks.WrapInfo wrapInfo-OpUlnko2 = flowLayoutBuildingBlocks.getWrapInfo-OpUlnko(obj.hasNext(), 0, IntIntPair.constructor-impl(leftOver2, i13), obj46, nextSize, 0, 0, false, false);
        wrapInfo-OpUlnko = wrapInfo-OpUlnko2;
        int i54 = 0;
        if (wrapInfo-OpUlnko.isLastItemInContainer()) {
            i19 = nextSize != 0 ? measurable3 : 0;
            ellipsisWrapInfo2 = flowLayoutBuildingBlocks4.getWrapEllipsisInfo(wrapInfo-OpUlnko, i19, -1, 0, leftOver2, 0);
        } else {
            leftOver = leftOver2;
        }
        int i42 = 0;
        ...
        int i69 = measurable3;
        i = i55;
        lineIndex = leftOverCrossAxis2;
        measurable = measurable7;
        crossAxisTotalSize3 = ellipsisWrapInfo2;
        ellipsisWrapInfo = i65;
        nextMainAxisSize2 = i60;
        currentLineMainAxisSize2 = wrapInfo-OpUlnko2;
        wrapInfo = i13;
        leftOverCrossAxis = i91;
        while (!currentLineMainAxisSize2.isLastItemInContainer()) {
            if (measurable != null) {
            }
            Intrinsics.checkNotNull(i20);
            measureAndCache-rqJ1uqs2 = i20.intValue();
            Intrinsics.checkNotNull(nextCrossAxisSize);
            valueOf4 = endBreakLineList2;
            int intValue3 = nextCrossAxisSize.intValue();
            i2 = $i$f$getMainAxisMaxImpl;
            int i92 = Math.max(ellipsisWrapInfo, intValue3);
            int currentLineCrossAxisSize3 = leftOver - measureAndCache-rqJ1uqs2;
            leftOverCrossAxis2 = intValue3;
            int i66 = mainAxisMax3;
            obj78.setItemShown$foundation_layout_release(leftOverCrossAxis + 1);
            (List)list.add(measurable);
            placeables.set(leftOverCrossAxis, spacing2.element);
            i35 -= i6;
            if (dp-u2uoSUM3 < maxLines) {
            } else {
            }
            i22 = 0;
            flowLayoutBuildingBlocks = i22;
            if (items2 != 0) {
            } else {
            }
            index = leftOverCrossAxis;
            i10 = placeables;
            nextIndexInLine = dp-u2uoSUM3;
            measureAndCache-rqJ1uqs = measurable;
            if (!obj.hasNext()) {
            } else {
            }
            ...
            Intrinsics.checkNotNull(nextCrossAxisSize);
            intIntPair = valueOf5;
            wrapInfo-OpUlnko = flowLayoutBuildingBlocks4.getWrapInfo-OpUlnko(obj.hasNext(), nextIndexInLine, IntIntPair.constructor-impl(currentLineCrossAxisSize3, wrapInfo), obj61, intIntPair, lineIndex, i, i92, false);
            i21 = i92;
            ...
            mainAxisMax = list3;
            nextMainAxisSize = valueOf4;
            i20 = currentLineMainAxisSize4;
            ellipsisWrapInfo = i11;
            nextMainAxisSize2 = currentLineMainAxisSize;
            leftOverCrossAxis = index + 1;
            endBreakLineList2 = nextMainAxisSize;
            list3 = mainAxisMax;
            $i$f$getMainAxisMaxImpl = i2;
            ...
            valueOf4 = 0;
            lineIndex++;
            nextMainAxisSize2 = i21;
            i6 = leftOverCrossAxis3;
            leftOver = i56;
            wrapInfo = currentLineMainAxisSize2;
            i20 = valueOf4;
            i = crossAxisTotalSize;
            crossAxisTotalSize3 = wrapEllipsisInfo;
            ellipsisWrapInfo = currentLineMainAxisSize;
            ...
            items2.update-4j6BHR0$foundation_layout_release(i12, leftOverCrossAxis, items.toDp-u2uoSUM(nextIndexInLine2), items.toDp-u2uoSUM(measurable));
            i10 = placeables;
            measurable = wrapInfo;
            nextIndexInLine = dp-u2uoSUM3;
            measureAndCache-rqJ1uqs = measurable;
            nextIndexInLine2 = RangesKt.coerceAtLeast(currentLineCrossAxisSize3 - currentLineCrossAxisSize, 0);
            leftOverCrossAxis = dp-u2uoSUM3;
            i12 = lineIndex;
            i22 = i69;
        }
        int mainAxisMax4 = $i$f$getMainAxisMaxImpl;
        int i83 = leftOverCrossAxis;
        map = placeables;
        mainAxisMax2 = endBreakLineList2;
        Measurable measurable5 = measurable;
        MutableIntList placeables2 = list3;
        if (crossAxisTotalSize3 != 0) {
            int i30 = crossAxisTotalSize3;
            list.add(i30.getEllipsis());
            ...
            if (lastItemInContainer.getPlaceEllipsisOnLastContentLine()) {
                ...
                mainAxisMax2.set(spacing2, Math.max(mainAxisMax2.get(spacing2), IntIntPair.getSecond-impl(lastItemInContainer.getEllipsisSize-OO21N7I())));
        ...
        i4 = 0;
        while (i4 < size2) {
            new Placeable[size2][i4] = $i$a$LetFlowLayoutKt$breakDownItems$2.get(i4);
            i4++;
        }
        ...
        i$iv2 = i72;
        i$iv = i31;
        crossAxisTotalSize2 = mainAxisTotalSize2;
        while (i$iv2 < startIndex._size) {
            ...
            MeasureResult measure = RowColumnMeasurePolicyKt.measure((RowColumnMeasurePolicy)measurePolicy, crossAxisTotalSize2, Constraints.getMinHeight-impl(l2), Constraints.getMaxWidth-impl(l2), mainAxisMax2.get(i49), this_$iv, items, list, crossAxisOffsets, currentLineCrossAxisSize4, measureConstraints, currentLineIndex, leftOverCrossAxis4);
            constructor-impl2 = currentLineCrossAxisSize4;
            int i38 = 0;
            ...
            i$iv += crossAxisSize;
            crossAxisTotalSize2 = Math.max(crossAxisTotalSize2, mainAxisSize);
            ...
            mainAxisMax2 = list2;
            wrapInfo = flowLayoutBuildingBlocks;
            $i$a$LetFlowLayoutKt$breakDownItems$2 = map;
            items = $this$breakDownItems_u2ddi9J0FM;
        ...
        MutableIntList crossAxisSizes2 = mainAxisMax2;
        int i85 = i15;
        ...
        ArrayList currentLineCrossAxisSize5 = list;
        if (mutableVector3.isEmpty()) {
            i16 = crossAxisTotalSize2;
            i18 = i$iv;
        } else {
            i16 = crossAxisTotalSize2;
            i18 = i$iv;
        }
        return FlowLayoutKt.placeHelper-BmaY500($this$breakDownItems_u2ddi9J0FM, constraints, i15, i16, i18, iArr5, mutableVector3, measurePolicy);
    }
    ...
    public static final MultiContentMeasurePolicy columnMeasurementMultiContentHelper(androidx.compose.foundation.layout.Arrangement.Vertical verticalArrangement, androidx.compose.foundation.layout.Arrangement.Horizontal horizontalArrangement, int maxItemsInMainAxis, int maxLines, androidx.compose.foundation.layout.FlowLayoutOverflowState overflowState, Composer $composer, int $changed) {
        ...
        if (i16 |= changed5 == 0) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                i9 = 0;
                flowMeasurePolicy = new FlowMeasurePolicy(0, obj, obj2, obj2.getSpacing-D9Ej5fM(), FlowLayoutKt.CROSS_AXIS_ALIGNMENT_START, obj.getSpacing-D9Ej5fM(), i6, i5, obj3, 0);
    ...
    private static final long intrinsicCrossAxisSize(List<? extends IntrinsicMeasurable> children, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> mainAxisSize, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> crossAxisSize, int mainAxisAvailable, int mainAxisSpacing, int crossAxisSpacing, int maxItemsInMainAxis, int maxLines, androidx.compose.foundation.layout.FlowLayoutOverflowState overflow) {
        ...
        noOfItemsShown = i22;
        final int i38 = i33;
        androidx.compose.foundation.layout.FlowLayoutBuildingBlocks.WrapInfo wrapInfo-OpUlnko = flowLayoutBuildingBlocks2.getWrapInfo-OpUlnko(i5, 0, IntIntPair.constructor-impl(i22, wrapEllipsisInfo), i26, box-impl2, 0, 0, i6, false);
        if (wrapInfo-OpUlnko.isLastItemInContainer()) {
            i = nextChild != null ? i38 : second-impl;
            ellipsisSize-F35zm-w$foundation_layout_release = overflow.ellipsisSize-F35zm-w$foundation_layout_release(i, second-impl, second-impl);
        ...
        while (totalCrossAxisSize < size) {
            wrapEllipsisInfo = noOfItemsShown - i8;
            int remaining3 = totalCrossAxisSize + 1;
            int noOfItemsShown2 = i40;
            i6 = Math.max(nextMainAxisSize, noOfItemsShown2);
            nextChild = valueOf;
            if ((IntrinsicMeasurable)nextChild != null) {
            } else {
            }
            ...
            box-impl = IntIntPair.box-impl(IntIntPair.constructor-impl(i9, nextCrossAxisSize));
            constructor-impl3 = i34;
            l = i35;
            androidx.compose.foundation.layout.FlowLayoutBuildingBlocks.WrapInfo wrapInfo-OpUlnko2 = flowLayoutBuildingBlocks2.getWrapInfo-OpUlnko(i2, i15 -= lastBreak, IntIntPair.constructor-impl(wrapEllipsisInfo, i3), totalCrossAxisSize, box-impl, lineIndex, ellipsisSize-OO21N7I, i6, false);
            placeEllipsisOnLastContentLine = lineIndex;
            lineIndex = placeEllipsisOnLastContentLine;
            currentCrossAxisSize = i9;
            remaining = size;
            nextMainAxisSize = i6;
        ...
        return IntIntPair.constructor-impl(ellipsisSize-OO21N7I -= crossAxisSpacing, i4);
    }
    ...
    private static final int maxIntrinsicMainAxisSize(List<? extends IntrinsicMeasurable> children, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> mainAxisSize, int crossAxisAvailable, int mainAxisSpacing, int maxItemsInMainAxis) {
        ...
        while (index$iv < obj3.size()) {
            ...
            currentFixedSpace = 0;
            index$iv++;
            if (i5 + 1 == children.size()) {
            } else {
            }
            currentFixedSpace += i3;
        }
    ...
    private static final int minIntrinsicMainAxisSize(List<? extends IntrinsicMeasurable> children, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> mainAxisSize, Function3<? super IntrinsicMeasurable, ? super Integer, ? super Integer, Integer> crossAxisSize, int crossAxisAvailable, int mainAxisSpacing, int crossAxisSpacing, int maxItemsInMainAxis, int maxLines, androidx.compose.foundation.layout.FlowLayoutOverflowState overflow) {
        ...
        if (i10 < low.size()) {
            if (overflow.getType$foundation_layout_release() != FlowLayoutOverflow.OverflowType.ExpandIndicator) {
                if (overflow.getType$foundation_layout_release() == FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator) {
                    ...
                    if (i10 >= low.size() && i15 >= overflow.getMinLinesToShowCollapse$foundation_layout_release() && overflow.getType$foundation_layout_release() == FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator) {
                        if (i15 >= overflow.getMinLinesToShowCollapse$foundation_layout_release()) {
                            i14 = overflow.getType$foundation_layout_release() == FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator ? i : i19;
                        } else {
                        }
                    } else {
                    }
        ...
        i16 = mainAxisUsed.length == 0 ? i : i19;
        if (i16 != 0) {
        } else {
            first-impl = mainAxisUsed[i19];
            int i30 = 0;
            int i33 = i19;
            $i$a$MaxOfFlowLayoutKt$minIntrinsicMainAxisSize$crossAxisUsed$1 = new IntRange(i, ArraysKt.getLastIndex(mainAxisUsed));
            ...
            i9 = crossAxisSizes.length == 0 ? i : i33;
            if (i9 != 0) {
            } else {
                i2 = crossAxisSizes[i33];
                int i31 = 0;
                i13 = $this$minIntrinsicMainAxisSize_u24lambda_u249;
                $i$a$MaxOfFlowLayoutKt$minIntrinsicMainAxisSize$minimumItemSize$1 = new IntRange(i, ArraysKt.getLastIndex(crossAxisSizes));
                IntIterator iterator = $i$a$MaxOfFlowLayoutKt$minIntrinsicMainAxisSize$minimumItemSize$1.iterator();
                while (iterator.hasNext()) {
                    i = crossAxisSizes[iterator.nextInt()];
                ...
                while (itemShown <= mainAxisSizes) {
                    ...
                    int crossAxisSizes2 = i6;
                    i8 = first-impl;
                    i11 = high;
                    int mustHaveEllipsis = i25;
                    intrinsicCrossAxisSize = FlowLayoutKt.intrinsicCrossAxisSize(low, high3, mainAxisSizes2, crossAxisSizes2, mainAxisSpacing, crossAxisSpacing, i12, i15, overflow);
    ...
    public static final MultiContentMeasurePolicy rowMeasurementMultiContentHelper(androidx.compose.foundation.layout.Arrangement.Horizontal horizontalArrangement, androidx.compose.foundation.layout.Arrangement.Vertical verticalArrangement, int maxItemsInMainAxis, int maxLines, androidx.compose.foundation.layout.FlowLayoutOverflowState overflowState, Composer $composer, int $changed) {
        ...
        if (i16 |= changed5 == 0) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                i6 = 0;
                flowMeasurePolicy = new FlowMeasurePolicy(1, obj2, obj, obj2.getSpacing-D9Ej5fM(), FlowLayoutKt.CROSS_AXIS_ALIGNMENT_TOP, obj.getSpacing-D9Ej5fM(), i5, i7, obj3, 0);
                composer2.updateRememberedValue(flowMeasurePolicy);
            } else {
                flowMeasurePolicy = rememberedValue;
            }
