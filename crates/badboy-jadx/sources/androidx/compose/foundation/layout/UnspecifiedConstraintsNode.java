    ...
    public MeasureResult measure-3p2s80s(MeasureScope $this$measure_u2d3p2s80s, Measurable measurable, long constraints) {
        ...
        if (!Dp.equals-impl0(this.minWidth, Dp.Companion.getUnspecified-D9Ej5fM()) && Constraints.getMinWidth-impl(constraints) == 0) {
            if (Constraints.getMinWidth-impl(constraints) == 0) {
                minWidth-impl2 = RangesKt.coerceAtLeast(RangesKt.coerceAtMost($this$measure_u2d3p2s80s.roundToPx-0680j_4(this.minWidth), Constraints.getMaxWidth-impl(constraints)), i);
            } else {
                minWidth-impl2 = Constraints.getMinWidth-impl(constraints);
            }
        } else {
        }
        ...
        Placeable measure-BRTryo0 = measurable.measure-BRTryo0(ConstraintsKt.Constraints(minWidth-impl2, Constraints.getMaxWidth-impl(constraints), minHeight-impl, Constraints.getMaxHeight-impl(constraints)));
