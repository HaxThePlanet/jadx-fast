...
final class AspectRatioElement extends ModifierNodeElement<androidx.compose.foundation.layout.AspectRatioNode> {
    ...
    public boolean equals(Object other) {
        int i;
        Object obj;
        int matchHeightConstraintsFirst2;
        ...
        matchHeightConstraintsFirst2 = Float.compare(aspectRatio, matchHeightConstraintsFirst) == 0 ? i : i2;
        if (matchHeightConstraintsFirst2 != 0 && this.matchHeightConstraintsFirst == obj2.matchHeightConstraintsFirst) {
