...
public final class Arrangement {
        ...
        public void arrange(Density $this$arrange, int totalSize, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            if (i6 == 0) {
                ...
                while (occupied < length.length) {
                    i = i4;
                    i3 = 0;
                    iArr[i7] = Math.min(lastSpace, i12 - i);
                    lastSpace = i25 + i$iv;
                    occupied++;
                    i9 = sizes;
                    i7 = i8;
                ...
                while (-1 < i9) {
                    ...
                    length = i9;
                    i10 = 0;
                    iArr[length] = Math.min(occupied, i12 - i11);
    ...
    private final void forEachIndexed(int[] $this$forEachIndexed, boolean reversed, Function2<? super Integer, ? super Integer, Unit> action) {
        ...
        final int i6 = 0;
        if (!reversed) {
            i4 = $this$forEachIndexed;
            i5 = 0;
            valueOf = 0;
            i = 0;
            while (i < i4.length) {
                action.invoke(Integer.valueOf(valueOf), Integer.valueOf(i4[i]));
                i++;
                valueOf = i2;
            }
        } else {
            length2--;
            while (-1 < i4) {
                action.invoke(Integer.valueOf(i4), Integer.valueOf($this$forEachIndexed[i4]));
                i4--;
            }
        }
    }
    ...
    public final void placeLeftOrTop$foundation_layout_release(int[] size, int[] outPosition, boolean reverseInput) {
        ...
        if (!reverseInput) {
            ...
            i3 = 0;
            i4 = 0;
            while (i4 < i$iv.length) {
                i2 = 0;
                outPosition[i3] = current;
                current += i;
                i4++;
                i3 = i6;
            }
    ...
    public final void placeSpaceAround$foundation_layout_release(int totalSize, int[] size, int[] outPosition, boolean reverseInput) {
        ...
        if (!reverseInput) {
            ...
            while (i2 < i7.length) {
                i3 = 0;
                i5 = 0;
                outPosition[i11] = Math.round(current);
                current += i15;
                i2++;
                i$iv = size;
                i11 = i9;
    ...
    public final void placeSpaceBetween$foundation_layout_release(int totalSize, int[] size, int[] outPosition, boolean reverseInput) {
        ...
        f2 /= f3;
        current = 0;
        if (reverseInput && i$iv.length == i9) {
            if (i$iv.length == i9) {
                current = i16;
            }
        }
        ...
        if (!reverseInput) {
            ...
            while (i5 < i9.length) {
                i2 = 0;
                i8 = 0;
                outPosition[i3] = Math.round(current);
                current += i12;
                i5++;
                i$iv = size;
                i3 = i10;
    ...
    public final void placeSpaceEvenly$foundation_layout_release(int totalSize, int[] size, int[] outPosition, boolean reverseInput) {
        ...
        if (!reverseInput) {
            ...
            while (i11 < a.length) {
                i = 0;
                i10 = 0;
                outPosition[i4] = Math.round(current);
                i5 = i$iv;
                current += i14;
                i11++;
                i4 = i6;
