...
final class WindowInsetsNestedScrollConnection implements NestedScrollConnection, WindowInsetsAnimationControlListener {
    ...
    private final Object fling-huYlsQE(long l, float f2, boolean z3, Continuation<? super Velocity> continuation4) {
        ...
        anon = obj2;
        i = Integer.MIN_VALUE;
        if (obj2 instanceof WindowInsetsNestedScrollConnection.fling.1 && label2 &= i != 0) {
            anon = obj2;
            i = Integer.MIN_VALUE;
            if (label2 &= i != 0) {
                anon.label = label -= i;
                ...
                anon = new WindowInsetsNestedScrollConnection.fling.1(this, obj2);
            }
        } else {
        }
        ...
        switch (label3) {
            case 0:
                ...
                currentInsets = z3;
                Job animationJob = _this.animationJob;
                ...
                _this.animationJob = i6;
                _this.partialConsumption = i5;
                animationController = i3;
        ...
        obj4 = flingAmount;
        if ((WindowInsetsAnimationController)obj4 == null) {
            return Velocity.box-impl(Velocity.Companion.getZero-9UxMQ8M());
        }
        int valueOf2 = _this.sideCalculator.valueOf((WindowInsetsAnimationController)obj4.getHiddenStateInsets());
        valueOf = _this.sideCalculator.valueOf(obj4.getShownStateInsets());
        currentInsets = _this.sideCalculator.valueOf(obj4.getCurrentInsets());
        if (Float.compare(i2, i5) <= 0) {
            if (currentInsets != valueOf2) {
                if (Float.compare(i2, i5) >= 0 && currentInsets == valueOf) {
                    if (currentInsets == valueOf) {
                        i9 = currentInsets == valueOf ? i3 : 0;
                    }
                }
            } else {
            }
            obj4.finish(i9);
            _this.animationController = i6;
            return Velocity.box-impl(Velocity.Companion.getZero-9UxMQ8M());
        } else {
        }
        splineBasedFloatDecayAnimationSpec = new SplineBasedFloatDecayAnimationSpec(_this.density);
        f += flingDistance;
        endPercent = Float.compare(i13, i16) > 0 ? 1 : 0;
        i3 = endPercent != 0 ? valueOf : valueOf2;
        if (Float.compare(i6, f4) <= 0) {
            if (Float.compare(i6, f5) < 0) {
                i5 = j$02;
                obj3 = _this;
                _this2 = new Ref.FloatRef();
                i8 = endPercent != 0 ? 1 : 0;
                available2 = new WindowInsetsNestedScrollConnection.fling.2(obj3, currentInsets, i2, splineBasedFloatDecayAnimationSpec, valueOf2, valueOf, _this2, obj4, i8, 0);
                anon.L$0 = obj3;
                anon.L$1 = _this2;
                anon.J$0 = i5;
                anon.label = 2;
                ...
                obj3 = _this;
                i5 = i8;
                available2 = new WindowInsetsNestedScrollConnection.fling.3(obj3, currentInsets, i3, i2, obj4, valueOf, 0);
                anon.L$0 = obj3;
                anon.J$0 = i5;
                anon.label = 3;
                if (CoroutineScopeKt.coroutineScope((Function2)available2, anon) == cOROUTINE_SUSPENDED) {
    ...
    private final long scroll-8S9VItk(long available, float scrollAmount) {
        ...
        int i6 = 0;
        int i7 = 0;
        visible = Float.compare(obj14, i6) == 0 ? i4 : i7;
        if (visible == 0) {
            if (Float.compare(obj14, i6) > 0) {
            } else {
                i4 = i7;
            }
            if (this.windowInsets.isVisible() == i4 && animationController == null) {
                if (animationController == null) {
                } else {
                    if (animationController == null) {
                    ...
                    i3 = Float.compare(obj14, i6) > 0 ? valueOf2 : valueOf;
                    if (valueOf3 == i3) {
                        this.partialConsumption = i6;
