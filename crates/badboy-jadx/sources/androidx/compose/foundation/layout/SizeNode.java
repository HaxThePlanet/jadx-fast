...
final class SizeNode extends Modifier.Node implements LayoutModifierNode {
    ...
    private final long getTargetConstraints-OenEA2s(Density $this$targetConstraints) {
        ...
        if (!Dp.equals-impl0(this.maxWidth, Dp.Companion.getUnspecified-D9Ej5fM())) {
            coerceAtLeast = RangesKt.coerceAtLeast($this$targetConstraints.roundToPx-0680j_4(this.maxWidth), i);
        } else {
            coerceAtLeast = i2;
        }
        ...
        if (!Dp.equals-impl0(this.minWidth, Dp.Companion.getUnspecified-D9Ej5fM())) {
            ...
            if (RangesKt.coerceAtLeast(RangesKt.coerceAtMost($this$targetConstraints.roundToPx-0680j_4(this.minWidth), coerceAtLeast), i) != i2) {
            } else {
                it = i;
            }
        } else {
        ...
        if (!Dp.equals-impl0(this.minHeight, Dp.Companion.getUnspecified-D9Ej5fM())) {
            coerceAtLeast2 = RangesKt.coerceAtLeast(RangesKt.coerceAtMost($this$targetConstraints.roundToPx-0680j_4(this.minHeight), coerceAtLeast3), i);
        ...
        return ConstraintsKt.Constraints(it, coerceAtLeast, i, coerceAtLeast3);
    }
