...
final class PaddingValuesInsets implements androidx.compose.foundation.layout.WindowInsets {
    ...
    public String toString() {
        ...
        String str2 = ", ";
        return stringBuilder.append("PaddingValues(").append(Dp.toString-impl(this.paddingValues.calculateLeftPadding-u2uoSUM(ltr))).append(str2).append(Dp.toString-impl(this.paddingValues.calculateTopPadding-D9Ej5fM())).append(str2).append(Dp.toString-impl(this.paddingValues.calculateRightPadding-u2uoSUM(ltr))).append(str2).append(Dp.toString-impl(this.paddingValues.calculateBottomPadding-D9Ej5fM())).append(')').toString();
    }
}
