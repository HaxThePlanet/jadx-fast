...
final class AndroidFlingSpline {
    ...
    static {
        ...
        while (i3 < i13) {
            ...
            i9 = 1056964608;
            AndroidFlingSpline.SplinePositions[i3] = i34 += i37;
            yMax = 1065353216;
            y = 0;
            dy = 0;
            y = yMin + i39;
            ...
            AndroidFlingSpline.SplineTimes[i3] = i19 += i6;
            i3++;
            i13 = 100;
            i5 = 1065353216;
            if (Float.compare(dy, i10) > 0) {
        ...
        AndroidFlingSpline.SplineTimes[i13] = i5;
    ...
    public final long flingPosition-LfoxSSI(float time) {
        ...
        if (i7 < i3) {
            f3 /= f2;
            f2 = AndroidFlingSpline.SplinePositions[i7];
            distanceCoef = f2 + i2;
        }
        int tInf = 0;
        int i5 = 32;
