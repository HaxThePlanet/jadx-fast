    ...
    public final androidx.compose.foundation.layout.FlowLayoutBuildingBlocks.WrapEllipsisInfo ellipsisInfo$foundation_layout_release(boolean hasNext, int lineIndex, int totalCrossAxisSize) {
        ...
        switch (measurable) {
            ...
            case 3:
                ...
                measurable = this.seeMoreSize;
                ellipsisSize = minCrossAxisSizeToShowCollapse;
                measurable2 = placeable;
                ellipsisSize = minCrossAxisSizeToShowCollapse;
                measurable2 = placeable;
                ...
                measurable = intIntPair2;
                measurable2 = placeable;
                ellipsisSize = measurable3;
                measurable = intIntPair;
                measurable2 = placeable;
                return null;
                Intrinsics.checkNotNull(measurable);
                wrapEllipsisInfo = new FlowLayoutBuildingBlocks.WrapEllipsisInfo(ellipsisSize, measurable2, measurable.unbox-impl(), valueOf, 0, 8, 0);
                i4 = wrapEllipsisInfo;
                break;
            default:
