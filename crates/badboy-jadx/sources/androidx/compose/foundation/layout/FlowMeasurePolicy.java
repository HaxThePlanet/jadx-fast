...
final class FlowMeasurePolicy implements MultiContentMeasurePolicy, androidx.compose.foundation.layout.FlowLineMeasurePolicy {
    ...
    private FlowMeasurePolicy(boolean isHorizontal, androidx.compose.foundation.layout.Arrangement.Horizontal horizontalArrangement, androidx.compose.foundation.layout.Arrangement.Vertical verticalArrangement, float mainAxisSpacing, androidx.compose.foundation.layout.CrossAxisAlignment crossAxisAlignment, float crossAxisArrangementSpacing, int maxItemsInMainAxis, int maxLines, androidx.compose.foundation.layout.FlowLayoutOverflowState overflow) {
        ...
        if (isHorizontal()) {
            iNSTANCE2 = FlowMeasurePolicy.maxMainAxisIntrinsicItemSize.1.INSTANCE;
        } else {
            iNSTANCE2 = FlowMeasurePolicy.maxMainAxisIntrinsicItemSize.2.INSTANCE;
        }
        this.maxMainAxisIntrinsicItemSize = iNSTANCE2;
        if (isHorizontal()) {
            iNSTANCE = FlowMeasurePolicy.maxCrossAxisIntrinsicItemSize.1.INSTANCE;
        } else {
            iNSTANCE = FlowMeasurePolicy.maxCrossAxisIntrinsicItemSize.2.INSTANCE;
        }
        this.maxCrossAxisIntrinsicItemSize = iNSTANCE;
        if (isHorizontal()) {
            iNSTANCE4 = FlowMeasurePolicy.minCrossAxisIntrinsicItemSize.1.INSTANCE;
        } else {
            iNSTANCE4 = FlowMeasurePolicy.minCrossAxisIntrinsicItemSize.2.INSTANCE;
        }
        this.minCrossAxisIntrinsicItemSize = iNSTANCE4;
        if (isHorizontal()) {
            iNSTANCE3 = FlowMeasurePolicy.minMainAxisIntrinsicItemSize.1.INSTANCE;
        } else {
            iNSTANCE3 = FlowMeasurePolicy.minMainAxisIntrinsicItemSize.2.INSTANCE;
        }
        this.minMainAxisIntrinsicItemSize = iNSTANCE3;
    }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> measurables, int width) {
        ...
        obj.overflow.setOverflowMeasurables--hBUhpc$foundation_layout_release(firstOrNull3, firstOrNull4, obj.isHorizontal(), ConstraintsKt.Constraints$default(0, width, 0, 0, 13, 0));
        if (obj.isHorizontal()) {
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> measurables, int height) {
        ...
        obj.overflow.setOverflowMeasurables--hBUhpc$foundation_layout_release(firstOrNull, firstOrNull4, obj.isHorizontal(), ConstraintsKt.Constraints$default(0, 0, 0, height, 7, 0));
        if (obj.isHorizontal()) {
            if ((List)CollectionsKt.firstOrNull(list) == null) {
                firstOrNull3 = CollectionsKt.emptyList();
            }
            maxIntrinsicMainAxisSize = obj.maxIntrinsicMainAxisSize(firstOrNull3, height, obj2.roundToPx-0680j_4(obj.mainAxisSpacing));
        } else {
            if ((List)CollectionsKt.firstOrNull(list) == null) {
                firstOrNull2 = CollectionsKt.emptyList();
            }
            maxIntrinsicMainAxisSize = obj.intrinsicCrossAxisSize(firstOrNull2, height, obj2.roundToPx-0680j_4(obj.mainAxisSpacing), obj2.roundToPx-0680j_4(obj.crossAxisArrangementSpacing), obj.maxItemsInMainAxis, obj.maxLines, obj.overflow);
        }
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, List<? extends List<? extends IntrinsicMeasurable>> measurables, int width) {
        ...
        if (obj.isHorizontal()) {
            ...
            intrinsicCrossAxisSize = obj.intrinsicCrossAxisSize(firstOrNull2, width, obj2.roundToPx-0680j_4(obj.mainAxisSpacing), obj2.roundToPx-0680j_4(obj.crossAxisArrangementSpacing), obj.maxItemsInMainAxis, obj.maxLines, obj.overflow);
        } else {
            if ((List)CollectionsKt.firstOrNull(list) == null) {
                firstOrNull3 = CollectionsKt.emptyList();
            }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, List<? extends List<? extends IntrinsicMeasurable>> measurables, int height) {
        ...
        if (obj.isHorizontal()) {
            ...
            minIntrinsicMainAxisSize = obj.minIntrinsicMainAxisSize(firstOrNull2, height, obj2.roundToPx-0680j_4(obj.mainAxisSpacing), obj2.roundToPx-0680j_4(obj.crossAxisArrangementSpacing), obj.maxItemsInMainAxis, obj.maxLines, obj.overflow);
        } else {
            if ((List)CollectionsKt.firstOrNull(list) == null) {
                firstOrNull = CollectionsKt.emptyList();
            }
            minIntrinsicMainAxisSize = obj.intrinsicCrossAxisSize(firstOrNull, height, obj2.roundToPx-0680j_4(obj.mainAxisSpacing), obj2.roundToPx-0680j_4(obj.crossAxisArrangementSpacing), obj.maxItemsInMainAxis, obj.maxLines, obj.overflow);
        }
