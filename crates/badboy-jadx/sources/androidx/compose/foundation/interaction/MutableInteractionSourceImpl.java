...
final class MutableInteractionSourceImpl implements androidx.compose.foundation.interaction.MutableInteractionSource {
    ...
    public Flow getInteractions() {
        return (Flow)getInteractions();
    }

    public MutableSharedFlow<androidx.compose.foundation.interaction.Interaction> getInteractions() {
