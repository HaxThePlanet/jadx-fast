...
public final class DragInteractionKt {
    public static final State<Boolean> collectIsDraggedAsState(androidx.compose.foundation.interaction.InteractionSource $this$collectIsDraggedAsState, Composer $composer, int $changed) {
        ...
        String str;
        Object empty;
        Object $i$a$CacheDragInteractionKt$collectIsDraggedAsState$isDragged$1;
        Object anon;
        int i;
        Boolean valueOf;
        int i2;
        ...
        if (rememberedValue2 == Composer.Companion.getEmpty()) {
            ...
            $i$a$CacheDragInteractionKt$collectIsDraggedAsState$isDragged$1 = rememberedValue2;
        }
        androidx.compose.runtime.MutableState invalid$iv = $i$a$CacheDragInteractionKt$collectIsDraggedAsState$isDragged$1;
