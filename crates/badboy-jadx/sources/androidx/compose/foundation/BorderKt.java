...
public final class BorderKt {
    ...
    private static final Path createRoundRectPath(Path targetPath, RoundRect roundedRect, float strokeWidth, boolean fillArea) {
        ...
        if (!fillArea) {
            ...
            i = 0;
            Path.addRoundRect$default(path2, BorderKt.createInsetRoundedRect(strokeWidth, roundedRect), difference-b3I0S0c, i3, difference-b3I0S0c);
            path3.op-N5in7k0(path3, path2, PathOperation.Companion.getDifference-b3I0S0c());
        }
        return targetPath;
    }
