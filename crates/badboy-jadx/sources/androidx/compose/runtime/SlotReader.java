...
public final class SlotReader {
    ...
    public final List<androidx.compose.runtime.KeyInfo> extractKeys() {
        ...
        while (childIndex < this.currentEnd) {
            ...
            keyInfo = new KeyInfo(SlotTableKt.access$key(this.groups, childIndex), objectKey(this.groups, childIndex), childIndex, i4, i2);
    ...
    public final int skipGroup() {
        ...
        if (SlotTableKt.access$isNode(this.groups, this.currentGroup)) {
            ...
            i = SlotTableKt.access$nodeCount(this.groups, this.currentGroup);
        }
