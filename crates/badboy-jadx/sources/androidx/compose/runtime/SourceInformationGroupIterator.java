...
final class SourceInformationGroupIterator implements Iterator<CompositionGroup>, KMappedMarker {
    ...
    public CompositionGroup next() {
        ...
        if (i3 instanceof Anchor) {
            sourceInformationSlotTableGroup = new SlotTableGroup(this.table, (Anchor)i3.getLocation$runtime_release(), this.version);
            return sourceInformationSlotTableGroup;
        } else {
            if (!i3 instanceof GroupSourceInformation) {
            } else {
                relativeGroupPath = new RelativeGroupPath(this.path, index2--);
                sourceInformationSlotTableGroup = new SourceInformationSlotTableGroup(this.table, this.parent, (GroupSourceInformation)i3, (SourceInformationGroupPath)relativeGroupPath);
            }
        }
