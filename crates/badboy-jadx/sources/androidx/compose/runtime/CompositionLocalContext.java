...
public final class CompositionLocalContext {
    ...
    public CompositionLocalContext(androidx.compose.runtime.PersistentCompositionLocalMap compositionLocals) {
        super();
        this.compositionLocals = compositionLocals;
    }

    public final androidx.compose.runtime.PersistentCompositionLocalMap getCompositionLocals$runtime_release() {
