...
public final class SlotTable implements CompositionData, Iterable<CompositionGroup>, KMappedMarker {
    ...
    private final int emitGroup(StringBuilder $this$emitGroup, int index, int level) {
        ...
        if (sourceInformationOf != null && sourceInformationOf != null) {
            ...
            if (sourceInformationOf != null) {
                ...
                dataIndex2 = 2;
                str4 = 0;
                if (!StringsKt.startsWith$default(sourceInformationOf, "C(", slotsSize, dataIndex2, str4)) {
                    if (StringsKt.startsWith$default(sourceInformationOf, "CC(", slotsSize, dataIndex2, str4)) {
                        i5 = 6;
                        i2 = 0;
                        int i17 = 0;
                        i3 = 0;
                        $this$emitGroup.append(" ");
                        String substring = sourceInformationOf.substring(indexOf$default += i9, StringsKt.indexOf$default((CharSequence)sourceInformationOf, ')', i17, i3, i5, i2));
        ...
        if (slotsSize != 0 && emitGroup$dataIndex2 <= this.slotsSize) {
            if (emitGroup$dataIndex2 <= this.slotsSize) {
                ...
                string2 = SlotTableKt.access$slotAnchor(this.groups, index);
                if (string2 < emitGroup$dataIndex2) {
                    $this$emitGroup.append(", slots=[");
                    $this$emitGroup.append(string2);
                    $this$emitGroup.append(": ");
                    dataIndex = string2;
                    while (dataIndex < emitGroup$dataIndex2) {
                        if (dataIndex != string2) {
                        }
    ...
    private static final int verifyWellFormed$validateGroup(Ref.IntRef current, androidx.compose.runtime.SlotTable this$0, int parent, int parentEnd) {
        ...
        final int element = string4.element;
        string4.element = element + 1;
        string5 = SlotTableKt.access$parentAnchor(obj.groups, element);
        string3 = 1;
        i5 = string5 == i13 ? string3 : 0;
        int i20 = 0;
        if (i5 == 0) {
            int i23 = 0;
        ...
        i18 += element;
        i7 = string <= obj.groupsSize ? string3 : 0;
        int i21 = 0;
        if (i7 == 0) {
            int i26 = 0;
        ...
        i = SlotTableKt.access$slotAnchor(obj.groups, element) <= slotsSize ? string3 : 0;
        int i33 = 0;
        if (i == 0) {
            append2 = 0;
        ...
        i16 += z5;
        i3 = slotsSize - i22 >= i17 ? string3 : 0;
        i10 = 0;
        if (i3 == 0) {
            append2 = 0;
            stringBuilder = new StringBuilder();
        ...
        i8 = i32 == $i$a$CheckPreconditionSlotTable$verifyWellFormed$validateGroup$11 ? 1 : 0;
        i12 = 0;
        final int i39 = i17;
    ...
    public final boolean ownsAnchor(androidx.compose.runtime.Anchor anchor) {
        ...
        if (anchor.getValid()) {
            ...
            if (i4 >= 0 && Intrinsics.areEqual(this.anchors.get(i4), anchor)) {
                it = Intrinsics.areEqual(this.anchors.get(i4), anchor) ? i2 : i3;
            } else {
            }
            if (it != 0) {
                i3 = i2;
    ...
    public final void verifyWellFormed() {
        ...
        while (value$iv < slots.length) {
            ...
            $i$a$CheckPreconditionSlotTable$verifyWellFormed$1 = i;
        }
        int index = 0;
        lastLocation = -1;
