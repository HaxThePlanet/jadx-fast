...
public final class DynamicProvidableCompositionLocal<T>  extends androidx.compose.runtime.ProvidableCompositionLocal<T> {
    ...
    public DynamicProvidableCompositionLocal(androidx.compose.runtime.SnapshotMutationPolicy<T> policy, Function0<? extends T> defaultFactory) {
    ...
    public androidx.compose.runtime.ProvidedValue<T> defaultProvidedValue$runtime_release(T value) {
        int i;
        i = value == null ? 1 : 0;
        ProvidedValue providedValue = new ProvidedValue((CompositionLocal)this, value, i, this.policy, 0, 0, 1);
