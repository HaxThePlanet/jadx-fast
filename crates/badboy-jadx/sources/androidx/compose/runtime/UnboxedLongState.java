...
public final class UnboxedLongState implements androidx.compose.runtime.LongState {
    ...
    private final androidx.compose.runtime.State<Long> baseState;
    static {
    }

    public UnboxedLongState(androidx.compose.runtime.State<Long> baseState) {
        super();
    ...
    public String toString() {
        ...
        return stringBuilder.append("UnboxedLongState(baseState=").append(this.baseState).append(")@").append(hashCode()).toString();
    }
}
