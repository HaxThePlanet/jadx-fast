...
final class SnapshotStateKt__ProduceStateKt {
    public static final <T> androidx.compose.runtime.State<T> produceState(T initialValue, Object key1, Object key2, Object key3, Function2<? super androidx.compose.runtime.ProduceStateScope<T>, ? super Continuation<? super Unit>, ? extends Object> producer, androidx.compose.runtime.Composer $composer, int $changed) {
        ...
        String str;
        Object $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$4;
        int i;
        Object anon;
        ...
        if (rememberedValue2 == Composer.Companion.getEmpty()) {
            ...
            $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$4 = rememberedValue2;
        }
        androidx.compose.runtime.MutableState mutableState2 = $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$4;
        ...
        if (!composer3.changedInstance(obj)) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$4 = 0;
    ...
    public static final <T> androidx.compose.runtime.State<T> produceState(T initialValue, Object key1, Object key2, Function2<? super androidx.compose.runtime.ProduceStateScope<T>, ? super Continuation<? super Unit>, ? extends Object> producer, androidx.compose.runtime.Composer $composer, int $changed) {
        boolean traceInProgress;
        String str;
        Object $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$3;
        int i;
        Object anon;
        int i2 = -1703169085;
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            ...
            $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$3 = rememberedValue;
        }
        androidx.compose.runtime.MutableState invalid$iv = $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$3;
        ComposerKt.sourceInformationMarkerEnd($composer);
        ...
        if (!$composer.changedInstance(producer)) {
            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$3 = 0;
    ...
    public static final <T> androidx.compose.runtime.State<T> produceState(T initialValue, Object key1, Function2<? super androidx.compose.runtime.ProduceStateScope<T>, ? super Continuation<? super Unit>, ? extends Object> producer, androidx.compose.runtime.Composer $composer, int $changed) {
        boolean traceInProgress;
        String str;
        Object $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$2;
        int i;
        Object anon;
        int i2 = -1928268701;
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            ...
            $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$2 = rememberedValue;
        }
        androidx.compose.runtime.MutableState invalid$iv = $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$2;
        ComposerKt.sourceInformationMarkerEnd($composer);
        ...
        if (!$composer.changedInstance(producer)) {
            if (rememberedValue2 == Composer.Companion.getEmpty()) {
                $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$2 = 0;
    ...
    public static final <T> androidx.compose.runtime.State<T> produceState(T initialValue, Function2<? super androidx.compose.runtime.ProduceStateScope<T>, ? super Continuation<? super Unit>, ? extends Object> producer, androidx.compose.runtime.Composer $composer, int $changed) {
        boolean traceInProgress;
        String str;
        Object $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$1;
        int empty;
        Object anon;
        int i = 10454275;
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            ...
            $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$1 = rememberedValue;
        }
        androidx.compose.runtime.MutableState invalid$iv = $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$1;
        ComposerKt.sourceInformationMarkerEnd($composer);
    ...
    public static final <T> androidx.compose.runtime.State<T> produceState(T initialValue, Object[] keys, Function2<? super androidx.compose.runtime.ProduceStateScope<T>, ? super Continuation<? super Unit>, ? extends Object> producer, androidx.compose.runtime.Composer $composer, int $changed) {
        boolean traceInProgress;
        String str;
        Object $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$5;
        int empty;
        Object anon;
        int i = 490154582;
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            ...
            $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$5 = rememberedValue;
        }
        androidx.compose.runtime.MutableState invalid$iv = $i$a$CacheSnapshotStateKt__ProduceStateKt$produceState$result$5;
        ComposerKt.sourceInformationMarkerEnd($composer);
