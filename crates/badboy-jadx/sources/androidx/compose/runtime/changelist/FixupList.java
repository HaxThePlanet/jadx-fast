...
public final class FixupList extends androidx.compose.runtime.changelist.OperationsDebugStringFormattable {
    ...
    public final void createAndInsertNode(Function0<? extends Object> factory, int insertIndex, Anchor groupAnchor) {
        ...
        this_$iv3 = "StringBuilder().apply(builderAction).toString()";
        if (value$iv$iv2 == 0) {
            stringBuilder2 = 0;
            ...
            int i33 = 0;
            $i$f$push2 = string;
            $this$push_u24lambda_u246_u24lambda_u243$iv4 = iNSTANCE.getInts();
            i4 = value$iv$iv2;
            value$iv$iv2 = i30;
            missingIntCount$iv2 = append;
            $i$f$checkPrecondition = i25;
            while ($i$f$checkPrecondition < $this$push_u24lambda_u246_u24lambda_u243$iv4) {
                i5 = $i$f$checkPrecondition;
                i7 = 0;
                if (i40 &= i13 != 0) {
                } else {
                }
                i2 = $this$push_u24lambda_u246_u24lambda_u243$iv4;
                sb6 = sb7;
                ...
                sb7 = sb6;
                $this$push_u24lambda_u246_u24lambda_u243$iv4 = i2;
                if (value$iv$iv2 > 0) {
                } else {
                }
                i2 = $this$push_u24lambda_u246_u24lambda_u243$iv4;
                sb6 = sb7;
                $this$push_u24lambda_u246_u24lambda_u243$iv = $i$f$checkPrecondition;
                sb6.append(iNSTANCE.intParamName-w8GmfQM(Operation.IntParameter.constructor-impl(i5)));
                value$iv$iv2++;
                i2 = $this$push_u24lambda_u246_u24lambda_u243$iv4;
                sb7.append(str4);
            }
            StringBuilder $this$push_u24lambda_u246_u24lambda_u243$iv6 = sb7;
            string = stringBuilder6.toString();
            Intrinsics.checkNotNullExpressionValue(string, this_$iv3);
            stringBuilder = new StringBuilder();
            sb3 = stringBuilder;
            i10 = 0;
            objectParamName-31yXWZQ = iNSTANCE.getObjects();
            $this$push_u24lambda_u246_u24lambda_u245$iv = i25;
            $i$f$getFactoryHpuvwBQ = i5;
            while ($this$push_u24lambda_u246_u24lambda_u245$iv < objectParamName-31yXWZQ) {
                i5 = $this$push_u24lambda_u246_u24lambda_u245$iv;
                i7 = 0;
                if (i38 &= i13 != 0) {
                } else {
                }
                i2 = $this$push_u24lambda_u246_u24lambda_u245$iv;
                sb = sb3;
                $this$push_u24lambda_u246_u24lambda_u245$iv3 = objectParamName-31yXWZQ;
                sb3 = sb;
                $this$push_u24lambda_u246_u24lambda_u245$iv = i19;
            ...
            Intrinsics.checkNotNullExpressionValue(string3, this_$iv3);
        ...
        if (value$iv$iv == 0) {
            ...
            sb2 = stringBuilder5;
            int i31 = 0;
            $this$push_u24lambda_u246_u24lambda_u243$iv2 = iNSTANCE2.getInts();
            missingIntCount$iv = i29;
            this_$iv2 = pendingOperations;
            this_$iv4 = i25;
            while (this_$iv4 < $this$push_u24lambda_u246_u24lambda_u243$iv2) {
                sb3 = this_$iv4;
                i10 = 0;
                if (i34 &= i4 != 0) {
                } else {
                }
                $i$f$push2 = $this$push_u24lambda_u246_u24lambda_u243$iv2;
                sb4 = sb2;
                $this$push_u24lambda_u246_u24lambda_u243$iv3 = this_$iv4;
                this_$iv4 = $this$push_u24lambda_u246_u24lambda_u243$iv3 + 1;
                sb2 = sb4;
                $this$push_u24lambda_u246_u24lambda_u243$iv2 = $i$f$push2;
                ...
                sb4 = sb2;
                $this$push_u24lambda_u246_u24lambda_u243$iv3 = this_$iv4;
                sb4.append(iNSTANCE2.intParamName-w8GmfQM(Operation.IntParameter.constructor-impl(sb3)));
                missingIntCount$iv++;
                $i$f$push2 = $this$push_u24lambda_u246_u24lambda_u243$iv2;
                sb2.append(str4);
            }
            StringBuilder $this$push_u24lambda_u246_u24lambda_u243$iv5 = sb2;
            String string2 = stringBuilder5.toString();
            Intrinsics.checkNotNullExpressionValue(string2, this_$iv3);
            stringBuilder2 = new StringBuilder();
            missingIntCount$iv2 = stringBuilder2;
            stringBuilder = 0;
            $this$push_u24lambda_u246_u24lambda_u245$iv4 = iNSTANCE2.getObjects();
            i = value$iv$iv;
            value$iv$iv = i32;
            i6 = $i$f$push;
            $i$f$push = sb3;
            while (value$iv$iv < $this$push_u24lambda_u246_u24lambda_u245$iv4) {
                sb3 = value$iv$iv;
                $i$f$push2 = 0;
                if (i36 &= i5 != 0) {
                } else {
                }
                i4 = $this$push_u24lambda_u246_u24lambda_u245$iv4;
                sb5 = missingIntCount$iv2;
                $this$push_u24lambda_u246_u24lambda_u245$iv2 = value$iv$iv;
                value$iv$iv = $this$push_u24lambda_u246_u24lambda_u245$iv2 + 1;
                missingIntCount$iv2 = sb5;
                $this$push_u24lambda_u246_u24lambda_u245$iv4 = i4;
                if (missingIntCount$iv > 0) {
                } else {
                }
                i4 = $this$push_u24lambda_u246_u24lambda_u245$iv4;
                sb5 = missingIntCount$iv2;
                $this$push_u24lambda_u246_u24lambda_u245$iv2 = value$iv$iv;
                sb5.append(iNSTANCE2.objectParamName-31yXWZQ(Operation.ObjectParameter.constructor-impl(sb3)));
                $i$f$push++;
                i4 = $this$push_u24lambda_u246_u24lambda_u245$iv4;
                missingIntCount$iv2.append(str4);
            }
            StringBuilder $this$push_u24lambda_u246_u24lambda_u245$iv5 = missingIntCount$iv2;
            pendingOperations = stringBuilder2.toString();
            Intrinsics.checkNotNullExpressionValue(pendingOperations, this_$iv3);
    ...
    public final <V, T> void updateNode(V value, Function2<? super T, ? super V, Unit> block) {
        ...
        if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
            i6 = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? append : string;
        } else {
        }
        int i12 = 0;
        if (i6 == 0) {
