...
public final class ChangeList extends androidx.compose.runtime.changelist.OperationsDebugStringFormattable {
    ...
    public final void pushAdvanceSlotsBy(int distance) {
        ...
        if (Operations.access$getPushedIntMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects())) {
            i10 = Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects()) ? 1 : str;
        } else {
        }
        int i13 = 0;
        if (i10 == 0) {
    ...
    public final void pushCopyNodesToNewAnchorLocation(List<? extends Object> nodes, IntRef effectiveNodeIndex) {
        ...
        if (!(Collection)missingObjects$iv.isEmpty()) {
            ...
            if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
                i2 = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? string : append;
            } else {
            }
            i8 = 0;
            if (i2 == 0) {
                ...
                while (i4 < iNSTANCE.getInts()) {
                    i6 = i4;
                    i12 = 0;
                    if (i20 &= i7 != 0 && missingIntCount$iv > 0) {
                    }
                    i4++;
                    append = 0;
                    intParamName-w8GmfQM = ", ";
    ...
    public final void pushCopySlotTableToAnchorLocation(MovableContentState resolvedState, CompositionContext parentContext, MovableContentStateReference from, MovableContentStateReference to) {
        ...
        StringBuilder stringBuilder;
        StringBuilder sb;
        String $this$push_u24lambda_u246_u24lambda_u245$iv;
        int i4;
        int i8;
        int i2;
        androidx.compose.runtime.changelist.Operations this_$iv;
        ...
        if (i6 == 0) {
            ...
            while (i < iNSTANCE.getInts()) {
                i2 = i;
                i10 = 0;
                if (i22 &= i5 != 0 && missingIntCount$iv > 0) {
                }
                i++;
                missingObjects$iv = this;
                if (missingIntCount$iv > 0) {
                }
                sb3.append(iNSTANCE.intParamName-w8GmfQM(Operation.IntParameter.constructor-impl(i2)));
                missingIntCount$iv++;
                sb3.append(", ");
            }
            string = stringBuilder3.toString();
            ...
            sb = stringBuilder;
            i2 = 0;
            $this$push_u24lambda_u246_u24lambda_u245$iv2 = iNSTANCE.getObjects();
            i4 = $i$f$push;
            $i$f$push = i20;
            missingObjectCount$iv = 0;
            while (missingObjectCount$iv < $this$push_u24lambda_u246_u24lambda_u245$iv2) {
                ...
                sb2 = sb;
                $this$push_u24lambda_u246_u24lambda_u245$iv = objectParamName-31yXWZQ;
                missingObjectCount$iv++;
                objectParamName-31yXWZQ = $this$push_u24lambda_u246_u24lambda_u245$iv;
                sb = sb2;
                $this$push_u24lambda_u246_u24lambda_u245$iv2 = i7;
                if (missingIntCount$iv > 0) {
                } else {
                }
                i7 = $this$push_u24lambda_u246_u24lambda_u245$iv2;
                sb2 = sb;
                $this$push_u24lambda_u246_u24lambda_u245$iv = objectParamName-31yXWZQ;
                sb2.append(iNSTANCE.objectParamName-31yXWZQ(Operation.ObjectParameter.constructor-impl(i3)));
                $i$f$push++;
                i7 = $this$push_u24lambda_u246_u24lambda_u245$iv2;
    ...
    public final void pushDetermineMovableContentNodeIndex(IntRef effectiveNodeIndexOut, Anchor anchor) {
        ...
        if (Operations.access$getPushedIntMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getObjects())) {
            i = Operations.access$getPushedObjectMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getObjects()) ? append : string;
        } else {
        }
        int i12 = 0;
        if (i == 0) {
            ...
            while (missingObjectCount$iv < objectParamName-31yXWZQ) {
                ...
                i8 = objectParamName-31yXWZQ;
                sb.append(iNSTANCE.objectParamName-31yXWZQ(Operation.ObjectParameter.constructor-impl(i5)));
                this_$iv3++;
                sb.append(intParamName-w8GmfQM);
            }
            String string2 = stringBuilder.toString();
    ...
    public final void pushDowns(Object[] nodes) {
        ...
        append = 0;
        str = 1;
        objectParamName-31yXWZQ = missingObjectCount$iv.length == 0 ? str : append;
        if (objectParamName-31yXWZQ == 0) {
            ...
            if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
                i = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? str : append;
            } else {
            }
            i11 = 0;
            if (i == 0) {
                ...
                while (i9 < iNSTANCE.getInts()) {
                    i4 = i9;
                    i12 = 0;
                    if (i16 &= i10 != 0 && missingIntCount$iv > 0) {
                    }
                    i9++;
                    append = 0;
                    intParamName-w8GmfQM = ", ";
    ...
    public final void pushEnsureGroupStarted(Anchor anchor) {
        ...
        int i14 = 0;
        str2 = 0;
        Operations.WriteScope.setObject-DKhxnng(Operations.WriteScope.constructor-impl(objectParamName-31yXWZQ), Operation.ObjectParameter.constructor-impl(str2), anchor);
        if (Operations.access$getPushedIntMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects())) {
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from) {
        ...
        if (Operations.access$getPushedIntMask$p(this_$iv) == Operations.access$createExpectedArgMask(this_$iv, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(this_$iv) == Operations.access$createExpectedArgMask(this_$iv, iNSTANCE.getObjects())) {
            i9 = Operations.access$getPushedObjectMask$p(this_$iv) == Operations.access$createExpectedArgMask(this_$iv, iNSTANCE.getObjects()) ? append : string;
        } else {
        }
        int i12 = 0;
        if (i9 == 0) {
    ...
    public final void pushInsertSlots(Anchor anchor, SlotTable from, androidx.compose.runtime.changelist.FixupList fixups) {
        ...
        int i15 = 0;
        str2 = 1;
        Operations.WriteScope.setObject-DKhxnng(constructor-impl3, Operation.ObjectParameter.constructor-impl(str2), from);
        ...
        if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
            i8 = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? str2 : string;
        } else {
        }
        int i13 = 0;
        if (i8 == 0) {
            ...
            while (i4 < iNSTANCE.getInts()) {
                i6 = i4;
                i2 = 0;
                if (i19 &= i != 0 && missingIntCount$iv > 0) {
                }
                i4++;
                missingObjects$iv = this;
                if (missingIntCount$iv > 0) {
    ...
    public final void pushMoveCurrentGroup(int offset) {
        ...
        int i14 = 0;
        str2 = 0;
        Operations.WriteScope.setInt-A6tL2VI(Operations.WriteScope.constructor-impl(objectParamName-31yXWZQ), Operation.IntParameter.constructor-impl(str2), offset);
        if (Operations.access$getPushedIntMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects())) {
            i3 = Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects()) ? 1 : str2;
        } else {
        }
        int i13 = 0;
        if (i3 == 0) {
    ...
    public final void pushMoveNode(int to, int from, int count) {
        ...
        int i14 = 0;
        str = 0;
        Operations.WriteScope.setInt-A6tL2VI(constructor-impl3, Operation.IntParameter.constructor-impl(str), from);
        ...
        if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
            i8 = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? string : str;
        } else {
        }
        int i12 = 0;
        if (i8 == 0) {
            ...
            int i17 = 0;
            i2 = string;
            while (str < iNSTANCE.getInts()) {
                i3 = str;
                i4 = 0;
                if (i18 &= i9 != 0 && missingIntCount$iv > 0) {
                }
                str++;
                missingObjects$iv = this;
                if (missingIntCount$iv > 0) {
    ...
    public final void pushReleaseMovableGroupAtCurrent(ControlledComposition composition, CompositionContext parentContext, MovableContentStateReference reference) {
        ...
        if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
            i10 = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? str2 : string;
        } else {
        }
        int i13 = 0;
        if (i10 == 0) {
    ...
    public final void pushRemember(RememberObserver value) {
        ...
        int i14 = 0;
        str2 = 0;
        Operations.WriteScope.setObject-DKhxnng(Operations.WriteScope.constructor-impl(objectParamName-31yXWZQ), Operation.ObjectParameter.constructor-impl(str2), value);
        if (Operations.access$getPushedIntMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects())) {
    ...
    public final void pushRemoveNode(int removeFrom, int moveCount) {
        ...
        if (Operations.access$getPushedIntMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getObjects())) {
            i3 = Operations.access$getPushedObjectMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getObjects()) ? append : string;
        } else {
        }
        int i12 = 0;
        if (i3 == 0) {
            ...
            while (string < iNSTANCE.getInts()) {
                i7 = string;
                i9 = 0;
                if (i17 &= i2 != 0 && missingIntCount$iv > 0) {
                }
                string++;
                append = i4;
                i4 = append;
            ...
            while (missingObjectCount$iv < objectParamName-31yXWZQ) {
                ...
                i2 = objectParamName-31yXWZQ;
                missingObjectCount$iv++;
                objectParamName-31yXWZQ = i2;
                if (missingIntCount$iv > 0) {
                }
                i2 = objectParamName-31yXWZQ;
                sb.append(iNSTANCE.objectParamName-31yXWZQ(Operation.ObjectParameter.constructor-impl(i9)));
    ...
    public final void pushTrimValues(int count) {
        ...
        int i14 = 0;
        str = 0;
        Operations.WriteScope.setInt-A6tL2VI(Operations.WriteScope.constructor-impl(objectParamName-31yXWZQ), Operation.IntParameter.constructor-impl(str), count);
        if (Operations.access$getPushedIntMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects())) {
            i9 = Operations.access$getPushedObjectMask$p(objectParamName-31yXWZQ) == Operations.access$createExpectedArgMask(objectParamName-31yXWZQ, iNSTANCE.getObjects()) ? 1 : str;
        } else {
        }
        int i13 = 0;
        if (i9 == 0) {
    ...
    public final void pushUpdateAnchoredValue(Object value, Anchor anchor, int groupSlotIndex) {
        ...
        if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
            i5 = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? str : string;
        } else {
        }
        int i13 = 0;
        if (i5 == 0) {
    ...
    public final <T, V> void pushUpdateNode(V value, Function2<? super T, ? super V, Unit> block) {
        ...
        if (Operations.access$getPushedIntMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects())) {
            i3 = Operations.access$getPushedObjectMask$p(operations) == Operations.access$createExpectedArgMask(operations, iNSTANCE.getObjects()) ? append : string;
        } else {
        }
        int i12 = 0;
        if (i3 == 0) {
    ...
    public final void pushUpdateValue(Object value, int groupSlotIndex) {
        ...
        if (Operations.access$getPushedIntMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getInts()) && Operations.access$getPushedObjectMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getObjects())) {
            i10 = Operations.access$getPushedObjectMask$p(this_$iv3) == Operations.access$createExpectedArgMask(this_$iv3, iNSTANCE.getObjects()) ? 1 : append;
        } else {
        }
        int i14 = 0;
        if (i10 == 0) {
            ...
            while (i9 < iNSTANCE.getInts()) {
                i5 = i9;
                i4 = 0;
                if (i19 &= i6 != 0 && missingIntCount$iv > 0) {
                }
                i9++;
                append = 0;
                intParamName-w8GmfQM = ", ";
            ...
            this_$iv = stringBuilder3.toString();
            String str2 = "StringBuilder().apply(builderAction).toString()";
            Intrinsics.checkNotNullExpressionValue(this_$iv, str2);
            stringBuilder = new StringBuilder();
            sb = stringBuilder;
            i5 = 0;
            objectParamName-31yXWZQ = iNSTANCE.getObjects();
            ...
            Intrinsics.checkNotNullExpressionValue(string, str2);
            StringBuilder stringBuilder2 = new StringBuilder();
            PreconditionsKt.throwIllegalStateException(stringBuilder2.append("Error while pushing ").append(iNSTANCE).append(". Not all arguments were provided. Missing ").append(missingIntCount$iv).append(" int arguments (").append(this_$iv).append(") and ").append(this_$iv3).append(" object arguments (").append(string).append(").").toString());
        } else {
            this_$iv2 = this_$iv3;
        }
    }
