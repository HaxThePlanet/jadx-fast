...
public interface Saver<Original, Saveable>  {
    public abstract Original restore(Saveable saveable);

    public abstract Saveable save(androidx.compose.runtime.saveable.SaverScope saverScope, Original original2);
}
