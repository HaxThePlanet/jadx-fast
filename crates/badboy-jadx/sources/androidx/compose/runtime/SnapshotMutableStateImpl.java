    ...
    public StateRecord mergeRecords(StateRecord previous, StateRecord current, StateRecord applied) {
        ...
        if (getPolicy().equivalent((SnapshotMutableStateImpl.StateStateRecord)obj3.getValue(), (SnapshotMutableStateImpl.StateStateRecord)obj.getValue())) {
            ...
            if (equivalent != null) {
                value = create;
                value2 = 0;
                Intrinsics.checkNotNull(value, "null cannot be cast to non-null type androidx.compose.runtime.SnapshotMutableStateImpl.StateStateRecord<T of androidx.compose.runtime.SnapshotMutableStateImpl.mergeRecords$lambda$4>");
                (SnapshotMutableStateImpl.StateStateRecord)value.setValue(equivalent);
            } else {
                create = 0;
            }
        }
