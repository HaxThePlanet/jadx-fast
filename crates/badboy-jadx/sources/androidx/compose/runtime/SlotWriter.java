...
public final class SlotWriter {
    ...
    public static final class Companion {
        ...
        private final List<androidx.compose.runtime.Anchor> moveGroup(androidx.compose.runtime.SlotWriter fromWriter, int fromIndex, androidx.compose.runtime.SlotWriter toWriter, boolean updateFromCursor, boolean updateToCursor, boolean removeSourceGroup) {
            ...
            while (currentSlot < child) {
                ...
                i12 = SlotWriter.access$getSlotsGapStart$p(writer);
                SlotTableKt.access$updateDataAnchor(iArr2, currentSlot, SlotWriter.access$dataIndexToDataAnchor(writer, i44 += i40, i12, subList, hasMarks));
            ...
            if (i29 < i32) {
                ...
                while (anchorDelta < i32) {
                    ...
                    anchorIndex.setLocation$runtime_release(location$runtime_release + i3);
            ...
            if (SlotTableKt.access$isNode(iArr2, i36)) {
                ...
                i9 = SlotTableKt.access$nodeCount(iArr2, i36);
            }
            SlotWriter.access$setNodeCount$p(writer3, i25 += i9);
    ...
    private final void insertGroups(int size) {
        ...
        if (i8 > 0 && gapLen < i8) {
            ...
            if (gapLen < i8) {
                ...
                dataIndexToDataAnchor = Math.max(Math.max(i * 2, i6 + i8), 32);
                groupAddress2 = new int[dataIndexToDataAnchor * 5];
                i7 = dataIndexToDataAnchor - i6;
                ArraysKt.copyInto(dataIndex, groupAddress2, i4, i4, groupGapStart * 5);
                ArraysKt.copyInto(dataIndex, groupAddress2, i5 * 5, groups * 5, i * 5);
                obj.groups = groupAddress2;
                gapLen = i7;
            }
            ...
            groupAddress = groupGapStart;
            while (groupAddress < groupGapStart + i8) {
                SlotTableKt.access$updateDataAnchor(obj.groups, groupAddress, obj.dataIndexToDataAnchor(dataIndex, slotsGapStart, obj.slotsGapLen, slots.length));
                groupAddress++;
            }
            groupAddress2 = obj.slotsGapOwner;
            if (groupAddress2 >= groupGapStart) {
                obj.slotsGapOwner = groupAddress2 + i8;
            }
        }
    }
    ...
    private final void insertSlots(int size, int group) {
        ...
        if (size > 0 && gapLen < size) {
            ...
            if (gapLen < size) {
                ...
                length = slots.length;
                i6 = length - gapLen;
                i4 = Math.max(Math.max(length * 2, i6 + size), 32);
                arr = new Object[i4];
                i5 = 0;
                i3 = i5;
                while (i3 < i4) {
                ...
                i7 = i4 - i6;
                ArraysKt.copyInto(slots, arr, i5, i5, slotsGapStart);
                ArraysKt.copyInto(slots, arr, slotsGapStart + i7, slotsGapStart + gapLen, length);
                this.slots = arr;
                gapLen = i7;
            }
    ...
    private final void moveAnchors(int originalLocation, int newLocation, int size) {
        ...
        while (index$iv < list.size()) {
            obj2 = obj;
            i2 = 0;
            i3 = anchorIndex + anchor;
            if (i3 >= obj3.groupGapStart) {
            } else {
            }
            obj2.setLocation$runtime_release(i3);
            obj3.anchors.add(SlotTableKt.access$locationOf(obj3.anchors, i3, size$runtime_release), obj2);
            index$iv++;
            i4 = originalLocation;
            i = i5;
            obj2.setLocation$runtime_release(-i7);
        }
    }
        ...
        if (slotsGapOwner != i7) {
            ...
            if (i7 < slotsGapOwner) {
                ...
                while (updateAddress < obj.groupIndexToAddress(i7)) {
                    ...
                    SlotTableKt.access$updateDataAnchor(obj.groups, updateAddress, i9 += i2);
                    updateAddress++;
                    if (updateAddress == obj.groupGapStart) {
                    }
    ...
    private final void startGroup(int key, Object objectKey, boolean isNode, Object aux) {
        ...
        i4 = obj.insertCount > 0 ? sourceInformationOf : i7;
        obj.nodeCountStack.push(obj.nodeCount);
        if (i4 != 0) {
            groupIndexToAddress2 = obj.currentGroup;
            dataIndex = obj.dataIndex(obj.groups, obj.groupIndexToAddress(groupIndexToAddress2));
            obj.insertGroups(sourceInformationOf);
            obj.currentSlot = dataIndex;
            obj.currentSlotEnd = dataIndex;
            i6 = obj2 != Composer.Companion.getEmpty() ? sourceInformationOf : i7;
            if (isNode == 0 && obj3 != Composer.Companion.getEmpty()) {
                i3 = obj3 != Composer.Companion.getEmpty() ? sourceInformationOf : i7;
            } else {
            }
            int dataIndexToDataAnchor = obj.dataIndexToDataAnchor(dataIndex, obj.slotsGapStart, obj.slotsGapLen, slots.length);
            int i12 = 0;
            if (dataIndexToDataAnchor >= 0 && obj.slotsGapOwner < groupIndexToAddress2) {
                if (obj.slotsGapOwner < groupIndexToAddress2) {
                    i5 = slotsSize;
                } else {
            ...
            SlotTableKt.access$initGroup(obj.groups, obj.groupIndexToAddress(groupIndexToAddress2), key, isNode, i6, i3, obj.parent, i5);
            i2 = i6 != 0 ? sourceInformationOf : i7;
            if (i3 != 0) {
            } else {
                sourceInformationOf = i7;
            }
            i11 += sourceInformationOf;
            obj.insertSlots(i, groupIndexToAddress2);
            ...
            obj.nodeCount = i7;
            obj.parent = groupIndexToAddress2;
            obj.currentGroup = groupIndexToAddress2 + 1;
            sourceInformationOf = obj.sourceInformationOf(parent2);
            if (parent2 >= 0 && sourceInformationOf != null) {
                sourceInformationOf = obj.sourceInformationOf(parent2);
                if (sourceInformationOf != null) {
                    sourceInformationOf.reportGroup(obj, groupIndexToAddress2);
                }
            }
        } else {
            ...
            groupIndexToAddress2 = obj.groupIndexToAddress(currentGroup2);
            ...
            obj.currentSlot = obj.slotIndex(obj.groups, groupIndexToAddress2);
            obj.currentSlotEnd = obj.dataIndex(obj.groups, obj.groupIndexToAddress(currentGroup3 += sourceInformationOf));
            obj.nodeCount = SlotTableKt.access$nodeCount(obj.groups, groupIndexToAddress2);
    ...
    public final int endGroup() {
        ...
        i = 1;
        nodesDelta = 0;
        currentAddress = obj.insertCount > 0 ? i : nodesDelta;
                ...
                if (i5 == 0) {
                    if (nodesDelta != 0) {
                        ...
                        while (current != 0) {
                            ...
                            oldGroupSize = groupIndexToAddress;
                            i4 = nodesDelta;
                            SlotTableKt.access$updateGroupSize(obj.groups, groupIndexToAddress2, i6 += i5);
                        }
                        inserting = currentAddress;
                        oldGroupSize = groupIndexToAddress;
                        i4 = nodesDelta;
    ...
    public final void insertAux(Object value) {
        ...
        int i3;
        final int i6 = 1;
        i4 = this.insertCount >= 0 ? i6 : slots;
        int i7 = 0;
        if (i4 == 0) {
            int i8 = 0;
    ...
    public final void moveGroup(int offset) {
        ...
        count2 = offset;
        groupToMove = currentGroup;
        while (count2 > 0) {
            if (groupToMove += i23 <= dataIndexToDataAddress2) {
            } else {
            }
            i = i11;
            i6 = 0;
        ...
        int i18 = SlotTableKt.access$groupSize(obj.groups, obj.groupIndexToAddress(groupToMove));
        int dataIndex2 = obj.dataIndex(obj.groups, obj.groupIndexToAddress(obj.currentGroup));
        int dataIndex3 = obj.dataIndex(obj.groups, obj.groupIndexToAddress(groupToMove));
        int dataIndex4 = obj.dataIndex(obj.groups, obj.groupIndexToAddress(groupToMove + i18));
        ...
        final int i36 = groupToMove;
        groupToMove2 = i7;
        while (groupToMove2 < count) {
            int groupIndexToAddress = obj.groupIndexToAddress(groupToMove2);
    ...
    public final List<androidx.compose.runtime.Anchor> moveTo(androidx.compose.runtime.Anchor anchor, int offset, androidx.compose.runtime.SlotWriter writer) {
        ...
        i4 = 1;
        final int i11 = 0;
        i5 = obj2.insertCount > 0 ? i4 : i11;
        ComposerKt.runtimeCheck(i5);
        i2 = this.insertCount == 0 ? i4 : i11;
        ...
        if (currentGroup <= i6 && i6 < this.currentGroupEnd) {
            i = i6 < this.currentGroupEnd ? i4 : i11;
        } else {
        }
        ComposerKt.runtimeCheck(i);
    ...
    public final void verifyParentAnchors$runtime_release() {
        ...
        while (groupAddress < getCapacity()) {
            i5 = SlotTableKt.access$parentAnchor(this.groups, groupAddress);
            if (parentAnchorToIndex(i5) < groupGapStart) {
            } else {
            }
            if (i5 <= i7) {
            } else {
