...
public final class IntMap<E>  {
    ...
    public IntMap(int initialCapacity) {
        SparseArray sparseArray = new SparseArray(initialCapacity);
        super(sparseArray);
    }

    public IntMap(int i, int i2, DefaultConstructorMarker defaultConstructorMarker3) {
        int obj1;
        obj1 = i2 &= 1 != 0 ? 10 : obj1;
        super(obj1);
    }
    ...
    public final boolean contains(int key) {
        int i;
        i = this.sparseArray.indexOfKey(key) >= 0 ? 1 : 0;
        return i;
    }
