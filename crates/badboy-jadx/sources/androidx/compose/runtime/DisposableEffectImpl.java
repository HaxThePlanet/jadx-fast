...
final class DisposableEffectImpl implements androidx.compose.runtime.RememberObserver {
    ...
    private final Function1<androidx.compose.runtime.DisposableEffectScope, androidx.compose.runtime.DisposableEffectResult> effect;
    private androidx.compose.runtime.DisposableEffectResult onDispose;
    public DisposableEffectImpl(Function1<? super androidx.compose.runtime.DisposableEffectScope, ? extends androidx.compose.runtime.DisposableEffectResult> effect) {
        super();
        this.effect = effect;
    }
    ...
    public void onForgotten() {
        androidx.compose.runtime.DisposableEffectResult onDispose = this.onDispose;
        if (onDispose != null) {
            onDispose.dispose();
        }
        this.onDispose = 0;
    ...
    public void onRemembered() {
        this.onDispose = (DisposableEffectResult)this.effect.invoke(EffectsKt.access$getInternalDisposableEffectScope$p());
    }
}
