...
public final class PersistentHashMapEntries<K, V>  extends AbstractSet<Map.Entry<? extends K, ? extends V>> implements ImmutableSet<Map.Entry<? extends K, ? extends V>> {
    ...
    public PersistentHashMapEntries(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.PersistentHashMap<K, V> map) {
        super();
        this.map = map;
    }
    ...
    public boolean contains(Map.Entry<? extends K, ? extends V> element) {
        ...
        if (value2 != null) {
            int i = 0;
            $i$a$LetPersistentHashMapEntries$contains$1 = Intrinsics.areEqual(value2, element.getValue());
        } else {
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        PersistentHashMapEntriesIterator persistentHashMapEntriesIterator = new PersistentHashMapEntriesIterator(this.map.getNode$runtime_release());
        return (Iterator)persistentHashMapEntriesIterator;
    }
}
