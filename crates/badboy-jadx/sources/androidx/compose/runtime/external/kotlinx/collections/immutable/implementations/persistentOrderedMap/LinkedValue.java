...
public final class LinkedValue<V>  {
    ...
    public LinkedValue(V value) {
        super(value, EndOfChain.INSTANCE, EndOfChain.INSTANCE);
    }

    public LinkedValue(V value, Object previous) {
        super(value, previous, EndOfChain.INSTANCE);
    }

    public LinkedValue(V value, Object previous, Object next) {
        super();
        this.value = value;
    ...
    public final androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.persistentOrderedMap.LinkedValue<V> withNext(Object newNext) {
        LinkedValue linkedValue = new LinkedValue(this.value, this.previous, newNext);
        return linkedValue;
    }

    public final androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.persistentOrderedMap.LinkedValue<V> withPrevious(Object newPrevious) {
        LinkedValue linkedValue = new LinkedValue(this.value, newPrevious, this.next);
        return linkedValue;
    }
    ...
    public final androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.persistentOrderedMap.LinkedValue<V> withValue(V newValue) {
        LinkedValue linkedValue = new LinkedValue(newValue, this.previous, this.next);
        return linkedValue;
    }
}
