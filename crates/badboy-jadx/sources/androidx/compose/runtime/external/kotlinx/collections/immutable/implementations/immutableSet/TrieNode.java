...
public final class TrieNode<E>  {
    ...
    private final androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E> mutableCollisionAddAll(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E> otherNode, DeltaCounter intersectionSizeRef, MutabilityOwnership owner) {
        ...
        if (Intrinsics.areEqual(obj3.ownedBy, obj6)) {
            ...
            trieNode = new TrieNode(i2, copyOf, obj6);
        }
        return trieNode;
    }
    ...
    public final boolean containsAll(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E> otherNode, int shift) {
        ...
        while (mask$iv != 0) {
            ...
            i3 = it;
            buffer = 0;
            obj = obj5.buffer[obj5.indexOfCellAt$runtime_release(i3)];
            Object obj10 = obj3.buffer[obj3.indexOfCellAt$runtime_release(i3)];
            i6 = i7;
            ...
            i2 = i5;
            i7 = i6;
            Intrinsics.checkNotNull(obj, otherIsNode);
            Object obj8 = obj;
            if (obj10 != null) {
            } else {
            }
    ...
    public final androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E> mutableAddAll(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E> otherNode, int shift, DeltaCounter intersectionSizeRef, androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.PersistentHashSetBuilder<?> mutator) {
        ...
        while (mask$iv != 0) {
            ...
            obj = set2.buffer[indexOfCellAt$runtime_release2];
            ...
            set = z2;
            thisCell = this.makeNode(i2, thisCell, positionMask3, obj, i7 + 5, set3.getOwnership$runtime_release());
            objArr[index$iv] = thisCell;
            index$iv++;
            mask$iv ^= lowestOneBit;
            positionMask3 = obj.hashCode();
            i2 = thisCell.hashCode();
            ...
            androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode mutableAdd2 = (TrieNode)obj.mutableAdd(positionMask3, thisCell, i7 + 5, set3);
            ...
            positionMask3 = thisCell.hashCode();
            Intrinsics.checkNotNull(thisCell, str);
            Object obj5 = thisCell;
            if (obj != null) {
            }
            thisIsNode = z;
            androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode mutableAdd = (TrieNode)thisCell.mutableAdd(positionMask3, obj, i7 + 5, set3);
    ...
    public final Object mutableRemoveAll(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E> otherNode, int shift, DeltaCounter intersectionSizeRef, androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.PersistentHashSetBuilder<?> mutator) {
        ...
        while (mask$iv != 0) {
            ...
            i7 = lowestOneBit;
            companion = 0;
            indexOfCellAt$runtime_release = obj2.indexOfCellAt$runtime_release(i7);
            obj = 0;
            i6 = 0;
            ...
            removalBitmap2 = obj;
            if ((TrieNode)obj8.contains(removalBitmap2, length, shift + 5)) {
            } else {
            }
            deltaCounter.plusAssign(1);
            oldSize = TrieNode.EMPTY;
            removalBitmap2 = length.hashCode();
            ...
            i5 = obj;
            $i$f$forEachOneBit2 = $i$f$forEachOneBit;
            removalBitmap2 = (TrieNode)length.mutableRemove(i5, obj8, shift + 5, set2);
        ...
        int removalBitmap3 = removalBitmap2;
                ...
                if (bitCount == 1 && shift != 0) {
                    if (shift != 0) {
                        ...
                        if (realBuffer instanceof TrieNode) {
                            removalBitmap2 = new TrieNode(realBitMap, /* result */, set2.getOwnership$runtime_release());
                            realBuffer = removalBitmap2;
                        } else {
                        }
                    } else {
                        ...
                        removalBitmap2 = new TrieNode(realBitMap, arr, set2.getOwnership$runtime_release());
                        realBuffer = removalBitmap2;
                    }
                } else {
                }
    ...
    public final Object mutableRetainAll(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E> otherNode, int shift, DeltaCounter intersectionSizeRef, androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.PersistentHashSetBuilder<?> mutator) {
        ...
        Object trieNode;
        boolean bitmap;
        Object[] ownership$runtime_release;
        int realBitMap;
        ...
        while (mask$iv != 0) {
            ...
            i = 0;
            i10 = 0;
            i2 = ownership$runtime_release3.buffer[ownership$runtime_release4.indexOfCellAt$runtime_release(j$iv)];
            ...
            if (Intrinsics.areEqual(i2, obj3)) {
            } else {
            }
            it = TrieNode.EMPTY;
            ...
            $i$f$forEachOneBit = 0;
            if ((TrieNode)obj3.contains($i$f$forEachOneBit, i2, shift + 5)) {
            } else {
            }
            it = TrieNode.EMPTY;
            deltaCounter.plusAssign(1);
            $i$f$forEachOneBit = i2.hashCode();
            Intrinsics.checkNotNull(i2, otherIsNode);
            Object obj4 = i2;
            if (obj3 != null) {
            } else {
            }
            $i$f$forEachOneBit = 0;
            if ((TrieNode)i2.contains($i$f$forEachOneBit, obj3, shift + 5)) {
            } else {
            }
            it = TrieNode.EMPTY;
            deltaCounter.plusAssign(1);
            ...
            i7 = mask$iv;
            i9 = i5;
            it = (TrieNode)i2.mutableRetainAll((TrieNode)obj3, shift + 5, deltaCounter, mutator);
        }
        int $this$forEachOneBit$iv2 = i8;
                ...
                if (bitCount == 1 && shift != 0) {
                    if (shift != 0) {
                        ...
                        while (i$iv < mask$iv.length) {
                            ...
                            i11 = 1;
                            ownership$runtime_release4 = this;
                            $i$f$forEachOneBit[ownership$runtime_release3 + j$iv] = mask$iv[i$iv];
                            if (ownership$runtime_release3 + j$iv <= $i$f$forEachOneBit.length) {
                            } else {
                            }
                            i6 = 0;
