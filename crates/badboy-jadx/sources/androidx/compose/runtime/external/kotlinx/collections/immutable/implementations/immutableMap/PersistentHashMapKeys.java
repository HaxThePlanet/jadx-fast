...
public final class PersistentHashMapKeys<K, V>  extends AbstractSet<K> implements ImmutableSet<K> {
    ...
    public PersistentHashMapKeys(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.PersistentHashMap<K, V> map) {
        super();
        this.map = map;
    }
    ...
    public Iterator<K> iterator() {
        ...
        return (Iterator)persistentHashMapKeysIterator;
    }
}
