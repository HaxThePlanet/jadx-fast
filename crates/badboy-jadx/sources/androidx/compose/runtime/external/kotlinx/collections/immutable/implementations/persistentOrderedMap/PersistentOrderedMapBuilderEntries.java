...
public final class PersistentOrderedMapBuilderEntries<K, V>  extends AbstractMapBuilderEntries<Map.Entry<K, V>, K, V> {
    ...
    public PersistentOrderedMapBuilderEntries(androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.persistentOrderedMap.PersistentOrderedMapBuilder<K, V> builder) {
        super();
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        ...
        return (Iterator)persistentOrderedMapBuilderEntriesIterator;
    }
