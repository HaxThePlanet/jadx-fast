...
public class MutableSnapshot extends androidx.compose.runtime.snapshots.Snapshot {
    ...
    private final void validateNotAppliedOrPinned() {
        ...
        if (this.applied) {
            ...
            i = 0;
            this_$iv = Snapshot.access$getPinningTrackingHandle$p((Snapshot)this) >= 0 ? i2 : i;
            if (this_$iv != 0) {
            } else {
                i2 = i;
            }
    ...
    public final androidx.compose.runtime.snapshots.SnapshotApplyResult innerApplyLocked$runtime_release(int snapshotId, Map<androidx.compose.runtime.snapshots.StateRecord, ? extends androidx.compose.runtime.snapshots.StateRecord> optimisticMerges, androidx.compose.runtime.snapshots.SnapshotIdSet invalidSnapshots) {
        ...
        if (statesToRemove != 0) {
            ...
            if ($this$fastForEach$iv == null) {
                bitCount$iv$iv = first;
            } else {
                bitCount$iv$iv = CollectionsKt.plus((Collection)$this$fastForEach$iv, (Iterable)first);
            }
    ...
    public androidx.compose.runtime.snapshots.Snapshot takeNestedSnapshot(Function1<Object, Unit> readObserver) {
        ...
        i = 0;
        int i3 = 0;
        i2 = SnapshotKt.access$getNextSnapshotId$p();
        SnapshotKt.access$setNextSnapshotId$p(i2 + 1);
        SnapshotKt.access$setOpenSnapshots$p(SnapshotKt.access$getOpenSnapshots$p().set(i2));
        NestedReadonlySnapshot nestedReadonlySnapshot = new NestedReadonlySnapshot(i2, SnapshotKt.addRange(getInvalid$runtime_release(), id2 + 1, i2), SnapshotKt.mergedReadObserver$default(readObserver, getReadObserver$runtime_release(), false, 4, 0), (Snapshot)this);
        ...
        synchronized (lock) {
            ...
            SnapshotKt.access$setNextSnapshotId$p(i2 + 1);
            SnapshotKt.access$setOpenSnapshots$p(SnapshotKt.access$getOpenSnapshots$p().set(i2));
            nestedReadonlySnapshot = new NestedReadonlySnapshot(i2, SnapshotKt.addRange(getInvalid$runtime_release(), id2 + 1, i2), SnapshotKt.mergedReadObserver$default(readObserver, getReadObserver$runtime_release(), false, 4, 0), (Snapshot)this);
