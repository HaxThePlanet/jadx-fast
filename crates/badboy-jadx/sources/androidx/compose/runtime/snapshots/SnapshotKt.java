...
public final class SnapshotKt {
    ...
    private static final void checkAndOverwriteUnusedRecordsLocked() {
        ...
        while (i$iv2 < size$runtime_release) {
            hashes$runtime_release = extraStateObjects.getValues$runtime_release()[i$iv2];
            ...
            currentUsed$iv++;
            extraStateObjects.getValues$runtime_release()[currentUsed$iv] = hashes$runtime_release;
    ...
    public static final <T extends androidx.compose.runtime.snapshots.StateRecord> T current(T r) {
        ...
        if (SnapshotKt.readable(r, current2.getId(), current2.getInvalid$runtime_release()) == null) {
            ...
            i2 = 0;
            readable = SnapshotKt.readable(r, current.getId(), current.getInvalid$runtime_release());
    ...
    private static final Map<androidx.compose.runtime.snapshots.StateRecord, androidx.compose.runtime.snapshots.StateRecord> optimisticMerges(androidx.compose.runtime.snapshots.MutableSnapshot currentSnapshot, androidx.compose.runtime.snapshots.MutableSnapshot applyingSnapshot, androidx.compose.runtime.snapshots.SnapshotIdSet invalidSnapshots) {
        ...
        int i$iv$iv;
        long slot$iv$iv;
        androidx.collection.MutableScatterSet $this$maskEmptyOrDeleted$iv$iv$iv;
        int result;
        int i;
        int i3;
        int start3;
        ...
        if (0 <= i17) {
            ...
            previous = set;
            first = start2;
            $this$maskEmptyOrDeleted$iv$iv$iv = readable;
            i4 = mergeRecords;
            result = start2;
        }
        return (Map)result;
    ...
    private static final boolean overwriteUnusedRecordsLocked(androidx.compose.runtime.snapshots.StateObject state) {
        ...
        i2 = 1;
        while (current != null) {
            snapshotId$runtime_release2 = current.getSnapshotId$runtime_release();
            if (snapshotId$runtime_release2 != 0) {
            }
            current = current.getNext$runtime_release();
            i3 = 0;
            i2 = 1;
            if (snapshotId$runtime_release2 < lowestOrDefault) {
            } else {
            }
            retainedRecords++;
            if (validRecord == 0) {
            ...
            stateRecord.setSnapshotId$runtime_release(i3);
            stateRecord.assign(overwriteRecord);
            snapshotId$runtime_release3 = state.getFirstStateRecord();
            i = 0;
            current$iv = snapshotId$runtime_release3;
            youngest$iv = snapshotId$runtime_release3;
            while (current$iv != null) {
                snapshotId$runtime_release4 = 0;
