...
public final class SnapshotIdSet implements Iterable<Integer>, KMappedMarker {
    ...
    public final androidx.compose.runtime.snapshots.SnapshotIdSet and(androidx.compose.runtime.snapshots.SnapshotIdSet bits) {
        ...
        if (obj2.lowerBound == obj.lowerBound && obj2.belowBound == obj.belowBound) {
            if (obj2.belowBound == obj.belowBound) {
                if (Long.compare(eMPTY, belowBound) == 0 && Long.compare(previous4, belowBound) == 0 && obj.belowBound == null) {
                    if (Long.compare(previous4, belowBound) == 0) {
                ...
                if (obj.belowBound == null) {
                    ...
                    if (Long.compare(l2, i7) != 0) {
                        ...
                        while (index$iv$iv2 < snapshotIdSet) {
                            ...
                            i3 = previous4;
                            previous4 = i9;
                            if (obj2.get(previous4)) {
                            }
                            accumulator$iv = previous3;
                            previous3 = z;
                        }
                        i3 = previous4;
                    } else {
                    ...
                    if (Long.compare(l3, i7) != 0) {
                        index$iv$iv3 = 0;
                        while (index$iv$iv3 < snapshotIdSet) {
                            previous = 0;
                            z = belowBound;
                            previous3 = 0;
                            if (Long.compare(i12, i7) != 0 && obj2.get(z)) {
                            }
                            index$iv$iv3++;
                            previous = 0;
                            z = belowBound;
                    ...
                    z = obj3;
                    i4 = 0;
                    i8 = SnapshotIdSet.access$getBelowBound$p(z);
                    if (i8 != null) {
                        while (i5 < i8.length) {
                            belowBound2 = 0;
                            i2 = 0;
                    ...
                    if (Long.compare(l, i7) != 0) {
                        ...
                        while (index$iv$iv < 64) {
                            l = 0;
                            previous2 = snapshotIdSet;
                            belowBound2 = 0;
                            if (Long.compare(l, i7) != 0 && obj.get(previous2)) {
                            }
                            index$iv$iv++;
                            l = 0;
                            previous2 = snapshotIdSet;
                            belowBound2 = 0;
                            if (obj.get(previous2)) {
                            }
                            previous4 = previous5;
                            previous5 = previous3;
                        }
                    }
                    if (Long.compare(accumulator$iv, i7) != 0) {
                        index$iv$iv3 = 0;
                        while (index$iv$iv3 < 64) {
                            previous5 = 0;
                            belowBound2 = accumulator$iv;
                            previous3 = 0;
                            if (Long.compare(i19, i7) != 0 && obj.get(belowBound2)) {
                            }
                            index$iv$iv3++;
                            previous5 = 0;
                            belowBound2 = accumulator$iv;
    ...
    public final androidx.compose.runtime.snapshots.SnapshotIdSet andNot(androidx.compose.runtime.snapshots.SnapshotIdSet bits) {
        ...
        if (set2.lowerBound == set.lowerBound && set2.belowBound == set.belowBound) {
            if (set2.belowBound == set.belowBound) {
                ...
                i6 = 1;
                lowerBound2 = 64;
                if (Long.compare(l, previous2) != 0) {
                    index$iv$iv = 0;
                    while (index$iv$iv < lowerBound2) {
                        if (Long.compare(i15, previous2) != 0) {
                        } else {
                        }
                        i3 = previous2;
                        index$iv$iv++;
                ...
                if (Long.compare(belowBound, i3) != 0) {
                    index$iv$iv2 = 0;
                    while (index$iv$iv2 < lowerBound2) {
    ...
    public final androidx.compose.runtime.snapshots.SnapshotIdSet fastFold(androidx.compose.runtime.snapshots.SnapshotIdSet initial, Function2<? super androidx.compose.runtime.snapshots.SnapshotIdSet, ? super Integer, androidx.compose.runtime.snapshots.SnapshotIdSet> operation) {
        ...
        if (iArr != null) {
            ...
            while (i < iArr.length) {
                i4 = 0;
                accumulator = obj.invoke(accumulator, Integer.valueOf(iArr[i]));
                i++;
            }
        }
        int i10 = 0;
    ...
    public final void fastForEach(Function1<? super Integer, Unit> block) {
        ...
        if (Long.compare(valueOf3, i7) != 0) {
            ...
            while (index < i6) {
                ...
                index++;
                block.invoke(Integer.valueOf(i10 += i4));
            }
        }
    }
        ...
        if (set3.lowerBound == set2.lowerBound && set3.belowBound == set2.belowBound) {
            if (set3.belowBound == set2.belowBound) {
                ...
                if (set2.belowBound == null) {
                    ...
                    if (Long.compare(cmp2, i6) != 0) {
                        index$iv$iv4 = 0;
                        while (index$iv$iv4 < l) {
                            if (Long.compare(i16, i6) != 0) {
                            }
                            index$iv$iv4++;
                            iArr = 0;
                            previous = 0;
                    ...
                    if (Long.compare(cmp, i6) != 0) {
                        index$iv$iv2 = 0;
                        while (index$iv$iv2 < l) {
                            if (Long.compare(i18, i6) != 0) {
                            }
                            index$iv$iv2++;
                            iArr = 0;
                            previous = 0;
                        ...
                        if (i11 >= l2) {
                            if (!get(bit)) {
                                ...
                                while (newLowerBound < i28) {
                                    ...
                                    while (i4 < cmp.length) {
                                        i8 = 0;
                                        (List)arrayList.add(Integer.valueOf(cmp[i4]));
                                        i4++;
                                        valueOf = 64;
                                    }
                                    i8 = 0;
                                    iArr.add(Integer.valueOf(cmp[i4]));
                                    i4++;
                                    valueOf = 64;
                                }
                                i7 = newLowerBound;
                                ...
                                SnapshotIdSet snapshotIdSet5 = new SnapshotIdSet(newUpperSet, obj18, l, obj20, i7, belowBound);
