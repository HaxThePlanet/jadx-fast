    ...
    public static final class Companion {
        ...
        public final <T> T observe(Function1<Object, Unit> readObserver, Function1<Object, Unit> writeObserver, Function0<? extends T> block) {
            ...
            if (obj7 instanceof TransparentObserverMutableSnapshot) {
                ...
                i4 = 0;
                i2 = 0;
                i3 = Long.compare(threadId$runtime_release, currentThreadId) == 0 ? 1 : i2;
                if (i3 != 0) {
            ...
            if (obj7 != null) {
                if (obj7 instanceof MutableSnapshot) {
                    i = transparentObserverMutableSnapshot;
                    if (obj7 instanceof MutableSnapshot) {
                        i = obj7;
                    }
                    transparentObserverMutableSnapshot = new TransparentObserverMutableSnapshot(i, readObserver, writeObserver, 1, 0);
