    ...
    public final void remove() {
        ...
        if (map.getMap().getModification$runtime_release() != StateMapMutableIterator.access$getModification(map)) {
            ...
            if (current == null) {
                ...
                this.current = 0;
                Unit $i$a$ModifyStateMapMutableIterator$remove$1 = Unit.INSTANCE;
                int i4 = 0;
        ...
        ConcurrentModificationException $i$a$ModifyStateMapMutableIterator$remove$12 = new ConcurrentModificationException();
        throw $i$a$ModifyStateMapMutableIterator$remove$12;
    }
