...
public final class SliderKt {
    ...
    private static final void CorrectValueSideEffect(Function1<? super Float, Float> scaleToOffset, ClosedFloatingPointRange<Float> valueRange, ClosedFloatingPointRange<Float> trackRange, MutableState<Float> valueState, float value, Composer $composer, int $changed) {
        ...
        i7 = 4;
        if (i27 & 6 == 0) {
            i2 = restartGroup.changedInstance(scaleToOffset) ? i7 : 2;
            $dirty2 |= i2;
        } else {
            obj = scaleToOffset;
        }
        rememberedValue = 32;
        if (i27 & 48 == 0) {
            i14 = restartGroup.changed(valueRange) ? rememberedValue : 16;
            $dirty2 |= i14;
        } else {
            obj3 = valueRange;
        }
        i13 = 256;
        if (i27 & 384 == 0) {
            i10 = restartGroup.changed(trackRange) ? i13 : 128;
            $dirty2 |= i10;
        } else {
            obj4 = trackRange;
        }
        ...
        i8 = 16384;
        if (i27 & 24576 == 0) {
            i11 = restartGroup.changed(value) ? i8 : 8192;
            $dirty2 |= i11;
        } else {
            f = value;
        }
        ...
        if (i28 & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                i9 = 1;
                str = 0;
                i3 = i28 & 112 == rememberedValue ? i9 : str;
                i4 = i28 & 14 == i7 ? i9 : str;
                i12 = i22 &= i28 == i8 ? i9 : str;
                i5 = i28 & 7168 == empty ? i9 : str;
                if (i28 & 896 == i13) {
                } else {
                    i9 = str;
                }
                ...
                if (i19 |= i9 == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        i = 0;
                        empty = new SliderKt.CorrectValueSideEffect.1.1(obj3, obj, f, obj2, obj4);
                        $dirty.updateRememberedValue((Function0)empty);
                    } else {
    ...
    public static final void RangeSlider(ClosedFloatingPointRange<Float> value, Function1<? super ClosedFloatingPointRange<Float>, Unit> onValueChange, Modifier modifier, boolean enabled, ClosedFloatingPointRange<Float> valueRange, int steps, Function0<Unit> onValueChangeFinished, androidx.compose.material.SliderColors colors, Composer $composer, int $changed, int i11) {
        ...
        if (i65 & 1 != 0) {
            ...
            if (i64 & 6 == 0) {
                i24 = restartGroup.changed(value) ? 4 : 2;
                $dirty |= i24;
            } else {
                obj3 = value;
            }
        ...
        if (i65 & 2 != 0) {
            ...
            if (i64 & 48 == 0) {
                i2 = restartGroup.changedInstance(obj8) ? 32 : 16;
                $dirty |= i2;
            }
        }
        steps2 = i65 & 4;
        ...
        if ($composer4 != 0) {
            ...
            if (i76 &= i64 == 0) {
                i16 = restartGroup.changed(steps) ? 131072 : 65536;
                $dirty |= i16;
            } else {
                $i$a$CacheSliderKt$RangeSlider$tickFractions$1 = steps;
            }
        ...
        if (i4 != 0) {
            ...
            if (i64 & i25 == 0) {
                i25 = restartGroup.changedInstance(onValueChangeFinished) ? 1048576 : 524288;
                $dirty |= i25;
            } else {
                obj = onValueChangeFinished;
            }
            ...
            if (!composer.getSkipping()) {
                ...
                if (i64 & 1 != 0) {
                    if (composer.getDefaultsInvalid()) {
                        ...
                        steps2 = $composer4 != 0 ? 0 : $i$a$CacheSliderKt$RangeSlider$tickFractions$1;
                        onValueChangeFinished2 = i4 != 0 ? 0 : obj;
                        if (i65 & 128 != 0) {
                            i20 = 131072;
                            $composer2 = composer;
                            $dirty &= i17;
                            i23 = steps2;
                            i4 = onValueChangeFinished2;
                            z = i14;
                        ...
                        if (i65 & 128 != 0) {
                            ...
                            z = i14;
                            i4 = obj;
                            i23 = $i$a$CacheSliderKt$RangeSlider$tickFractions$1;
                            $composer2 = composer;
                            i20 = 131072;
                        } else {
                            sliderColors2 = colors;
                ...
                if (i26 == 0) {
                    ...
                    if (i18 == 0) {
                        if (rememberedValue2 == Composer.Companion.getEmpty()) {
                            int i78 = 0;
                            composer3.updateRememberedValue(SliderKt.stepsToTickFractions(i23));
                        } else {
                    ...
                    $composer4 = colors2;
                    $composer3 = composer5;
                    SliderKt.RangeSlider.2 valueRange3 = new SliderKt.RangeSlider.2($composer4, obj3, (List)$i$a$CacheSliderKt$RangeSlider$tickFractions$1, i4, SnapshotStateKt.rememberUpdatedState(obj8, $composer2, i50 &= 14), (MutableInteractionSource)$i$a$CacheSliderKt$RangeSlider$startInteractionSource$1, (MutableInteractionSource)$i$a$CacheSliderKt$RangeSlider$endInteractionSource$1, z, i23, sliderColors2);
                    obj43 = $composer3;
                    BoxWithConstraintsKt.BoxWithConstraints(SizeKt.requiredSizeIn-qDBjuR0$default(InteractiveComponentSizeKt.minimumInteractiveComponentSize(obj7), Dp.constructor-impl(f2 *= thumbRadius), Dp.constructor-impl(f *= other$iv), 0, 0, 12, 0), 0, false, (Function3)ComposableLambdaKt.rememberComposableLambda(652589923, true, valueRange3, $composer3, 54), obj43, 3072, 6);
                    composer = obj43;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    ...
                    if (endRestartGroup != null) {
                        traceInProgress = new SliderKt.RangeSlider.3(value, obj8, $dirty2, z2, obj4, modifier2, obj5, sliderColors, i64, i65);
    ...
    private static final void RangeSliderImpl(boolean enabled, float positionFractionStart, float positionFractionEnd, List<Float> tickFractions, androidx.compose.material.SliderColors colors, float width, MutableInteractionSource startInteractionSource, MutableInteractionSource endInteractionSource, Modifier modifier, Modifier startThumbSemantics, Modifier endThumbSemantics, Composer $composer, int $changed, int $changed1) {
        ...
        if (i24 & 384 == 0) {
            i7 = restartGroup.changed(positionFractionEnd) ? 256 : 128;
            $dirty |= i7;
        }
        if (i24 & 3072 == 0) {
        ...
        if (i24 & 24576 == 0) {
            i23 = restartGroup.changed(colors) ? 16384 : 8192;
            $dirty |= i23;
        } else {
            then = colors;
        }
        if (i24 & i93 == 0) {
            i18 = restartGroup.changed(f3) ? 131072 : 65536;
            $dirty |= i18;
        }
        int i94 = 1572864;
        if (i24 & i94 == 0) {
            i8 = restartGroup.changed(empty) ? 1048576 : 524288;
            $dirty |= i8;
        }
        if (i24 & i95 == 0) {
            i16 = restartGroup.changed(obj2) ? 8388608 : 4194304;
            $dirty |= i16;
        }
        if (i24 & i96 == 0) {
            i9 = restartGroup.changed(measurePolicy$iv) ? 67108864 : 33554432;
            $dirty |= i9;
        }
        if (i24 & i97 == 0) {
            i17 = restartGroup.changed(obj) ? 536870912 : 268435456;
            $dirty |= i17;
        }
        if ($changed1 & 6 == 0) {
        ...
        if ($dirty & i13 == 306783378 && $dirty1 & 3 == 2) {
            if ($dirty1 & 3 == 2) {
                if (!restartGroup.getSkipping()) {
                    ...
                    ComposerKt.sourceInformationMarkerEnd(trackStrokeWidth);
                    int i68 = 1;
                    SliderKt.SliderThumb-PcYyNuk(boxScopeInstance, FocusableKt.focusable(SemanticsModifierKt.semantics((Modifier)Modifier.Companion, i68, (Function1)$this$RangeSliderImpl_u24lambda_u2412), i68, obj2).then(obj5), Dp.constructor-impl(f9 * positionFractionEnd), obj2, colors, enabled, $dirty1, trackStrokeWidth, i35 | i57);
                    ComposerKt.sourceInformationMarkerEnd(trackStrokeWidth);
    ...
    public static final void Slider(float value, Function1<? super Float, Unit> onValueChange, Modifier modifier, boolean enabled, ClosedFloatingPointRange<Float> valueRange, int steps, Function0<Unit> onValueChangeFinished, MutableInteractionSource interactionSource, androidx.compose.material.SliderColors colors, Composer $composer, int $changed, int i12) {
        ...
        boolean z;
        boolean z3;
        androidx.compose.material.SliderColors i9;
        ...
        if (i61 & 2 != 0) {
            ...
            if (i60 & 48 == 0) {
                i22 = restartGroup.changedInstance(obj5) ? 32 : 16;
                $dirty |= i22;
            }
        }
        ...
        if ($dirty & i27 == 38347922) {
            if (!composer.getSkipping()) {
                ...
                if (interactionSource2 == 0) {
                    $composer4.startReplaceGroup(246071380);
                    ComposerKt.sourceInformation($composer4, "161@7702L39");
                    ComposerKt.sourceInformationMarkerStart($composer4, -407704210, str);
                    ...
                    i6 = $i$a$CacheSliderKt$Slider$interactionSource$1;
                } else {
                    $composer4.startReplaceGroup(-407704861);
                    $composer4.endReplaceGroup();
                ...
                if (i4 == 0) {
                    ...
                    ComposerKt.sourceInformationMarkerStart($composer4, -407698430, str);
                    if (i33 &= $dirty == 131072) {
                        i17 = 1;
                    }
                    ...
                    if (i17 == 0) {
                        if (rememberedValue2 == Composer.Companion.getEmpty()) {
                            int i55 = 0;
                            composer2.updateRememberedValue(SliderKt.stepsToTickFractions(i14));
                        } else {
                    ...
                    $composer3 = obj45;
                    $composer2 = composer3;
                    SliderKt.Slider.2 anon = new SliderKt.Slider.2($composer3, value, (List)$i$a$CacheSliderKt$Slider$tickFractions$1, i25, i40, z4, i9, SnapshotStateKt.rememberUpdatedState(obj5, $composer4, i62 &= 14));
                    obj44 = $composer2;
                    BoxWithConstraintsKt.BoxWithConstraints(FocusableKt.focusable(SliderKt.sliderSemantics(SizeKt.requiredSizeIn-qDBjuR0$default(InteractiveComponentSizeKt.minimumInteractiveComponentSize(obj), Dp.constructor-impl(f2 *= thumbRadius), Dp.constructor-impl(f3 *= arg0$iv), 0, 0, 12, 0), f, obj42, obj5, i25, obj45, obj46), z4, i40), 0, false, (Function3)ComposableLambdaKt.rememberComposableLambda(2085116814, true, anon, $composer2, 54), obj44, 3072, 6);
                    composer = obj44;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    }
                    ...
                    interactionSource3 = i25;
                    ScopeUpdateScope endRestartGroup = composer.endRestartGroup();
                    if (endRestartGroup != null) {
                        traceInProgress = new SliderKt.Slider.3(value, onValueChange, $dirty2, z2, obj3, modifier2, interactionSource3, enabled2, sliderColors, i60, i61);
                        endRestartGroup.updateScope((Function2)traceInProgress);
                    }
                }
            } else {
    ...
    private static final void SliderImpl(boolean enabled, float positionFraction, List<Float> tickFractions, androidx.compose.material.SliderColors colors, float width, MutableInteractionSource interactionSource, Modifier modifier, Composer $composer, int $changed) {
        ...
        traceInProgress2 = 1679682785;
        final Composer restartGroup = $composer.startRestartGroup(traceInProgress2);
        ComposerKt.sourceInformation(restartGroup, "C(SliderImpl)P(1,4,5!1,6)593@25125L712:Slider.kt#jmzs0o");
        if (i68 & 6 == 0) {
            i8 = restartGroup.changed(enabled) ? 4 : 2;
            $dirty2 |= i8;
        } else {
            valueOf = enabled;
        }
        if (i68 & 48 == 0) {
            i = restartGroup.changed(positionFraction) ? 32 : 16;
            $dirty2 |= i;
        }
        if (i68 & 384 == 0) {
            i13 = restartGroup.changedInstance(tickFractions) ? 256 : 128;
            $dirty2 |= i13;
        } else {
            obj3 = tickFractions;
        }
        if (i68 & 3072 == 0) {
            i10 = restartGroup.changed(colors) ? 2048 : 1024;
            $dirty2 |= i10;
        } else {
            obj2 = colors;
        }
        if (i68 & 24576 == 0) {
            i14 = restartGroup.changed(f4) ? 16384 : 8192;
            $dirty2 |= i14;
        }
        if (i61 &= i68 == 0) {
            i2 = restartGroup.changed(interactionSource) ? 131072 : 65536;
            $dirty2 |= i2;
        } else {
            obj = interactionSource;
        }
        if (i62 &= i68 == 0) {
            i4 = restartGroup.changed(obj5) ? 1048576 : 524288;
            $dirty2 |= i4;
        }
        $dirty = $dirty2;
        if ($dirty3 &= $dirty == 599186) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty, -1, "androidx.compose.material.SliderImpl (Slider.kt:592)");
                }
                ...
                if (!composer5.getInserting()) {
                    $i$a$ReusableComposeNodeLayoutKt$Layout$1$iv$iv = valueOf2;
                ...
                i3 = 0;
                ComposerKt.sourceInformationMarkerStart(composer4, -2146769399, "C73@3429L9:Box.kt#2w3rfo");
                localMap$iv$iv = composer4;
                i6 = 0;
                ComposerKt.sourceInformationMarkerStart(localMap$iv$iv, 1216522066, "C*597@25285L7,606@25530L216,616@25755L76:Slider.kt#jmzs0o");
                int i56 = 0;
                int i70 = 0;
                int i74 = 0;
                int i76 = 0;
                int i77 = i42;
                ComposerKt.sourceInformationMarkerStart(localMap$iv$iv, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                ComposerKt.sourceInformationMarkerEnd(localMap$iv$iv);
                Object this_$iv = consume;
                int i75 = i29;
                int i71 = 0;
                int i58 = 0;
                ...
                map = map2;
                localMap$iv$iv2 = obj52;
                trackStrokeWidth = alignment;
                SliderKt.Track(SizeKt.fillMaxSize$default((Modifier)Modifier.Companion, 0, 1, 0), obj2, enabled, 0, positionFraction, obj3, this_$iv.toPx-0680j_4(SliderKt.ThumbRadius), (Density)this_$iv.toPx-0680j_4(SliderKt.TrackHeight), localMap$iv$iv, i34 |= i48);
                i17 = $dirty;
                SliderKt.SliderThumb-PcYyNuk((BoxScope)BoxScopeInstance.INSTANCE, (Modifier)Modifier.Companion, Dp.constructor-impl(f3 * positionFraction), obj, colors, enabled, Dp.constructor-impl(arg0$iv2 *= f6), localMap$iv$iv, skipping | f2);
                ComposerKt.sourceInformationMarkerEnd(localMap$iv$iv);
                ComposerKt.sourceInformationMarkerEnd(composer4);
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new SliderKt.SliderImpl.2(enabled, positionFraction, tickFractions, colors, f4, interactionSource, obj5, i68);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    private static final void SliderThumb-PcYyNuk(BoxScope $this$SliderThumb_u2dPcYyNuk, Modifier modifier, float offset, MutableInteractionSource interactionSource, androidx.compose.material.SliderColors colors, boolean enabled, float thumbSize, Composer $composer, int $changed) {
        ...
        $i$a$CacheSliderKt$SliderThumb$1$1 = $composer.startRestartGroup(traceInProgress);
        ...
        if (unbox-impl & 6 == 0) {
            i14 = $i$a$CacheSliderKt$SliderThumb$1$1.changed(background-bw27NRU) ? 4 : 2;
            $dirty |= i14;
        }
        if (unbox-impl & 48 == 0) {
            i4 = $i$a$CacheSliderKt$SliderThumb$1$1.changed(obj4) ? 32 : 16;
            $dirty |= i4;
        }
        if (unbox-impl & 384 == 0) {
            i5 = $i$a$CacheSliderKt$SliderThumb$1$1.changed(offset) ? 256 : 128;
            $dirty |= i5;
        } else {
            f = offset;
        }
        ...
        if (unbox-impl & 3072 == 0) {
            i6 = $i$a$CacheSliderKt$SliderThumb$1$1.changed(obj5) ? currentCompositeKeyHash : 1024;
            $dirty |= i6;
        }
        if (unbox-impl & 24576 == 0) {
            i22 = $i$a$CacheSliderKt$SliderThumb$1$1.changed(obj6) ? 16384 : 8192;
            $dirty |= i22;
        }
        if (i50 &= unbox-impl == 0) {
            i11 = $i$a$CacheSliderKt$SliderThumb$1$1.changed(z2) ? 131072 : 65536;
            $dirty |= i11;
        }
        if (i51 &= unbox-impl == 0) {
            i13 = $i$a$CacheSliderKt$SliderThumb$1$1.changed(f4) ? 1048576 : 524288;
            $dirty |= i13;
        }
        int i52 = $dirty;
        if ($dirty2 &= i52 == 599186) {
            if (!$i$a$CacheSliderKt$SliderThumb$1$1.getSkipping()) {
                ...
                if (rememberedValue2 == Composer.Companion.getEmpty()) {
                    ...
                    it$iv2 = composer8;
                    $i$a$CacheSliderKt$SliderThumb$1$interactions$1 = it$iv3;
                }
                ...
                composer4 = $i$a$LayoutBoxKt$Box$1$iv;
                obj = $this$cache$iv;
                Composer interactions = composer4;
                ...
                SpacerKt.Spacer(BackgroundKt.background-bw27NRU(ShadowKt.shadow-s4CzXII$default(HoverableKt.hoverable$default(IndicationKt.indication(SizeKt.size-VpY3zN4(obj4, f4, f4), (InteractionSource)obj5, RippleKt.rippleOrFallbackImplementation-9IZ8Weo(false, SliderKt.ThumbRippleRadius, 0, i9, composer4, 54)), obj5, false, 2, $i$a$CacheSliderKt$SliderThumb$1$1), f2, (Shape)RoundedCornerShapeKt.getCircleShape(), false, 0, obj45, 0, obj47), (Color)obj6.thumbColor(z2, interactions, i40 |= i47).getValue().unbox-impl(), $i$a$CacheSliderKt$SliderThumb$1$1), interactions, 0);
    ...
    private static final void Track(Modifier modifier, androidx.compose.material.SliderColors colors, boolean enabled, float positionFractionStart, float positionFractionEnd, List<Float> tickFractions, float thumbPx, float trackStrokeWidth, Composer $composer, int $changed) {
        ...
        if (traceInProgress & 6 == 0) {
            i7 = restartGroup.changed(obj2) ? 4 : 2;
            $dirty |= i7;
        }
        if (traceInProgress & 48 == 0) {
            i9 = restartGroup.changed(empty) ? 32 : 16;
            $dirty |= i9;
        }
        if (traceInProgress & 384 == 0) {
            i8 = restartGroup.changed(z) ? 256 : 128;
            $dirty |= i8;
        }
        if (traceInProgress & 3072 == 0) {
            i2 = restartGroup.changed(positionFractionStart) ? 2048 : 1024;
            $dirty |= i2;
        } else {
            f4 = positionFractionStart;
        }
        if (traceInProgress & 24576 == 0) {
            i13 = restartGroup.changed(positionFractionEnd) ? 16384 : 8192;
            $dirty |= i13;
        } else {
            f2 = positionFractionEnd;
        }
        if (i46 &= traceInProgress == 0) {
            i6 = restartGroup.changedInstance(obj) ? 131072 : 65536;
            $dirty |= i6;
        }
        if (i47 &= traceInProgress == 0) {
            i10 = restartGroup.changed(thumbPx) ? 1048576 : 524288;
            $dirty |= i10;
        } else {
            f3 = thumbPx;
        }
        if (i52 &= traceInProgress == 0) {
            i12 = restartGroup.changed(trackStrokeWidth) ? 8388608 : 4194304;
            $dirty |= i12;
        } else {
            f = trackStrokeWidth;
        }
        if ($dirty & i14 == 4793490) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                ...
                i3 = i16 &= $dirty == 1048576 ? 1 : 0;
                i4 = i59 &= $dirty == 8388608 ? 1 : 0;
                i5 = i61 &= $dirty == 16384 ? 1 : 0;
                ...
                if (i27 |= changed10 == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        empty = 0;
                        i = $dirty;
                        inactiveTrackColor = new SliderKt.Track.1.1(f3, trackColor2, f, f2, f4, trackColor, tickFractions, tickColor, activeTickColor);
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                CanvasKt.Canvas(obj2, (Function1)inactiveTrackColor, restartGroup, i & 14);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
            } else {
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new SliderKt.Track.2(obj2, colors, z, positionFractionStart, positionFractionEnd, tickFractions, thumbPx, trackStrokeWidth, $changed);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
