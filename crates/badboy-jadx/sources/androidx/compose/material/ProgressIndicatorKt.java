...
public final class ProgressIndicatorKt {
    ...
    public static final void CircularProgressIndicator-DUhRLBM(float progress, Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, int $changed, int i9) {
        ...
        float empty;
        Object obj;
        Object $i$a$CacheProgressIndicatorKt$CircularProgressIndicator$1;
        int i4;
        long l3;
        ...
        if (i15 != 0) {
            ...
            if (i48 & 3072 == 0) {
                i21 = restartGroup.changed(backgroundColor) ? 2048 : 1024;
                $dirty |= i21;
            } else {
                f2 = backgroundColor;
            }
        ...
        if ($this$fastCoerceAtLeast$iv$iv != 0) {
            ...
            if (i48 & 24576 == 0) {
                i5 = restartGroup.changed(strokeCap) ? 16384 : 8192;
                $dirty |= i5;
            } else {
                l4 = strokeCap;
            }
        ...
        if (i48 & i56 == 0) {
            if (obj36 & 32 == 0) {
                i16 = restartGroup.changed($changed) ? 131072 : 65536;
            } else {
                i17 = $changed;
            }
            $dirty |= i16;
        ...
        if ($dirty & i57 == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                int i34 = 0;
                stroke = new Stroke((Density)restartGroup.consume((CompositionLocal)CompositionLocalsKt.getLocalDensity()).toPx-0680j_4(f2), 0, i22, 0, 0, 26, 0);
                ...
                if (i40 |= i20 == 0) {
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        ...
                        obj29 = l4;
                        obj27 = anon;
                        super($this$fastCoerceAtLeast$iv$iv, obj29, obj30, $this$CircularProgressIndicator_DUhRLBM_u24lambda_u246, l2, $changed);
                        l5 = obj29;
                        composer.updateRememberedValue((Function1)obj27);
                    } else {
                        $i$a$CacheProgressIndicatorKt$CircularProgressIndicator$1 = rememberedValue;
                        l5 = l4;
                    }
                } else {
                }
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                CanvasKt.Canvas(SizeKt.size-3ABfNKs(ProgressSemanticsKt.progressSemantics$default(obj27, $this$fastCoerceAtLeast$iv$iv, 0, obj30, 6, 0), ProgressIndicatorKt.CircularIndicatorDiameter), (Function1)$i$a$CacheProgressIndicatorKt$CircularProgressIndicator$1, restartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            traceInProgress = new ProgressIndicatorKt.CircularProgressIndicator.2(progress, obj, l3, str, f, l, l2, i8, i48, obj36);
    ...
    public static final void CircularProgressIndicator-LxG7B9w(Modifier modifier, long color, float strokeWidth, long backgroundColor, int strokeCap, Composer $composer, int $changed, int i8) {
        ...
        long $dirty4;
        int changed;
        int $i$a$WithProgressIndicatorKt$CircularProgressIndicator$stroke$2;
        boolean traceInProgress;
        int str;
        int i14;
        long animateFloat2;
        ...
        if (i36 != 0) {
            ...
            if (i44 & 384 == 0) {
                i10 = restartGroup.changed(backgroundColor) ? 256 : 128;
                $dirty |= i10;
            } else {
                animateFloat = backgroundColor;
            }
        ...
        if (i44 & 24576 == 0) {
            if (obj41 & 16 == 0) {
                ...
                $i$a$WithProgressIndicatorKt$CircularProgressIndicator$stroke$2 = $changed;
            }
            $dirty |= changed3;
        } else {
            $i$a$WithProgressIndicatorKt$CircularProgressIndicator$stroke$2 = $changed;
        ...
        if ($dirty & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                if (i44 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (obj41 & 16 != 0) {
                            ...
                            i7 = $dirty;
                            i9 = $i$a$WithProgressIndicatorKt$CircularProgressIndicator$stroke$2;
                            strokeCap2 = animateFloat2;
                            $dirty2 = animateFloat;
                            l3 = size-3ABfNKs;
                        }
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, i7, -1, "androidx.compose.material.CircularProgressIndicator (ProgressIndicator.kt:365)");
                }
                int i38 = 0;
                int i42 = 0;
                ComposerKt.sourceInformationMarkerStart(restartGroup, 2023513938, "CC:CompositionLocal.kt#9igjgp");
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                int i39 = 0;
                Stroke stroke2 = new Stroke((Density)restartGroup.consume((CompositionLocal)CompositionLocalsKt.getLocalDensity()).toPx-0680j_4($dirty2), 0, i9, 0, 0, 26, 0);
                ...
                anon = 1;
                State animateValue = InfiniteTransitionKt.animateValue(infiniteTransition, Integer.valueOf(i46), 5, VectorConvertersKt.getVectorConverter(IntCompanionObject.INSTANCE), AnimationSpecKt.infiniteRepeatable-9IiC70o$default((DurationBasedAnimationSpec)AnimationSpecKt.tween$default(6660, i46, EasingKt.getLinearEasing(), 2, i43), 0, obj35, strokeCap, 6), i72, restartGroup, i28 | i54, 16);
                obj35 = infiniteRepeatable-9IiC70o$default2;
                State animateFloat3 = InfiniteTransitionKt.animateFloat(infiniteTransition, 0, 1133445120, obj35, i72, restartGroup, i50 |= i57, 8);
                int i84 = 0;
                obj32 = infiniteTransition;
                obj35 = infiniteRepeatable-9IiC70o$default3;
                animateFloat2 = InfiniteTransitionKt.animateFloat(obj32, 0, 1133576192, obj35, i84, restartGroup, i60 |= i67, 8);
                obj32 = infiniteTransition2;
                animateFloat = InfiniteTransitionKt.animateFloat(obj32, 0, 1133576192, AnimationSpecKt.infiniteRepeatable-9IiC70o$default((DurationBasedAnimationSpec)AnimationSpecKt.keyframes((Function1)ProgressIndicatorKt.CircularProgressIndicator.startAngle.2.INSTANCE), i84, i89, obj35, 6), 0, restartGroup, i70 |= i75, 8);
                i2 = obj32;
                ComposerKt.sourceInformationMarkerStart(restartGroup, -973296137, "CC(remember):ProgressIndicator.kt#9igjgp");
                i11 = i7 & 7168 == 2048 ? anon : 0;
                i12 = i7 & 896 == 256 ? anon : 0;
                if (i31 ^= 48 > 32) {
                ...
                if (empty == 0) {
                    ...
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        int invalid$iv = 0;
                        anon = new ProgressIndicatorKt.CircularProgressIndicator.3.1(l3, obj22, $this$CircularProgressIndicator_LxG7B9w_u24lambda_u248, f2, strokeCap2, i9, animateValue, animateFloat2, animateFloat, animateFloat3);
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                CanvasKt.Canvas(SizeKt.size-3ABfNKs(ProgressSemanticsKt.progressSemantics(obj2), ProgressIndicatorKt.CircularIndicatorDiameter), (Function1)$i$a$CacheProgressIndicatorKt$CircularProgressIndicator$3, restartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                i5 = i7;
                i14 = $i$a$WithProgressIndicatorKt$CircularProgressIndicator$stroke$2;
                $dirty4 = l3;
                f = f2;
                l = l2;
                $dirty3 = obj2;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new ProgressIndicatorKt.CircularProgressIndicator.4($dirty3, l, strokeCap2, f, $dirty4, $i$a$WithProgressIndicatorKt$CircularProgressIndicator$stroke$2, i14, i44, obj41);
    ...
    public static final void CircularProgressIndicator-MBs18nI(float progress, Modifier modifier, long color, float strokeWidth, Composer $composer, int $changed, int i7) {
        ...
        if ($dirty & 1171 == 1170) {
            if (!restartGroup.getSkipping()) {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.material.CircularProgressIndicator (ProgressIndicator.kt:443)");
                }
                ProgressIndicatorKt.CircularProgressIndicator-DUhRLBM(f3, obj, f2, defaultsInvalid, i2, Color.Companion.getTransparent-0d7_KjU(), obj13, StrokeCap.Companion.getButt-KaPHkGw(), restartGroup);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj2 = obj;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new ProgressIndicatorKt.CircularProgressIndicator.5(progress, obj2, l, l2, f, i20, obj25);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    public static final void CircularProgressIndicator-aM-cp0Q(Modifier modifier, long color, float strokeWidth, Composer $composer, int $changed, int i6) {
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i15 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (obj24 & 2 != 0) {
                            color3 = MaterialTheme.INSTANCE.getColors(restartGroup, 6).getPrimary-0d7_KjU();
                            $dirty &= -113;
                        }
                        if (i14 != 0) {
                ...
                ProgressIndicatorKt.CircularProgressIndicator-LxG7B9w(color3, l3, f, skipping, Color.Companion.getTransparent-0d7_KjU(), obj11, StrokeCap.Companion.getSquare-KaPHkGw(), restartGroup);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                l2 = l3;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new ProgressIndicatorKt.CircularProgressIndicator.6($dirty2, l2, strokeWidth-D9Ej5fM, f2, i15, obj24);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
    ...
    public static final void LinearProgressIndicator-2cYBFYY(Modifier modifier, long color, long backgroundColor, int strokeCap, Composer $composer, int $changed, int i7) {
        ...
        if (i40 & 48 == 0) {
            if (obj45 & 2 == 0) {
                i12 = restartGroup.changed(color) ? 32 : 16;
            } else {
                $dirty5 = color;
            }
            $dirty3 |= i12;
        ...
        if (i40 & 3072 == 0) {
            if (obj45 & 8 == 0) {
                changed3 = restartGroup.changed($changed) ? str : 1024;
            } else {
                i18 = $changed;
            }
            $dirty3 |= changed3;
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i40 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (obj45 & 2 != 0) {
                            $dirty3 &= -113;
                            defaultsInvalid = $dirty5;
                        } else {
                            defaultsInvalid = $dirty5;
                        }
                        if (obj45 & 4 != 0) {
                            backgroundColor4 = Color.copy-wmQWz5c$default(defaultsInvalid, $this$cache$iv, 1047904911, 0, 0, 0, 14);
                            $dirty3 &= -897;
                        } else {
                            backgroundColor4 = str2;
                        }
                        if (obj45 & 8 != 0) {
                            backgroundColor2 = $dirty6;
                            $dirty = butt-KaPHkGw;
                            strokeCap2 = defaultsInvalid;
                            l3 = l2;
                        } else {
                            backgroundColor2 = $dirty3;
                            $dirty = i18;
                            strokeCap2 = defaultsInvalid;
                            l3 = l2;
                        }
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, backgroundColor2, -1, "androidx.compose.material.LinearProgressIndicator (ProgressIndicator.kt:143)");
                }
                int i41 = 0;
                int i49 = 1;
                int i71 = i41;
                ...
                $dirty5 = rememberInfiniteTransition;
                ...
                i6 = 0;
                i4 = 0;
                animateFloat4 = InfiniteTransitionKt.animateFloat($dirty5, 0, 1065353216, AnimationSpecKt.infiniteRepeatable-9IiC70o$default((DurationBasedAnimationSpec)AnimationSpecKt.keyframes((Function1)ProgressIndicatorKt.LinearProgressIndicator.secondLineTail.2.INSTANCE), i6, i4, obj29, i9), i60, restartGroup, i47 | i55, backgroundColor5);
                ...
                if (i58 ^= 384 > i39) {
                    if (!restartGroup.changed(l5)) {
                        i10 = infiniteTransition & 384 == i39 ? i5 : 0;
                    } else {
                    }
                } else {
                    backgroundColor3 = l5;
                ...
                if (i67 ^= 3072 > i35) {
                    if (!restartGroup.changed($dirty)) {
                        i15 = infiniteTransition & 3072 == i35 ? i5 : 0;
                    } else {
                    }
                } else {
                }
                ...
                if (i22 |= changed10 == 0) {
                    ...
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        $dirty = 0;
                        animateFloat = state3;
                        animateFloat3 = state6;
                        firstLineTail$delegate = new ProgressIndicatorKt.LinearProgressIndicator.3.1(backgroundColor3, companion, strokeCap3, strokeCap2, i, animateFloat3, state7, animateFloat, animateFloat4);
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                CanvasKt.Canvas(SizeKt.size-VpY3zN4(ProgressSemanticsKt.progressSemantics(ProgressIndicatorKt.increaseSemanticsBounds(modifier3)), ProgressIndicatorKt.LinearIndicatorWidth, ProgressIndicatorKt.LinearIndicatorHeight), (Function1)firstLineTail$delegate, restartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $dirty2 = modifier3;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new ProgressIndicatorKt.LinearProgressIndicator.4($dirty2, modifier2, color2, l, state3, i19, i40, obj45);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    public static final void LinearProgressIndicator-RIQooxk(Modifier modifier, long color, long backgroundColor, Composer $composer, int $changed, int i6) {
        ...
        if ($dirty & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.material.LinearProgressIndicator (ProgressIndicator.kt:242)");
                }
                ProgressIndicatorKt.LinearProgressIndicator-2cYBFYY(l3, l5, defaultsInvalid, i5, obj11, StrokeCap.Companion.getButt-KaPHkGw(), restartGroup);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                l6 = l5;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new ProgressIndicatorKt.LinearProgressIndicator.6($dirty2, l6, copy-wmQWz5c$default, l2, obj5, i20, obj31);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    public static final void LinearProgressIndicator-_5eSR-E(float progress, Modifier modifier, long color, long backgroundColor, int strokeCap, Composer $composer, int $changed, int i8) {
        ...
        if (i42 & 384 == 0) {
            if (obj33 & 4 == 0) {
                i11 = restartGroup.changed(color) ? 256 : 128;
            } else {
        ...
        if (i42 & 3072 == 0) {
            if (obj33 & 8 == 0) {
                i5 = restartGroup.changed(strokeCap) ? i38 : 1024;
            } else {
                l3 = strokeCap;
            }
            $dirty2 |= i5;
        ...
        if (i42 & 24576 == 0) {
            if (obj33 & 16 == 0) {
                changed2 = restartGroup.changed($changed) ? i18 : 8192;
            } else {
                i12 = $changed;
            }
            $dirty2 |= changed2;
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i42 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (obj33 & 8 != 0) {
                            backgroundColor2 = Color.copy-wmQWz5c$default(l2, obj17, 1047904911, 0, 0, 0, 14);
                            $dirty2 &= -7169;
                        } else {
                            backgroundColor2 = l3;
                        }
                ...
                if (i32 ^= 3072 > i38) {
                    if (!restartGroup.changed(l3)) {
                        i13 = $dirty2 & 3072 == i38 ? companion : 0;
                    } else {
                    }
                } else {
                }
                if (i40 ^= 24576 > i18) {
                    if (!restartGroup.changed(i12)) {
                        i16 = $dirty2 & 24576 == i18 ? companion : 0;
                    } else {
                    }
                } else {
                }
                if (i41 ^= 384 > 256) {
                    if (!restartGroup.changed(backgroundColor3)) {
                        if ($dirty2 & 384 == 256) {
                        } else {
                            companion = 0;
                        }
                ...
                if (i34 |= companion == 0) {
                    ...
                    if (rememberedValue == Composer.Companion.getEmpty()) {
                        $dirty2 = 0;
                        color2 = new ProgressIndicatorKt.LinearProgressIndicator.1.1(l3, l3, i12, $i$f$fastCoerceIn, backgroundColor3, i17);
                ...
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                CanvasKt.Canvas(SizeKt.size-VpY3zN4(ProgressSemanticsKt.progressSemantics$default(ProgressIndicatorKt.increaseSemanticsBounds(modifier3), $i$f$fastCoerceIn, 0, i17, 6, 0), ProgressIndicatorKt.LinearIndicatorWidth, ProgressIndicatorKt.LinearIndicatorHeight), (Function1)color2, restartGroup, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                l4 = l;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new ProgressIndicatorKt.LinearProgressIndicator.2(f, modifier3, backgroundColor3, butt-KaPHkGw, l4, rememberedValue, i6, i42, obj33);
            endRestartGroup.updateScope((Function2)traceInProgress);
        } else {
            modifier4 = modifier3;
            modifier2 = backgroundColor3;
        }
    }
    ...
    public static final void LinearProgressIndicator-eaDK9VM(float progress, Modifier modifier, long color, long backgroundColor, Composer $composer, int $changed, int i7) {
        ...
        if (i23 & 3072 == 0) {
            if (obj32 & 8 == 0) {
                i11 = restartGroup.changed($composer) ? 2048 : 1024;
            } else {
                l4 = $composer;
            }
            $dirty |= i11;
        ...
        if ($dirty & 1171 == i24) {
            if (!restartGroup.getSkipping()) {
                ...
                ProgressIndicatorKt.LinearProgressIndicator-_5eSR-E(f, obj, l3, i24, l5, obj13, StrokeCap.Companion.getButt-KaPHkGw(), restartGroup);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj2 = obj;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress = new ProgressIndicatorKt.LinearProgressIndicator.5(progress, obj2, l2, l7, l6, defaultsInvalid, i23, obj32);
            endRestartGroup.updateScope((Function2)traceInProgress);
        }
    }
    ...
    private static final void drawLinearIndicator-qYKTg0g(DrawScope $this$drawLinearIndicator_u2dqYKTg0g, float startFraction, float endFraction, long color, float strokeWidth, int strokeCap) {
        ...
        i15 = (float)i24;
        final int i25 = height-impl / i15;
        i11 = $this$drawLinearIndicator_u2dqYKTg0g.getLayoutDirection() == LayoutDirection.Ltr ? 1 : 0;
        int i26 = 1065353216;
        i18 = i11 != 0 ? startFraction : i26 - endFraction;
        i18 *= width-impl;
        i14 = i11 != 0 ? endFraction : i26 - startFraction;
        i14 *= width-impl;
        i17 = obj46;
        if (!StrokeCap.equals-impl0(i17, StrokeCap.Companion.getButt-KaPHkGw())) {
            if (Float.compare(height-impl, width-impl) > 0) {
                ...
                i15 = strokeCap / i15;
                rangeTo = RangesKt.rangeTo(i15, width-impl - i15);
                ...
                if (Float.compare(f2, i) > 0) {
                    ...
                    f = floatValue;
                    DrawScope.drawLine-NGM6Ib0$default($this$drawLinearIndicator_u2dqYKTg0g, color, floatValue, OffsetKt.Offset(adjustedBarStart, i25), i, OffsetKt.Offset(floatValue, i25), obj14, strokeCap, i17, 0, 0, 0);
                } else {
                    adjustedBarStart2 = adjustedBarStart;
                    f = floatValue;
                }
