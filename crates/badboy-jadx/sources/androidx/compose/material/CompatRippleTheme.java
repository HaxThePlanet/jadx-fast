...
public final class CompatRippleTheme implements RippleTheme {
    ...
    public static final androidx.compose.material.CompatRippleTheme INSTANCE;
    static {
    ...
    public long defaultColor-WaAFU9c(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.CompatRippleTheme.defaultColor (Ripple.kt:279)");
        }
        int i3 = 0;
        ...
        return RippleDefaults.INSTANCE.rippleColor-5vOe2sY((Color)$composer.consume((CompositionLocal)ContentColorKt.getLocalContentColor()).unbox-impl(), true);
    }
    ...
    public RippleAlpha rippleAlpha(Composer $composer, int $changed) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.CompatRippleTheme.rippleAlpha (Ripple.kt:286)");
        }
        int i3 = 0;
        ComposerKt.sourceInformationMarkerStart($composer, 2023513938, "CC:CompositionLocal.kt#9igjgp");
        ComposerKt.sourceInformationMarkerEnd($composer);
        ...
        $composer.endReplaceGroup();
        return RippleDefaults.INSTANCE.rippleAlpha-DxMtmZc((Color)$composer.consume((CompositionLocal)ContentColorKt.getLocalContentColor()).unbox-impl(), true);
    }
}
