...
public final class CheckboxKt {
    ...
    public static final void Checkbox(boolean checked, Function1<? super Boolean, Unit> onCheckedChange, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, androidx.compose.material.CheckboxColors colors, Composer $composer, int $changed, int i9) {
        ...
        if (i9 & 1 != 0) {
            ...
            if (i33 & 6 == 0) {
                i8 = restartGroup.changed(z3) ? 4 : 2;
                $dirty |= i8;
            }
        }
        rememberedValue = 32;
        if (i9 & 2 != 0) {
            ...
            if (i33 & 48 == 0) {
                i2 = restartGroup.changedInstance(obj5) ? rememberedValue : 16;
                $dirty |= i2;
            }
        }
        int i25 = i9 & 4;
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i33 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        enabled2 = i5 != 0 ? 1 : z;
                        obj2 = i10 != 0 ? colors-zjMxDiM : obj4;
                        if (i9 & 32 != 0) {
                            composer = restartGroup;
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.material.Checkbox (Checkbox.kt:91)");
                }
                if (obj5 != null) {
                    ...
                    int i31 = 1;
                    i7 = $dirty & 112 == rememberedValue ? i31 : i4;
                    if ($dirty & 14 == 4) {
                        i4 = i31;
                    }
                    i7 |= i4;
                ...
                CheckboxKt.TriStateCheckbox(ToggleableStateKt.ToggleableState(z3), invalid$iv, z, i10, obj4, obj3, restartGroup, i23 | i30, 0);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            traceInProgress = new CheckboxKt.Checkbox.2(z3, obj5, $dirty2, z2, obj, checkboxColors, i33, i9);
    ...
    private static final void CheckboxImpl(boolean enabled, ToggleableState value, Modifier modifier, androidx.compose.material.CheckboxColors colors, Composer $composer, int $changed) {
        ...
        rememberedValue = 2;
        if (i8 & 6 == 0) {
            i3 = restartGroup.changed(z) ? 4 : rememberedValue;
            $dirty2 |= i3;
        }
        if (i8 & 48 == 0) {
            i11 = restartGroup.changed(obj3) ? 32 : 16;
            $dirty2 |= i11;
        }
        if (i8 & 384 == 0) {
            i6 = restartGroup.changed(obj4) ? 256 : 128;
            $dirty2 |= i6;
        }
        if (i8 & 3072 == 0) {
    ...
    public static final void TriStateCheckbox(ToggleableState state, Function0<Unit> onClick, Modifier modifier, boolean enabled, MutableInteractionSource interactionSource, androidx.compose.material.CheckboxColors colors, Composer $composer, int $changed, int i9) {
        ...
        if (i9 & 1 != 0) {
            ...
            if (i29 & 6 == 0) {
                i7 = restartGroup.changed(state) ? 4 : 2;
                $dirty2 |= i7;
            } else {
                obj2 = state;
            }
        ...
        if (checkboxRippleRadius != 0) {
            ...
            if (i29 & 24576 == 0) {
                i12 = restartGroup.changed(interactionSource) ? 16384 : 8192;
                $dirty2 |= i12;
            } else {
                interactionSource3 = interactionSource;
            }
        ...
        if (i37 &= $dirty2 == i3) {
            if (!restartGroup.getSkipping()) {
                ...
                restartGroup.endDefaults();
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(companion, $dirty, -1, "androidx.compose.material.TriStateCheckbox (Checkbox.kt:137)");
                }
                if (onClick != null) {
                    restartGroup.startReplaceGroup(1923882473);
                    ComposerKt.sourceInformation(restartGroup, "146@6729L136");
                    colors-zjMxDiM = $dirty;
                    $dirty = $dirty2;
                    companion = ToggleableKt.triStateToggleable-O2vRcR0((Modifier)Modifier.Companion, obj2, obj, RippleKt.rippleOrFallbackImplementation-9IZ8Weo(false, CheckboxKt.CheckboxRippleRadius, 0, obj6, restartGroup, 54), $dirty, Role.box-impl(Role.Companion.getCheckbox-o7Vup1c()), onClick);
                ...
                Object obj9 = i8;
                CheckboxKt.CheckboxImpl($dirty2, state, PaddingKt.padding-3ABfNKs(obj3.then(minimumInteractiveComponentSize).then(companion), CheckboxKt.CheckboxDefaultPadding), obj9, restartGroup, i18 | i25);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                obj5 = obj9;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            companion = new CheckboxKt.TriStateCheckbox.1(state, onClick, obj7, colors2, obj4, obj5, i29, i9);
    ...
    private static final void drawBox-1wkBAMs(DrawScope $this$drawBox_u2d1wkBAMs, long boxColor, long borderColor, float radius, float strokeWidth) {
        ...
        if (Color.equals-impl0(boxColor, borderColor)) {
            ...
            DrawScope.drawRoundRect-u-Aw5IA$default(obj2, boxColor, obj27, OffsetKt.Offset(i14, i14), obj29, SizeKt.Size(width-impl - i27, width-impl - i17), obj31, CornerRadiusKt.CornerRadius$default(Math.max(i24, f - i14), i24, i26, i22), obj33, (DrawStyle)Fill.INSTANCE, i6);
            DrawScope.drawRoundRect-u-Aw5IA$default(obj2, radius, obj27, OffsetKt.Offset(i29, i29), obj29, SizeKt.Size(width-impl - i14, width-impl - i14), obj31, CornerRadiusKt.CornerRadius$default(f - i29, i24, i26, i22), obj33, (DrawStyle)stroke2, i6);
        }
    }
