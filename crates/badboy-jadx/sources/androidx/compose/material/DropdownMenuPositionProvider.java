...
public final class DropdownMenuPositionProvider implements PopupPositionProvider {
    ...
    public long calculatePosition-llwVHH4(IntRect anchorBounds, long windowSize, LayoutDirection layoutDirection, long popupContentSize) {
        ...
        int i10 = 0;
        i3 = 1;
        i = layoutDirection2 == LayoutDirection.Ltr ? i3 : -1;
        roundToPx-0680j_4 *= i;
        int i11 = 0;
        ...
        if (layoutDirection2 == LayoutDirection.Ltr) {
            ...
            arr2[intValue3] = Integer.valueOf(i12);
            arr2[i3] = Integer.valueOf(i15);
            i4 = anchorBounds.getLeft() >= 0 ? i16 : i17;
            arr2[i22] = Integer.valueOf(i4);
            sequenceOf = SequencesKt.sequenceOf(arr2);
        } else {
            Integer[] arr = new Integer[width-impl2];
            arr[intValue3] = Integer.valueOf(i15);
            arr[i3] = Integer.valueOf(i12);
        ...
        while (iterator.hasNext()) {
            intValue4 = (Number)iterator.next().intValue();
            next2 = 0;
            if (intValue4 >= 0) {
            } else {
            }
            ...
            i3 = i6;
            i7 = width-impl2;
            if (intValue4 + width-impl7 <= IntSize.getWidth-impl(windowSize)) {
            } else {
            }
            i3 = i6;
        }
        ...
        arr3[intValue3] = Integer.valueOf(Math.max(bottom += $this$calculatePosition_llwVHH4_u24lambda_u242, $this$calculatePosition_llwVHH4_u24lambda_u240));
        arr3[i6] = Integer.valueOf(i21);
        arr3[i22] = Integer.valueOf(i26 += $this$calculatePosition_llwVHH4_u24lambda_u242);
        arr3[i7] = Integer.valueOf(i29 -= $this$calculatePosition_llwVHH4_u24lambda_u240);
        int i32 = 0;
        ...
        while (iterator2.hasNext()) {
            ...
            i7 = 0;
            if (intValue3 >= $this$calculatePosition_llwVHH4_u24lambda_u240) {
            } else {
            }
            ...
            intValue3 = 0;
            if (intValue3 + height-impl7 <= height-impl - verticalMargin) {
            } else {
            }
            layoutDirection2 = i6;
        }
        verticalMargin = $this$calculatePosition_llwVHH4_u24lambda_u240;
        if ((Integer)i2 != 0) {
            intValue = (Integer)i2.intValue();
        } else {
            intValue = i21;
        }
        IntRect intRect = new IntRect(intValue2, intValue, width-impl6 += intValue2, intValue + height-impl6);
