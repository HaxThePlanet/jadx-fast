...
@Metadata(d1 = "\u0000\u0010\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0008\u0003\"\u0010\u0010\u0000\u001a\u0004\u0018\u00010\u0001X\u0082\u000e¢\u0006\u0002\n\u0000\"\u0015\u0010\u0002\u001a\u00020\u0001*\u00020\u00038F¢\u0006\u0006\u001a\u0004\u0008\u0004\u0010\u0005¨\u0006\u0006", d2 = {"_delete", "Landroidx/compose/ui/graphics/vector/ImageVector;", "Delete", "Landroidx/compose/material/icons/Icons$Sharp;", "getDelete", "(Landroidx/compose/material/icons/Icons$Sharp;)Landroidx/compose/ui/graphics/vector/ImageVector;", "material-icons-core_release"}, k = 2, mv = {1, 8, 0}, xi = 48)
public final class DeleteKt {
    ...
    public static final ImageVector getDelete(Icons.Sharp $this$Delete) {
        ...
        int i12 = 0;
        int i13 = 0;
        ImageVector.Builder builder = new ImageVector.Builder("Sharp.Delete", Dp.constructor-impl(1103101952), Dp.constructor-impl(1103101952), 1103101952, 1103101952, 0, obj8, 0, 0, 96, 0);
        int i11 = 0;
        int i15 = 0;
        int i28 = 0;
        ...
        int i39 = 0;
        final int i44 = i;
        int $i$f$materialIcon = 1086324736;
        final ImageVector.Builder builder5 = builder;
        PathBuilder $this$_get_Delete__u24lambda_u241 = builder4;
        $this$_get_Delete__u24lambda_u241.moveTo($i$f$materialIcon, 1101529088);
        ...
        $this$_get_Delete__u24lambda_u241.horizontalLineTo($i$f$materialIcon);
        $this$_get_Delete__u24lambda_u241.verticalLineToRelative(1096810496);
        ...
        $this$_get_Delete__u24lambda_u241.close();
        DeleteKt._delete = ImageVector.Builder.addPath-oIyEayM$default(builder, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, i28, 1065353216, i17, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), i17, 0, 0, 0, 14336, 0).build();
