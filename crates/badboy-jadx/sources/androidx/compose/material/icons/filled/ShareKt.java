...
public final class ShareKt {
    ...
    public static final ImageVector getShare(Icons.Filled $this$Share) {
        ...
        int i20 = -1069547520;
        builder.reflectiveCurveToRelative(i20, 1068205343, i20, 1077936128);
        ...
        int i98 = 1077600584;
        builder6.curveToRelative(0, 1070470267, 1067953684, 1077600584, i98, 1077600584);
        int i64 = 0;
        builder6.curveToRelative(1070470267, i64, 1077600584, -1079529964, i98, -1069883064);
        int i17 = -1069883064;
        builder.reflectiveCurveToRelative(-1079529964, i17, i17, i17);
        builder.close();
        ShareKt._share = ImageVector.Builder.addPath-oIyEayM$default(builder2, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, 0, 1065353216, 1065353216, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), 1065353216, 0, 0, i64, 14336, 0).build();
