...
public final class CreateKt {
    ...
    public static final ImageVector getCreate(Icons.Outlined $this$Create) {
        ...
        int i26 = 1081081856;
        builder.lineToRelative(i26, i26);
        builder.lineToRelative(i23, i22);
        builder6.curveToRelative(1053273620, -1094210028, 1053273620, -1081962660, 0, -1078691103);
        builder6.close();
        CreateKt._create = ImageVector.Builder.addPath-oIyEayM$default(builder2, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, i36, 1065353216, i45, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), i45, 0, 0, 0, 14336, 0).build();
