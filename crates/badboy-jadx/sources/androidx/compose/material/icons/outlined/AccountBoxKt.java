...
public final class AccountBoxKt {
    ...
    public static final ImageVector getAccountBox(Icons.Outlined $this$AccountBox) {
        ...
        int i96 = 1073741824;
        builder6.curveToRelative(0, 1066192077, 1063675494, 1073741824, i96, 1073741824);
        builder.horizontalLineToRelative(i3);
        builder6.curveToRelative(1066192077, 0, 1073741824, -1083808154, i96, -1073741824);
        ...
        int i98 = 1094713344;
        builder6.curveTo(1090959442, 1099756995, 1092783964, 1099431936, i98, 1099431936);
        ...
        builder6.curveTo(1099536794, 1098954834, 1097575956, 1097859072, i98, 1097859072);
        ...
        int i74 = 0;
        builder6.curveToRelative(1073154621, i74, 1080033280, -1077348925, 1080033280, -1067450368);
        int i25 = 1086324736;
        int i34 = 1094713344;
        builder.reflectiveCurveTo(1096737096, i25, i34, i25);
        builder6.curveToRelative(-1074329027, i74, -1067450368, 1070134723, -1067450368, 1080033280);
        int i26 = 1095761920;
        builder.reflectiveCurveTo(1092689592, i26, i34, i26);
        builder.close();
        builder.moveTo(1094713344, 1090519040);
        builder6.curveToRelative(1062501089, i74, 1069547520, 1059816735, 1069547520, 1069547520);
        int i28 = 1093664768;
        builder.reflectiveCurveTo(1095583662, i28, i34, i28);
        int i29 = -1077936128;
        builder.reflectiveCurveToRelative(i29, -1087666913, i29, i29);
        int i30 = 1090519040;
        builder.reflectiveCurveTo(1093843026, i30, i34, i30);
        builder.close();
        AccountBoxKt._accountBox = ImageVector.Builder.addPath-oIyEayM$default(builder2, pathBuilder.getNodes(), VectorKt.getDefaultFillType(), "", (Brush)solidColor, 1065353216, 0, 1065353216, 1065353216, StrokeCap.Companion.getButt-KaPHkGw(), StrokeJoin.Companion.getBevel-LxFBmk8(), 1065353216, 0, 0, i74, 14336, 0).build();
