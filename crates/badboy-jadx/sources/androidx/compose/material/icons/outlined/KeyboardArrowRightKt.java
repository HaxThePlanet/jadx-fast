...
public final class KeyboardArrowRightKt {
    ...
    public static final ImageVector getKeyboardArrowRight(Icons.Outlined $this$KeyboardArrowRight) {
        ...
        int i12 = 0;
        int i13 = 0;
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.KeyboardArrowRight", Dp.constructor-impl(1103101952), Dp.constructor-impl(1103101952), 1103101952, 1103101952, 0, obj8, 0, 0, 96, 0);
        int i11 = 0;
        int i15 = 0;
        int i21 = 0;
    ...
    @Deprecated(message = "Use the AutoMirrored version at Icons.AutoMirrored.Outlined.KeyboardArrowRight", replaceWith = @ReplaceWith(...))
    public static void getKeyboardArrowRight$annotations(Icons.Outlined icons$Outlined) {
    }
}
