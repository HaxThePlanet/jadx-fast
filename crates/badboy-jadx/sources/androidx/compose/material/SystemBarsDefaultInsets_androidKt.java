...
public final class SystemBarsDefaultInsets_androidKt {
    public static final WindowInsets getSystemBarsForVisualComponents(WindowInsets.Companion $this$systemBarsForVisualComponents, Composer $composer, int $changed) {
        ...
        String str;
        int i = -1520067638;
        ComposerKt.sourceInformationMarkerStart($composer, i, "C24@919L10:SystemBarsDefaultInsets.android.kt#jmzs0o");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(i, $changed, -1, "androidx.compose.material.<get-systemBarsForVisualComponents> (SystemBarsDefaultInsets.android.kt:24)");
        }
        if (ComposerKt.isTraceInProgress()) {
