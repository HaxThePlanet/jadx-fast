...
public final class MenuKt {
    ...
    public static final void DropdownMenuContent(MutableTransitionState<Boolean> expandedStates, MutableState<TransformOrigin> transformOriginState, ScrollState scrollState, Modifier modifier, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i8) {
        ...
        if (i8 & 2 != 0) {
            ...
            if (transitionAnimation & 48 == 0) {
                i12 = restartGroup.changed(obj3) ? 32 : 16;
                $dirty |= i12;
            }
        }
        if (i8 & 4 != 0) {
            ...
            if (transitionAnimation & 384 == 0) {
                i4 = restartGroup.changed(obj4) ? 256 : 128;
                $dirty |= i4;
            }
        }
        graphicsLayer = i8 & 8;
        ...
        if ($dirty & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                i2 = (Boolean)transition5.getCurrentState().booleanValue() ? 1065353216 : 1061997773;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                $composer2.endReplaceGroup();
                initialValue$iv$iv = Float.valueOf(i2);
                ...
                i19 = 0;
                ComposerKt.sourceInformationMarkerStart(restartGroup, -142660079, "CC(animateValue)P(3,2)1883@77007L32,1884@77062L31,1885@77118L23,1887@77154L89:Transition.kt#pdpnli");
                it = (Boolean)transition4.getCurrentState().booleanValue();
                ...
                i3 = obj31 != null ? 1065353216 : 0;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer4.endReplaceGroup();
                it3 = (Boolean)transition4.getTargetState().booleanValue();
                ...
                i15 = obj31 != null ? 1065353216 : traceInProgress;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer5.endReplaceGroup();
                androidx.compose.material.MenuKt.DropdownMenuContent.alpha.2 targetValue$iv$iv2 = iNSTANCE2;
                transitionAnimation = TransitionKt.createTransitionAnimation(transition4, Float.valueOf(i3), Float.valueOf(i15), (FiniteAnimationSpec)(Function3)iNSTANCE2.invoke(transition4.getSegment(), restartGroup, Integer.valueOf(i68 &= 112)), VectorConvertersKt.getVectorConverter(FloatCompanionObject.INSTANCE), "FloatAnimation", restartGroup, i81 |= i27);
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                ComposerKt.sourceInformationMarkerStart(restartGroup, 668225020, "CC(remember):Menu.kt#9igjgp");
                int i51 = 1;
                i21 = i17 & 112 == 32 ? i51 : 0;
                ...
                i7 = 895555282;
                composer = composer2;
                CardKt.Card-F-jzlyU(GraphicsLayerModifierKt.graphicsLayer((Modifier)Modifier.Companion, (Function1)anon), 0, 0, i7, 0, 0, 0, MenuKt.MenuElevation, (Function2)ComposableLambdaKt.rememberComposableLambda(i7, i51, anon2, restartGroup, 54), composer);
    ...
    public static final void DropdownMenuItemContent(Function0<Unit> onClick, Modifier modifier, boolean enabled, PaddingValues contentPadding, MutableInteractionSource interactionSource, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i9) {
        ...
        if (i49 &= $dirty == 74898) {
            if (!restartGroup.getSkipping()) {
                ...
                interactionSource2 = rowMeasurePolicy != 0 ? 0 : obj7;
                if (ComposerKt.isTraceInProgress()) {
                ...
                z = z3;
                Modifier padding = PaddingKt.padding(SizeKt.sizeIn-qDBjuR0$default(SizeKt.fillMaxWidth$default(ClickableKt.clickable-O2vRcR0$default(obj7, skipping, RippleKt.rippleOrFallbackImplementation-9IZ8Weo(true, 0, 0, rowMeasurePolicy, restartGroup, 6), z3, 0, 0, obj, 24, i62), 0, 1, 0), MenuKt.DropdownMenuItemDefaultMinWidth, MenuKt.DropdownMenuItemDefaultMinHeight, MenuKt.DropdownMenuItemDefaultMaxWidth, 0, 8, i62), contentPadding2);
        ...
        if (endRestartGroup != null) {
            $dirty2 = obj37;
            traceInProgress2 = new MenuKt.DropdownMenuItemContent.2(onClick, obj4, z2, obj5, obj3, obj9, i37, i9);
    ...
    public static final long calculateTransformOrigin(IntRect parentBounds, IntRect menuBounds) {
        ...
        return TransformOriginKt.TransformOrigin(i3, i2);
    }
