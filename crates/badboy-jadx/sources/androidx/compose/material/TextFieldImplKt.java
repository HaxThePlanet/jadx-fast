...
public final class TextFieldImplKt {
    ...
    public static final void CommonDecorationBox(androidx.compose.material.TextFieldType type, String value, Function2<? super Composer, ? super Integer, Unit> innerTextField, VisualTransformation visualTransformation, Function2<? super Composer, ? super Integer, Unit> label, Function2<? super Composer, ? super Integer, Unit> placeholder, Function2<? super Composer, ? super Integer, Unit> leadingIcon, Function2<? super Composer, ? super Integer, Unit> trailingIcon, boolean singleLine, boolean enabled, boolean isError, InteractionSource interactionSource, PaddingValues contentPadding, Shape shape, androidx.compose.material.TextFieldColors colors, Function2<? super Composer, ? super Integer, Unit> border, Composer $composer, int $changed, int $changed1) {
        ...
        if (i23 & 6 == 0) {
            i4 = restartGroup.changed(type) ? 4 : 2;
            $dirty |= i4;
        } else {
            obj7 = type;
        }
        if (i23 & 48 == 0) {
            i19 = restartGroup.changed(value) ? 32 : changedInstance;
            $dirty |= i19;
        } else {
            obj11 = value;
        }
        i12 = 128;
        if (i23 & 384 == 0) {
            i22 = restartGroup.changedInstance(innerTextField) ? $this$takeOrElse_u2dDxMtmZc$iv2 : i12;
            $dirty |= i22;
        } else {
            obj5 = innerTextField;
        }
        if (i23 & 3072 == 0) {
            i11 = restartGroup.changed(rememberComposableLambda) ? 2048 : $i$f$isSpecified8_81llA2;
            $dirty |= i11;
        }
        caption = 8192;
        if (i23 & 24576 == 0) {
            i16 = restartGroup.changedInstance(obj4) ? subtitle1 : caption;
            $dirty |= i16;
        }
        int i48 = 196608;
        int i58 = 65536;
        if (i23 & i48 == 0) {
            $i$a$WithTextFieldImplKt$CommonDecorationBox$22 = i48;
            i17 = restartGroup.changedInstance(placeholder) ? unbox-impl2 : i58;
            $dirty |= i17;
        } else {
            $i$a$WithTextFieldImplKt$CommonDecorationBox$22 = i48;
            obj9 = placeholder;
        ...
        if (i23 & i60 == 0) {
            i21 = restartGroup.changedInstance(trailingIcon) ? 8388608 : 4194304;
            $dirty |= i21;
        } else {
            obj3 = trailingIcon;
        }
        ...
        if ($changed & i62 == 0) {
            i10 = restartGroup.changed(z2) ? 536870912 : 268435456;
            $dirty |= i10;
        }
        if (i33 & 6 == 0) {
            i19 = restartGroup.changed(z) ? 4 : 2;
            $dirty1 |= i19;
        }
        if (i33 & 48 == 0 && restartGroup.changed(obj6)) {
        ...
        if (i33 & 384 == 0) {
            if (restartGroup.changed(contentPadding)) {
                ...
                $this$takeOrElse_u2dDxMtmZc$iv2 = i12;
            }
        ...
        if (i33 & 3072 == 0) {
            if (restartGroup.changed(shape)) {
                $i$f$isSpecified8_81llA2 = 2048;
            }
            $dirty1 |= $i$f$isSpecified8_81llA2;
        } else {
            obj = shape;
        }
        if (i33 & 24576 == 0) {
        ...
        if (i33 & $i$a$WithTextFieldImplKt$CommonDecorationBox$22 == 0) {
        ...
        if ($dirty & i18 == 306783378 && i32 &= $dirty1 == 74898) {
            if (i32 &= $dirty1 == 74898) {
                if (!restartGroup.getSkipping()) {
                    ...
                    int i51 = 0;
                    i7 = $dirty & 112 == 32 ? 1 : i51;
                    i13 = $dirty & 7168 == 2048 ? 1 : i51;
                    Composer composer2 = restartGroup;
                    int i54 = 0;
                    Object rememberedValue = composer2.rememberedValue();
                    int i57 = 0;
                    if (annotatedString | i13 == 0) {
                        if (rememberedValue == Composer.Companion.getEmpty()) {
                            int i41 = 0;
                            annotatedString = new AnnotatedString(obj11, 0, 0, 6, 0);
                    ...
                    boolean booleanValue = (Boolean)FocusInteractionKt.collectIsFocusedAsState(obj6, restartGroup, i36 &= 14).getValue().booleanValue();
                    if (booleanValue) {
                        unfocusedNotEmpty = InputPhase.Focused;
                    } else {
                        i3 = (CharSequence)text2.length() == 0 ? 1 : i51;
                        unfocusedNotEmpty = i3 != 0 ? InputPhase.UnfocusedEmpty : InputPhase.UnfocusedNotEmpty;
                    }
                    TextFieldImplKt.CommonDecorationBox.labelColor.1 anon2 = new TextFieldImplKt.CommonDecorationBox.labelColor.1(obj2, z2, z, obj6);
                    i14 = booleanValue;
                    ...
                    if (Color.equals-impl0(subtitle1.getColor-0d7_KjU(), unfocusedNotEmpty)) {
                        if (Color.equals-impl0(caption.getColor-0d7_KjU(), unfocusedNotEmpty)) {
                            if (!Color.equals-impl0(subtitle1.getColor-0d7_KjU(), unfocusedNotEmpty) && Color.equals-impl0(caption.getColor-0d7_KjU(), unfocusedNotEmpty)) {
                                i22 = Color.equals-impl0(caption.getColor-0d7_KjU(), unfocusedNotEmpty) ? 1 : i51;
                            } else {
                            }
                        } else {
                        }
                    ...
                    if (i22 != 0) {
                        ...
                        int i52 = 0;
                        $i$f$isSpecified8_81llA = Long.compare(l, unbox-impl2) != 0 ? 1 : i51;
                        if ($i$f$isSpecified8_81llA != 0) {
                            field = iNSTANCE2;
                            i5 = inputPhase;
                        } else {
                            $i$f$isSpecified8_81llA = 0;
                            $i$f$isSpecified8_81llA2 = typography;
                            field = iNSTANCE2;
                    ...
                    $i$a$WithTextFieldImplKt$CommonDecorationBox$2 = 0;
                    if (i22 != 0) {
                        restartGroup.startReplaceGroup(-1572659596);
                        ComposerKt.sourceInformation(restartGroup, "*116@4633L22");
                        i = 0;
                        int i53 = 0;
                        $i$f$isSpecified8_81llA2 = Long.compare(unbox-impl, unbox-impl2) != 0 ? 1 : i51;
                        if ($i$f$isSpecified8_81llA2 != 0) {
                            i9 = $i$a$WithTextFieldImplKt$CommonDecorationBox$2;
                        } else {
                        ...
                        restartGroup.endReplaceGroup();
                        $i$a$WithTextFieldImplKt$CommonDecorationBox$22 = $this$takeOrElse_u2dDxMtmZc$iv2;
                    } else {
                        int $i$a$WithTextFieldImplKt$CommonDecorationBox$23 = $i$a$WithTextFieldImplKt$CommonDecorationBox$2;
                        restartGroup.startReplaceGroup(780554381);
                        restartGroup.endReplaceGroup();
                        $i$a$WithTextFieldImplKt$CommonDecorationBox$22 = color-0d7_KjU6;
                    }
                    restartGroup.endReplaceGroup();
                    i2 = label != null ? 1 : i51;
                    i6 = $dirty;
                    i15 = $dirty1;
                    obj7 = str8;
                    TextFieldImplKt.CommonDecorationBox.3 anon = new TextFieldImplKt.CommonDecorationBox.3(label, obj9, obj7, obj2, z2, z, obj6, leadingIcon, trailingIcon, shape, obj7, obj5, singleLine, contentPadding, i22, border);
                    changed = obj7;
                    obj11 = restartGroup;
                    field.Transition-DTcfvLk(i5, $this$takeOrElse_u2dDxMtmZc$iv, obj7, $i$a$WithTextFieldImplKt$CommonDecorationBox$22, z2, anon2, i2, (Function6)ComposableLambdaKt.rememberComposableLambda(225557475, true, anon, restartGroup, 54));
                    composer = obj11;
                    if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void Decoration-euL9pac(long contentColor, TextStyle typography, Float contentAlpha, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i7) {
        ...
        traceInProgress = obj17 & 2;
        if (traceInProgress != 0) {
            $dirty |= 48;
        } else {
            if (i16 & 48 == 0) {
                i5 = restartGroup.changed(contentAlpha) ? 32 : 16;
                $dirty |= i5;
            }
        }
        str = obj17 & 4;
        if (str != null) {
            ...
            if (i16 & 384 == 0) {
                i6 = restartGroup.changed(content) ? 256 : 128;
                $dirty |= i6;
            }
        }
        if (obj17 & 8 != 0) {
            ...
            if (i16 & 3072 == 0) {
                i4 = restartGroup.changedInstance($composer) ? 2048 : 1024;
                $dirty |= i4;
            }
        }
        final int i17 = $dirty;
        ...
        if (obj12 != null) {
            rememberComposableLambda = new TextFieldImplKt.Decoration.1(contentColor, traceInProgress, obj3, obj, $composer, i16, obj17);
