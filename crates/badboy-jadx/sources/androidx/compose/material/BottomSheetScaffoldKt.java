...
public final class BottomSheetScaffoldKt {
    ...
    private static final void BottomSheet-dAqlCkY(androidx.compose.material.BottomSheetState state, boolean sheetGesturesEnabled, Shape sheetShape, float sheetElevation, long sheetBackgroundColor, long sheetContentColor, float sheetPeekHeight, Modifier modifier, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int i12) {
        ...
        if (i64 & 1 != 0) {
            ...
            if (i63 & 6 == 0) {
                i7 = traceInProgress.changed(obj5) ? 4 : 2;
                $dirty |= i7;
            }
        }
        if (i64 & 2 != 0) {
            ...
            if (i63 & 48 == 0) {
                i13 = traceInProgress.changed(sheetGesturesEnabled) ? 32 : 16;
                $dirty |= i13;
            } else {
                z = sheetGesturesEnabled;
            }
        ...
        if (i64 & 4 != 0) {
            ...
            if (i63 & 384 == 0) {
                i18 = traceInProgress.changed(sheetShape) ? 256 : 128;
                $dirty |= i18;
            } else {
                obj2 = sheetShape;
            }
        ...
        if (i64 & 8 != 0) {
            ...
            if (i63 & 3072 == 0) {
                i4 = traceInProgress.changed(sheetElevation) ? 2048 : 1024;
                $dirty |= i4;
            } else {
                f = sheetElevation;
            }
        ...
        if (i64 & 16 != 0) {
            ...
            if (i63 & 24576 == 0) {
                i10 = traceInProgress.changed(sheetBackgroundColor) ? 16384 : 8192;
                $dirty |= i10;
            } else {
                semantics$default = sheetBackgroundColor;
            }
        ...
        if (i64 & 32 != 0) {
            ...
            if (i63 & i59 == 0) {
                i15 = traceInProgress.changed(sheetPeekHeight) ? 131072 : 65536;
                $dirty |= i15;
            } else {
                l = sheetPeekHeight;
            }
        ...
        if (i64 & 64 != 0) {
            ...
            if (i63 & i60 == 0) {
                i9 = traceInProgress.changed(rememberedValue) ? 1048576 : 524288;
                $dirty |= i9;
            }
        }
        str = i64 & 128;
        ...
        if (str != null) {
            ...
            if (i63 & i == 0) {
                i19 = i60;
                i = traceInProgress.changed($composer) ? 8388608 : 4194304;
                $dirty |= i;
            } else {
                i19 = i60;
                obj4 = $composer;
        ...
        if ($dirty3 &= $this$BottomSheet_dAqlCkY_u24lambda_u243 == 38347922) {
            if (!traceInProgress.getSkipping()) {
                ...
                int i53 = i23;
                int i61 = 0;
                i3 = $this$BottomSheet_dAqlCkY_u24lambda_u243;
                ...
                if (compositionCoroutineScope == Composer.Companion.getEmpty()) {
                    ...
                    composer$iv2 = new CompositionScopedCoroutineScopeCanceller(EffectsKt.createCompositionCoroutineScope((CoroutineContext)EmptyCoroutineContext.INSTANCE, composer2));
                    composer3.updateRememberedValue(composer$iv2);
                } else {
                    composer$iv = composer2;
                    composer$iv2 = obj3;
                }
                ComposerKt.sourceInformationMarkerEnd(traceInProgress);
                coroutineScope = (CompositionScopedCoroutineScopeCanceller)composer$iv2.getCoroutineScope();
                ComposerKt.sourceInformationMarkerEnd(traceInProgress);
                int i27 = 0;
                int i36 = 0;
        ...
        if (endRestartGroup != null) {
            $this$BottomSheet_dAqlCkY_u24lambda_u243 = new BottomSheetScaffoldKt.BottomSheet.4(obj5, sheetGesturesEnabled, sheetShape, sheetElevation, sheetBackgroundColor, obj2, sheetPeekHeight, str, content, obj4, obj7, i63, i64);
    ...
    public static final void BottomSheetScaffold-HnlDQGw(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> sheetContent, Modifier modifier, androidx.compose.material.BottomSheetScaffoldState scaffoldState, Function2<? super Composer, ? super Integer, Unit> topBar, Function3<? super androidx.compose.material.SnackbarHostState, ? super Composer, ? super Integer, Unit> snackbarHost, Function2<? super Composer, ? super Integer, Unit> floatingActionButton, int floatingActionButtonPosition, boolean sheetGesturesEnabled, Shape sheetShape, float sheetElevation, long sheetBackgroundColor, long sheetContentColor, float sheetPeekHeight, long backgroundColor, long contentColor, Function3<? super PaddingValues, ? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed, int $changed1, int i20) {
        ...
        int sheetPeekHeight2;
        androidx.compose.foundation.shape.CornerBasedShape $dirty17;
        ...
        androidx.compose.foundation.shape.CornerBasedShape $dirty12;
        Object obj5;
        ...
        if (i54 & 1 != 0) {
            ...
            if (i27 & 6 == 0) {
                i19 = restartGroup.changedInstance(sheetContent) ? 4 : 2;
                $dirty5 |= i19;
            } else {
                obj4 = sheetContent;
            }
        ...
        if (surface-0d7_KjU != 0) {
            ...
            if (i27 & 3072 == 0) {
                i2 = restartGroup.changedInstance(topBar) ? changed6 : i75;
                $dirty5 |= i2;
            } else {
                sheetShape2 = topBar;
            }
        ...
        if (i76 != 0) {
            ...
            if (i27 & 24576 == 0) {
                i10 = restartGroup.changedInstance(snackbarHost) ? i24 : i21;
                $dirty5 |= i10;
            } else {
                obj6 = snackbarHost;
            }
        ...
        if (i9 != 0) {
            ...
            if (i27 & i77 == 0) {
                i11 = restartGroup.changedInstance(floatingActionButton) ? 131072 : 65536;
                $dirty5 |= i11;
            } else {
                obj5 = floatingActionButton;
            }
        ...
        if (i80 != 0) {
            $dirty5 |= i81;
            i8 = floatingActionButtonPosition;
        } else {
            if (i27 & i81 == 0) {
                i3 = restartGroup.changed(floatingActionButtonPosition) ? 1048576 : 524288;
                $dirty5 |= i3;
            } else {
                i8 = floatingActionButtonPosition;
            }
        ...
        if (sheetElevation2 != 0) {
            ...
            if (i27 & i18 == 0) {
                i7 = restartGroup.changed(sheetGesturesEnabled) ? 8388608 : 4194304;
                $dirty5 |= i7;
            } else {
                z = sheetGesturesEnabled;
            }
        ...
        if (i27 & i82 == 0) {
            if (i54 & 256 == 0) {
                changed4 = restartGroup.changed(sheetShape) ? 67108864 : 33554432;
            } else {
                obj = sheetShape;
            }
            $dirty5 |= changed4;
        ...
        if (obj54 & i83 == 0) {
            if (i54 & 512 == 0) {
                changed5 = restartGroup.changed(sheetElevation) ? 536870912 : 268435456;
            } else {
                f = sheetElevation;
            }
            $dirty5 |= changed5;
        ...
        if (i12 & 6 == 0) {
            if (i54 & 1024 == 0) {
                $dirty1 = i61;
                i4 = restartGroup.changed(sheetBackgroundColor) ? 4 : 2;
            } else {
                $dirty1 = i61;
                $dirty15 = sheetBackgroundColor;
            }
            $dirty1 |= i4;
        } else {
            $dirty110 = i61;
        ...
        if (i12 & 48 == 0) {
            if (i54 & 2048 == 0) {
                i15 = restartGroup.changed(sheetPeekHeight) ? 32 : 16;
            } else {
                l = sheetPeekHeight;
            }
            $dirty110 = obj53 | i15;
        ...
        if (i12 & 384 == 0) {
            if (i54 & 4096 == 0) {
                i3 = restartGroup.changed(contentColor) ? 256 : 128;
            } else {
        ...
        if (i54 & i74 != 0) {
            ...
            if (obj55 & i77 == 0) {
                i12 = restartGroup.changedInstance(i20) ? 131072 : 65536;
                $dirty19 |= i12;
            } else {
                obj2 = i20;
            }
        }
        if (i46 &= $dirty5 == 306783378 && $dirty19 & i43 == 74898) {
            if ($dirty19 & i43 == 74898) {
                if (!restartGroup.getSkipping()) {
                    ...
                    if (obj54 & 1 != 0) {
                        if (restartGroup.getDefaultsInvalid()) {
                            ...
                            topBar3 = surface-0d7_KjU != 0 ? 0 : sheetShape2;
                            if (i76 != 0) {
                                obj6 = sheetShape2;
                            }
                            if (i9 != 0) {
                            ...
                            if (i54 & 2048 != 0) {
                                sheetContentColor2 = ColorsKt.contentColorFor-ek8zF_U(composer2, obj5, restartGroup);
                                $dirty14 = $dirty19;
                            } else {
                            ...
                            if (i54 & 8192 != 0) {
                                obj38 = $dirty5;
                                $dirty = MaterialTheme.INSTANCE.getColors(restartGroup, 6).getBackground-0d7_KjU();
                                $dirty14 &= -7169;
                            } else {
                                obj38 = $dirty5;
                                $dirty = l2;
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        obj42 = $dirty17;
                        obj38 = $dirty16;
                        ComposerKt.traceEventStart(-423121424, i25, sheetBackgroundColor3, "androidx.compose.material.BottomSheetScaffold (BottomSheetScaffold.kt:347)");
                    } else {
                        obj42 = $dirty17;
                        obj38 = $dirty16;
                    }
                    ...
                    super(obj7, sheetShape2, obj37, obj38, obj39, i20, z, obj42, sheetElevation2, obj44, sheetPeekHeight, obj46, contentColor, sheetContent, obj6);
                    obj43 = restartGroup;
                    obj36 = contentColor2;
                    obj38 = i24;
                    SurfaceKt.Surface-F-jzlyU(SizeKt.fillMaxSize$default(obj8, 0, i50, 0), 0, obj36, obj37, obj38, obj39, 0, 0, (Function2)ComposableLambdaKt.rememberComposableLambda(-131096268, i50, anon, restartGroup, 54), obj43);
                    l4 = obj38;
                    composer = obj43;
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventEnd();
                    ...
                    sheetPeekHeight3 = obj6;
                    snackbarHost2 = z2;
                    i14 = i25;
                    $dirty2 = sheetShape2;
                    i17 = sheetBackgroundColor3;
                    $dirty3 = obj5;
                    topBar2 = i8;
                    obj3 = obj8;
                    $composer2 = obj7;
        ...
        if (endRestartGroup != null) {
            endRestartGroup = new BottomSheetScaffoldKt.BottomSheetScaffold.2(sheetContent, obj3, $composer2, $dirty2, sheetPeekHeight3, $dirty3, topBar2, snackbarHost2, $dirty12, floatingActionButton2, floatingActionButtonPosition2, obj8, scaffoldState2, sheetElevation2, sheetGesturesEnabled2, sheetBackgroundColor2, i13, l4, i76, i20, obj54, obj55, obj56);
    ...
    private static final void BottomSheetScaffoldLayout-HJHHjMs(Function2<? super Composer, ? super Integer, Unit> topBar, Function2<? super Composer, ? super Integer, Unit> body, Function2<? super Composer, ? super Integer, Unit> bottomSheet, Function2<? super Composer, ? super Integer, Unit> floatingActionButton, Function2<? super Composer, ? super Integer, Unit> snackbarHost, float sheetPeekHeight, Function0<Float> sheetOffset, int floatingActionButtonPosition, androidx.compose.material.BottomSheetState sheetState, Composer $composer, int $changed) {
        ...
        if (i35 & 6 == 0) {
            i7 = restartGroup.changedInstance(valueOf) ? 4 : 2;
            $dirty |= i7;
        }
        if (i35 & 48 == 0) {
            i17 = restartGroup.changedInstance(setCompositeKeyHash) ? 32 : 16;
            $dirty |= i17;
        }
        if (i35 & 384 == 0) {
        ...
        if (i35 & 3072 == 0) {
            i5 = restartGroup.changedInstance(constructor-impl) ? 2048 : 1024;
            $dirty |= i5;
        }
        if (i35 & 24576 == 0) {
            i18 = restartGroup.changedInstance(obj2) ? 16384 : 8192;
            $dirty |= i18;
        }
        if (i36 &= i35 == 0) {
            i4 = restartGroup.changed(f) ? 131072 : 65536;
            $dirty |= i4;
        }
        companion = 1048576;
        if (i37 &= i35 == 0) {
            i6 = restartGroup.changedInstance(obj3) ? companion : 524288;
            $dirty |= i6;
        }
        if (i38 &= i35 == 0) {
            i20 = restartGroup.changed(i34) ? 8388608 : 4194304;
            $dirty |= i20;
        }
        if (i39 &= i35 == 0) {
            i22 = restartGroup.changed(obj4) ? 67108864 : 33554432;
            $dirty |= i22;
        }
        if (i40 &= $dirty == 38347922) {
            if (!restartGroup.getSkipping()) {
                ...
                i16 = i43 &= $dirty == companion ? 1 : i60;
                i21 = i48 &= $dirty == 8388608 ? 1 : i60;
                i = i50 &= $dirty == 131072 ? 1 : i60;
                i14 = i52 &= $dirty == 67108864 ? 1 : i60;
                ...
                if (!composer.getInserting()) {
                    ...
                    if (!Intrinsics.areEqual(composer.rememberedValue(), Integer.valueOf(i9))) {
