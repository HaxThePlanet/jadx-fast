...
final class TwoLine {
    ...
    public final void ListItem(Modifier modifier, Function2<? super Composer, ? super Integer, Unit> icon, Function2<? super Composer, ? super Integer, Unit> text, Function2<? super Composer, ? super Integer, Unit> secondaryText, Function2<? super Composer, ? super Integer, Unit> overlineText, Function2<? super Composer, ? super Integer, Unit> trailing, Composer $composer, int $changed, int i9) {
        ...
        if (i9 & 4 != 0) {
            ...
            if (i2 & 384 == 0) {
                i22 = restartGroup.changedInstance(obj6) ? 256 : 128;
                $dirty |= i22;
            }
        }
        if (i9 & 8 != 0) {
            ...
            if (i2 & 3072 == 0) {
                i23 = restartGroup.changedInstance(obj7) ? 2048 : 1024;
                $dirty |= i23;
            }
        }
        if (i9 & 16 != 0) {
            ...
            if (i2 & 24576 == 0) {
                i = restartGroup.changedInstance(obj8) ? 16384 : 8192;
                $dirty |= i;
            }
        }
        int i62 = 196608;
        if (i9 & 32 != 0) {
            ...
            if (i2 & i62 == 0) {
                i20 = restartGroup.changedInstance(obj9) ? 131072 : 65536;
                $dirty |= i20;
            }
        }
        i16 = 1572864;
        ...
        if ($dirty2 &= i63 == 599186) {
            if (!restartGroup.getSkipping()) {
                ...
                if (obj8 != null) {
                    ...
                    composer7.endReplaceGroup();
                    i2 = padding-qDBjuR0$default;
                } else {
                    composer7.startReplaceGroup(-1766213598);
                    ComposerKt.sourceInformation(composer7, "251@9572L84,237@8988L668");
                    Dp[] arr2 = new Dp[2];
                    primaryBaselineOffsetNoIcon2 = obj5 != null ? TwoLine.PrimaryBaselineOffsetWithIcon : TwoLine.PrimaryBaselineOffsetNoIcon;
                ...
                if (obj9 != null) {
                    ...
                    listOf = obj5 != null ? primaryBaselineOffsetNoIcon : primaryBaselineOffsetNoIcon;
                ...
                composer5 = restartGroup;
                obj3 = factory$iv$iv$iv2;
            }
        } else {
        }
        ScopeUpdateScope endRestartGroup = composer5.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new TwoLine.ListItem.2(obj2, obj3, obj5, obj6, obj7, obj8, obj9, $changed, i9);
