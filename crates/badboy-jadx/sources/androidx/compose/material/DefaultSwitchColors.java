    ...
    public boolean equals(Object other) {
        ...
        if (other != null) {
            ...
            if (getClass() != class) {
                ...
                Object obj = other;
                if (!Color.equals-impl0(this.checkedThumbColor, class)) {
                    return i2;
                }
                if (!Color.equals-impl0(this.checkedTrackColor, class)) {
                    return i2;
                }
                if (!Color.equals-impl0(this.uncheckedThumbColor, class)) {
                    return i2;
                }
                if (!Color.equals-impl0(this.uncheckedTrackColor, class)) {
                    return i2;
                }
                if (!Color.equals-impl0(this.disabledCheckedThumbColor, class)) {
                    return i2;
                }
                if (!Color.equals-impl0(this.disabledCheckedTrackColor, class)) {
                    return i2;
                }
                if (!Color.equals-impl0(this.disabledUncheckedThumbColor, class)) {
                    return i2;
                }
                if (!Color.equals-impl0(this.disabledUncheckedTrackColor, class)) {
                    return i2;
                }
            }
            return i;
