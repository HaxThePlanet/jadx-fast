...
public final class SnackbarHostKt {
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (!Intrinsics.areEqual(items, (FadeInFadeOutState)invalid$iv.getCurrent())) {
                    ...
                    while (index$iv$iv < empty.size()) {
                        ...
                        maybeCachedBoxMeasurePolicy = i16;
                        mutableList = keys;
                        i13 = i5;
                    }
                    keys = mutableList;
    ...
    public static final void SnackbarHost(androidx.compose.material.SnackbarHostState hostState, Modifier modifier, Function3<? super androidx.compose.material.SnackbarData, ? super Composer, ? super Integer, Unit> snackbar, Composer $composer, int $changed, int i6) {
        ...
        if (i6 & 1 != 0) {
            ...
            if (i12 & 6 == 0) {
                i2 = restartGroup.changed(hostState) ? 4 : 2;
                $dirty |= i2;
            } else {
                obj3 = hostState;
            }
        ...
        if (i7 != 0) {
            ...
            if (i12 & 384 == 0) {
                i3 = restartGroup.changedInstance(snackbar) ? 256 : 128;
                $dirty |= i3;
            } else {
                obj = snackbar;
            }
        ...
        if (i24 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                i7 = modifier2;
                SnackbarHostKt.FadeInFadeOutWithScale(obj3.getCurrentSnackbarData(), i7, obj, restartGroup, i23 |= i19, 0);
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                modifier3 = i7;
        ...
        ScopeUpdateScope endRestartGroup = restartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            currentSnackbarData = new SnackbarHostKt.SnackbarHost.2(obj3, modifier3, obj2, i12, i6);
