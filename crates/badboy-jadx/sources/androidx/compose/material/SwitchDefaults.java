...
public final class SwitchDefaults {
    ...
    public final androidx.compose.material.SwitchColors colors-SQMK_m0(long checkedThumbColor, long checkedTrackColor, float checkedTrackAlpha, long uncheckedThumbColor, long uncheckedTrackColor, float uncheckedTrackAlpha, long disabledCheckedThumbColor, long disabledCheckedTrackColor, long disabledUncheckedThumbColor, long disabledUncheckedTrackColor, Composer $composer, int $changed, int $changed1, int i14) {
        ...
        if (i10 & 128 != 0) {
            ...
            disabledCheckedThumbColor2 = ColorKt.compositeOver--OWjLjI(Color.copy-wmQWz5c$default(checkedTrackColor2, checkedTrackColor, ContentAlpha.INSTANCE.getDisabled(composer, i17), 0, 0, 0, i3), i3);
        } else {
            obj38 = compositeOver--OWjLjI;
        ...
        if (i10 & 256 != 0) {
            ...
            disabledCheckedTrackColor2 = ColorKt.compositeOver--OWjLjI(Color.copy-wmQWz5c$default(uncheckedThumbColor2, checkedTrackColor, ContentAlpha.INSTANCE.getDisabled(composer, i17), 0, 0, 0, i3), i3);
        } else {
            obj40 = disabledCheckedThumbColor2;
        ...
        if (i10 &= 512 != 0) {
            ...
            disabledUncheckedTrackColor2 = ColorKt.compositeOver--OWjLjI(Color.copy-wmQWz5c$default(uncheckedTrackColor2, checkedTrackColor, ContentAlpha.INSTANCE.getDisabled(composer, i17), 0, 0, 0, 14), i3);
        } else {
