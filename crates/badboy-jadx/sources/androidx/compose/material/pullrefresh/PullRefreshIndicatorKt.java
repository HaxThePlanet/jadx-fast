...
public final class PullRefreshIndicatorKt {
    ...
    private static final void CircularArrowIndicator-iJQMabo(androidx.compose.material.pullrefresh.PullRefreshState state, long color, Modifier modifier, Composer $composer, int $changed) {
        ...
        if (i16 & 384 == 0) {
            i5 = restartGroup.changed(obj3) ? 256 : 128;
            $dirty2 |= i5;
        }
        if ($dirty2 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty2, -1, "androidx.compose.material.pullrefresh.CircularArrowIndicator (PullRefreshIndicator.kt:134)");
                }
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new PullRefreshIndicatorKt.CircularArrowIndicator.3(state, color, $dirty, obj3, i16);
    ...
    public static final void PullRefreshIndicator-jB83MbM(boolean refreshing, androidx.compose.material.pullrefresh.PullRefreshState state, Modifier modifier, long backgroundColor, long contentColor, boolean scale, Composer $composer, int $changed, int i9) {
        ...
        if (obj52 & 2 != 0) {
            ...
            if (i51 & 48 == 0) {
                i6 = restartGroup.changedInstance(obj4) ? 32 : 16;
                $dirty2 |= i6;
            }
        }
        i7 = obj52 & 4;
        ...
        if (i51 & 24576 == 0) {
            if (obj52 & 16 == 0) {
                i19 = restartGroup.changed(scale) ? 16384 : 8192;
            } else {
                str = scale;
            }
            $dirty2 |= i19;
            ...
            if (!restartGroup.getSkipping()) {
                ...
                if (i51 & 1 != 0) {
                    if (restartGroup.getDefaultsInvalid()) {
                        ...
                        if (obj52 & 16 != 0) {
                            contentColor2 = ColorsKt.contentColorFor-ek8zF_U(backgroundColor2, obj, restartGroup);
                            $dirty2 &= i66;
                        } else {
                            contentColor2 = str;
                        }
                ...
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress2, $dirty2, -1, "androidx.compose.material.pullrefresh.PullRefreshIndicator (PullRefreshIndicator.kt:82)");
                }
                ...
                Modifier background-bw27NRU = BackgroundKt.background-bw27NRU(ShadowKt.shadow-s4CzXII$default(PullRefreshIndicatorTransformKt.pullRefreshIndicatorTransform(SizeKt.size-3ABfNKs(modifier2, PullRefreshIndicatorKt.IndicatorSize), obj4, z2), f, (Shape)PullRefreshIndicatorKt.SpinnerShape, true, 0, obj25, 0, obj27), unbox-impl, obj);
                int i50 = i14;
                i25 = 0;
                obj45 = consume;
                ...
                Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer3, background-bw27NRU);
                ...
                CrossfadeKt.Crossfade(Boolean.valueOf(refreshing), 0, (FiniteAnimationSpec)AnimationSpecKt.tween$default(100, 0, i37, i2, i37), 0, (Function3)ComposableLambdaKt.rememberComposableLambda(1853731063, true, anon, composer5, 54), composer4, i34 |= 24960, 10);
        ...
        final ScopeUpdateScope endRestartGroup = composer3.endRestartGroup();
        if (endRestartGroup != null) {
            traceInProgress2 = new PullRefreshIndicatorKt.PullRefreshIndicator.2(refreshing, obj4, $composer3, $dirty, i7, color, obj, z3, i51, obj52);
            endRestartGroup.updateScope((Function2)traceInProgress2);
        }
    }
