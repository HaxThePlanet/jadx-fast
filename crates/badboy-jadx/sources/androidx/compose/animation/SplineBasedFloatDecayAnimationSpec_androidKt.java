...
public final class SplineBasedFloatDecayAnimationSpec_androidKt {
    ...
    public static final <T> DecayAnimationSpec<T> rememberSplineBasedDecay(Composer $composer, int $changed) {
        ...
        String str;
        Object $i$a$CacheSplineBasedFloatDecayAnimationSpec_androidKt$rememberSplineBasedDecay$1;
        Object empty;
        ...
        if (!$composer.changed((Density)this_$iv.getDensity())) {
            if (rememberedValue == Composer.Companion.getEmpty()) {
                ...
                $i$a$CacheSplineBasedFloatDecayAnimationSpec_androidKt$rememberSplineBasedDecay$1 = rememberedValue;
            }
        } else {
        }
        ComposerKt.sourceInformationMarkerEnd($composer);
        ...
        ComposerKt.sourceInformationMarkerEnd($composer);
        return (DecayAnimationSpec)$i$a$CacheSplineBasedFloatDecayAnimationSpec_androidKt$rememberSplineBasedDecay$1;
    }
