...
public final class SharedElement {
    ...
    public final void onLookaheadResult-v_w8tDc(androidx.compose.animation.SharedElementInternalState state, long lookaheadSize, long topLeft) {
        ...
        if (state.getBoundsAnimation().getTarget()) {
            ...
            box-impl2 = 0;
            if (rect != null) {
                box-impl = Offset.box-impl(rect.getTopLeft-F1C5BW0());
            } else {
                box-impl = box-impl2;
            }
            if (box-impl == 0) {
                ...
                size-NH-jbRc = Offset.equals-impl0(box-impl.unbox-impl(), obj4);
            }
            if (size-NH-jbRc) {
                size-NH-jbRc = get_targetBounds();
                if (size-NH-jbRc != null) {
                    box-impl2 = Size.box-impl(size-NH-jbRc.getSize-NH-jbRc());
                }
                if (box-impl2 == 0) {
                } else {
                    equals-impl0 = Size.equals-impl0(box-impl2.unbox-impl(), box-impl2);
                }
                if (equals-impl0 == 0) {
                    size-NH-jbRc = RectKt.Rect-tz77jQw(obj14, obj15);
                    set_targetBounds(size-NH-jbRc);
                    box-impl2 = this.states;
                    equals-impl0 = 0;
                    index$iv = 0;
                    while (index$iv < (List)box-impl2.size()) {
                        i = 0;
                        currentBounds = getCurrentBounds();
                        Intrinsics.checkNotNull(currentBounds);
                        (SharedElementInternalState)box-impl2.get(index$iv).getBoundsAnimation().animate(currentBounds, size-NH-jbRc);
                        index$iv++;
                    }
                }
            } else {
