...
public final class VectorizedKeyframesSpec<V extends androidx.compose.animation.core.AnimationVector>  implements androidx.compose.animation.core.VectorizedDurationBasedAnimationSpec<V> {
        ...
        if (this.arcSpline != null) {
            ...
            if (Intrinsics.areEqual(lastInitialValue, initialValue)) {
                ...
                if (!Intrinsics.areEqual(lastTargetValue, targetValue)) {
                    ...
                    arcSpline = new ArcSpline(modes, i3, initialArcMode);
    ...
    public V getValueFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        animationVector4 = initialVelocity;
        ...
        obj.init(animationVector2, animationVector4, obj23);
        ...
        if (obj.arcSpline != null && obj.arcSpline == null) {
            ...
            arcSpline.getPos(obj.getEasedTime(i6), posArray);
            i = 0;
            if (obj.posArray == null) {
                Intrinsics.throwUninitializedPropertyAccessException(str3);
                posArray2 = 0;
            ...
            while (i < posArray2.length) {
                ...
                valueVector3.set$animation_core_release(i, posArray3[i]);
                i++;
                Intrinsics.throwUninitializedPropertyAccessException(str3);
                posArray3 = 0;
        ...
        while (i3 < valueVector2.getSize$animation_core_release()) {
            if (obj.valueVector == null) {
            }
            valueVector.set$animation_core_release(i3, VectorConvertersKt.lerp(vectorValue2.get$animation_core_release(i3), vectorValue.get$animation_core_release(i3), obj.getEasedTimeFromIndex(entryForTimeMillis, i6, true)));
            i3++;
            animationVector2 = targetValue;
            animationVector4 = initialVelocity;
            i4 = i2;
    ...
    public V getVelocityFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        if (obj.arcSpline != null && obj.arcSpline == null) {
            ...
            while (i3 < slopeArray3.length) {
                if (obj.velocityVector == null) {
                }
                if (obj.slopeArray == null) {
                }
                velocityVector.set$animation_core_release(i3, slopeArray2[i3]);
                i3++;
                Intrinsics.throwUninitializedPropertyAccessException(str3);
                slopeArray2 = i2;
        ...
        i4 = 0;
        while (i4 < valueFromMillis2.getSize$animation_core_release()) {
            if (obj.velocityVector == null) {
            }
            velocityVector2.set$animation_core_release(i4, i13 *= i);
            i4++;
            Intrinsics.throwUninitializedPropertyAccessException(str2);
            velocityVector2 = i2;
        }
