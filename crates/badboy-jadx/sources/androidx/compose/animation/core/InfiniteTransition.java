...
public final class InfiniteTransition {
    ...
    public final void run$animation_core_release(Composer $composer, int $changed) {
        ...
        if ($changed & 6 == 0) {
            i3 = obj11.changedInstance(this) ? 4 : refreshChildNeeded;
            $dirty |= i3;
        }
                    ...
                    if (getRefreshChildNeeded()) {
                        ...
                        if (!obj11.changedInstance(this)) {
                            if (rememberedValue == Composer.Companion.getEmpty()) {
                                empty = 0;
                                empty2 = new InfiniteTransition.run.1.1((MutableState)mutableStateOf$default, this, i);
                                refreshChildNeeded.updateRememberedValue((Function2)empty2);
                            } else {
                        ...
                        ComposerKt.sourceInformationMarkerEnd(obj11);
                        EffectsKt.LaunchedEffect(this, (Function2)empty2, obj11, $dirty & 14);
