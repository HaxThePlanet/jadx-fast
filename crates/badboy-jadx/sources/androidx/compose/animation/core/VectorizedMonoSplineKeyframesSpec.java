            ...
            if (Intrinsics.areEqual(obj.lastInitialValue, animationVector)) {
                if (!Intrinsics.areEqual(obj.lastTargetValue, obj2)) {
                    ...
                    if (obj.values == null) {
                        ...
                        fArr3 = monoSpline2;
                        while (fArr3 < contains) {
                            i3 = obj.timestamps.get(fArr3);
                            if (i3 == 0) {
                            } else {
                            }
                            if (i3 == obj.getDurationMillis()) {
                            } else {
                            }
                            Object obj4 = obj.keyframes.get(i3);
                            Intrinsics.checkNotNull(obj4);
                            i = monoSpline2;
                            while (i < size$animation_core_release) {
                                new float[size$animation_core_release][i] = (AnimationVector)(Pair)obj4.getFirst().get$animation_core_release(i);
                                i++;
                            }
                            binarySearch$default[fArr3] = fArr2;
                            fArr3++;
                            fArr2[i] = first.get$animation_core_release(i);
                            i++;
                            if (!obj.keyframes.contains(i3)) {
                            } else {
                            }
                            Object obj5 = obj.keyframes.get(i3);
                            Intrinsics.checkNotNull(obj5);
                            i = monoSpline2;
                            while (i < size$animation_core_release) {
                                new float[size$animation_core_release][i] = (AnimationVector)(Pair)obj5.getFirst().get$animation_core_release(i);
                                i++;
                            }
                            fArr2[i] = first.get$animation_core_release(i);
                            i++;
                            ...
                            fArr2[first] = obj2.get$animation_core_release(first);
                            first++;
                            if (!obj.keyframes.contains(i3)) {
                            } else {
                            }
                            Object obj3 = obj.keyframes.get(i3);
                            Intrinsics.checkNotNull(obj3);
                            i = monoSpline2;
                            while (i < size$animation_core_release) {
                                new float[size$animation_core_release][i] = (AnimationVector)(Pair)obj3.getFirst().get$animation_core_release(i);
                                i++;
                            }
                            fArr2[i] = first.get$animation_core_release(i);
                            i++;
                            ...
                            fArr2[first] = animationVector.get$animation_core_release(first);
                            first++;
                        }
                        ...
                        if (equal ^= 1 != 0 && !obj.keyframes.contains(monoSpline2) && obj.values == null) {
                            if (!obj.keyframes.contains(monoSpline2)) {
                                ...
                                fArr3 = new float[size$animation_core_release];
                                i3 = monoSpline2;
                                while (i3 < size$animation_core_release) {
                                    fArr3[i3] = animationVector.get$animation_core_release(i3);
                                    i3++;
                                }
                                contains[IntListExtensionKt.binarySearch$default(obj.timestamps, 0, 0, 0, 6, 0)] = fArr3;
                            }
                        }
                        if (equal2 ^= 1 != 0 && !obj.keyframes.contains(obj.getDurationMillis()) && obj.values == null) {
                            if (!obj.keyframes.contains(obj.getDurationMillis())) {
                                ...
                                while (monoSpline2 < size$animation_core_release) {
                                    fArr3[monoSpline2] = obj2.get$animation_core_release(monoSpline2);
                                    monoSpline2++;
                                }
                                contains[IntListExtensionKt.binarySearch$default(obj.timestamps, obj.getDurationMillis(), 0, 0, 6, 0)] = fArr3;
                            }
                        }
                    }
                    if (obj.times == null) {
                    ...
                    monoSpline2 = new MonoSpline(times, i2, obj.periodicBias);
