...
public final class EasingFunctionsKt {
    ...
    private static final float EaseInOutElastic$lambda$2(float fraction) {
        ...
        i4 = 1;
        i = 0;
        i2 = Float.compare(fraction, i3) == 0 ? i4 : i;
        if (i2 != 0) {
        } else {
            i2 = 1065353216;
            i5 = Float.compare(fraction, i2) == 0 ? i4 : i;
            if (i5 != 0) {
                i3 = i2;
            } else {
                if (Float.compare(i3, fraction) <= 0 && Float.compare(fraction, i6) <= 0) {
    ...
    private static final float EaseOutElastic$lambda$1(float fraction) {
        ...
        int i2;
        i3 = 0;
        cmp = Float.compare(fraction, i4) == 0 ? i : i3;
        if (cmp != 0) {
        } else {
            i4 = 1065353216;
