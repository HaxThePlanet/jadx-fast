...
public final class Transition<S>  {
    ...
    public final void animateTo$animation_core_release(S targetState, Composer $composer, int $changed) {
        ...
        if (i7 & 48 == 0) {
            i4 = restartGroup.changed(obj) ? 32 : 16;
            $dirty |= i4;
        }
        if ($dirty & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.animation.core.Transition.animateTo (Transition.kt:1209)");
                }
                if (!obj.isSeeking()) {
                            ...
                            if (obj.getUpdateChildrenNeeded()) {
                                ...
                                if (changedInstance2 |= i5 == 0) {
                                    if (rememberedValue == Composer.Companion.getEmpty()) {
                                        ...
                                        traceInProgress2.updateRememberedValue((Function1)anon);
                                    } else {
        ...
        if (endRestartGroup != null) {
            traceInProgress2 = new Transition.animateTo.2(obj, obj2, i7);
    ...
    public final void seek(S initialState, S targetState, long playTimeNanos) {
        ...
        while (index$iv2 < (List)_transitions.size()) {
            obj2 = obj;
            i = 0;
            Intrinsics.checkNotNull((Transition)obj2, "null cannot be cast to non-null type androidx.compose.animation.core.Transition<kotlin.Any>");
            obj3 = obj2;
            i2 = 0;
            if (obj3.isSeeking()) {
            }
            index$iv2++;
            obj3.seek(obj3.getCurrentState(), obj3.getTargetState(), playTimeNanos);
        }
    ...
    public final void setInitialAnimations$animation_core_release(androidx.compose.animation.core.SeekableTransitionState.SeekingAnimationState animationState) {
        ...
        while (index$iv2 < (List)_animations.size()) {
            i = 0;
            (Transition.TransitionAnimationState)_animations.get(index$iv2).setInitialValueAnimation$animation_core_release(animationState);
            index$iv2++;
        }
        SnapshotStateList $this$fastForEach$iv = this._transitions;
        int i3 = 0;
        ...
        while (index$iv < (List)$this$fastForEach$iv.size()) {
            i = 0;
            (Transition)$this$fastForEach$iv.get(index$iv).setInitialAnimations$animation_core_release(animationState);
            index$iv++;
        }
    }
