...
public final class IntListExtensionKt {
    ...
    public static final int binarySearch(IntList $this$binarySearch, int element, int fromIndex, int toIndex) {
        ...
        int low;
        int high;
        String $i$a$RequirePreconditionIntListExtensionKt$binarySearch$1;
        ...
        if (fromIndex < 0) {
            ...
            if (toIndex > $this$binarySearch.getSize()) {
                ...
                while (low <= high) {
                    i8 >>>= i3;
                    append = $this$binarySearch.get($i$a$RequirePreconditionIntListExtensionKt$binarySearch$1);
                    high = i2;
                    low = $i$a$RequirePreconditionIntListExtensionKt$binarySearch$1 + 1;
                }
                return -i4;
            }
