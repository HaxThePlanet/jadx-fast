...
public final class VectorizedFloatAnimationSpec<V extends androidx.compose.animation.core.AnimationVector>  implements androidx.compose.animation.core.VectorizedFiniteAnimationSpec<V> {
    ...
    public long getDurationNanos(V initialValue, V targetValue, V initialVelocity) {
        ...
        while (iterator.hasNext()) {
            i2 = nextInt;
            i = 0;
            f = initialValue.get$animation_core_release(i2);
            maxDuration = l;
        }
        return maxDuration;
    }
    ...
    public V getEndVelocity(V initialValue, V targetValue, V initialVelocity) {
        ...
        while (i < endVelocityVector.getSize$animation_core_release()) {
            ...
            endVelocityVector2.set$animation_core_release(i, this.anims.get(i).getEndVelocity(initialValue.get$animation_core_release(i), targetValue.get$animation_core_release(i), initialVelocity.get$animation_core_release(i)));
            i++;
            Intrinsics.throwUninitializedPropertyAccessException(str);
            endVelocityVector2 = i2;
        }
    ...
    public V getValueFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        while (i2 < valueVector.getSize$animation_core_release()) {
            if (this.valueVector == null) {
            }
            valueVector3.set$animation_core_release(i2, this.anims.get(i2).getValueFromNanos(playTimeNanos, obj8, targetValue.get$animation_core_release(i2), initialVelocity.get$animation_core_release(i2)));
            i2++;
            Intrinsics.throwUninitializedPropertyAccessException(str);
            valueVector3 = i;
        }
    ...
    public V getVelocityFromNanos(long playTimeNanos, V initialValue, V targetValue, V initialVelocity) {
        ...
        while (i2 < velocityVector3.getSize$animation_core_release()) {
            ...
            velocityVector.set$animation_core_release(i2, this.anims.get(i2).getVelocityFromNanos(playTimeNanos, obj8, targetValue.get$animation_core_release(i2), initialVelocity.get$animation_core_release(i2)));
            i2++;
            Intrinsics.throwUninitializedPropertyAccessException(str);
            velocityVector = i;
        }
