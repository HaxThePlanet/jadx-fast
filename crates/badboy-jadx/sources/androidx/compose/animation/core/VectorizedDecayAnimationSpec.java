...
public interface VectorizedDecayAnimationSpec<V extends androidx.compose.animation.core.AnimationVector>  {
    ...
    public abstract long getDurationNanos(V v, V v2);

    public abstract V getTargetValue(V v, V v2);

    public abstract V getValueFromNanos(long l, V v2, V v3);

    public abstract V getVelocityFromNanos(long l, V v2, V v3);
}
