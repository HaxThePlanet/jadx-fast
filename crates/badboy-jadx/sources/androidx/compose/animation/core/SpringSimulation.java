...
public final class SpringSimulation {
    ...
    private final void init() {
        ...
        int i5 = 1;
        i = Float.compare(finalPosition, uNSET) == 0 ? i5 : 0;
        if (i != 0) {
        } else {
            d *= d2;
            i3 = 1065353216;
            if (Float.compare(dampingRatio3, i3) > 0) {
                double d6 = (double)i5;
                this.gammaPlus = i7 += i10;
                this.gammaMinus = i9 -= sqrt;
            } else {
                if (Float.compare(dampingRatio6, i2) >= 0 && Float.compare(dampingRatio7, i3) < 0) {
                    if (Float.compare(dampingRatio7, i3) < 0) {
                        this.dampedFreq = naturalFreq *= sqrt;
                    }
                }
            }
            this.initialized = i5;
