...
public final class SlotTreeKt {
    ...
    private static final List<androidx.compose.ui.tooling.data.ParameterInformation> extractParameterInfo(List<? extends Object> data, androidx.compose.ui.tooling.data.SourceInformationContext context) {
        ...
        if (!(Collection)data.isEmpty()) {
            ...
            while (iterator.hasNext()) {
                ...
                i9 = 0;
                if (obj3 != null && StringsKt.endsWith$default(obj3.getClass().getName(), ".RecomposeScopeImpl", i6, 2, i13)) {
                } else {
                }
                it = i6;
                i13 = 0;
                i6 = 0;
                if (StringsKt.endsWith$default(obj3.getClass().getName(), ".RecomposeScopeImpl", i6, 2, i13)) {
                } else {
                }
                it = 1;
            }
            ...
            if (element$iv != null) {
                ...
                if (accessibleField != null) {
                    str3 = accessibleField.get(element$iv);
                    if (str3 != null) {
                        class = str3.getClass();
                        ...
                        if (accessibleField2 != null) {
                            Object obj4 = accessibleField2.get(str3);
                        ...
                        if (accessibleField3 != null) {
                            obj2 = accessibleField3.get(str3);
                        ...
                        while (i12 < sortedWith.size()) {
                            ...
                            substring = 0;
                            parameter = new Parameter(i6, substring, 2, substring);
                            ...
                            i11 = 0;
                            parameterInformation = new ParameterInformation(substring, sortedIndex.get(str3), i2, i10, i11, parameter.getInlineClass(), i14);
    ...
    public static final List<androidx.compose.ui.tooling.data.ParameterInformation> findParameters(CompositionGroup $this$findParameters, androidx.compose.ui.tooling.data.ContextCache cache) {
        int sourceInformationContextOf$default;
        androidx.compose.ui.tooling.data.SourceInformationContext sourceInformationContextOf$default2;
        ...
        sourceInformationContextOf$default = 2;
        sourceInformationContextOf$default2 = 0;
        if (cache == null) {
            sourceInformationContextOf$default2 = SlotTreeKt.sourceInformationContextOf$default(sourceInfo, sourceInformationContextOf$default2, sourceInformationContextOf$default, sourceInformationContextOf$default2);
        } else {
            ...
            if (obj == null) {
                i2 = 0;
                contexts$ui_tooling_data_release.put(sourceInfo, SlotTreeKt.sourceInformationContextOf$default(sourceInfo, sourceInformationContextOf$default2, sourceInformationContextOf$default, sourceInformationContextOf$default2));
            } else {
                sourceInformationContextOf$default = obj;
            }
            if (sourceInformationContextOf$default instanceof SourceInformationContext != null) {
                sourceInformationContextOf$default2 = sourceInformationContextOf$default;
            }
        }
        ArrayList arrayList = new ArrayList();
        CollectionsKt.addAll((Collection)(List)arrayList, $this$findParameters.getData());
        return SlotTreeKt.extractParameterInfo(arrayList, sourceInformationContextOf$default2);
    }
    ...
    private static final androidx.compose.ui.tooling.data.Group getGroup(CompositionGroup $this$getGroup, androidx.compose.ui.tooling.data.SourceInformationContext parentContext) {
        ...
        if (node3 instanceof LayoutInfo) {
            list2 = modifierInfo;
        } else {
            list2 = modifierInfo;
        }
        if (node3 instanceof LayoutInfo) {
            $i$f$reduce = SlotTreeKt.boundsOfLayoutNode((LayoutInfo)node3);
            i4 = 1;
            int i12 = 0;
            if (i16 != 0 && i16.isCall() == i4) {
                i2 = i16.isCall() == i4 ? i4 : i12;
            } else {
            }
            if (i2 != 0 && inline != null) {
                if (inline != null) {
            ...
            if (node3 != null) {
                callGroup = new NodeGroup(key, node3, $i$f$reduce, (Collection)list7, list2, (Collection)list8);
                node2 = node3;
                list = list2;
                i6 = location2;
            } else {
                ...
                callGroup = new CallGroup(key, name, $i$f$reduce, location2, node, SlotTreeKt.extractParameterInfo(list7, i16), (Collection)list7, (Collection)list8, i4);
            }
            return callGroup;
        } else {
            if (list8.isEmpty()) {
    ...
    private static final List<androidx.compose.ui.tooling.data.Parameter> parseParameters(String parameters) {
        ...
        Integer valueOf;
        int i;
        androidx.compose.ui.tooling.data.Parameter parameter;
        int intValue;
        parameter2 = ")";
        ...
        while (!SlotTreeKt.parseParameters$isChar(objectRef, parameter2)) {
        ...
        SlotTreeKt.parseParameters$expect(objectRef, parameter2);
    ...
    private static final androidx.compose.ui.tooling.data.SourceInformationContext sourceInformationContextOf(String information, androidx.compose.ui.tooling.data.SourceInformationContext parent) {
        ...
        packageHash = 0;
        sourceFile2 = 0;
        objectRef2.element = Regex.find$default(SlotTreeKt.tokenizer, (CharSequence)charSequence, packageHash, 2, sourceFile2);
        ArrayList arrayList = new ArrayList();
        ...
        while (objectRef2.element != null) {
            ...
            SlotTreeKt.sourceInformationContextOf$next$4(objectRef2);
            i5 = sourceInformationContextOf$parseLocation;
            if (i6 != 0) {
            }
            SlotTreeKt.sourceInformationContextOf$next$4(objectRef2);
            i6 = sourceInformationContextOf$parseLocation;
            parameters = callName;
            isInline = 1;
            if (i6 != 0) {
            }
        ...
        if (sourceFile == null) {
            if (parent != null) {
                sourceFile2 = parent.getSourceFile();
            }
            i4 = sourceFile2;
        } else {
            i4 = sourceFile;
        ...
        SourceInformationContext sourceInformationContext = new SourceInformationContext(parameters, i4, i7, list, i2, i5, i6, isInline);
