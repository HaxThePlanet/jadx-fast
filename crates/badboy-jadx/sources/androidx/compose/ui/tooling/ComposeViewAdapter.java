...
public final class ComposeViewAdapter extends FrameLayout {
    ...
    private final void WrapPreview(Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        i2 = 2;
        if ($changed & 6 == 0) {
            i3 = obj8.changedInstance(content) ? i : i2;
            $dirty |= i3;
        }
        if ($changed & 48 == 0) {
            i4 = obj8.changedInstance(this) ? 32 : 16;
            $dirty |= i4;
        }
        if ($dirty & 19 == 18) {
            if (!obj8.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.ui.tooling.ComposeViewAdapter.WrapPreview (ComposeViewAdapter.android.kt:432)");
                }
                ...
                arr[i2] = LocalOnBackPressedDispatcherOwner.INSTANCE.provides((OnBackPressedDispatcherOwner)this.FakeOnBackPressedDispatcherOwner);
    ...
    private final void findDesignInfoProviders() {
        ...
        for (Object next3 : iterator3) {
            i7 = 0;
            (Collection)arrayList2.add(SlotTreeKt.asTree((CompositionData)next3));
        }
        i4 = 0;
    ...
    public static void init$ui_tooling_release$default(androidx.compose.ui.tooling.ComposeViewAdapter composeViewAdapter, String string2, String string3, Class class4, int i5, boolean z6, boolean z7, long l8, boolean z9, boolean z10, String string11, Function0 function012, Function0 function013, int i14, Object object15) {
        androidx.compose.ui.tooling.ComposeViewAdapter.init.2 iNSTANCE;
        androidx.compose.ui.tooling.ComposeViewAdapter.init.1 iNSTANCE2;
        int i7;
        int i2;
        int i9;
        int i;
        ...
        int i10;
        int i3;
        androidx.compose.ui.tooling.ComposeViewAdapter.init.1 view;
        androidx.compose.ui.tooling.ComposeViewAdapter.init.2 view2;
        int i11 = object15;
        final int i21 = 0;
        i2 = i11 & 4 != 0 ? i21 : class4;
        int i22 = 0;
        i9 = i11 & 8 != 0 ? i22 : i5;
        i = i11 & 16 != 0 ? i22 : z6;
        i6 = i11 & 32 != 0 ? i22 : z7;
        i8 = i11 & 64 != 0 ? i7 : l8;
        i4 = i11 & 128 != 0 ? i22 : z10;
        i10 = i11 & 256 != 0 ? i22 : string11;
        ...
        composeViewAdapter.init$ui_tooling_release(string2, string3, i2, i9, i, i6, i8, obj11, i4, i10, i3, view);
    }
    ...
    private final String invokeGetDesignInfo(Object $this$invokeGetDesignInfo, int x, int y) {
        ...
        if (designInfoMethodOrNull != null) {
            ...
            if (i2 != 0) {
                int i4 = 0;
                $i$a$IfEmptyComposeViewAdapter$invokeGetDesignInfo$1$1 = i;
            }
            i = $i$a$IfEmptyComposeViewAdapter$invokeGetDesignInfo$1$1;
        }
        return i;
    }
