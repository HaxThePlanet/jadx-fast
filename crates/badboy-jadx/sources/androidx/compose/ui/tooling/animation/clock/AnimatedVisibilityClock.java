    ...
    public List<ComposeAnimatedProperty> getAnimatedProperties() {
        ...
        if (it$iv$iv != null) {
            ...
            while (iterator.hasNext()) {
                ...
                $i$a$LetAnimatedVisibilityClock$getAnimatedProperties$1 = new ComposeAnimatedProperty((Transition.TransitionAnimationState)obj2.getLabel(), value);
                i5 = $i$a$LetAnimatedVisibilityClock$getAnimatedProperties$1;
                if (i5 != 0) {
                }
                it$iv$iv = transition;
