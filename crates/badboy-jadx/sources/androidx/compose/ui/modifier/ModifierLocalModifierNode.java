    ...
    public <T> T getCurrent(androidx.compose.ui.modifier.ModifierLocal<T> $this$current) {
        ...
        if (!delegatableNode.getNode().isAttached()) {
            ...
            while (layout$iv$iv != null) {
                ...
                key = value$iv;
                node$iv$iv = $this$visitAncestors_u2dY_u2dYKmho_u24default$iv;
                i10 = $i$f$getLocalsOLwlOKw;
                ...
                while (node$iv$iv2 != null) {
                    ...
                    while ($this$visitAncestors_u2dY_u2dYKmho_u24default$iv != null) {
                        ...
                        while (node$iv$iv$iv != null) {
                            ...
                            Modifier.Node node6 = node$iv$iv5;
                            if (node6 != null) {
                            } else {
                            }
