...
public final class Actual_jvmKt {
    ...
    public static final void tryPopulateReflectively(InspectorInfo $this$tryPopulateReflectively, ModifierNodeElement<?> element) {
        ...
        while (index$iv < $this$sortedBy$iv.size()) {
            obj2 = obj3;
            i = 0;
            if (!(Field)obj2.getDeclaringClass().isAssignableFrom(ModifierNodeElement.class)) {
            }
            index$iv++;
            obj2.setAccessible(true);
            $this$tryPopulateReflectively.getProperties().set(obj2.getName(), obj2.get(element));
        }
    }
}
