...
public final class CompositionLocalsKt {
    ...
    public static final void ProvideCommonCompositionLocals(Owner owner, androidx.compose.ui.platform.UriHandler uriHandler, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        int density;
        int autofillTree;
        traceInProgress = 874662829;
        final Composer obj10 = $composer.startRestartGroup(traceInProgress);
        ComposerKt.sourceInformation(obj10, "C(ProvideCommonCompositionLocals)P(1,2)215@7394L1256:CompositionLocals.kt#itgzvw");
        i = 4;
        density = 2;
        if ($changed & 6 == 0) {
            if ($changed & 8 == 0) {
                changedInstance2 = obj10.changed(owner);
            } else {
                changedInstance2 = obj10.changedInstance(owner);
            }
            i4 = changedInstance2 ? i : density;
            $dirty |= i4;
        }
        final int i23 = 16;
        if ($changed & 48 == 0) {
            if ($changed & 64 == 0) {
                changedInstance = obj10.changed(uriHandler);
            } else {
                changedInstance = obj10.changedInstance(uriHandler);
            }
            i3 = changedInstance != null ? 32 : i23;
            $dirty |= i3;
        }
        if ($changed & 384 == 0) {
        ...
        if ($dirty & 147 == 146) {
            if (!obj10.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(traceInProgress, $dirty, -1, "androidx.compose.ui.platform.ProvideCommonCompositionLocals (CompositionLocals.kt:214)");
                }
                ...
                arr[i] = CompositionLocalsKt.LocalDensity.provides(owner.getDensity());
                ...
                CompositionLocalKt.CompositionLocalProvider(arr, content, obj10, $stable |= i);
                if (ComposerKt.isTraceInProgress()) {
