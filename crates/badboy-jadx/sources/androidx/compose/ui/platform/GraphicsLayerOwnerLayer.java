    ...
    private final void clipManually(Canvas canvas) {
        ...
        if (this.graphicsLayer.getClip()) {
            ...
            if (outline instanceof Outline.Rectangle) {
                Canvas.clipRect-mtrdD-E$default(canvas, (Outline.Rectangle)outline.getRect(), i4, i2, i);
            } else {
                if (outline instanceof Outline.Rounded) {
                    ...
                    tmpPath.reset();
                    Path.addRoundRect$default(tmpPath, (Outline.Rounded)outline.getRoundRect(), i, i2, i);
                    Canvas.clipPath-mtrdD-E$default(canvas, tmpPath, i4, i2, i);
                } else {
                    if (outline instanceof Outline.Generic) {
                        Canvas.clipPath-mtrdD-E$default(canvas, (Outline.Generic)outline.getPath(), i4, i2, i);
                    }
                }
            }
        }
