...
public final class AndroidComposeView extends ViewGroup implements Owner, androidx.compose.ui.platform.ViewRootForTest, PositionCalculator, DefaultLifecycleObserver {
    ...
    private final boolean childSizeCanAffectParentSize(LayoutNode $this$childSizeCanAffectParentSize) {
        ...
        if (!this.wasMeasuredWithMultipleConstraints) {
            ...
            if (hasFixedInnerContentConstraints$ui_release != null && !hasFixedInnerContentConstraints$ui_release.getHasFixedInnerContentConstraints$ui_release()) {
                wasMeasuredWithMultipleConstraints = !hasFixedInnerContentConstraints$ui_release.getHasFixedInnerContentConstraints$ui_release() ? i : i2;
            } else {
            }
    ...
    private final int handleMotionEvent-8iAsVTc(MotionEvent motionEvent) {
        ...
        if (previousMotionEvent2 != null && previousMotionEvent2.getToolType(i14) == pointerInputEventProcessor) {
            i2 = previousMotionEvent2.getToolType(i14) == pointerInputEventProcessor ? i10 : i14;
        } else {
        }
        final int i18 = i2;
        i4 = 10;
        if (previousMotionEvent2 != null) {
            if (obj3.hasChangedDevices(motionEvent2, previousMotionEvent2)) {
                if (obj3.isDevicePressEvent(previousMotionEvent2)) {
                    ...
                    if (previousMotionEvent2.getActionMasked() != i4 && i18 != 0) {
                        if (i18 != 0) {
                            i3 = i19;
            ...
            if (previousMotionEvent != null && previousMotionEvent.getAction() == i3) {
                try {
                    if (previousMotionEvent.getAction() == i3) {
                    } else {
                    }
                    pointerId = 1;
                    pointerId = i14;
    ...
    private final boolean isBadMotionEvent(MotionEvent event) {
        ...
        if (!Float.isInfinite(naN4) && !Float.isNaN(naN4)) {
            i2 = !Float.isNaN(naN4) ? i4 : i3;
        } else {
        }
        if (i2 != 0) {
            naN = event.getY();
            if (!Float.isInfinite(naN) && !Float.isNaN(naN)) {
                i2 = !Float.isNaN(naN) ? i4 : i3;
            } else {
            }
            if (i2 != 0) {
                rawX = event.getRawX();
                if (!Float.isInfinite(rawX) && !Float.isNaN(rawX)) {
                    i2 = !Float.isNaN(rawX) ? i4 : i3;
                } else {
                }
                if (i2 != 0) {
                    rawY = event.getRawY();
                    if (!Float.isInfinite(rawY) && !Float.isNaN(rawY)) {
                        i2 = !Float.isNaN(rawY) ? i4 : i3;
                    } else {
                    }
                    if (i2 == 0) {
                        eventInvalid = i4;
    ...
    private final void recalculateWindowPosition() {
        ...
        if (!this.forceUseMatrixCache && Long.compare(currentAnimationTimeMillis, lastMatrixRecalculationAnimationTime) != 0) {
            ...
            if (Long.compare(currentAnimationTimeMillis, lastMatrixRecalculationAnimationTime) != 0) {
                ...
                this.windowPosition = OffsetKt.Offset(obj - f2, f3 - f);
            }
        }
    }
    ...
    private final void sendSimulatedEvent(MotionEvent motionEvent, int action, long eventTime, boolean forceHover) {
        ...
        while (i3 < i7) {
            ...
            i = buttonState;
            i += i3;
            obj2.getPointerProperties(pointerProperties, arr[i3]);
            pointerCoords = arr2[i3];
    ...
    public void onEndApplyChanges() {
        ...
        while (this.endApplyChangesListeners.isNotEmpty()) {
            ...
            while (i < size) {
                int i5 = 0;
                this_$iv = this.endApplyChangesListeners.getContent()[i];
                this.endApplyChangesListeners.set(i, 0);
    ...
    public void setCoroutineContext(CoroutineContext value) {
        ...
        count$iv$iv2 = stack$iv$iv.getRoot().getNodes$ui_release().getHead$ui_release();
        if (count$iv$iv2 instanceof SuspendingPointerInputModifierNode) {
            (SuspendingPointerInputModifierNode)count$iv$iv2.resetPointerInputHandler();
        }
        int i12 = 0;
        ...
        while (layout$iv$iv != null) {
            ...
            node$iv$iv3 = child$ui_release;
            if (aggregateChildKindSet$ui_release &= i15 != 0) {
            } else {
            }
            headModifierNode = count$iv$iv2;
            ...
            stack$iv$iv = this;
            context = value;
            count$iv$iv2 = headModifierNode;
            i4 = nestedVectorStack.pop();
            while (node$iv$iv3 != null) {
                ...
                while (stack$iv$iv != null) {
                    ...
                    stack$iv$iv = DelegatableNodeKt.access$pop(node$iv$iv);
                    context = value;
                    count$iv$iv2 = headModifierNode;
                    ...
                    while (node$iv$iv$iv != null) {
                        ...
                        i6 = count$iv$iv;
                        i5 = i10;
                        node$iv$iv2 = new MutableVector(new Modifier.Node[i10], 0);
                        stack$iv$iv = node2;
                        next$iv$iv = node2;
            ...
            (SuspendingPointerInputModifierNode)(PointerInputModifierNode)this_$iv$iv$iv2.resetPointerInputHandler();
            node$iv$iv3 = layout$iv$iv.getNodes$ui_release().getHead$ui_release();
        }
    }
    ...
    public Object textInputSession(Function2<? super androidx.compose.ui.platform.PlatformTextInputSessionScope, ? super Continuation<?>, ? extends Object> function2, Continuation<?> continuation2) {
        ...
        androidx.compose.ui.platform.AndroidComposeView.textInputSession.2 anon2;
        Object obj6;
        Object obj7;
        anon = continuation2;
        ...
        if (continuation2 instanceof AndroidComposeView.textInputSession.1 && label2 &= i2 != 0) {
            ...
            if (label2 &= i2 != 0) {
                ...
                anon = new AndroidComposeView.textInputSession.1(this, continuation2);
            }
        } else {
        }
        obj7 = anon.result;
        ...
        switch (label) {
            case 0:
                ...
                anon2 = new AndroidComposeView.textInputSession.2(view);
                anon.label = 1;
