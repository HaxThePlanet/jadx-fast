...
public final class DecodeHelper {
    ...
    public final SpanStyle decodeSpanStyle() {
        ...
        i5 = this;
        i2 = 1;
        while (i5.parcel.dataAvail() > i2) {
            decodeTextUnit-XSAIIZE = i5.decodeByte();
            fontStyle = 8;
            i4 = 5;
            i3 = 4;
            i2 = 7;
            ...
            i5 = this;
            i2 = 1;
            mutableSpanStyle.setShadow(i5.decodeShadow());
            mutableSpanStyle.setTextDecoration(i5.decodeTextDecoration());
            mutableSpanStyle.setBackground-8_81llA(i5.decodeColor-0d7_KjU());
            mutableSpanStyle.setTextGeometricTransform(i5.decodeTextGeometricTransform());
            mutableSpanStyle.setBaselineShift-_isdbwI(BaselineShift.box-impl(i5.decodeBaselineShift-y9eOQZs()));
            mutableSpanStyle.setLetterSpacing--R2X_6o(i5.decodeTextUnit-XSAIIZE());
            mutableSpanStyle.setFontFeatureSettings(i5.decodeString());
            mutableSpanStyle.setFontSynthesis-tDdu0R4(FontSynthesis.box-impl(i5.decodeFontSynthesis-GVVA2EU()));
            mutableSpanStyle.setFontStyle-mLjRB2g(FontStyle.box-impl(i5.decodeFontStyle-_-LCdwA()));
            mutableSpanStyle.setFontWeight(i5.decodeFontWeight());
            mutableSpanStyle.setFontSize--R2X_6o(i5.decodeTextUnit-XSAIIZE());
            mutableSpanStyle.setColor-8_81llA(i5.decodeColor-0d7_KjU());
        }
