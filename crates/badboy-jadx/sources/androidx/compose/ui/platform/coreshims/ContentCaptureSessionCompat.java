...
public class ContentCaptureSessionCompat {
    ...
    public static androidx.compose.ui.platform.coreshims.ContentCaptureSessionCompat toContentCaptureSessionCompat(ContentCaptureSession contentCaptureSession, View host) {
    ...
    public AutofillId newAutofillId(long virtualChildId) {
        return ContentCaptureSessionCompat.Api29Impl.newAutofillId((ContentCaptureSession)this.mWrappedObj, (AutofillIdCompat)Objects.requireNonNull(ViewCompatShims.getAutofillId(this.mView)).toAutofillId(), virtualChildId);
    }

    public androidx.compose.ui.platform.coreshims.ViewStructureCompat newVirtualViewStructure(AutofillId parentId, long virtualId) {
    ...
    public void notifyViewsAppeared(List<ViewStructure> list) {
        ...
        if (Build.VERSION.SDK_INT >= 34) {
            ...
            i2 = 1;
            ContentCaptureSessionCompat.Api23Impl.getExtras(viewStructure).putBoolean("TREAT_AS_VIEW_TREE_APPEARING", i2);
            ...
            ContentCaptureSessionCompat.Api23Impl.getExtras(viewStructure2).putBoolean("TREAT_AS_VIEW_TREE_APPEARED", i2);
