...
public final class OutlineResolver {
    ...
    public final void clipToOutline(Canvas canvas) {
        ...
        if (clipPath != null) {
            ...
            i3 = 0;
            int cmp = Float.compare(roundedCornerRadius3, i3);
            if (cmp > 0) {
                ...
                if (roundRectClipPath != null) {
                    ...
                    if (!roundedCornerRadius2.isSameBounds-4L21HEs(roundedCornerRadius2.tmpRoundRect, roundedCornerRadius2.rectTopLeft, obj3, roundedCornerRadius2.rectSize)) {
                        roundRect = RoundRectKt.RoundRect-gG7oq9Y(Offset.getX-impl(obj.rectTopLeft), Offset.getY-impl(obj.rectTopLeft), x-impl2 + width-impl, y-impl2 + sameBounds-4L21HEs, CornerRadiusKt.CornerRadius$default(obj.roundedCornerRadius, i3, i7, i8));
                        if (roundRectClipPath == null) {
