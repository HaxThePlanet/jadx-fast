...
public final class Wrapper_androidKt {
    ...
    private static final Composition doSetContent(androidx.compose.ui.platform.AndroidComposeView owner, CompositionContext parent, Function2<? super Composer, ? super Integer, Unit> content) {
        ...
        int wrappedComposition;
        boolean wrappedComposition2;
        ...
        if (wrappedComposition instanceof WrappedComposition) {
        } else {
            wrappedComposition = 0;
        }
        if (wrappedComposition == 0) {
            wrappedComposition = new WrappedComposition(owner, CompositionKt.Composition((Applier)uiApplier, parent));
            i = 0;
            owner.getView().setTag(R.id.wrapped_composition_tag, wrappedComposition);
        }
        ...
        return (Composition)wrappedComposition;
    }
