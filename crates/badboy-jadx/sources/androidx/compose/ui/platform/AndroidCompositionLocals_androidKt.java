...
public final class AndroidCompositionLocals_androidKt {
    ...
    public static final void ProvideAndroidCompositionLocals(androidx.compose.ui.platform.AndroidComposeView owner, Function2<? super Composer, ? super Integer, Unit> content, Composer $composer, int $changed) {
        ...
        configuration$delegate = 1396852028;
        Composer restartGroup = $composer.startRestartGroup(configuration$delegate);
        ...
        if ($dirty & 19 == 18) {
            if (!restartGroup.getSkipping()) {
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(configuration$delegate, $dirty, -1, "androidx.compose.ui.platform.ProvideAndroidCompositionLocals (AndroidCompositionLocals.android.kt:91)");
                }
                view2 = owner;
                ...
                if (rememberedValue == Composer.Companion.getEmpty()) {
                    empty3 = 0;
                    anon = new AndroidCompositionLocals_androidKt.ProvideAndroidCompositionLocals.1.1((MutableState)obj3);
                    composer.updateRememberedValue((Function1)anon);
                } else {
                    anon = rememberedValue;
                }
                ComposerKt.sourceInformationMarkerEnd(restartGroup);
                obj.setConfigurationChangeObserver((Function1)anon);
                ...
                if (viewTreeOwners == null) {
                    ...
                    if (rememberedValue5 == Composer.Companion.getEmpty()) {
                        ...
                        configuration$delegate2 = obj3;
                        i = $dirty;
                        configuration$delegate = rememberedValue5;
                    }
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    ...
                    int i30 = 0;
                    if (!restartGroup.changedInstance((DisposableSaveableStateRegistry)configuration$delegate)) {
                        if (rememberedValue3 == Composer.Companion.getEmpty()) {
                            empty4 = 0;
                            anon2 = new AndroidCompositionLocals_androidKt.ProvideAndroidCompositionLocals.2.1(configuration$delegate);
                    ...
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    int i22 = 6;
                    EffectsKt.DisposableEffect(Unit.INSTANCE, (Function1)anon2, restartGroup, i22);
                    int i23 = 0;
                    int i31 = 0;
                    int i34 = 0;
                    ...
                    arr[i23] = AndroidCompositionLocals_androidKt.LocalConfiguration.provides(AndroidCompositionLocals_androidKt.ProvideAndroidCompositionLocals$lambda$1(configuration$delegate2));
                    int i32 = 1;
                    ...
                    arr[obj23] = SaveableStateRegistryKt.getLocalSaveableStateRegistry().provides(configuration$delegate);
                    arr[5] = AndroidCompositionLocals_androidKt.LocalView.provides(obj.getView());
                    arr[i22] = AndroidCompositionLocals_androidKt.LocalImageVectorCache.provides(AndroidCompositionLocals_androidKt.obtainImageVectorCache(skipping, AndroidCompositionLocals_androidKt.ProvideAndroidCompositionLocals$lambda$1(configuration$delegate2), restartGroup, i23));
    ...
    private static final ImageVectorCache obtainImageVectorCache(Context context, Configuration configuration, Composer $composer, int $changed) {
        ...
        if (rememberedValue3 == Composer.Companion.getEmpty()) {
            empty2 = 0;
            anon = new AndroidCompositionLocals_androidKt.obtainImageVectorCache.callbacks.1.1((Configuration)configuration4, (ImageVectorCache)invalid$iv);
            composer4.updateRememberedValue(anon);
        } else {
        ...
        if (!composer.changedInstance(obj)) {
            if (rememberedValue4 == Composer.Companion.getEmpty()) {
                empty2 = 0;
                anon2 = new AndroidCompositionLocals_androidKt.obtainImageVectorCache.1.1(obj, (AndroidCompositionLocals_androidKt.obtainImageVectorCache.callbacks.1.1)anon);
