...
public final class AndroidPlatformTextInputSession implements androidx.compose.ui.platform.PlatformTextInputSessionScope, CoroutineScope {
    ...
    public Object startInputMethod(androidx.compose.ui.platform.PlatformTextInputMethodRequest platformTextInputMethodRequest, Continuation<?> continuation2) {
        ...
        androidx.compose.ui.platform.AndroidPlatformTextInputSession.startInputMethod.2 anon;
        androidx.compose.ui.platform.AndroidPlatformTextInputSession.startInputMethod.3 anon3;
        int i3;
        Object obj8;
        Object obj9;
        anon2 = continuation2;
        i2 = Integer.MIN_VALUE;
        if (continuation2 instanceof AndroidPlatformTextInputSession.startInputMethod.1 && label2 &= i2 != 0) {
            anon2 = continuation2;
            i2 = Integer.MIN_VALUE;
            if (label2 &= i2 != 0) {
                anon2.label = obj9 -= i2;
        ...
        switch (label) {
            case 0:
                ...
                label = this;
                anon = new AndroidPlatformTextInputSession.startInputMethod.2(platformTextInputMethodRequest, label);
                anon3 = new AndroidPlatformTextInputSession.startInputMethod.3(label, 0);
                anon2.label = 1;
