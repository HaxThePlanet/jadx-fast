...
public final class SemanticsUtils_androidKt {
    ...
    private static final void getAllUncoveredSemanticsNodesToIntObjectMap$findAllSemanticNodesRecursive(Region unaccountedSpace, SemanticsNode root, MutableIntObjectMap<androidx.compose.ui.platform.SemanticsNodeWithAdjustedBounds> nodes, SemanticsNode currentNode, Region region) {
        ...
        int i6 = 0;
        $this$fastRoundToInt$iv3 = Math.round(touchBoundsInRoot.getLeft());
        int i7 = 0;
        $this$fastRoundToInt$iv2 = Math.round(touchBoundsInRoot.getTop());
        int i9 = 0;
        ...
        region2.set($this$fastRoundToInt$iv3, $this$fastRoundToInt$iv2, $this$fastRoundToInt$iv4, $this$fastRoundToInt$iv5);
        $this$fastRoundToInt$iv = -1;
        if (semanticsNode4.getId() == root.getId()) {
            i = $this$fastRoundToInt$iv;
        } else {
        ...
        if (region2.op(semanticsNodeWithAdjustedBounds2, Region.Op.INTERSECT)) {
            ...
            while ($this$fastRoundToInt$iv < i2) {
            ...
            if (SemanticsUtils_androidKt.isImportantForAccessibility(semanticsNode4)) {
                ...
                importantForAccessibility = $this$fastRoundToInt$iv2;
                semanticsNodeWithAdjustedBounds2.op($this$fastRoundToInt$iv3, importantForAccessibility, semanticsNodeWithAdjustedBounds, $this$fastRoundToInt$iv5, Region.Op.DIFFERENCE);
                $this$fastRoundToInt$iv4 = semanticsNodeWithAdjustedBounds;
                $this$fastRoundToInt$iv2 = importantForAccessibility;
                left = $this$fastRoundToInt$iv3;
            } else {
                left = $this$fastRoundToInt$iv3;
            }
        } else {
