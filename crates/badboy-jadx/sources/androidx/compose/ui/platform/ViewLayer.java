...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    public static final class Companion {
        ...
        public final void updateDisplayList(View view) {
            ...
            if (!getHasRetrievedMethod()) {
                ...
                arr3[arr] = String.class;
                arr3[i] = new Class[arr].getClass();
                int i3 = 0;
                ...
                if (method2 == null) {
                    try {
                        ...
                        method.invoke(view, new Object[arr]);
    ...
    private final void resetClipBounds() {
        Rect clipBoundsCache;
        int clipBoundsCache2;
        int i;
        int width;
        int height;
        if (this.clipToBounds) {
            ...
            if (this.clipBoundsCache == null) {
                clipBoundsCache = new Rect(i, i, getWidth(), getHeight());
                this.clipBoundsCache = clipBoundsCache;
            } else {
                clipBoundsCache = this.clipBoundsCache;
                Intrinsics.checkNotNull(clipBoundsCache);
                clipBoundsCache.set(i, i, getWidth(), getHeight());
            }
            clipBoundsCache2 = this.clipBoundsCache;
        } else {
            clipBoundsCache2 = 0;
        }
        setClipBounds(clipBoundsCache2);
    }
