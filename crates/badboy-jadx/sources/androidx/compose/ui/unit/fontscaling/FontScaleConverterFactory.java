...
public final class FontScaleConverterFactory {
    ...
    public final androidx.compose.ui.unit.fontscaling.FontScaleConverter forScale(float fontScale) {
        ...
        Object startTable2;
        androidx.compose.ui.unit.fontscaling.FontScaleConverter fontScaleConverterTable;
        float startScale;
        float[] fArr;
        Object fontScaleConverterTable2;
        int i2;
        ...
        if (i9 >= FontScaleConverterFactory.sLookupTables.size()) {
            ...
            put(fontScale, (FontScaleConverter)fontScaleConverterTable);
            ...
            int i10 = 0;
            if (i6 < 0) {
                fontScaleConverterTable2 = new FontScaleConverterTable(FontScaleConverterFactory.CommonFontSizes, FontScaleConverterFactory.CommonFontSizes);
            ...
            f = fontScale;
            fontScaleConverterTable = createInterpolatedTableBetween(startTable2, (FontScaleConverter)FontScaleConverterFactory.sLookupTables.valueAt(i9), MathUtils.INSTANCE.constrainedMap(0, 1065353216, i, getScaleFromKey(FontScaleConverterFactory.sLookupTables.keyAt(i9)), f));
