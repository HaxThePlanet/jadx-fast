...
public interface FontScalingLinear {
    ...
    public float toDp-GaN1DYA(long $this$toDp_u2dGaN1DYA) {
        ...
        int i2 = 0;
        IllegalStateException $i$a$CheckFontScalingLinear$toDp$1 = new IllegalStateException("Only Sp can convert to Px".toString());
        throw $i$a$CheckFontScalingLinear$toDp$1;
    }
