...
final class PainterNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode {
    ...
    public PainterNode(Painter painter, boolean z2, Alignment alignment3, ContentScale contentScale4, float f5, ColorFilter colorFilter6, int i7, DefaultConstructorMarker defaultConstructorMarker8) {
        ...
        i = i7 & 16 != 0 ? obj12 : f5;
        i2 = i7 & 32 != 0 ? obj13 : colorFilter6;
        super(painter, z2, alignment, contentScale, i, i2);
    }
    ...
    private final long calculateScaledSize-E7KxVPU(long dstSize) {
        ...
        if (!getUseIntrinsicSize()) {
            ...
            i2 = 0;
            i3 = 0;
            cmp = Float.compare(width-impl, i2) == 0 ? i : i3;
            if (cmp == 0) {
                if (Float.compare(height-impl2, i2) == 0) {
                } else {
                    i = i3;
                }
                if (i == 0) {
    ...
    private final boolean hasSpecifiedAndFiniteWidth-uvyYCjk(long $this$hasSpecifiedAndFiniteWidth_u2duvyYCjk) {
        ...
        if (!Size.equals-impl0($this$hasSpecifiedAndFiniteWidth_u2duvyYCjk, obj6)) {
            ...
            if (!Float.isInfinite(width-impl) && !Float.isNaN(width-impl)) {
                equals-impl0 = !Float.isNaN(width-impl) ? i : i2;
            } else {
            }
            if (equals-impl0 != 0) {
                i2 = i;
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope $this$maxIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        if (getUseIntrinsicSize()) {
            i2 = 0;
            width2 = width;
            obj10 = Math.max(Constraints.getMinHeight-impl(modifyConstraints-ZezNO4M(ConstraintsKt.Constraints$default(i2, width2, 0, 0, 13, 0))), measurable.maxIntrinsicHeight(width2));
        } else {
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope $this$maxIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        if (getUseIntrinsicSize()) {
            i = 0;
            height2 = height;
            obj10 = Math.max(Constraints.getMinWidth-impl(modifyConstraints-ZezNO4M(ConstraintsKt.Constraints$default(i, 0, 0, height2, 7, 0))), measurable.maxIntrinsicWidth(height2));
        } else {
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope $this$minIntrinsicHeight, IntrinsicMeasurable measurable, int width) {
        ...
        if (getUseIntrinsicSize()) {
            i = 0;
            width2 = width;
            obj10 = Math.max(Constraints.getMinHeight-impl(modifyConstraints-ZezNO4M(ConstraintsKt.Constraints$default(i, width2, 0, 0, 13, 0))), measurable.minIntrinsicHeight(width2));
        } else {
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope $this$minIntrinsicWidth, IntrinsicMeasurable measurable, int height) {
        ...
        if (getUseIntrinsicSize()) {
            i2 = 0;
            height2 = height;
            obj10 = Math.max(Constraints.getMinWidth-impl(modifyConstraints-ZezNO4M(ConstraintsKt.Constraints$default(i2, 0, 0, height2, 7, 0))), measurable.minIntrinsicWidth(height2));
        } else {
