...
public final class FocusGroupNode_androidKt {
    ...
    private static final View getView(Modifier.Node $this$getView) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckNotNullFocusGroupNode_androidKt$getView$1 = new IllegalStateException("Could not fetch interop view".toString());
        throw $i$a$CheckNotNullFocusGroupNode_androidKt$getView$1;
    }
}
