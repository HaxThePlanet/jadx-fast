...
public final class AndroidView_androidKt {
    ...
    public static final <T extends View> void AndroidView(Function1<? super Context, ? extends T> factory, Modifier modifier, Function1<? super T, Unit> update, Composer $composer, int $changed, int i6) {
        ...
        if (i6 & 1 != 0) {
            ...
            if (i13 & 6 == 0) {
                i2 = restartGroup.changedInstance(factory) ? 4 : 2;
                $dirty2 |= i2;
            }
        }
        int i11 = i6 & 2;
        ...
        if (i12 != 0) {
            ...
            if (i13 & 384 == 0) {
                i7 = restartGroup.changedInstance(update) ? 256 : 128;
                $dirty2 |= i7;
            } else {
                obj2 = update;
            }
        ...
        if (i15 & 147 == 146) {
            if (!restartGroup.getSkipping()) {
                ...
                obj = i12 != 0 ? obj15 : obj2;
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventStart(anon, i15, -1, "androidx.compose.ui.viewinterop.AndroidView (AndroidView.android.kt:107)");
                }
                AndroidView_androidKt.AndroidView(factory, i4, 0, AndroidView_androidKt.NoOpUpdate, obj, restartGroup, obj15 | anon, 4);
                if (ComposerKt.isTraceInProgress()) {
        ...
        if (obj15 != null) {
            anon = new AndroidView_androidKt.AndroidView.1(factory, obj3, obj4, i13, i6);
    ...
    public static final <T extends View> void AndroidView(Function1<? super Context, ? extends T> factory, Modifier modifier, Function1<? super T, Unit> onReset, Function1<? super T, Unit> onRelease, Function1<? super T, Unit> update, Composer $composer, int $changed, int i8) {
        ...
        if (i8 & 1 != 0) {
            ...
            if (i19 & 6 == 0) {
                i2 = restartGroup.changedInstance(obj10) ? 4 : 2;
                $dirty |= i2;
            }
        }
        int i9 = i8 & 2;
        ...
        if (iNSTANCE != null) {
            ...
            if (i19 & 3072 == 0) {
                i = restartGroup.changedInstance(onRelease) ? 2048 : 1024;
                $dirty |= i;
            } else {
                obj6 = onRelease;
            }
        ...
        if (i30 & 9363 == 9362) {
            if (!restartGroup.getSkipping()) {
                ...
                if (onReset2 != null) {
                    ...
                    obj2 = 0;
                    AndroidView_androidKt.updateViewHolderParams-6NefGtU(constructor-impl, materializeModifier, currentCompositeKeyHash, (Density)obj8, (LifecycleOwner)obj5, (SavedStateRegistryOwner)obj9, (LayoutDirection)obj7, currentCompositionLocalMap);
                    ...
                    Updater.set-impl(constructor-impl, obj6, (Function2)AndroidView_androidKt.AndroidView.2.3.INSTANCE);
                    ...
                    constructor-impl = Updater.constructor-impl(restartGroup);
                    obj2 = 0;
                    AndroidView_androidKt.updateViewHolderParams-6NefGtU(constructor-impl, materializeModifier, currentCompositeKeyHash, obj8, obj5, obj9, obj7, currentCompositionLocalMap);
                    Updater.set-impl(constructor-impl, obj, (Function2)AndroidView_androidKt.AndroidView.3.1.INSTANCE);
                    Updater.set-impl(constructor-impl, obj6, (Function2)AndroidView_androidKt.AndroidView.3.2.INSTANCE);
                    restartGroup.endNode();
                    ComposerKt.sourceInformationMarkerEnd(restartGroup);
                    restartGroup.endReplaceGroup();
                }
        ...
        if (endRestartGroup != null) {
            traceInProgress = new AndroidView_androidKt.AndroidView.4(obj10, modifier2, onReset2, obj3, obj4, i19, i8);
