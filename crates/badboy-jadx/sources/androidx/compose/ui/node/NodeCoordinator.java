...
public abstract class NodeCoordinator extends androidx.compose.ui.node.LookaheadCapablePlaceable implements Measurable, LayoutCoordinates, androidx.compose.ui.node.OwnerScope {
    ...
    private final void hitNear-JHbHoSQ(Modifier.Node $this$hitNear_u2dJHbHoSQ, androidx.compose.ui.node.NodeCoordinator.HitTestSource hitTestSource, long pointerPosition, androidx.compose.ui.node.HitTestResult hitTestResult, boolean isTouchEvent, boolean isInLayer, float distanceFromEdge) {
        ...
        if ($this$hitNear_u2dJHbHoSQ == null) {
            ...
            f = distanceFromEdge;
            f2 = obj18;
            anon = new NodeCoordinator.hitNear.1(this, $this$hitNear_u2dJHbHoSQ, hitTestSource, pointerPosition, obj5, isTouchEvent, isInLayer, f, f2);
            isTouchEvent.hitInMinimumTouchTarget($this$hitNear_u2dJHbHoSQ, f2, f, (Function0)anon);
        }
    }
    ...
    public final androidx.compose.ui.node.NodeCoordinator findCommonAncestor$ui_release(androidx.compose.ui.node.NodeCoordinator other) {
        ...
        androidx.compose.ui.node.LayoutNode parent$ui_release4;
        ...
        while (ancestor1.getDepth$ui_release() > ancestor2.getDepth$ui_release()) {
            parent$ui_release4 = ancestor1.getParent$ui_release();
            Intrinsics.checkNotNull(parent$ui_release4);
            ancestor1 = parent$ui_release4;
        }
        ...
        while (ancestor1 != ancestor2) {
            ...
            parent$ui_release = ancestor2.getParent$ui_release();
            ancestor1 = parent$ui_release3;
            ancestor2 = parent$ui_release;
        }
    ...
    public Object getParentData() {
        ...
        if (getLayoutNode().getNodes$ui_release().has-H91voCI$ui_release(NodeKind.constructor-impl(64))) {
            ...
            while (parent$ui_release != null) {
                ...
                this_$iv2 = nodes$ui_release;
                i3 = $i$f$tailToHead$ui_release;
                node4 = parent$ui_release;
                if (node3 != getTail()) {
                }
                parent$ui_release = node4.getParent$ui_release();
                nodes$ui_release = this_$iv2;
                $i$f$tailToHead$ui_release = i3;
                count$iv = 64;
                int i11 = 0;
                $i$f$getParentDataOLwlOKw = NodeKind.constructor-impl(count$iv);
                i5 = 0;
                stack$iv = 0;
                int i12 = 0;
                node$iv = node2;
    ...
    public Set<AlignmentLine> getProvidedAlignmentLines() {
        ...
        while (coordinator != null) {
            ...
            linkedHashSet = 0;
            i = 1;
            if (alignmentLines != null && empty ^= i == i) {
            }
        ...
        if (includeSelfInTraversal-H91voCI) {
            ...
            while (node$iv$iv4 != null) {
                ...
                while (node != null) {
                    ...
                    if ($i$f$isKindH91voCI$ui_release != 0 && node instanceof DelegatingNode) {
                    } else {
                    }
                    layer2 = layer;
                    i8 = $i$f$getDrawOLwlOKw;
                    ...
                    count$iv$iv2 = 0;
                    node3 = 0;
                    node$iv$iv$iv = (DelegatingNode)node.getDelegate$ui_release();
    ...
    public final void onPlaced() {
        ...
        final int i12 = 0;
        if (includeSelfInTraversal-H91voCI) {
            node$iv$iv2 = NodeCoordinator.access$headNode(nodeCoordinator2, includeSelfInTraversal-H91voCI);
            while (node$iv$iv2 != null) {
                ...
                while (node$iv$iv != null) {
                    ...
                    type$iv = $i$f$getLayoutAwareOLwlOKw;
                    Modifier.Node type$iv2 = node$iv$iv;
                    int i14 = 0;
                    node5 = type$iv2;
                    ...
                    node = 0;
                    type$iv = $i$f$getLayoutAwareOLwlOKw;
                    (LayoutAwareModifierNode)node$iv$iv.onPlaced((LayoutCoordinates)this);
                    this_$iv2 = nodeCoordinator;
                    i2 = $i$f$visitNodesALcG6gQ;
                }
                type$iv = $i$f$getLayoutAwareOLwlOKw;
        ...
        if (layer != null && this.isClipping) {
            if (this.isClipping) {
                if (clipToMinimumTouchTargetSize) {
                    ...
                    width-impl2 /= i10;
                    height-impl2 /= i10;
                    bounds.intersect(-l3, -i5, f5 += l3, f6 += i5);
                } else {
                    if (clipBounds) {
                        l3 = 0;
                        bounds.intersect(l3, l3, (float)width-impl, (float)height-impl);
                    }
                }
                if (bounds.isEmpty()) {
                }
    ...
    public final void releaseLayer() {
        ...
        if (this.layer != null && this.explicitLayer != null) {
            i2 = 0;
            if (this.explicitLayer != null) {
                this.explicitLayer = i2;
            }
            i3 = 0;
            NodeCoordinator.updateLayerBlock$default(this, i2, i3, 2, i2);
            LayoutNode.requestRelayout$ui_release$default(getLayoutNode(), i3, 1, i2);
        }
    }
            ...
            if (oldAlignmentLines2 != 0) {
                ...
                if (!value.getAlignmentLines().isEmpty() && !Intrinsics.areEqual(value.getAlignmentLines(), this.oldAlignmentLines) && this.oldAlignmentLines == null) {
                    if (!Intrinsics.areEqual(value.getAlignmentLines(), this.oldAlignmentLines)) {
                        ...
                        oldAlignmentLines2.putAll(value.getAlignmentLines());
                    }
                }
            } else {
            }
    ...
    public final boolean shouldSharePointerInputWithSiblings() {
        ...
        int i13 = 0;
        type$iv2 = 16;
        count$iv$iv = this.headNode(NodeKindKt.getIncludeSelfInTraversal-H91voCI(NodeKind.constructor-impl(type$iv2)));
        if (count$iv$iv == null) {
            return 0;
        }
        if (count$iv$iv.isAttached()) {
            int i15 = 0;
            ...
            if (aggregateChildKindSet$ui_release &= i12 != 0) {
                ...
                while (next$iv$iv != null) {
                    ...
                    while (node$iv$iv2 != null) {
                        ...
                        this_$iv$iv$iv2 = 0;
                        if (this_$iv$iv$iv2 != 0 && node$iv$iv2 instanceof DelegatingNode) {
                        } else {
                        }
                        type$iv = type$iv2;
                        node$iv$iv2 = DelegatableNodeKt.access$pop(i6);
                        arr = this;
                        count$iv$iv = start;
                        type$iv2 = type$iv;
    ...
    public final void updateLayerBlock(Function1<? super GraphicsLayerScope, Unit> layerBlock, boolean forceUpdateLayerParameters) {
        ...
        if (layoutNode.isAttached() && layerBlock != null) {
            if (layerBlock != null) {
                ...
                if (this.layer == null) {
                    i2 = 0;
                    layer$default = Owner.createLayer$default(LayoutNodeKt.requireOwner(layoutNode), this.drawBlock, this.invalidateParentLayer, i2, 4, 0);
                    i = layer$default;
                    i5 = 0;
                    i.resize-ozmzZPI(getMeasuredSize-YbymL2g());
                    i.move--gyyYBs(getPosition-nOcc-ac());
