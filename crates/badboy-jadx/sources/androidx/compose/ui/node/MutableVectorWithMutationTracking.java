...
public final class MutableVectorWithMutationTracking<T>  {
    ...
    public final void forEach(Function1<? super T, Unit> block) {
        ...
        Object obj;
        final int i = 0;
        final MutableVector vector = getVector();
        final int i2 = 0;
        final int size = vector.getSize();
        if (size > 0) {
            i$iv = 0;
            block.invoke(vector.getContent()[i$iv]);
            while (i$iv++ >= size) {
    ...
    public final T removeAt(int index) {
        Object at = this.vector.removeAt(index);
        final Object obj = at;
        final int i = 0;
        this.onVectorMutated.invoke();
        return at;
