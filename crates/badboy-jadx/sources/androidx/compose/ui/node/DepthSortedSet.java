...
public final class DepthSortedSet {
    ...
    public final void add(androidx.compose.ui.node.LayoutNode node) {
        ...
        String $i$a$CheckPreconditionDepthSortedSet$add$1;
        String $i$a$CheckPreconditionDepthSortedSet$add$2;
        ...
        if (this.extraAssertions) {
            ...
            if ((Integer)value$iv == null) {
                ...
                $i$a$CheckPreconditionDepthSortedSet$add$1 = 0;
    ...
    public final boolean contains(androidx.compose.ui.node.LayoutNode node) {
        ...
        int i;
        String $i$a$CheckPreconditionDepthSortedSet$contains$1;
    ...
    public final boolean remove(androidx.compose.ui.node.LayoutNode node) {
        boolean extraAssertions;
        String $i$a$CheckPreconditionDepthSortedSet$remove$1;
        int valueOf;
        int i;
        String $i$a$CheckPreconditionDepthSortedSet$remove$2;
        int i2 = 0;
        if (!node.isAttached()) {
            int i3 = 0;
