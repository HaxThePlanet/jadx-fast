...
public abstract class LookaheadCapablePlaceable extends Placeable implements androidx.compose.ui.node.MeasureScopeWithLayoutNode, androidx.compose.ui.node.MotionReferencePlacementDelegate {
    ...
    private final void addRulerReader(androidx.compose.ui.node.LayoutNode layoutNode, Ruler ruler) {
        ...
        if (rulerReaders != null) {
            ...
            if (0 <= i6) {
                ...
                lArr2 = $i$f$removeIf;
                $this$maskEmptyOrDeleted$iv$iv$iv = value$iv$iv$iv;
                i4 = 7;
        ...
        if (obj3.rulerReaders == null) {
            this_$iv2 = new MutableScatterMap(0, 1, i5);
            i$iv$iv = 0;
            obj3.rulerReaders = this_$iv2;
        }
        MutableScatterMap map2 = this_$iv2;
        int i13 = 0;
        if (map2.get(obj4) == null) {
            int i14 = 0;
            mutableScatterSet = new MutableScatterSet(0, 1, i5);
            int i15 = 0;
    ...
    private final void captureRulers(androidx.compose.ui.node.PlaceableResult placeableResult) {
        Object cmp3;
        androidx.compose.ui.node.PlaceableResult j$iv$iv4;
        int newValue;
        int j$iv$iv;
        ...
        float newValue2;
        cmp3 = this;
        j$iv$iv4 = placeableResult;
        if (cmp3.isPlacingForAlignment) {
        }
        index$iv$iv = j$iv$iv4.getResult().getRulers();
        final MutableScatterMap rulerReaders = cmp3.rulerReaders;
        slot$iv$iv = 8;
        if (index$iv$iv == null) {
            if (rulerReaders != null) {
            ...
            l = -9187201950435737472L;
            i5 = 0;
            if (cmp3.rulerValuesCache == null) {
                mutableObjectFloatMap2 = new MutableObjectFloatMap(0, 1, i5);
                i6 = 0;
                cmp3.rulerValuesCache = mutableObjectFloatMap2;
            }
            if (cmp3.rulerValues == null) {
                mutableObjectFloatMap = new MutableObjectFloatMap(0, 1, i5);
                $this$maskEmptyOrDeleted$iv$iv$iv = 0;
                cmp3.rulerValues = mutableObjectFloatMap;
            } else {
                i2 = 0;
                i$iv$iv3 = 1;
            }
            ...
            snapshotObserver = cmp3.getLayoutNode().getOwner$ui_release();
            ...
            if (snapshotObserver != null && snapshotObserver != null) {
                ...
                if (snapshotObserver != null) {
                    i$iv$iv2 = new LookaheadCapablePlaceable.captureRulers.3(j$iv$iv4, cmp3);
                    snapshotObserver.observeReads$ui_release((OwnerScope)j$iv$iv4, LookaheadCapablePlaceable.onCommitAffectingRuler, (Function0)i$iv$iv2);
                }
            }
            if (rulerReaders != null) {
            ...
            j$iv$iv4 = mutableObjectFloatMap;
            i$iv$iv = 0;
            $this$maskEmptyOrDeleted$iv$iv$iv = i6.metadata;
            length3 += -2;
            if (0 <= j$iv$iv2) {
            } else {
                slot$iv$iv2 = j$iv$iv4;
