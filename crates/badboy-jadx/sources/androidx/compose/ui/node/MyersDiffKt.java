...
public final class MyersDiffKt {
    ...
    private static final androidx.compose.ui.node.IntStack calculateDiff(int oldSize, int newSize, androidx.compose.ui.node.DiffCallback cb) {
        ...
        while (intStack2.isNotEmpty()) {
            ...
            i4 = intStack2.pop();
            i3 = intStack2.pop();
            if (MyersDiffKt.midPoint-q5eDKzI(i3, i4, i2, i, cb, CenteredArray.constructor-impl(new int[i13++]), CenteredArray.constructor-impl(new int[i15++]), constructor-impl3) != null && Snake.getDiagonalSize-impl(constructor-impl3) > 0) {
            }
            if (Snake.getDiagonalSize-impl(constructor-impl3) > 0) {
            }
            intStack2.pushRange(i3, Snake.getStartX-impl(constructor-impl3), i2, Snake.getStartY-impl(constructor-impl3));
            intStack2.pushRange(Snake.getEndX-impl(constructor-impl3), i4, Snake.getEndY-impl(constructor-impl3), i);
