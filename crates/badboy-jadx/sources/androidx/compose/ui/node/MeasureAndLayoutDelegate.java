...
public final class MeasureAndLayoutDelegate {
    ...
    private final void forceMeasureTheSubtreeInternal(androidx.compose.ui.node.LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                i2 = 1;
                if (obj.getLookaheadMeasurePending$ui_release() && this.relayoutNodes.contains(obj, i2)) {
                } else {
                }
                forceMeasureTheSubtree(obj, i2);
                if (this.relayoutNodes.contains(obj, i2)) {
                } else {
                }
                remeasureAndRelayoutIfNeeded(obj, i2, false);
    ...
    public final boolean measureAndLayout(Function0<Unit> onLayout) {
        ...
        int i7;
        int i5;
        androidx.compose.ui.node.DepthSortedSet set2;
        int notEmpty;
        String $i$a$RequirePreconditionMeasureAndLayoutDelegate$performMeasureAndLayout$1$iv;
        int i8;
        int i;
        boolean z;
        androidx.compose.ui.node.DepthSortedSetsForDifferentPasses set;
        int i2;
        int rootNodeResized;
        int i3;
        int i4;
        ...
        if (obj2.rootConstraints != null && obj.relayoutNodes.isNotEmpty()) {
            ...
            if (obj.relayoutNodes.isNotEmpty()) {
                ...
                while (set.isNotEmpty()) {
                    ...
                    set2 = DepthSortedSetsForDifferentPasses.access$getSet$p(set);
                    i5 = set2.pop();
                    i4 = i5;
                    i6 = 0;
                    if (i5 == MeasureAndLayoutDelegate.access$getRoot$p(this) && MeasureAndLayoutDelegate.remeasureAndRelayoutIfNeeded$default(obj, i5, i3, false, 4, 0) != null) {
                    }
                    obj = this;
                    if (MeasureAndLayoutDelegate.remeasureAndRelayoutIfNeeded$default(obj, i5, i3, false, 4, 0) != null) {
                    }
                    rootNodeResized = 1;
                    set2 = DepthSortedSetsForDifferentPasses.access$getLookaheadSet$p(set);
                }
                if (onLayout != null) {
                    onLayout.invoke();
                }
    ...
    public final boolean requestLookaheadRelayout(androidx.compose.ui.node.LayoutNode layoutNode, boolean forced) {
        ...
        switch (i3) {
            ...
            case 2:
                ...
                i = 1;
                lookaheadMeasurePending$ui_release = i;
                lookaheadMeasurePending$ui_release = i2;
                lookaheadMeasurePending$ui_release = i;
                lookaheadMeasurePending$ui_release = i2;
