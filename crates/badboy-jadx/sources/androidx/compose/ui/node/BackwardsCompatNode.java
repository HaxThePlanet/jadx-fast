...
public final class BackwardsCompatNode extends Modifier.Node implements androidx.compose.ui.node.LayoutModifierNode, androidx.compose.ui.node.DrawModifierNode, androidx.compose.ui.node.SemanticsModifierNode, androidx.compose.ui.node.PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, androidx.compose.ui.node.ParentDataModifierNode, androidx.compose.ui.node.LayoutAwareModifierNode, androidx.compose.ui.node.GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, androidx.compose.ui.node.OwnerScope, BuildDrawCacheParams {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        i3 = 0;
        final int i32 = 1;
        this_$iv5 = kindSet$ui_release &= $i$f$getLocalsOLwlOKw != 0 ? i32 : i3;
        if (this_$iv5 != 0 && value$iv instanceof ModifierLocalConsumer) {
        ...
        int i7 = 0;
        int i17 = 0;
        this_$iv3 = kindSet$ui_release2 &= $i$f$getDrawOLwlOKw != 0 ? i32 : i3;
        if (this_$iv3 != 0 && value$iv instanceof DrawCacheModifier) {
        ...
        int i8 = 0;
        i2 = 0;
        this_$iv2 = kindSet$ui_release3 &= $i$f$getLayoutOLwlOKw != 0 ? i32 : i3;
        if (this_$iv2 != 0 && BackwardsCompatNodeKt.access$isChainUpdate(this)) {
        ...
        int i9 = 0;
        anon2 = 0;
        isChainUpdate = kindSet$ui_release4 &= $i$f$getLayoutAwareOLwlOKw != 0 ? i32 : i3;
        if (isChainUpdate != 0 && value$iv instanceof OnRemeasuredModifier && BackwardsCompatNodeKt.access$isChainUpdate(this)) {
        ...
        int i10 = 0;
        int i21 = 0;
        this_$iv = kindSet$ui_release5 &= $i$f$getGlobalPositionAwareOLwlOKw != 0 ? i32 : i3;
        ...
        int i11 = 0;
        int i23 = 0;
        this_$iv4 = kindSet$ui_release6 &= $i$f$getPointerInputOLwlOKw != 0 ? i32 : i3;
        if (this_$iv4 != 0 && value$iv instanceof PointerInputModifier) {
