...
public final class LayoutNodeDrawScope implements DrawScope, ContentDrawScope {
    ...
    public void drawContent() {
        ...
        $this$drawIntoCanvas$iv3 = requireCoordinator-64DMado;
        Canvas canvas = (DrawScope)$this$drawIntoCanvas$iv3.getDrawContext().getCanvas();
        final int i9 = 0;
        ...
        if (node5 != null) {
            ...
            while (node$iv != null) {
                ...
                while (node$iv$iv != null) {
                    ...
                    node$iv = $this$drawIntoCanvas$iv3;
            ...
            $this$drawIntoCanvas$iv3.performDraw(canvas, getDrawContext().getGraphicsLayer());
        }
    }
