...
final class CanvasCompatQ {
    ...
    public static final androidx.compose.ui.text.android.CanvasCompatQ INSTANCE;
    static {
        CanvasCompatQ canvasCompatQ = new CanvasCompatQ();
        CanvasCompatQ.INSTANCE = canvasCompatQ;
    }
