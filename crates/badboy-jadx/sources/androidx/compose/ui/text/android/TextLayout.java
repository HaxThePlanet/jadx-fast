...
public final class TextLayout {
    ...
    public TextLayout(java.lang.CharSequence charSequence, float width, TextPaint textPaint, int alignment, TextUtils.TruncateAt ellipsize, int textDirectionHeuristic, float lineSpacingMultiplier, float lineSpacingExtra, boolean includePadding, boolean fallbackLineSpacing, int maxLines, int breakStrategy, int lineBreakStyle, int lineBreakWordStyle, int hyphenationFrequency, int justificationMode, int[] leftIndents, int[] rightIndents, androidx.compose.ui.text.android.LayoutIntrinsics layoutIntrinsics) {
        ...
        if (obj3 instanceof Spanned) {
            i9 = (Spanned)obj3.nextSpanTransition(-1, length, BaselineShiftSpan.class) < length ? i17 : i18;
        } else {
            i9 = i18;
        }
        ...
        if (boringMetrics2 != null && Float.compare(maxIntrinsicWidth, f) <= 0) {
            if (Float.compare(maxIntrinsicWidth, f) <= 0) {
                if (i9 == 0) {
                    ...
                    i8 = boringMetrics2;
                    boringMetrics = z2;
                    create = BoringLayoutFactory.INSTANCE.create(obj3, obj5.textPaint, i, i8, alignment2, obj5.includePadding, obj5.fallbackLineSpacing, ellipsize, i);
                    metrics = i8;
                    obj = maxLines;
                    ...
                    widthInt = alignment2;
                    create = StaticLayoutFactory.INSTANCE.create(charSequence, obj5.textPaint, i, 0, charSequence.length(), frameworkTextDir, widthInt, maxLines, ellipsize, (int)f2, lineSpacingMultiplier, lineSpacingExtra, justificationMode, obj5.includePadding, obj5.fallbackLineSpacing, breakStrategy, lineBreakStyle, lineBreakWordStyle, hyphenationFrequency, leftIndents, rightIndents);
                    alignment2 = widthInt;
                }
            } else {
                metrics = boringMetrics2;
    ...
    public TextLayout(java.lang.CharSequence charSequence, float f2, TextPaint textPaint3, int i4, TextUtils.TruncateAt textUtils$TruncateAt5, int i6, float f7, float f8, boolean z9, boolean z10, int i11, int i12, int i13, int i14, int i15, int i16, int[] i17Arr17, int[] i18Arr18, androidx.compose.ui.text.android.LayoutIntrinsics layoutIntrinsics19, int i20, DefaultConstructorMarker defaultConstructorMarker21) {
        ...
        i = i30 & 128 != 0 ? i2 : f8;
        i5 = i30 & 256 != 0 ? i45 : z9;
        i24 = i30 & 512 != 0 ? i10 : z10;
        i29 = i30 & 1024 != 0 ? i28 : i11;
        i19 = i30 & 2048 != 0 ? i45 : i12;
        i21 = i30 & 4096 != 0 ? i45 : i13;
        i17 = i30 & 8192 != 0 ? i45 : i14;
        i7 = i30 & 16384 != 0 ? i45 : i15;
        i27 = i38 &= i30 != 0 ? i45 : i16;
        i22 = i40 &= i30 != 0 ? i46 : i17Arr17;
        i9 = i42 &= i30 != 0 ? i46 : i18Arr18;
        if (i30 &= i44 != 0) {
            layoutIntrinsics2 = new LayoutIntrinsics(charSequence, textPaint3, i18);
        ...
        super(charSequence2, f2, textPaint, i23, i25, i18, i26, i, i5, i24, i29, i19, i21, i17, i7, i27, i22, i9, layoutIntrinsics);
    }
    ...
    public final void fillBoundingBoxes(int startOffset, int endOffset, float[] array, int arrayStart) {
        ...
        if (i8 == 0) {
            ...
            i4 = i3 < length ? offset : 0;
            if (i4 == 0) {
            } else {
                i11 = i19 > i3 ? offset : 0;
                if (i11 == 0) {
                } else {
                    i = i19 <= length ? offset : 0;
                    if (i == 0) {
                    } else {
                        i10 = length2 -= arrayStart >= i20 * 4 ? offset : 0;
                        if (i10 == 0) {
                        } else {
