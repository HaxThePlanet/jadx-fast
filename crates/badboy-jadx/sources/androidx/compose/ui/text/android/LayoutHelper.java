...
public final class LayoutHelper {
    ...
    public final Bidi analyzeBidi(int paragraphIndex) {
        ...
        if (Bidi.requiresBidi(cArr, runCount, i6)) {
            i5 = isRtlParagraph(paragraphIndex) ? i8 : runCount;
            bidi = new Bidi(cArr, 0, 0, 0, i6, i5);
    ...
    public final float getHorizontalPosition(int offset, boolean usePrimaryDirection, boolean upstream) {
        ...
        lineEnd = obj.layout.getLineEnd(lineForOffset);
        if (i18 != lineStart && i18 != lineEnd) {
            if (i18 != lineEnd) {
                return getDownstreamHorizontal(offset, usePrimaryDirection);
            }
        }
        if (i18 != 0) {
            if (i18 == obj.layout.getText().length()) {
                ...
                final int lineEndToVisibleEnd2 = obj.lineEndToVisibleEnd(lineEnd, lineStart);
                ...
                if (lineBidi != 0) {
                    if (lineBidi.getRunCount() == 1) {
                        ...
                        while (i12 < runCount3) {
                            ...
                            i9 = 0;
                            LayoutHelper.BidiRun bidiRun2 = new LayoutHelper.BidiRun(lineStart + runStart, lineStart + runLimit, i9);
                            arr[i12] = bidiRun2;
                            i12++;
                            z2 = upstream;
                            i4 = i15;
                            lineEnd = i5;
                            paragraphForOffset = i;
                            paragraphStart = i13;
                            i9 = bidiStart2;
                        }
                        int lineEnd5 = lineEnd;
                        ...
                        i16 = 0;
                        Bidi.reorderVisually(bArr, i16, arr, i16, arr.length);
                        if (i18 == lineStart) {
                            rtl = arr;
                            int i25 = 0;
                            index$iv = 0;
                            while (index$iv < rtl.length) {
                                i3 = 0;
                                if (rtl[index$iv].getStart() == i18) {
                                } else {
                                }
                                i16 = 0;
                                index$iv++;
                            ...
                            if (i8 == ArraysKt.getLastIndex(arr) && i17 == 0) {
                                if (i17 == 0) {
                        ...
                        rtl2 = 0;
                        index$iv2 = 0;
                        while (index$iv2 < objArr.length) {
                            i3 = 0;
                            if (objArr[index$iv2].getEnd() == lineEndToVisibleEnd) {
                            } else {
                            }
                            bidiStart = 0;
                            index$iv2++;
                        ...
                        index$iv2 = -1;
                        if (!usePrimaryDirection) {
                            if (rtlParagraph == arr[index$iv2].isRtl()) {
                                i10 = rtlParagraph;
                            } else {
                        ...
                        if (index$iv2 == 0 && i10 != 0) {
                            if (i10 != 0) {
                                return obj.layout.getLineLeft(lineForOffset);
                            }
                        }
                        if (index$iv2 == ArraysKt.getLastIndex(arr) && i10 == 0) {
                            if (i10 == 0) {
                                return obj.layout.getLineRight(lineForOffset);
                            }
                        }
                        if (i10 != 0) {
                            return obj.layout.getPrimaryHorizontal(arr[index$iv2 + -1].getEnd());
                        }
                    }
                    return obj.layout.getPrimaryHorizontal(arr[index$iv2 + 1].getEnd());
                }
    ...
    public final androidx.compose.ui.text.android.LayoutHelper.BidiRun[] getLineBidiRuns$ui_text_release(int lineIndex) {
        ...
        final Object obj = this;
        i2 = lineIndex;
        int lineStart = obj.layout.getLineStart(i2);
        int lineEnd = obj.layout.getLineEnd(i2);
        i6 = 0;
        int paragraphForOffset$default = LayoutHelper.getParagraphForOffset$default(obj, lineStart, i6, 2, 0);
        ...
        if (analyzeBidi != null) {
            ...
            if (analyzeBidi == null) {
                ...
                while (i5 < runCount) {
                    ...
                    i7 = i;
                    bidiRun = new LayoutHelper.BidiRun(lineStart + runStart, lineStart + runLimit, i7);
                    arr2[i5] = bidiRun;
                    i5++;
                    i2 = lineIndex;
                    i6 = i;
