...
public final class IndentationFixSpan_androidKt {
    ...
    public static final float getEllipsizedLeftPadding(Layout $this$getEllipsizedLeftPadding, int lineIndex, Paint paint) {
        ...
        int i6 = 0;
        i = 1;
        if (TextLayout_androidKt.isLineEllipsized($this$getEllipsizedLeftPadding, lineIndex) && $this$getEllipsizedLeftPadding.getParagraphDirection(lineIndex) == i && Float.compare(lineLeft, i6) < 0) {
            i = 1;
            if ($this$getEllipsizedLeftPadding.getParagraphDirection(lineIndex) == i) {
