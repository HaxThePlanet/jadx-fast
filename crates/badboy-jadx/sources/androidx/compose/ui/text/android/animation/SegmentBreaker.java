        ...
        if (breakOffsets.size() != 0) {
            if (breakOffsets.size() == 1) {
                ...
                while (i$iv < CollectionsKt.getLastIndex(breakOffsets)) {
                    ...
                    layout = segment;
                    arrayList = layout2;
                    super(intValue2, intValue, Math.min(result$iv, i4), layout.getLineTop(lineEndSpace), Math.max(result$iv, i4), layout.getLineBottom(lineEndSpace));
        ...
        if (breakOffsets.size() != 0) {
            if (breakOffsets.size() == 1) {
                ...
                while (i$iv < CollectionsKt.getLastIndex(breakOffsets)) {
                    ...
                    i8 = 0;
                    int lineForOffset = LayoutCompat_androidKt.getLineForOffset(layout, intValue, i6);
                    if (layout.getParagraphDirection(lineForOffset) == -1) {
                    } else {
                    }
                    i3 = 0;
                    ...
                    i9 = 0;
                    int i16 = (int)f3;
                    left = Math.min(i11, i16);
                    right = Math.max(i11, i16);
                    ...
                    lineNo = segment;
                    int i15 = i20;
                    super(intValue, intValue2, i4, layout.getLineTop(lineForOffset), i12, layout.getLineBottom(lineForOffset));
