...
public final class PlaceholderSpan extends ReplacementSpan {
    ...
    public int getSize(Paint paint, java.lang.CharSequence text, int start, int end, Paint.FontMetricsInt fm) {
        ...
        if (i2 == 0) {
            ...
            this.widthPx = PlaceholderSpan_androidKt.ceilToInt(i);
            switch (heightUnit) {
                case 0:
            ...
            if (fm != null) {
                ...
                switch (verticalAlign) {
                    case 0:
                        ...
                        break;
                    case 1:
                        ceilToInt.descent = ascent7 += heightPx2;
                        break;
                    case 2:
                        ceilToInt.ascent = descent4 -= heightPx2;
                        break;
                    case 3:
                        ceilToInt.ascent = ascent4 -= i9;
                        ceilToInt.descent = ascent5 += heightPx2;
                        break;
                    default:
