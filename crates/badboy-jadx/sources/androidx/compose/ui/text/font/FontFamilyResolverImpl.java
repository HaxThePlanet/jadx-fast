...
public final class FontFamilyResolverImpl implements androidx.compose.ui.text.font.FontFamily.Resolver {
    ...
    public Object preload(androidx.compose.ui.text.font.FontFamily fontFamily, Continuation<? super Unit> continuation2) {
        ...
        Object cacheKey;
        int i4;
        androidx.compose.ui.text.font.FontFamilyResolverImpl.preload.1 anon2;
        Object obj26;
        obj = continuation2;
        anon = obj;
        i = Integer.MIN_VALUE;
        if (obj instanceof FontFamilyResolverImpl.preload.1 && label3 &= i != 0) {
            anon = obj;
            i = Integer.MIN_VALUE;
            if (label3 &= i != 0) {
                anon.label = label2 -= i;
                ...
                anon = new FontFamilyResolverImpl.preload.1(this, obj);
            }
        } else {
        }
        result = anon.result;
        ...
        switch (label) {
            ...
            default:
                obj26 = result;
                androidx.compose.ui.text.font.FontFamilyResolverImpl.preload.1 anon5 = anon;
        ...
        obj26 = result;
        androidx.compose.ui.text.font.FontFamilyResolverImpl.preload.1 anon4 = anon;
