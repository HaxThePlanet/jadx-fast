...
public final class AsyncFontListLoader implements State<Object> {
    ...
    public final Object load(Continuation<? super Unit> continuation) {
        ...
        switch (label3) {
            ...
            case 1:
                ...
                i2 = i$1;
                obj2 = l$0;
                i5 = $i$a$FastForEachAsyncFontListLoader$load$23;
                $i$f$fastForEach = i7;
                $i$a$FastForEachAsyncFontListLoader$load$22 = $result2;
                ...
                obj2.cacheable = i9;
                i = i9;
                TypefaceResult.Immutable immutable3 = new TypefaceResult.Immutable(obj2.getValue(), i);
                ...
                $result2 = $i$a$FastForEachAsyncFontListLoader$load$22;
                $result = i5;
                async-PKNRLFQ = l$1;
                $i$f$fastForEach2 = i2;
                ...
                i2 = $i$f$fastForEach2;
                index$iv2 = font;
                $i$a$FastForEachAsyncFontListLoader$load$2 = async-PKNRLFQ;
                obj2 = $this$fastForEach$iv;
                index$iv2 += i;
                break;
            case 2:
        ...
        TypefaceResult.Immutable immutable = new TypefaceResult.Immutable(obj2.getValue(), i);
    ...
    public final Object loadWithTimeoutOrNull$ui_text_release(androidx.compose.ui.text.font.Font font, Continuation<Object> continuation2) {
        ...
        androidx.compose.ui.text.font.AsyncFontListLoader.loadWithTimeoutOrNull.2 context2;
        ...
        Object obj10;
        anon = continuation2;
        context = Integer.MIN_VALUE;
        if (continuation2 instanceof AsyncFontListLoader.loadWithTimeoutOrNull.1 && label2 &= context != null) {
            anon = continuation2;
            context = Integer.MIN_VALUE;
            if (label2 &= context != null) {
                anon.label = obj10 -= context;
            } else {
        ...
        switch (label) {
            case 0:
                ...
                context2 = new AsyncFontListLoader.loadWithTimeoutOrNull.2(this, font, 0);
                anon.L$0 = font;
                anon.label = 1;
                return cOROUTINE_SUSPENDED;
            case 1:
