...
public final class DeviceFontFamilyName {
    ...
    public static String constructor-impl(String name) {
        ...
        int i2 = 0;
        IllegalArgumentException $i$a$RequireDeviceFontFamilyName$1 = new IllegalArgumentException("name may not be empty".toString());
        throw $i$a$RequireDeviceFontFamilyName$1;
    }
