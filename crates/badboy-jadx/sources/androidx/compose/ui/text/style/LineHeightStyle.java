    ...
    public static final class Alignment {
        ...
        public static float constructor-impl(float topRatio) {
            ...
            if (Float.compare(i3, topRatio) <= 0 && Float.compare(topRatio, i4) <= 0) {
                i = Float.compare(topRatio, i4) <= 0 ? i2 : i7;
            } else {
            }
            if (i == 0) {
                i = Float.compare(topRatio, i6) == 0 ? i2 : i7;
                if (i != 0) {
                } else {
                    i2 = i7;
                }
        ...
        public static String toString-impl(float arg0) {
            ...
            i2 = 1;
            final int i5 = 0;
            i = Float.compare(arg0, top) == 0 ? i2 : i5;
            if (i != 0) {
                string = "LineHeightStyle.Alignment.Top";
            } else {
                i4 = Float.compare(arg0, center) == 0 ? i2 : i5;
                if (i4 != 0) {
                    string = "LineHeightStyle.Alignment.Center";
                } else {
                    i3 = Float.compare(arg0, proportional) == 0 ? i2 : i5;
                    if (i3 != 0) {
