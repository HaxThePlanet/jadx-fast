...
final class ColorStyle implements androidx.compose.ui.text.style.TextForegroundStyle {
    ...
    private ColorStyle(long value) {
        ...
        int i2 = 0;
        IllegalArgumentException $i$a$RequireColorStyle$1 = new IllegalArgumentException("ColorStyle value must be specified, use TextForegroundStyle.Unspecified instead.".toString());
        throw $i$a$RequireColorStyle$1;
    }
