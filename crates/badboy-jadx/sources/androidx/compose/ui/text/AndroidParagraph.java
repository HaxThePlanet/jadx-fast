...
public final class AndroidParagraph implements androidx.compose.ui.text.Paragraph {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics paragraphIntrinsics, int maxLines, boolean ellipsis, long constraints) {
        ...
        if (Constraints.getMinHeight-impl(obj.constraints) == 0 && Constraints.getMinWidth-impl(obj.constraints) == 0) {
            i6 = Constraints.getMinWidth-impl(obj.constraints) == 0 ? i29 : 0;
        } else {
        }
        if (i6 == 0) {
        } else {
            i3 = obj.maxLines >= i29 ? i29 : 0;
            if (i3 == 0) {
            } else {
                ...
                i8 = TextAlign.equals-impl0(style2.getTextAlign-e0LSkKk(), TextAlign.Companion.getJustify-e0LSkKk()) ? i29 : 0;
                ...
                i10 = AndroidParagraph_androidKt.access$toLayoutBreakStrategy-xImikfE(LineBreak.getStrategy-fcGXIks(style2.getLineBreak-rAG3T2k()));
                i15 = AndroidParagraph_androidKt.access$toLayoutLineBreakStyle-hpcqdu8(LineBreak.getStrictness-usljTpc(style2.getLineBreak-rAG3T2k()));
                i = AndroidParagraph_androidKt.access$toLayoutLineBreakWordStyle-wPN0Rpw(LineBreak.getWordBreak-jp8hJ3c(style2.getLineBreak-rAG3T2k()));
                final int i30 = 0;
                ...
                firstLayout2 = obj.constructTextLayout(style, alignment, justificationMode, obj.maxLines, arrayList, i10, i15, i);
                if (obj.ellipsis) {
                    i13 = style;
                    i11 = alignment;
                        ...
                        if (obj.maxLines > i29) {
                            ...
                            if (ellipsis2 >= 0 && ellipsis2 != obj.maxLines) {
                                if (ellipsis2 != obj.maxLines) {
                                    ...
                                    firstLayout2 = obj.constructTextLayout(i13, i11, justificationMode, RangesKt.coerceAtLeast(ellipsis2, i29), arrayList, i10, i15, i);
                                } else {
                                    style = i13;
                                    alignment = i11;
                ...
                if (!charSequence instanceof Spanned) {
                    ...
                    i10 = 0;
                    spans = (Spanned)charSequence.getSpans(i10, charSequence.length(), PlaceholderSpan.class);
                    textPaint$ui_text_release = 0;
                    arrayList = new ArrayList(spans.length);
                    i15 = spans;
                    i = 0;
                    firstLayout = i10;
                    while (firstLayout < i15.length) {
                        lineTop = textStyle;
                        i5 = 0;
