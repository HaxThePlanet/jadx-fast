...
public final class SpanStyleKt {
    ...
    public static final androidx.compose.ui.text.SpanStyle fastMerge-dSHsh3o(androidx.compose.ui.text.SpanStyle $this$fastMerge_u2ddSHsh3o, long color, Brush brush, float alpha, long fontSize, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis, FontFamily fontFamily, String fontFeatureSettings, long letterSpacing, BaselineShift baselineShift, TextGeometricTransform textGeometricTransform, LocaleList localeList, long background, TextDecoration textDecoration, Shadow shadow, androidx.compose.ui.text.PlatformSpanStyle platformStyle, DrawStyle drawStyle) {
        ...
        if (!TextUnitKt.isUnspecified--R2X_6o(fontWeight)) {
            if (TextUnit.equals-impl0(fontWeight, obj12)) {
                if (obj15 == null) {
                    ...
                    $this$isSpecified$iv = Long.compare(i6, $this$isSpecified$iv2) != 0 ? i10 : i;
                        ...
                        if (Color.equals-impl0(l4, obj2)) {
                            if (equal3 != null) {
                                if (Intrinsics.areEqual(equal3, $this$fastMerge_u2ddSHsh3o.getFontStyle-4Lr2A7w())) {
                                    if (equal != null) {
                                        if (Intrinsics.areEqual(equal, $this$fastMerge_u2ddSHsh3o.getFontWeight())) {
                                            if (fontFamily3 != null) {
                                                            ...
                                                            if (obj19 != null) {
                                                                if (Intrinsics.areEqual(obj19, $this$fastMerge_u2ddSHsh3o.getTextDecoration())) {
                                                                    if (Intrinsics.areEqual(obj15, $this$fastMerge_u2ddSHsh3o.getTextForegroundStyle$ui_text_release().getBrush())) {
                                                                        if (obj15 != null) {
                                                                            localeList2 = Float.compare(f, alpha2) == 0 ? i10 : i;
                                                                            if (localeList2 != 0) {
                                                                                if (obj16 != null) {
                                                                                                            ...
                                                                                                            if (Intrinsics.areEqual(textDecoration, $this$fastMerge_u2ddSHsh3o.getTextGeometricTransform())) {
                                                                                                                if (shadow != null) {
                                                                                                                    if (Intrinsics.areEqual(shadow, $this$fastMerge_u2ddSHsh3o.getLocaleList())) {
                                                                                                                        int i5 = 0;
                                                                                                                        $i$f$isSpecified8_81llA = Long.compare(unspecified--R2X_6o, $this$isSpecified$iv2) != 0 ? i10 : i;
        ...
        if (!TextUnitKt.isUnspecified--R2X_6o(l)) {
            l2 = l;
        } else {
        ...
        if (fontFamily == null) {
            obj8 = fontSynthesis-ZQGJjVo;
        } else {
            obj8 = fontFamily;
        }
        if (fontFeatureSettings == null) {
            obj10 = fontSynthesis-ZQGJjVo;
        } else {
            obj10 = fontFeatureSettings;
        }
        if (obj17 == null) {
            obj5 = fontSynthesis-ZQGJjVo;
        } else {
            obj5 = obj17;
        }
        if (!TextUnitKt.isUnspecified--R2X_6o(textGeometricTransform)) {
            l3 = textGeometricTransform;
        } else {
            l3 = textGeometricTransform2;
        }
        if (obj18 == null) {
            obj6 = textGeometricTransform2;
        } else {
            obj6 = obj18;
        }
        if (obj9 == null) {
        ...
        if (i != 0) {
            ...
            int i7 = 0;
            i4 = $i$a$TakeOrElseDxMtmZcSpanStyleKt$fastMerge$1;
        }
        if (obj19 == null) {
            obj12 = textDecoration2;
        } else {
            obj12 = obj19;
        }
        if (obj3 == null) {
        ...
        SpanStyle spanStyle2 = new SpanStyle($this$fastMerge_u2ddSHsh3o.getTextForegroundStyle$ui_text_release().merge(from-8_81llA), l2, obj24, obj2, obj8, obj10, fontFamily2, obj5, l3, obj31, obj6, obj11, obj13, i4, obj36, obj12, obj, SpanStyleKt.mergePlatformStyle(spanStyle, obj4), obj7, 0);
        return spanStyle2;
    }
    ...
    public static final androidx.compose.ui.text.SpanStyle lerp(androidx.compose.ui.text.SpanStyle start, androidx.compose.ui.text.SpanStyle stop, float fraction) {
        ...
        SpanStyle spanStyle = new SpanStyle(TextDrawStyleKt.lerp(start.getTextForegroundStyle$ui_text_release(), stop.getTextForegroundStyle$ui_text_release(), f), lerpTextUnitInheritable-C3pnCVY, obj6, FontWeightKt.lerp(fontWeight, fontWeight2, f), (FontStyle)SpanStyleKt.lerpDiscrete(start.getFontStyle-4Lr2A7w(), stop.getFontStyle-4Lr2A7w(), f), (FontSynthesis)SpanStyleKt.lerpDiscrete(start.getFontSynthesis-ZQGJjVo(), stop.getFontSynthesis-ZQGJjVo(), f), (FontFamily)SpanStyleKt.lerpDiscrete(start.getFontFamily(), fontFamily2, f), (String)SpanStyleKt.lerpDiscrete(start.getFontFeatureSettings(), fontFeatureSettings2, f), SpanStyleKt.lerpTextUnitInheritable-C3pnCVY(start.getLetterSpacing-XSAIIZE(), fontFeatureSettings2, stop.getLetterSpacing-XSAIIZE()), obj13, BaselineShift.box-impl(BaselineShiftKt.lerp-jWV1Mfo(constructor-impl, constructor-impl2, f)), TextGeometricTransformKt.lerp(textGeometricTransform, textGeometricTransform2, f), (LocaleList)SpanStyleKt.lerpDiscrete(start.getLocaleList(), localeList2, f), ColorKt.lerp-jxsXWHM(start.getBackground-0d7_KjU(), localeList2, stop.getBackground-0d7_KjU()), obj18, (TextDecoration)SpanStyleKt.lerpDiscrete(start.getTextDecoration(), stop.getTextDecoration(), f), ShadowKt.lerp(shadow, shadow3, f), SpanStyleKt.lerpPlatformStyle(start.getPlatformStyle(), stop.getPlatformStyle(), f), (DrawStyle)SpanStyleKt.lerpDiscrete(start.getDrawStyle(), stop.getDrawStyle(), f), 0);
        return spanStyle;
    }
