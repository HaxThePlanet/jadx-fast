...
public final class TtsAnnotationExtensions_androidKt {
    public static final TtsSpan toSpan(TtsAnnotation $this$toSpan) {
        if (!$this$toSpan instanceof VerbatimTtsAnnotation) {
            ...
            return TtsAnnotationExtensions_androidKt.toSpan((VerbatimTtsAnnotation)$this$toSpan);
        }
    ...
    public static final TtsSpan toSpan(VerbatimTtsAnnotation $this$toSpan) {
        TtsSpan.VerbatimBuilder verbatimBuilder = new TtsSpan.VerbatimBuilder($this$toSpan.getVerbatim());
        return verbatimBuilder.build();
    }
}
