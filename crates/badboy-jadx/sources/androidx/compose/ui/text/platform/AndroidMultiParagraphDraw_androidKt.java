...
public final class AndroidMultiParagraphDraw_androidKt {
            ...
            if (obj instanceof SolidColor) {
                ...
                if (obj instanceof ShaderBrush) {
                    ...
                    while (index$iv2 < paragraphInfoList$ui_text_release3.size()) {
                        ...
                        i = 0;
                        height += height2;
                        width2 = Math.max(width2, size.getParagraph().getWidth());
                        index$iv2++;
                    }
                    shader-uvyYCjk = (ShaderBrush)obj.createShader-uvyYCjk(SizeKt.Size(width2, height));
                    matrix = new Matrix();
                    ...
                    while (index$iv < paragraphInfoList$ui_text_release.size()) {
                        width = i;
                        i6 = 0;
                        (ParagraphInfo)width.getParagraph().paint-hn5TExg(canvas, (Brush)BrushKt.ShaderBrush(shader-uvyYCjk), alpha, shadow, decoration, drawStyle, blendMode);
                        i4 = 0;
                        canvas.translate(i4, width.getParagraph().getHeight());
                        matrix.setTranslate(i4, -height4);
    ...
    public static void drawMultiParagraph-7AXcY_I$default(MultiParagraph multiParagraph, Canvas canvas2, Brush brush3, float f4, Shadow shadow5, TextDecoration textDecoration6, DrawStyle drawStyle7, int i8, int i9, Object object10) {
        ...
        AndroidMultiParagraphDraw_androidKt.drawMultiParagraph-7AXcY_I(multiParagraph, canvas2, brush3, i3, i4, i5, i2, i);
    }
