...
public final class Html_androidKt {
    ...
    private static final FontFamily optionalFontFamilyFromName(String familyName) {
        ...
        Typeface create = Typeface.create(familyName, i3);
        final Typeface typeface2 = create;
        final int i5 = 0;
        if (!Intrinsics.areEqual(create, Typeface.DEFAULT) && !Intrinsics.areEqual(create, Typeface.create(Typeface.DEFAULT, i3))) {
            if (!Intrinsics.areEqual(create, Typeface.create(Typeface.DEFAULT, i3))) {
            } else {
                i4 = i3;
            }
        } else {
    ...
    private static final androidx.compose.ui.text.SpanStyle toSpanStyle(StyleSpan $this$toSpanStyle) {
        ...
        switch (italic-_-LCdwA) {
            case 1:
                ...
                break;
            case 2:
                spanStyle2 = new SpanStyle(0, obj4, 0, obj6, 0, FontStyle.box-impl(FontStyle.Companion.getItalic-_-LCdwA()), 0, 0, 0, 0, obj13, 0, 0, 0, 0, obj18, 0, 0, 0, 0, 65527, 0);
