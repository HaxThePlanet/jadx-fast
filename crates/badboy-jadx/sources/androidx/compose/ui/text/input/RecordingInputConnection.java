...
public final class RecordingInputConnection implements InputConnection {
    ...
    public boolean requestCursorUpdates(int cursorUpdateMode) {
        ...
        if (isActive) {
            ...
            sDK_INT2 = 0;
            final int i13 = 1;
            i6 = cursorUpdateMode & 1 != 0 ? i13 : sDK_INT2;
            i7 = cursorUpdateMode & 2 != 0 ? i13 : sDK_INT2;
            if (Build.VERSION.SDK_INT >= 33) {
                i = cursorUpdateMode & 16 != 0 ? i13 : sDK_INT2;
                includeInsertionMarker = i;
                i2 = cursorUpdateMode & 8 != 0 ? i13 : sDK_INT2;
                includeCharacterBounds = i2;
                i4 = cursorUpdateMode & 4 != 0 ? i13 : sDK_INT2;
            ...
            this.eventCallback.onRequestCursorAnchorInfo(i6, i7, includeEditorBounds, includeLineBounds2, i5, i3);
            return i13;
        }
        return isActive;
    }
