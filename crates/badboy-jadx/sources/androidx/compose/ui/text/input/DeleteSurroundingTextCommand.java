...
public final class DeleteSurroundingTextCommand implements androidx.compose.ui.text.input.EditCommand {
    ...
    public void applyTo(androidx.compose.ui.text.input.EditingBuffer buffer) {
        ...
        int i4 = 0;
        result$iv = selectionEnd$ui_text_release + lengthAfterCursor;
        if (i6 &= i8 < 0) {
            int i7 = 0;
            result$iv = $i$a$AddExactOrElseDeleteSurroundingTextCommand$applyTo$end$1;
        }
        ...
        buffer.delete$ui_text_release(Math.max(i11, result$iv2), buffer.getSelectionStart$ui_text_release());
    }
