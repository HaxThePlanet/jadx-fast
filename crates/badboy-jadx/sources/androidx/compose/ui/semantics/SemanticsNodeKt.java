...
public final class SemanticsNodeKt {
    public static final androidx.compose.ui.semantics.SemanticsNode SemanticsNode(LayoutNode layoutNode, boolean mergingEnabled) {
        ...
        int i11;
        Modifier.Node node6;
        this_$iv2 = layoutNode.getNodes$ui_release();
        int i13 = 0;
        ...
        if (i18 &= i16 != 0) {
            ...
            while (node$iv$iv$iv$iv2 != null) {
                ...
                while (this_$iv2 != null) {
                    ...
                    it$iv = 0;
                    i5 = 0;
                    node$iv$iv$iv$iv = (DelegatingNode)this_$iv2.getDelegate$ui_release();
                    while (node$iv$iv$iv$iv != null) {
                        ...
                        $i$f$headH91voCI$ui_release = stack$iv$iv$iv;
                        node$iv$iv$iv2 = node4;
                        $i$f$headH91voCI$ui_release2 = node$iv$iv$iv;
                        stack$iv$iv$iv2 = node5;
                        node$iv$iv$iv$iv = node$iv$iv$iv$iv.getChild$ui_release();
                        this_$iv2 = stack$iv$iv$iv2;
                        node$iv$iv$iv = $i$f$headH91voCI$ui_release2;
                        stack$iv$iv$iv = $i$f$headH91voCI$ui_release;
                        it$iv++;
                        node5 = this_$iv2;
                        if (it$iv == 1) {
                        ...
                        $i$f$headH91voCI$ui_release = stack$iv$iv$iv;
                        $i$f$headH91voCI$ui_release2 = node$iv$iv$iv;
                        stack$iv$iv$iv2 = node$iv$iv$iv2;
                        this_$iv$iv$iv$iv = 1;
                    }
                    node5 = this_$iv2;
                    if (it$iv == 1) {
            ...
            while (node$iv$iv$iv$iv2 != null) {
                ...
                while (this_$iv2 != null) {
                    ...
                    while (node$iv$iv$iv$iv != null) {
                        ...
                        $i$f$firstFromHeadALcG6gQ$ui_release = $i$f$firstFromHeadALcG6gQ$ui_release2;
                        next$iv$iv$iv = node2;
                        $i$f$firstFromHeadALcG6gQ$ui_release3 = node$iv$iv$iv;
                        stack$iv$iv$iv = node;
                        node$iv$iv$iv$iv = node$iv$iv$iv$iv.getChild$ui_release();
                        this_$iv2 = stack$iv$iv$iv;
                        node$iv$iv$iv = $i$f$firstFromHeadALcG6gQ$ui_release3;
                        $i$f$firstFromHeadALcG6gQ$ui_release2 = $i$f$firstFromHeadALcG6gQ$ui_release;
                        count$iv$iv$iv++;
                        node = this_$iv2;
                        if (count$iv$iv$iv == 1) {
                        ...
                        next$iv$iv$iv = node2;
                        $i$f$firstFromHeadALcG6gQ$ui_release3 = count$iv$iv$iv3;
                        count$iv$iv$iv = count$iv$iv$iv2;
                        count$iv$iv$iv3.add(node2);
                        if (count$iv$iv$iv3 != 0) {
                        }
                        stack$iv$iv$iv = 0;
