...
public final class LiveRegionMode {
    ...
    public static final androidx.compose.ui.semantics.LiveRegionMode.Companion Companion;
    ...
    public static final class Companion {
        ...
        public final int getAssertive-0phEisY() {
            return LiveRegionMode.access$getAssertive$cp();
        }
    ...
    static {
        LiveRegionMode.Companion companion = new LiveRegionMode.Companion(0);
        LiveRegionMode.Companion = companion;
        LiveRegionMode.Polite = LiveRegionMode.constructor-impl(0);
        LiveRegionMode.Assertive = LiveRegionMode.constructor-impl(1);
    }

    private LiveRegionMode(int value) {
        super();
        this.value = value;
    }
    ...
    public static final androidx.compose.ui.semantics.LiveRegionMode box-impl(int i) {
    ...
    public static boolean equals-impl(int i, Object object2) {
        final int i3 = 0;
        if (!object2 instanceof LiveRegionMode) {
            return i3;
        }
        if (i != (LiveRegionMode)object2.unbox-impl()) {
            return i3;
        }
        return 1;
    }
    ...
    public static String toString-impl(int arg0) {
        String str;
        str = LiveRegionMode.equals-impl0(arg0, LiveRegionMode.Polite) ? "Polite" : equals-impl02 ? "Assertive" : "Unknown";
        return str;
    }

    public boolean equals(Object object) {
        return LiveRegionMode.equals-impl(this.value, object);
    }

    public int hashCode() {
        return LiveRegionMode.hashCode-impl(this.value);
    }

    public String toString() {
        return LiveRegionMode.toString-impl(this.value);
    }
