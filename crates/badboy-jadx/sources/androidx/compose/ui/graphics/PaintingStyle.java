...
public final class PaintingStyle {
    ...
    public static final androidx.compose.ui.graphics.PaintingStyle.Companion Companion;
    ...
    public static final class Companion {
        ...
        public final int getFill-TiuSbCo() {
            return PaintingStyle.access$getFill$cp();
        }

        public final int getStroke-TiuSbCo() {
            return PaintingStyle.access$getStroke$cp();
        }
    }
    static {
        PaintingStyle.Companion companion = new PaintingStyle.Companion(0);
        PaintingStyle.Companion = companion;
        PaintingStyle.Fill = PaintingStyle.constructor-impl(0);
        PaintingStyle.Stroke = PaintingStyle.constructor-impl(1);
    }

    private PaintingStyle(int value) {
        super();
        this.value = value;
    }
    ...
    public static final androidx.compose.ui.graphics.PaintingStyle box-impl(int i) {
    ...
    public static boolean equals-impl(int i, Object object2) {
        final int i3 = 0;
        if (!object2 instanceof PaintingStyle) {
            return i3;
        }
        if (i != (PaintingStyle)object2.unbox-impl()) {
            return i3;
        }
        return 1;
    }
    ...
    public static String toString-impl(int arg0) {
        String str;
        str = PaintingStyle.equals-impl0(arg0, PaintingStyle.Fill) ? "Fill" : equals-impl02 ? "Stroke" : "Unknown";
        return str;
    }

    public boolean equals(Object object) {
        return PaintingStyle.equals-impl(this.value, object);
    }

    public int hashCode() {
        return PaintingStyle.hashCode-impl(this.value);
    }

    public String toString() {
        return PaintingStyle.toString-impl(this.value);
    }
