...
public abstract class Painter {
    ...
    public final void draw-x_KDEd0(DrawScope $this$draw_u2dx_KDEd0, long size, float alpha, ColorFilter colorFilter) {
        ...
        final int i17 = 0;
        if (Float.compare(f, i2) > 0 && Float.compare(width-impl2, i2) > 0 && Float.compare(height-impl, i2) > 0) {
            if (Float.compare(width-impl2, i2) > 0) {
                if (Float.compare(height-impl, i2) > 0) {
                    if (obj.useLayer) {
                        ...
                        canvas.saveLayer(RectKt.Rect-tz77jQw(Offset.Companion.getZero-F1C5BW0(), obj14), obj.obtainPaint());
                        useLayer = 0;
