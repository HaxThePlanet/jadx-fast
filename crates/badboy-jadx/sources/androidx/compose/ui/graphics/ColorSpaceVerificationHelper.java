...
final class ColorSpaceVerificationHelper {
    ...
    public static final ColorSpace composeColorSpace(ColorSpace $this$composeColorSpace) {
        ...
        double minValue;
        double maxValue;
        TransferParameters transferParameters3;
        double d4;
        double d;
        double d5;
        double d2;
                                                                ...
                                                                if (id == ColorSpace.Named.PRO_PHOTO_RGB.ordinal()) {
                                                                    ...
                                                                    if (id == ColorSpace.Named.SMPTE_C.ordinal()) {
                                                                        ...
                                                                        if (obj instanceof ColorSpace.Rgb) {
                                                                            transferParameters2 = (ColorSpace.Rgb)obj.getTransferParameters();
                                                                            int i4 = 1;
                                                                            i2 = 0;
                                                                            if (whitePoint4.length == 3) {
                                                                                whitePoint = new WhitePoint((ColorSpace.Rgb)obj.getWhitePoint()[i2], (ColorSpace.Rgb)obj.getWhitePoint()[i4], (ColorSpace.Rgb)obj.getWhitePoint()[2]);
                                                                            } else {
                                                                                whitePoint = new WhitePoint((ColorSpace.Rgb)obj.getWhitePoint()[i2], (ColorSpace.Rgb)obj.getWhitePoint()[i4]);
                                                                            }
                                                                            if (transferParameters2 != null) {
                                                                                transferParameters = new TransferParameters(transferParameters2.g, obj12, transferParameters2.a, obj14, transferParameters2.b, obj16, transferParameters2.c, obj18, transferParameters2.d, obj20, transferParameters2.e, obj22, transferParameters2.f, obj24);
                                                                                transferParameters3 = transferParameters;
                                                                            } else {
                                                                                transferParameters3 = transferParameters;
                                                                            }
                                                                            ...
                                                                            i = 0;
                                                                            srgb = new Rgb((ColorSpace.Rgb)obj.getName(), (ColorSpace.Rgb)obj.getPrimaries(), whitePoint, (ColorSpace.Rgb)obj.getTransform(), externalSyntheticLambda2, externalSyntheticLambda3, obj.getMinValue(i), obj.getMaxValue(i), transferParameters3, (ColorSpace.Rgb)obj.getId());
                                                                        } else {
