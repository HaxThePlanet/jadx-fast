...
public final class ClipOp {
    ...
    public static final androidx.compose.ui.graphics.ClipOp.Companion Companion;
    ...
    public static final class Companion {
        ...
        public final int getDifference-rtfAjoo() {
            return ClipOp.access$getDifference$cp();
        }

        public final int getIntersect-rtfAjoo() {
            return ClipOp.access$getIntersect$cp();
        }
    }
    static {
        ClipOp.Companion companion = new ClipOp.Companion(0);
        ClipOp.Companion = companion;
        ClipOp.Difference = ClipOp.constructor-impl(0);
        ClipOp.Intersect = ClipOp.constructor-impl(1);
    }

    private ClipOp(int value) {
        super();
        this.value = value;
    }
    ...
    public static final androidx.compose.ui.graphics.ClipOp box-impl(int i) {
    ...
    public static boolean equals-impl(int i, Object object2) {
        final int i3 = 0;
        if (!object2 instanceof ClipOp) {
            return i3;
        }
        if (i != (ClipOp)object2.unbox-impl()) {
            return i3;
        }
        return 1;
    }
    ...
    public static String toString-impl(int arg0) {
        String str;
        str = ClipOp.equals-impl0(arg0, ClipOp.Difference) ? "Difference" : equals-impl02 ? "Intersect" : "Unknown";
        return str;
    }

    public boolean equals(Object object) {
        return ClipOp.equals-impl(this.value, object);
    }

    public int hashCode() {
        return ClipOp.hashCode-impl(this.value);
    }

    public String toString() {
        return ClipOp.toString-impl(this.value);
    }
