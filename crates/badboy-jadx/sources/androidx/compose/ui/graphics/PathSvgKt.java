    ...
    public static final String toSvg(androidx.compose.ui.graphics.Path $this$toSvg, boolean asDocument) {
        ...
        if (iterator.hasNext() && asDocument) {
            ...
            while (iterator.hasNext()) {
                evenOdd-Rg-k1Os = 0;
                i2 = 2;
                next$default = PathIterator.next$default(iterator, fArr, evenOdd-Rg-k1Os, i2, 0);
                i3 = 5;
                i = 4;
                i4 = 3;
                ...
                sb.append(stringBuilder4.append(fArr[i2]).append(append2).append(fArr[i4]).append(append2).toString());
                StringBuilder stringBuilder5 = new StringBuilder();
                sb.append(stringBuilder5.append(fArr[i]).append(append2).append(fArr[i3]).append(append2).toString());
                ...
                sb.append(stringBuilder3.append(fArr[i2]).append(append2).append(fArr[i4]).append(append2).append(fArr[i]).append(append2).append(fArr[i3]).toString());
                StringBuilder stringBuilder7 = new StringBuilder();
                sb.append(stringBuilder7.append(PathSvgKt.command(PathSegment.Type.Line, lastType)).append(fArr[i2]).append(append2).append(fArr[i4]).toString());
