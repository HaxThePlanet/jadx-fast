...
public final class VectorPath extends androidx.compose.ui.graphics.vector.VectorNode {
    ...
    public VectorPath(String string, List list2, int i3, Brush brush4, float f5, Brush brush6, float f7, float f8, int i9, int i10, float f11, float f12, float f13, float f14, int i15, DefaultConstructorMarker defaultConstructorMarker16) {
        ...
        int i26 = 0;
        i5 = i17 & 8 != 0 ? i26 : brush4;
        int i28 = 1065353216;
        i6 = i17 & 16 != 0 ? i28 : f5;
        i7 = i17 & 32 != 0 ? i26 : brush6;
        i14 = i17 & 64 != 0 ? i28 : f7;
        int i27 = 0;
        i8 = i17 & 128 != 0 ? i27 : f8;
        if (i17 & 256 != 0) {
            i = defaultStrokeLineCap;
        } else {
            i = i9;
        }
        if (i17 & 512 != 0) {
            i11 = defaultStrokeLineJoin;
        } else {
            i11 = i10;
        }
        i12 = i17 & 1024 != 0 ? i16 : f11;
        i4 = i17 & 2048 != 0 ? i27 : f12;
        i13 = i17 & 4096 != 0 ? i28 : f13;
        i2 = i17 &= 8192 != 0 ? i27 : f14;
        super(str, list2, i3, i5, i6, i7, i14, i8, i, i11, i12, i4, i13, i2, 0);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (other != null) {
            if (getClass() != other.getClass()) {
                ...
                i7 = Float.compare(fillAlpha, fillAlpha2) == 0 ? i8 : i9;
                if (i7 == 0) {
                    return i9;
                }
                ...
                i6 = Float.compare(strokeAlpha, strokeAlpha2) == 0 ? i8 : i9;
                if (i6 == 0) {
                    return i9;
                }
                i5 = Float.compare(strokeLineWidth, strokeLineWidth2) == 0 ? i8 : i9;
                if (i5 == 0) {
                    return i9;
                }
                ...
                i3 = Float.compare(strokeLineMiter, strokeLineMiter2) == 0 ? i8 : i9;
                if (i3 == 0) {
                    return i9;
                }
                i4 = Float.compare(trimPathStart, trimPathStart2) == 0 ? i8 : i9;
                if (i4 == 0) {
                    return i9;
                }
                i = Float.compare(trimPathEnd, trimPathEnd2) == 0 ? i8 : i9;
                if (i == 0) {
                    return i9;
                }
                i2 = Float.compare(trimPathOffset, trimPathOffset2) == 0 ? i8 : i9;
                if (i2 == 0) {
                    return i9;
                }
