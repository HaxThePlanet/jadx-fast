...
public final class BezierKt {
    ...
    private static final float evaluateX(androidx.compose.ui.graphics.PathSegment segment, float t) {
        ...
        switch (i2) {
            ...
            case 4:
                break;
            case 5:
                evaluateQuadratic = BezierKt.evaluateCubic(points2[i5], points2[i3], points2[i], points2[6], t);
                break;
            case 6:
                break;
            case 7:
    ...
    public static final float evaluateY(androidx.compose.ui.graphics.PathSegment segment, float t) {
        ...
        switch (i3) {
            ...
            case 4:
                break;
            case 5:
                evaluateQuadratic = BezierKt.evaluateCubic(points2[i5], points2[i2], points2[i], points2[7], t);
                break;
            case 6:
                break;
            case 7:
    ...
    private static final int findDerivativeRoots(androidx.compose.ui.graphics.PathSegment segment, boolean horizontal, float[] roots, int index) {
        ...
        switch (i6) {
            ...
            case 3:
                ...
                i14 *= f;
                i4 = 0;
                d0 = BezierKt.access$writeValidRootInUnitRange(i24 /= i8, roots, index);
                break;
            case 4:
                break;
            case 5:
                ...
                i22 *= i17;
                i27 *= i17;
                int quadraticRoots = BezierKt.findQuadraticRoots(i6, i4, i2, roots, index);
                int i30 = 1073741824;
                i29 *= i30;
                i = 0;
    ...
    public static final float findFirstCubicRoot(float p0, float p1, float p2, float p3) {
        ...
        i = 1;
        final int i91 = 0;
        b$iv = Double.compare(d13, l7) < 0 ? i : i91;
        i2 = 1065353216;
        int i87 = 0;
        final int i88 = 2143289344;
        if (b$iv != 0) {
            int i35 = 0;
            $i$f$closeTo = Double.compare(d17, l7) < 0 ? i : i91;
            if ($i$f$closeTo != 0) {
                int i41 = 0;
                ...
                if (Float.compare(f8, i87) < 0) {
                    i2 = Float.compare(f8, i94) >= 0 ? i87 : i88;
                } else {
                    if (Float.compare(f8, i2) > 0) {
                        if (Float.compare(f8, cmp5) <= 0) {
                        } else {
                            i2 = i88;
                        }
                    } else {
            ...
            if (Float.compare(f6, i87) < 0) {
                i5 = Float.compare(f6, i93) >= 0 ? i87 : i88;
            } else {
                if (Float.compare(f6, i2) > 0) {
                    i5 = Float.compare(f6, i96) <= 0 ? i2 : i88;
                } else {
                    i5 = f6;
                }
            }
            ...
            if (Float.compare(f7, i87) < 0) {
                i2 = Float.compare(f7, i93) >= 0 ? i87 : i88;
            } else {
                if (Float.compare(f7, i2) > 0) {
        ...
        if (Double.compare(i83, i106) < 0 && Double.compare($this$fastCoerceAtMost$iv$iv, l6) < 0) {
            ...
            if (Float.compare(f, i87) < 0) {
                i4 = Float.compare(f, i92) >= 0 ? i87 : i88;
            } else {
                if (Float.compare(f, i2) > 0) {
                    i4 = Float.compare(f, i95) <= 0 ? i2 : i88;
                } else {
                    i4 = f;
                }
            }
            ...
            if (Float.compare(f2, i87) < 0) {
                i3 = Float.compare(f2, i92) >= 0 ? i87 : i88;
            } else {
                if (Float.compare(f2, i2) > 0) {
                    i3 = Float.compare(f2, i95) <= 0 ? i2 : i88;
                } else {
                    i3 = f2;
                }
            }
            ...
            if (Float.compare(f3, i87) < 0) {
                i2 = Float.compare(f3, i92) >= 0 ? i87 : i88;
            } else {
        ...
        if (i != 0) {
            ...
            if (Float.compare(i52, i87) < 0) {
                ...
                if (Float.compare(i52, i2) > 0) {
                    i6 = Float.compare(i52, i95) <= 0 ? i2 : i88;
                } else {
                    i6 = i52;
                }
            }
            ...
            if (Float.compare(i30, i87) < 0) {
                i2 = Float.compare(i30, i92) >= 0 ? i87 : i88;
            } else {
                if (Float.compare(i30, i2) > 0) {
        ...
        if (Float.compare(f12, i87) < 0) {
            i2 = Float.compare(f12, i92) >= 0 ? i87 : i88;
        } else {
            if (Float.compare(f12, i2) > 0) {
    ...
    private static final float findFirstQuadraticRoot(float p0, float p1, float p2) {
        ...
        if (i == 0) {
            ...
            if (Float.compare(f2, i32) < 0) {
                i4 = Float.compare(f2, i31) >= 0 ? i32 : i33;
            } else {
                if (Float.compare(f2, i2) > 0) {
                    i4 = Float.compare(f2, i30) <= 0 ? i2 : i33;
                } else {
                    i4 = f2;
                }
            }
    ...
    private static final int findQuadraticRoots(float p0, float p1, float p2, float[] roots, int index) {
        ...
        rootCount = 0;
        l = l2;
        i4 = Double.compare(i19, i20) == 0 ? 1 : i3;
        if (i4 == 0) {
            l2 = -sqrt;
            i14 += d;
            a = d2;
