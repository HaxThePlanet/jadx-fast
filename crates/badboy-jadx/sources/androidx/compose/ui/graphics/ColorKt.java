...
public final class ColorKt {
    ...
    public static final long Color(float red, float green, float blue, float alpha, ColorSpace colorSpace) {
        ...
        int $this$fastCoerceAtMost$iv$iv6;
        int $this$fastCoerceAtMost$iv$iv3;
        int e$iv3;
        float $this$fastCoerceAtMost$iv$iv5;
        int i8;
        ...
        int i78 = 0;
        int i106 = 0;
        if (obj.isSrgb() && Float.compare($this$fastCoerceAtMost$iv$iv7, i15) < 0) {
            i15 = 0;
            i51 = 1065353216;
            i78 = 0;
            i106 = 0;
            if (Float.compare($this$fastCoerceAtMost$iv$iv7, i15) < 0) {
                $this$fastCoerceAtMost$iv$iv7 = i15;
            }
            int i107 = 0;
            if (Float.compare($this$fastCoerceAtMost$iv$iv7, i51) > 0) {
                $this$fastCoerceAtMost$iv$iv7 = i51;
            }
            ...
            int i92 = 0;
            int i119 = 0;
            if (Float.compare($this$fastCoerceAtMost$iv$iv6, i54) < 0) {
                $this$fastCoerceAtMost$iv$iv6 = i54;
            }
            int i120 = 0;
            if (Float.compare($this$fastCoerceAtMost$iv$iv6, i64) > 0) {
                $this$fastCoerceAtMost$iv$iv6 = i64;
            }
            int i57 = 0;
            int i65 = 1065353216;
            int i93 = 0;
            int i121 = 0;
            if (Float.compare($this$fastCoerceAtMost$iv$iv3, i57) < 0) {
                $this$fastCoerceAtMost$iv$iv3 = i57;
            }
            int i122 = 0;
            if (Float.compare($this$fastCoerceAtMost$iv$iv3, i65) > 0) {
                $this$fastCoerceAtMost$iv$iv3 = i65;
            }
        ...
        int i58 = 0;
        i = 1;
        i14 = obj.getComponentCount() == 3 ? i : i58;
        int i48 = 0;
        if (i14 == 0) {
            int i88 = 0;
        ...
        i3 = id$ui_graphics_release != -1 ? i : i58;
        int i82 = 0;
        if (i3 == 0) {
            int i105 = 0;
        ...
        int i95 = 0;
        int i123 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv5, minValue) < 0) {
            $this$fastCoerceAtMost$iv$iv5 = minValue;
        }
        int i124 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv5, maxValue2) > 0) {
            $this$fastCoerceAtMost$iv$iv5 = maxValue2;
        }
        int i36 = 0;
        int floatToRawIntBits = Float.floatToRawIntBits($this$fastCoerceAtMost$iv$iv5);
        ...
        int i84 = 0;
        int i115 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv, minValue3) < 0) {
            $this$fastCoerceAtMost$iv$iv = minValue3;
        }
        int i116 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv, maxValue) > 0) {
            $this$fastCoerceAtMost$iv$iv = maxValue;
        }
        int i38 = 0;
        int floatToRawIntBits2 = Float.floatToRawIntBits($this$fastCoerceAtMost$iv$iv);
        ...
        int i67 = 0;
        int i97 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv4, i19) < 0) {
            $this$fastCoerceAtMost$iv$iv4 = i19;
        }
        int i98 = 0;
        if (Float.compare($this$fastCoerceAtMost$iv$iv4, i39) > 0) {
            $this$fastCoerceAtMost$iv$iv4 = i39;
        }
        int i68 = 65535;
    ...
    public static final long compositeOver--OWjLjI(long $this$compositeOver_u2d_u2dOWjLjI, long background) {
        ...
        i4 = 1;
        final int i22 = 0;
        i = Float.compare(i13, i8) == 0 ? i4 : i22;
        if (i != 0) {
            i9 = i8;
        } else {
            i20 /= i13;
        ...
        int i15 = 0;
        i6 = Float.compare(i13, i8) == 0 ? i4 : i22;
        if (i6 != 0) {
            i5 = i8;
        } else {
            i24 /= i13;
        ...
        return ColorKt.UncheckedColor(i9, i5, i8, i13, Color.getColorSpace-impl(obj20));
    }
