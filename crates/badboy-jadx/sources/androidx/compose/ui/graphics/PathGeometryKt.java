...
public final class PathGeometryKt {
    ...
    public static final List<androidx.compose.ui.graphics.Path> divide(androidx.compose.ui.graphics.Path $this$divide, List<androidx.compose.ui.graphics.Path> contours) {
        ...
        while (type != PathSegment.Type.Done) {
            ...
            type = PathIterator.next$default(iterator, fArr, i10, i11, i12);
            path2.close();
            path2.cubicTo(fArr[i11], fArr[i2], fArr[i], fArr[i4], fArr[6], fArr[7]);
            isEmpty = path;
            path2.quadraticTo(fArr[i11], fArr[i2], fArr[i], fArr[i4]);
            isEmpty = path;
    ...
    public static final androidx.compose.ui.graphics.Path reverse(androidx.compose.ui.graphics.Path $this$reverse, androidx.compose.ui.graphics.Path destination) {
        ...
        points3 = 0;
        final int size2 = iterator.calculateSize(points3);
        ...
        while (type != PathSegment.Type.Done) {
            ...
            type = PathIterator.next$default(iterator, fArr, points3, i27, i10);
        ...
        while (-1 < insertClose) {
            ...
            dataIndex = dataIndex2;
            i7 = i24;
            obj3.cubicTo(obj[4], obj[5], obj[i27], obj[i11], obj[i5], obj[i28]);
            insertMove = i6;
            dataIndex = dataIndex2;
            i7 = insertClose;
            i7 = insertClose;
            obj3.quadraticTo(obj[i27], obj[i11], obj[i5], obj[i28]);
            insertMove = i6;
            dataIndex = dataIndex2;
            i7 = insertClose;
            obj3.lineTo(obj[i5], obj[i28]);
            insertMove = i6;
            dataIndex = dataIndex2;
            i7 = insertClose;
            if (insertClose2 != 0) {
            ...
            dataIndex--;
            points = obj5;
            i2 = ArraysKt.getLastIndex((float[])points);
            i5 = points3;
            obj3.moveTo(points[i2 + -1], points[i2]);
            obj = points;
            i6 = insertMove;
            dataIndex2 = dataIndex;
        }
