...
final class KeyInputElement extends ModifierNodeElement<androidx.compose.ui.input.key.KeyInputNode> {
    ...
    public KeyInputElement(Function1<? super androidx.compose.ui.input.key.KeyEvent, Boolean> onKeyEvent, Function1<? super androidx.compose.ui.input.key.KeyEvent, Boolean> onPreKeyEvent) {
        super();
        this.onKeyEvent = onKeyEvent;
        this.onPreKeyEvent = onPreKeyEvent;
    }

    public static androidx.compose.ui.input.key.KeyInputElement copy$default(androidx.compose.ui.input.key.KeyInputElement keyInputElement, Function1 function12, Function1 function13, int i4, Object object5) {
        Function1 obj1;
        Function1 obj2;
        if (i4 & 1 != 0) {
            obj1 = keyInputElement.onKeyEvent;
        }
        if (i4 &= 2 != 0) {
            obj2 = keyInputElement.onPreKeyEvent;
        }
        return keyInputElement.copy(obj1, obj2);
    }
    ...
    public final androidx.compose.ui.input.key.KeyInputElement copy(Function1<? super androidx.compose.ui.input.key.KeyEvent, Boolean> function1, Function1<? super androidx.compose.ui.input.key.KeyEvent, Boolean> function12) {
        KeyInputElement keyInputElement = new KeyInputElement(function1, function12);
    ...
    public androidx.compose.ui.input.key.KeyInputNode create() {
        KeyInputNode keyInputNode = new KeyInputNode(this.onKeyEvent, this.onPreKeyEvent);
        return keyInputNode;
    }
    ...
    public boolean equals(Object object) {
        ...
        final int i2 = 0;
        if (!object instanceof KeyInputElement) {
            return i2;
        }
        Object obj = object;
    ...
    public int hashCode() {
        ...
        if (this.onKeyEvent == null) {
            ...
            i2 = this.onKeyEvent.hashCode();
        }
        if (this.onPreKeyEvent == null) {
        } else {
            i = this.onPreKeyEvent.hashCode();
        }
        return i3 += i;
    }
    ...
    public String toString() {
        ...
        return stringBuilder.append("KeyInputElement(onKeyEvent=").append(this.onKeyEvent).append(", onPreKeyEvent=").append(this.onPreKeyEvent).append(')').toString();
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public void update(Modifier.Node node) {
        update((KeyInputNode)node);
    }
