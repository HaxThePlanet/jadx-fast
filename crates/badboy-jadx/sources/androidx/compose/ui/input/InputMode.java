...
public final class InputMode {
    ...
    public static final androidx.compose.ui.input.InputMode.Companion Companion;
    ...
    public static final class Companion {
        ...
        public final int getKeyboard-aOaMEAU() {
            return InputMode.access$getKeyboard$cp();
        }

        public final int getTouch-aOaMEAU() {
            return InputMode.access$getTouch$cp();
        }
    }
    static {
        InputMode.Companion companion = new InputMode.Companion(0);
        InputMode.Companion = companion;
        InputMode.Touch = InputMode.constructor-impl(1);
        InputMode.Keyboard = InputMode.constructor-impl(2);
    }
    ...
    public static final androidx.compose.ui.input.InputMode box-impl(int i) {
    ...
    public static boolean equals-impl(int i, Object object2) {
        final int i3 = 0;
        if (!object2 instanceof InputMode) {
            return i3;
        }
        if (i != (InputMode)object2.unbox-impl()) {
            return i3;
        }
        return 1;
    }
    ...
    public static String toString-impl(int arg0) {
        String str;
        str = InputMode.equals-impl0(arg0, InputMode.Touch) ? "Touch" : equals-impl02 ? "Keyboard" : "Error";
        return str;
    }

    public boolean equals(Object object) {
        return InputMode.equals-impl(this.value, object);
    }

    public int hashCode() {
        return InputMode.hashCode-impl(this.value);
    }

    public String toString() {
        return InputMode.toString-impl(this.value);
    }
