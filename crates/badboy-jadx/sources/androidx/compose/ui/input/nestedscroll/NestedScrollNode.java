...
public final class NestedScrollNode extends Modifier.Node implements TraversableNode, androidx.compose.ui.input.nestedscroll.NestedScrollConnection {
    ...
    public Object onPostFling-RZ2iAVY(long l, long l2, Continuation<? super Velocity> continuation3) {
        ...
        if (obj14 instanceof NestedScrollNode.onPostFling.1 && label &= i3 != 0) {
            anon = obj14;
            i3 = Integer.MIN_VALUE;
            if (label &= i3 != 0) {
                anon.label = obj14 -= i3;
        ...
        switch (_this) {
            ...
            case 2:
                ...
                return Velocity.box-impl(Velocity.plus-AH228Gc(unbox-impl, i));
            default:
    ...
    public Object onPreFling-QWom1Mo(long l, Continuation<? super Velocity> continuation2) {
        ...
        anon = obj12;
        i = Integer.MIN_VALUE;
        if (obj12 instanceof NestedScrollNode.onPreFling.1 && label2 &= i != 0) {
            anon = obj12;
            i = Integer.MIN_VALUE;
            if (label2 &= i != 0) {
                anon.label = obj12 -= i;
