        ...
        if (obj4 == null) {
            ...
            if (Intrinsics.areEqual(obj4, obj3.getMotionEvent$ui_release())) {
                ...
                while (index$iv < changes.size()) {
                    ...
                    i6 = i9;
                    pointerInputEventData = new PointerInputEventData(obj2.getId-J3iCeTQ(), obj15, obj2.getUptimeMillis(), obj17, obj2.getPosition-F1C5BW0(), obj19, obj2.getPosition-F1C5BW0(), obj21, obj2.getPressed(), obj2.getPressure(), obj2.getType-T8wyACA(), i, 0, 0, obj28, 0, obj30, 1792, 0);
                ...
                $this$fastForEach$iv = list;
                i6 = i9;
                internalPointerEvent2 = new PointerInputEvent(obj4.getEventTime(), i9, (List)arrayList, obj4);
                internalPointerEvent = new InternalPointerEvent(longSparseArray, internalPointerEvent2);
                pointerEvent = new PointerEvent(list4, internalPointerEvent);
