...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, androidx.compose.ui.focus.FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    private final void initializeFocusState() {
        ...
        if (FocusTargetNode.initializeFocusState$isInitialized(this)) {
            ...
            Unit $i$a$WithNewTransaction$defaultFocusTargetNode$initializeFocusState$2 = Unit.INSTANCE;
            FocusTransactionManager.access$commitTransaction(requireTransactionManager);
        }
        int $this$iv = 0;
        IllegalStateException $i$a$CheckFocusTargetNode$initializeFocusState$1 = new IllegalStateException("Re-initializing focus target node.".toString());
        throw $i$a$CheckFocusTargetNode$initializeFocusState$1;
    }
    ...
    private static final boolean initializeFocusState$hasActiveChild(androidx.compose.ui.focus.FocusTargetNode this$0) {
        ...
        Modifier.Node $i$f$visitSubtreeIf6rFNWt0;
        int node;
        ...
        final int i15 = $i$f$getFocusTargetOLwlOKw;
        ...
        while (mutableVector.isNotEmpty()) {
            node = mutableVector.removeAt(size -= count$iv$iv);
            ...
            while (node$iv$iv3 != null) {
                ...
                while (node$iv$iv != null) {
                    ...
                    while (node$iv$iv$iv != null) {
                        ...
                        type$iv = $i$f$getFocusTargetOLwlOKw;
                        i = $i$f$visitSubtreeIf6rFNWt02;
                        $i$f$visitSubtreeIf6rFNWt0 = initializeFocusState$isInitialized;
                        ...
                        diveDeeper$iv$iv = node$iv$iv;
                        if (diveDeeper$iv$iv != null && $i$f$getFocusTargetOLwlOKw != 0) {
                        }
                        ...
                        $i$f$getFocusTargetOLwlOKw.add(initializeFocusState$isInitialized);
                        if ($i$f$getFocusTargetOLwlOKw != 0) {
                        }
                        node$iv$iv = $i$f$visitSubtreeIf6rFNWt02;
                        $i$f$getFocusTargetOLwlOKw.add(diveDeeper$iv$iv);
                        i9 = i12;
                        ...
                        node$iv$iv = initializeFocusState$isInitialized;
                        type$iv = $i$f$getFocusTargetOLwlOKw;
                        i = $i$f$visitSubtreeIf6rFNWt02;
                        $i$f$visitSubtreeIf6rFNWt0 = initializeFocusState$isInitialized;
                        this_$iv$iv$iv = 1;
    ...
    private static final boolean initializeFocusState$isInActiveSubTree(androidx.compose.ui.focus.FocusTargetNode this$0) {
        ...
        boolean $this$visitAncestors_u2dY_u2dYKmho_u24default$iv2;
        int tail$ui_release;
        int $i$f$getFocusTargetOLwlOKw;
            ...
            while (layout$iv$iv != null) {
                ...
                while (node$iv$iv2 != null) {
                    ...
                    while (node$iv$iv != null) {
                        ...
                        $this$visitAncestors_u2dY_u2dYKmho_u24default$iv2 = 0;
                        ...
                        while (node$iv$iv$iv != null) {
                            ...
                            $i$f$getFocusTargetOLwlOKw = type$iv2;
                            includeSelf$iv = i;
                            $this$visitAncestors_u2dY_u2dYKmho_u24default$iv2++;
                            type$iv2 = $i$f$getFocusTargetOLwlOKw;
                            if ($this$visitAncestors_u2dY_u2dYKmho_u24default$iv2 == 1) {
                            } else {
                            }
                            if (stack$iv$iv == 0) {
                            } else {
    ...
    public final androidx.compose.ui.focus.FocusProperties fetchFocusProperties$ui_release() {
        androidx.compose.ui.focus.FocusPropertiesImpl count$iv$iv;
        int count$iv$iv3;
        int tail$ui_release;
        DelegatableNode delegatableNode;
        int this_$iv$iv$iv;
        Modifier.Node this_$iv$iv$iv4;
        int $i$f$getFocusPropertiesOLwlOKw;
        Modifier.Node type$iv;
        int $i$f$getFocusTargetOLwlOKw;
        int untilType$iv;
        int untilType$iv2;
        ...
        if (!delegatableNode2.getNode().isAttached()) {
            ...
            while (layout$iv$iv != null) {
                ...
                count$iv$iv = properties2;
                delegatableNode = $this$visitSelfAndAncestors_u2d5BbP62I$iv;
                $i$f$getFocusPropertiesOLwlOKw = type$iv2;
                ...
                while (node$iv$iv3 != null) {
                    ...
                    i4 = 0;
                    i5 = 0;
                    if (kindSet$ui_release3 &= $i$f$getFocusPropertiesOLwlOKw != 0) {
                    } else {
                    }
                    this_$iv$iv = 0;
                    if (this_$iv$iv != 0) {
                    ...
                    while (node$iv$iv2 != null) {
                        properties2 = count$iv$iv;
                        if (node$iv$iv2 instanceof FocusPropertiesModifierNode) {
                        } else {
                        }
                        int i9 = 0;
                        if (kindSet$ui_release4 &= $i$f$getFocusPropertiesOLwlOKw != 0) {
                        } else {
                        }
                        count$iv$iv3 = 0;
                        ...
                        this_$iv$iv$iv = 1;
                        untilType$iv = 0;
                        node$iv$iv2 = DelegatableNodeKt.access$pop(i);
                        count$iv$iv = properties2;
                        delegatableNode = $this$visitSelfAndAncestors_u2d5BbP62I$iv;
                        $i$f$getFocusPropertiesOLwlOKw = type$iv2;
                        $i$f$getFocusTargetOLwlOKw = i7;
                        ...
                        while (node$iv$iv$iv != null) {
                            ...
                            i6 = 0;
                            count$iv$iv2 = 0;
                            if (kindSet$ui_release5 &= $i$f$getFocusPropertiesOLwlOKw != 0) {
                            } else {
                            }
                            this_$iv$iv$iv2 = 0;
                            ...
                            if (node4 != null && this_$iv$iv$iv4 != 0) {
                            }
                            ...
                            this_$iv$iv$iv4.add(node);
                            if (this_$iv$iv$iv4 != 0) {
                            }
                            node$iv$iv2 = $i$f$getFocusPropertiesOLwlOKw;
                            this_$iv$iv$iv4.add(node4);
                            count$iv$iv2 = count$iv$iv3;
                            i8 = 0;
                            i3 = i10;
                            type$iv2 = $i$f$getFocusPropertiesOLwlOKw;
                        ...
                        i2 = 0;
                        $this$visitSelfAndAncestors_u2d5BbP62I$iv = delegatableNode;
                        (FocusPropertiesModifierNode)node$iv$iv2.applyFocusProperties((FocusProperties)properties2);
                        type$iv2 = $i$f$getFocusPropertiesOLwlOKw;
                        i7 = $i$f$getFocusTargetOLwlOKw;
                        this_$iv$iv$iv = 1;
                        untilType$iv = 0;
            ...
            properties = count$iv$iv;
            $this$visitSelfAndAncestors_u2d5BbP62I$iv = delegatableNode;
            type$iv2 = $i$f$getFocusPropertiesOLwlOKw;
            i7 = $i$f$getFocusTargetOLwlOKw;
            return (FocusProperties)properties;
        }
        androidx.compose.ui.focus.FocusPropertiesImpl properties5 = count$iv$iv;
    ...
    public void onDetach() {
        ...
        int[] exit-dhqQ-8s;
        int i;
        Throwable $i$a$WithNewTransaction$defaultFocusTargetNode$onDetach$1;
        ...
        switch (requireTransactionManager) {
            ...
            case 2:
                ...
                $i$a$WithNewTransaction$defaultFocusTargetNode$onDetach$1 = Unit.INSTANCE;
                FocusTransactionManager.access$commitTransaction(requireTransactionManager);
                break;
            default:
        }
