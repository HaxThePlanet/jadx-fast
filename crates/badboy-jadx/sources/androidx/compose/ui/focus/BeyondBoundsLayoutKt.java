...
public final class BeyondBoundsLayoutKt {
    public static final <T> T searchBeyondBounds--OM-vw8(androidx.compose.ui.focus.FocusTargetNode $this$searchBeyondBounds_u2d_u2dOM_u2dvw8, int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        DelegatableNode count$iv$iv$iv2;
        int it$iv;
        int i;
        int $i$f$getFocusTargetOLwlOKw;
        int $i$f$nearestAncestor64DMado2;
        Modifier.Node $i$f$nearestAncestor64DMado;
        Function1 function1;
        ...
        count$iv$iv$iv2 = $this$searchBeyondBounds_u2d_u2dOM_u2dvw8;
        int i12 = 0;
        ...
        if (!delegatableNode2.getNode().isAttached()) {
            ...
            while (layout$iv$iv$iv != null) {
                ...
                $this$nearestAncestor_u2d64DMado$iv = count$iv$iv$iv2;
                type$iv = $i$f$getFocusTargetOLwlOKw;
                i7 = $i$f$nearestAncestor64DMado2;
                delegatableNode = beyondBoundsLayoutParent;
                node$iv$iv$iv = 0;
                ...
                count$iv$iv$iv2 = $this$nearestAncestor_u2d64DMado$iv;
                $i$f$getFocusTargetOLwlOKw = type$iv;
                $i$f$nearestAncestor64DMado2 = i7;
                beyondBoundsLayoutParent = delegatableNode;
                count$iv$iv$iv2 = layout$iv$iv$iv.getNodes$ui_release();
                if (count$iv$iv$iv2 != null) {
                } else {
                }
                node$iv$iv$iv3 = count$iv$iv$iv2.getTail$ui_release();
                while (node$iv$iv$iv2 != null) {
                    ...
                    while (node$iv$iv$iv3 != null) {
                        ...
                        if ($i$f$isKindH91voCI$ui_release != 0 && node$iv$iv$iv3 instanceof DelegatingNode) {
                        } else {
                        }
                        type$iv = $i$f$getFocusTargetOLwlOKw;
                        i7 = $i$f$nearestAncestor64DMado2;
                        delegatableNode = beyondBoundsLayoutParent;
                        node$iv$iv$iv3 = DelegatableNodeKt.access$pop(i5);
                        count$iv$iv$iv2 = $this$nearestAncestor_u2d64DMado$iv;
                        $i$f$getFocusTargetOLwlOKw = type$iv;
                        $i$f$nearestAncestor64DMado2 = i7;
                        beyondBoundsLayoutParent = delegatableNode;
                        ...
                        while (node$iv$iv$iv$iv != null) {
                            ...
                            i7 = $i$f$nearestAncestor64DMado2;
                            delegatableNode = beyondBoundsLayoutParent;
                            $i$f$nearestAncestor64DMado = node;
                            ...
                            Modifier.Node node4 = node$iv$iv$iv3;
                            ...
                            node$iv$iv$iv3 = $i$f$nearestAncestor64DMado2;
            ...
            if (i != 0 && Intrinsics.areEqual((FocusTargetNode)i.getBeyondBoundsLayoutParent(), $this$searchBeyondBounds_u2d_u2dOM_u2dvw8.getBeyondBoundsLayoutParent())) {
                $i$f$getFocusTargetOLwlOKw = 0;
                if (Intrinsics.areEqual(i.getBeyondBoundsLayoutParent(), $this$searchBeyondBounds_u2d_u2dOM_u2dvw8.getBeyondBoundsLayoutParent())) {
                    return node$iv$iv$iv;
                }
            }
            ...
            function1 = block;
            layout-o7g1Pn8 = node$iv$iv$iv;
        }
        DelegatableNode delegatableNode3 = count$iv$iv$iv2;
