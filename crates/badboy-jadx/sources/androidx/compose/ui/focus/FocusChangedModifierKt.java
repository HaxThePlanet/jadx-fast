...
public final class FocusChangedModifierKt {
    public static final Modifier onFocusChanged(Modifier $this$onFocusChanged, Function1<? super androidx.compose.ui.focus.FocusState, Unit> onFocusChanged) {
        FocusChangedElement focusChangedElement = new FocusChangedElement(onFocusChanged);
        return $this$onFocusChanged.then((Modifier)focusChangedElement);
    }
}
