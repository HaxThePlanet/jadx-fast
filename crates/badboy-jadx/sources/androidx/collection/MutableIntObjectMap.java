...
public final class MutableIntObjectMap<V>  extends androidx.collection.IntObjectMap<V> {
    ...
    public MutableIntObjectMap(int initialCapacity) {
        ...
        int i3 = 0;
        IllegalArgumentException $i$a$RequireMutableIntObjectMap$1 = new IllegalArgumentException("Capacity must be a positive value.".toString());
        throw $i$a$RequireMutableIntObjectMap$1;
    }
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i6 < obj._capacity) {
            ...
            i3 = _capacity;
            i2 = metadata;
            metadata2[i10] = i16 |= i7;
            obj.keys[firstAvailableSlot] = i4;
            obj.values[firstAvailableSlot] = obj.values[i6];
            $i$f$hash = 1;
        }
    }
    ...
    public final boolean remove(int key, V value) {
        ...
        if (i2 >= 0) {
            if (Intrinsics.areEqual(obj3.values[i2], value)) {
                obj3.removeValueAt(i2);
                return i11;
            }
        } else {
            obj = value;
