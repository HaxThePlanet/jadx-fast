...
public final class ArraySet<E>  implements Collection<E>, Set<E>, KMutableCollection, KMutableSet {
            ...
            if (i7 >= hashes$collection5.length) {
                if (i7 >= 8) {
                    ...
                    if (i7 >= hashes$collection) {
                        ...
                        array$collection3 = hashes$collection;
                    }
                }
                hashes$collection = set.getHashes$collection();
                array$collection2 = set.getArray$collection();
                ArraySetKt.allocArrays(set, array$collection3);
                if (i7 != set.get_size$collection()) {
                    ...
                    if (oarray$iv == 0) {
                        oarray$iv = array$collection2;
                        i = 0;
                        ArraysKt.copyInto$default(hashes$collection, set.getHashes$collection(), 0, i, hashes$collection.length, 6, 0);
                        ArraysKt.copyInto$default(oarray$iv, set.getArray$collection(), i, 0, oarray$iv.length, 6, 0);
                    } else {
                        oarray$iv = array$collection2;
                    }
                }
    ...
    public final void addAll(androidx.collection.ArraySet<? extends E> array) {
        ...
        if (obj.get_size$collection() == 0) {
            if (i8 > 0) {
                ...
                i4 = 0;
                i = 0;
                ArraysKt.copyInto$default(array.getHashes$collection(), obj.getHashes$collection(), i4, i, i8, i3, i2);
                ArraysKt.copyInto$default(array.getArray$collection(), obj.getArray$collection(), i4, i, i8, i3, i2);
                if (obj.get_size$collection() != 0) {
                } else {
    ...
    public final void ensureCapacity(int minimumCapacity) {
        ...
        if (hashes$collection2.length < minimumCapacity) {
            ...
            if (set.get_size$collection() > 0) {
                i2 = 0;
                ArraysKt.copyInto$default(set.getHashes$collection(), set.getHashes$collection(), 0, i2, set.get_size$collection(), 6, 0);
                ArraysKt.copyInto$default(array$collection2, set.getArray$collection(), i2, 0, set.get_size$collection(), 6, 0);
            } else {
                oarray$iv = array$collection2;
            }
        }
    ...
    public final E removeAt(int index) {
        ...
        if (i14 <= 1) {
            ...
            i7 = i14 + -1;
            i5 = 8;
            if (hashes$collection3.length > i5 && set.get_size$collection() < length /= 3) {
                if (set.get_size$collection() < length /= 3) {
                    if (set.get_size$collection() > i5) {
                        i5 = array$collection3 + array$collection;
                    } else {
                    }
                    int[] hashes$collection = set.getHashes$collection();
                    array$collection2 = set.getArray$collection();
                    ArraySetKt.allocArrays(set, i5);
                    if (index > 0) {
                        i4 = 6;
                        i6 = 0;
                        i5 = 0;
                        i = 0;
                        i3 = index;
                        ArraysKt.copyInto$default(hashes$collection, set.getHashes$collection(), i5, i, i3, i4, i6);
                        iArr = hashes$collection;
                        ArraysKt.copyInto$default(array$collection2, set.getArray$collection(), i5, i, i3, i4, i6);
                    } else {
                        i3 = index;
                        iArr = hashes$collection;
                        ohashes$iv = array$collection2;
                    }
                    if (i3 < i7) {
                        ArraysKt.copyInto(iArr, set.getHashes$collection(), i3, i3 + 1, i7 + 1);
                        ArraysKt.copyInto(ohashes$iv, set.getArray$collection(), i3, i3 + 1, i7 + 1);
                    }
                } else {
                    i3 = index;
                    if (i3 < i7) {
                        ArraysKt.copyInto(set.getHashes$collection(), set.getHashes$collection(), i3, i3 + 1, i7 + 1);
                        ArraysKt.copyInto(set.getArray$collection(), set.getArray$collection(), i3, i3 + 1, i7 + 1);
                    }
                    set.getArray$collection()[i7] = 0;
                }
            } else {
            }
            if (i14 != set.get_size$collection()) {
            } else {
                set.set_size$collection(i7);
            }
        }
        ConcurrentModificationException concurrentModificationException = new ConcurrentModificationException();
        throw concurrentModificationException;
    ...
    public String toString() {
        ...
        if (obj.isEmpty()) {
            ...
            sb.append('{');
            i$iv2 = 0;
            while (i$iv2 < obj.get_size$collection()) {
                if (i$iv2 > 0) {
                }
