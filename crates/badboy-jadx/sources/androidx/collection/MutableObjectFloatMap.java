...
public final class MutableObjectFloatMap<K>  extends androidx.collection.ObjectFloatMap<K> {
    ...
    public MutableObjectFloatMap(int initialCapacity) {
        ...
        int i3 = 0;
        IllegalArgumentException $i$a$RequireMutableObjectFloatMap$1 = new IllegalArgumentException("Capacity must be a positive value.".toString());
        throw $i$a$RequireMutableObjectFloatMap$1;
    }

    public MutableObjectFloatMap(int i, int i2, DefaultConstructorMarker defaultConstructorMarker3) {
        int obj1;
        obj1 = i2 &= 1 != 0 ? 6 : obj1;
        super(obj1);
    }
    ...
    private final void resizeStorage(int newCapacity) {
        ...
        while (i8 < obj3._capacity) {
            ...
            i6 = metadata;
            metadata2[i2] = i14 |= i4;
            obj3.keys[firstAvailableSlot] = obj;
            obj3.values[firstAvailableSlot] = obj3.values[i8];
    ...
    @Override // androidx.collection.ObjectFloatMap
    ...
    public final float put(K key, float value, float default) {
        int index;
        float previous;
        float[] values;
        index = findIndex(key);
