        ...
        if (other instanceof SimpleArrayMap != null && size() != (SimpleArrayMap)other.size()) {
            ...
            try {
                while (i3 < this.size) {
                    valueAt2 = keyAt(i3);
                    valueAt = valueAt(i3);
                    equal2 = (SimpleArrayMap)obj.get(valueAt2);
                    i3++;
                }
                valueAt2 = keyAt(i3);
                valueAt = valueAt(i3);
                equal2 = obj.get(valueAt2);
                if (valueAt == null) {
                } else {
                }
                if (equal2 == null) {
                ...
                return i4;
                if (!Intrinsics.areEqual(valueAt, equal2)) {
                } else {
                }
                return i4;
                i3++;
    ...
    public V removeAt(int index) {
        ...
        if (i2 == 0) {
            ...
            if (size2 <= i3) {
                ...
                if (hashes4.length > i4 && size2 < length2 /= 3) {
                    if (size2 < length2 /= 3) {
                        ...
                        if (size2 != this.size) {
                            ...
                            if (index > 0) {
                                ArraysKt.copyInto(hashes, this.hashes, array3, array3, index);
                                ArraysKt.copyInto(array2, this.array, array3, array3, index << 1);
                            }
                            if (index < i5) {
                                ArraysKt.copyInto(hashes, this.hashes, index, index + 1, i5 + 1);
                                ArraysKt.copyInto(array2, this.array, index << 1, i17 <<= i3, i << 1);
                            }
                            if (size2 != this.size) {
                            } else {
                                this.size = i5;
                ...
                if (index < i5) {
                    ArraysKt.copyInto(this.hashes, this.hashes, index, index + 1, i5 + 1);
                    ArraysKt.copyInto(this.array, this.array, index << 1, i13 <<= i3, i14 <<= i3);
                }
                i4 = 0;
                this.array[i5 << 1] = i4;
                this.array[i10 += i3] = i4;
            }
            ConcurrentModificationException concurrentModificationException = new ConcurrentModificationException();
            throw concurrentModificationException;
        }
