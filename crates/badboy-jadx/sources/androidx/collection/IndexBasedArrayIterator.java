...
public abstract class IndexBasedArrayIterator<T>  implements Iterator<T>, KMutableIterator {
    ...
    public void remove() {
        ...
        int i4 = 0;
        IllegalStateException $i$a$CheckIndexBasedArrayIterator$remove$1 = new IllegalStateException("Call next() before removing an element.".toString());
        throw $i$a$CheckIndexBasedArrayIterator$remove$1;
    }
