...
public final class Utf8Safe extends androidx.emoji2.text.flatbuffer.Utf8 {
    ...
    public static String decodeUtf8Array(byte[] bytes, int index, int size) {
        ...
        if (i5 |= i12 < 0) {
            ...
            while (offset2 < i13) {
                ...
                while (offset < i13) {
                    oneByte2 = bytes[offset];
                    if (!Utf8.DecodeUtil.isOneByte(oneByte2)) {
                        break loop_10;
                    } else {
                    }
                    offset++;
                    Utf8.DecodeUtil.handleOneByte(oneByte2, cArr, i4);
                    i4 = oneByte;
                }
                i = i4;
                offset2 = offset;
    ...
    public static String decodeUtf8Buffer(ByteBuffer buffer, int offset, int length) {
        ...
        if (i4 |= i8 < 0) {
            ...
            while (obj10 < i6) {
                ...
                obj10++;
                Utf8.DecodeUtil.handleOneByte(offset2, cArr, i3);
                i3 = oneByte;
            }
            i = i3;
            while (obj10 < i6) {
                ...
                obj10 = offset2 + 1;
                int i11 = obj10 + 1;
                Utf8.DecodeUtil.handleFourBytes(i3, buffer.get(offset2), buffer.get(obj10), buffer.get(i11), cArr, i);
                obj10 = i2;
                i = resultPos;
                obj10 = offset2 + 1;
                Utf8.DecodeUtil.handleThreeBytes(i3, buffer.get(offset2), buffer.get(obj10), cArr, i);
                obj10 = oneByte;
                i = oneByte2;
                obj10 = offset2 + 1;
                Utf8.DecodeUtil.handleTwoBytes(i3, buffer.get(offset2), cArr, i);
                i = oneByte;
                obj10 = i + 1;
                Utf8.DecodeUtil.handleOneByte(i3, cArr, i);
                while (offset2 < i6) {
    ...
    private static void encodeUtf8Buffer(java.lang.CharSequence in, ByteBuffer out) {
        ...
        while (inIx < length) {
            ...
            out.put(str, (byte)i4);
            outIx2 = str;
            arrayIndexOutOfBoundsException = outIx2 + 1;
            out.put(outIx2, (byte)i19);
            out.put(arrayIndexOutOfBoundsException, (byte)i6);
            outIx2 = arrayIndexOutOfBoundsException;
            out.put(outIx2, (byte)charAt);
        }
        out.position(outIx2);
    }
