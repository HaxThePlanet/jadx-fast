            ...
            if (inputConnection == null) {
                ...
                if (beforeLength >= 0) {
                    if (afterLength < 0) {
                        ...
                        length = -1;
                        if (inCodePoints && EmojiProcessor.CodepointIndexFinder.findIndexBackward(editable, selectionStart, Math.max(beforeLength, i)) != length && EmojiProcessor.CodepointIndexFinder.findIndexForward(editable, selectionEnd, Math.max(afterLength, i)) == length) {
                            length = -1;
                            if (EmojiProcessor.CodepointIndexFinder.findIndexBackward(editable, selectionStart, Math.max(beforeLength, i)) != length) {
                                if (EmojiProcessor.CodepointIndexFinder.findIndexForward(editable, selectionEnd, Math.max(afterLength, i)) == length) {
                                }
    ...
    java.lang.CharSequence process(java.lang.CharSequence charSequence, int start, int end, int maxEmojiCount, boolean replaceAll) {
        ...
        if (!z2) {
            if (charSequence instanceof Spannable) {
                ...
                spannable = unprecomputeTextOnModificationSpannable2;
            } else {
        ...
        unprecomputeTextOnModificationSpannable2 = spannable.getSpans(start, end, EmojiSpan.class);
        if (spannable != 0 && (EmojiSpan[])unprecomputeTextOnModificationSpannable2 != null && unprecomputeTextOnModificationSpannable2.length > 0) {
            unprecomputeTextOnModificationSpannable2 = spannable.getSpans(start, end, EmojiSpan.class);
            if ((EmojiSpan[])(EmojiSpan[])unprecomputeTextOnModificationSpannable2 != null) {
                if (unprecomputeTextOnModificationSpannable2.length > 0) {
                    try {
                        index = 0;
                        while (index < unprecomputeTextOnModificationSpannable2.length) {
                            obj = (EmojiSpan[])(EmojiSpan[])unprecomputeTextOnModificationSpannable2[index];
                            spanStart = spannable.getSpanStart(obj);
                            if (spanStart != obj12) {
                            }
                            obj11 = i6;
                            obj12 = i4;
                        ...
                        obj = unprecomputeTextOnModificationSpannable2[index];
                        spanStart = spannable.getSpanStart(obj);
                        if (spanStart != obj12) {
                        }
                        spannable.removeSpan(obj);
                        ...
                        charSequence2 = charSequence;
                        i3 = replaceAll;
                        if (maxEmojiCount != Integer.MAX_VALUE && spannable != 0) {
                        } else {
                        }
                        if (spannable != 0) {
                        } else {
                        ...
                        i = maxEmojiCount;
                        EmojiProcessor.EmojiProcessAddSpanCallback emojiProcessAddSpanCallback = new EmojiProcessor.EmojiProcessAddSpanCallback(spannable, this.mSpanFactory);
                        Object obj5 = charSequence;
                        obj10 = this.process(obj5, index2, i5, i, replaceAll, emojiProcessAddSpanCallback);
                        if (obj10 != null && z2) {
                        }
                        if (z2) {
                        }
