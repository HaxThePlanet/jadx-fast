...
public final class Uuid implements Serializable {
    ...
    public static final class Companion {
        ...
        public final kotlin.uuid.Uuid fromByteArray(byte[] byteArray) {
            ...
            int i2 = 0;
            IllegalArgumentException $i$a$RequireUuid$Companion$fromByteArray$1 = new IllegalArgumentException("Expected exactly 16 bytes".toString());
            throw $i$a$RequireUuid$Companion$fromByteArray$1;
        }
        ...
        public final kotlin.uuid.Uuid parse(String uuidString) {
            ...
            Object obj2 = this;
            int i5 = 0;
            IllegalArgumentException $i$a$RequireUuid$Companion$parse$1 = new IllegalArgumentException("Expected a 36-char string in the standard uuid format.".toString());
            throw $i$a$RequireUuid$Companion$parse$1;
        }
