...
class StringsKt__StringBuilderJVMKt extends kotlin.text.StringsKt__RegexExtensionsKt {
    ...
    private static final StringBuilder appendRange(StringBuilder $this$appendRange, java.lang.CharSequence value, int startIndex, int endIndex) {
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(...))
    public static final java.lang.Appendable appendln(java.lang.Appendable $this$appendln) {
        Intrinsics.checkNotNullParameter($this$appendln, "<this>");
        java.lang.Appendable append = $this$appendln.append((CharSequence)SystemProperties.LINE_SEPARATOR);
        Intrinsics.checkNotNullExpressionValue(append, "append(...)");
        return append;
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(...))
    private static final java.lang.Appendable appendln(java.lang.Appendable $this$appendln, char value) {
        Intrinsics.checkNotNullParameter($this$appendln, "<this>");
        java.lang.Appendable append = $this$appendln.append(value);
        Intrinsics.checkNotNullExpressionValue(append, "append(...)");
        return StringsKt.appendln(append);
    }

    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(...))
    private static final java.lang.Appendable appendln(java.lang.Appendable $this$appendln, java.lang.CharSequence value) {
        Intrinsics.checkNotNullParameter($this$appendln, "<this>");
        java.lang.Appendable append = $this$appendln.append(value);
        Intrinsics.checkNotNullExpressionValue(append, "append(...)");
        return StringsKt.appendln(append);
    ...
    @Deprecated(level = DeprecationLevel.WARNING, message = "Use appendLine instead. Note that the new method always appends the line feed character '\\n' regardless of the system line separator.", replaceWith = @ReplaceWith(...))
    private static final StringBuilder appendln(StringBuilder $this$appendln, java.lang.CharSequence value) {
        Intrinsics.checkNotNullParameter($this$appendln, "<this>");
        StringBuilder append = $this$appendln.append(value);
        Intrinsics.checkNotNullExpressionValue(append, "append(...)");
        return StringsKt.appendln(append);
    ...
    private static final StringBuilder deleteAt(StringBuilder $this$deleteAt, int index) {
        ...
        StringBuilder charAt = $this$deleteAt.deleteCharAt(index);
        Intrinsics.checkNotNullExpressionValue(charAt, "deleteCharAt(...)");
        return charAt;
    }
    ...
    private static final StringBuilder insertRange(StringBuilder $this$insertRange, int index, java.lang.CharSequence value, int startIndex, int endIndex) {
    ...
    static void toCharArray$default(StringBuilder $this$toCharArray_u24default, char[] destination, int destinationOffset, int startIndex, int endIndex, int i6, Object object7) {
        int obj2;
        int obj3;
        int obj4;
        if (i6 & 2 != 0) {
