...
class StringsKt__IndentKt extends kotlin.text.StringsKt__AppendableKt {
    ...
    public static final String replaceIndent(String $this$replaceIndent, String newIndent) {
        ...
        while (iterator.hasNext()) {
            next = iterator.next();
            i7 = 0;
            if (!StringsKt.isBlank((CharSequence)(String)next)) {
            }
    ...
    public static final String replaceIndentByMargin(String $this$replaceIndentByMargin, String newIndent, String marginPrefix) {
        ...
        if (StringsKt.isBlank((CharSequence)$i$a$LetCollectionsKt___CollectionsKt$mapIndexedNotNullTo$1$1$iv$iv$iv)) {
            ...
            while (iterator.hasNext()) {
                ...
                i4 = 0;
                i9 = destination$iv$iv$iv3;
                i = 0;
                obj = destination$iv$iv$iv3;
                line = charAt;
                int i12 = -1;
                while (line < (CharSequence)i9.length()) {
                    i7 = 0;
                    line++;
                    $i$a$LetCollectionsKt___CollectionsKt$mapIndexedNotNullTo$1$1$iv$iv$iv = marginPrefix;
                    i12 = -1;
                ...
                i10 = index$iv;
                index$iv = line;
                firstNonWhitespaceIndex = obj;
                if (StringsKt.startsWith$default(firstNonWhitespaceIndex, marginPrefix, index$iv, false, 4, 0)) {
                } else {
                }
                $i$a$LetCollectionsKt___CollectionsKt$mapIndexedNotNullTo$1$1$iv$iv$iv = i6;
                ...
                firstNonWhitespaceIndex = obj;
                i7 = 0;
                if (!CharsKt.isWhitespace(i9.charAt(line))) {
                } else {
                }
                line++;
                $i$a$LetCollectionsKt___CollectionsKt$mapIndexedNotNullTo$1$1$iv$iv$iv = marginPrefix;
