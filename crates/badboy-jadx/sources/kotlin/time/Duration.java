...
public final class Duration implements Comparable<kotlin.time.Duration> {
    ...
    private static final void appendFractional-impl(long arg0, StringBuilder $this$appendFractional, int whole, int fractional, int fractionalSize, String unit, boolean isoZeroes) {
        ...
        if (fractionalSize != 0) {
            ...
            if (obj19 == null && i3 < i11) {
                if (i3 < i11) {
                    Intrinsics.checkNotNullExpressionValue(whole.append((CharSequence)padStart, i8, i3), str);
                } else {
                    Intrinsics.checkNotNullExpressionValue(whole.append((CharSequence)padStart, i8, i13 *= i11), str);
                }
            } else {
            }
        } else {
    ...
    public static long constructor-impl(long rawValue) {
        ...
        if (DurationJvmKt.getDurationAssertionsEnabled() && Duration.isInNanos-impl(rawValue)) {
            ...
            if (Long.compare(l, value-impl5) <= 0 && Long.compare(value-impl5, l) < 0) {
                i3 = Long.compare(value-impl5, l) < 0 ? i : i2;
            } else {
            }
            if (i3 == 0) {
            } else {
    ...
    public static final long times-UwyO8pc(long arg0, int scale) {
        ...
        if (Duration.isInNanos-impl(arg0)) {
            l4 = 0;
            if (Long.compare(i10, coerceIn) <= 0 && Long.compare(coerceIn, l) < 0) {
                if (Long.compare(coerceIn, l) < 0) {
                    l4 = 1;
                }
            }
            if (l4 != 0) {
                ...
                if (Long.compare(l4, coerceIn) == 0) {
                    ...
                    l8 *= i;
                    l7 += i2;
                    if (Long.compare(i8, l4) == 0 && Long.compare(i9, i3) >= 0) {
                        if (Long.compare(i9, i3) >= 0) {
                            value = coerceIn;
        ...
        if (Long.compare(arg0, i11) == 0) {
            ...
            if (Long.compare(arg0, iNFINITE) == 0) {
                ...
                if (Long.compare(arg0, nEG_INFINITE) == 0) {
                    ...
                    nanoseconds = Duration.getNanosecondsComponent-impl(absoluteValue-UwyO8pc);
                    i8 = 0;
                    i2 = 0;
                    hasDays2 = Long.compare(days, i11) != 0 ? 1 : i2;
                    i = hoursComponent-impl != 0 ? 1 : i2;
                    i9 = i;
                    i6 = minutes2 != 0 ? 1 : i2;
                    i10 = i6;
                    if (secondsComponent-impl == 0) {
                    ...
                    if (i2 != 0) {
                        ...
                        if (secondsComponent-impl == 0 && hasDays3 == 0 && i9 == 0) {
                            if (hasDays3 == 0) {
                                if (i9 == 0) {
                                    if (i10 != 0) {
                                        components2 = i12;
                                        ...
                                        if (nanoseconds >= append) {
                                            ...
                                            nanoseconds2 = i18;
                                            minutes = days;
                                            Duration.appendFractional-impl(arg0, obj5, sb, nanoseconds / append, nanoseconds % append, 6, "ms");
                                            hours2 = secondsComponent-impl;
                                        } else {
                                            components2 = i12;
                                            hasSeconds2 = i2;
                                            minutes = days;
                    ...
                    if (negative-impl && hours > hasSeconds) {
                        if (hours > hasSeconds) {
                            sb.insert(hasSeconds, '(').append(')');
                        }
                    }
