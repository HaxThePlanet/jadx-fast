...
public final class DurationKt {
    ...
    private static final long durationOfMillisNormalized(long millis) {
        ...
        long obj8;
        i = 0;
        if (Long.compare(l5, millis) <= 0 && Long.compare(millis, l4) < 0) {
            if (Long.compare(millis, l4) < 0) {
                i = 1;
            }
        }
        if (i != 0) {
    ...
    private static final long parseDuration(String value, boolean strictIso) {
        ...
        if (whole == 0) {
            ...
            if (allowSpaces != 0 && StringsKt.startsWith$default((CharSequence)it, '-', i30, 2, 0)) {
                i16 = StringsKt.startsWith$default((CharSequence)it, '-', i30, i27, prevUnit) ? 1 : i30;
            } else {
            }
            ...
            if (whole <= index) {
                ...
                if (it.charAt(index) == 80) {
                    if (index++ == whole) {
                        ...
                        while (index < whole) {
                            length3 = value;
                            i3 = 0;
                            nonDigitSymbols = length3;
                            $i$f$substringWhile2 = 0;
                            i$iv$iv = i13;
                            i13 = component;
                            while (i$iv$iv < nonDigitSymbols.length()) {
                                Object obj2 = nonDigitSymbols;
                                index2 = length4;
                                length4 = obj2.charAt(i$iv$iv);
                                $this$skipWhile$iv$iv2 = 0;
                                ...
                                i19 = i3;
                                i12 = allowSpaces;
                                if (StringsKt.contains$default((CharSequence)index2, length4, false, 2, 0)) {
                                } else {
                                }
                                length5 = 0;
                                if (length4 < 58) {
                            ...
                            $i$f$substringWhile = 2;
                            index2 = length4;
                            Intrinsics.checkNotNull(length3, str11);
                            String substring = length3.substring(index, i$iv$iv);
                ...
                if (strictIso) {
                    ...
                    i$iv = 48;
                    it = value;
                    if (StringsKt.regionMatches(it, index, component, 0, Math.max(i17 - index, str.length()), true)) {
                        ...
                        prevUnit = 0;
                        unitName = 0;
                        allowSpaces = i11 == 0 ? 1 : 0;
                        if (i11 != 0 && it.charAt(index) == 40 && StringsKt.last((CharSequence)it) == 41) {
                            if (it.charAt(index) == 40) {
                                if (StringsKt.last((CharSequence)it) == 41) {
                                    ...
                                    if (index++ == i17 + -1) {
                                        ...
                                        while (index < length4) {
                                            ...
                                            infinityString = i19;
                                            i19 = afterFirst;
                                            while (infinityString < str13.length()) {
                                                char charAt6 = str13.charAt(infinityString);
                                                index2 = 0;
                                                if (48 <= charAt6) {
                                                } else {
                                                }
                                            ...
                                            $i$f$substringWhile2 = i5;
                                            Intrinsics.checkNotNull(str2, str11);
                                            String substring2 = str2.substring(index3, infinityString);
                                            ...
                                            int i33 = 0;
                                            i$iv$iv2 = index4;
                                            while (i$iv$iv2 < $this$skipWhile$iv$iv3.length()) {
                                                char charAt5 = $this$skipWhile$iv$iv3.charAt(i$iv$iv2);
                                                $i$f$substringWhile2 = 0;
                                            ...
                                            String substring3 = str4.substring(index4, i$iv$iv2);
                                            ...
                                            i$iv$iv2 = substring2.substring(0, indexOf$default2);
                                            Intrinsics.checkNotNullExpressionValue(i$iv$iv2, charAt);
                                            Intrinsics.checkNotNull(substring2, str11);
                                            ...
                                            unitName = i19;
                                            component = str;
                                            charAt5 = $this$skipWhile$iv$iv3.charAt(i$iv$iv2);
                                            $i$f$substringWhile2 = 0;
                                            if (97 <= charAt5 && charAt5 < 123) {
                                            } else {
                                            }
                                            ...
                                            it3 = 1;
                                            i = 1;
                                            charAt6 = str13.charAt(infinityString);
                                            index2 = 0;
                                            if (48 <= charAt6) {
                                            } else {
                                            }
