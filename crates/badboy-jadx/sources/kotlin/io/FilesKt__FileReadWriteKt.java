...
class FilesKt__FileReadWriteKt extends kotlin.io.FilesKt__FilePathComponentsKt {
    ...
    public static final void writeTextImpl(OutputStream $this$writeTextImpl, String text, Charset charset) {
        ...
        while (startIndex < text.length()) {
            i2 = Math.min(i5 - leftover, length3 -= startIndex);
            i4 = startIndex + i2;
            char[] array = allocate.array();
            Intrinsics.checkNotNullExpressionValue(array, "array(...)");
            text.getChars(startIndex, i4, array, leftover);
            allocate.limit(i2 + leftover);
            i3 = 0;
            if (i4 == text.length()) {
            } else {
            }
            i = i3;
            int i10 = 0;
            $this$writeTextImpl.write(byteBufferForEncoding.array(), i3, byteBufferForEncoding.position());
