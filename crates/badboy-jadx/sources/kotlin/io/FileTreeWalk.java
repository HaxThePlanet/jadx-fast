...
public final class FileTreeWalk implements Sequence<File> {
    ...
    private static abstract class DirectoryState extends kotlin.io.FileTreeWalk.WalkState {
        public DirectoryState(File rootDir) {
            ...
            int i = 0;
            AssertionError $i$a$AssertFileTreeWalk$DirectoryState$1 = new AssertionError("rootDir must be verified to be directory beforehand.");
            throw $i$a$AssertFileTreeWalk$DirectoryState$1;
        }
    }
