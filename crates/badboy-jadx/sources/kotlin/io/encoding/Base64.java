...
public class Base64 {
    ...
    private final int decodeImpl(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        if (byteStart == -2) {
            ...
            if (payload != 0) {
                ...
                IllegalArgumentException illegalArgumentException3 = new IllegalArgumentException(stringBuilder.append("Symbol '").append((char)i10).append(str3).append(string4).append(str2).append(skipIllegalSymbolsIfMime + -1).append(" is prohibited after the pad character").toString());
    ...
    public final int decodeSize$kotlin_stdlib(byte[] source, int startIndex, int endIndex) {
        ...
        if (symbols == 1) {
            ...
            if (this.isMimeScheme) {
                index = startIndex;
                while (index < endIndex) {
                    i2 = Base64Kt.access$getBase64DecodeMap$p()[b &= 255];
                    if (i2 < 0) {
                        break;
                    } else {
                    }
                ...
                i3 = 61;
                if (source[endIndex + -1] == i3 && source[endIndex + -2] == i3) {
                    if (source[endIndex + -2] == i3) {
                        symbols--;
                    }
                }
            }
    ...
    public final int encodeIntoByteArrayImpl$kotlin_stdlib(byte[] source, byte[] destination, int destinationOffset, int startIndex, int endIndex) {
        ...
        byte1 = startIndex;
        i7 = destinationOffset;
        i3 = obj2.isMimeScheme ? 19 : 0x7fffffff /* Unknown resource */;
        i8 = 1;
        while (byte1 + 2 < i11) {
            i2 = Math.min(i19 /= 3, i3);
            i = 0;
            while (i < i2) {
                int i24 = byte1 + 1;
                int i25 = i24 + 1;
            ...
            i = i7 + 1;
            obj4[i7] = Base64.mimeLineSeparatorSymbols[0];
            i7 = i + 1;
            obj4[i] = Base64.mimeLineSeparatorSymbols[i8];
            i24 = byte1 + 1;
            i25 = i24 + 1;
            i33 |= padOnEncode;
            i39 = i7 + 1;
        ...
        switch (byte2) {
            case 1:
                ...
                int i27 = i7 + 1;
                obj4[i7] = bArr[mimeLineSeparatorSymbols >>> 6];
                i7 = i27 + 1;
