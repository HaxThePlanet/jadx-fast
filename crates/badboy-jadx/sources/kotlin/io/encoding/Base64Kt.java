...
public final class Base64Kt {
    ...
    static {
        ...
        i4 = 0;
        i = 0;
        while (i < base64EncodeMap.length) {
            i5 = 0;
            iArr3[base64EncodeMap[i]] = i4;
            i++;
            i4 = i2;
        }
        ...
        i3 = 0;
        i6 = 0;
        while (i6 < base64UrlEncodeMap.length) {
            i5 = 0;
            iArr4[base64UrlEncodeMap[i6]] = i3;
            i6++;
            i3 = i2;
        }
    ...
    public static final boolean isInMimeAlphabet(int symbol) {
        ...
        if (symbol >= 0 && symbol < base64DecodeMap.length) {
            i3 = symbol < base64DecodeMap.length ? i2 : i4;
        } else {
        }
