...
class FilesKt__UtilsKt extends kotlin.io.FilesKt__FileTreeWalkKt {
    ...
    public static final File copyTo(File $this$copyTo, File target, boolean overwrite, int bufferSize) {
        ...
        if (!$this$copyTo.exists()) {
            ...
            i = 0;
            ByteStreamsKt.copyTo((InputStream)(FileInputStream)(Closeable)inputStream, (OutputStream)(FileOutputStream)(Closeable)outputStream2, bufferSize);
            output = 0;
            CloseableKt.closeFinally(outputStream2, output);
