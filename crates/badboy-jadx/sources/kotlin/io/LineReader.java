...
public final class LineReader {
    ...
    private final int decode(boolean endOfInput) {
        ...
        while (LineReader.decoder == null) {
            ...
            i = 0;
            LineReader.sb.append(LineReader.chars, i, position + -1);
            LineReader.charBuf.position(i);
    ...
    public final String readLine(InputStream inputStream, Charset charset) {
        ...
        synchronized (this) {
            try {
                ...
                if (LineReader.chars[nChars + -1] == i5) {
                } else {
                }
                LineReader.byteBuf.position(i3);
                nChars2 = nChars;
                compactBytes = i4;
                nChars2--;
                if (nChars2 > 0 && LineReader.chars[nChars2 + -1] == i5 && nChars2 > 0 && LineReader.chars[nChars2 + -1] == 13) {
                }
                if (LineReader.chars[nChars2 + -1] == i5) {
                }
                nChars2--;
                if (nChars2 > 0) {
                }
                ...
                String string2 = new String(LineReader.chars, i3, nChars2);
                return string2;
                LineReader.sb.append(LineReader.chars, i3, nChars2);
                String string = LineReader.sb.toString();
                Intrinsics.checkNotNullExpressionValue(string, "toString(...)");
                if (LineReader.sb.length() > i) {
                }
                trimStringBuilder();
                LineReader.sb.setLength(i3);
                return string;
                compactBytes = compactBytes();
                throw inputStream;
            }
