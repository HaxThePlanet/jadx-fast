...
class PreconditionsKt__PreconditionsKt extends kotlin.PreconditionsKt__AssertionsJVMKt {
    private static final void check(boolean value) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckPreconditionsKt__PreconditionsKt$check$2 = new IllegalStateException("Check failed.".toString());
        throw $i$a$CheckPreconditionsKt__PreconditionsKt$check$2;
    }
    ...
    private static final <T> T checkNotNull(T value) {
        ...
        int i = 0;
        IllegalStateException $i$a$CheckNotNullPreconditionsKt__PreconditionsKt$checkNotNull$2 = new IllegalStateException("Required value was null.".toString());
        throw $i$a$CheckNotNullPreconditionsKt__PreconditionsKt$checkNotNull$2;
    }
    ...
    private static final void require(boolean value) {
        ...
        int i = 0;
        IllegalArgumentException $i$a$RequirePreconditionsKt__PreconditionsKt$require$2 = new IllegalArgumentException("Failed requirement.".toString());
        throw $i$a$RequirePreconditionsKt__PreconditionsKt$require$2;
    }
    ...
    private static final <T> T requireNotNull(T value) {
        ...
        int i = 0;
        IllegalArgumentException $i$a$RequireNotNullPreconditionsKt__PreconditionsKt$requireNotNull$2 = new IllegalArgumentException("Required value was null.".toString());
        throw $i$a$RequireNotNullPreconditionsKt__PreconditionsKt$requireNotNull$2;
    }
