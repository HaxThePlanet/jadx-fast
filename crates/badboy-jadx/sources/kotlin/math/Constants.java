...
final class Constants {
    ...
    public static final double upper_taylor_n_bound = 1;
    static {
        Constants constants = new Constants();
        Constants.INSTANCE = constants;
        Constants.LN2 = Math.log(4611686018427387904L);
        Constants.epsilon = Math.ulp(4607182418800017408L);
        Constants.taylor_2_bound = Math.sqrt(Constants.epsilon);
        Constants.taylor_n_bound = Math.sqrt(Constants.taylor_2_bound);
        double d3 = (double)i;
        Constants.upper_taylor_2_bound = d3 / taylor_2_bound2;
        d3 /= taylor_n_bound;
    }
}
