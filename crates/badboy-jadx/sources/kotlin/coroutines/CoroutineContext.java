...
public interface CoroutineContext {
    ...
    public interface Element extends kotlin.coroutines.CoroutineContext {
        public abstract <R> R fold(R r, Function2<? super R, ? super kotlin.coroutines.CoroutineContext.Element, ? extends R> function22);
    ...
    @Metadata(d1 = "\u0000\u0010\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\u0008f\u0018\u0000*\u0008\u0008\u0000\u0010\u0001*\u00020\u00022\u00020\u0003¨\u0006\u0004", d2 = {"Lkotlin/coroutines/CoroutineContext$Key;", "E", "Lkotlin/coroutines/CoroutineContext$Element;", "", "kotlin-stdlib"}, k = 1, mv = {1, 9, 0}, xi = 48)
    public interface Key {
    }

    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        public static kotlin.coroutines.CoroutineContext plus(kotlin.coroutines.CoroutineContext $this, kotlin.coroutines.CoroutineContext context) {
            Object fold;
            Intrinsics.checkNotNullParameter(context, "context");
            if (context == EmptyCoroutineContext.INSTANCE) {
                fold = $this;
            } else {
                fold = context.fold($this, (Function2)CoroutineContext.plus.1.INSTANCE);
            }
            return fold;
        }
    }
    ...
    public abstract kotlin.coroutines.CoroutineContext plus(kotlin.coroutines.CoroutineContext coroutineContext);
}
