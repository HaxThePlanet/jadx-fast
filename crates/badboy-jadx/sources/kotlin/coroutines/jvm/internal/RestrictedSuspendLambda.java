...
public abstract class RestrictedSuspendLambda extends kotlin.coroutines.jvm.internal.RestrictedContinuationImpl implements FunctionBase<Object>, kotlin.coroutines.jvm.internal.SuspendFunction {
    ...
    public RestrictedSuspendLambda(int arity, Continuation<Object> completion) {
        super(completion);
        this.arity = arity;
    }

    @Override // kotlin.coroutines.jvm.internal.RestrictedContinuationImpl
    public int getArity() {
        return this.arity;
    }
