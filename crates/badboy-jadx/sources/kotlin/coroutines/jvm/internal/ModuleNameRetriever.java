...
final class ModuleNameRetriever {
    ...
    public final String getModuleName(kotlin.coroutines.jvm.internal.BaseContinuationImpl continuation) {
        ...
        if (getModuleMethod != null) {
            invoke2 = getModuleMethod.invoke(continuation.getClass(), new Object[i2]);
        } else {
            invoke2 = i;
        }
        if (invoke2 == 0) {
        ...
        if (getDescriptorMethod != null) {
            invoke3 = getDescriptorMethod.invoke(invoke2, new Object[i2]);
        } else {
            invoke3 = i;
        }
        if (invoke3 == 0) {
        ...
        if (nameMethod != null) {
            invoke = nameMethod.invoke(invoke3, new Object[i2]);
        } else {
            invoke = i;
        }
        if (invoke instanceof String != null) {
            i = invoke;
        }
        return i;
    }
