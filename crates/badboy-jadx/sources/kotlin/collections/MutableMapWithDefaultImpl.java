...
final class MutableMapWithDefaultImpl<K, V>  implements kotlin.collections.MutableMapWithDefault<K, V> {
    ...
    public V getOrImplicitDefault(K key) {
        Object value$iv;
        boolean $i$a$GetOrElseNullableMutableMapWithDefaultImpl$getOrImplicitDefault$1;
        Function1 default;
        ...
        if (map.get(key) == null && !map.containsKey(key)) {
            if (!map.containsKey(key)) {
                int i2 = 0;
                value$iv = $i$a$GetOrElseNullableMutableMapWithDefaultImpl$getOrImplicitDefault$1;
            } else {
            }
        } else {
        }
