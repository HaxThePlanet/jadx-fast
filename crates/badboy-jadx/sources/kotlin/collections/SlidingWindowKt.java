...
public final class SlidingWindowKt {
    public static final void checkWindowSizeStep(int size, int step) {
        ...
        if (i == 0) {
            ...
            IllegalArgumentException $i$a$RequireSlidingWindowKt$checkWindowSizeStep$1 = new IllegalArgumentException(string.toString());
            throw $i$a$RequireSlidingWindowKt$checkWindowSizeStep$1;
        }
    }
