...
public @interface Flow {
    ...
    public abstract String source() default "The method argument (if parameter was annotated) or this container (if instance method was annotated)";

    @Override // java.lang.annotation.Annotation
    public abstract boolean sourceIsContainer() default false;

    @Override // java.lang.annotation.Annotation
    public abstract String target() default "This container (if the parameter was annotated) or the return value (if instance method was annotated)";

    @Override // java.lang.annotation.Annotation
    public abstract boolean targetIsContainer() default false;
}
