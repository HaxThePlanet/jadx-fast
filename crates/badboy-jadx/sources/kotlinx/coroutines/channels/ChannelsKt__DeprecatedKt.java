...
final class ChannelsKt__DeprecatedKt {
    ...
    public static final Object count(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Continuation continuation2) {
        ...
        switch (label2) {
            case 0:
                ...
                obj13 = i8;
                $i$f$consume2 = i10;
                $this$consume$iv$iv2 = $this$consumeEach_u24lambda_u241$iv;
            ...
            case 1:
                ...
                iterator = l$0;
                count2 = l$1;
                $this$consume$iv$iv = i9;
                cause$iv$iv = l$2;
                i3 = i7;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv = i5;
                $i$f$consume = $continuation;
                anon2 = $result;
                $continuation2 = obj14;
                obj14 = cause$iv$iv.next();
                i = 0;
                iterator.element = element += i6;
                obj14 = $continuation2;
                $result = anon2;
                $continuation = $i$f$consume;
                count = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv;
                $i$f$consume2 = i3;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2 = cause$iv$iv;
                i4 = $this$consume$iv$iv;
                cause$iv$iv3 = count2;
                $this$consume$iv$iv2 = iterator;
                obj14 = Unit.INSTANCE;
                ChannelsKt.cancelConsumed(count2, $this$consume$iv$iv);
        ...
        if (next == $continuation) {
            ...
            count2 = cause$iv$iv3;
            $this$consume$iv$iv = i4;
            cause$iv$iv = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2;
            i3 = $i$f$consume2;
    ...
    public static final Object elementAt(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, int i2, Continuation continuation3) {
        ...
        switch (label2) {
            ...
            case 1:
                ...
                $result = anon;
                $continuation3 = count;
                $i$a$ConsumeChannelsKt__DeprecatedKt$elementAt$2 = i3;
                index = $this$consume$iv;
                obj2 = cause$iv;
                $this$consume$iv2 = iterator;
                $this$elementAt_u24lambda_u240 = i4;
                Object obj4 = cause$iv;
                int i9 = iterator;
                StringBuilder stringBuilder = new StringBuilder();
                obj14 = new IndexOutOfBoundsException(stringBuilder.append(str).append(i3).append(i5).toString());
                throw obj14;
            default:
        ...
        if (next == $continuation3) {
            ...
            i3 = $i$a$ConsumeChannelsKt__DeprecatedKt$elementAt$2;
    ...
    public static final Object filterNotNullTo(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Collection collection2, Continuation continuation3) {
        ...
        switch (label2) {
            ...
            case 1:
                ...
                cause$iv$iv = l$2;
                i = i4;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2 = $continuation3;
                anon2 = $result;
                $continuation = obj12;
                obj12 = cause$iv$iv.next();
                i3 = 0;
                iterator.add(obj12);
                obj12 = $continuation;
                $result = anon2;
                $continuation3 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2;
                $i$f$consumeEach2 = i;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv = cause$iv$iv;
                i2 = $this$consume$iv$iv2;
        ...
        $result.L$1 = cause$iv$iv3;
        $result.L$2 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv;
        $result.label = 1;
        Object next = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv.hasNext($result);
        if (next == $continuation3) {
            return $continuation3;
        } else {
            $continuation = obj12;
    ...
    public static final Object filterNotNullTo(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, kotlinx.coroutines.channels.SendChannel sendChannel2, Continuation continuation3) {
        ...
        int i2;
        Object l$1;
        kotlinx.coroutines.channels.ChannelIterator destination;
        Object l$0;
        int i;
        Object send;
        Throwable th;
        ...
        $result = continuation3;
        $i$f$consumeEach = Integer.MIN_VALUE;
        if (continuation3 instanceof ChannelsKt__DeprecatedKt.filterNotNullTo.3 && label &= $i$f$consumeEach != 0) {
            $result = continuation3;
            $i$f$consumeEach = Integer.MIN_VALUE;
            if (label &= $i$f$consumeEach != 0) {
                $result.label = obj13 -= $i$f$consumeEach;
            } else {
        ...
        switch (label2) {
            case 0:
                ...
                obj13 = obj11;
                obj11 = i4;
                $i$f$consumeEach2 = $continuation3;
                anon = $result;
                $continuation = th;
                break;
            case 1:
                ...
                anon.L$2 = l$2;
                anon.label = 2;
                return $i$f$consumeEach2;
                obj13 = $continuation;
                $result = anon;
                $continuation3 = $i$f$consumeEach2;
                i3 = destination2;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv = l$2;
                l$2 = i;
                obj13 = obj12;
                obj12 = l$0;
                destination = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv;
                destination2 = i3;
                $i$f$consumeEach2 = $continuation3;
                anon = $result;
                $continuation = th;
                ...
                destination = l$2;
                obj13 = Unit.INSTANCE;
                ChannelsKt.cancelConsumed(l$1, i2);
                return l$0;
            case 2:
                obj11 = 0;
                obj12 = 0;
    ...
    public static final Object indexOf(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Object object2, Continuation continuation3) {
        ...
        if (obj instanceof ChannelsKt__DeprecatedKt.indexOf.1 && label2 &= $i$f$consume2 != 0) {
            anon = obj;
            $i$f$consume2 = Integer.MIN_VALUE;
    ...
    public static final Object last(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Continuation continuation2) {
        ...
        switch (label2) {
            ...
            case 1:
                ...
                iterator = l$1;
                iterator2 = i6;
                $i$a$ConsumeChannelsKt__DeprecatedKt$last$23 = obj10;
                break;
            case 2:
                obj9 = 0;
                ResultKt.throwOnFailure(obj10);
                ...
                iterator4 = l$2;
                last = i4;
                $i$a$ConsumeChannelsKt__DeprecatedKt$last$22 = $continuation;
                anon = $result;
                $continuation2 = obj10;
                $result.L$0 = iterator3;
                $result.L$1 = iterator;
                $result.L$2 = $i$a$ConsumeChannelsKt__DeprecatedKt$last$2;
                $result.label = 2;
                Object next2 = iterator.hasNext($result);
                return $continuation;
                $continuation2 = obj10;
                obj10 = next2;
                i2 = $this$consume$iv2;
                ...
                iterator4 = $i$a$ConsumeChannelsKt__DeprecatedKt$last$2;
                last = i;
                $i$a$ConsumeChannelsKt__DeprecatedKt$last$22 = $continuation;
                anon = i3;
                ...
                obj10 = $continuation2;
                $result = anon;
                $continuation = $i$a$ConsumeChannelsKt__DeprecatedKt$last$22;
                i = last2;
                iterator = $this$consume$iv;
                iterator3 = cause$iv;
                $this$consume$iv2 = i2;
                ChannelsKt.cancelConsumed(cause$iv, i2);
                return iterator4;
            default:
                obj9 = new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                throw obj9;
        }
        if (!(Boolean)$i$a$ConsumeChannelsKt__DeprecatedKt$last$23.booleanValue()) {
        } else {
            $i$a$ConsumeChannelsKt__DeprecatedKt$last$2 = next;
            i = i3;
        }
    ...
    public static final Object lastIndexOf(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Object object2, Continuation continuation3) {
        ...
        switch (label3) {
            ...
            case 1:
                ...
                cause$iv$iv = l$4;
                i2 = i10;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv = i9;
                $i$f$consume = i7;
                $i$f$consumeEach3 = $result;
                i4 = 0;
                element.element = lastIndex2.element;
                lastIndex2.element = element3 += i8;
                $result = $i$f$consumeEach3;
                $result2 = $i$f$consume;
                $i$f$consumeEach4 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv;
                $i$f$consume3 = i2;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2 = cause$iv$iv;
                $i$f$consumeEach = $this$consume$iv$iv2;
                cause$iv$iv2 = index;
                $this$consume$iv$iv = lastIndex2;
                index2 = element;
                lastIndex = iterator;
                Unit iNSTANCE = Unit.INSTANCE;
                ChannelsKt.cancelConsumed(index, $this$consume$iv$iv2);
        ...
        anon.L$4 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2;
        anon.label = i8;
        Object next = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2.hasNext(anon);
        if (next == cOROUTINE_SUSPENDED) {
            ...
            iterator = lastIndex;
            element = index2;
            lastIndex2 = $this$consume$iv$iv;
            index = cause$iv$iv2;
            $this$consume$iv$iv2 = $i$f$consumeEach;
            cause$iv$iv = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2;
            i2 = $i$f$consume3;
            $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv = $i$f$consumeEach4;
            $i$f$consume = i3;
        }
    }
    ...
    public static final Object maxWith(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Comparator comparator2, Continuation continuation3) {
        ...
        switch (label2) {
            ...
            case 2:
                ...
                $continuation = obj12;
                obj12 = next3;
                iterator = $i$a$ConsumeChannelsKt__DeprecatedKt$maxWith$2;
                ...
                $i$a$ConsumeChannelsKt__DeprecatedKt$maxWith$2 = iterator;
                obj12 = $continuation;
                $result = anon;
                $continuation2 = max;
                next = cause$iv;
    ...
    public static final Object minWith(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Comparator comparator2, Continuation continuation3) {
        ...
        switch (label2) {
            case 0:
                ...
                comparator = receiveChannel;
                obj10 = i4;
                $i$a$ConsumeChannelsKt__DeprecatedKt$minWith$2 = obj;
                break;
            case 1:
                obj11 = 0;
                obj10 = 0;
            ...
            case 2:
                ...
                $continuation = obj12;
                obj12 = next3;
                iterator = $i$a$ConsumeChannelsKt__DeprecatedKt$minWith$2;
                comparator3 = comparator;
                $this$consume$iv = it;
                iterator3 = min;
                cause$iv = next;
                ...
                it = $this$consume$iv;
                comparator = comparator3;
                $i$a$ConsumeChannelsKt__DeprecatedKt$minWith$2 = iterator;
                obj12 = $continuation;
                $result = anon;
                $continuation3 = min2;
                next = cause$iv;
    ...
    public static final Object none(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Continuation continuation2) {
        ...
        if (continuation2 instanceof ChannelsKt__DeprecatedKt.none.1 && label &= i5 != 0) {
            anon = continuation2;
            i5 = Integer.MIN_VALUE;
            if (label &= i5 != 0) {
                anon.label = obj9 -= i5;
    ...
    public static final Object singleOrNull(kotlinx.coroutines.channels.ReceiveChannel receiveChannel, Continuation continuation2) {
        ...
        switch (label2) {
            ...
            case 2:
                ...
                next = obj11;
                single = i4;
                ChannelsKt.cancelConsumed(cause$iv, single);
                return i4;
                ChannelsKt.cancelConsumed(cause$iv, single);
                return $i$f$consume;
            default:
        ...
        cause$iv = $i$a$ConsumeChannelsKt__DeprecatedKt$singleOrNull$2;
    }
    ...
    public static final <E, C extends kotlinx.coroutines.channels.SendChannel<? super E>> Object toChannel(kotlinx.coroutines.channels.ReceiveChannel<? extends E> receiveChannel, C c2, Continuation<? super C> continuation3) {
        ...
        anon2.L$0 = obj12;
        anon2.L$1 = l$1;
        anon2.L$2 = destination;
        anon2.label = 1;
        Object next = destination.hasNext(anon2);
    ...
    public static final <K, V, M extends Map<? super K, ? super V>> Object toMap(kotlinx.coroutines.channels.ReceiveChannel<? extends Pair<? extends K, ? extends V>> receiveChannel, M m2, Continuation<? super M> continuation3) {
        ...
        switch (label2) {
            ...
            case 1:
                ...
                cause$iv$iv3 = l$2;
                i3 = i4;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2 = $continuation2;
                map = $result;
                $continuation3 = obj15;
                obj = obj15;
                i = 0;
                ...
                obj15 = $continuation3;
                $result = map;
                $continuation2 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2;
                $i$f$consumeEach = i3;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv = cause$iv$iv3;
        ...
        if (next == $continuation2) {
            ...
            cause$iv$iv3 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv;
            i3 = $i$f$consumeEach;
            $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2$iv2 = $continuation2;
            map = map2;
        }
