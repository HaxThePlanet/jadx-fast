...
final class ChannelsKt__Channels_commonKt {
    ...
    public static final <E> Object consumeEach(kotlinx.coroutines.channels.BroadcastChannel<E> broadcastChannel, Function1<? super E, Unit> function12, Continuation<? super Unit> continuation3) {
        ...
        switch (label2) {
            case 0:
                ...
                obj10 = i4;
                $i$f$consumeEach = i8;
                channel$iv = function12;
                obj11 = i7;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$42 = iterator;
                break;
            case 1:
                obj10 = 0;
                obj11 = 0;
                ...
                channel$iv2 = l$2;
                i = i3;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$4 = $continuation2;
                anon2 = $result;
                $continuation4 = obj12;
                iterator.invoke(channel$iv2.next());
                obj12 = $continuation4;
                $result = anon2;
                $continuation2 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$4;
                $i$f$consumeEach = i;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$42 = channel$iv2;
                subscription = action;
                channel$iv = iterator;
                obj12 = Unit.INSTANCE;
        ...
        $result.L$0 = channel$iv;
        $result.L$1 = subscription;
        $result.L$2 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$42;
        $result.label = i5;
        Object next = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$42.hasNext($result);
        if (next == $continuation2) {
            ...
            iterator = channel$iv;
            action = subscription;
            channel$iv2 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$42;
            i = $i$f$consumeEach;
            $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$4 = $continuation2;
            anon2 = anon;
        }
    ...
    public static final <E> Object consumeEach(kotlinx.coroutines.channels.ReceiveChannel<? extends E> receiveChannel, Function1<? super E, Unit> function12, Continuation<? super Unit> continuation3) {
        ...
        switch (label2) {
            case 0:
                ...
                obj9 = i4;
                $i$f$consumeEach2 = i6;
                $this$consume$iv = $this$consumeEach_u24lambda_u241;
            ...
            case 1:
                ...
                anon = $result;
                $continuation2 = obj11;
                iterator.invoke(cause$iv.next());
                obj11 = $continuation2;
                $result = anon;
                $continuation3 = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2;
                $i$f$consumeEach2 = i2;
                $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$22 = cause$iv;
                i = $this$consume$iv2;
                cause$iv3 = action;
                $this$consume$iv = iterator;
                obj11 = Unit.INSTANCE;
                ChannelsKt.cancelConsumed(action, $this$consume$iv2);
                return Unit.INSTANCE;
            default:
                obj9 = new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                throw obj9;
        }
        $result.L$0 = $this$consume$iv;
        ...
        if (next == $continuation3) {
            ...
            action = cause$iv3;
            $this$consume$iv2 = i;
            cause$iv = $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$22;
            i2 = $i$f$consumeEach2;
            $i$a$ConsumeChannelsKt__Channels_commonKt$consumeEach$2 = $continuation3;
            anon = anon2;
        }
    ...
    public static final <E> Object toList(kotlinx.coroutines.channels.ReceiveChannel<? extends E> receiveChannel, Continuation<? super List<? extends E>> continuation2) {
        ...
        if (continuation2 instanceof ChannelsKt__Channels_commonKt.toList.1 && label &= th != 0) {
            $result = continuation2;
            th = Integer.MIN_VALUE;
            if (label &= th != 0) {
                $result.label = obj15 -= th;
            } else {
        ...
        switch (label2) {
            ...
            case 1:
                ...
                cause$iv$iv2 = $this$toList_u24lambda_u243;
                $this$consume$iv$iv2 = obj2;
                $this$toList_u24lambda_u2432 = iterator;
                obj15 = Unit.INSTANCE;
                ChannelsKt.cancelConsumed($this$toList_u24lambda_u243, $this$consume$iv$iv);
        ...
        $result.L$1 = $this$consume$iv$iv2;
        $result.L$2 = cause$iv$iv2;
        ...
        if (next == $continuation3) {
            ...
            obj2 = $this$consume$iv$iv2;
            $this$toList_u24lambda_u243 = cause$iv$iv2;
