...
final class LazyBroadcastCoroutine<E>  extends kotlinx.coroutines.channels.BroadcastCoroutine<E> {
    ...
    public LazyBroadcastCoroutine(CoroutineContext parentContext, kotlinx.coroutines.channels.BroadcastChannel<E> channel, Function2<? super kotlinx.coroutines.channels.ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {
    ...
    public kotlinx.coroutines.channels.ReceiveChannel<E> openSubscription() {
        start();
        return get_channel().openSubscription();
    }
}
