...
public final class DebugStringsKt {
    ...
    public static final String toDebugString(Continuation<?> $this$toDebugString) {
        ...
        if ($this$toDebugString instanceof DispatchedContinuation) {
            ...
            $i$a$GetOrElseDebugStringsKt$toDebugString$2 = Result.constructor-impl(stringBuilder.append(obj).append(string2).append(DebugStringsKt.getHexAddress(obj)).toString());
            if (Result.exceptionOrNull-impl($i$a$GetOrElseDebugStringsKt$toDebugString$2) == null) {
            } else {
                int i2 = 0;
                StringBuilder stringBuilder2 = new StringBuilder();
                $i$a$GetOrElseDebugStringsKt$toDebugString$2 = string2;
            }
            string = $i$a$GetOrElseDebugStringsKt$toDebugString$2;
        }
        return string;
    }
}
