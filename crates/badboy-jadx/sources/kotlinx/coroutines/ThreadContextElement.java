...
public interface ThreadContextElement<S>  extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <S, R> R fold(kotlinx.coroutines.ThreadContextElement<S> $this, R initial, Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
            return CoroutineContext.Element.DefaultImpls.fold((CoroutineContext.Element)$this, initial, operation);
        }

        public static <S, E extends CoroutineContext.Element> E get(kotlinx.coroutines.ThreadContextElement<S> $this, CoroutineContext.Key<E> key) {
            return CoroutineContext.Element.DefaultImpls.get((CoroutineContext.Element)$this, key);
        }

        public static <S> CoroutineContext minusKey(kotlinx.coroutines.ThreadContextElement<S> $this, CoroutineContext.Key<?> key) {
            return CoroutineContext.Element.DefaultImpls.minusKey((CoroutineContext.Element)$this, key);
        }

        public static <S> CoroutineContext plus(kotlinx.coroutines.ThreadContextElement<S> $this, CoroutineContext context) {
            return CoroutineContext.Element.DefaultImpls.plus((CoroutineContext.Element)$this, context);
        }
    }
    public abstract void restoreThreadContext(CoroutineContext coroutineContext, S s2);

    public abstract S updateThreadContext(CoroutineContext coroutineContext);
}
