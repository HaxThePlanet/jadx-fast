...
final class FlowKt__ReduceKt {
    ...
    public static final <T, R> Object fold(kotlinx.coroutines.flow.Flow<? extends T> flow, R r2, Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function33, Continuation<? super R> continuation4) {
        ...
        if (continuation4 instanceof FlowKt__ReduceKt.fold.1 && label2 &= i3 != 0) {
            anon = continuation4;
            i3 = Integer.MIN_VALUE;
            if (label2 &= i3 != 0) {
                anon.label = obj8 -= i3;
    ...
    public static final <T> Object last(kotlinx.coroutines.flow.Flow<? extends T> flow, Continuation<? super T> continuation2) {
        ...
        int i2;
        Ref.ObjectRef objectRef;
        kotlinx.coroutines.flow.FlowKt__ReduceKt.last.2 anon;
        int i;
        Object obj5;
        Object obj6;
        anon2 = continuation2;
        ...
        if (continuation2 instanceof FlowKt__ReduceKt.last.1 && label &= i2 != 0) {
            ...
            if (label &= i2 != 0) {
                ...
                anon2 = new FlowKt__ReduceKt.last.1(continuation2);
            }
        } else {
        }
        obj6 = anon2.result;
        ...
        switch (objectRef) {
            case 0:
                ...
                objectRef = new Ref.ObjectRef();
                objectRef.element = NullSurrogateKt.NULL;
                anon = new FlowKt__ReduceKt.last.2(objectRef);
                anon2.L$0 = objectRef;
                anon2.label = 1;
                return cOROUTINE_SUSPENDED;
                obj5 = objectRef;
    ...
    public static final <S, T extends S> Object reduce(kotlinx.coroutines.flow.Flow<? extends T> flow, Function3<? super S, ? super T, ? super Continuation<? super S>, ? extends Object> function32, Continuation<? super S> continuation3) {
        ...
        int i3;
        Ref.ObjectRef objectRef;
        kotlinx.coroutines.flow.FlowKt__ReduceKt.reduce.2 anon;
        int i;
        Object obj5;
        Object obj7;
        anon2 = continuation3;
        ...
        if (continuation3 instanceof FlowKt__ReduceKt.reduce.1 && label &= i3 != 0) {
            ...
            if (label &= i3 != 0) {
                ...
                anon2 = new FlowKt__ReduceKt.reduce.1(continuation3);
            }
        } else {
        }
        obj7 = anon2.result;
        ...
        switch (objectRef) {
            case 0:
                ...
                objectRef = new Ref.ObjectRef();
                objectRef.element = NullSurrogateKt.NULL;
                anon = new FlowKt__ReduceKt.reduce.2(objectRef, function32);
                anon2.L$0 = objectRef;
                anon2.label = 1;
                return cOROUTINE_SUSPENDED;
                obj5 = objectRef;
