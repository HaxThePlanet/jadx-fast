...
final class ReadonlySharedFlow<T>  implements kotlinx.coroutines.flow.SharedFlow<T>, kotlinx.coroutines.flow.CancellableFlow<T>, FusibleFlow<T> {

    private final kotlinx.coroutines.flow.SharedFlow<T> $$delegate_0;
    private final Job job;
    public ReadonlySharedFlow(kotlinx.coroutines.flow.SharedFlow<? extends T> flow, Job job) {
        super();
        this.job = job;
