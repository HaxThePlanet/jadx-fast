        ...
        if (sUSPEND == 0) {
            ...
            if (i == 0) {
                ...
                if ($this$buffer instanceof FusibleFlow) {
                    fuse$default = FusibleFlow.DefaultImpls.fuse$default((FusibleFlow)$this$buffer, 0, i6, capacity3, 1, 0);
                    obj = $this$buffer;
                } else {
                    i3 = capacity3;
                    int onBufferOverflow3 = i6;
                    channelFlowOperatorImpl = new ChannelFlowOperatorImpl($this$buffer, 0, onBufferOverflow3, i3, 2, 0);
                    i6 = onBufferOverflow3;
                    capacity3 = i3;
