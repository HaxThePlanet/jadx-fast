...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    public final class Worker extends Thread {
        ...
        public final long runSingleTask() {
            ...
            int i3;
            final int i5 = 0;
            i = this.state == CoroutineScheduler.WorkerState.CPU_ACQUIRED ? i2 : i5;
            if (i != 0) {
        ...
        public final boolean tryReleaseCpu(kotlinx.coroutines.scheduling.CoroutineScheduler.WorkerState newState) {
            ...
            i2 = state == CoroutineScheduler.WorkerState.CPU_ACQUIRED ? 1 : 0;
            if (i2 != 0) {
                i = 0;
    ...
    public CoroutineScheduler(int corePoolSize, int maxPoolSize, long idleWorkerKeepAliveNs, String schedulerName) {
        ...
        if (i2 == 0) {
            ...
            i3 = this.maxPoolSize >= this.corePoolSize ? i11 : i10;
            String str7 = "Max pool size ";
            if (i3 == 0) {
            } else {
                i = this.maxPoolSize <= 2097150 ? i11 : i10;
                if (i == 0) {
                } else {
    ...
    private final boolean tryCreateWorker(long state) {
        ...
        int i5 = 0;
        int i9 = 0;
        corePoolSize = createNewWorker();
        i = 1;
        if (RangesKt.coerceAtLeast(this_$iv - this_$iv2, i9) < this.corePoolSize && corePoolSize == i && this.corePoolSize > i) {
            corePoolSize = createNewWorker();
            i = 1;
            if (corePoolSize == i) {
    ...
    public final void dispatch(Runnable block, kotlinx.coroutines.scheduling.TaskContext taskContext, boolean tailDispatch) {
        ...
        int i3 = 0;
        int i4 = 1;
        $this$isBlocking$iv = task2.taskContext.getTaskMode() == i4 ? i4 : i2;
    ...
    public final boolean parkedWorkersStackPush(kotlinx.coroutines.scheduling.CoroutineScheduler.Worker worker) {
        ...
        while (DebugKt.getASSERTIONS_ENABLED()) {
            ...
            $i$a$AssertCoroutineScheduler$parkedWorkersStackPush$1$1 = i6;
            ...
            indexInArray = worker.getIndexInArray();
            i3 = 1;
            $i$a$AssertCoroutineScheduler$parkedWorkersStackPush$1$1 = i3;
        }
        AssertionError assertionError = new AssertionError();
        throw assertionError;
    }
    ...
    public final void parkedWorkersStackTopUpdate(kotlinx.coroutines.scheduling.CoroutineScheduler.Worker worker, int oldIndex, int newIndex) {
        ...
        while (i2 == oldIndex) {
            ...
            i5 = parkedWorkersStackNextIndex;
            if (i5 < 0) {
            }
            l = parkedWorkersStack$FU.get(this);
            i = 0;
    ...
    public final void shutdown(long timeout) {
        ...
        i4 = 0;
        final int i10 = 1;
        if (!CoroutineScheduler._isTerminated$FU.compareAndSet(obj, i4, i10)) {
        }
        ...
        while ((CoroutineScheduler.Worker)this_$iv != currentWorker) {
            ...
            $i$a$AssertCoroutineScheduler$shutdown$1 = i4;
