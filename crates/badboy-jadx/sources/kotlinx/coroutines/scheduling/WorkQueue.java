...
public final class WorkQueue {
    ...
    private final kotlinx.coroutines.scheduling.Task pollBuffer() {
        ...
        while (i3 - i4 == 0) {
            i3 = WorkQueue.consumerIndex$FU.get(this);
            andSet = 0;
            andSet = this.buffer.getAndSet(i3 & 127, andSet);
        }
        return andSet;
    }
    ...
    private final kotlinx.coroutines.scheduling.Task stealWithExclusiveMode(int stealingMode) {
        ...
        int i;
        int i3;
        i2 = WorkQueue.consumerIndex$FU.get(this);
        if (stealingMode == 1) {
        } else {
            i4 = 0;
        }
        int i6 = 0;
        while (i2 != WorkQueue.producerIndex$FU.get(this)) {
            kotlinx.coroutines.scheduling.Task tryExtractFromTheMiddle = tryExtractFromTheMiddle(i2, i4);
            i2 = i;
            i6 = 0;
        }
        return i6;
    ...
    private final kotlinx.coroutines.scheduling.Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if ((Task)obj2 != null) {
            ...
            if (i2 == onlyBlocking && ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(this.buffer, i3, obj2, blockingTasksInBuffer$FU) && onlyBlocking != 0) {
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<kotlinx.coroutines.scheduling.Task> stolenTaskRef) {
        ...
        while ((Task)obj == null) {
            ...
            int i9 = 0;
            i = 1;
            if (obj3.taskContext.getTaskMode() == i) {
            } else {
            }
            i5 = 0;
            if (i5 != 0) {
