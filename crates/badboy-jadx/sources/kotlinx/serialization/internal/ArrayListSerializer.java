...
public final class ArrayListSerializer<E>  extends kotlinx.serialization.internal.CollectionSerializer<E, List<? extends E>, ArrayList<E>> {
    ...
    public Object toBuilder(Object $this$toBuilder) {
        return toBuilder((List)$this$toBuilder);
    }
    ...
    protected ArrayList<E> toBuilder(List<? extends E> $this$toBuilder) {
        ...
        if ($this$toBuilder instanceof ArrayList != null) {
            arrayList = $this$toBuilder;
        } else {
            arrayList = 0;
        }
        if (arrayList == null) {
            arrayList = new ArrayList((Collection)$this$toBuilder);
        }
        return arrayList;
    }
