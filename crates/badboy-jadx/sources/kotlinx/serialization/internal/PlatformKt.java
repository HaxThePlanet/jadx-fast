...
public final class PlatformKt {
    ...
    private static final <T> KSerializer<T> findObjectSerializer(Class<T> $this$findObjectSerializer) {
        ...
        if (it2 != null) {
            i8 = 0;
            i4 = 2;
            if (!StringsKt.startsWith$default(it2, "java.", i10, i4, i7)) {
                if (StringsKt.startsWith$default(it2, "kotlin.", i10, i4, i7)) {
                    it2 = 1;
                } else {
                    it2 = i10;
                }
        ...
        Object invoke = (Method)single$iv2.invoke((Field)single$iv.get(i7), new Object[i10]);
