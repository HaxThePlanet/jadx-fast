...
public abstract class TaggedDecoder<Tag>  implements Decoder, CompositeDecoder {
    ...
    private static final Object decodeNullableSerializableElement$lambda$3(kotlinx.serialization.internal.TaggedDecoder this$0, DeserializationStrategy $deserializer, Object $previousValue) {
        Object $i$a$DecodeIfNullableTaggedDecoder$decodeNullableSerializableElement$1$1;
        ...
        if (!$deserializer.getDescriptor().isNullable()) {
            if ((Decoder)decoder.decodeNotNullMark()) {
                int i2 = 0;
                $i$a$DecodeIfNullableTaggedDecoder$decodeNullableSerializableElement$1$1 = this$0.decodeSerializableValue($deserializer, $previousValue);
            } else {
                $i$a$DecodeIfNullableTaggedDecoder$decodeNullableSerializableElement$1$1 = decoder.decodeNull();
            }
        } else {
        }
        return $i$a$DecodeIfNullableTaggedDecoder$decodeNullableSerializableElement$1$1;
    }
