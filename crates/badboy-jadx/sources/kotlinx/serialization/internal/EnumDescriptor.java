...
public final class EnumDescriptor extends kotlinx.serialization.internal.PluginGeneratedSerialDescriptor {
    ...
    private static final SerialDescriptor[] elementDescriptors_delegate$lambda$0(int $elementsCount, String $name, kotlinx.serialization.internal.EnumDescriptor this$0) {
        ...
        while (i3 < $elementsCount) {
            ...
            arr2[i3] = SerialDescriptorsKt.buildSerialDescriptor$default(stringBuilder.append($name).append('.').append(this$0.getElementName(i3)).toString(), (SerialKind)StructureKind.OBJECT.INSTANCE, new SerialDescriptor[i5], 0, 8, 0);
            i3++;
        }
        return arr2;
    }
    ...
    public int hashCode() {
        ...
        while (iterator.hasNext()) {
            ...
            i5 = 0;
            accumulator$iv$iv = i4;
            i5 = (String)obj2.hashCode();
        }
