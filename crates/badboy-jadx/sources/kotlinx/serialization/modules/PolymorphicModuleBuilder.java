...
public final class PolymorphicModuleBuilder<Base>  {
    ...
    public final void buildTo(kotlinx.serialization.modules.SerializersModuleBuilder builder) {
        ...
        for (Object next : iterator) {
            ...
            baseSerializer2 = obj;
            int i4 = 0;
            Intrinsics.checkNotNull(baseSerializer2, "null cannot be cast to non-null type kotlinx.serialization.KSerializer<T of kotlinx.serialization.internal.Platform_commonKt.cast>");
            SerializersModuleBuilder.registerPolymorphicSerializer$default(builder, this.baseClass, baseClass2, baseSerializer2, false, 8, 0);
        }
