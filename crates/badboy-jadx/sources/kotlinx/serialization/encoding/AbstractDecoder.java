...
public abstract class AbstractDecoder implements kotlinx.serialization.encoding.Decoder, kotlinx.serialization.encoding.CompositeDecoder {
    public static Object decodeSerializableValue$default(kotlinx.serialization.encoding.AbstractDecoder abstractDecoder, DeserializationStrategy deserializationStrategy2, Object object3, int i4, Object object5) {
        int obj2;
        if (object5 != null) {
        } else {
            if (i4 &= 2 != 0) {
            ...
            return abstractDecoder.decodeSerializableValue(deserializationStrategy2, obj2);
        }
        UnsupportedOperationException obj0 = new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: decodeSerializableValue");
        throw obj0;
    }

    @Override // kotlinx.serialization.encoding.Decoder
    public kotlinx.serialization.encoding.CompositeDecoder beginStructure(SerialDescriptor descriptor) {
    ...
    @Override // kotlinx.serialization.encoding.Decoder
    public kotlinx.serialization.encoding.Decoder decodeInline(SerialDescriptor descriptor) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        return (Decoder)this;
    }

    @Override // kotlinx.serialization.encoding.Decoder
    public kotlinx.serialization.encoding.Decoder decodeInlineElement(SerialDescriptor descriptor, int index) {
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
    ...
    public final <T> T decodeNullableSerializableElement(SerialDescriptor descriptor, int index, DeserializationStrategy<? extends T> deserializer, T previousValue) {
        Object $i$a$DecodeIfNullableAbstractDecoder$decodeNullableSerializableElement$1;
        boolean decodeNotNullMark;
        Intrinsics.checkNotNullParameter(descriptor, "descriptor");
        Intrinsics.checkNotNullParameter(deserializer, "deserializer");
        kotlinx.serialization.encoding.Decoder decoder = this;
        final int i = 0;
        if (!deserializer.getDescriptor().isNullable()) {
            if ((Decoder)decoder.decodeNotNullMark()) {
                int i2 = 0;
                $i$a$DecodeIfNullableAbstractDecoder$decodeNullableSerializableElement$1 = decodeSerializableValue(deserializer, previousValue);
            } else {
                $i$a$DecodeIfNullableAbstractDecoder$decodeNullableSerializableElement$1 = decoder.decodeNull();
            }
        } else {
        }
        return $i$a$DecodeIfNullableAbstractDecoder$decodeNullableSerializableElement$1;
    }
    ...
    public String decodeString() {
        final Object decodeValue = decodeValue();
