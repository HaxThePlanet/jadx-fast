...
public interface Decoder {
    ...
    public static final class DefaultImpls {
        ...
        public static <T> T decodeNullableSerializableValue(kotlinx.serialization.encoding.Decoder $this, DeserializationStrategy<? extends T> deserializer) {
            Object $i$a$DecodeIfNullableDecoder$decodeNullableSerializableValue$1;
            ...
            if (!deserializer.getDescriptor().isNullable()) {
                if (obj.decodeNotNullMark()) {
                    int i2 = 0;
                    $i$a$DecodeIfNullableDecoder$decodeNullableSerializableValue$1 = $this.decodeSerializableValue(deserializer);
                } else {
                    $i$a$DecodeIfNullableDecoder$decodeNullableSerializableValue$1 = obj.decodeNull();
                }
            } else {
            }
            return $i$a$DecodeIfNullableDecoder$decodeNullableSerializableValue$1;
        }
