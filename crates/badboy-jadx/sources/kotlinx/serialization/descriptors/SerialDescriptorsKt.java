...
public final class SerialDescriptorsKt {
    ...
    public static final kotlinx.serialization.descriptors.SerialDescriptor PrimitiveSerialDescriptor(String serialName, kotlinx.serialization.descriptors.PrimitiveKind kind) {
        ...
        int i = 0;
        IllegalArgumentException $i$a$RequireSerialDescriptorsKt$PrimitiveSerialDescriptor$1 = new IllegalArgumentException("Blank serial names are prohibited".toString());
        throw $i$a$RequireSerialDescriptorsKt$PrimitiveSerialDescriptor$1;
    }
    ...
    public static final kotlinx.serialization.descriptors.SerialDescriptor SerialDescriptor(String serialName, kotlinx.serialization.descriptors.SerialDescriptor original) {
        ...
        if (StringsKt.isBlank((CharSequence)serialName)) {
            ...
            if (kind instanceof PrimitiveKind) {
                ...
                IllegalArgumentException illegalArgumentException = new IllegalArgumentException(stringBuilder.append("The name of the wrapped descriptor (").append(serialName).append(") cannot be the same as the name of the original descriptor (").append(original.getSerialName()).append(')').toString().toString());
                throw illegalArgumentException;
            }
            int i = 0;
            IllegalArgumentException $i$a$RequireSerialDescriptorsKt$SerialDescriptor$2 = new IllegalArgumentException("For primitive descriptors please use 'PrimitiveSerialDescriptor' instead".toString());
            throw $i$a$RequireSerialDescriptorsKt$SerialDescriptor$2;
        }
        int i3 = 0;
        IllegalArgumentException $i$a$RequireSerialDescriptorsKt$SerialDescriptor$1 = new IllegalArgumentException("Blank serial names are prohibited".toString());
        throw $i$a$RequireSerialDescriptorsKt$SerialDescriptor$1;
    }
