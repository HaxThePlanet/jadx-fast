...
fn get_library_method_throws(class: &str, method: &str) -> Option<&'static [&'static str]> {
    ...
    match (class, method) {
        ...
        // java.io - Base streams
        ("java/io/InputStream", "read") => Some(&["java/io/IOException"]),
        ("java/io/InputStream", "skip") => Some(&["java/io/IOException"]),
        ("java/io/InputStream", "available") => Some(&["java/io/IOException"]),
        ("java/io/InputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/InputStream", "reset") => Some(&["java/io/IOException"]),
        ...
        ("java/io/Reader", "skip") => Some(&["java/io/IOException"]),
        ("java/io/Reader", "ready") => Some(&["java/io/IOException"]),
        ("java/io/Reader", "close") => Some(&["java/io/IOException"]),
        ("java/io/Reader", "reset") => Some(&["java/io/IOException"]),
        ("java/io/Writer", "write") => Some(&["java/io/IOException"]),
        ("java/io/Writer", "append") => Some(&["java/io/IOException"]),
        ...
        ("java/io/File", "getCanonicalPath") => Some(&["java/io/IOException"]),
        ("java/io/File", "getCanonicalFile") => Some(&["java/io/IOException"]),
        // java.io - FileInputStream/FileOutputStream
        ("java/io/FileInputStream", "<init>") => Some(&["java/io/FileNotFoundException"]),
        ("java/io/FileInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/io/FileInputStream", "skip") => Some(&["java/io/IOException"]),
        ("java/io/FileInputStream", "available") => Some(&["java/io/IOException"]),
        ("java/io/FileInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/FileInputStream", "getChannel") => Some(&["java/io/IOException"]),
        ("java/io/FileOutputStream", "<init>") => Some(&["java/io/FileNotFoundException"]),
        ("java/io/FileOutputStream", "write") => Some(&["java/io/IOException"]),
        ("java/io/FileOutputStream", "flush") => Some(&["java/io/IOException"]),
        ("java/io/FileOutputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/FileOutputStream", "getChannel") => Some(&["java/io/IOException"]),
        ...
        ("java/io/BufferedInputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/BufferedInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/io/BufferedInputStream", "skip") => Some(&["java/io/IOException"]),
        ("java/io/BufferedInputStream", "available") => Some(&["java/io/IOException"]),
        ("java/io/BufferedInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/BufferedOutputStream", "write") => Some(&["java/io/IOException"]),
        ("java/io/BufferedOutputStream", "flush") => Some(&["java/io/IOException"]),
        ("java/io/BufferedOutputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/BufferedReader", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/BufferedReader", "read") => Some(&["java/io/IOException"]),
        ("java/io/BufferedReader", "readLine") => Some(&["java/io/IOException"]),
        ("java/io/BufferedReader", "skip") => Some(&["java/io/IOException"]),
        ("java/io/BufferedReader", "ready") => Some(&["java/io/IOException"]),
        ("java/io/BufferedReader", "close") => Some(&["java/io/IOException"]),
        ("java/io/BufferedWriter", "write") => Some(&["java/io/IOException"]),
        ("java/io/BufferedWriter", "newLine") => Some(&["java/io/IOException"]),
        ("java/io/BufferedWriter", "flush") => Some(&["java/io/IOException"]),
        ("java/io/BufferedWriter", "close") => Some(&["java/io/IOException"]),
        // java.io - Data streams
        ("java/io/DataInputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readFully") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readBoolean") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readByte") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readUnsignedByte") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readShort") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readUnsignedShort") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readChar") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readInt") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readLong") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readFloat") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readDouble") => Some(&["java/io/IOException"]),
        ("java/io/DataInputStream", "readUTF") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "write") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeBoolean") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeByte") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeShort") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeChar") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeInt") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeLong") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeFloat") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeDouble") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "writeUTF") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "flush") => Some(&["java/io/IOException"]),
        ("java/io/DataOutputStream", "close") => Some(&["java/io/IOException"]),
        // java.io - InputStreamReader/OutputStreamWriter
        ("java/io/InputStreamReader", "<init>") => Some(&["java/io/UnsupportedEncodingException"]),
        ("java/io/InputStreamReader", "read") => Some(&["java/io/IOException"]),
        ("java/io/InputStreamReader", "ready") => Some(&["java/io/IOException"]),
        ("java/io/InputStreamReader", "close") => Some(&["java/io/IOException"]),
        ("java/io/OutputStreamWriter", "<init>") => Some(&["java/io/UnsupportedEncodingException"]),
        ("java/io/OutputStreamWriter", "write") => Some(&["java/io/IOException"]),
        ("java/io/OutputStreamWriter", "flush") => Some(&["java/io/IOException"]),
        ("java/io/OutputStreamWriter", "close") => Some(&["java/io/IOException"]),
        ...
        ("java/io/RandomAccessFile", "readFully") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "write") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "seek") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "length") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "setLength") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "getFilePointer") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "readBoolean") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "readByte") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "readInt") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "readLong") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "readUTF") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "writeInt") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "writeLong") => Some(&["java/io/IOException"]),
        ("java/io/RandomAccessFile", "writeUTF") => Some(&["java/io/IOException"]),
        ...
        ("java/io/ObjectInputStream", "defaultReadObject") => Some(&["java/io/IOException", "java/lang/ClassNotFoundException"]),
        ("java/io/ObjectInputStream", "readFields") => Some(&["java/io/IOException", "java/lang/ClassNotFoundException"]),
        ("java/io/ObjectInputStream", "readBoolean") => Some(&["java/io/IOException"]),
        ("java/io/ObjectInputStream", "readInt") => Some(&["java/io/IOException"]),
        ("java/io/ObjectInputStream", "readLong") => Some(&["java/io/IOException"]),
        ("java/io/ObjectInputStream", "readUTF") => Some(&["java/io/IOException"]),
        ("java/io/ObjectInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "writeObject") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "defaultWriteObject") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "writeFields") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "writeBoolean") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "writeInt") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "writeLong") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "writeUTF") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "flush") => Some(&["java/io/IOException"]),
        ("java/io/ObjectOutputStream", "close") => Some(&["java/io/IOException"]),
        // java.io - PrintStream/PrintWriter
        ("java/io/PrintStream", "<init>") => Some(&["java/io/FileNotFoundException"]),
        ("java/io/PrintWriter", "<init>") => Some(&["java/io/FileNotFoundException"]),
        // java.io - Piped streams
        ("java/io/PipedInputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/PipedInputStream", "connect") => Some(&["java/io/IOException"]),
        ("java/io/PipedInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/io/PipedInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/PipedOutputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/PipedOutputStream", "connect") => Some(&["java/io/IOException"]),
        ("java/io/PipedOutputStream", "write") => Some(&["java/io/IOException"]),
        ("java/io/PipedOutputStream", "flush") => Some(&["java/io/IOException"]),
        ("java/io/PipedOutputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/PipedReader", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/PipedReader", "connect") => Some(&["java/io/IOException"]),
        ("java/io/PipedReader", "read") => Some(&["java/io/IOException"]),
        ("java/io/PipedReader", "close") => Some(&["java/io/IOException"]),
        ("java/io/PipedWriter", "<init>") => Some(&["java/io/IOException"]),
        ("java/io/PipedWriter", "connect") => Some(&["java/io/IOException"]),
        ("java/io/PipedWriter", "write") => Some(&["java/io/IOException"]),
        ("java/io/PipedWriter", "flush") => Some(&["java/io/IOException"]),
        ("java/io/PipedWriter", "close") => Some(&["java/io/IOException"]),
        // java.io - Other streams
        ("java/io/PushbackInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/io/PushbackInputStream", "unread") => Some(&["java/io/IOException"]),
        ("java/io/PushbackInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/PushbackReader", "read") => Some(&["java/io/IOException"]),
        ("java/io/PushbackReader", "unread") => Some(&["java/io/IOException"]),
        ("java/io/PushbackReader", "close") => Some(&["java/io/IOException"]),
        ("java/io/LineNumberReader", "read") => Some(&["java/io/IOException"]),
        ("java/io/LineNumberReader", "readLine") => Some(&["java/io/IOException"]),
        ("java/io/LineNumberReader", "skip") => Some(&["java/io/IOException"]),
        ("java/io/SequenceInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/io/SequenceInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/io/StringReader", "read") => Some(&["java/io/IOException"]),
        ("java/io/StringReader", "skip") => Some(&["java/io/IOException"]),
        ("java/io/StringReader", "ready") => Some(&["java/io/IOException"]),
        ("java/io/StringReader", "close") => Some(&["java/io/IOException"]),
        ("java/io/StringWriter", "write") => Some(&["java/io/IOException"]),
        ("java/io/StringWriter", "close") => Some(&["java/io/IOException"]),
        ("java/io/CharArrayReader", "read") => Some(&["java/io/IOException"]),
        ("java/io/CharArrayReader", "close") => Some(&["java/io/IOException"]),
        ("java/io/CharArrayWriter", "writeTo") => Some(&["java/io/IOException"]),
        ...
        ("java/lang/Class", "getMethods") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getDeclaredMethod") => Some(&["java/lang/NoSuchMethodException"]),
        ("java/lang/Class", "getDeclaredMethods") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getField") => Some(&["java/lang/NoSuchFieldException"]),
        ("java/lang/Class", "getFields") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getDeclaredField") => Some(&["java/lang/NoSuchFieldException"]),
        ("java/lang/Class", "getDeclaredFields") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getConstructor") => Some(&["java/lang/NoSuchMethodException"]),
        ("java/lang/Class", "getConstructors") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getDeclaredConstructor") => Some(&["java/lang/NoSuchMethodException"]),
        ("java/lang/Class", "getDeclaredConstructors") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getClasses") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getDeclaredClasses") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getEnclosingMethod") => Some(&["java/lang/SecurityException"]),
        ("java/lang/Class", "getEnclosingConstructor") => Some(&["java/lang/SecurityException"]),
        // java.lang.reflect - Method
        ("java/lang/reflect/Method", "invoke") => Some(&["java/lang/IllegalAccessException", "java/lang/reflect/InvocationTargetException"]),
        ("java/lang/reflect/Method", "getDefaultValue") => Some(&["java/lang/TypeNotPresentException"]),
        ("java/lang/reflect/Method", "getGenericReturnType") => Some(&["java/lang/reflect/GenericSignatureFormatError"]),
        ("java/lang/reflect/Method", "getGenericParameterTypes") => Some(&["java/lang/reflect/GenericSignatureFormatError"]),
        ("java/lang/reflect/Method", "getGenericExceptionTypes") => Some(&["java/lang/reflect/GenericSignatureFormatError"]),
        ...
        ("java/lang/reflect/Constructor", "getGenericParameterTypes") => Some(&["java/lang/reflect/GenericSignatureFormatError"]),
        ("java/lang/reflect/Constructor", "getGenericExceptionTypes") => Some(&["java/lang/reflect/GenericSignatureFormatError"]),
        // java.lang.reflect - Field
        ("java/lang/reflect/Field", "get") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getBoolean") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getByte") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getChar") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getShort") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getInt") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getLong") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getFloat") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getDouble") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "set") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setBoolean") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setByte") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setChar") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setShort") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setInt") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setLong") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setFloat") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "setDouble") => Some(&["java/lang/IllegalAccessException"]),
        ("java/lang/reflect/Field", "getGenericType") => Some(&["java/lang/reflect/GenericSignatureFormatError"]),
        // java.lang.reflect - Array
        ("java/lang/reflect/Array", "newInstance") => Some(&["java/lang/NegativeArraySizeException"]),
        ("java/lang/reflect/Array", "get") => Some(&["java/lang/ArrayIndexOutOfBoundsException"]),
        ("java/lang/reflect/Array", "set") => Some(&["java/lang/ArrayIndexOutOfBoundsException"]),
        // java.lang.reflect - Proxy
        ("java/lang/reflect/Proxy", "newProxyInstance") => Some(&["java/lang/IllegalArgumentException"]),
        ("java/lang/reflect/Proxy", "getInvocationHandler") => Some(&["java/lang/IllegalArgumentException"]),
        // java.lang - Thread
        ("java/lang/Thread", "sleep") => Some(&["java/lang/InterruptedException"]),
        ("java/lang/Thread", "join") => Some(&["java/lang/InterruptedException"]),
        ("java/lang/Thread", "start") => Some(&["java/lang/IllegalThreadStateException"]),
        // java.lang - Object
        ...
        ("java/lang/ClassLoader", "loadClass") => Some(&["java/lang/ClassNotFoundException"]),
        ("java/lang/ClassLoader", "findClass") => Some(&["java/lang/ClassNotFoundException"]),
        ("java/lang/ClassLoader", "defineClass") => Some(&["java/lang/ClassFormatError"]),
        // java.lang - String/Integer/etc parsing
        ("java/lang/Integer", "parseInt") => Some(&["java/lang/NumberFormatException"]),
        ("java/lang/Long", "parseLong") => Some(&["java/lang/NumberFormatException"]),
        ("java/lang/Float", "parseFloat") => Some(&["java/lang/NumberFormatException"]),
        ("java/lang/Double", "parseDouble") => Some(&["java/lang/NumberFormatException"]),
        ("java/lang/Short", "parseShort") => Some(&["java/lang/NumberFormatException"]),
        ("java/lang/Byte", "parseByte") => Some(&["java/lang/NumberFormatException"]),
        // java.lang - Process
        ("java/lang/Process", "waitFor") => Some(&["java/lang/InterruptedException"]),
        ("java/lang/ProcessBuilder", "start") => Some(&["java/io/IOException"]),
        ("java/lang/Runtime", "exec") => Some(&["java/io/IOException"]),
        ...
        // java.util.zip
        ("java/util/zip/ZipFile", "<init>") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipFile", "getEntry") => Some(&["java/lang/IllegalStateException"]),
        ("java/util/zip/ZipFile", "getInputStream") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipFile", "entries") => Some(&["java/lang/IllegalStateException"]),
        ("java/util/zip/ZipFile", "close") => Some(&["java/io/IOException"]),
        ("java/util/zip/ZipInputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/util/zip/ZipInputStream", "getNextEntry") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipInputStream", "closeEntry") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipInputStream", "read") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/util/zip/ZipOutputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/util/zip/ZipOutputStream", "putNextEntry") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipOutputStream", "closeEntry") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipOutputStream", "write") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipOutputStream", "finish") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/ZipOutputStream", "close") => Some(&["java/io/IOException", "java/util/zip/ZipException"]),
        ("java/util/zip/GZIPInputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/util/zip/GZIPInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/util/zip/GZIPInputStream", "close") => Some(&["java/io/IOException"]),
        ("java/util/zip/GZIPOutputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/util/zip/GZIPOutputStream", "write") => Some(&["java/io/IOException"]),
        ("java/util/zip/GZIPOutputStream", "finish") => Some(&["java/io/IOException"]),
        ("java/util/zip/GZIPOutputStream", "close") => Some(&["java/io/IOException"]),
        ("java/util/zip/Inflater", "inflate") => Some(&["java/util/zip/DataFormatException"]),
        ("java/util/zip/InflaterInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/util/zip/DeflaterOutputStream", "write") => Some(&["java/io/IOException"]),
        ("java/util/zip/CheckedInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/util/zip/CheckedOutputStream", "write") => Some(&["java/io/IOException"]),
        // java.util.jar
        ("java/util/jar/JarFile", "<init>") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarFile", "getManifest") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarFile", "getJarEntry") => Some(&["java/lang/IllegalStateException"]),
        ("java/util/jar/JarFile", "getInputStream") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarFile", "close") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarInputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarInputStream", "getManifest") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarInputStream", "getNextJarEntry") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarInputStream", "read") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarOutputStream", "<init>") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarOutputStream", "putNextEntry") => Some(&["java/io/IOException"]),
        ("java/util/jar/JarOutputStream", "close") => Some(&["java/io/IOException"]),
        // java.util.Properties
        ("java/util/Properties", "load") => Some(&["java/io/IOException"]),
        ("java/util/Properties", "loadFromXML") => Some(&["java/io/IOException", "java/util/InvalidPropertiesFormatException"]),
        ("java/util/Properties", "store") => Some(&["java/io/IOException"]),
        ("java/util/Properties", "storeToXML") => Some(&["java/io/IOException"]),
        // java.util - Scanner and Formatter
        ("java/util/Scanner", "<init>") => Some(&["java/io/FileNotFoundException"]),
        ("java/util/Formatter", "<init>") => Some(&["java/io/FileNotFoundException"]),
        ("java/util/Formatter", "close") => Some(&["java/util/FormatterClosedException"]),
        // java.util - ResourceBundle
        ("java/util/ResourceBundle", "getBundle") => Some(&["java/util/MissingResourceException"]),
        // java.text - Parsing
        ("java/text/DateFormat", "parse") => Some(&["java/text/ParseException"]),
        ("java/text/SimpleDateFormat", "parse") => Some(&["java/text/ParseException"]),
        ("java/text/NumberFormat", "parse") => Some(&["java/text/ParseException"]),
        ("java/text/DecimalFormat", "parse") => Some(&["java/text/ParseException"]),
        ("java/text/MessageFormat", "parse") => Some(&["java/text/ParseException"]),
        // java.nio.channels
        ("java/nio/channels/FileChannel", "open") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "read") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "write") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "position") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "size") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "truncate") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "force") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "transferTo") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "transferFrom") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "map") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "lock") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "tryLock") => Some(&["java/io/IOException"]),
        ("java/nio/channels/FileChannel", "close") => Some(&["java/io/IOException"]),
        ("java/nio/channels/SocketChannel", "open") => Some(&["java/io/IOException"]),
        ("java/nio/channels/SocketChannel", "connect") => Some(&["java/io/IOException"]),
        ("java/nio/channels/SocketChannel", "finishConnect") => Some(&["java/io/IOException"]),
        ("java/nio/channels/SocketChannel", "read") => Some(&["java/io/IOException"]),
        ("java/nio/channels/SocketChannel", "write") => Some(&["java/io/IOException"]),
        ("java/nio/channels/SocketChannel", "close") => Some(&["java/io/IOException"]),
        ("java/nio/channels/ServerSocketChannel", "open") => Some(&["java/io/IOException"]),
        ("java/nio/channels/ServerSocketChannel", "bind") => Some(&["java/io/IOException"]),
        ("java/nio/channels/ServerSocketChannel", "accept") => Some(&["java/io/IOException"]),
        ("java/nio/channels/ServerSocketChannel", "close") => Some(&["java/io/IOException"]),
        ("java/nio/channels/Selector", "open") => Some(&["java/io/IOException"]),
        ("java/nio/channels/Selector", "select") => Some(&["java/io/IOException"]),
        ("java/nio/channels/Selector", "close") => Some(&["java/io/IOException"]),
        // java.nio.file
        ("java/nio/file/Files", "newInputStream") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "newOutputStream") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "newBufferedReader") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "newBufferedWriter") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "newByteChannel") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "createFile") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "createDirectory") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "createDirectories") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "createTempFile") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "createTempDirectory") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "createLink") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "createSymbolicLink") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "delete") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "deleteIfExists") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "copy") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "move") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "readSymbolicLink") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "getOwner") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "setOwner") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "getFileAttributeView") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "readAttributes") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "setAttribute") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "getAttribute") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "getPosixFilePermissions") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "setPosixFilePermissions") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "readAllBytes") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "readAllLines") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "write") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "list") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "walk") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "walkFileTree") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "newDirectoryStream") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "lines") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "size") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "getLastModifiedTime") => Some(&["java/io/IOException"]),
        ("java/nio/file/Files", "setLastModifiedTime") => Some(&["java/io/IOException"]),
        ("java/nio/file/Paths", "get") => Some(&["java/nio/file/InvalidPathException"]),

        // javax.xml.parsers
        ("javax/xml/parsers/DocumentBuilderFactory", "newInstance") => Some(&["javax/xml/parsers/FactoryConfigurationError"]),
        ("javax/xml/parsers/DocumentBuilderFactory", "newDocumentBuilder") => Some(&["javax/xml/parsers/ParserConfigurationException"]),
        ("javax/xml/parsers/DocumentBuilder", "parse") => Some(&["org/xml/sax/SAXException", "java/io/IOException"]),
        ("javax/xml/parsers/DocumentBuilder", "newDocument") => Some(&["javax/xml/parsers/ParserConfigurationException"]),
        ("javax/xml/parsers/SAXParserFactory", "newInstance") => Some(&["javax/xml/parsers/FactoryConfigurationError"]),
        ("javax/xml/parsers/SAXParserFactory", "newSAXParser") => Some(&["javax/xml/parsers/ParserConfigurationException", "org/xml/sax/SAXException"]),
        ("javax/xml/parsers/SAXParser", "parse") => Some(&["org/xml/sax/SAXException", "java/io/IOException"]),
        ("javax/xml/parsers/SAXParser", "getXMLReader") => Some(&["org/xml/sax/SAXException"]),
        // javax.xml.transform
        ("javax/xml/transform/TransformerFactory", "newInstance") => Some(&["javax/xml/transform/TransformerFactoryConfigurationError"]),
        ("javax/xml/transform/TransformerFactory", "newTransformer") => Some(&["javax/xml/transform/TransformerConfigurationException"]),
        ("javax/xml/transform/TransformerFactory", "newTemplates") => Some(&["javax/xml/transform/TransformerConfigurationException"]),
        ("javax/xml/transform/Transformer", "transform") => Some(&["javax/xml/transform/TransformerException"]),
        // javax.xml.xpath
        ("javax/xml/xpath/XPathFactory", "newInstance") => Some(&["javax/xml/xpath/XPathFactoryConfigurationException"]),
        ("javax/xml/xpath/XPath", "compile") => Some(&["javax/xml/xpath/XPathExpressionException"]),
        ("javax/xml/xpath/XPath", "evaluate") => Some(&["javax/xml/xpath/XPathExpressionException"]),
        ("javax/xml/xpath/XPathExpression", "evaluate") => Some(&["javax/xml/xpath/XPathExpressionException"]),
        // org.xml.sax
        ("org/xml/sax/XMLReader", "parse") => Some(&["org/xml/sax/SAXException", "java/io/IOException"]),
        ("org/xml/sax/XMLReader", "setContentHandler") => Some(&["org/xml/sax/SAXException"]),
        ("org/xml/sax/XMLReader", "setProperty") => Some(&["org/xml/sax/SAXNotRecognizedException", "org/xml/sax/SAXNotSupportedException"]),
        ("org/xml/sax/XMLReader", "setFeature") => Some(&["org/xml/sax/SAXNotRecognizedException", "org/xml/sax/SAXNotSupportedException"]),
        ("org/xml/sax/helpers/XMLReaderFactory", "createXMLReader") => Some(&["org/xml/sax/SAXException"]),
        // org.w3c.dom
        ("org/w3c/dom/Document", "createElementNS") => Some(&["org/w3c/dom/DOMException"]),
        ("org/w3c/dom/Document", "createAttributeNS") => Some(&["org/w3c/dom/DOMException"]),
        ("org/w3c/dom/Node", "appendChild") => Some(&["org/w3c/dom/DOMException"]),
        ("org/w3c/dom/Node", "insertBefore") => Some(&["org/w3c/dom/DOMException"]),
        ("org/w3c/dom/Node", "removeChild") => Some(&["org/w3c/dom/DOMException"]),
        ("org/w3c/dom/Node", "replaceChild") => Some(&["org/w3c/dom/DOMException"]),
        ("org/w3c/dom/Node", "setTextContent") => Some(&["org/w3c/dom/DOMException"]),
        // javax.net.ssl
        ("javax/net/ssl/SSLContext", "getInstance") => Some(&["java/security/NoSuchAlgorithmException"]),
        ("javax/net/ssl/SSLContext", "init") => Some(&["java/security/KeyManagementException"]),
        ("javax/net/ssl/SSLSocket", "startHandshake") => Some(&["java/io/IOException"]),
        ("javax/net/ssl/SSLSocket", "getInputStream") => Some(&["java/io/IOException"]),
        ("javax/net/ssl/SSLSocket", "getOutputStream") => Some(&["java/io/IOException"]),
        ("javax/net/ssl/HttpsURLConnection", "connect") => Some(&["java/io/IOException"]),
        ("javax/net/ssl/TrustManagerFactory", "getInstance") => Some(&["java/security/NoSuchAlgorithmException"]),
        ("javax/net/ssl/TrustManagerFactory", "init") => Some(&["java/security/KeyStoreException"]),
        ("javax/net/ssl/KeyManagerFactory", "getInstance") => Some(&["java/security/NoSuchAlgorithmException"]),
        ("javax/net/ssl/KeyManagerFactory", "init") => Some(&["java/security/KeyStoreException", "java/security/NoSuchAlgorithmException", "java/security/UnrecoverableKeyException"]),
        // java.security - KeyStore
        ("java/security/KeyStore", "getInstance") => Some(&["java/security/KeyStoreException"]),
        ("java/security/KeyStore", "load") => Some(&["java/io/IOException", "java/security/NoSuchAlgorithmException", "java/security/cert/CertificateException"]),
        ("java/security/KeyStore", "store") => Some(&["java/io/IOException", "java/security/NoSuchAlgorithmException", "java/security/cert/CertificateException", "java/security/KeyStoreException"]),
        ("java/security/KeyStore", "getKey") => Some(&["java/security/KeyStoreException", "java/security/NoSuchAlgorithmException", "java/security/UnrecoverableKeyException"]),
        ("java/security/KeyStore", "getCertificate") => Some(&["java/security/KeyStoreException"]),
        ("java/security/KeyStore", "getCertificateChain") => Some(&["java/security/KeyStoreException"]),
        ("java/security/KeyStore", "setKeyEntry") => Some(&["java/security/KeyStoreException"]),
        ("java/security/KeyStore", "setCertificateEntry") => Some(&["java/security/KeyStoreException"]),
        ("java/security/KeyStore", "deleteEntry") => Some(&["java/security/KeyStoreException"]),
        // java.security.cert
        ("java/security/cert/CertificateFactory", "getInstance") => Some(&["java/security/cert/CertificateException"]),
        ("java/security/cert/CertificateFactory", "generateCertificate") => Some(&["java/security/cert/CertificateException"]),
        ("java/security/cert/CertificateFactory", "generateCertificates") => Some(&["java/security/cert/CertificateException"]),
        ("java/security/cert/X509Certificate", "checkValidity") => Some(&["java/security/cert/CertificateExpiredException", "java/security/cert/CertificateNotYetValidException"]),
        ("java/security/cert/X509Certificate", "verify") => Some(&["java/security/cert/CertificateException", "java/security/NoSuchAlgorithmException", "java/security/InvalidKeyException", "java/security/NoSuchProviderException", "java/security/SignatureException"]),
        // Android - Context
        ("android/content/Context", "openFileInput") => Some(&["java/io/FileNotFoundException"]),
        ("android/content/Context", "openFileOutput") => Some(&["java/io/FileNotFoundException"]),
        ("android/content/Context", "deleteFile") => Some(&["java/io/IOException"]),
        ("android/content/Context", "getFilesDir") => Some(&["java/io/IOException"]),
        ("android/content/Context", "getCacheDir") => Some(&["java/io/IOException"]),
        ("android/content/Context", "getExternalFilesDir") => Some(&["java/io/IOException"]),
        // Android - ContentResolver
        ("android/content/ContentResolver", "openInputStream") => Some(&["java/io/FileNotFoundException"]),
        ("android/content/ContentResolver", "openOutputStream") => Some(&["java/io/FileNotFoundException"]),
        ("android/content/ContentResolver", "openAssetFileDescriptor") => Some(&["java/io/FileNotFoundException"]),
        ("android/content/ContentResolver", "openFileDescriptor") => Some(&["java/io/FileNotFoundException"]),
        ("android/content/ContentResolver", "openTypedAssetFileDescriptor") => Some(&["java/io/FileNotFoundException"]),
        // Android - AssetManager
        ("android/content/res/AssetManager", "open") => Some(&["java/io/IOException"]),
        ("android/content/res/AssetManager", "openFd") => Some(&["java/io/IOException"]),
        ("android/content/res/AssetManager", "openNonAssetFd") => Some(&["java/io/IOException"]),
        ("android/content/res/AssetManager", "openXmlResourceParser") => Some(&["java/io/IOException"]),
        ("android/content/res/AssetManager", "list") => Some(&["java/io/IOException"]),
        // Android - Resources
        ("android/content/res/Resources", "openRawResource") => Some(&["android/content/res/Resources$NotFoundException"]),
        ("android/content/res/Resources", "openRawResourceFd") => Some(&["android/content/res/Resources$NotFoundException"]),
        ("android/content/res/Resources", "getXml") => Some(&["android/content/res/Resources$NotFoundException"]),
        ("android/content/res/Resources", "getDrawable") => Some(&["android/content/res/Resources$NotFoundException"]),
        ("android/content/res/Resources", "getString") => Some(&["android/content/res/Resources$NotFoundException"]),
        ("android/content/res/Resources", "getColor") => Some(&["android/content/res/Resources$NotFoundException"]),
        ("android/content/res/Resources", "getDimension") => Some(&["android/content/res/Resources$NotFoundException"]),
        // Android - BitmapFactory
        ("android/graphics/BitmapFactory", "decodeFile") => Some(&["java/io/FileNotFoundException"]),
        ("android/graphics/BitmapFactory", "decodeStream") => Some(&["java/io/IOException"]),
        ("android/graphics/BitmapFactory", "decodeResource") => Some(&["android/content/res/Resources$NotFoundException"]),
        // Android - Bitmap
        ("android/graphics/Bitmap", "compress") => Some(&["java/io/IOException"]),
        ("android/graphics/Bitmap", "createBitmap") => Some(&["java/lang/IllegalArgumentException"]),
        // Android - MediaPlayer
        ("android/media/MediaPlayer", "setDataSource") => Some(&["java/io/IOException", "java/lang/IllegalArgumentException", "java/lang/SecurityException", "java/lang/IllegalStateException"]),
        ("android/media/MediaPlayer", "prepare") => Some(&["java/io/IOException", "java/lang/IllegalStateException"]),
        ("android/media/MediaPlayer", "start") => Some(&["java/lang/IllegalStateException"]),
        ("android/media/MediaPlayer", "stop") => Some(&["java/lang/IllegalStateException"]),
        ("android/media/MediaPlayer", "pause") => Some(&["java/lang/IllegalStateException"]),
        ("android/media/MediaPlayer", "reset") => Some(&["java/lang/IllegalStateException"]),
        ("android/media/MediaPlayer", "release") => Some(&["java/lang/IllegalStateException"]),
        // Android - MediaRecorder
        ("android/media/MediaRecorder", "prepare") => Some(&["java/io/IOException", "java/lang/IllegalStateException"]),
        ("android/media/MediaRecorder", "start") => Some(&["java/lang/IllegalStateException"]),
        ("android/media/MediaRecorder", "stop") => Some(&["java/lang/IllegalStateException"]),
        // Android - SQLiteDatabase
        ("android/database/sqlite/SQLiteDatabase", "openDatabase") => Some(&["android/database/sqlite/SQLiteException"]),
        ("android/database/sqlite/SQLiteDatabase", "openOrCreateDatabase") => Some(&["android/database/sqlite/SQLiteException"]),
        ("android/database/sqlite/SQLiteDatabase", "execSQL") => Some(&["android/database/SQLException"]),
        ("android/database/sqlite/SQLiteDatabase", "rawQuery") => Some(&["android/database/SQLException"]),
        ("android/database/sqlite/SQLiteDatabase", "query") => Some(&["android/database/SQLException"]),
        ("android/database/sqlite/SQLiteDatabase", "insert") => Some(&["android/database/SQLException"]),
        ("android/database/sqlite/SQLiteDatabase", "update") => Some(&["android/database/SQLException"]),
        ("android/database/sqlite/SQLiteDatabase", "delete") => Some(&["android/database/SQLException"]),
        ("android/database/sqlite/SQLiteDatabase", "compileStatement") => Some(&["android/database/SQLException"]),
        ("android/database/sqlite/SQLiteDatabase", "beginTransaction") => Some(&["android/database/SQLException"]),
        // Android - SharedPreferences
        ("android/content/SharedPreferences$Editor", "commit") => Some(&["java/lang/IllegalStateException"]),
        // Android - PackageManager
        ("android/content/pm/PackageManager", "getPackageInfo") => Some(&["android/content/pm/PackageManager$NameNotFoundException"]),
        ("android/content/pm/PackageManager", "getApplicationInfo") => Some(&["android/content/pm/PackageManager$NameNotFoundException"]),
        ("android/content/pm/PackageManager", "getActivityInfo") => Some(&["android/content/pm/PackageManager$NameNotFoundException"]),
        ("android/content/pm/PackageManager", "getServiceInfo") => Some(&["android/content/pm/PackageManager$NameNotFoundException"]),
        ("android/content/pm/PackageManager", "getReceiverInfo") => Some(&["android/content/pm/PackageManager$NameNotFoundException"]),
        ("android/content/pm/PackageManager", "getProviderInfo") => Some(&["android/content/pm/PackageManager$NameNotFoundException"]),
        ("android/content/pm/PackageManager", "getResourcesForApplication") => Some(&["android/content/pm/PackageManager$NameNotFoundException"]),
        // Android - Intent/Activity
        ("android/content/Intent", "parseUri") => Some(&["java/net/URISyntaxException"]),
        ("android/app/Activity", "startActivityForResult") => Some(&["android/content/ActivityNotFoundException"]),
        // Android - Network
        ("android/net/Uri", "parse") => Some(&["java/lang/NullPointerException"]),
        // Android - JSON (org.json on Android)
        ("org/json/JSONTokener", "<init>") => Some(&["org/json/JSONException"]),
        ("org/json/JSONTokener", "nextValue") => Some(&["org/json/JSONException"]),
...
fn is_checked_exception(exception_type: &str) -> bool {
    // Common unchecked exception types (RuntimeException subclasses and Errors)
    let unchecked = [
        // Core RuntimeException and common subclasses
        ...
        // Additional RuntimeException subclasses
