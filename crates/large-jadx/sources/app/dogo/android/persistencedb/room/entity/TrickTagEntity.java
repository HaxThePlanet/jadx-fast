...
public final class TrickTagEntity {
    ...
    public TrickTagEntity(String string, String string2, String string3, long l4, String string5) {
        n.f(string, "tagId");
        n.f(string2, "locale");
        n.f(string3, "name");
        n.f(obj7, "locale_tagId");
        super();
        this.tagId = string;
        this.locale = string2;
        this.name = string3;
        this.updatedAt = l4;
        this.locale_tagId = obj7;
    }

    public TrickTagEntity(String string, String string2, String string3, long l4, String string5, int i6, g g7) {
        String obj13;
        int obj14;
        if (g7 &= 16 != 0) {
    ...
    public static app.dogo.android.persistencedb.room.entity.TrickTagEntity copy$default(app.dogo.android.persistencedb.room.entity.TrickTagEntity trickTagEntity, String string2, String string3, String string4, long l5, String string6, int i7, Object object8) {
        String obj5;
        String obj6;
        String obj7;
        long obj8;
        String obj10;
        if (object8 & 1 != 0) {
            obj5 = trickTagEntity.tagId;
        }
        if (object8 & 2 != 0) {
            obj6 = trickTagEntity.locale;
        }
        if (object8 & 4 != 0) {
            obj7 = trickTagEntity.name;
        }
        if (object8 & 8 != 0) {
            obj8 = trickTagEntity.updatedAt;
        }
        if (object8 & 16 != 0) {
            obj10 = trickTagEntity.locale_tagId;
        }
        return trickTagEntity.copy(obj5, obj6, obj7, obj8, object8);
    }
    ...
    public final app.dogo.android.persistencedb.room.entity.TrickTagEntity copy(String string, String string2, String string3, long l4, String string5) {
        n.f(string, "tagId");
        n.f(string2, "locale");
        n.f(string3, "name");
        n.f(obj14, "locale_tagId");
    ...
    public boolean equals(Object object) {
        ...
        final int i2 = 0;
        if (!object instanceof TrickTagEntity) {
            return i2;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("TrickTagEntity(tagId=");
