...
public final class WorkoutInfoEntity {
    ...
    public WorkoutInfoEntity(String string, List<String> list2) {
        n.f(string, "dogId");
    ...
    public WorkoutInfoEntity(String string, List list2, int i3, g g4) {
        List obj2;
        if (i3 &= 2 != 0) {
            obj2 = p.g();
        }
    ...
    public static app.dogo.android.persistencedb.room.entity.WorkoutInfoEntity copy$default(app.dogo.android.persistencedb.room.entity.WorkoutInfoEntity workoutInfoEntity, String string2, List list3, int i4, Object object5) {
        String obj1;
        List obj2;
        if (i4 & 1 != 0) {
            obj1 = workoutInfoEntity.dogId;
        }
        if (i4 &= 2 != 0) {
            obj2 = workoutInfoEntity.cachedWorkoutTrickIdList;
        }
        return workoutInfoEntity.copy(obj1, obj2);
    }
    ...
    public final app.dogo.android.persistencedb.room.entity.WorkoutInfoEntity copy(String string, List<String> list2) {
        n.f(string, "dogId");
        n.f(list2, "cachedWorkoutTrickIdList");
        WorkoutInfoEntity workoutInfoEntity = new WorkoutInfoEntity(string, list2);
    ...
    public boolean equals(Object object) {
        ...
        final int i2 = 0;
        if (!object instanceof WorkoutInfoEntity) {
            return i2;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("WorkoutInfoEntity(dogId=");
