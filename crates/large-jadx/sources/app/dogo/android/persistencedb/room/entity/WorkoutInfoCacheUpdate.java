...
/* compiled from: WorkoutInfoCacheUpdate.kt */
...
public final /* data */ class WorkoutInfoCacheUpdate {

    private final List<String> cachedWorkoutTrickIdList;
    private final String dogId;
    public WorkoutInfoCacheUpdate(String str, List<String> list) {
        n.f(str, "dogId");
    ...
    public static /* synthetic */ WorkoutInfoCacheUpdate copy$default(WorkoutInfoCacheUpdate workoutInfoCacheUpdate, String str, List list, int i, Object object) {
        String dogId2;
        ...
        return workoutInfoCacheUpdate.copy(dogId2, cachedWorkoutTrickIdList2);
    }
    ...
    public final WorkoutInfoCacheUpdate copy(String dogId, List<String> cachedWorkoutTrickIdList) {
        n.f(dogId, "dogId");
        n.f(cachedWorkoutTrickIdList, "cachedWorkoutTrickIdList");
        return new WorkoutInfoCacheUpdate(dogId, cachedWorkoutTrickIdList);
    }
    ...
    /* operator */ public boolean equals(Object other) {
        ...
        if (!(other instanceof WorkoutInfoCacheUpdate)) {
            return false;
        }
    ...
    public String toString() {
        ...
        String str2 = "WorkoutInfoCacheUpdate(dogId=";
