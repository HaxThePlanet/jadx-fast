...
public final class UserCurrentDogIdUpdate {

    private final String currentDogId;
    private final String id;
    public UserCurrentDogIdUpdate(String string, String string2) {
        n.f(string, "id");
    ...
    public static app.dogo.android.persistencedb.room.entity.UserCurrentDogIdUpdate copy$default(app.dogo.android.persistencedb.room.entity.UserCurrentDogIdUpdate userCurrentDogIdUpdate, String string2, String string3, int i4, Object object5) {
        String obj1;
        String obj2;
        if (i4 & 1 != 0) {
            obj1 = userCurrentDogIdUpdate.id;
        }
        if (i4 &= 2 != 0) {
            obj2 = userCurrentDogIdUpdate.currentDogId;
        }
        return userCurrentDogIdUpdate.copy(obj1, obj2);
    }
    ...
    public final app.dogo.android.persistencedb.room.entity.UserCurrentDogIdUpdate copy(String string, String string2) {
        n.f(string, "id");
        n.f(string2, "currentDogId");
        UserCurrentDogIdUpdate userCurrentDogIdUpdate = new UserCurrentDogIdUpdate(string, string2);
        return userCurrentDogIdUpdate;
    }
    ...
    public boolean equals(Object object) {
        ...
        final int i2 = 0;
        if (!object instanceof UserCurrentDogIdUpdate) {
            return i2;
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("UserCurrentDogIdUpdate(id=");
