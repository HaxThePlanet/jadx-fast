...
/* compiled from: ClickerSelectScreen.kt */
...
public final class ClickerSelectScreen extends e {
    ...
    public static final class a implements Parcelable.Creator<m> {
        public final m a(Parcel parcel) {
            n.f(parcel, "parcel");
            parcel.readInt();
            return new ClickerSelectScreen();
        }
    ...
    protected Fragment createFragment() {
        return new ClickerSelectDialog();
    }

    @Override // app.dogo.com.dogo_android.util.e
    public i3 createTrackingParameters() {
        return S.recommendedProgramsListScreen.withoutParameters();
    }
