...
public final class n0 extends s {
    ...
    static final class a extends p implements l<Throwable, w> {
        ...
        final app.dogo.com.dogo_android.welcome_v2.n0 this$0;
        a(app.dogo.com.dogo_android.welcome_v2.n0 n0) {
            this.this$0 = n0;
            super(1);
        }
        ...
        public final void invoke(Throwable throwable) {
            ...
            n0.h(this.this$0).postValue(aVar);
        }
    }
    ...
    static final class b extends p implements l<RecommendedOrderedPrograms, w> {
        ...
        final app.dogo.com.dogo_android.welcome_v2.n0 this$0;
        b(app.dogo.com.dogo_android.welcome_v2.n0 n0) {
            this.this$0 = n0;
            super(1);
        }
        ...
        public final void a(RecommendedOrderedPrograms recommendedOrderedPrograms) {
            ...
            n0.h(this.this$0).postValue(cVar);
    ...
    public n0(SurveyAnswers surveyAnswers, z2 z22, p2 p23, o3 o34, j2 j25) {
    ...
    public static final x h(app.dogo.com.dogo_android.welcome_v2.n0 n0) {
        return n0.f;
    }

    public static RecommendedOrderedPrograms j(app.dogo.com.dogo_android.welcome_v2.n0 n0, RecommendedOrderedPrograms recommendedOrderedPrograms2) {
        n0.l(n0, recommendedOrderedPrograms2);
    ...
    private final void k(long l) {
        ...
        if (!this.e.a()) {
            ...
            q qVar = new q(this);
            obj7 = this.b.f(j0.s(arrayList)).map(qVar).observeOn(a.b()).subscribeOn(a.b()).delay(l, obj8);
    ...
    private static final RecommendedOrderedPrograms l(app.dogo.com.dogo_android.welcome_v2.n0 n0, RecommendedOrderedPrograms recommendedOrderedPrograms2) {
        n.f(n0, "this$0");
        n.f(recommendedOrderedPrograms2, "it");
        n0.d.q(q3.OnboardingSurvey, n0.a.getUserPropertyTrackingData());
        n0.o(recommendedOrderedPrograms2);
        n0.p();
        n0.n();
        return recommendedOrderedPrograms2;
    }
