...
/* compiled from: DailyWorkoutCompletedScreen.kt */
...
public final class DailyWorkoutCompletedScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<c> {
        public final c a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new DailyWorkoutCompletedScreen((WorkoutStreakInfo)WorkoutStreakInfo.CREATOR.createFromParcel(parcel), parcel.readString());
        }
    ...
    public c(WorkoutStreakInfo workoutStreakInfo, String str) {
    ...
    public final WorkoutStreakInfo createFragment() {
        return this.a;
    }

    @Override // app.dogo.com.dogo_android.y.j
    protected Fragment createFragment() {
        return new DailyWorkoutCompletedFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        return S.settings.withParameters(u.a(new EP_Type(), "workout"), u.a(new EP_Streak(), Integer.valueOf(this.a.getCurrentStreak())));
    }
