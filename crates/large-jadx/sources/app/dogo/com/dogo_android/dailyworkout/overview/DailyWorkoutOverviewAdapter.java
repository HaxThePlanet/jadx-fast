...
/* compiled from: DailyWorkoutOverviewAdapter.kt */
...
public final class DailyWorkoutOverviewAdapter extends RecyclerView.h<e.a> implements app.dogo.com.dogo_android.util.d0.a {

    static final /* synthetic */ l<Object>[] b;
    private final c a = new e$c();
    ...
    public static final class c extends b<List<? extends TrickItem>> {
        ...
        final /* synthetic */ e b;
        public c(Object object, Object object2, e eVar) {
            this.a = object;
            this.b = eVar;
            super(object2);
        }
        ...
        protected void afterChange(l<?> property, List<? extends TrickItem> oldValue, List<? extends TrickItem> newValue) {
            ...
            this.b.autoNotify(this.b, oldValue, newValue, app.dogo.com.dogo_android.dailyworkout.overview.e.d.a);
        }
    }
    ...
    static {
        l[] arr = new l[1];
        DailyWorkoutOverviewAdapter.b = new l[] { c0.f(new t(c0.b(DailyWorkoutOverviewAdapter.class), "tricks", "getTricks()Ljava/util/List;")) };
    }

    public e() {
        super();
        List list = p.g();
        final app.dogo.com.dogo_android.f.k.e.c delegates_observable_1 = new Delegates_observable_1(list, list, this);
    }
    ...
    public final List<TrickItem> getItemCount() {
        return (List)this.a.getValue(this, DailyWorkoutOverviewAdapter.b[0]);
    }
    ...
    public void onBindViewHolder(e.a holder, int position) {
        n.f(holder, "holder");
        z = holder instanceof DailyWorkoutOverviewAdapter_TrickItemViewHolder;
        if (holder instanceof DailyWorkoutOverviewAdapter_TrickItemViewHolder) {
            (DailyWorkoutOverviewAdapter_TrickItemViewHolder)holder.b().V((TrickItem)getItemCount().get(position));
        }
        holder.a().p();
    }
    ...
    public e.a onCreateViewHolder(ViewGroup parent, int viewType) {
        n.f(parent, "parent");
        final c8 c8Var = c8.T(LayoutInflater.from(parent.getContext()), parent, false);
        n.e(c8Var, "inflate(inflater, parent, false)");
        return new DailyWorkoutOverviewAdapter_TrickItemViewHolder(this, c8Var);
    }

    @Override // androidx.recyclerview.widget.RecyclerView$h
    public final void i(List<TrickItem> list) {
        n.f(list, "<set-?>");
        this.a.setValue(this, DailyWorkoutOverviewAdapter.b[0], list);
    }
}
