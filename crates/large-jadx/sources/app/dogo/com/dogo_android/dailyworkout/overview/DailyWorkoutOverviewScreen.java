...
/* compiled from: DailyWorkoutOverviewScreen.kt */
...
public final class DailyWorkoutOverviewScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<g> {
        public final g a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new DailyWorkoutOverviewScreen(parcel.readString());
        }
    ...
    protected Fragment createFragment() {
        return new DailyWorkoutOverviewFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        return S.programOverviewScreen.withoutParameters();
    }
