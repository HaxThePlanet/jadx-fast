...
public final class k0 extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.i.k0> CREATOR;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.i.k0> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.i.k0 a(Parcel parcel) {
            n.f(parcel, "parcel");
            parcel.readInt();
            k0 obj2 = new k0();
            return obj2;
        ...
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.i.k0[] b(int i) {
            return new k0[i];
        }
