...
public final class a0 extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.login_v2.a0> CREATOR;
    private final String a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.login_v2.a0> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.login_v2.a0 a(Parcel parcel) {
            n.f(parcel, "parcel");
            a0 a0Var = new a0(parcel.readString());
            return a0Var;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.login_v2.a0[] b(int i) {
            return new a0[i];
        }
