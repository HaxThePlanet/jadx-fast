...
/* compiled from: SimpleVimeoVideo.kt */
...
public final class SimpleVimeoVideo {
    ...
    private final List<SimpleVimeoVideo.VideoFile> files;
    private final SimpleVimeoVideo.PictureFiles pictures;
    ...
    public static final class PictureFiles {
        ...
        private ArrayList<SimpleVimeoVideo.PictureFiles.PictureFile> sizes;
        public final String getLink() {
            return this.link;
        }

        public final ArrayList<SimpleVimeoVideo.PictureFiles.PictureFile> getSizes() {
            return this.sizes;
        }

        public final void setSizes(ArrayList<SimpleVimeoVideo.PictureFiles.PictureFile> arrayList) {
    ...
    public final List<SimpleVimeoVideo.VideoFile> getFiles() {
        return this.files;
    }

    public final SimpleVimeoVideo.PictureFiles getPictures() {
