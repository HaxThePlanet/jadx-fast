...
public final class g extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.y.a0.g> CREATOR;
    ...
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.y.a0.g> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.y.a0.g a(Parcel parcel) {
            int i;
        ...
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.y.a0.g[] b(int i) {
            return new g[i];
        }
    ...
    public g(ProgramQuestion programQuestion, ProgramSaveInfo programSaveInfo2, String string3, boolean z4, TrainingSession trainingSession5) {
    ...
    public g(ProgramQuestion programQuestion, ProgramSaveInfo programSaveInfo2, String string3, boolean z4, TrainingSession trainingSession5, int i6, g g7) {
        int obj10;
        int obj11;
    ...
    public i3 createTrackingParameters() {
        f2 f2Var = new f2();
        return j3.X.b(f2Var, this.a.getQuestionId());
    }
