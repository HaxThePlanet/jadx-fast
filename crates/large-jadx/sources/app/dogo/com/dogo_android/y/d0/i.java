...
public final class i extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.y.d0.i> CREATOR;
    private final String a;
    private final String b;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.y.d0.i> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.y.d0.i a(Parcel parcel) {
            n.f(parcel, "parcel");
        ...
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.y.d0.i[] b(int i) {
            return new i[i];
        }
