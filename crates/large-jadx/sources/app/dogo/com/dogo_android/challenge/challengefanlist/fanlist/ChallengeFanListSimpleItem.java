...
/* compiled from: ChallengeFanListSimpleItem.kt */
...
public final class ChallengeFanListSimpleItem extends a<f.a> {

    /* renamed from: Companion, reason: from kotlin metadata */
    public static final f.b INSTANCE = new f$b(0);
    ...
    @Override // h.a.b.h.a
    public void e(h.a.b.b<f<?>> bVar, f.a aVar, int i, List<? extends Object> list) {
        n.f(aVar, "holder");
        n.f(list, "payloads");
        aVar.setModel(this.model);
    }

    @Override // h.a.b.h.a
    /* operator */ public boolean equals(Object other) {
        if (other instanceof ChallengeFanListSimpleItem) {
    ...
    @Override // h.a.b.h.a
    public f.a f(View view, h.a.b.b<f<?>> bVar) {
        n.f(view, "view");
        return new ChallengeFanListSimpleItem_ChallengeFanSimpleViewHolder(this, view, bVar);
    }
    ...
    public int getLayoutRes() {
        return R.layout.cell_challenge_fan_item;
    }
}
