...
public final class d extends e {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.d.e.d> CREATOR;
    private final ChallengeReportInfo a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.d.e.d> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.d.e.d a(Parcel parcel) {
            n.f(parcel, "parcel");
            d dVar = new d((ChallengeReportInfo)ChallengeReportInfo.CREATOR.createFromParcel(parcel));
            return dVar;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.d.e.d[] b(int i) {
            return new d[i];
        }
    ...
    public final ChallengeReportInfo a() {
        return this.a;
    }
