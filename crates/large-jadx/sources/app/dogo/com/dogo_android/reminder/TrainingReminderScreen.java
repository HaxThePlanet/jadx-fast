...
/* compiled from: TrainingReminderScreen.kt */
...
public final class TrainingReminderScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<k> {
        public final k a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new TrainingReminderScreen(parcel.readString(), parcel.readString());
        }
    ...
    protected Fragment createFragment() {
        return new TrainingReminderFragment();
    }
    ...
    public /* synthetic */ k(String str, String str2, int i, g gVar) {
        String str3;
        str3 = i & 2 != 0 ? "" : str3;
        this(str, str3);
    }
