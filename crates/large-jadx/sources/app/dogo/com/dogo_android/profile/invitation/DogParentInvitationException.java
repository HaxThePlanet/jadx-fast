...
/* compiled from: DogParentInvitationException.kt */
...
public abstract /* sealed */ class DogParentInvitationException extends Exception {
    ...
    public static final class DogIsAlreadyAdded extends DogParentInvitationException {
    ...
    public static final class DogIsDeleted extends DogParentInvitationException {
        public DogIsDeleted() {
            super(null);
        }
    }
    ...
    public static final class InvitationDoesNotExist extends DogParentInvitationException {
    ...
    public static final class InvitationHasExpired extends DogParentInvitationException {
        public InvitationHasExpired() {
            super(null);
        }
    }
    private DogParentInvitationException() {
        super();
    }

    public /* synthetic */ DogParentInvitationException(g gVar) {
        this();
    }
}
