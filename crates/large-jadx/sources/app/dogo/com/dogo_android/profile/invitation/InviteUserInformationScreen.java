...
/* compiled from: InviteUserInformationScreen.kt */
...
public final class InviteUserInformationScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<k> {
        public final k a(Parcel parcel) {
            n.f(parcel, "parcel");
            parcel.readInt();
            return new InviteUserInformationScreen();
        }
    ...
    protected Fragment createFragment() {
        return new InviteUserInformationFragment();
    }
