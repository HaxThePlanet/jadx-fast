...
public final class i0 implements DialogInterface.OnClickListener {
    ...
    public final e w;
    public i0(FirebaseInAppMessagingDisplayCallbacks firebaseInAppMessagingDisplayCallbacks, Action action2, String string3, String string4, e e5) {
        super();
    ...
    public final void onClick(DialogInterface dialogInterface, int i2) {
        g1.B(this.a, this.b, this.c, this.v, this.w, dialogInterface, i2);
    }
}
