...
/* compiled from: DogLogTypeSelectorItemDecoration.kt */
...
public final class DogLogTypeSelectorItemDecoration extends RecyclerView.o {

    /* renamed from: a, reason: from kotlin metadata */
    private final float sidePaddingPixels;
    public j(Context context) throws android.content.res.Resources.NotFoundException {
        n.f(context, "context");
        super();
        this.sidePaddingPixels = context.getResources().getDimension(2131165623);
    }
