...
public final class b implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ b(Activity activity, ZendeskConfigurationInfo zendeskConfigurationInfo) {
        super();
        this.a = activity;
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        app.dogo.com.dogo_android.util.extensionfunction.f1.e(this.a, this.b, dialogInterface, i);
    }
}
