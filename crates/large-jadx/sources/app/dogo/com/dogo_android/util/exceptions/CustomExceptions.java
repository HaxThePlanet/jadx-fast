...
public abstract /* sealed */ class CustomExceptions extends Exception {
    ...
    public static final class DataNotFound extends CustomExceptions {
    ...
    public /* synthetic */ CustomExceptions(String str, g gVar) {
        this(str);
    }
}
