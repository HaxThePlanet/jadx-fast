...
public final class k implements DialogInterface.OnClickListener {
    ...
    public /* synthetic */ k(Activity activity, ZendeskConfigurationInfo zendeskConfigurationInfo) {
        super();
        this.a = activity;
    ...
    public final void onClick(DialogInterface dialogInterface, int i) {
        app.dogo.com.dogo_android.util.extensionfunction.f1.d(this.a, this.b, dialogInterface, i);
    }
}
