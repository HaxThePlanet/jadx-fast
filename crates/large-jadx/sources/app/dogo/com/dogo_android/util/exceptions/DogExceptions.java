...
/* compiled from: DogExceptions.kt */
...
public abstract /* sealed */ class DogExceptions extends Exception {
    ...
    public static final class NameIsTooLong extends DogExceptions {
    ...
    public static final class NameIsTooShort extends DogExceptions {
        public NameIsTooShort() {
            super(null);
        }
    }
    private DogExceptions() {
        super();
    }

    public /* synthetic */ DogExceptions(g gVar) {
        this();
    }
}
