...
/* compiled from: ReminderIntervalScreen.kt */
...
public final class ReminderIntervalScreen extends e {
    ...
    public static final class a implements Parcelable.Creator<o> {
        public final o a(Parcel parcel) {
            ...
            return new ReminderIntervalScreen(arrayList);
        }
    ...
    /* renamed from: a, reason: from kotlin metadata */
    public final List<Long> createFragment() {
        return this.list;
    }

    @Override // app.dogo.com.dogo_android.util.e
    protected Fragment createFragment() {
        return new ReminderIntervalDialog();
    }

    @Override // app.dogo.com.dogo_android.util.e
    public i3 createTrackingParameters() {
        return S.clicker.withoutParameters();
    }
