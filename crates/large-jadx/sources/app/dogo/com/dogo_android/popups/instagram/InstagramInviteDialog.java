...
/* compiled from: InstagramInviteDialog.kt */
...
public final class InstagramInviteDialog extends u {
    ...
    public static final class a extends p implements kotlin.d0.c.a<d> {
        ...
        public final d invoke() {
            return b.a(this.$this_viewModel, this.$qualifier, c0.b(InstagramInviteViewModel.class), this.$parameters);
        }
    ...
    public c() {
        ...
        this.x = j.a(LazyThreadSafetyMode.SYNCHRONIZED, new app.dogo.com.dogo_android.popups.instagram.c.a(this, aVar2, aVar2));
    }

    /* renamed from: X1, reason: from kotlin metadata */
    private final d openInstagram() {
        return (InstagramInviteViewModel)this.x.getValue();
    }
    ...
    private static final void b2(c cVar, View view) {
        n.f(cVar, "this$0");
        cVar.openInstagram().k();
        cVar.d2();
        cVar.dismiss();
    }

    /* renamed from: c2, reason: from kotlin metadata */
    private final void openAppStore(String packageName) {
        try {
            startActivity(new Intent("android.intent.action.VIEW", Uri.parse(n.o("market://details?id=", packageName))));
        } catch (android.content.ActivityNotFoundException unused) {
            packageName = n.o("http://play.google.com/store/apps/details?id=", packageName);
            packageName = Uri.parse(packageName);
            startActivity(new Intent(r0, packageName));
        }
    }

    @Override // app.dogo.com.dogo_android.util.e0.u
    public c E1() {
        return DialogTags.INSTAGRAM_INVITE_DIALOG;
    }

    @Override // app.dogo.com.dogo_android.util.e0.u
    public k3 H1() {
        return S.challengeFilters;
    }
    ...
    public final void d2() {
        ...
        if (packageManager != null) {
            try {
                launchIntentForPackage = packageManager.getLaunchIntentForPackage(openInstagram().i());
                if (launchIntentForPackage != null) {
                    startActivity(new Intent("android.intent.action.VIEW", Uri.parse(openInstagram().instagramFollowVideo())));
                } else {
                    openAppStore(openInstagram().i());
                }
            } catch (android.content.ActivityNotFoundException unused) {
                return;
            }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        e9 e9Var = e9.T(inflater, container, false);
        n.e(e9Var, "inflate(inflater, container, false)");
        this.binding = e9Var;
        int i2 = 0;
        String str3 = "binding";
        if (e9Var == null) {
    ...
    public void onViewCreated(View view, Bundle bundle) throws b {
        ...
        if (this.binding == null) {
            ...
            binding2.O.setOnClickListener(new app.dogo.com.dogo_android.popups.instagram.a(this));
            if (this.binding == null) {
                n.w(str2);
                /* Dexterity WARN: Type inference failed for thrown value */
                throw (Throwable) i;
            } else {
                binding22.P.setOnClickListener(new app.dogo.com.dogo_android.popups.instagram.b(this));
                return;
            }
        }
    }
    ...
    public static /* synthetic */ void onViewCreated(c view, View savedInstanceState) {
        InstagramInviteDialog.a2(view, savedInstanceState);
    }

    public static /* synthetic */ void Z1(c cVar, View view) {
        InstagramInviteDialog.b2(cVar, view);
    }
