...
public final class m extends Fragment {
    ...
    public static final app.dogo.com.dogo_android.r.m.a Companion;
    private ch a;
    private final h b;
    ...
    public static final class a {
        ...
        public final void a(List<CompoundButton> list, LinearLayout linearLayout2) {
            int empty;
            int childCount;
            int i;
            View childAt;
            String str;
            n.f(list, "mutableList");
            n.f(linearLayout2, "linearLayout");
            empty = 0;
    ...
    public static final class b extends p implements a<app.dogo.com.dogo_android.r.l> {
    ...
    public static void C1(app.dogo.com.dogo_android.r.m m, Boolean boolean2) {
        m.I1(m, boolean2);
    }

    public static void D1(app.dogo.com.dogo_android.r.m m, View view2) {
        m.H1(m, view2);
    }

    public static void E1(app.dogo.com.dogo_android.r.m m, y y2) {
        m.J1(m, y2);
    }

    public static void F1(app.dogo.com.dogo_android.r.m m, Boolean boolean2) {
        m.K1(m, boolean2);
    }

    public static void G1(app.dogo.com.dogo_android.r.m m, View view2) {
        m.L1(m, view2);
    }

    private static final void H1(app.dogo.com.dogo_android.r.m m, View view2) {
        n.f(m, "this$0");
    ...
    private static final void I1(app.dogo.com.dogo_android.r.m m, Boolean boolean2) {
        n.f(m, "this$0");
        final androidx.fragment.app.e obj0 = m.getActivity();
        if (obj0 == null) {
        } else {
    ...
    private static final void J1(app.dogo.com.dogo_android.r.m m, y y2) {
        n.f(m, "this$0");
        ch obj1 = m.a;
        if (obj1 == null) {
        } else {
    ...
    private static final void K1(app.dogo.com.dogo_android.r.m m, Boolean boolean2) {
        Object obj1;
        boolean obj2;
        n.f(m, "this$0");
        n.e(boolean2, "it");
    ...
    private static final void L1(app.dogo.com.dogo_android.r.m m, View view2) {
        Object obj0;
        boolean obj1;
        n.f(m, "this$0");
        if (m.B1().m()) {
    ...
    public void onViewCreated(View view, Bundle bundle2) {
        ...
        if (chVar == null) {
            ...
            LinearLayout linearLayout = chVar.O;
            ...
            if (obj5 == null) {
                ...
                e eVar = new e(this);
                B1().r().observe(obj6, eVar);
                g gVar = new g(this);
                B1().u().observe(getViewLifecycleOwner(), gVar);
                h hVar = new h(this);
                B1().v().observe(getViewLifecycleOwner(), hVar);
                obj5 = this.a;
                if (obj5 == null) {
                } else {
                    obj6 = new i(this);
