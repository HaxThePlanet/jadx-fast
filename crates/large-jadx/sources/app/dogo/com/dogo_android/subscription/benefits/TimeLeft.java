...
public final class TimeLeft extends a0<Long> {
    ...
    public static final class TimerDisposable extends AtomicReference<b> implements b, Runnable {
        ...
        public static final TimeLeft.TimerDisposable.Companion INSTANCE = null;
        private static final long serialVersionUID = 8465401857522493082L;
        private final d0<? super Long> downstream;
        private final long durationInSeconds;
        public TimerDisposable(d0<? super Long> d0Var, long j) {
            n.f(d0Var, "downstream");
            super();
        ...
        @Override // java.util.concurrent.atomic.AtomicReference
        public final void setFuture(b d) {
            c.replace(this, d);
        }

        static {
            TimeLeft_TimerDisposable.INSTANCE = new TimeLeft_TimerDisposable_Companion(null);
        }
    }
    public TimeLeft(long j, TimeUnit timeUnit, z zVar, long j2) {
        n.f(timeUnit, "unit");
        n.f(zVar, "scheduler");
        super();
        this.delay = j;
    ...
    @Override // i.b.a0
    protected void subscribeActual(d0<? super Long> observer) {
        n.f(observer, "observer");
        app.dogo.com.dogo_android.subscription.benefits.TimeLeft.TimerDisposable timeLeft_TimerDisposable = new TimeLeft_TimerDisposable(observer, this.durationInSeconds, timeUnit);
        observer.onSubscribe(timeLeft_TimerDisposable);
        timeLeft_TimerDisposable.setFuture(this.scheduler.d(timeLeft_TimerDisposable, this.delay, this.unit));
    }
}
