...
public final class RxJavaDogo {
    ...
    public static final RxJavaDogo INSTANCE = new RxJavaDogo();
    private RxJavaDogo() {
        super();
    }

    public final a0<Long> timerWithStart(long absoluteSecondsLeft) {
        final i.b.z zVar = a.a();
        n.e(zVar, "computation()");
        TimeLeft timeLeft = new TimeLeft(1L, timeUnit, TimeUnit.SECONDS, zVar, absoluteSecondsLeft, obj2);
        return timeLeft;
    }
