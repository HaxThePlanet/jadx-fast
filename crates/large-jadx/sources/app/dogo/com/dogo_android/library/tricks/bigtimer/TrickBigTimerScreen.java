...
/* compiled from: TrickBigTimerScreen.kt */
...
public class TrickBigTimerScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<h> {
        public final h a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new TrickBigTimerScreen((TrickDetailsPlan)parcel.readParcelable(TrickBigTimerScreen.class.getClassLoader()), parcel.readString(), parcel.readString(), parcel.readString());
        }
    ...
    public h(app.dogo.com.dogo_android.n.m.n nVar, String str, String str2, String str3) {
        n.f(nVar, "session");
    ...
    public app.dogo.com.dogo_android.n.m.n createFragment() {
        return this.a;
    }

    @Override // app.dogo.com.dogo_android.y.j
    protected Fragment createFragment() {
        return new TrickBigTimerFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        String str = null;
        TrickItem trickItem = createFragment().a();
        if (trickItem == null) {
            int i = 0;
        } else {
            str = trickItem.getId();
