...
public final class k extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.u.n.q.k> CREATOR;
    private final PottyRemindersItem a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.u.n.q.k> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.n.q.k a(Parcel parcel) {
            int cREATOR;
            int obj3;
            n.f(parcel, "parcel");
            if (parcel.readInt() == 0) {
                ...
                obj3 = PottyRemindersItem.CREATOR.createFromParcel(parcel);
            }
            k kVar = new k((PottyRemindersItem)obj3);
            return kVar;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.n.q.k[] b(int i) {
            return new k[i];
        }
    ...
    public k(PottyRemindersItem pottyRemindersItem, int i2, g g3) {
        int obj1;
        obj1 = i2 &= 1 != 0 ? 0 : obj1;
        super(obj1);
    }
    ...
    public final PottyRemindersItem a() {
        return this.a;
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        if (pottyRemindersItem == null) {
            ...
            parcel.writeInt(1);
            pottyRemindersItem.writeToParcel(parcel, i2);
        }
    }
}
