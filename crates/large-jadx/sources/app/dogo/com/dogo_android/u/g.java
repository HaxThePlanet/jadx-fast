...
public final class g extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.u.g> CREATOR;
    private final String a;
    private final String b;
    private final String c;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.u.g> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.g a(Parcel parcel) {
            n.f(parcel, "parcel");
            g gVar = new g(parcel.readString(), parcel.readString(), parcel.readString());
            return gVar;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.g[] b(int i) {
            return new g[i];
        }
    ...
    public i3 createTrackingParameters() {
        e2 e2Var = new e2();
        r2 r2Var = new r2();
        return j3.e1.b(e2Var, this.b, r2Var, this.c);
    }
