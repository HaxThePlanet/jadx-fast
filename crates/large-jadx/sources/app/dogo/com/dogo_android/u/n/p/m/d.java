...
public final class d extends e {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.u.n.p.m.d> CREATOR;
    private final List<DogLog> a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.u.n.p.m.d> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.n.p.m.d a(Parcel parcel) {
            int i;
            Object fromParcel;
            n.f(parcel, "parcel");
            ...
            d obj5 = new d(arrayList);
            return obj5;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.n.p.m.d[] b(int i) {
            return new d[i];
        }
