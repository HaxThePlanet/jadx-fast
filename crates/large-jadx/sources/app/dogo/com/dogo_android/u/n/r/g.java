...
public final class g extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.u.n.r.g> CREATOR;
    private final String a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.u.n.r.g> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.n.r.g a(Parcel parcel) {
            n.f(parcel, "parcel");
        ...
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.u.n.r.g[] b(int i) {
            return new g[i];
        }
