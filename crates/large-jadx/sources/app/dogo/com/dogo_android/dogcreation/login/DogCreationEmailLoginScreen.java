...
/* compiled from: DogCreationEmailLoginScreen.kt */
...
public final class DogCreationEmailLoginScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<j> {
        public final j a(Parcel parcel) {
            n.f(parcel, "parcel");
            parcel.readInt();
            return new DogCreationEmailLoginScreen();
        }
    ...
    protected Fragment createFragment() {
        return new DogCreationEmailLoginFragment();
    }
