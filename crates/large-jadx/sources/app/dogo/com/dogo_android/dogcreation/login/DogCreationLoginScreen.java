...
/* compiled from: DogCreationLoginScreen.kt */
...
public final class DogCreationLoginScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<n> {
        public final n a(Parcel parcel) {
            n.f(parcel, "parcel");
            parcel.readInt();
            return new DogCreationLoginScreen();
        }
    ...
    protected Fragment createFragment() {
        return new DogCreationLoginFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        return S.dogCreationPicture.b(new EP_ViewSource(), "dog_profile");
    }
