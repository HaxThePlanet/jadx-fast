...
public final class j extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.g.g0.j> CREATOR;
    private final String a;
    private final String b;
    private final String c;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.g.g0.j> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.g.g0.j a(Parcel parcel) {
            n.f(parcel, "parcel");
        ...
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.g.g0.j[] b(int i) {
            return new j[i];
        }
    ...
    public i3 createTrackingParameters() {
        r2 r2Var = new r2();
        return j3.J0.b(r2Var, "dashboard");
    }
