...
public final class q extends e {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.view.q> CREATOR;
    private final String a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.view.q> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.view.q a(Parcel parcel) {
            n.f(parcel, "parcel");
            q qVar = new q(parcel.readString());
            return qVar;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.view.q[] b(int i) {
            return new q[i];
        }
    ...
    public i3 createTrackingParameters() {
        r2 r2Var = new r2();
        return j3.A0.c(u.a(r2Var, this.a));
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("SharePromptScreen(source=");
