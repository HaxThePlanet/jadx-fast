...
/* compiled from: RatePromptV2Screen.kt */
...
public final /* data */ class RatePromptV2Screen extends e {
    ...
    public static final class a implements Parcelable.Creator<n> {
        public final n a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new RatePromptV2Screen(parcel.readString());
        }
    ...
    protected Fragment createFragment() {
        return new RatePromptDialogV2();
    }

    @Override // app.dogo.com.dogo_android.util.e
    public i3 createTrackingParameters() {
        return S.trickDetails.withoutParameters();
    }
    ...
    /* operator */ public boolean equals(Object other) {
        ...
        if (!(other instanceof RatePromptV2Screen)) {
            return false;
        }
    ...
    public String toString() {
        ...
        String str2 = "RatePromptV2Screen(source=";
