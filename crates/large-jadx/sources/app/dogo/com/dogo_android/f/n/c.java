...
public final class c extends Fragment {
    ...
    public static final class a extends p implements a<app.dogo.com.dogo_android.f.n.e> {
        ...
        public final app.dogo.com.dogo_android.f.n.e invoke() {
    ...
    static final class b extends p implements a<a> {
        ...
        final app.dogo.com.dogo_android.f.n.c this$0;
        b(app.dogo.com.dogo_android.f.n.c c) {
            this.this$0 = c;
            super(0);
        }
    ...
    public static final app.dogo.com.dogo_android.f.n.d B1(app.dogo.com.dogo_android.f.n.c c) {
        return c.C1();
    }

    private final app.dogo.com.dogo_android.f.n.d C1() {
        return (d)k1.a(this);
    }

    private final app.dogo.com.dogo_android.f.n.e D1() {
        return (e)this.b.getValue();
    }

    public static void E1(app.dogo.com.dogo_android.f.n.c c, Boolean boolean2) {
        c.G1(c, boolean2);
    }

    public static void F1(app.dogo.com.dogo_android.f.n.c c, Boolean boolean2) {
        c.H1(c, boolean2);
    }

    private static final void G1(app.dogo.com.dogo_android.f.n.c c, Boolean boolean2) {
        n.f(c, "this$0");
        ...
        g gVar = new g(c.C1().getFragmentReturnTag());
        g1.n(c.getActivity(), gVar);
    }

    private static final void H1(app.dogo.com.dogo_android.f.n.c c, Boolean boolean2) {
        n.f(c, "this$0");
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup2, Bundle bundle3) {
        ...
        sa obj2 = sa.T(layoutInflater, viewGroup2, false);
    ...
    public void onViewCreated(View view, Bundle bundle2) {
        ...
        n.e(obj4, str2);
        a aVar = new a(this);
        D1().h().observe(obj4, aVar);
        obj4 = getViewLifecycleOwner();
        n.e(obj4, str2);
        b bVar = new b(this);
        D1().i().observe(obj4, bVar);
    }
}
