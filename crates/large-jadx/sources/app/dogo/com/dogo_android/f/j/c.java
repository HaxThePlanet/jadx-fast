...
public final class c extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.f.j.c> CREATOR;
    private final String a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.f.j.c> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.f.j.c a(Parcel parcel) {
            n.f(parcel, "parcel");
        ...
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.f.j.c[] b(int i) {
            return new c[i];
        }
    ...
    public i3 createTrackingParameters() {
        r2 r2Var = new r2();
        return j3.q0.c(u.a(r2Var, this.a));
    }
