...
public final class b extends Fragment {
    ...
    public static final class a extends p implements a<app.dogo.com.dogo_android.f.o.d> {
        ...
        public final app.dogo.com.dogo_android.f.o.d invoke() {
    ...
    public b() {
        super();
        final int i = 0;
        b.a aVar = new b.a(this, i, i);
        this.a = j.a(m.SYNCHRONIZED, aVar);
    }

    private final app.dogo.com.dogo_android.f.o.c B1() {
        return (c)k1.a(this);
    }

    private final app.dogo.com.dogo_android.f.o.d C1() {
        return (d)this.a.getValue();
    }

    public static void D1(app.dogo.com.dogo_android.f.o.b b, View view2) {
        b.E1(b, view2);
    }

    private static final void E1(app.dogo.com.dogo_android.f.o.b b, View view2) {
        n.f(b, "this$0");
        b.C1().i();
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup2, Bundle bundle3) {
        ...
        kh obj2 = kh.T(getLayoutInflater(), viewGroup2, false);
