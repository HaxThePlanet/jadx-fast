...
/* compiled from: LayoutSpecialProgramExerciseBindingImpl.java */
...
public class tm extends sm {
    ...
    public tm(e eVar, View view) {
        this(eVar, view, ViewDataBinding.D(eVar, view, 3, tm.T, tm.U));
    }
    ...
    protected void m() {
        ...
        if (l2 != l3 && this.O != null) {
            exercise = this.O.getExercise();
        }
        if (l2 != l3) {
            ProgramBindingAdapters.configureBinding(this.R, exercise, this.P);
        }
    }
    ...
    private tm(e eVar, View view, Object[] objectArr) {
        final int i2 = 0;
