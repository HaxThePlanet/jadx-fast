...
public class tl extends app.dogo.com.dogo_android.h.sl {
    ...
    public tl(e e, View view2) {
        super(e, view2, ViewDataBinding.D(e, view2, 3, tl.T, tl.U));
    }

    private tl(e e, View view2, Object[] object3Arr3) {
        final int i3 = 0;
    ...
    protected void m() {
        ...
        try {
            ...
            articlesWithProgress = specialProgramOverviewItem.getArticlesWithProgress();
            if (cmp != 0) {
            }
            l.v0(this.R, articlesWithProgress, this.P);
            throw th;
        }
    }
