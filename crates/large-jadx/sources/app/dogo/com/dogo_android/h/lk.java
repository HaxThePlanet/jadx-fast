...
public class lk extends app.dogo.com.dogo_android.h.kk {
    ...
    static {
        ...
        int[] iArr = new int[i3];
        iArr = new int[]{2131558774, 2131558774, 2131558774, 2131558774};
        gVar.a(0, /* result */, iArr2, iArr);
        int i = 0;
    }

    public lk(e e, View view2) {
        super(e, view2, ViewDataBinding.D(e, view2, 5, lk.V, lk.W));
    }

    private lk(e e, View view2, Object[] object3Arr3) {
        super(e, view2, 4, (mk)object3Arr3[1], (mk)object3Arr3[2], (mk)object3Arr3[3], (mk)object3Arr3[4]);
        this.U = -1;
        L(this.O);
        L(this.P);
    ...
    private boolean U(app.dogo.com.dogo_android.h.mk mk, int i2) {
        if (i2 == 0) {
            this.U = obj3 |= i;
            return 1;
            synchronized (this) {
    ...
    private boolean V(app.dogo.com.dogo_android.h.mk mk, int i2) {
        if (i2 == 0) {
            this.U = obj3 |= i;
            return 1;
            synchronized (this) {
    ...
    private boolean W(app.dogo.com.dogo_android.h.mk mk, int i2) {
        if (i2 == 0) {
            this.U = obj3 |= i;
            return 1;
            synchronized (this) {
    ...
    private boolean X(app.dogo.com.dogo_android.h.mk mk, int i2) {
        if (i2 == 0) {
            this.U = obj3 |= i;
            return 1;
            synchronized (this) {
        ...
        if (i != 0 && i != 1 && i != 2 && i != 3) {
            if (i != 1) {
                if (i != 2) {
                    ...
                    return V((mk)object2, i3);
                }
                return X((mk)object2, i3);
            }
            return U((mk)object2, i3);
        }
        return W((mk)object2, i3);
    }
