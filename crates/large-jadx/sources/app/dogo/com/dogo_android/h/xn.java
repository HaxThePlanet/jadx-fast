...
/* compiled from: TooltipWorkoutClickerBindingImpl.java */
...
public class xn extends wn {
    ...
    static {
        ...
        obj.put(2131362096, 3);
    }

    public xn(e eVar, View view) {
        this(eVar, view, ViewDataBinding.D(eVar, view, 4, xn.S, xn.T));
    }
    ...
    private xn(e eVar, View view, Object[] objectArr) {
