...
public class r3 extends app.dogo.com.dogo_android.h.q3 {
    ...
    public r3(e e, View view2) {
        super(e, view2, ViewDataBinding.D(e, view2, 3, r3.T, r3.U));
    }

    private r3(e e, View view2, Object[] object3Arr3) {
    ...
    public boolean O(int i, Object object2) {
        int obj2;
        if (94 == i) {
            V((PermissionDescription)object2);
            obj2 = 1;
        } else {
            obj2 = 0;
        }
    ...
    protected void m() {
        ...
        int i4 = 0;
        this.S = i4;
        final PermissionDescription permissionDescription = this.Q;
        cmp = Long.compare(i3, i4);
        synchronized (this) {
            i4 = 0;
            this.S = i4;
            permissionDescription = this.Q;
            cmp = Long.compare(i3, i4);
        }
        try {
