...
/* compiled from: ProgramQuestionCorrectAnswerViewModel.kt */
...
public final class ProgramQuestionCorrectAnswerViewModel extends s {

    /* renamed from: a, reason: from kotlin metadata */
    private final ProgramQuestion programQuestion;
    private final o3 b;
    public e(ProgramQuestion programQuestion, ProgramSaveInfo programSaveInfo, o3 o3Var) {
    ...
    public final String getCorrectAnswer() {
        return (String)this.programQuestion.getAnswers().get(this.programQuestion.getCorrectAnswer());
    }
    ...
    @Override // app.dogo.com.dogo_android.util.e0.s
    public final void j() {
        this.b.logEvent(E_TrainingProgram.i.c(new EP_QuestionId(), this.programQuestion.getQuestionId()));
    }
}
