...
/* compiled from: ProgramTrickTryViewModel.kt */
...
public final class ProgramTrickTryViewModel extends s {
    ...
    public e(TrickItem trickItem, ProgramSaveInfo programSaveInfo, o3 o3Var) {
        n.f(trickItem, "trick");
    ...
    public final TrickItem trackLetsTryButtonTap() {
        return this.a;
    }

    @Override // app.dogo.com.dogo_android.util.e0.s
    public final void i() {
        this.b.logEvent(E_TrainingProgram.B.withParameters(u.a(new EP_TrickId(), this.a.getId()), u.a(new EP_Type(), "try")));
    }

    @Override // app.dogo.com.dogo_android.util.e0.s
    public final void j() {
        this.b.logEvent(E_TrainingProgram.B.withParameters(u.a(new EP_TrickId(), this.a.getId()), u.a(new EP_Type(), "no")));
    }
