...
/* compiled from: ProgramQuestionCorrectAnswerScreen.kt */
...
public final class ProgramQuestionCorrectAnswerScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<d> {
        public final d a(Parcel parcel) {
            ...
            ProgramQuestionCorrectAnswerScreen programQuestionCorrectAnswerScreen = new ProgramQuestionCorrectAnswerScreen((ProgramQuestion)ProgramQuestion.CREATOR.createFromParcel(parcel), (ProgramSaveInfo)ProgramSaveInfo.CREATOR.createFromParcel(parcel), parcel.readString(), (parcel.readInt() != 0 ? 1 : 0), (TrainingSession)fromParcel);
            return programQuestionCorrectAnswerScreen;
        }
    ...
    public d(ProgramQuestion programQuestion, ProgramSaveInfo programSaveInfo, String str, boolean z, TrainingSession trainingSession) {
    ...
    protected Fragment createFragment() {
        return new ProgramQuestionCorrectAnswerFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        return S.examExplanation.withoutParameters();
    }
    ...
    public /* synthetic */ d(ProgramQuestion programQuestion, ProgramSaveInfo programSaveInfo, String str, boolean z, TrainingSession trainingSession, int i, g gVar) {
        int i2 = 0;
        i = i & 8 != 0 ? 0 : i;
        i2 = i & 16 != 0 ? 0 : i2;
