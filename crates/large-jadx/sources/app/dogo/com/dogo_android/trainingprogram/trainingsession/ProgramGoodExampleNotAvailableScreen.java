...
/* compiled from: ProgramGoodExampleNotAvailableScreen.kt */
...
public final class ProgramGoodExampleNotAvailableScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<i> {
        public final i a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new ProgramGoodExampleNotAvailableScreen(parcel.readString(), parcel.readString());
        }
    ...
    protected Fragment createFragment() {
        return new ProgramGoodExampleNotAvailableFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        return S.mobileInbox.b(new EP_TrickId(), this.fragmentReturnTag);
    }
