...
/* compiled from: ProgramExamsCompletedScreen.kt */
...
public final class ProgramExamsCompletedScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<d> {
        public final d a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new ProgramExamsCompletedScreen((ProgramExamSummary)ProgramExamSummary.CREATOR.createFromParcel(parcel), parcel.readString(), parcel.readString());
        }
    ...
    public d(ProgramExamSummary programExamSummary, String str, String str2) {
    ...
    protected Fragment createFragment() {
        return new ProgramExamsCompletedFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        return S.goodExampleNotAvailable.withoutParameters();
    }
