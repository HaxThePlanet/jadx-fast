...
/* compiled from: TrainingMetricsStreakCompletedFragment.kt */
...
public final class TrainingMetricsStreakCompletedFragment extends Fragment {
    ...
    public static final class b extends p implements kotlin.d0.c.a<d> {
        ...
        public final d invoke() {
            return b.a(this.$this_viewModel, this.$qualifier, c0.b(TrainingMetricsStreakCompletedViewModel.class), this.$parameters);
        }
    ...
    public b() {
        ...
        this.binding = j.a(LazyThreadSafetyMode.SYNCHRONIZED, new app.dogo.com.dogo_android.trainingmetrics.streakachieved.b.b(this, aVar, aVar));
    }
    ...
    private final c D1() {
        return (TrainingMetricsStreakCompletedScreen)app.dogo.com.dogo_android.util.extensionfunction.k1.a(this);
    }

    private final d E1() {
        return (TrainingMetricsStreakCompletedViewModel)this.binding.getValue();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ah ahVar = ah.T(getLayoutInflater(), container, false);
        n.e(ahVar, "inflate(layoutInflater, container, false)");
        this.b = ahVar;
        int i = 0;
        String str5 = "binding";
        if (ahVar == null) {
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        e.b(onBackPressedDispatcher, getViewLifecycleOwner(), false, new app.dogo.com.dogo_android.trainingmetrics.streakachieved.b.a(this), 2, null);
        if (this.b == null) {
            n.w("binding");
            /* Dexterity WARN: Type inference failed for thrown value */
            throw (Throwable) 0;
        } else {
            ahVar.O.setOnClickListener(new app.dogo.com.dogo_android.trainingmetrics.streakachieved.a(this));
            E1().saveTodayWorkoutCompletedShowedTime();
            return;
        }
    }
    ...
    public static /* synthetic */ void G1(b bVar, View view) {
        TrainingMetricsStreakCompletedFragment.H1(bVar, view);
    }
}
