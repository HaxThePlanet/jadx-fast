...
public final class t extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.q.p.t> CREATOR;
    private final DogProfile a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.q.p.t> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.q.p.t a(Parcel parcel) {
            n.f(parcel, "parcel");
            t tVar = new t((DogProfile)DogProfile.CREATOR.createFromParcel(parcel));
            return tVar;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.q.p.t[] b(int i) {
            return new t[i];
        }
