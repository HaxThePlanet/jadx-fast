...
public final class b0 extends s {
    ...
    public static final class b extends a implements CoroutineExceptionHandler {
        ...
        final app.dogo.com.dogo_android.q.p.b0 a;
        public b(CoroutineExceptionHandler.a coroutineExceptionHandler$a, app.dogo.com.dogo_android.q.p.b0 b02) {
            this.a = b02;
            super(a);
        }
    ...
    static final class a extends k implements p<m0, d<? super w>, Object> {
        ...
        int label;
        final app.dogo.com.dogo_android.q.p.b0 this$0;
        a(app.dogo.com.dogo_android.q.p.b0 b0, d<? super app.dogo.com.dogo_android.q.p.b0.a> d2) {
            this.this$0 = b0;
            super(2, d2);
        }

        public final Object c(m0 m0, d<? super w> d2) {
            return (b0.a)create(m0, d2).invokeSuspend(w.a);
        }

        public final d<w> create(Object object, d<?> d2) {
            b0.a obj2 = new b0.a(this.this$0, d2);
            return obj2;
        }
        ...
        public final Object invokeSuspend(Object object) {
            ...
            if (!b0.h(this.this$0).a()) {
                b0.k(this.this$0).s("dog_preview_gender");
                unknownHostException = new UnknownHostException();
                aVar = new y.a(unknownHostException);
                this.this$0.n().postValue(aVar);
            } else {
                if ((Integer)this.this$0.m().getValue() == null) {
                    value = b.c(i);
                }
                n.e(value, "pickerPosition.value ?: 0 + 1");
                this.label = i;
                if (b0.j(this.this$0).i(b0.i(this.this$0).getId(), d.Companion.b(value.intValue()), this) == obj) {
                    return obj;
                }
            }
        }
    }
    public b0(DogProfile dogProfile, g2 g22, h2 h23, o3 o34, j2 j25) {
        ...
        this.d = o34;
        this.e = j25;
        x obj3 = new x(Integer.valueOf(g.b(obj2--, 0)));
        this.f = obj3;
        x obj2 = new x();
        this.g = obj2;
        obj2 = new a();
        this.h = obj2;
        obj3 = new b0.b(CoroutineExceptionHandler.r, this);
        this.i = obj3;
    }

    public static final j2 h(app.dogo.com.dogo_android.q.p.b0 b0) {
        return b0.e;
    }

    public static final DogProfile i(app.dogo.com.dogo_android.q.p.b0 b0) {
        return b0.a;
    }

    public static final g2 j(app.dogo.com.dogo_android.q.p.b0 b0) {
        return b0.b;
    }

    public static final o3 k(app.dogo.com.dogo_android.q.p.b0 b0) {
        return b0.d;
    }
    ...
    public final void o() {
        final int i = 0;
        b0.a aVar = new b0.a(this, i);
        k.d(f0.a(this), this.i, i, aVar, 2, 0);
    }
}
