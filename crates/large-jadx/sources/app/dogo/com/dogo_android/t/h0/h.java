...
public final class h extends app.dogo.com.dogo_android.t.h0.n {

    private final d a;
    public h(d d) {
        n.f(d, "splitInstallSessionState");
        super(0);
        this.a = d;
    }
    ...
    public String toString() {
        ...
        stringBuilder.append("LanguageConfirmCommandItem(splitInstallSessionState=");
