...
public final class f extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.x.c.f> CREATOR;
    private final String a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.x.c.f> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.x.c.f a(Parcel parcel) {
            n.f(parcel, "parcel");
            f fVar = new f(parcel.readString());
            return fVar;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.x.c.f[] b(int i) {
            return new f[i];
        }
