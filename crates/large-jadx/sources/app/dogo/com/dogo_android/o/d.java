...
public final class d extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.o.d> CREATOR;
    private final String a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.o.d> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.o.d a(Parcel parcel) {
            n.f(parcel, "parcel");
        ...
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.o.d[] b(int i) {
            return new d[i];
        }
    ...
    public i3 createTrackingParameters() {
        r2 r2Var = new r2();
        return j3.m0.c(u.a(r2Var, this.a));
    }
