...
public final class j extends j {
    ...
    public static final Parcelable.Creator<app.dogo.com.dogo_android.exam.k.j> CREATOR;
    private final g a;

    @Metadata(k = 3, mv = {1, 5, 1}, xi = 48)
    public static final class a implements Parcelable.Creator<app.dogo.com.dogo_android.exam.k.j> {
        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.exam.k.j a(Parcel parcel) {
            n.f(parcel, "parcel");
            j jVar = new j((g)g.CREATOR.createFromParcel(parcel));
            return jVar;
        }

        @Override // android.os.Parcelable$Creator
        public final app.dogo.com.dogo_android.exam.k.j[] b(int i) {
            return new j[i];
        }
    ...
    public String toString() {
        ...
        stringBuilder.append("ExamRecordScreen(examUploadData=");
