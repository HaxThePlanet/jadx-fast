...
public class AppCompatCheckBox extends CheckBox implements l, t {
    ...
    public AppCompatCheckBox(Context context, AttributeSet attributeSet2) {
        super(context, attributeSet2, a.r);
    }

    public AppCompatCheckBox(Context context, AttributeSet attributeSet2, int i3) {
