...
public class DefaultJwtParserBuilder implements JwtParserBuilder {
    ...
    public JwtParser build() {
        ...
        DefaultJwtParser defaultJwtParser = new DefaultJwtParser(this.signingKeyResolver, this.key, this.keyBytes, this.clock, this.allowedClockSkewMillis, claims, this.expectedClaims, this.base64UrlDecoder, this.deserializer, this.compressionCodecResolver);
    ...
    public JwtParserBuilder require(String str, Object object) {
