...
class h {
    ...
    private static final io.grpc.k1.r.j.h d;
    private final io.grpc.k1.r.j.h.a a;
    ...
    private static final class a {
        ...
        static io.grpc.k1.r.j.h.a[] a(io.grpc.k1.r.j.h.a h$a) {
            return a.a;
        }

        static int b(io.grpc.k1.r.j.h.a h$a) {
            return a.b;
        }

        static int c(io.grpc.k1.r.j.h.a h$a) {
            return a.c;
        }
    }
    static {
    ...
    private void a(int i, int i2, byte b3) {
        int i4;
        int i3;
        io.grpc.k1.r.j.h.a aVar2;
        io.grpc.k1.r.j.h.a aVar;
        io.grpc.k1.r.j.h.a obj5;
        int obj7;
        h.a aVar3 = new h.a(i, b3);
        obj5 = this.a;
        int i5 = 8;
        while (obj7 > i5) {
            i7 &= 255;
            if (h.a.a(obj5)[i4] == null) {
            }
            obj5 = h.a.a(obj5)[i4];
            i5 = 8;
            aVar = new h.a();
    ...
    public static io.grpc.k1.r.j.h f() {
        return h.d;
    }
    ...
    byte[] c(byte[] bArr) {
        ...
        for (byte b : bArr) {
            i5 += 8;
            while (i5 >= 8) {
                aVar = h.a.a(aVar)[i10 &= 255];
                if (h.a.a(aVar) == 0) {
                } else {
                }
                i5 += -8;
                byteArrayOutputStream.write(h.a.b(aVar));
                i5 -= i6;
                aVar = this.a;
            }
            aVar = h.a.a(aVar)[i10 &= 255];
        ...
        while (i5 > 0) {
            ...
            byteArrayOutputStream.write(h.a.b(obj7));
            i5 -= obj7;
            aVar = this.a;
        }
    ...
    void d(byte[] bArr, OutputStream outputStream2) {
        int i;
        int i3;
        int i4;
        int i2;
        ...
        for (byte b2 : bArr) {
            ...
            i3 += b;
            while (i3 >= 8) {
                outputStream2.write((int)i8);
            }
            i9 = 255;
            outputStream2.write((int)i8);
        }
        if (i3 > 0) {
            outputStream2.write((int)i);
        }
    }
