...
class m {
    public static <T> void a(java.lang.Appendable appendable, T t2, l<? super T, ? extends java.lang.CharSequence> l3) {
        String obj2;
        boolean obj3;
        n.f(appendable, "$this$appendElement");
        if (l3) {
            appendable.append((CharSequence)l3.invoke(t2));
        } else {
            obj3 = t2 != null ? t2 instanceof CharSequence : 1;
            if (obj3 != null) {
