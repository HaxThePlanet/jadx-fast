...
public final class b {
    public static final <E> E[] a(int i) {
        ...
        IllegalArgumentException obj1 = new IllegalArgumentException("capacity must be non-negative.".toString());
        throw obj1;
    }

    public static final <T> T[] b(T[] tArr, int i2) {
        n.f(tArr, "$this$copyOfUninitializedElements");
        final Object[] obj1 = Arrays.copyOf(tArr, i2);
