...
public final class h {
    public static final long a(Reader reader, Writer writer2, int i3) {
        int read;
        int i;
        long l;
        n.f(reader, "$this$copyTo");
        n.f(writer2, "out");
        final char[] obj7 = new char[i3];
        read = reader.read(obj7);
        i = 0;
        while (read >= 0) {
            writer2.write(obj7, 0, read);
            i += l;
            read = reader.read(obj7);
        }
        return i;
    ...
    public static long b(Reader reader, Writer writer2, int i3, int i4, Object object5) {
        int obj2;
        if (i4 &= 2 != 0) {
            obj2 = 8192;
        }
        return h.a(reader, writer2, obj2);
    }

    public static final String c(Reader reader) {
        n.f(reader, "$this$readText");
        StringWriter stringWriter = new StringWriter();
        h.b(reader, stringWriter, 0, 2, 0);
        final String obj4 = stringWriter.toString();
        n.e(obj4, "buffer.toString()");
        return obj4;
    }
}
