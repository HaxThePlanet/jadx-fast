...
public final class a {
    public static final long a(InputStream inputStream, OutputStream outputStream2, int i3) {
        int read;
        int i;
        long l;
        n.f(inputStream, "$this$copyTo");
        n.f(outputStream2, "out");
        final byte[] obj7 = new byte[i3];
        read = inputStream.read(obj7);
        i = 0;
        while (read >= 0) {
            outputStream2.write(obj7, 0, read);
            i += l;
            read = inputStream.read(obj7);
        }
        return i;
    ...
    public static long b(InputStream inputStream, OutputStream outputStream2, int i3, int i4, Object object5) {
        int obj2;
        if (i4 &= 2 != 0) {
            obj2 = 8192;
        }
        return a.a(inputStream, outputStream2, obj2);
    }
}
