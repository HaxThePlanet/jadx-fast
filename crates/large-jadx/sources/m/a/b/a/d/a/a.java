...
public final class a {
    ...
    static final class a extends p implements a<a> {
        ...
        final Fragment $this_getSharedViewModel;
        a(Fragment fragment) {
    ...
    public static final <T extends androidx.lifecycle.e0> T a(Fragment fragment, a a2, d<T> d3, a<? extends a> a4) {
        n.f(fragment, "<this>");
        n.f(d3, "clazz");
        a.a aVar3 = new a.a(fragment);
        return a.b(a.a(fragment), a2, 0, aVar3, d3, a4);
    }
}
