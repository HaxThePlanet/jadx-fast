...
public final class e<T, R>  extends r<R> {
    ...
    static final class a extends AtomicInteger implements y<T>, b {
        ...
        final j errorMode;
        final c errors;
        final i.b.m0.e.d.e.a.a<R> inner;
        R item;
        final n<? super T, ? extends g0<? extends R>> mapper;
        final i<T> queue;
        volatile int state;
        b upstream;
        a(y<? super R> y, n<? super T, ? extends g0<? extends R>> n2, int i3, j j4) {
            super();
            this.downstream = y;
            this.mapper = n2;
            this.errorMode = j4;
        ...
        void a() {
            ...
            while (this.cancelled) {
                ...
                b.e(cancelled, "The mapper returned a null SingleSource");
                this.state = i3;
                (g0)cancelled.subscribe(this.inner);
                i = i3;
            }
            queue.clear();
            this.item = inner;
    ...
    public e(r<T> r, n<? super T, ? extends g0<? extends R>> n2, j j3, int i4) {
        super();
        this.a = r;
        this.b = n2;
        this.c = j3;
    ...
    protected void subscribeActual(y<? super R> y) {
        ...
        if (!i.c(this.a, this.b, y)) {
            aVar = new e.a(y, this.b, this.v, this.c);
