...
public final class e<T, R> extends r<R> {
    ...
    static final class a<T, R> extends AtomicInteger implements y<T>, i.b.j0.b {
        ...
        final e.a.a<R> inner = new e$a$a<>();
        R item;
        final n<? super T, ? extends g0<? extends R>> mapper;
        final i<T> queue = new c<>();
        volatile int state;
        i.b.j0.b upstream;
        a(y<? super R> yVar, n<? super T, ? extends g0<? extends R>> nVar, int i, i.b.m0.j.j jVar) {
            super();
            this.downstream = yVar;
            this.mapper = nVar;
            this.errorMode = jVar;
            i.b.m0.j.c cVar = new c();
            i.b.m0.e.d.e.a.a aVar = new e.a.a(this);
    ...
    public e(r<T> rVar, n<? super T, ? extends g0<? extends R>> nVar, i.b.m0.j.j jVar, int i) {
        super();
        this.a = rVar;
        this.b = nVar;
        this.c = jVar;
    ...
    protected void subscribeActual(y<? super R> yVar) {
        if (!i.c(this.a, this.b, yVar)) {
            this.a.subscribe(new e.a(yVar, this.b, this.v, this.c));
        }
    }
}
