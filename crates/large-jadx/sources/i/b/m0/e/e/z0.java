...
public final class z0<T, R> extends a<T, R> {
    ...
    static final class a<T, R> extends AtomicInteger implements y<T>, i.b.j0.b {
        ...
        @Override // java.util.concurrent.atomic.AtomicInteger
        void e(z0.a.a<T, R> a.a, Throwable th) {
            this.set.c(a.a);
            if (this.errors.a(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
        ...
        public void onNext(T t) {
            ...
            i.b.m0.e.e.z0.a.a aVar = new z0.a.a(this);
            if (!this.cancelled) {
                if (this.set.b(aVar)) {
    ...
    public z0(w<T> wVar, n<? super T, ? extends g0<? extends R>> nVar, boolean z) {
        super(wVar);
        this.b = nVar;
        this.c = z;
    }
    ...
    protected void subscribeActual(y<? super R> yVar) {
        this.a.subscribe(new z0.a(yVar, this.b, this.c));
    }
}
