...
public final class r2<T> extends a<T, T> {
    ...
    static final class a<T> extends AtomicInteger implements y<T>, i.b.j0.b {
        ...
        final r2.a.a<T> inner = new r2$a$a<>();
        final i.b.t0.d<Object> signaller;
        final w<T> source;
        final AtomicReference<i.b.j0.b> upstream = new AtomicReference<>();
        final AtomicInteger wip = new AtomicInteger();
        a(y<? super T> yVar, i.b.t0.d<Object> dVar, w<T> wVar) {
            super();
            ...
            i.b.m0.e.e.r2.a.a aVar = new r2.a.a(this);
        ...
        public void onComplete() {
            ...
            boolean z = false;
            this.active = z;
            this.signaller.onNext(Integer.valueOf(z));
        }
    ...
    public r2(w<T> wVar, n<? super r<Object>, ? extends w<?>> nVar) {
        super(wVar);
        this.b = nVar;
    }
    ...
    protected void subscribeActual(y<? super T> yVar) {
        ...
        i.b.m0.e.e.r2.a aVar = new r2.a(yVar, dVar, this.a);
