...
public final class p<T>  extends CountDownLatch implements y<T>, Future<T>, b {
    ...
    public void onComplete() {
        ...
        AtomicReference dISPOSED;
        if (this.a == null) {
            NoSuchElementException noSuchElementException = new NoSuchElementException("The source is empty");
            onError(noSuchElementException);
        }
        compareAndSet = this.c.get();
        while ((b)compareAndSet != this) {
            compareAndSet = this.c.get();
        }
    }
    ...
    public void onNext(T t) {
        if (this.a != null) {
            ...
            IndexOutOfBoundsException obj2 = new IndexOutOfBoundsException("More than one element received");
            onError(obj2);
        }
        this.a = t;
    }
