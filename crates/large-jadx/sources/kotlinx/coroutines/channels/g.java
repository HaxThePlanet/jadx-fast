...
public class g<E>  extends c<w> implements kotlinx.coroutines.channels.f<E> {

    private final kotlinx.coroutines.channels.f<E> c;
    public g(g g, kotlinx.coroutines.channels.f<E> f2, boolean z3, boolean z4) {
        super(g, z3, z4);
        this.c = f2;
    }

    protected final kotlinx.coroutines.channels.f<E> K0() {
        return this.c;
    }
    ...
    public void L(Throwable throwable) {
        int i = 0;
        final CancellationException obj3 = f2.z0(this, throwable, i, 1, i);
        this.c.c(obj3);
        I(obj3);
    }

    public Object b(d<? super kotlinx.coroutines.channels.i<? extends E>> d) {
        Object obj = b.d();
        return this.c.b(d);
    }
