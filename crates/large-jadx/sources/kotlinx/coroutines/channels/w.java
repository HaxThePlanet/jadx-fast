...
public interface w<E>  {
    ...
    public static final class a {
        public static boolean a(kotlinx.coroutines.channels.w w, Throwable throwable2, int i3, Object object4) {
            int obj1;
            if (object4 != null) {
            } else {
                if (i3 &= 1 != 0) {
    ...
    public abstract boolean d(Throwable throwable);

    public abstract void s(l<? super Throwable, w> l);

    public abstract Object u(E e);
