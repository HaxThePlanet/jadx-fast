...
public final class n0 {
    public static final kotlinx.coroutines.m0 a(g g) {
        kotlin.b0.g.b bVar;
        int i;
        g obj3;
        if (g.get(y1.s) != null) {
            ...
            i = 0;
            obj3 = g.plus(b2.b(i, 1, i));
        }
        f fVar = new f(obj3);
        return fVar;
    }

    public static final <R> Object b(p<? super kotlinx.coroutines.m0, ? super d<? super R>, ? extends Object> p, d<? super R> d2) {
        x xVar = new x(d2.getContext(), d2);
        final Object obj2 = b.c(xVar, xVar, p);
        if (obj2 == b.d()) {
            h.c(d2);
        }
        return obj2;
