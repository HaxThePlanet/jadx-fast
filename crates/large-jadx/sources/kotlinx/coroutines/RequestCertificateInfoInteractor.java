...
/* compiled from: RequestCertificateInfoInteractor.kt */
...
public final class RequestCertificateInfoInteractor {

    /* renamed from: a, reason: from kotlin metadata */
    private final i2 cloudFunction;
    public j3(i2 i2Var) {
        n.f(i2Var, "cloudFunction");
        super();
        this.cloudFunction = i2Var;
    }
    ...
    public final a0<CertificateInfo> getCertificateInfo(String programId, String dogId) {
        ...
        n.f(dogId, "dogId");
        return this.cloudFunction.i(programId, dogId);
    }
}
