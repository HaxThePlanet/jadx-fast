...
/* compiled from: ZeroStateDecoration.kt */
...
public final class ZeroStateDecoration extends RecyclerView.o {
    ...
    public void onDraw(Canvas canvas, RecyclerView parent, RecyclerView.b0 state) {
        ...
        if (parent.getChildCount() == 0 && this.view == null) {
            z = false;
            this.view = LayoutInflater.from(parent.getContext()).inflate(this.layoutId, parent, z);
            if (this.view != null) {
                int i = 1073741824;
                this.view.measure(View.MeasureSpec.makeMeasureSpec(parent.getWidth(), i), View.MeasureSpec.makeMeasureSpec(parent.getHeight(), i));
            }
            if (this.view != null) {
                this.view.layout(parent.getLeft(), parent.getTop(), parent.getRight(), parent.getBottom());
            }
            if (this.view != null) {
