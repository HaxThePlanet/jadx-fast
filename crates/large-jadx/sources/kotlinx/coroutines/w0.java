...
public interface w0 {
    ...
    public static final class a {
        public static kotlinx.coroutines.e1 a(kotlinx.coroutines.w0 w0, long l2, Runnable runnable3, g g4) {
            return t0.a().x(l2, runnable3, g4);
        }
    }
    public abstract void j(long l, kotlinx.coroutines.p<? super w> p2);

    public abstract kotlinx.coroutines.e1 x(long l, Runnable runnable2, g g3);
}
