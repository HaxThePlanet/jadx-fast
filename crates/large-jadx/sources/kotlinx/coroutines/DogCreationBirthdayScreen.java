...
/* compiled from: DogCreationBirthdayScreen.kt */
...
public final class DogCreationBirthdayScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<e> {
        public final e a(Parcel parcel) {
            n.f(parcel, "parcel");
            parcel.readInt();
            return new DogCreationBirthdayScreen();
        }
    ...
    public i3 createTrackingParameters() {
        return S.programExamsCompleteScreen.withoutParameters();
    }
