...
/* compiled from: DogCreationGenderFragment.kt */
...
public final class DogCreationGenderFragment extends Fragment {
    ...
    static final class b extends p implements l<androidx.activity.d, w> {
        @Override // kotlin.d0.d.p
        public final void a(androidx.activity.d dVar) {
            str = "$this$addCallback";
            n.f(dVar, str);
            z = d.this.F1().m().getValue() instanceof LoadResult_Loading;
            if (!(DogCreationGenderFragment.C1(d.this).m().getValue() instanceof oadResult_Loading)) {
    ...
    public static final class d extends p implements kotlin.d0.c.a<f> {
        ...
        public final f invoke() {
            return b.a(this.$this_viewModel, this.$qualifier, c0.b(DogCreationGenderViewModel.class), this.$parameters);
        }
    ...
    static final class e extends p implements kotlin.d0.c.a<m.a.c.i.a> {
        ...
        public final m.a.c.i.a invoke() {
            ...
            if (dogProfile == null) {
                ...
                app.dogo.com.dogo_android.k.d gender = dogProfile.getGender();
            }
    ...
    private final f F1() {
        return (DogCreationGenderViewModel)this.c.getValue();
    }
    ...
    private final void G1() {
        ...
        if (goToNextScreen().p()) {
            if (goToNextScreen().isUserSignedIn()) {
                ...
                goToNextScreen().updateDogCreationProfileId(app.dogo.com.dogo_android.util.extensionfunction.k1.a(this));
                activity = getActivity();
                if (activity != null) {
            ...
            activity = getActivity();
            if (activity != null) {
                app.dogo.com.dogo_android.util.extensionfunction.g1.n(activity, new DogCreationReminderScreen());
            }
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) throws android.content.res.Resources.NotFoundException {
        ...
        boolean z = false;
        kb kbVar = kb.T(inflater, container, z);
        n.e(kbVar, "inflate(inflater, container, false)");
        this.binding = kbVar;
        String str2 = "binding";
        i = 0;
        if (kbVar == null) {
            ...
            if (this.binding == null) {
                ...
                arr[z] = i;
                binding2.Q.setText(getResources().getString(2131886453, arr));
                if (this.binding == null) {
                    n.w(str2);
                    /* Dexterity WARN: Type inference failed for thrown value */
                    throw (Throwable) i;
        ...
        if (this.binding == null) {
            ...
            if (this.binding == null) {
                ...
                if (this.binding == null) {
                    ...
                    F1().isUserSignedIn().observe(viewLifecycleOwner2, new kotlinx.coroutines.d.a(this));
                    return;
                }
            }
        }
    ...
    public static /* synthetic */ void onViewCreated(d view, View savedInstanceState) {
        DogCreationGenderFragment.K1(view, savedInstanceState);
    }

    public static /* synthetic */ void I1(d dVar, View view) {
        DogCreationGenderFragment.L1(dVar, view);
    }

    public static /* synthetic */ void J1(d dVar, View view) {
        DogCreationGenderFragment.M1(dVar, view);
    }
}
