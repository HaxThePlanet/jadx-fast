...
/* compiled from: PottyProgramOverviewScreen.kt */
...
public final class PottyProgramOverviewScreen extends j {
    ...
    public static final class a implements Parcelable.Creator<m> {
        public final m a(Parcel parcel) {
            n.f(parcel, "parcel");
            return new PottyProgramOverviewScreen(parcel.readString());
        }
    ...
    protected Fragment createFragment() {
        return new PottyProgramOverviewFragment();
    }

    @Override // app.dogo.com.dogo_android.y.j
    public i3 createTrackingParameters() {
        return S.onboardingPagerSocialising.b(new EP_ViewSource(), this.source);
    }
