...
public final class OpenJSSEPlatform extends okhttp3.internal.platform.Platform {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = "\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\u0008\u0002\n\u0002\u0010\u000b\n\u0002\u0008\u0006\u0008\u0086\u0003\u0018\u00002\u00020\u0001B\t\u0008\u0002¢\u0006\u0004\u0008\t\u0010\nJ\u000f\u0010\u0003\u001a\u0004\u0018\u00010\u0002¢\u0006\u0004\u0008\u0003\u0010\u0004R\u0019\u0010\u0006\u001a\u00020\u00058\u0006@\u0006¢\u0006\u000c\n\u0004\u0008\u0006\u0010\u0007\u001a\u0004\u0008\u0006\u0010\u0008¨\u0006\u000b", d2 = {"Lokhttp3/internal/platform/OpenJSSEPlatform$Companion;", "", "Lokhttp3/internal/platform/OpenJSSEPlatform;", "buildIfSupported", "()Lokhttp3/internal/platform/OpenJSSEPlatform;", "", "isSupported", "Z", "()Z", "<init>", "()V", "okhttp"}, k = 1, mv = {1, 4, 0})
    public static final class Companion {
        ...
        public final okhttp3.internal.platform.OpenJSSEPlatform buildIfSupported() {
            boolean openJSSEPlatform;
            int i;
            if (isSupported()) {
                openJSSEPlatform = new OpenJSSEPlatform(0);
                i = openJSSEPlatform;
            }
            return i;
        }
    ...
    static {
        OpenJSSEPlatform.Companion companion = new OpenJSSEPlatform.Companion(0);
        OpenJSSEPlatform.Companion = companion;
    ...
    private OpenJSSEPlatform() {
        ...
        this.provider = (Provider)openJSSE;
    }

    public OpenJSSEPlatform(g g) {
        super();
    }
    ...
    public void configureTlsExtensions(SSLSocket sSLSocket, String string2, List<Protocol> list3) {
        ...
        if (sSLSocket instanceof SSLSocket) {
            obj4 = (SSLSocket)sSLSocket.getSSLParameters();
            if (obj4 instanceof SSLParameters) {
                obj5 = Platform.Companion.alpnProtocolNames(list3).toArray(new String[0]);
                Objects.requireNonNull(obj5, "null cannot be cast to non-null type kotlin.Array<T>");
                (SSLParameters)obj4.setApplicationProtocols((String[])obj5);
                sSLSocket.setSSLParameters(obj4);
            }
        } else {
    ...
    public String getSelectedProtocol(SSLSocket sSLSocket) {
        ...
        n.f(sSLSocket, "sslSocket");
        if (sSLSocket instanceof SSLSocket) {
            obj2 = (SSLSocket)sSLSocket.getApplicationProtocol();
            if (obj2 == null) {
                obj2 = 0;
            } else {
                if (obj2.hashCode() != 0) {
    ...
    public SSLContext newSSLContext() {
        ...
        n.e(instance, "SSLContext.getInstance(\"TLSv1.3\", provider)");
        return instance;
    }
    ...
    public X509TrustManager trustManager(SSLSocketFactory sSLSocketFactory) {
        ...
        UnsupportedOperationException obj2 = new UnsupportedOperationException("clientBuilder.sslSocketFactory(SSLSocketFactory) not supported with OpenJSSE");
        throw obj2;
    }
}
