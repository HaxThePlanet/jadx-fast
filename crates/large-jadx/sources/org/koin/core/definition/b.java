...
/* typealias Definition = kotlin.Function2<org.koin.core.scope.Scope, org.koin.core.parameter.ParametersHolder, T> */
/* typealias IndexKey = kotlin.Boolean */
public final class b {
    /* renamed from: a, reason: from kotlin metadata */
    public static final String indexKey(d<?> clazz, m.a.c.j.a typeQualifier, m.a.c.j.a scopeQualifier) {
        String typeQualifier2;
        n.f(clazz, "clazz");
        n.f(scopeQualifier, "scopeQualifier");
        typeQualifier2 = "";
        if (typeQualifier != null) {
            typeQualifier2 = typeQualifier.getValue();
            if (typeQualifier2 != null) {
            }
        }
        StringBuilder stringBuilder = new StringBuilder();
        String str3 = a.a(clazz);
        char c = ':';
        str4 = str3 + c + typeQualifier2 + c + scopeQualifier;
        return str4;
    }
}
