...
public class MLPSpecificBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final b bVar = new b("MLPSpecificBox.java", MLPSpecificBox.class);
        final String str58 = "method-execution";
        MLPSpecificBox.ajc$tjp_0 = bVar.h(str58, bVar.g("1", "getFormat_info", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "", "", "", "int"), 49);
        MLPSpecificBox.ajc$tjp_1 = bVar.h(str58, bVar.g("1", "setFormat_info", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "int", "format_info", "", "void"), 53);
        MLPSpecificBox.ajc$tjp_2 = bVar.h(str58, bVar.g("1", "getPeak_data_rate", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "", "", "", "int"), 57);
        MLPSpecificBox.ajc$tjp_3 = bVar.h(str58, bVar.g("1", "setPeak_data_rate", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "int", "peak_data_rate", "", "void"), 61);
        MLPSpecificBox.ajc$tjp_4 = bVar.h(str58, bVar.g("1", "getReserved", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "", "", "", "int"), 65);
        MLPSpecificBox.ajc$tjp_5 = bVar.h(str58, bVar.g("1", "setReserved", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "int", "reserved", "", "void"), 69);
        MLPSpecificBox.ajc$tjp_6 = bVar.h(str58, bVar.g("1", "getReserved2", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "", "", "", "int"), 73);
        MLPSpecificBox.ajc$tjp_7 = bVar.h(str58, bVar.g("1", "setReserved2", "com.googlecode.mp4parser.boxes.MLPSpecificBox", "int", "reserved2", "", "void"), 77);
    }
