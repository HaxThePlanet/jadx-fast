...
public class GenericMediaHeaderTextAtom extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final b bVar = new b("GenericMediaHeaderTextAtom.java", GenericMediaHeaderTextAtom.class);
        final String str128 = "method-execution";
        GenericMediaHeaderTextAtom.ajc$tjp_0 = bVar.h(str128, bVar.g("1", "getUnknown_1", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 60);
        GenericMediaHeaderTextAtom.ajc$tjp_1 = bVar.h(str128, bVar.g("1", "setUnknown_1", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_1", "", "void"), 64);
        GenericMediaHeaderTextAtom.ajc$tjp_10 = bVar.h(str128, bVar.g("1", "getUnknown_6", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 100);
        GenericMediaHeaderTextAtom.ajc$tjp_11 = bVar.h(str128, bVar.g("1", "setUnknown_6", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_6", "", "void"), 104);
        GenericMediaHeaderTextAtom.ajc$tjp_12 = bVar.h(str128, bVar.g("1", "getUnknown_7", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 108);
        GenericMediaHeaderTextAtom.ajc$tjp_13 = bVar.h(str128, bVar.g("1", "setUnknown_7", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_7", "", "void"), 112);
        GenericMediaHeaderTextAtom.ajc$tjp_14 = bVar.h(str128, bVar.g("1", "getUnknown_8", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 116);
        GenericMediaHeaderTextAtom.ajc$tjp_15 = bVar.h(str128, bVar.g("1", "setUnknown_8", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_8", "", "void"), 120);
        GenericMediaHeaderTextAtom.ajc$tjp_16 = bVar.h(str128, bVar.g("1", "getUnknown_9", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 124);
        GenericMediaHeaderTextAtom.ajc$tjp_17 = bVar.h(str128, bVar.g("1", "setUnknown_9", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_9", "", "void"), 128);
        GenericMediaHeaderTextAtom.ajc$tjp_2 = bVar.h(str128, bVar.g("1", "getUnknown_2", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 68);
        GenericMediaHeaderTextAtom.ajc$tjp_3 = bVar.h(str128, bVar.g("1", "setUnknown_2", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_2", "", "void"), 72);
        GenericMediaHeaderTextAtom.ajc$tjp_4 = bVar.h(str128, bVar.g("1", "getUnknown_3", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 76);
        GenericMediaHeaderTextAtom.ajc$tjp_5 = bVar.h(str128, bVar.g("1", "setUnknown_3", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_3", "", "void"), 80);
        GenericMediaHeaderTextAtom.ajc$tjp_6 = bVar.h(str128, bVar.g("1", "getUnknown_4", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 84);
        GenericMediaHeaderTextAtom.ajc$tjp_7 = bVar.h(str128, bVar.g("1", "setUnknown_4", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_4", "", "void"), 88);
        GenericMediaHeaderTextAtom.ajc$tjp_8 = bVar.h(str128, bVar.g("1", "getUnknown_5", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "", "", "", "int"), 92);
        GenericMediaHeaderTextAtom.ajc$tjp_9 = bVar.h(str128, bVar.g("1", "setUnknown_5", "com.googlecode.mp4parser.boxes.apple.GenericMediaHeaderTextAtom", "int", "unknown_5", "", "void"), 96);
    }
