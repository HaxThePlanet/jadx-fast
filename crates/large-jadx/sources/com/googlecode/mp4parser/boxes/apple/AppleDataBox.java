...
public abstract class AppleDataBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final b bVar = new b("AppleDataBox.java", AppleDataBox.class);
        final String str44 = "method-execution";
        AppleDataBox.ajc$tjp_0 = bVar.h(str44, bVar.g("1", "getLanguageString", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", "java.lang.String"), 25);
        AppleDataBox.ajc$tjp_1 = bVar.h(str44, bVar.g("1", "getDataType", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", "int"), 43);
        AppleDataBox.ajc$tjp_2 = bVar.h(str44, bVar.g("1", "getDataCountry", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", "int"), 47);
        AppleDataBox.ajc$tjp_3 = bVar.h(str44, bVar.g("1", "setDataCountry", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "int", "dataCountry", "", "void"), 51);
        AppleDataBox.ajc$tjp_4 = bVar.h(str44, bVar.g("1", "getDataLanguage", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "", "", "", "int"), 55);
        AppleDataBox.ajc$tjp_5 = bVar.h(str44, bVar.g("1", "setDataLanguage", "com.googlecode.mp4parser.boxes.apple.AppleDataBox", "int", "dataLanguage", "", "void"), 59);
    }
    ...
    public String getLanguageString() {
        ...
        str = this.dataLanguage;
        if ((String)AppleDataBox.language.get(str) == null) {
            ByteBuffer wrap = ByteBuffer.wrap(new byte[2]);
            g.e(wrap, this.dataLanguage);
            wrap.reset();
            String displayLanguage = new Locale(e.f(wrap)).getDisplayLanguage();
        }
        return value;
    }
    ...
    protected ByteBuffer parseDataLength4ccTypeCountryLanguageAndReturnRest(ByteBuffer byteBuffer) {
        ...
        this.dataCountry = _short;
        int i5 = 65536;
        if (_short < 0) {
            this.dataCountry = _short + i5;
        }
        short _short2 = byteBuffer.getShort();
        this.dataLanguage = _short2;
        if (_short2 < 0) {
            this.dataLanguage = _short2 + i5;
        }
        int i = byteBuffer.getInt() - 16;
    ...
    @Override // com.googlecode.mp4parser.AbstractBox
    protected void writeDataLength4ccTypeCountryLanguage(ByteBuffer byteBuffer) throws java.io.UnsupportedEncodingException {
