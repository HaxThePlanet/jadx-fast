...
public class TrackLoadSettingsAtom extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final b bVar = new b("TrackLoadSettingsAtom.java", TrackLoadSettingsAtom.class);
        final String str58 = "method-execution";
        TrackLoadSettingsAtom.ajc$tjp_0 = bVar.h(str58, bVar.g("1", "getPreloadStartTime", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "", "", "", "int"), 49);
        TrackLoadSettingsAtom.ajc$tjp_1 = bVar.h(str58, bVar.g("1", "setPreloadStartTime", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "int", "preloadStartTime", "", "void"), 53);
        TrackLoadSettingsAtom.ajc$tjp_2 = bVar.h(str58, bVar.g("1", "getPreloadDuration", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "", "", "", "int"), 57);
        TrackLoadSettingsAtom.ajc$tjp_3 = bVar.h(str58, bVar.g("1", "setPreloadDuration", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "int", "preloadDuration", "", "void"), 61);
        TrackLoadSettingsAtom.ajc$tjp_4 = bVar.h(str58, bVar.g("1", "getPreloadFlags", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "", "", "", "int"), 65);
        TrackLoadSettingsAtom.ajc$tjp_5 = bVar.h(str58, bVar.g("1", "setPreloadFlags", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "int", "preloadFlags", "", "void"), 69);
        TrackLoadSettingsAtom.ajc$tjp_6 = bVar.h(str58, bVar.g("1", "getDefaultHints", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "", "", "", "int"), 73);
        TrackLoadSettingsAtom.ajc$tjp_7 = bVar.h(str58, bVar.g("1", "setDefaultHints", "com.googlecode.mp4parser.boxes.apple.TrackLoadSettingsAtom", "int", "defaultHints", "", "void"), 77);
    }
