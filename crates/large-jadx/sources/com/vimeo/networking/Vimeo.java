...
public class Vimeo {
    ...
    public enum RefineSort {
        ...
        public static Vimeo.RefineSort fromString(String str) {
            ...
            if (str == null) {
                ...
                com.vimeo.networking.Vimeo.RefineSort[] values = Vimeo.RefineSort.values();
                length = values.length;
                i = 0;
                for (com.vimeo.networking.Vimeo.RefineSort refineSort : values) {
                    if (str.equalsIgnoreCase(refineSort.text)) {
                        return refineSort;
                    }
                }
            }
    ...
    public enum RefineUploadDate {
        ...
        public static Vimeo.RefineUploadDate fromString(String str) {
            int i = 0;
            com.vimeo.networking.Vimeo.RefineUploadDate refineUploadDate;
            boolean equalsIgnoreCase;
            if (str == null) {
                StringBuilder stringBuilder = new StringBuilder();
                String str2 = "No constant with text ";
                ...
                com.vimeo.networking.Vimeo.RefineUploadDate[] values = Vimeo.RefineUploadDate.values();
                length = values.length;
                i = 0;
                for (com.vimeo.networking.Vimeo.RefineUploadDate refineUploadDate : values) {
                    if (str.equalsIgnoreCase(refineUploadDate.text)) {
                        return refineUploadDate;
                    }
                }
            }
        }
