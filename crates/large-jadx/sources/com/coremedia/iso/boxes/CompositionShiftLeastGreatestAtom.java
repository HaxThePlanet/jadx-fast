...
public class CompositionShiftLeastGreatestAtom extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final b bVar = new b("CompositionShiftLeastGreatestAtom.java", CompositionShiftLeastGreatestAtom.class);
        final String str72 = "method-execution";
        CompositionShiftLeastGreatestAtom.ajc$tjp_0 = bVar.h(str72, bVar.g("1", "getCompositionOffsetToDisplayOffsetShift", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "", "", "", "int"), 66);
        CompositionShiftLeastGreatestAtom.ajc$tjp_1 = bVar.h(str72, bVar.g("1", "setCompositionOffsetToDisplayOffsetShift", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "int", "compositionOffsetToDisplayOffsetShift", "", "void"), 70);
        CompositionShiftLeastGreatestAtom.ajc$tjp_2 = bVar.h(str72, bVar.g("1", "getLeastDisplayOffset", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "", "", "", "int"), 74);
        CompositionShiftLeastGreatestAtom.ajc$tjp_3 = bVar.h(str72, bVar.g("1", "setLeastDisplayOffset", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "int", "leastDisplayOffset", "", "void"), 78);
        CompositionShiftLeastGreatestAtom.ajc$tjp_4 = bVar.h(str72, bVar.g("1", "getGreatestDisplayOffset", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "", "", "", "int"), 82);
        CompositionShiftLeastGreatestAtom.ajc$tjp_5 = bVar.h(str72, bVar.g("1", "setGreatestDisplayOffset", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "int", "greatestDisplayOffset", "", "void"), 86);
        CompositionShiftLeastGreatestAtom.ajc$tjp_6 = bVar.h(str72, bVar.g("1", "getDisplayStartTime", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "", "", "", "int"), 90);
        CompositionShiftLeastGreatestAtom.ajc$tjp_7 = bVar.h(str72, bVar.g("1", "setDisplayStartTime", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "int", "displayStartTime", "", "void"), 94);
        CompositionShiftLeastGreatestAtom.ajc$tjp_8 = bVar.h(str72, bVar.g("1", "getDisplayEndTime", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "", "", "", "int"), 98);
        CompositionShiftLeastGreatestAtom.ajc$tjp_9 = bVar.h(str72, bVar.g("1", "setDisplayEndTime", "com.coremedia.iso.boxes.CompositionShiftLeastGreatestAtom", "int", "displayEndTime", "", "void"), 102);
    }
