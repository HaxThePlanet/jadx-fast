...
public final class g {
    ...
    public static final com.facebook.e0.g.a b;
    ...
    public static final class a {
        ...
        public final com.facebook.e0.g.b c() {
            return h.j.h();
        }
        ...
        public final void e(Context context, String string2) {
            n.f(context, "context");
            h.j.k(context, string2);
        }

        public final com.facebook.e0.g f(Context context) {
            n.f(context, "context");
            final int i = 0;
            g gVar = new g(context, i, i, i);
            return gVar;
        }
    ...
    @Metadata(d1 = "\u0000\u000c\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\u0008\u0004\u0008\u0086\u0001\u0018\u00002\u0008\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\u0008\u0002¢\u0006\u0002\u0010\u0002j\u0002\u0008\u0003j\u0002\u0008\u0004¨\u0006\u0005", d2 = {"Lcom/facebook/appevents/AppEventsLogger$FlushBehavior;", "", "(Ljava/lang/String;I)V", "AUTO", "EXPLICIT_ONLY", "facebook-core_release"}, k = 1, mv = {1, 5, 1})
    ...
    private g(Context context, String string2, a a3) {
        super();
        h hVar = new h(context, string2, a3);
        this.a = hVar;
    }

    public g(Context context, String string2, a a3, g g4) {
        super(context, string2, a3);
    }
    ...
    public final void d(String string, double d2) {
        this.a.l(string, d2);
    }

    public final void e(String string, double d2, Bundle bundle3) {
        this.a.m(string, d2, bundle3);
    }

    public final void f(String string, Bundle bundle2) {
