...
public class TierInfoBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        final b bVar = new b("TierInfoBox.java", TierInfoBox.class);
        final String str156 = "method-execution";
        TierInfoBox.ajc$tjp_0 = bVar.h(str156, bVar.g("1", "getTierID", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 69);
        TierInfoBox.ajc$tjp_1 = bVar.h(str156, bVar.g("1", "setTierID", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "tierID", "", "void"), 73);
        TierInfoBox.ajc$tjp_10 = bVar.h(str156, bVar.g("1", "getVisualWidth", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 109);
        TierInfoBox.ajc$tjp_11 = bVar.h(str156, bVar.g("1", "setVisualWidth", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "visualWidth", "", "void"), 113);
        TierInfoBox.ajc$tjp_12 = bVar.h(str156, bVar.g("1", "getVisualHeight", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 117);
        TierInfoBox.ajc$tjp_13 = bVar.h(str156, bVar.g("1", "setVisualHeight", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "visualHeight", "", "void"), 121);
        TierInfoBox.ajc$tjp_14 = bVar.h(str156, bVar.g("1", "getDiscardable", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 125);
        TierInfoBox.ajc$tjp_15 = bVar.h(str156, bVar.g("1", "setDiscardable", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "discardable", "", "void"), 129);
        TierInfoBox.ajc$tjp_16 = bVar.h(str156, bVar.g("1", "getConstantFrameRate", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 133);
        TierInfoBox.ajc$tjp_17 = bVar.h(str156, bVar.g("1", "setConstantFrameRate", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "constantFrameRate", "", "void"), 137);
        TierInfoBox.ajc$tjp_18 = bVar.h(str156, bVar.g("1", "getReserved2", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 141);
        TierInfoBox.ajc$tjp_19 = bVar.h(str156, bVar.g("1", "setReserved2", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "reserved2", "", "void"), 145);
        TierInfoBox.ajc$tjp_2 = bVar.h(str156, bVar.g("1", "getProfileIndication", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 77);
        TierInfoBox.ajc$tjp_20 = bVar.h(str156, bVar.g("1", "getFrameRate", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 149);
        TierInfoBox.ajc$tjp_21 = bVar.h(str156, bVar.g("1", "setFrameRate", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "frameRate", "", "void"), 153);
        TierInfoBox.ajc$tjp_3 = bVar.h(str156, bVar.g("1", "setProfileIndication", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "profileIndication", "", "void"), 81);
        TierInfoBox.ajc$tjp_4 = bVar.h(str156, bVar.g("1", "getProfile_compatibility", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 85);
        TierInfoBox.ajc$tjp_5 = bVar.h(str156, bVar.g("1", "setProfile_compatibility", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "profile_compatibility", "", "void"), 89);
        TierInfoBox.ajc$tjp_6 = bVar.h(str156, bVar.g("1", "getLevelIndication", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 93);
        TierInfoBox.ajc$tjp_7 = bVar.h(str156, bVar.g("1", "setLevelIndication", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "levelIndication", "", "void"), 97);
        TierInfoBox.ajc$tjp_8 = bVar.h(str156, bVar.g("1", "getReserved1", "com.mp4parser.iso14496.part15.TierInfoBox", "", "", "", "int"), 101);
        TierInfoBox.ajc$tjp_9 = bVar.h(str156, bVar.g("1", "setReserved1", "com.mp4parser.iso14496.part15.TierInfoBox", "int", "reserved1", "", "void"), 105);
    }
    ...
    protected void _parseDetails(ByteBuffer byteBuffer) {
        ...
        this.discardable = (i8 & 192) >> 6;
        this.constantFrameRate = (i8 & 48) >> 4;
    ...
    protected void getContent(ByteBuffer byteBuffer) {
        ...
        g.j(byteBuffer, (this.discardable << 6) + (this.constantFrameRate << 4) + this.reserved2);
