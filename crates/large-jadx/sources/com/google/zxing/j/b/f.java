...
final class f {
    ...
    static {
        ...
        iArr8 = new int[]{27, 917};
        int i10 = 4;
        int[] iArr9 = new int[i10];
        iArr9 = new int[]{522, 568, 723, 809};
        int i15 = 8;
        int[] iArr10 = new int[i15];
        iArr10 = new int[]{237, 308, 436, 284, 646, 653, 428, 379};
        iArr[i3] = iArr10;
        int[] iArr2 = new int[16];
        iArr2 = new int[]{274, 562, 232, 755, 599, 524, 801, 132, 295, 116, 442, 428, 295, 42, 176, 65};
        iArr[3] = iArr2;
    ...
    static String a(java.lang.CharSequence charSequence, int i2) {
        int i3;
        int i;
        char c2;
        int i6;
        ...
        StringBuilder obj9 = new StringBuilder(i7);
        i7--;
        while (i3 >= 0) {
            if (cArr[i3] != 0) {
            }
    ...
    static int b(int i) {
        ...
        IllegalArgumentException obj1 = new IllegalArgumentException("Error correction level must be between 0 and 8!");
        throw obj1;
    }
}
