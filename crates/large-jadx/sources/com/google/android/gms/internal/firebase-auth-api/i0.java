...
final class i0<E>  extends com.google.android.gms.internal.firebase-auth-api.kq<E> implements RandomAccess {

    private static final com.google.android.gms.internal.firebase-auth-api.i0<Object> v;
    private E[] b;
    private int c;
    static {
        final int i = 0;
        i0 i0Var = new i0(new Object[i], i);
        i0.v = i0Var;
        i0Var.zzb();
    }

    private i0(E[] eArr, int i2) {
        super();
        this.b = eArr;
        this.c = i2;
    }

    public static <E> com.google.android.gms.internal.firebase-auth-api.i0<E> d() {
        return i0.v;
    }
