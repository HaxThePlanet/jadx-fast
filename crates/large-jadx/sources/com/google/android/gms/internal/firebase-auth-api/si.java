...
final class si extends com.google.android.gms.internal.firebase-auth-api.an<AuthResult, zzg> {

    private final EmailAuthCredential v;
    public si(EmailAuthCredential emailAuthCredential) {
        super(2);
    ...
    public final void l(com.google.android.gms.internal.firebase-auth-api.ol ol, k k2) {
        ...
        this.u = zmVar;
        ee obj5 = new ee(this.v.zzd(), this.v.zze(), this.d.zzf());
        ol.j().V1(obj5, this.b);
    }
