...
final class ir extends com.google.android.gms.internal.firebase-auth-api.kq<Double> implements RandomAccess, com.google.android.gms.internal.firebase-auth-api.d, com.google.android.gms.internal.firebase-auth-api.g0 {

    private static final com.google.android.gms.internal.firebase-auth-api.ir v;
    private double[] b;
    private int c;
    static {
        final int i = 0;
        ir irVar = new ir(new double[i], i);
        ir.v = irVar;
        irVar.zzb();
    }
    ...
    public final com.google.android.gms.internal.firebase-auth-api.d f(int i) {
        if (i < this.c) {
            ...
            ir irVar = new ir(Arrays.copyOf(this.b, i), this.c);
            return irVar;
        }
