//! Golden file tests comparing dexterity output vs Java JADX reference
//!
//! These tests ensure output compatibility with Java JADX.
//! Run with: cargo test -p dexterity-cli --test golden_tests
//!
...
/// Run dexterity on a file and return all output files
...
fn test_small_apk_structure() {
    ...
    let actual = run_rust_jadx(&input).expect("dexterity failed");
